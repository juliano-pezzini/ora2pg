...
--Rotina utilizada para atualização de valores ao utilizar nova forma de geração de pós-estabelecido.
CREATE OR REPLACE PROCEDURE pls_cta_alt_valor_pos_pck.pls_ajuste_valorizacao_proc ( nr_seq_conta_p pls_conta_v.nr_sequencia%type, nr_seq_conta_pos_estab_p pls_conta_pos_estabelecido.nr_sequencia%type, qt_liberada_p pls_conta_proc_v.qt_procedimento%type, vl_liberado_p pls_conta_proc_v.vl_liberado%type, vl_unitario_p pls_conta_proc_v.vl_unitario%type, vl_liberado_hi_p pls_conta_proc_v.vl_liberado_hi%type, vl_liberado_mat_p pls_conta_proc_v.vl_liberado_material%type, vl_liberado_co_p pls_conta_proc_v.vl_liberado_co%type, vl_lib_taxa_hi_p pls_conta_proc_v.vl_lib_taxa_servico%type, vl_lib_taxa_mat_p pls_conta_proc_v.vl_lib_taxa_material%type, vl_lib_taxa_co_p pls_conta_proc_v.vl_taxa_co%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
for r_C01_w in C01(nr_seq_conta_pos_estab_p) loop
	...
	vl_glosa_co_w 			:= pls_util_cta_pck.pls_obter_vl_glosa(vl_liberado_co_p, r_C01_w.vl_custo_operacional);
	vl_glosa_hi_w 			:= pls_util_cta_pck.pls_obter_vl_glosa(vl_liberado_hi_p, r_C01_w.vl_medico);
	vl_glosa_material_w 		:= pls_util_cta_pck.pls_obter_vl_glosa(vl_liberado_mat_p, r_C01_w.vl_materiais);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_cta_alt_valor_pos_pck.pls_ajuste_valorizacao_proc ( nr_seq_conta_p pls_conta_v.nr_sequencia%type, nr_seq_conta_pos_estab_p pls_conta_pos_estabelecido.nr_sequencia%type, qt_liberada_p pls_conta_proc_v.qt_procedimento%type, vl_liberado_p pls_conta_proc_v.vl_liberado%type, vl_unitario_p pls_conta_proc_v.vl_unitario%type, vl_liberado_hi_p pls_conta_proc_v.vl_liberado_hi%type, vl_liberado_mat_p pls_conta_proc_v.vl_liberado_material%type, vl_liberado_co_p pls_conta_proc_v.vl_liberado_co%type, vl_lib_taxa_hi_p pls_conta_proc_v.vl_lib_taxa_servico%type, vl_lib_taxa_mat_p pls_conta_proc_v.vl_lib_taxa_material%type, vl_lib_taxa_co_p pls_conta_proc_v.vl_taxa_co%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
