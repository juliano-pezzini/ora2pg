...
-- #PossívelMelhoria
CREATE OR REPLACE PROCEDURE pls_cta_alt_valor_pos_pck.pls_atualiza_dados_comp_proc ( nr_seq_conta_proc_p pls_conta_proc_v.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_cta_alt_valor_pos_pck.pls_atualiza_dados_comp_proc ( nr_seq_conta_proc_p pls_conta_proc_v.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
