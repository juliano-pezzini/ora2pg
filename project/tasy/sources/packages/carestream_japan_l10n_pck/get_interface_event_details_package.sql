...
CREATE OR REPLACE PROCEDURE carestream_japan_l10n_pck.get_interface_event_details (nr_seq_event_p bigint, nm_integration_p INOUT text, nm_interface_p INOUT text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE carestream_japan_l10n_pck.get_interface_event_details (nr_seq_event_p bigint, nm_integration_p INOUT text, nm_interface_p INOUT text) FROM PUBLIC;
