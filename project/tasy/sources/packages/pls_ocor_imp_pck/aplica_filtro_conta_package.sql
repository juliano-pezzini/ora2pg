...
BEGIN
-- gerencia a aplicaaao do filtro de conta
...
if (nr_seq_filtro_p IS NOT NULL AND nr_seq_filtro_p::text <> '') then
	...
	for r_c_filtro in c_filtro(nr_seq_filtro_p) loop
		...
		begin
			-- obtam a restriaao da conta

			
			valor_bind_w := pls_ocor_imp_pck.obter_restricao_conta(	r_c_filtro.nr_seq_grupo_doenca, r_c_filtro.cd_doenca_cid, r_c_filtro.ie_tipo_guia, r_c_filtro.nr_seq_tipo_atendimento, r_c_filtro.nr_seq_saida_int, r_c_filtro.ie_regime_internacao, r_c_filtro.ie_tipo_consulta, r_c_filtro.ie_carater_internacao, r_c_filtro.nr_seq_clinica, r_c_filtro.ie_indicador_dorn, r_c_filtro.ie_tipo_internado, r_c_filtro.ie_vinc_internacao, r_c_filtro.ie_recem_nascido, r_c_filtro.ie_indicacao_acidente, r_c_filtro.ie_tipo_faturamento, r_c_filtro.ie_regime_atendimento, r_c_filtro.ie_saude_ocupacional, valor_bind_w);
