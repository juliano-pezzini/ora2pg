...
BEGIN
-- gerencia a aplicaaao do filtro de beneficiario
...
if (nr_seq_filtro_p IS NOT NULL AND nr_seq_filtro_p::text <> '') then
	...
	for r_c_filtro in c_filtro(nr_seq_filtro_p) loop
		...
		begin
			-- obtam a restriaao do beneficiario

			SELECT * FROM pls_ocor_imp_pck.obter_restricao_beneficiario(	r_c_filtro.nr_seq_segurado, r_c_filtro.cd_convenio, r_c_filtro.ie_local_cadastro, r_c_filtro.ie_tipo_segurado, r_c_filtro.cd_categoria, r_c_filtro.qt_idade_min, r_c_filtro.qt_idade_max, r_c_filtro.ie_sexo, r_c_filtro.ie_pcmso, r_c_filtro.ie_unid_tempo_idade, r_c_filtro.ie_titularidade, valor_bind_w, ds_tabelas_w) INTO STRICT _ora2pg_r;
