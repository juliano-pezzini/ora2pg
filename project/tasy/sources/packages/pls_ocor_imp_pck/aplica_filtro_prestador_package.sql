...
c_filtro CURSOR(	nr_seq_filtro_pc	pls_oc_cta_filtro.nr_sequencia%type,
			ie_tipo_prestador_pc	pls_oc_cta_filtro_prest.ie_tipo_prestador%type) FOR
...
if (nr_seq_filtro_p IS NOT NULL AND nr_seq_filtro_p::text <> '') then
	...
	for r_c_filtro in c_filtro(nr_seq_filtro_p, ie_tipo_prestador_p) loop
		...
		begin
			...
			-- obtam a restriaao do Prestador

			valor_bind_w := pls_ocor_imp_pck.obter_restricao_prestador(	ie_tipo_prestador_p, r_c_filtro.nr_seq_grupo_prestador, r_c_filtro.nr_seq_classificacao, r_c_filtro.nr_seq_prestador, r_c_filtro.cd_prestador, r_c_filtro.nr_seq_tipo_prestador, r_c_filtro.cd_especialidade_medica, r_c_filtro.ie_tipo_pesssoa_prest, valor_bind_w);
			
			-- Montar o select padrao juntamente as restriaaes.						

			valor_bind_w := pls_ocor_imp_pck.obter_select_filtro(	ie_considera_selecao_p, ie_incidencia_selecao_regra_p, ie_incidencia_selecao_filtro_p, ie_processo_excecao_p, nr_seq_ocorrencia_p, nr_id_transacao_p, nr_seq_filtro_p, nr_seq_lote_protocolo_p, nr_seq_protocolo_p, nr_seq_conta_p, nr_seq_conta_proc_p, nr_seq_conta_mat_p, dt_inicio_vigencia_p, dt_fim_vigencia_p, null, null, dados_restricao_w, null, null, dados_restricao_w, null, null, dados_restricao_w, cd_estabelecimento_p, valor_bind_w);
