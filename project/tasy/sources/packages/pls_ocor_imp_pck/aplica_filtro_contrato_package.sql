...
BEGIN
-- gerencia a aplicaaao do filtro de contrato
...
if (nr_seq_filtro_p IS NOT NULL AND nr_seq_filtro_p::text <> '') then
	...
	for r_c_filtro in c_filtro(nr_seq_filtro_p) loop
		...
		begin
			-- obtam a restriaao do contrato

			SELECT * FROM pls_ocor_imp_pck.obter_restricao_contrato(	r_c_filtro.nr_contrato, r_c_filtro.nr_seq_grupo_contrato, ds_tabelas_w, valor_bind_w) INTO STRICT _ora2pg_r;
