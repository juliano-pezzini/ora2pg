...
BEGIN
-- gerencia a aplicaaao do filtro de protocolo
...
if (nr_seq_filtro_p IS NOT NULL AND nr_seq_filtro_p::text <> '') then
	...
	for r_c_filtro in c_filtro(nr_seq_filtro_p) loop
		...
		begin
			-- obtam a restriaao do protocolo

			valor_bind_w := pls_ocor_imp_pck.obter_restricao_protocolo(r_c_filtro.cd_versao_tiss, valor_bind_w);
