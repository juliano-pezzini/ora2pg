...
BEGIN
-- gerencia a aplicaaao do filtro de produto
...
if (nr_seq_filtro_p IS NOT NULL AND nr_seq_filtro_p::text <> '') then
	...
	for r_c_filtro in c_filtro(nr_seq_filtro_p) loop
		...
		begin	
			...
			SELECT * FROM pls_ocor_imp_pck.obter_restricao_produto(	r_c_filtro.nr_seq_tipo_acomodacao, r_c_filtro.ie_preco, r_c_filtro.nr_seq_grupo_produto, r_c_filtro.nr_seq_plano, r_c_filtro.nr_seq_categoria, r_c_filtro.ie_regulamentacao, ds_tabelas_w, valor_bind_w) INTO STRICT _ora2pg_r;
