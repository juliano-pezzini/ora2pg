...
-- Desfazer dados de baixa do A530



CREATE OR REPLACE PROCEDURE ptu_aviso_pck.desfazer_dados_baixa_a530 ( nr_seq_arquivo_p ptu_aviso_arquivo.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_aviso_pck.desfazer_dados_baixa_a530 ( nr_seq_arquivo_p ptu_aviso_arquivo.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
