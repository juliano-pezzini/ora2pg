...
CREATE OR REPLACE PROCEDURE adep_onc_gerar_horarios_pck.adep_onc_obter_hor_proced ( nm_usuario_p text, nr_atendimento_p bigint, ie_exibir_suspensos_p text, ie_data_lib_proced_p text, ie_opcao_filtro_p text, dt_filtro_p timestamp, nr_ciclo_p bigint, dt_inicial_horario_p timestamp, dt_final_horario_p timestamp) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE adep_onc_gerar_horarios_pck.adep_onc_obter_hor_proced ( nm_usuario_p text, nr_atendimento_p bigint, ie_exibir_suspensos_p text, ie_data_lib_proced_p text, ie_opcao_filtro_p text, dt_filtro_p timestamp, nr_ciclo_p bigint, dt_inicial_horario_p timestamp, dt_final_horario_p timestamp) FROM PUBLIC;
