...
CREATE OR REPLACE PROCEDURE adep_onc_gerar_horarios_pck.gerar_flag_horarios (nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE adep_onc_gerar_horarios_pck.gerar_flag_horarios (nm_usuario_p text) FROM PUBLIC;
