...
CREATE OR REPLACE PROCEDURE pls_cta_proc_mat_regra_pck.gera_seq_tiss_proc ( nr_seq_conta_proc_regra_p pls_conta_proc_regra.nr_sequencia%type, nr_seq_conta_regra_vinc_p pls_conta_proc_regra.nr_sequencia%type, ie_vinculo_proc_mat_p text, nr_seq_conta_p pls_conta.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE

_ora2pg_r RECORD;
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:	Gera um novo sequencial tiss para o item em questao, caso o mesmo nao possuir
...
if (nr_seq_conta_proc_regra_p IS NOT NULL AND nr_seq_conta_proc_regra_p::text <> '') and (nr_seq_conta_p IS NOT NULL AND nr_seq_conta_p::text <> '') then
	
	-- carrega o maximo seq tiss do atendimento

	select (pls_cta_proc_mat_regra_pck.get_max_seq_tiss_atend(a.nr_sequencia, a.nr_seq_segurado))
...
union all
	...
	into STRICT	tb_nr_seq_conta_proc_regra_w(0),
	...
	and	c.nr_sequencia		= nr_seq_conta_proc_regra_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_cta_proc_mat_regra_pck.gera_seq_tiss_proc ( nr_seq_conta_proc_regra_p pls_conta_proc_regra.nr_sequencia%type, nr_seq_conta_regra_vinc_p pls_conta_proc_regra.nr_sequencia%type, ie_vinculo_proc_mat_p text, nr_seq_conta_p pls_conta.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
