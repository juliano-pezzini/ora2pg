...
/*Function que obtem o codigo da cop*/

CREATE OR REPLACE FUNCTION fis_sef_edoc_reg_lfpd05_pck.obter_cop ( cd_cfop_p text, ie_entrada_saida_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION fis_sef_edoc_reg_lfpd05_pck.obter_cop ( cd_cfop_p text, ie_entrada_saida_p text) FROM PUBLIC;
