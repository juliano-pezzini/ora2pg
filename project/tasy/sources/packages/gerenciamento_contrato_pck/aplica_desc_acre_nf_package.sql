...
SET client_encoding TO 'UTF8';
	...
	vl_liq_item_p = Valor liquido do item da nota fiscal
	*/
CREATE OR REPLACE FUNCTION gerenciamento_contrato_pck.aplica_desc_acre_nf ( nr_seq_nota_fiscal_p bigint, vl_liq_item_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION gerenciamento_contrato_pck.aplica_desc_acre_nf ( nr_seq_nota_fiscal_p bigint, vl_liq_item_p bigint) FROM PUBLIC;
