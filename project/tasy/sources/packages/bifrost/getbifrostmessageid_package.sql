...
CREATE OR REPLACE FUNCTION bifrost.getbifrostmessageid ( response utl_http.resp ) RETURNS varchar AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON FUNCTION bifrost.getbifrostmessageid ( response utl_http.resp ) FROM PUBLIC;
