...
CREATE OR REPLACE PROCEDURE ish_pat_case_pck.transfer_sending_response (( nr_sequencia_p bigint, ds_xml_p text) is nr_seq_doc_origem_w intpd_fila_transmissao.nr_seq_documento%type) RETURNS FROM AS $body$
DECLARE
 "urn",
		'http://schemas.xmlsoap.org/soap/envelope/' as "soapenv"),
	'soapenv:Envelope/soapenv:Body/urn:PatcaseAddtransferResponse' passing xml_w columns
...
from	xmltable(
		...
		'http://schemas.xmlsoap.org/soap/envelope/' as "soapenv"),
	'soapenv:Envelope/soapenv:Body/urn:PatcaseChangetransferResponse' passing xml_w columns
	newmovemntdata		xml	path	'NewMovemntData',
	return 			xml	path	'Return')
...
from	xmltable(
		...
		'urn:sap-com:document:sap:soap:functions:mc-style' as "urn",
		'http://schemas.xmlsoap.org/soap/envelope/' as "soapenv"),
	'soapenv:Envelope/soapenv:Body/urn:PatcaseCanceltransferResponse' passing xml_w columns
	newmovemntdata		xml	path	'NewMovemntData',
	return 			xml	path	'Return');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ish_pat_case_pck.transfer_sending_response (( nr_sequencia_p bigint, ds_xml_p text) is nr_seq_doc_origem_w intpd_fila_transmissao.nr_seq_documento%type) FROM PUBLIC;
