...
c_conta CURSOR(	nr_seq_segurado_pc	pls_selecao_ocor_cta.nr_seq_segurado%type,
		cd_guia_referencia_pc	pls_selecao_ocor_cta.cd_guia_referencia%type) FOR
...
c_proc CURSOR(	nr_seq_segurado_pc	pls_selecao_ocor_cta.nr_seq_segurado%type,
		cd_guia_referencia_pc	pls_selecao_ocor_cta.cd_guia_referencia%type) FOR
...
c_mat CURSOR(	nr_seq_segurado_pc	pls_selecao_ocor_cta.nr_seq_segurado%type,
		cd_guia_referencia_pc	pls_selecao_ocor_cta.cd_guia_referencia%type) FOR
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_tipos_ocor_pck.alimenta_selecao_excecao ( nr_id_transacao_p pls_selecao_ocor_cta.nr_id_transacao%type, dados_filtro_p pls_tipos_ocor_pck.dados_filtro, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nr_id_transacao_ex_p INOUT pls_selecao_ex_ocor_cta.nr_id_transacao%type) FROM PUBLIC;
