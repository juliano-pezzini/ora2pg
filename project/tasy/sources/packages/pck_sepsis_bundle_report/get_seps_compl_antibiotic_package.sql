...
SET client_encoding TO 'UTF8';
   ...
   -----------------------
CREATE OR REPLACE FUNCTION pck_sepsis_bundle_report.get_seps_compl_antibiotic (nr_atendimento_p gqa_protocolo_pac.nr_atendimento%type) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pck_sepsis_bundle_report.get_seps_compl_antibiotic (nr_atendimento_p gqa_protocolo_pac.nr_atendimento%type) FROM PUBLIC;
