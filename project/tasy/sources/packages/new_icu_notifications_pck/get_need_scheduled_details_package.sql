...
CREATE OR REPLACE FUNCTION new_icu_notifications_pck.get_need_scheduled_details (nm_usuario_p text) RETURNS SETOF T_ALERT_DETAILS_TABLE AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION new_icu_notifications_pck.get_need_scheduled_details (nm_usuario_p text) FROM PUBLIC;
