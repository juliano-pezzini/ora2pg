...
CREATE OR REPLACE FUNCTION new_icu_notifications_pck.get_cosign_items (nr_atendimento_p bigint, nm_usuario_p text) RETURNS bigint AS $body$
DECLARE
...
BEGIN
	...
	and     coalesce(ie_prescritor_aux, 'N') = 'N'
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION new_icu_notifications_pck.get_cosign_items (nr_atendimento_p bigint, nm_usuario_p text) FROM PUBLIC;
