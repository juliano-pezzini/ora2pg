...
CREATE OR REPLACE PROCEDURE pls_rec_glosa_emp_pck.grava_mat_recurso ( tb_nr_sequencia_p INOUT dbms_sql.number_table, tb_nr_seq_grg_guia_p INOUT dbms_sql.number_table, tb_nr_seq_guia_mat_p INOUT dbms_sql.number_table, tb_nr_seq_dma_procedimento_p INOUT dbms_sql.number_table, tb_nr_seq_material_p INOUT dbms_sql.number_table, tb_cd_material_imp_p INOUT dbms_sql.varchar2_table, tb_cd_tabela_imp_p INOUT dbms_sql.varchar2_table, tb_vl_cobrado_fat_p INOUT dbms_sql.number_table, tb_vl_glosado_p INOUT dbms_sql.number_table, tb_vl_recursado_p INOUT dbms_sql.number_table, tb_vl_acatado_p INOUT dbms_sql.number_table, tb_dt_realizacao_imp_p INOUT dbms_sql.date_table, nm_usuario_p usuario.nm_usuario%type, ie_commit_p text, ie_esvaziar_table_p text) AS $body$
DECLARE

/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:	Grava os materiais das guias conforme os protocolos do recurso
...
forall i in tb_nr_sequencia_p.first..tb_nr_sequencia_p.last
	insert into pls_grg_guia_mat(	nr_sequencia,
					dt_atualizacao,
					nm_usuario,
					dt_atualizacao_nrec,
					nm_usuario_nrec,
	...
	values (	tb_nr_sequencia_p(i),
			...
			tb_nr_seq_guia_mat_p(i),
			tb_nr_seq_dma_procedimento_p(i),
			tb_nr_seq_material_p(i),
			tb_cd_material_imp_p(i),
