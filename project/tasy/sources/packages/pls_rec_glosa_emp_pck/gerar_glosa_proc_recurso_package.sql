...
CREATE OR REPLACE PROCEDURE pls_rec_glosa_emp_pck.gerar_glosa_proc_recurso ( nr_seq_demost_analise_p pls_dma_demons_analise.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE

_ora2pg_r RECORD;
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:	Gera as glosas para os procedimentos 
...
tb_nr_seq_grg_proc_w		dbms_sql.number_table;
...
c01 CURSOR(	nr_seq_demost_analise_pc	pls_dma_demons_analise.nr_sequencia%type) FOR
	SELECT	nextval('pls_grg_guia_proc_glosa_seq') nr_sequencia,
		a.nr_sequencia nr_seq_grg_proc,
...
begin
	...
	exit when tb_nr_sequencia_w.count = 0;
		...
		SELECT * FROM pls_rec_glosa_emp_pck.grava_glosa_proc_recurso(	tb_nr_sequencia_w, tb_nr_seq_grg_proc_w, tb_nr_seq_motivo_glosa_w, tb_ds_justificativa_w, tb_nr_seq_dma_proc_glosa_w, nm_usuario_p, 'N', 'S') INTO STRICT _ora2pg_r;
 	tb_nr_sequencia_w := _ora2pg_r.tb_nr_sequencia_p; tb_nr_seq_grg_proc_w := _ora2pg_r.tb_nr_seq_grg_proc_p; tb_nr_seq_motivo_glosa_w := _ora2pg_r.tb_nr_seq_motivo_glosa_p; tb_ds_justificativa_w := _ora2pg_r.tb_ds_justificativa_p; tb_nr_seq_dma_proc_glosa_w := _ora2pg_r.tb_nr_seq_dma_proc_glosa_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_rec_glosa_emp_pck.gerar_glosa_proc_recurso ( nr_seq_demost_analise_p pls_dma_demons_analise.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
