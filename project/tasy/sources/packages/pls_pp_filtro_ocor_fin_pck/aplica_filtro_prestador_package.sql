...
CREATE OR REPLACE PROCEDURE pls_pp_filtro_ocor_fin_pck.aplica_filtro_prestador ( ie_considera_selecao_p INOUT boolean, qt_filtro_processado_p INOUT integer, nr_id_transacao_p pls_pp_rp_ofin_selecao.nr_id_transacao%type, ie_excecao_p pls_pp_rp_cta_filtro.ie_excecao%type, nr_seq_filtro_p pls_pp_rp_cta_filtro.nr_sequencia%type, cd_condicao_pagamento_p pls_pp_lote.cd_condicao_pagamento%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
