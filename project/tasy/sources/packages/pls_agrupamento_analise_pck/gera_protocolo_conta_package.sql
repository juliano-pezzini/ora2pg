...
BEGIN
-- variavel que controla se foi gerado um novo protocolo ou se foi retornado um que ja existia

ie_gerou_novo_p := 'N';

/* Se nao existir cria-se um novo protocolo */
...
SELECT	nr_seq_protocolo_w, nm_usuario_p, clock_timestamp(),
	...
	1, fim_mes(dt_mes_competencia), cd_estabelecimento_p,
	...
	(SELECT	max(nr_sequencia)
	 from    pls_outorgante
	 where   cd_estabelecimento = cd_estabelecimento_p), ie_guia_fisica, nr_seq_lote_conta_p,
	dt_recebimento, ie_origem_protocolo, ie_tipo_importacao,
	dt_integracao
