...
CREATE OR REPLACE PROCEDURE sup_gerar_planej_pck.atualizar_atributos_planej ( cd_empresa_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
BEGIN
	...
	EXIT WHEN NOT FOUND; /* apply on c01 */
		...
		EXIT WHEN NOT FOUND; /* apply on c02 */
			...
			vl_retorno_w := sup_gerar_planej_pck.gerar_valor_atrib_planej(
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE sup_gerar_planej_pck.atualizar_atributos_planej ( cd_empresa_p bigint, nm_usuario_p text) FROM PUBLIC;
