...
CREATE OR REPLACE PROCEDURE sup_gerar_planej_pck.gerar_atributos_padroes ( nm_usuario_p text) AS $body$
DECLARE
...
BEGIN
	...
	EXIT WHEN NOT FOUND; /* apply on c01 */
		...
		EXIT WHEN NOT FOUND; /* apply on c02 */
			...
			CALL CALL sup_gerar_planej_pck.gravar_valor_atrib_planej(
				nm_atributo_w,
				vl_atributo_w,
				cd_material_w,
				cd_estabelecimento_w,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE sup_gerar_planej_pck.gerar_atributos_padroes ( nm_usuario_p text) FROM PUBLIC;
