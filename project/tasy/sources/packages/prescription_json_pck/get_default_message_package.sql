...
CREATE OR REPLACE FUNCTION prescription_json_pck.get_default_message ( nr_prescricao_p bigint ) RETURNS PHILIPS_JSON AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION prescription_json_pck.get_default_message ( nr_prescricao_p bigint ) FROM PUBLIC;
