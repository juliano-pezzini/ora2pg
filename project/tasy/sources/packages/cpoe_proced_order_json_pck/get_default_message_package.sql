...
CREATE OR REPLACE FUNCTION cpoe_proced_order_json_pck.get_default_message ( nr_cpoe_proc_p bigint ) RETURNS PHILIPS_JSON AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION cpoe_proced_order_json_pck.get_default_message ( nr_cpoe_proc_p bigint ) FROM PUBLIC;
