...
if (dt_solicitacao_p IS NOT NULL AND dt_solicitacao_p::text <> '') then
	dt_solicitacao_w	:= to_date(dt_solicitacao_p, 'dd/mm/rrrr');
end if;

--Select utilizado para verificar se ja existe um pedido de autorizacao igual na base, se existir so retorna a sequencia da resposta do pedido
...
if (nr_seq_pedido_existe_w IS NOT NULL AND nr_seq_pedido_existe_w::text <> '') then
	...
	values (nextval('ptu_pedido_autorizacao_seq'), dt_atendimento_w, ie_tipo_cliente_w,
		...
		ie_liminar_p, cd_ibge_p, ie_rede_min_p,
		nr_protocolo_atendimento_p, ds_token_p,
		...
		ie_tipo_guia_p, ie_tipo_acomodacao_p, ie_cobertura_especial_p,
		ie_complementar_1_p, ie_complementar_2_p, ie_complementar_3_p,
		ie_tipo_etapa_autorizacao_p, dt_solicitacao_w, ie_saude_ocupacional_p) returning nr_sequencia into nr_seq_pedido_aut_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_imp_pck.ptu_imp_cab_00600_v70 ( dt_atendimento_p ptu_pedido_autorizacao.dt_atendimento%type, ie_tipo_cliente_p ptu_pedido_autorizacao.ie_tipo_cliente%type, cd_doenca_cid_p ptu_pedido_autorizacao.cd_doenca_cid%type, ie_rede_min_p ptu_pedido_autorizacao.ie_tipo_rede_min%type, ie_alto_custo_p ptu_pedido_autorizacao.ie_alto_custo%type, cd_unimed_prestador_req_p ptu_pedido_autorizacao.cd_unimed_prestador_req%type, nr_seq_prestador_req_p ptu_pedido_autorizacao.nr_seq_prestador_req%type, cd_especialidade_p ptu_pedido_autorizacao.cd_especialidade%type, ie_urg_emerg_p ptu_pedido_autorizacao.ie_urg_emerg%type, cd_unimed_executora_p ptu_pedido_autorizacao.cd_unimed_executora%type, cd_unimed_beneficiario_p ptu_pedido_autorizacao.cd_unimed_beneficiario%type, cd_unimed_p ptu_pedido_autorizacao.cd_unimed%type, nr_via_cartao_p ptu_pedido_autorizacao.nr_via_cartao%type, nr_seq_execucao_p ptu_pedido_autorizacao.nr_seq_execucao%type, cd_usuario_plano_p ptu_pedido_autorizacao.cd_usuario_plano%type, ds_biometria_p ptu_pedido_autorizacao.ds_biometria%type, cd_unimed_prestador_p ptu_pedido_autorizacao.cd_unimed_prestador%type, cd_transacao_p ptu_pedido_autorizacao.cd_transacao%type, nr_seq_prest_alto_custo_p ptu_pedido_autorizacao.nr_seq_prest_alto_custo%type, nm_prestador_alto_custo_p ptu_pedido_autorizacao.nm_prestador_alto_custo%type, cd_versao_p ptu_pedido_autorizacao.nr_versao%type, ie_recem_nascido_p ptu_pedido_autorizacao.ie_recem_nascido%type, ie_tipo_internacao_p ptu_pedido_autorizacao.ie_tipo_internacao%type, ie_tipo_acidente_p ptu_pedido_autorizacao.ie_tipo_acidente%type, nm_prof_solicitante_p ptu_pedido_autorizacao.nm_prof_solicitante%type, nr_fone_prof_solic_p ptu_pedido_autorizacao.nr_fone_prof_solic%type, ds_email_prof_solic_p ptu_pedido_autorizacao.ds_email_prof_solic%type, cd_unimed_atendimento_p ptu_pedido_autorizacao.cd_unimed_atendimento%type, ie_anexo_p ptu_pedido_autorizacao.ie_anexo%type, ie_sexo_p ptu_pedido_autorizacao.ie_sexo%type, nr_idade_p ptu_pedido_autorizacao.nr_idade%type, dt_sug_internacao_p ptu_pedido_autorizacao.dt_sug_internacao%type, ie_ordem_servico_p ptu_pedido_autorizacao.ie_ordem_servico%type, nr_seq_ordem_p ptu_pedido_autorizacao.nr_seq_ordem%type, cd_versao_tiss_p ptu_pedido_autorizacao.nr_versao_tiss%type, ds_observacao_p ptu_pedido_autorizacao.ds_observacao%type, ds_ind_clinica_p ptu_pedido_autorizacao.ds_ind_clinica%type, ie_liminar_p ptu_pedido_autorizacao.ie_liminar%type, cd_ibge_p ptu_pedido_autorizacao.cd_municipio_ibge%type, nr_protocolo_atendimento_p ptu_pedido_autorizacao.nr_protocolo_atendimento%type, ds_token_p ptu_pedido_autorizacao.ds_token%type, nm_prestador_solic_p ptu_pedido_autorizacao.nm_prestador%type, sg_conselho_prest_solic_p ptu_pedido_autorizacao.sg_conselho_profissional%type, nr_conselho_prest_solic_p ptu_pedido_autorizacao.nr_conselho_profissional%type, uf_conselho_prest_solic_p ptu_pedido_autorizacao.uf_conselho_profissional%type, cd_cbo_prest_solic_p ptu_pedido_autorizacao.cd_cbo_prest_solic%type, cd_cbo_prest_exec_p ptu_pedido_autorizacao.cd_cbo_prest_exec%type, ie_tipo_guia_p ptu_pedido_autorizacao.ie_tipo_guia%type, ie_tipo_acomodacao_p ptu_pedido_autorizacao.ie_tipo_acomodacao%type, ie_cobertura_especial_p ptu_pedido_autorizacao.ie_cobertura_especial%type, ie_complementar_1_p ptu_pedido_autorizacao.ie_complementar_1%type, ie_complementar_2_p ptu_pedido_autorizacao.ie_complementar_2%type, ie_complementar_3_p ptu_pedido_autorizacao.ie_complementar_3%type, ie_tipo_etapa_autorizacao_p ptu_pedido_autorizacao.ie_etapa_autorizacao%type, dt_solicitacao_p ptu_pedido_autorizacao.dt_solicitacao%type, nm_usuario_p usuario.nm_usuario%type, ie_saude_ocupacional_p ptu_pedido_autorizacao.ie_saude_ocupacional%type, nr_seq_pedido_aut_p INOUT ptu_pedido_autorizacao.nr_sequencia%type, ie_possui_registro_p INOUT ptu_pedido_autorizacao.ie_anexo%type) FROM PUBLIC;
