...
DECLARE
	...
	SELECT	a.nr_prescricao,
		...
		c.nr_sequencia,
		substr(obter_status_hor_proced_cig(c.dt_fim_horario,c.dt_suspensao,c.ie_dose_especial,c.dt_lib_horario),1,15),
		c.cd_procedimento,
		z.ds_valor_dominio,
		...
		c.dt_horario,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, x.nr_prescricao, x.nr_sequencia, 'CIG') ie_pintar
	...
	group by
		...
		x.ie_se_necessario,
		x.cd_intervalo,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, x.nr_prescricao, x.nr_sequencia, 'CIG'),
		x.qt_procedimento,
		x.ie_suspenso,
		c.dt_lib_horario
	order by
