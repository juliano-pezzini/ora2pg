...
DECLARE
	...
	SELECT	a.nr_prescricao,
		...
		c.dt_suspensao,
		c.dt_horario,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, x.nr_prescricao, x.nr_sequencia, 'IVC') ie_pintar
	from	procedimento y,
		proc_interno w,
	...
	group by
		...
		c.dt_suspensao,
		c.ie_dose_especial,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, x.nr_prescricao, x.nr_sequencia, 'IVC'),
		c.cd_procedimento,
		w.ds_proc_exame,
		y.ds_procedimento,
		c.nr_seq_proc_interno,
