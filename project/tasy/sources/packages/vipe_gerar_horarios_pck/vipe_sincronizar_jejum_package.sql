...
DECLARE
	...
	SELECT	a.nr_prescricao,
		...
		c.dt_inicio dt_horario,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, c.nr_prescricao, c.nr_sequencia, 'J') ie_pintar
	...
	and	c.dt_inicio between dt_horario_inicio_sinc_w and dt_horario_fim_sinc_w
	and	((ie_prescr_setor_p = 'N') or (ie_prescr_setor_p = 'S' AND a.cd_setor_atendimento = cd_setor_paciente_p))
	group by c.dt_inicio,
		a.nr_prescricao,
		c.dt_inicio,
		c.dt_fim,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, c.nr_prescricao, c.nr_sequencia, 'J'),
		x.ds_tipo
	order by dt_horario;
