...
DECLARE
	...
	SELECT	a.nr_prescricao,
		...
		c.dt_horario,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, x.nr_prescricao, x.nr_sequencia, 'MAT') ie_pintar
	from	material y,
		prescr_material x,
		prescr_mat_hor c,
		prescr_medica a
	...
	group by c.dt_horario,
		...
		c.dt_suspensao,
		c.cd_material,
		VIPE_obter_se_colore(a.ie_motivo_prescricao, x.nr_prescricao, x.nr_sequencia, 'MAT'),
		y.ds_material,
		x.ie_acm,
		x.ie_se_necessario,
		x.cd_intervalo,
