...
-- Gera para AMB 
CREATE OR REPLACE PROCEDURE ptu_gerar_tabela_a1200_pck.gerar_a1200_amb ( cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
-- Serviços do pacote		 
C02 CURSOR(	cd_edicao_amb_pc	edicao_amb.cd_edicao_amb%type, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_tabela_a1200_pck.gerar_a1200_amb ( cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
