...
CREATE OR REPLACE FUNCTION alto_custo_cancer_pck.get_if_quimio_intratecal (nr_atendimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION alto_custo_cancer_pck.get_if_quimio_intratecal (nr_atendimento_p bigint) FROM PUBLIC;
