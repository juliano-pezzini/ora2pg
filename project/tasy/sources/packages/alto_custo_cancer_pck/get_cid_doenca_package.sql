...
CREATE OR REPLACE FUNCTION alto_custo_cancer_pck.get_cid_doenca (nr_atendimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION alto_custo_cancer_pck.get_cid_doenca (nr_atendimento_p bigint) FROM PUBLIC;
