...
CREATE OR REPLACE FUNCTION alto_custo_cancer_pck.get_cd_procedimento (nr_atendimento_p text,cd_pessoa_fisica_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION alto_custo_cancer_pck.get_cd_procedimento (nr_atendimento_p text,cd_pessoa_fisica_p text) FROM PUBLIC;
