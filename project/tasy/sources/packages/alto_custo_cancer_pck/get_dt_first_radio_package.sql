...
CREATE OR REPLACE FUNCTION alto_custo_cancer_pck.get_dt_first_radio (cd_pessoa_fisica_p text) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION alto_custo_cancer_pck.get_dt_first_radio (cd_pessoa_fisica_p text) FROM PUBLIC;
