...
CREATE OR REPLACE FUNCTION alto_custo_cancer_pck.get_if_radioterapia (cd_pessoa_fisica_p text) RETURNS bigint AS $body$
DECLARE
...
BEGIN        
        ...
        and (get_treatment_status(rt.nr_sequencia) = 'TA' or 
                    get_treatment_status(rt.nr_sequencia) = 'TF')
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION alto_custo_cancer_pck.get_if_radioterapia (cd_pessoa_fisica_p text) FROM PUBLIC;
