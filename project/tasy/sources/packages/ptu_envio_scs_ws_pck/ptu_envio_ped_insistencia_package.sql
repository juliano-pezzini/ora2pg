...
if (nr_seq_guia_p IS NOT NULL AND nr_seq_guia_p::text <> '') then
	...
	CALL pls_guia_gravar_historico(nr_seq_guia_p,2,substr('Enviado o pedido de insistência para a Unimed '||cd_unimed_beneficiario_w||' com a mensagem: '||chr(10)||ds_mensagem_p,1,4000),'',nm_usuario_p);
	...
	CALL pls_requisicao_gravar_hist(nr_seq_requisicao_p,'L',substr('Enviado o pedido de insistência para a Unimed '||cd_unimed_beneficiario_w||' com a mensagem: '||chr(10)||ds_mensagem_p,1,4000),null,nm_usuario_p);
end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_envio_scs_ws_pck.ptu_envio_ped_insistencia ( nr_seq_requisicao_p ptu_pedido_autorizacao.nr_seq_requisicao%type, nr_seq_guia_p ptu_pedido_autorizacao.nr_seq_guia%type, ds_mensagem_p text, nr_versao_ptu_p ptu_pedido_insistencia.nr_versao%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_pedido_novo_p INOUT ptu_pedido_insistencia.nr_sequencia%type) FROM PUBLIC;
