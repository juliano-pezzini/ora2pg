...
-- Enviar Status da Transação 00360 - Status da Transação
CREATE OR REPLACE PROCEDURE ptu_envio_scs_ws_pck.ptu_envio_status_transacao ( nr_seq_guia_p ptu_pedido_autorizacao.nr_seq_guia%type, nr_seq_requisicao_p ptu_pedido_autorizacao.nr_seq_requisicao%type, nr_versao_ptu_p ptu_pedido_status.nr_versao%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_pedido_novo_p INOUT ptu_pedido_status.nr_sequencia%type) AS $body$
DECLARE
...
values (nextval('ptu_pedido_status_seq'), '00360', cd_unimed_beneficiario_w,
	 ...
	 nr_versao_ptu_p) returning nr_sequencia into nr_seq_pedido_novo_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_envio_scs_ws_pck.ptu_envio_status_transacao ( nr_seq_guia_p ptu_pedido_autorizacao.nr_seq_guia%type, nr_seq_requisicao_p ptu_pedido_autorizacao.nr_seq_requisicao%type, nr_versao_ptu_p ptu_pedido_status.nr_versao%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_pedido_novo_p INOUT ptu_pedido_status.nr_sequencia%type) FROM PUBLIC;
