...
CREATE OR REPLACE FUNCTION cpoe_diet_json_pck.get_default_message ( nr_cpoe_diet_p bigint ) RETURNS PHILIPS_JSON AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION cpoe_diet_json_pck.get_default_message ( nr_cpoe_diet_p bigint ) FROM PUBLIC;
