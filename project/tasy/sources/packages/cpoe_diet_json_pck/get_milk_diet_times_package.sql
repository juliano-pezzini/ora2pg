...
CREATE OR REPLACE FUNCTION cpoe_diet_json_pck.get_milk_diet_times (nr_cpoe_diet_p bigint) RETURNS PHILIPS_JSON_LIST AS $body$
DECLARE
...
BEGIN
	...
	for r_c01 in c01 loop
		...
		json_item_w := cpoe_diet_json_pck.add_json_value(json_item_w, 'cdUnidMedProd1', r_c01.cd_unid_med_prod1);
		...
		if (r_c01.qt_dose_prod_adic1 IS NOT NULL AND r_c01.qt_dose_prod_adic1::text <> '') then
			json_component_item_w		:= philips_json();
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'componentType', 'A');
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeValue', r_c01.item_adic1_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'descMaterial', r_c01.desc_item_adic1);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeSystem', r_c01.item_adic1_code_system);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'qtDose', r_c01.qt_dose_prod_adic1);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeValue', r_c01.item_adic1_unid_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaText', r_c01.item_adic1_unid_text);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeSystem', r_c01.item_adic1_unid_code_system);
			json_component_item_list_w.append(json_component_item_w.to_json_value());
		end if;
		
		-- adicional 2
		if (r_c01.qt_dose_prod_adic2 IS NOT NULL AND r_c01.qt_dose_prod_adic2::text <> '') then
			json_component_item_w		:= philips_json();
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'componentType', 'A');
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeValue', r_c01.item_adic2_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'descMaterial', r_c01.desc_item_adic2);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeSystem', r_c01.item_adic2_code_system);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'qtDose', r_c01.qt_dose_prod_adic2);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeValue', r_c01.item_adic2_unid__code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaText', r_c01.item_adic2_unid_text);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeSystem', r_c01.item_adic2_unid_code_system);
			json_component_item_list_w.append(json_component_item_w.to_json_value());
		end if;
		
		-- adicional 3
		if (r_c01.qt_dose_prod_adic3 IS NOT NULL AND r_c01.qt_dose_prod_adic3::text <> '') then
			json_component_item_w		:= philips_json();
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'componentType', 'A');
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeValue', r_c01.item_adic3_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'descMaterial', r_c01.desc_item_adic3);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeSystem', r_c01.item_adic3_code_system);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'qtDose', r_c01.qt_dose_prod_adic3);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeValue', r_c01.item_adic3_unid_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaText', r_c01.item_adic3_unid_text);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeSystem', r_c01.item_adic3_unid_code_system);
			json_component_item_list_w.append(json_component_item_w.to_json_value());
		end if;
		
		-- adicional 4
		if (r_c01.qt_dose_prod_adic4 IS NOT NULL AND r_c01.qt_dose_prod_adic4::text <> '') then
			json_component_item_w		:= philips_json();
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'componentType', 'A');
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeValue', r_c01.item_adic4_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'descMaterial', r_c01.desc_item_adic4);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'codeSystem', r_c01.item_adic4_code_system);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'qtDose', r_c01.qt_dose_prod_adic4);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeValue', r_c01.item_adic4_unid_code_value);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaText', r_c01.item_adic4_unid_text);
			json_component_item_w := cpoe_diet_json_pck.add_json_value(json_component_item_w, 'unidadeMedidaCodeSystem', r_c01.item_adic4_unid_code_system);
			json_component_item_list_w.append(json_component_item_w.to_json_value());
		end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION cpoe_diet_json_pck.get_milk_diet_times (nr_cpoe_diet_p bigint) FROM PUBLIC;
