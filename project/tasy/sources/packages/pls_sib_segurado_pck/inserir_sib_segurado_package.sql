...
CREATE OR REPLACE PROCEDURE pls_sib_segurado_pck.inserir_sib_segurado ( nr_seq_movimento_p pls_sib_movimento.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_sib_segurado_pck.inserir_sib_segurado ( nr_seq_movimento_p pls_sib_movimento.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
