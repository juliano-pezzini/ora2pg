...
CREATE OR REPLACE PROCEDURE pfcs_pck_admission_prioritizer.pfcs_pa_calc_occupancy_census (cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
        ...
        qt_census_pa_triaged_w      numeric(20)  := 0; --> Total of patients in emergency department that have started triaged
...
;
            ...
            */
            pfcs_pck.pfcs_generate_results(
                ...
                vl_indicator_collab_p => qt_blocked_unit_w - qt_virtual_encounters_w,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_pck_admission_prioritizer.pfcs_pa_calc_occupancy_census (cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
