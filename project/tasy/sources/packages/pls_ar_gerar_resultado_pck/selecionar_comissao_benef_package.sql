...
-- SELECIONAR_COMISSAO_BENEF



CREATE OR REPLACE PROCEDURE pls_ar_gerar_resultado_pck.selecionar_comissao_benef ( nr_seq_lote_p pls_ar_lote.nr_sequencia%type, dt_inicio_p pls_ar_lote.dt_inicio%type, dt_fim_p pls_ar_lote.dt_fim%type, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) AS $body$
BEGIN
	begin
		...
		FROM (	select	sum(vl_comissao_benef) vl_repasse,
				c.nr_seq_segurado,
				c.nr_sequencia nr_seq_comissao_benef,
				d.nr_seq_plano,
				a.dt_referencia
