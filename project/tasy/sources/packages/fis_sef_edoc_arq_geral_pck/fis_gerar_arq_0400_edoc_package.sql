...
CREATE OR REPLACE PROCEDURE fis_sef_edoc_arq_geral_pck.fis_gerar_arq_0400_edoc () AS $body$
DECLARE
...
type reg_c_reg_0400 is table of fis_sef_edoc_0400%RowType;
...
fetch c_reg_0400 bulk collect	into vetReg0400 limit 1000;
	...
	PERFORM set_config('fis_sef_edoc_arq_geral_pck.ds_linha_w', substr(current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0400[i].cd_reg 	|| --01
			current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0400[i].cd_nat 	|| --02
			current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0400[i].ds_nat 	|| --03
			current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0400[i].cd_cop 	|| --04
	...
	current_setting('fis_sef_edoc_arq_geral_pck.fis_registros_w')::registro(current_setting('fis_sef_edoc_arq_geral_pck.qt_cursor_w')::bigint).cd_registro 		:= vetReg0400[i].cd_reg;

	if (current_setting('fis_sef_edoc_arq_geral_pck.nr_vetor_w')::bigint >= 1000) then
	begin
		--Inserindo registros definitivamente na tabela especifica - FIS_EFD_ICMSIPI_0400
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fis_sef_edoc_arq_geral_pck.fis_gerar_arq_0400_edoc () FROM PUBLIC;
