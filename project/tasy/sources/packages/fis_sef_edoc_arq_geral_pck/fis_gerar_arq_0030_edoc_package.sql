...
CREATE OR REPLACE PROCEDURE fis_sef_edoc_arq_geral_pck.fis_gerar_arq_0030_edoc () AS $body$
DECLARE


-- c_reg_0030
c_reg_0030 CURSOR FOR
SELECT 	*
from 	fis_sef_edoc_0030
where 	nr_seq_controle = current_setting('fis_sef_edoc_arq_geral_pck.nr_seq_controle_w')::bigint;

--Criação do array com o tipo sendo do cursor eespecificado - c_reg_0030
type reg_c_reg_0030 is table of fis_sef_edoc_0030%RowType;
vetReg0030 reg_c_reg_0030;
...
open c_reg_0030;
loop
fetch c_reg_0030 bulk collect	into vetReg0030 limit 1000;
	for i in 1 .. vetReg0030.Count loop
	begin
	...
	PERFORM set_config('fis_sef_edoc_arq_geral_pck.ds_linha_w', substr(current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_reg 		|| --01
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_ed 		|| --02
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_arq 		|| --03
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_iss 		|| --04
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_icms 		|| --05
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_ridf 		|| --06
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_rudf 		|| --07
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_lmc 		|| --08
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_rv 		|| --09
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_prf_ri 		|| --10
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_ec 		|| --11
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_iss 		|| --12
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_rt 		|| --13
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_icms 		|| --14
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_st 		|| --15
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_at 		|| --16
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_ipi 		|| --17
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0030[i].cd_ind_ri 		|| --18
	...
	current_setting('fis_sef_edoc_arq_geral_pck.fis_registros_w')::registro(current_setting('fis_sef_edoc_arq_geral_pck.qt_cursor_w')::bigint).cd_registro 		:= vetReg0030[i].cd_reg;

	if (current_setting('fis_sef_edoc_arq_geral_pck.nr_vetor_w')::bigint >= 1000) then
	begin
		--Inserindo registros definitivamente na tabela especifica - FIS_EFD_ICMSIPI_0030
...
EXIT WHEN NOT FOUND; /* apply on c_reg_0030 */
end loop;
close c_reg_0030;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fis_sef_edoc_arq_geral_pck.fis_gerar_arq_0030_edoc () FROM PUBLIC;
