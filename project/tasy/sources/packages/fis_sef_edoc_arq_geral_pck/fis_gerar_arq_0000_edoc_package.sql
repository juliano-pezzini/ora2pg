...
CREATE OR REPLACE PROCEDURE fis_sef_edoc_arq_geral_pck.fis_gerar_arq_0000_edoc () AS $body$
DECLARE


-- c_reg_0000
c_reg_0000 CURSOR FOR
SELECT 	*
from 	fis_sef_edoc_0000
where 	nr_seq_controle = current_setting('fis_sef_edoc_arq_geral_pck.nr_seq_controle_w')::bigint;

--Criação do array com o tipo sendo do cursor eespecificado - c_reg_0000
type reg_c_reg_0000 is table of fis_sef_edoc_0000%RowType;
vetReg0000 reg_c_reg_0000;
...
open c_reg_0000;
loop
fetch c_reg_0000 bulk collect into vetReg0000 limit 1000;
	for i in 1 .. vetReg0000.Count loop
	begin
	...
	PERFORM set_config('fis_sef_edoc_arq_geral_pck.ds_linha_w', substr(current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_reg			|| --01
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].ds_lfpd 			|| --02
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || to_char(vetReg0000[i].dt_ini,'ddmmyyyy') 	|| --03
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || to_char(vetReg0000[i].dt_fin,'ddmmyyyy') 	|| --04
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].ds_nome 			|| --05
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_cnpj 			|| --06
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].sg_uf 				|| --07
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].nr_ie 				|| --08
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_mun 			|| --09
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].ds_im 				|| --10
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || --11 Vazio1
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].ds_suframa 			|| --12
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_ver 			|| --13
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_fin 			|| --14
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_ctd 			|| --15
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].ds_pais 			|| --16
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].ds_fantasia 			|| --17
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].nr_nire 			|| --18
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || vetReg0000[i].cd_cpf 			|| --19
		       current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1) || current_setting('fis_sef_edoc_arq_geral_pck.ds_sep_w')::varchar(1), 					   --20 vazio2
		       1,
		       8000), false);
	...
	current_setting('fis_sef_edoc_arq_geral_pck.fis_registros_w')::registro(current_setting('fis_sef_edoc_arq_geral_pck.qt_cursor_w')::bigint).cd_registro 		:= vetReg0000[i].cd_reg;

	if (current_setting('fis_sef_edoc_arq_geral_pck.nr_vetor_w')::bigint >= 1000) then
	begin
		--Inserindo registros definitivamente na tabela especifica - FIS_EFD_ICMSIPI_0000
...
EXIT WHEN NOT FOUND; /* apply on c_reg_0000 */
end loop;
close c_reg_0000;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fis_sef_edoc_arq_geral_pck.fis_gerar_arq_0000_edoc () FROM PUBLIC;
