...
CREATE OR REPLACE FUNCTION pls_filtro_regra_event_rgl_pck.obter_restricao_reg_selecao ( ie_considera_selecao_p boolean, ie_tipo_regra_p pls_pp_cta_combinada.ie_tipo_regra%type, nr_id_transacao_p pls_pp_cta_rec_selecao.nr_id_transacao%type, ie_excecao_p pls_pp_cta_filtro.ie_excecao%type, nr_seq_filtro_p pls_pp_cta_filtro.nr_sequencia%type, ds_campo_p out text, ds_tabela_p out text, valor_bind_p INOUT sql_pck.t_dado_bind) AS $body$
DECLARE
...
ds_alias_sel_w := pls_filtro_regra_event_rgl_pck.obter_alias_tabela('selecao');
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pls_filtro_regra_event_rgl_pck.obter_restricao_reg_selecao ( ie_considera_selecao_p boolean, ie_tipo_regra_p pls_pp_cta_combinada.ie_tipo_regra%type, nr_id_transacao_p pls_pp_cta_rec_selecao.nr_id_transacao%type, ie_excecao_p pls_pp_cta_filtro.ie_excecao%type, nr_seq_filtro_p pls_pp_cta_filtro.nr_sequencia%type, ds_campo_p out text, ds_tabela_p out text, valor_bind_p INOUT sql_pck.t_dado_bind) FROM PUBLIC;
