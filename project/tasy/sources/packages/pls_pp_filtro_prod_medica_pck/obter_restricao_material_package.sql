...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pls_pp_filtro_prod_medica_pck.obter_restricao_material ( nr_seq_material_p pls_pp_rp_filtro_mat.nr_seq_material%type, nr_seq_estrut_mat_p pls_pp_rp_filtro_mat.nr_seq_estrut_mat%type, ie_tipo_despesa_mat_p pls_pp_rp_filtro_mat.ie_tipo_despesa_mat%type, nr_seq_regra_filtro_p pls_pp_cta_combinada.nr_sequencia%type, ds_campos_p out text, ds_tabela_p out text, valor_bind_p INOUT sql_pck.t_dado_bind) FROM PUBLIC;
