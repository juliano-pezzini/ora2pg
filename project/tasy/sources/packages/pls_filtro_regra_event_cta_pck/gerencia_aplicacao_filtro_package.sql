...
for r_c_conf_filtro_w in c_conf_filtro(nr_seq_regra_filtro_p) loop
	...
	CALL CALL CALL CALL CALL pls_filtro_regra_event_cta_pck.prepara_reg_proces_filtro(nr_id_transacao_p, r_c_conf_filtro_w.ie_excecao);
	...
	if (r_c_conf_filtro_w.ie_filtro_conta = 'S') then
		SELECT * FROM pls_filtro_regra_event_cta_pck.aplica_filtro_conta(	ie_considera_tab_selecao_w, qt_filtro_processado_w, ie_tipo_regra_p, nr_id_transacao_p, r_c_conf_filtro_w.ie_excecao, r_c_conf_filtro_w.nr_seq_filtro, dt_inicio_vigencia_p, dt_fim_vigencia_p, nr_seq_conta_p, nr_seq_analise_p, cd_estabelecimento_p, nm_usuario_p) INTO STRICT 	ie_considera_tab_selecao_w, qt_filtro_processado_w;
	...
	if (r_c_conf_filtro_w.ie_filtro_beneficiario = 'S') then
		SELECT * FROM pls_filtro_regra_event_cta_pck.aplica_filtro_beneficiario(	ie_considera_tab_selecao_w, qt_filtro_processado_w, ie_tipo_regra_p, nr_id_transacao_p, r_c_conf_filtro_w.ie_excecao, r_c_conf_filtro_w.nr_seq_filtro, dt_inicio_vigencia_p, dt_fim_vigencia_p, nr_seq_conta_p, nr_seq_analise_p, cd_estabelecimento_p, nm_usuario_p) INTO STRICT 	ie_considera_tab_selecao_w, qt_filtro_processado_w;
	...
	if (r_c_conf_filtro_w.ie_filtro_prestador = 'S') then
		SELECT * FROM pls_filtro_regra_event_cta_pck.aplica_filtro_prestador(	ie_considera_tab_selecao_w, qt_filtro_processado_w, ie_tipo_regra_p, nr_id_transacao_p, r_c_conf_filtro_w.ie_excecao, r_c_conf_filtro_w.nr_seq_filtro, dt_inicio_vigencia_p, dt_fim_vigencia_p, nr_seq_conta_p, nr_seq_analise_p, cd_estabelecimento_p, nm_usuario_p) INTO STRICT 	ie_considera_tab_selecao_w, qt_filtro_processado_w;
	...
	if (r_c_conf_filtro_w.ie_filtro_procedimento = 'S') then
		SELECT * FROM pls_filtro_regra_event_cta_pck.aplica_filtro_procedimento(	ie_considera_tab_selecao_w, qt_filtro_processado_w, 'P', nr_id_transacao_p, r_c_conf_filtro_w.ie_excecao, r_c_conf_filtro_w.nr_seq_filtro, dt_inicio_vigencia_p, dt_fim_vigencia_p, nr_seq_conta_p, nr_seq_analise_p, cd_estabelecimento_p, nm_usuario_p) INTO STRICT 	ie_considera_tab_selecao_w, qt_filtro_processado_w;
	...
	if (r_c_conf_filtro_w.ie_filtro_material = 'S') then
		SELECT * FROM pls_filtro_regra_event_cta_pck.aplica_filtro_material(	ie_considera_tab_selecao_w, qt_filtro_processado_w, 'M', nr_id_transacao_p, r_c_conf_filtro_w.ie_excecao, r_c_conf_filtro_w.nr_seq_filtro, dt_inicio_vigencia_p, dt_fim_vigencia_p, nr_seq_conta_p, nr_seq_analise_p, cd_estabelecimento_p, nm_usuario_p) INTO STRICT 	ie_considera_tab_selecao_w, qt_filtro_processado_w;
	...
	CALL CALL CALL CALL CALL pls_filtro_regra_event_cta_pck.atualiza_sel_excecao_end(nr_id_transacao_p, ie_processou_filtro_w, r_c_conf_filtro_w.ie_excecao);
end loop;
...
CALL CALL CALL CALL CALL CALL pls_filtro_regra_event_cta_pck.limpar_invalidos(nr_id_transacao_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_filtro_regra_event_cta_pck.gerencia_aplicacao_filtro ( nr_seq_regra_filtro_p pls_pp_cta_combinada.nr_sequencia%type, ie_tipo_regra_p pls_pp_cta_combinada.ie_tipo_regra%type, dt_inicio_vigencia_p pls_pp_cta_combinada.dt_inicio_vigencia%type, dt_fim_vigencia_p pls_pp_cta_combinada.dt_fim_vigencia%type, nr_id_transacao_p pls_pp_cta_selecao.nr_id_transacao%type, nr_seq_analise_p pls_analise_conta.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
