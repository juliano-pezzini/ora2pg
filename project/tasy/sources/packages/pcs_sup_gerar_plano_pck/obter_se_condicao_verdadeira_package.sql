...
CREATE OR REPLACE PROCEDURE pcs_sup_gerar_plano_pck.obter_se_condicao_verdadeira ( ds_condicao_p text, cd_material_p bigint, --ie_simular_p			varchar2,
 ie_retorno_p INOUT text, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pcs_sup_gerar_plano_pck.obter_se_condicao_verdadeira ( ds_condicao_p text, cd_material_p bigint,  ie_retorno_p INOUT text, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
