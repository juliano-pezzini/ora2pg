...
CREATE OR REPLACE PROCEDURE pls_gerencia_envio_ans_pck.del_conta_alte_sem_envio ( nr_seq_lote_p pls_monitor_tiss_lote.nr_sequencia%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerencia_envio_ans_pck.del_conta_alte_sem_envio ( nr_seq_lote_p pls_monitor_tiss_lote.nr_sequencia%type) FROM PUBLIC;
