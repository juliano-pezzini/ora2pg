...
CREATE OR REPLACE PROCEDURE pls_gerencia_envio_ans_pck.atualizar_monit_tiss_proc_rec ( dados_proc_update_p pls_gerencia_envio_ans_pck.dados_monitor_proc_update, nm_usuario_p usuario.nm_usuario%type) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerencia_envio_ans_pck.atualizar_monit_tiss_proc_rec ( dados_proc_update_p pls_gerencia_envio_ans_pck.dados_monitor_proc_update, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
