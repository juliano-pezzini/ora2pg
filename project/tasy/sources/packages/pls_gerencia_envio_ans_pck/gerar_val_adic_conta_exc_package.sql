...
CREATE OR REPLACE PROCEDURE pls_gerencia_envio_ans_pck.gerar_val_adic_conta_exc ( nr_seq_lote_p pls_monitor_tiss_lote.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
C01 CURSOR(nr_seq_lote_pc	pls_monitor_tiss_lote.nr_sequencia%type) FOR
	SELECT	b.cd_cbo_executante, b.cd_cnes_prest_exec, b.cd_cpf_cgc_prest_exec,
		...
		b.nr_cartao_nac_sus, b.nr_diarias_acompanhante, b.nr_diarias_uti,
		...
		b.nr_registro_operadora_inter, b.nr_cpf_benef, b.ie_regime_atendimento,
...
loop
	...
	fetch C01 bulk collect into 	tb_cd_cbo_executante_w, tb_cd_cnes_prest_exec_w, tb_cd_cpf_cgc_prest_exec_w,
					...
					tb_nr_registro_oper_inter_w, tb_nr_cpf_benef_w, tb_ie_regime_atendimento_w,
					tb_ie_saude_ocupacional, tb_ie_cobertura_especial_w, tb_cd_modelo_remuneracao_w
	...
	forall i in tb_nr_seq_cta_val_w.first .. tb_nr_seq_cta_val_w.last
		...
		set	cd_cbo_executante		= tb_cd_cbo_executante_w(i),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerencia_envio_ans_pck.gerar_val_adic_conta_exc ( nr_seq_lote_p pls_monitor_tiss_lote.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
