...
-- limpa os registros da tabela pls_monitor_tiss_alt_guia



CREATE OR REPLACE PROCEDURE pls_gerencia_envio_ans_pck.del_pls_monitor_tiss_alt_guia ( nr_seq_lote_p pls_monitor_tiss_lote.nr_sequencia%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerencia_envio_ans_pck.del_pls_monitor_tiss_alt_guia ( nr_seq_lote_p pls_monitor_tiss_lote.nr_sequencia%type) FROM PUBLIC;
