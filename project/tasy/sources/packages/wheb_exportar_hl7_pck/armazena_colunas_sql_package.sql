...
CREATE OR REPLACE PROCEDURE wheb_exportar_hl7_pck.armazena_colunas_sql (cursor_p integer, ar_resultado_p INOUT myArray) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE wheb_exportar_hl7_pck.armazena_colunas_sql (cursor_p integer, ar_resultado_p INOUT myArray) FROM PUBLIC;
