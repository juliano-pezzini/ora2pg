...
CREATE OR REPLACE PROCEDURE pck_glucose_control.get_data (dt_inicio_p timestamp, dt_fim_p timestamp, cd_unidade_p text, nr_relatorio_p bigint) AS $body$
DECLARE
      ...
      c1 CURSOR FOR
         SELECT mes_ano,
          ...
          group by mes_ano, dt_controle;
      r1 c1%rowtype;

BEGIN
      --Limpa tabela W
      delete FROM w_rep_glucose_control 
      ...
      loop
         ...
         insert into w_rep_glucose_control(nm_usuario,
             dt_atualizacao,
             nr_relatorio,
             nr_mes_ano,
             dt_controle,
      ...
      CALL pck_glucose_control.get_data_graph(dt_inicio_p,
                     dt_fim_p,
                     cd_unidade_p,
                     nr_relatorio_p);
      --
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pck_glucose_control.get_data (dt_inicio_p timestamp, dt_fim_p timestamp, cd_unidade_p text, nr_relatorio_p bigint) FROM PUBLIC;
