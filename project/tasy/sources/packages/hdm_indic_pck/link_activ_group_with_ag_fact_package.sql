...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_activ_group_with_ag_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_group_act_ag y
		...
		using(	SELECT	0 nr_seq_dimension,
			...
			where	not exists (select	1
						from	hdm_indic_ft_group_act_ag a
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_activ_group_with_ag_fact () FROM PUBLIC;
