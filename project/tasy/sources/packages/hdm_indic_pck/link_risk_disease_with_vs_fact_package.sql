...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_risk_disease_with_vs_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_vital_sign_rd y
		...
		using(	SELECT	0 nr_seq_dimension,
			...
			where	not exists (select	1
						from	hdm_indic_ft_vital_sign_rd a
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_risk_disease_with_vs_fact () FROM PUBLIC;
