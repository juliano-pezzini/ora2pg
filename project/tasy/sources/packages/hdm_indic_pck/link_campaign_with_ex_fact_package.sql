...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_campaign_with_ex_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_exam_cp y
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_campaign_with_ex_fact () FROM PUBLIC;
