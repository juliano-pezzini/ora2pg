...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_cont_group_whit_co_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_cost_cg y
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_cont_group_whit_co_fact () FROM PUBLIC;
