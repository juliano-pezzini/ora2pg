...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_professional_whit_ep_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_episode_pf y
		...
		using(	SELECT	0 nr_seq_dimension,
			...
			where	not exists (select	1
						from	hdm_indic_ft_episode_pf a
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_professional_whit_ep_fact () FROM PUBLIC;
