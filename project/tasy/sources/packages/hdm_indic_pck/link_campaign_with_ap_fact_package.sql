...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_campaign_with_ap_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_appoint_cp y
		...
		using(	SELECT	0 nr_seq_dimension,
			...
			where	not exists (select	1
						from	hdm_indic_ft_appoint_cp a
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_campaign_with_ap_fact () FROM PUBLIC;
