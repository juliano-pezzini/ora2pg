...
CREATE OR REPLACE PROCEDURE hdm_indic_pck.link_cont_group_whit_pr_fact () AS $body$
BEGIN
		merge into hdm_indic_ft_procedure_cg y
		...
		using(	SELECT	0 nr_seq_dimension,
			...
			where	not exists (select	1
						from	hdm_indic_ft_procedure_cg a
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hdm_indic_pck.link_cont_group_whit_pr_fact () FROM PUBLIC;
