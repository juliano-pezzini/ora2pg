...
CREATE OR REPLACE PROCEDURE pls_conv_xml_cta_pck.alimenta_campo_reg_imp_mat () AS $body$
DECLARE
...
loop
	...
	forall i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last 
		update	pls_regra_importacao_mat
		set	ie_situacao = 'A'
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_conv_xml_cta_pck.alimenta_campo_reg_imp_mat () FROM PUBLIC;
