...
CREATE OR REPLACE PROCEDURE pls_conv_xml_cta_pck.alimenta_campo_tuss_conversao () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_conv_xml_cta_pck.alimenta_campo_tuss_conversao () FROM PUBLIC;
