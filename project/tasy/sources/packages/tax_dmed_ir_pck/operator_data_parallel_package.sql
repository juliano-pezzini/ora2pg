...
CREATE OR REPLACE PROCEDURE tax_dmed_ir_pck.operator_data_parallel (job_code_p bigint, batch_monthly_sequence_p tax_dmed_lote_mensal.nr_sequencia%type, queue_sequence_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE tax_dmed_ir_pck.operator_data_parallel (job_code_p bigint, batch_monthly_sequence_p tax_dmed_lote_mensal.nr_sequencia%type, queue_sequence_p bigint) FROM PUBLIC;
