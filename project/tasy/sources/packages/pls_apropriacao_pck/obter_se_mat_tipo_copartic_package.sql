...
CREATE OR REPLACE FUNCTION pls_apropriacao_pck.obter_se_mat_tipo_copartic ( nr_seq_tipo_coparticipacao_p pls_tipo_coparticipacao.nr_sequencia%type, nr_seq_material_p pls_material.nr_sequencia%type) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pls_apropriacao_pck.obter_se_mat_tipo_copartic ( nr_seq_tipo_coparticipacao_p pls_tipo_coparticipacao.nr_sequencia%type, nr_seq_material_p pls_material.nr_sequencia%type) FROM PUBLIC;
