...
SET client_encoding TO 'UTF8';
   ...
   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	message type:- 3G -> Patient change information 
	This message contains a common header and order information respective to patient.
	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   **/
CREATE OR REPLACE PROCEDURE carestream_ris_japan_l10n_pck.patient_change_info ( unique_key_p bigint, nm_usuario_p text, log_sequence_number_p text, file_name_p text, cd_establishment_p bigint, ie_retransmit_p text ) AS $body$
BEGIN
        PERFORM set_config('carestream_ris_japan_l10n_pck.message_type_w', '3G', false);
        ...
        PERFORM set_config('carestream_ris_japan_l10n_pck.ds_message_w', 'Patient Change Information', false);
        PERFORM set_config('carestream_ris_japan_l10n_pck.interface_event_w', 933, false);
        ...
        from (SELECT Obter_Prontuario_Paciente(unique_key_p ) patient_mrn
                ) m;
...
;
        ...
        begin
            ...
            current_setting('carestream_ris_japan_l10n_pck.ds_local_w')::varchar(32767) := carestream_japan_l10n_pck.patient_infection_info(current_setting('carestream_ris_japan_l10n_pck.encounter_id_w')::varchar(10), current_setting('carestream_ris_japan_l10n_pck.ds_local_w')::varchar(32767));
            CALL CALL carestream_ris_japan_l10n_pck.append_message(current_setting('carestream_ris_japan_l10n_pck.ds_local_w')::varchar(32767));
        exception
            when others then
...
;
        ...
        PERFORM set_config('carestream_ris_japan_l10n_pck.ds_script_w', 'carestream_ris_japan_l10n_pck.patient_change_info ('
                       || unique_key_p
                       || ', '''
                       || ':nm_exec_user' 
                       || ''' , '
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE carestream_ris_japan_l10n_pck.patient_change_info ( unique_key_p bigint, nm_usuario_p text, log_sequence_number_p text, file_name_p text, cd_establishment_p bigint, ie_retransmit_p text ) FROM PUBLIC;
