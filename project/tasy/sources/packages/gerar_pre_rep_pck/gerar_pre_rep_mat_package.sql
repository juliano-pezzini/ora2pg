...
CREATE OR REPLACE PROCEDURE gerar_pre_rep_pck.gerar_pre_rep_mat ( nr_atendimento_p bigint, nr_prescricao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pre_rep_pck.gerar_pre_rep_mat ( nr_atendimento_p bigint, nr_prescricao_p bigint, nm_usuario_p text) FROM PUBLIC;
