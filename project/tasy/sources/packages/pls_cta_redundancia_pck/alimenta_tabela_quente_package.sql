...
CREATE OR REPLACE PROCEDURE pls_cta_redundancia_pck.alimenta_tabela_quente ( nr_seq_lote_conta_p pls_protocolo_conta.nr_seq_lote%type, nr_seq_protocolo_p pls_protocolo_conta.nr_sequencia%type, nr_seq_lote_processo_p pls_cta_lote_processo.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, nr_seq_analise_p pls_analise_conta.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
BEGIN
...
if (nr_seq_lote_conta_p IS NOT NULL AND nr_seq_lote_conta_p::text <> '') then
	...
	using(	SELECT	proc.cd_guia_referencia,
				partic.cd_medico cd_medico_executor,
				proc.cd_medico_solicitante,
				...
				proc.nr_seq_prestador_prot nr_seq_prestador_atend,
...
union all
			...
			SELECT	proc.cd_guia_referencia,
				proc.cd_medico_executor,
				proc.cd_medico_solicitante,
				proc.cd_procedimento,
				proc.dt_procedimento,
				proc.ie_origem_proced,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_cta_redundancia_pck.alimenta_tabela_quente ( nr_seq_lote_conta_p pls_protocolo_conta.nr_seq_lote%type, nr_seq_protocolo_p pls_protocolo_conta.nr_sequencia%type, nr_seq_lote_processo_p pls_cta_lote_processo.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, nr_seq_analise_p pls_analise_conta.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
