...
SET client_encoding TO 'UTF8';
    ...
    -----------------
CREATE OR REPLACE FUNCTION pck_cdsdvt_report.get_agv_impprove_score (start_date_p timestamp, end_date_p timestamp, cd_setor_p text, ds_age_p text, nr_week_p bigint) RETURNS bigint AS $body$
DECLARE


       nr_impprove_score_w bigint;
       qt_reg_w            bigint;
       ...
       c2 CURSOR FOR
          SELECT qt_score
            from ESCALA_IMPROVE_BLEEDING a
...
BEGIN
       ...
       loop
          ...
          fetch c2 into r2;
             ...
             nr_impprove_score_w := nr_impprove_score_w + r2.qt_score;
       ...
       --
       return ceil(nr_impprove_score_w/qt_reg_w);
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pck_cdsdvt_report.get_agv_impprove_score (start_date_p timestamp, end_date_p timestamp, cd_setor_p text, ds_age_p text, nr_week_p bigint) FROM PUBLIC;
