...
CREATE OR REPLACE PROCEDURE schematics_alt_pck.prc_obj_schematic_evento (nr_seq_obj_p bigint, nr_seq_dic_obj_p bigint, cd_funcao_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE schematics_alt_pck.prc_obj_schematic_evento (nr_seq_obj_p bigint, nr_seq_dic_obj_p bigint, cd_funcao_p bigint) FROM PUBLIC;
