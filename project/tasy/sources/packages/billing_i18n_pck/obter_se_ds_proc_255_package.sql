...
CREATE OR REPLACE FUNCTION billing_i18n_pck.obter_se_ds_proc_255 () RETURNS varchar AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION billing_i18n_pck.obter_se_ds_proc_255 () FROM PUBLIC;
