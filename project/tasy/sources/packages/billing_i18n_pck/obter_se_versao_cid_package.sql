...
CREATE OR REPLACE FUNCTION billing_i18n_pck.obter_se_versao_cid () RETURNS varchar AS $body$
BEGIN
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION billing_i18n_pck.obter_se_versao_cid () FROM PUBLIC;
