...
CREATE OR REPLACE FUNCTION ish_outpat_case_pck.obter_lanr_medic_depto (cd_pessoa_fisica_p text, cd_departamento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION ish_outpat_case_pck.obter_lanr_medic_depto (cd_pessoa_fisica_p text, cd_departamento_p bigint) FROM PUBLIC;
