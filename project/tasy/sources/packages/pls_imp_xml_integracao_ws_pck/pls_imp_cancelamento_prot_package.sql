...
ie_tipo_cliente_w		ptu_cancelamento_pa.ie_tipo_cliente%type;
...
insert into ptu_cancelamento_pa(nr_sequencia, cd_operadora, cd_operadora_destino,
	cd_operadora_origem, cd_transacao, nr_registro_ans,
	ie_tipo_cliente, cd_usuario_plano, ds_motivo,
	dt_geracao, nr_protocolo, nr_seq_execucao,
	nr_seq_protocolo, nr_versao, nm_usuario_transacao,
	dt_atualizacao,	dt_atualizacao_nrec, nm_usuario, 
	nm_usuario_nrec, cd_estabelecimento)
values (nextval('ptu_cancelamento_pa_seq'), cd_operadora_p, cd_operadora_destino_p,
	cd_operadora_origem_p, cd_transacao_p, nr_registro_ans_p,
	ie_tipo_cliente_w, cd_usuario_plano_p, ds_motivo_p,
	dt_geracao_p, nr_protocolo_p, nr_seq_execucao_p,
	nr_seq_protocolo_p, nr_versao_p, nm_usuario_transacao_p,
	clock_timestamp(), clock_timestamp(), nm_usuario_p,
	nm_usuario_p, cd_estabelecimento_w) returning nr_sequencia into nr_seq_cancelamento_p;
commit;
