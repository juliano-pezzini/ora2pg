...
CREATE OR REPLACE PROCEDURE mprev_pop_alvo_pck.limpar_tipo_tabelas (nm_tabela_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE mprev_pop_alvo_pck.limpar_tipo_tabelas (nm_tabela_p text) FROM PUBLIC;
