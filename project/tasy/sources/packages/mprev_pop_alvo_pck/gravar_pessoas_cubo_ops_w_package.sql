...
CREATE OR REPLACE PROCEDURE mprev_pop_alvo_pck.gravar_pessoas_cubo_ops_w (nr_seq_populacao_alvo_p bigint, nm_usuario_p text, nr_seq_controle_p bigint, ds_select_comp_p text) AS $body$
DECLARE


	cursor_w		sql_pck.t_cursor;
	tb_pessoas_cubo_ops_w	mprev_pop_alvo_pck.table_pessoas_cubo_ops;
...
BEGIN
	...
	loop
		CALL CALL mprev_pop_alvo_pck.limpar_tipo_tabelas('tb_pessoas_cubo_ops_w');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE mprev_pop_alvo_pck.gravar_pessoas_cubo_ops_w (nr_seq_populacao_alvo_p bigint, nm_usuario_p text, nr_seq_controle_p bigint, ds_select_comp_p text) FROM PUBLIC;
