...
CREATE OR REPLACE PROCEDURE mprev_pop_alvo_pck.desfazer_geracao_pop_alvo (nr_seq_populacao_alvo_p bigint) AS $body$
BEGIN
	...
	delete 	FROM mprev_pop_pes_custo
	where 	nr_seq_populacao_alvo = nr_seq_populacao_alvo_p;
	...
	delete 	FROM mprev_pop_alvo_benef
	where 	nr_seq_populacao_alvo = nr_seq_populacao_alvo_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE mprev_pop_alvo_pck.desfazer_geracao_pop_alvo (nr_seq_populacao_alvo_p bigint) FROM PUBLIC;
