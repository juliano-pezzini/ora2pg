...
DECLARE
	...
	and	a.dt_validade_prescr between dt_validade_limite_p and dt_validade_prescr_sae_w
	...
	and	((coalesce(a.ie_situacao,'A') <> 'I') or (c.dt_fim_horario IS NOT NULL AND c.dt_fim_horario::text <> ''))
