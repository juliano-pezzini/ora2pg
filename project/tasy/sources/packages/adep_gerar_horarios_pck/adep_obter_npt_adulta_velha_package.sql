...
DECLARE
	...
	from	(
		SELECT	a.nr_prescricao,
			...
			obter_desc_expressao(607186) ds_npt,
			substr(obter_status_solucao_prescr(4,a.nr_prescricao,x.nr_sequencia),1,3) ie_status_solucao,
			'' ds_inf_npt
		from	nut_paciente x,
			prescr_medica a
