...
DECLARE
	...
	and	((ie_regra_inclusao_p = 'S') or
		((ie_regra_inclusao_p = 'R') and (adep_obter_inclusao_regra(	'MAT',
																		a.nr_prescricao,
