...
CREATE OR REPLACE FUNCTION rcm301_arquivo_pck.get_segmentos_dataset (ie_dataset_p text, nr_seq_arquivo_p bigint) RETURNS SETOF T_DATASET_SEGMENTO AS $body$
DECLARE


r_dataset_segmento_w		r_dataset_segmento;
nr_seq_estrut_arq_w		d301_arquivo_envio.nr_seq_estrut_arq%type;
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	r_dataset_segmento_w.nr_tree_node	:= rcm301_arquivo_pck.get_treenode_segmento(c01_w.ie_segmento);
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION rcm301_arquivo_pck.get_segmentos_dataset (ie_dataset_p text, nr_seq_arquivo_p bigint) FROM PUBLIC;
