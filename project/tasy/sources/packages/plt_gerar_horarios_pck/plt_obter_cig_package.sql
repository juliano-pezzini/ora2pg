...
CREATE OR REPLACE PROCEDURE plt_gerar_horarios_pck.plt_obter_cig ( cd_estabelecimento_p bigint, cd_setor_usuario_p bigint, cd_perfil_p bigint, nm_usuario_p text, nr_atendimento_p bigint, dt_inicial_horarios_p timestamp, dt_final_horarios_p timestamp, dt_validade_limite_p timestamp, ie_agrupar_acm_sn_p text, ie_prescr_usuario_p text, nr_seq_regra_p bigint, ie_edicao_p text, ie_estendidos_p bigint, dt_referencia_p timestamp, ie_exibir_hor_suspensos_p text, dt_plano_p text) AS $body$
DECLARE
...
BEGIN
	...
	ie_copiar_w 	:= plt_obter_se_item_marcado('C', nr_seq_regra_p);
	ds_cor_titulo_w	:= plt_obter_cor_titulo('C',nr_seq_regra_p);
	...
	if (nr_atendimento_p IS NOT NULL AND nr_atendimento_p::text <> '') then
		...
		from	(	SELECT	nr_prescricao,
				...
				where	plt_obter_se_item_periodo(	dt_validade_limite_p,		dt_fim_w,				get_ie_plano_por_setor,		dt_plano_p,			t.dt_horario,
													...
													dt_referencia_p,			ie_edicao_p,			ie_exibir_hor_suspensos_p,	t.dt_suspensao,		'C',
