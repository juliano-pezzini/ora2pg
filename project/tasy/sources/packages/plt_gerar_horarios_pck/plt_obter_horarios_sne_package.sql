...
BEGIN
	...
	if (nr_atendimento_p IS NOT NULL AND nr_atendimento_p::text <> '') then
		...
		where	plt_obter_se_item_periodo(	dt_validade_limite_p,	dt_fim_w,				get_ie_plano_por_setor,		dt_plano_p,			t.dt_status,
											...
											dt_referencia_p,		ie_edicao_p,			ie_exibir_hor_suspensos_p,	t.dt_suspensao,		'SNE',
		...
		from	(SELECT	h.dt_horario,
				...
				and		((current_setting('plt_gerar_horarios_pck.ie_regra_incl_sne_w')::char(1) = 'S') or
						((current_setting('plt_gerar_horarios_pck.ie_regra_incl_sne_w')::char(1) = 'R') and (adep_obter_regra_inclusao(	'SNE',
																						...
																						null,
																						null) = 'S')))
				and		((coalesce(h.ie_horario_especial,'N') = 'N') or (h.dt_fim_horario IS NOT NULL AND h.dt_fim_horario::text <> ''))) t
