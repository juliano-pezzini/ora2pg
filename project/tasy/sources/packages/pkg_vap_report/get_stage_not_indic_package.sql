...
SET client_encoding TO 'UTF8';
  ...
  --
CREATE OR REPLACE FUNCTION pkg_vap_report.get_stage_not_indic (P_NR_ATEND bigint, P_ESTAB bigint, P_DT_START timestamp, P_DT_END timestamp, P_STAGE bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pkg_vap_report.get_stage_not_indic (P_NR_ATEND bigint, P_ESTAB bigint, P_DT_START timestamp, P_DT_END timestamp, P_STAGE bigint) FROM PUBLIC;
