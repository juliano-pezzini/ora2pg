...
SET client_encoding TO 'UTF8';
  ...
  --
CREATE OR REPLACE FUNCTION pkg_vap_report.get_estab_dt (P_ESTAB bigint, P_DT timestamp) RETURNS timestamp AS $body$
DECLARE
...
BEGIN
    ...
    ELSE
    --  
      ESTAB_TZ_V := pkg_vap_report.get_estab_tz(P_ESTAB, P_DT);
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pkg_vap_report.get_estab_dt (P_ESTAB bigint, P_DT timestamp) FROM PUBLIC;
