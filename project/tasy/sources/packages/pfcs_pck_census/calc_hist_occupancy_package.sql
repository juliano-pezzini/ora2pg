...
CREATE OR REPLACE PROCEDURE pfcs_pck_census.calc_hist_occupancy (cd_establishment_p bigint, nm_user_p text) AS $body$
DECLARE
...
BEGIN
        ...
        for qt_hours_increment in 1 .. 22 loop
            ...
            pfcs_pck.pfcs_generate_results(
                ...
                nr_seq_indicator_p => PFCS_PCK_INDICATORS.NR_VC_HISTOGRAM_CAPACITY,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_pck_census.calc_hist_occupancy (cd_establishment_p bigint, nm_user_p text) FROM PUBLIC;
