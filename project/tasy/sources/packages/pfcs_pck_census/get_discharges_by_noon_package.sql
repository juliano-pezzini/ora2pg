...
SET client_encoding TO 'UTF8';
    ...
    --=========================================== Functions ===========================================
CREATE OR REPLACE FUNCTION pfcs_pck_census.get_discharges_by_noon ( cd_establishment_p bigint ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pfcs_pck_census.get_discharges_by_noon ( cd_establishment_p bigint ) FROM PUBLIC;
