...
CREATE OR REPLACE FUNCTION ish_treatment_certificate_pck.get_treat_certificate_change (nr_seq_fila_p bigint) RETURNS SETOF T_TREAT_CERTIFICATE AS $body$
DECLARE
...
reg_integracao_w.nm_elemento	:= '_-rzvish_-certificTreatmChange';
...
EXIT WHEN NOT FOUND; /* apply on C01 */
    ...
    and     b.nr_seq_interno	= ( SELECT	min(x.nr_seq_interno)
	...
	select  intpd_conv('ATENDIMENTO_PACIENTE_INF', 'NR_SEQUENCIA', c01_w.nr_sequencia, nr_seq_regra_w, ie_conversao_w, 'E')
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION ish_treatment_certificate_pck.get_treat_certificate_change (nr_seq_fila_p bigint) FROM PUBLIC;
