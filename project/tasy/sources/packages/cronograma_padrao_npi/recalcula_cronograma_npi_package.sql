...
*/
CREATE OR REPLACE PROCEDURE cronograma_padrao_npi.recalcula_cronograma_npi ( nr_seq_cronograma_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cronograma_padrao_npi.recalcula_cronograma_npi ( nr_seq_cronograma_p bigint, nm_usuario_p text) FROM PUBLIC;
