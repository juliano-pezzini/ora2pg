...
CREATE OR REPLACE PROCEDURE ish_patient_pck.gerar_pessoa_classif ( reg_integracao_p INOUT gerar_int_padrao.reg_integracao_conv, cd_pessoa_fisica_p text, ie_classif_p text, vl_classif_p text, nr_seq_regra_p bigint, ie_conversao_p text, nm_usuario_p text, dt_atualizacao_p timestamp) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ish_patient_pck.gerar_pessoa_classif ( reg_integracao_p INOUT gerar_int_padrao.reg_integracao_conv, cd_pessoa_fisica_p text, ie_classif_p text, vl_classif_p text, nr_seq_regra_p bigint, ie_conversao_p text, nm_usuario_p text, dt_atualizacao_p timestamp) FROM PUBLIC;
