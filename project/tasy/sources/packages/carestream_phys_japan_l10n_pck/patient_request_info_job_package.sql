...
SET client_encoding TO 'UTF8';
   ...
   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	message type:- 2H -> Patient Information Request
    In this message physiology department ask to retransmit the paitent info to the physiology department
	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   **/
CREATE OR REPLACE PROCEDURE carestream_phys_japan_l10n_pck.patient_request_info_job () AS $body$
DECLARE
...
BEGIN
    ...
    select carestream_japan_l10n_pck.get_directory_event_code('2H', 'CARE_PHY_PDATA')
...
;
    ...
    for r_c04 in current_setting('carestream_phys_japan_l10n_pck.c04')::loop CURSOR
      begin
          ds_comando_w := 'carestream_phys_japan_l10n_pck.patient_request_info(''' ||r_c04.cd_registro ||''');';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE carestream_phys_japan_l10n_pck.patient_request_info_job () FROM PUBLIC;
