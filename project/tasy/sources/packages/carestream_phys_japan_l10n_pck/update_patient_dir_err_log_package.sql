...
SET client_encoding TO 'UTF8';
   ...
   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    Integration messages - Patient Change Information  
    Control code - 
    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   **/
CREATE OR REPLACE PROCEDURE carestream_phys_japan_l10n_pck.update_patient_dir_err_log () AS $body$
DECLARE
...
BEGIN
        select carestream_japan_l10n_pck.get_directory_event_code('1G', 'CARE_PHY_PDATA')
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE carestream_phys_japan_l10n_pck.update_patient_dir_err_log () FROM PUBLIC;
