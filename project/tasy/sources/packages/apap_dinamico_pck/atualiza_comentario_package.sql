...
CREATE OR REPLACE PROCEDURE apap_dinamico_pck.atualiza_comentario (nr_seq_valor_p bigint, nr_atendimento_p bigint, ds_comentario_p text, ie_acao_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE apap_dinamico_pck.atualiza_comentario (nr_seq_valor_p bigint, nr_atendimento_p bigint, ds_comentario_p text, ie_acao_p text) FROM PUBLIC;
