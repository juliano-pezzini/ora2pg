...
--Procedure utilizada para atualizacao de um determinado campo nos registros PTU. Necess_rio pois

--Ao ajustar diferen_as de arredondamento, pode existir mais de um registro PTU para um unico de p_s-estabelecido

--e n_o se pode apontar que o ajuste em todos os campos ser_ exatamente para o mesmo registro cont_bil.



CREATE OR REPLACE PROCEDURE pls_pos_estabelecido_pck.upd_campo_reg_ptu ( tb_seq_p INOUT pls_util_cta_pck.t_number_table, tb_valor_p INOUT pls_util_cta_pck.t_number_table, ie_campo_p text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_pos_estabelecido_pck.upd_campo_reg_ptu ( tb_seq_p INOUT pls_util_cta_pck.t_number_table, tb_valor_p INOUT pls_util_cta_pck.t_number_table, ie_campo_p text) FROM PUBLIC;
