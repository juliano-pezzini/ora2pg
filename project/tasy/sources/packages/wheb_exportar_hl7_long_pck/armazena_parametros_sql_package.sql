...
CREATE OR REPLACE PROCEDURE wheb_exportar_hl7_long_pck.armazena_parametros_sql (ds_comando_p text,ar_nm_parametros_sql_p INOUT myArray) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE wheb_exportar_hl7_long_pck.armazena_parametros_sql (ds_comando_p text,ar_nm_parametros_sql_p INOUT myArray) FROM PUBLIC;
