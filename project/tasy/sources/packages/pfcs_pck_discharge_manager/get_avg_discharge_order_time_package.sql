...
CREATE OR REPLACE FUNCTION pfcs_pck_discharge_manager.get_avg_discharge_order_time ( cd_establishment_p bigint, cd_unit_p bigint default null, cd_unit_classification_p text default null) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pfcs_pck_discharge_manager.get_avg_discharge_order_time ( cd_establishment_p bigint, cd_unit_p bigint default null, cd_unit_classification_p text default null) FROM PUBLIC;
