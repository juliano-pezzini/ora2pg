...
CREATE OR REPLACE PROCEDURE pls_cta_consistir_pck.pls_inativar_ocor_comb_val ( nr_seq_lote_p pls_analise_conta.nr_seq_lote_protocolo%type, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_cta_consistir_pck.pls_inativar_ocor_comb_val ( nr_seq_lote_p pls_analise_conta.nr_seq_lote_protocolo%type, nm_usuario_p text) FROM PUBLIC;
