...
CREATE OR REPLACE PROCEDURE pls_cta_consistir_pck.verifica_ocorrencia_combinada ( nr_seq_lote_p pls_lote_protocolo_conta.nr_sequencia%type, nr_seq_protocolo_p pls_protocolo_conta.nr_sequencia%type, nr_seq_lote_processo_p pls_cta_lote_processo.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, nr_seq_conta_proc_p pls_conta_proc.nr_sequencia%type, nr_seq_conta_mat_p pls_conta_mat.nr_sequencia%type, nr_seq_ocorrencia_p pls_ocorrencia.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) AS $body$
DECLARE
...
if (nr_seq_lote_processo_p IS NOT NULL AND nr_seq_lote_processo_p::text <> '') then
	...
	for r_c01_w in c01(nr_seq_lote_processo_p) loop
		...
		CALL pls_cta_consistir_pck.pls_inativar_ocor_comb(	r_c01_w.nr_seq_lote_conta, nm_usuario_p	, nr_seq_ocorrencia_p);
		
		CALL pls_oc_cta_gerar_combinada(	'CC', 'A', r_c01_w.nr_seq_lote_conta, null, null,
						null, null, null, null,
						null, null, null, null, nr_seq_ocorrencia_p, cd_estabelecimento_p, nm_usuario_p);
	...
	for r_c02_w in c02(nr_seq_lote_processo_p) loop
		...
		CALL pls_oc_cta_gerar_combinada(	'CC', 'A', null, r_c02_w.nr_seq_protocolo, null,
						null, null, null, null,
						null, null, null, null, nr_seq_ocorrencia_p, cd_estabelecimento_p, nm_usuario_p);
	end loop;
	...
	CALL pls_oc_cta_gerar_combinada(	'CC', 'A', nr_seq_lote_p, nr_seq_protocolo_p, null,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_cta_consistir_pck.verifica_ocorrencia_combinada ( nr_seq_lote_p pls_lote_protocolo_conta.nr_sequencia%type, nr_seq_protocolo_p pls_protocolo_conta.nr_sequencia%type, nr_seq_lote_processo_p pls_cta_lote_processo.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, nr_seq_conta_proc_p pls_conta_proc.nr_sequencia%type, nr_seq_conta_mat_p pls_conta_mat.nr_sequencia%type, nr_seq_ocorrencia_p pls_ocorrencia.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) FROM PUBLIC;
