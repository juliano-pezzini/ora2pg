...
SET client_encoding TO 'UTF8';
   ...
   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   **/
CREATE OR REPLACE PROCEDURE tosho_pck.patient_ward_transfer_info ( unique_key_p bigint, processing_type_p text, nm_usuario_p text, log_sequence_number_p text default 0, file_name_p text default null, cd_establishment_p bigint default 1, ie_retransmit_p text  DEFAULT NULL) AS $body$
DECLARE


        c02 CURSOR FOR
        SELECT x.*  ,   coalesce(obter_nome_pf(x.physician_code), ' ') physician_name
        from (SELECT obter_pessoa_atendimento(a.encounter_id, 'C') patient_id,
                a.encounter_id            encounter_id,
                a.department_admit_date   transfer_date,
                a.department_id           destination_ward,
                a.department_name           destination_ward_name,
                a.room_id                 destination_room,
                obter_dados_unidade(a.department_id, a.room_id , a.bed_id , 'NRSI') destination_room_name,
                tosho_pck.get_attending_physician(a.encounter_id)  physician_code
        from    bft_encounter_movement_v a
        where   a.movement_id = unique_key_p) x;
...
BEGIN
        ...
        PERFORM set_config('tosho_pck.message_type_w', '3J', false);
        PERFORM set_config('tosho_pck.file_seq_directory_w', 'TOSHO_PDATA', false);
        PERFORM set_config('tosho_pck.ds_message_w', 'Patient Ward Change Information', false);
        ...
        begin
            ...
            for r_c02 in c02 loop begin
                PERFORM set_config('tosho_pck.patient_id_w', r_c02.patient_id, false);
                ...
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(1,8,'L','0');
                 CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(processing_type_p,1);
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(to_char(r_c02.transfer_date, 'YYYYMMDD'), 8, 'L'); --SYORI_DATE
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(to_char(r_c02.transfer_date, 'HH24MISS'), 6, 'L'); --SYORI_TIME
                ...
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(to_char(r_c02.transfer_date, 'YYYYMMDD'), 8, 'L'); -- CHG_DATE
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c02.physician_code, 10, 'L', '0'); -- DR_CD
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c02.physician_name, 20); -- DR_NAME
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c02.destination_ward, 3, 'L', '0'); -- IDO_BYOTO_CD
                 CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c02.destination_ward_name, 20); -- IDO_BYOTO_NAME
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c02.destination_room, 4, 'L', '0'); -- IDO_ROOM_CD
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c02.destination_room_name, 20); -- IDO_ROOM_NAME
                CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(' ', 25, 'L'); -- FILLER
            end;
            end loop;
        exception
            when others then
        ...
        PERFORM set_config('tosho_pck.ds_script_w', 'tosho_pck.patient_ward_transfer_info ('
                       || unique_key_p 
                       || ', '''
                       || processing_type_p
                       || ''', '''
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE tosho_pck.patient_ward_transfer_info ( unique_key_p bigint, processing_type_p text, nm_usuario_p text, log_sequence_number_p text default 0, file_name_p text default null, cd_establishment_p bigint default 1, ie_retransmit_p text  DEFAULT NULL) FROM PUBLIC;
