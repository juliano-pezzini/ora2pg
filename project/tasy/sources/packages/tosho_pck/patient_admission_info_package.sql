...
SET client_encoding TO 'UTF8';
   ...
   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   **/
CREATE OR REPLACE PROCEDURE tosho_pck.patient_admission_info ( unique_key_p bigint, message_type_p text, processing_type_p text, nm_usuario_p text, log_sequence_number_p text, file_name_p text, cd_establishment_p bigint, ie_retransmit_p text ) AS $body$
DECLARE


        c04 CURSOR FOR
            SELECT x.*  ,   coalesce(obter_nome_pf(x.physician_code), ' ') physician_name
            from (SELECT a.nr_atendimento encounter_id,
                   ...
                   a.dt_acomodacao admission_date,
                   ...
                   coalesce(a.cd_unidade_basica,' ') room_code,
                    ...
                    obter_nome_departamento_medico(a.cd_departamento_desejado) department_name,
                    OBTER_DADOS_SETOR( a.cd_setor_desejado, 'DS') ward_name,
                    obter_dados_unidade(a.cd_setor_desejado,a.cd_unidade_basica , a.cd_unidade_compl , 'NRSI') room_name
            from   gestao_vaga a,
                    bft_encounter_v c
            where	a.nr_atendimento 	= c.encounter_id
            and     a.nr_sequencia = unique_key_p) x;
...
BEGIN
        ...
        PERFORM set_config('tosho_pck.ds_message_w', 'Patient Admission Information', false);
        ...
        for r_c04 in c04 loop begin
            PERFORM set_config('tosho_pck.patient_id_w', r_c04.patient_id, false);
            ...
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(to_char(r_c04.admission_date, 'YYYYMMDD'), 8, 'L'); --SYORI_DATE
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(to_char(r_c04.admission_date, 'HH24MISS'), 6, 'L'); --SYORI_TIME
            ...
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.encounter_type, 1, 'L', '0'); -- NYUGAI_KBN
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(to_char(r_c04.admission_date, 'YYYYMMDD'), 8, 'L'); -- CHG_DATE
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.physician_code, 10, 'L', '0'); -- DR_ID
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.physician_name, 20, 'L', '0'); -- DR_NAME
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.department_code, 3, 'L', '0'); -- IDO_KA_CD
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.department_name, 20); -- IDO_KA_NAME
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.ward_code, 3, 'L', '0'); -- BYOTO_CD
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.ward_name, 20); -- BYOTO_NAME
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.room_code, 4, 'L', '0'); -- ROOM_CD
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(r_c04.room_name, 20); -- ROOM_NAME
            CALL CALL CALL CALL CALL CALL CALL CALL CALL CALL tosho_pck.append_text(' ', 21, 'L'); -- FILLER
        end;
        end loop;
                exception
            when others then
        ...
        PERFORM set_config('tosho_pck.ds_script_w', 'tosho_pck.patient_admission_info ('
                       || unique_key_p 
                       || ', '''
                       || message_type_p
                       || ''', '''
        ...
        CALL CALL tosho_pck.perform_integration(unique_key_p, message_type_p, nm_usuario_p, log_sequence_number_p, current_setting('tosho_pck.data_file_name_w')::varchar(100),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE tosho_pck.patient_admission_info ( unique_key_p bigint, message_type_p text, processing_type_p text, nm_usuario_p text, log_sequence_number_p text, file_name_p text, cd_establishment_p bigint, ie_retransmit_p text ) FROM PUBLIC;
