...
CREATE OR REPLACE PROCEDURE pls_mensalidade_util_pck.ajustar_vigencia_tx_boleto () AS $body$
DECLARE
...
loop
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last
		update	pls_regra_emissao_boleto
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_mensalidade_util_pck.ajustar_vigencia_tx_boleto () FROM PUBLIC;
