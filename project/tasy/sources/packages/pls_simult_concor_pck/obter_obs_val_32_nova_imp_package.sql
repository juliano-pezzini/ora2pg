...
CREATE OR REPLACE FUNCTION pls_simult_concor_pck.obter_obs_val_32_nova_imp ( dados_regra_cab_p pls_simult_concor_pck.t_dado_cab_regra, cd_guia_referencia_p pls_conta.cd_guia_referencia%type, nr_seq_segurado_p pls_conta.nr_seq_segurado%type, dt_item_p pls_oc_cta_selecao_ocor_v.dt_item%type, nr_seq_conta_p pls_oc_cta_selecao_ocor_v.nr_seq_conta%type, ie_evento_p text) RETURNS text AS $body$
DECLARE
...
union all
			...
			from	pls_conta_proc_ocor_imp_v  b
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pls_simult_concor_pck.obter_obs_val_32_nova_imp ( dados_regra_cab_p pls_simult_concor_pck.t_dado_cab_regra, cd_guia_referencia_p pls_conta.cd_guia_referencia%type, nr_seq_segurado_p pls_conta.nr_seq_segurado%type, dt_item_p pls_oc_cta_selecao_ocor_v.dt_item%type, nr_seq_conta_p pls_oc_cta_selecao_ocor_v.nr_seq_conta%type, ie_evento_p text) FROM PUBLIC;
