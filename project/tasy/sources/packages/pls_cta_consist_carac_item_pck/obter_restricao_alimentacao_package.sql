...
CREATE OR REPLACE FUNCTION pls_cta_consist_carac_item_pck.obter_restricao_alimentacao ( ie_opcao_p text, nr_cursor_p integer, ie_proc_mat_p text, dados_regra_p dados_regra) RETURNS DADOS_RESTRICAO AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pls_cta_consist_carac_item_pck.obter_restricao_alimentacao ( ie_opcao_p text, nr_cursor_p integer, ie_proc_mat_p text, dados_regra_p dados_regra) FROM PUBLIC;
