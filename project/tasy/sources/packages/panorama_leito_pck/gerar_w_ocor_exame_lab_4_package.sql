...
SET client_encoding TO 'UTF8';
	...
	----------------------------- 4 ---------------------------------
	XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*/
CREATE OR REPLACE PROCEDURE panorama_leito_pck.gerar_w_ocor_exame_lab_4 ( nr_atendimento_p bigint, cd_pessoa_fisica_p text, pIeConcluido text) AS $body$
DECLARE
	...
	and		adep_obter_regra_inclusao('LAB', b.cd_estabelecimento, b.cd_setor_atendimento,
...
BEGIN
	...
	if (ds_alerta_w IS NOT NULL AND ds_alerta_w::text <> '') then
		CALL panorama_leito_pck.insert_ocorrencia(nr_atendimento_p,
						4,
						'assets/icons/status-and-feedback/microscope-clock.svg',
						'assets/icons/status-and-feedback/microscope-clock.svg',
						699144, /* Coleta de material para exame laboratorial*/
						967927,
						null,
						988845,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE panorama_leito_pck.gerar_w_ocor_exame_lab_4 ( nr_atendimento_p bigint, cd_pessoa_fisica_p text, pIeConcluido text) FROM PUBLIC;
