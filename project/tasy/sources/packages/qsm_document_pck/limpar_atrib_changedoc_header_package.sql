...
CREATE OR REPLACE PROCEDURE qsm_document_pck.limpar_atrib_changedoc_header (r_changeDocument_header_row_p INOUT r_changeDocument_header_row) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE qsm_document_pck.limpar_atrib_changedoc_header (r_changeDocument_header_row_p INOUT r_changeDocument_header_row) FROM PUBLIC;
