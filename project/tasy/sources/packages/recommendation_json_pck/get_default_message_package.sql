...
CREATE OR REPLACE FUNCTION recommendation_json_pck.get_default_message ( nr_cpoe_recomm_p bigint ) RETURNS PHILIPS_JSON AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION recommendation_json_pck.get_default_message ( nr_cpoe_recomm_p bigint ) FROM PUBLIC;
