...
CREATE OR REPLACE PROCEDURE rep_gerar_resumo_pck.gerar_rep_resumo_sne () AS $body$
DECLARE
...
WHERE a.cd_material	= c.cd_material and a.nr_prescricao	= nr_prescricao_w and a.ie_agrupador	= 8;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE rep_gerar_resumo_pck.gerar_rep_resumo_sne () FROM PUBLIC;
