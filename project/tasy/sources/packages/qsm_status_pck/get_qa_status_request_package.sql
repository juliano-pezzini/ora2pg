...
'getStatus'
*/
CREATE OR REPLACE FUNCTION qsm_status_pck.get_qa_status_request ( nr_seq_fila_p bigint) RETURNS SETOF T_STATUS AS $body$
DECLARE


C01 CURSOR(nr_seq_episodio_pc bigint) FOR
	SELECT	nr_seq_episodio ds_case,
		cd_estabelecimento ds_client
	from	atendimento_paciente
	where	nr_seq_episodio	= nr_seq_episodio_pc  LIMIT 1;
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION qsm_status_pck.get_qa_status_request ( nr_seq_fila_p bigint) FROM PUBLIC;
