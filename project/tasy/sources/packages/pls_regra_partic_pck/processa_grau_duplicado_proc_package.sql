...
-- faz o processamento da regra dentro da sequencia do procedimento para verificar se o grau esta duplicado



CREATE OR REPLACE PROCEDURE pls_regra_partic_pck.processa_grau_duplicado_proc ( nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type, dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_regra_partic_pck.processa_grau_duplicado_proc ( nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type, dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic) FROM PUBLIC;
