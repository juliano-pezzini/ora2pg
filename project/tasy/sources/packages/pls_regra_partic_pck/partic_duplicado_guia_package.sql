...
CREATE OR REPLACE PROCEDURE pls_regra_partic_pck.partic_duplicado_guia ( dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic, nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
for r_c01_w in c01(nr_id_transacao_p) loop
	...
	case(dados_val_partic_p.ie_incidencia)
		...
		when 'GPDH' then
			...
			-- faz as verificacoes para o prestador
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_regra_partic_pck.partic_duplicado_guia ( dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic, nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
