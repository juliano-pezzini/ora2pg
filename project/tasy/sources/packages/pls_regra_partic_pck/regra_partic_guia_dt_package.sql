...
CREATE OR REPLACE PROCEDURE pls_regra_partic_pck.regra_partic_guia_dt ( dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic, nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
c_partic_guia_dt CURSOR(	nr_seq_segurado_pc	pls_conta.nr_seq_segurado%type,
...
union all
	...
	if (qt_grupo_casou_w = qt_grupo_regra_w) then
		...
		for r_c_partic_guia_w in c_partic_guia_dt(	r_c01_w.nr_seq_segurado, r_c01_w.cd_guia_referencia,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_regra_partic_pck.regra_partic_guia_dt ( dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic, nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
