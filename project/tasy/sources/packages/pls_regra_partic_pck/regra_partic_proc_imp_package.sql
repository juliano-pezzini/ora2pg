...
CREATE OR REPLACE PROCEDURE pls_regra_partic_pck.regra_partic_proc_imp ( dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic, nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
c_partic_proc_imp CURSOR(	nr_seq_conta_proc_pc	pls_conta_proc.nr_sequencia%type,
				nr_seq_regra_pc		pls_grupo_partic_tm.nr_seq_regra%type) FOR
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_regra_partic_pck.regra_partic_proc_imp ( dados_val_partic_p pls_tipos_ocor_pck.dados_val_partic, nr_id_transacao_p pls_oc_cta_selecao_ocor_v.nr_id_transacao%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
