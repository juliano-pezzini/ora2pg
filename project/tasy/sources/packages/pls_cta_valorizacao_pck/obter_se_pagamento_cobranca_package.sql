...
CREATE OR REPLACE FUNCTION pls_cta_valorizacao_pck.obter_se_pagamento_cobranca ( ie_tipo_conta_p pls_conta.ie_tipo_conta%type) RETURNS PLS_REGRA_INTERCAMBIO.IE_COBRANCA_PAGAMENTO%TYPE AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pls_cta_valorizacao_pck.obter_se_pagamento_cobranca ( ie_tipo_conta_p pls_conta.ie_tipo_conta%type) FROM PUBLIC;
