...
SET client_encoding TO 'UTF8';
  ...
  --
CREATE OR REPLACE FUNCTION pkg_atend_pac_unid.get_sys_dt (P_ESTAB bigint, P_DT timestamp) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pkg_atend_pac_unid.get_sys_dt (P_ESTAB bigint, P_DT timestamp) FROM PUBLIC;
