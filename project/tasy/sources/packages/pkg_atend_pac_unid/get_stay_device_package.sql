...
SET client_encoding TO 'UTF8';
  ...
  --
CREATE OR REPLACE FUNCTION pkg_atend_pac_unid.get_stay_device (P_START_DATE timestamp, P_END_DATE timestamp, P_CLASS_DISP text, P_CD_ESTAB bigint DEFAULT 0, P_CD_SETOR bigint DEFAULT 0) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pkg_atend_pac_unid.get_stay_device (P_START_DATE timestamp, P_END_DATE timestamp, P_CLASS_DISP text, P_CD_ESTAB bigint DEFAULT 0, P_CD_SETOR bigint DEFAULT 0) FROM PUBLIC;
