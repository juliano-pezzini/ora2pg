...
SET client_encoding TO 'UTF8';
  ...
  --
CREATE OR REPLACE FUNCTION pkg_atend_pac_unid.get_median_device (P_START_DATE timestamp, P_END_DATE timestamp, P_CLASS_DISP text, P_CD_ESTAB bigint DEFAULT 0, P_CD_SETOR bigint DEFAULT 0) RETURNS bigint AS $body$
DECLARE
          ...
          FROM (SELECT NR_ATENDIMENTO,
                  ...
                  FROM (SELECT UN.NR_ATENDIMENTO,
                         ...
                         WHERE AD.NR_ATENDIMENTO = UN.NR_ATENDIMENTO
                           ...
                           AND coalesce(AD.DT_RETIRADA, UN.DT_ENTRADA) >= UN.DT_ENTRADA) alias48 
                 ORDER BY 4) alias49;
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION pkg_atend_pac_unid.get_median_device (P_START_DATE timestamp, P_END_DATE timestamp, P_CLASS_DISP text, P_CD_ESTAB bigint DEFAULT 0, P_CD_SETOR bigint DEFAULT 0) FROM PUBLIC;
