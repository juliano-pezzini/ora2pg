...
CREATE OR REPLACE PROCEDURE ptu_a950_pck.processa_guias_sadt_v7 ( nr_seq_arq_xml_p pls_imp_arq_A950.nr_sequencia%type, ds_guias_sadt_p pls_imp_arq_A950.ds_xml%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_a950_pck.processa_guias_sadt_v7 ( nr_seq_arq_xml_p pls_imp_arq_A950.nr_sequencia%type, ds_guias_sadt_p pls_imp_arq_A950.ds_xml%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
