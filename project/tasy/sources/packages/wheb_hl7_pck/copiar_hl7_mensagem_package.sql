...
CREATE OR REPLACE PROCEDURE wheb_hl7_pck.copiar_hl7_mensagem (nr_seq_proj_origem_p bigint, nr_seq_proj_destino_p bigint, nr_seq_mensagem_origem_p bigint) AS $body$
DECLARE
        ...
        loop
            ...
            begin
                ...
                values (nr_sequencia_w,
                     ...
                     wheb_usuario_pck.get_nm_usuario,
                     'A');
                CALL wheb_hl7_pck.copiar_hl7_segmento(hl7_mensagem_w.nr_sequencia, nr_sequencia_w, null);
            end;
        end loop;
        close c01;
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE wheb_hl7_pck.copiar_hl7_mensagem (nr_seq_proj_origem_p bigint, nr_seq_proj_destino_p bigint, nr_seq_mensagem_origem_p bigint) FROM PUBLIC;
