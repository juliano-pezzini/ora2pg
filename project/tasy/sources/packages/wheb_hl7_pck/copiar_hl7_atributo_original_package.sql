...
CREATE OR REPLACE PROCEDURE wheb_hl7_pck.copiar_hl7_atributo_original (nr_seq_segmento_p bigint, nr_seq_segmento_new_p bigint, nr_seq_mensagem_p bigint) AS $body$
DECLARE
        ...
        loop
            ...
            begin
                ...
                if (hl7_atributo_w.nr_seq_atrib_segm IS NOT NULL AND hl7_atributo_w.nr_seq_atrib_segm::text <> '') then
                    CALL wheb_hl7_pck.copiar_hl7_segm_atrib_original(hl7_atributo_w.nr_seq_atrib_segm, nr_seq_mensagem_p, nr_sequencia_w);
                end if;
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE wheb_hl7_pck.copiar_hl7_atributo_original (nr_seq_segmento_p bigint, nr_seq_segmento_new_p bigint, nr_seq_mensagem_p bigint) FROM PUBLIC;
