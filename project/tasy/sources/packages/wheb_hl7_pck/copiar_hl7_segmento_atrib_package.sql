...
CREATE OR REPLACE PROCEDURE wheb_hl7_pck.copiar_hl7_segmento_atrib (nr_sequencia_p bigint, nr_seq_mensagem_p bigint, nr_seq_atrib_p bigint) AS $body$
DECLARE

        nr_sequencia_w bigint;
        c01 CURSOR FOR
            SELECT * from hl7_segmento a where nr_sequencia = nr_sequencia_p;
...
BEGIN
        ...
        loop
            ...
            begin
                ...
                CALL wheb_hl7_pck.copiar_hl7_atributo(nr_sequencia_p, nr_sequencia_w, nr_seq_mensagem_p);
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE wheb_hl7_pck.copiar_hl7_segmento_atrib (nr_sequencia_p bigint, nr_seq_mensagem_p bigint, nr_seq_atrib_p bigint) FROM PUBLIC;
