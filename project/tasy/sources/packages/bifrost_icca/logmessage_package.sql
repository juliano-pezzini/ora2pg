...
CREATE OR REPLACE PROCEDURE bifrost_icca.logmessage ( bifrostMessageId text, eventName text, javaClass text, content text, resultValue text, userName text, errorMessage text ) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE bifrost_icca.logmessage ( bifrostMessageId text, eventName text, javaClass text, content text, resultValue text, userName text, errorMessage text ) FROM PUBLIC;
