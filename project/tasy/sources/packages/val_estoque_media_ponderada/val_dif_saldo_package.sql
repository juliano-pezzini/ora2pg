...
---------------------------------------------------------------
CREATE OR REPLACE PROCEDURE val_estoque_media_ponderada.val_dif_saldo ( cd_material_p bigint, cd_estabelecimento_p bigint , dt_mesano_referencia_p timestamp, nr_movimento_estoque_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE val_estoque_media_ponderada.val_dif_saldo ( cd_material_p bigint, cd_estabelecimento_p bigint , dt_mesano_referencia_p timestamp, nr_movimento_estoque_p bigint) FROM PUBLIC;
