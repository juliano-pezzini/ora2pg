...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             tipo_pls_parametro                                          force as object
(
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             lt_atributo_lookup                                          FORCE AS OBJECT (
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             lt_analise_inconsist                                          FORCE AS OBJECT (
  DS_ANALISE_PARA_USUARIO VARCHAR2(255),
  IE_TIPO_ACOMPANHAMENTO  VARCHAR2(1),
  IE_TIPO_AJUSTE          VARCHAR2(1)
);
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             person_name_dev_row                                          force as object(
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             search_macros_row                                          force as object(
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             ccd_management_rc                                          force as object (
  CD NUMBER,
  DS VARCHAR2(250),
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             log_settings_row                                          force as object(
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             get_chart_values_row                                          force as object(
...
-- Unsupported, please edit to match PostgreSQL syntax
CREATE OR REPLACE TYPE             lt_mensagem_sms                                          force as object(
