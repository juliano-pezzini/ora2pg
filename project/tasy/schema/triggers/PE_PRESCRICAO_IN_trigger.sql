...
DROP TRIGGER IF EXISTS pe_prescricao_in ON pe_prescricao CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pe_prescricao_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pe_prescricao_in() FROM PUBLIC;

CREATE TRIGGER pe_prescricao_in
	BEFORE INSERT OR UPDATE ON pe_prescricao FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pe_prescricao_in();
