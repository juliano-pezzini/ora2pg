...
DROP TRIGGER IF EXISTS atestado_paciente_sbis_in ON atestado_paciente CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_atestado_paciente_sbis_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_atestado_paciente_sbis_in() FROM PUBLIC;

CREATE TRIGGER atestado_paciente_sbis_in
	BEFORE INSERT OR UPDATE ON atestado_paciente FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_atestado_paciente_sbis_in();
