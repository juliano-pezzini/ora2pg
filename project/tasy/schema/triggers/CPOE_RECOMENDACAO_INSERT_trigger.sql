...
DROP TRIGGER IF EXISTS cpoe_recomendacao_insert ON cpoe_recomendacao CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_cpoe_recomendacao_insert() RETURNS trigger AS $BODY$
DECLARE
...
-- REVOKE ALL ON FUNCTION trigger_fct_cpoe_recomendacao_insert() FROM PUBLIC;

CREATE TRIGGER cpoe_recomendacao_insert
	BEFORE INSERT ON cpoe_recomendacao FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_cpoe_recomendacao_insert();
