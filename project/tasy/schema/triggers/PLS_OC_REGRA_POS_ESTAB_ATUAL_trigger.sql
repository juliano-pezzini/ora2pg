...
DROP TRIGGER IF EXISTS pls_oc_regra_pos_estab_atual ON pls_oc_regra_pos_estab CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_oc_regra_pos_estab_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_oc_regra_pos_estab_atual() FROM PUBLIC;

CREATE TRIGGER pls_oc_regra_pos_estab_atual
	BEFORE INSERT OR UPDATE ON pls_oc_regra_pos_estab FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_oc_regra_pos_estab_atual();
