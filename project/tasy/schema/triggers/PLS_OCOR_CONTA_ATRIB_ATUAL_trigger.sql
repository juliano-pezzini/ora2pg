...
DROP TRIGGER IF EXISTS pls_ocor_conta_atrib_atual ON pls_ocorrencia_conta_atrib CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_ocor_conta_atrib_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_ocor_conta_atrib_atual() FROM PUBLIC;

CREATE TRIGGER pls_ocor_conta_atrib_atual
	BEFORE INSERT OR UPDATE ON pls_ocorrencia_conta_atrib FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_ocor_conta_atrib_atual();
