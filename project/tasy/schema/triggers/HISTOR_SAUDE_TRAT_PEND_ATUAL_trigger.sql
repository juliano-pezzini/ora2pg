...
DROP TRIGGER IF EXISTS histor_saude_trat_pend_atual ON historico_saude_tratamento CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_histor_saude_trat_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_histor_saude_trat_pend_atual() FROM PUBLIC;

CREATE TRIGGER histor_saude_trat_pend_atual
	AFTER INSERT OR UPDATE ON historico_saude_tratamento FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_histor_saude_trat_pend_atual();
