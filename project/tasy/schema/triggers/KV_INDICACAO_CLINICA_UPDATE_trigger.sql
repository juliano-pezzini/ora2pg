...
DROP TRIGGER IF EXISTS kv_indicacao_clinica_update ON kv_indicacao_clinica CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_kv_indicacao_clinica_update() RETURNS trigger AS $BODY$
declare
...
BEGIN
    ...
    and		b.ie_situacao = 'A'
    and   b.IE_TIPO_PEND_EMISSAO  = 'KV2'
...
-- REVOKE ALL ON FUNCTION trigger_fct_kv_indicacao_clinica_update() FROM PUBLIC;

CREATE TRIGGER kv_indicacao_clinica_update
	BEFORE UPDATE ON kv_indicacao_clinica FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_kv_indicacao_clinica_update();
