...
DROP TRIGGER IF EXISTS pls_prest_grupo_serv_delete ON pls_prestador_grupo_serv CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_prest_grupo_serv_delete() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_prest_grupo_serv_delete() FROM PUBLIC;

CREATE TRIGGER pls_prest_grupo_serv_delete
	AFTER DELETE ON pls_prestador_grupo_serv FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_prest_grupo_serv_delete();
