...
DROP TRIGGER IF EXISTS formulario_exame_lab_update ON formulario_exame_lab CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_formulario_exame_lab_update() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_formulario_exame_lab_update() FROM PUBLIC;

CREATE TRIGGER formulario_exame_lab_update
	BEFORE UPDATE ON formulario_exame_lab FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_formulario_exame_lab_update();
