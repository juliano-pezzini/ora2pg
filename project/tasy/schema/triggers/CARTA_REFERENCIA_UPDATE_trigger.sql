...
DROP TRIGGER IF EXISTS carta_referencia_update ON carta_referencia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_carta_referencia_update() RETURNS trigger AS $BODY$
declare
...
BEGIN
    ...
    and		b.ie_situacao = 'A'
    and   	b.IE_TIPO_PEND_EMISSAO  = 'KV6'
...
-- REVOKE ALL ON FUNCTION trigger_fct_carta_referencia_update() FROM PUBLIC;

CREATE TRIGGER carta_referencia_update
	BEFORE UPDATE ON carta_referencia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_carta_referencia_update();
