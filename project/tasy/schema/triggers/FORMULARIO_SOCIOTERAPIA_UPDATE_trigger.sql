...
DROP TRIGGER IF EXISTS formulario_socioterapia_update ON formulario_socioterapia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_formulario_socioterapia_update() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_formulario_socioterapia_update() FROM PUBLIC;

CREATE TRIGGER formulario_socioterapia_update
	BEFORE UPDATE ON formulario_socioterapia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_formulario_socioterapia_update();
