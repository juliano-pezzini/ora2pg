...
DROP TRIGGER IF EXISTS pls_prestador_med_espec_atual ON pls_prestador_med_espec CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_prestador_med_espec_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_prestador_med_espec_atual() FROM PUBLIC;

CREATE TRIGGER pls_prestador_med_espec_atual
	BEFORE INSERT OR UPDATE ON pls_prestador_med_espec FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_prestador_med_espec_atual();
