...
DROP TRIGGER IF EXISTS alerta_paciente_sbis_in ON alerta_paciente CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_alerta_paciente_sbis_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_alerta_paciente_sbis_in() FROM PUBLIC;

CREATE TRIGGER alerta_paciente_sbis_in
	BEFORE INSERT OR UPDATE ON alerta_paciente FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_alerta_paciente_sbis_in();
