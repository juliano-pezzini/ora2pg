...
DROP TRIGGER IF EXISTS diops_movto_pel_atual ON diops_movto_pel CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_diops_movto_pel_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_diops_movto_pel_atual() FROM PUBLIC;

CREATE TRIGGER diops_movto_pel_atual
	BEFORE UPDATE ON diops_movto_pel FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_diops_movto_pel_atual();
