...
DROP TRIGGER IF EXISTS pls_contrato_doc_arq_atual ON pls_contrato_doc_arq CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_contrato_doc_arq_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_contrato_doc_arq_atual() FROM PUBLIC;

CREATE TRIGGER pls_contrato_doc_arq_atual
	BEFORE INSERT OR UPDATE ON pls_contrato_doc_arq FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_contrato_doc_arq_atual();
