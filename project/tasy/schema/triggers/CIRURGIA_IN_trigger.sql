...
DROP TRIGGER IF EXISTS cirurgia_in ON cirurgia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_cirurgia_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_cirurgia_in() FROM PUBLIC;

CREATE TRIGGER cirurgia_in
	BEFORE INSERT OR UPDATE ON cirurgia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_cirurgia_in();
