...
DROP TRIGGER IF EXISTS funcao_regra_relat_atual ON funcao_regra_relat CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_funcao_regra_relat_atual() RETURNS trigger AS $BODY$
DECLARE
...
-- REVOKE ALL ON FUNCTION trigger_fct_funcao_regra_relat_atual() FROM PUBLIC;

CREATE TRIGGER funcao_regra_relat_atual
	BEFORE INSERT OR UPDATE OR DELETE ON funcao_regra_relat FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_funcao_regra_relat_atual();
