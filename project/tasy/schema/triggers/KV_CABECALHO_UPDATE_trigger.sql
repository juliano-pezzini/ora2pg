...
DROP TRIGGER IF EXISTS kv_cabecalho_update ON kv_cabecalho CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_kv_cabecalho_update() RETURNS trigger AS $BODY$
declare
...
into STRICT is_rule_exists_w
    ...
    and		b.ie_situacao = 'A'
    and   b.IE_TIPO_PEND_EMISSAO  = 'KVH'
...
-- REVOKE ALL ON FUNCTION trigger_fct_kv_cabecalho_update() FROM PUBLIC;

CREATE TRIGGER kv_cabecalho_update
	BEFORE UPDATE ON kv_cabecalho FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_kv_cabecalho_update();
