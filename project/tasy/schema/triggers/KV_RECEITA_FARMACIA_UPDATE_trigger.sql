...
DROP TRIGGER IF EXISTS kv_receita_farmacia_update ON kv_receita_farmacia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_kv_receita_farmacia_update() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_kv_receita_farmacia_update() FROM PUBLIC;

CREATE TRIGGER kv_receita_farmacia_update
	BEFORE UPDATE ON kv_receita_farmacia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_kv_receita_farmacia_update();
