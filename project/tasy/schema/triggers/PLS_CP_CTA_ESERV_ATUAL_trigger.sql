...
DROP TRIGGER IF EXISTS pls_cp_cta_eserv_atual ON pls_cp_cta_eserv CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_cp_cta_eserv_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_cp_cta_eserv_atual() FROM PUBLIC;

CREATE TRIGGER pls_cp_cta_eserv_atual
	BEFORE INSERT OR UPDATE ON pls_cp_cta_eserv FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_cp_cta_eserv_atual();
