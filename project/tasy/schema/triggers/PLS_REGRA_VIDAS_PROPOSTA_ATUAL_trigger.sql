...
DROP TRIGGER IF EXISTS pls_regra_vidas_proposta_atual ON pls_regra_vidas_proposta CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_regra_vidas_proposta_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_regra_vidas_proposta_atual() FROM PUBLIC;

CREATE TRIGGER pls_regra_vidas_proposta_atual
	BEFORE INSERT OR UPDATE ON pls_regra_vidas_proposta FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_regra_vidas_proposta_atual();
