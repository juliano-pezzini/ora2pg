...
DROP TRIGGER IF EXISTS mprev_grupo_turma_partic_ins ON mprev_grupo_turma_partic CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_mprev_grupo_turma_partic_ins() RETURNS trigger AS $BODY$
DECLARE
...
-- REVOKE ALL ON FUNCTION trigger_fct_mprev_grupo_turma_partic_ins() FROM PUBLIC;

CREATE TRIGGER mprev_grupo_turma_partic_ins
	AFTER INSERT ON mprev_grupo_turma_partic FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_mprev_grupo_turma_partic_ins();
