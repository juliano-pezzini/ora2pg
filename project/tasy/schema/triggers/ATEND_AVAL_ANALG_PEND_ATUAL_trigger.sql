...
DROP TRIGGER IF EXISTS atend_aval_analg_pend_atual ON atend_aval_analgesia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_atend_aval_analg_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_atend_aval_analg_pend_atual() FROM PUBLIC;

CREATE TRIGGER atend_aval_analg_pend_atual
	AFTER INSERT OR UPDATE ON atend_aval_analgesia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_atend_aval_analg_pend_atual();
