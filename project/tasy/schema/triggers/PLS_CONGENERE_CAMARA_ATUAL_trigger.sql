...
DROP TRIGGER IF EXISTS pls_congenere_camara_atual ON pls_congenere_camara CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_congenere_camara_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_congenere_camara_atual() FROM PUBLIC;

CREATE TRIGGER pls_congenere_camara_atual
	BEFORE INSERT OR UPDATE ON pls_congenere_camara FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_congenere_camara_atual();
