...
DROP TRIGGER IF EXISTS cih_pac_fat_risco_pend_atual ON cih_pac_fat_risco CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_cih_pac_fat_risco_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_cih_pac_fat_risco_pend_atual() FROM PUBLIC;

CREATE TRIGGER cih_pac_fat_risco_pend_atual
	AFTER INSERT OR UPDATE ON cih_pac_fat_risco FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_cih_pac_fat_risco_pend_atual();
