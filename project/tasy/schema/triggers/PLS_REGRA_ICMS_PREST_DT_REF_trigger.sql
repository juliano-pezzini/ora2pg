...
DROP TRIGGER IF EXISTS pls_regra_icms_prest_dt_ref ON pls_regra_icms_prest CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_regra_icms_prest_dt_ref() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_regra_icms_prest_dt_ref() FROM PUBLIC;

CREATE TRIGGER pls_regra_icms_prest_dt_ref
	BEFORE INSERT OR UPDATE ON pls_regra_icms_prest FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_regra_icms_prest_dt_ref();
