...
DROP TRIGGER IF EXISTS atendimento_alerta_pend_atual ON atendimento_alerta CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_atendimento_alerta_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_atendimento_alerta_pend_atual() FROM PUBLIC;

CREATE TRIGGER atendimento_alerta_pend_atual
	AFTER INSERT OR UPDATE ON atendimento_alerta FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_atendimento_alerta_pend_atual();
