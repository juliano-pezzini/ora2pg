...
DROP TRIGGER IF EXISTS atend_monit_resp_pend_atual ON atendimento_monit_resp CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_atend_monit_resp_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_atend_monit_resp_pend_atual() FROM PUBLIC;

CREATE TRIGGER atend_monit_resp_pend_atual
	AFTER INSERT OR UPDATE ON atendimento_monit_resp FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_atend_monit_resp_pend_atual();
