...
DROP TRIGGER IF EXISTS pac_hist_social_pend_atual ON paciente_hist_social CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pac_hist_social_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pac_hist_social_pend_atual() FROM PUBLIC;

CREATE TRIGGER pac_hist_social_pend_atual
	AFTER INSERT OR UPDATE ON paciente_hist_social FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pac_hist_social_pend_atual();
