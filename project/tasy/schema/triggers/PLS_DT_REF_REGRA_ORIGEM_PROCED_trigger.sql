...
DROP TRIGGER IF EXISTS pls_dt_ref_regra_origem_proced ON pls_regra_origem_proced CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_dt_ref_regra_origem_proced() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_dt_ref_regra_origem_proced() FROM PUBLIC;

CREATE TRIGGER pls_dt_ref_regra_origem_proced
	BEFORE INSERT OR UPDATE ON pls_regra_origem_proced FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_dt_ref_regra_origem_proced();
