...
DROP TRIGGER IF EXISTS pls_decl_seg_pend_atual ON pls_declaracao_segurado CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_decl_seg_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_decl_seg_pend_atual() FROM PUBLIC;

CREATE TRIGGER pls_decl_seg_pend_atual
	AFTER INSERT OR UPDATE ON pls_declaracao_segurado FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_decl_seg_pend_atual();
