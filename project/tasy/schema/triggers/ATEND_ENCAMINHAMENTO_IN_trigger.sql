...
DROP TRIGGER IF EXISTS atend_encaminhamento_in ON atend_encaminhamento CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_atend_encaminhamento_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_atend_encaminhamento_in() FROM PUBLIC;

CREATE TRIGGER atend_encaminhamento_in
	BEFORE INSERT OR UPDATE ON atend_encaminhamento FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_atend_encaminhamento_in();
