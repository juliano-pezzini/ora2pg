...
DROP TRIGGER IF EXISTS pls_segurado_doc_arq_atual ON pls_segurado_doc_arq CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_segurado_doc_arq_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_segurado_doc_arq_atual() FROM PUBLIC;

CREATE TRIGGER pls_segurado_doc_arq_atual
	BEFORE INSERT OR UPDATE ON pls_segurado_doc_arq FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_segurado_doc_arq_atual();
