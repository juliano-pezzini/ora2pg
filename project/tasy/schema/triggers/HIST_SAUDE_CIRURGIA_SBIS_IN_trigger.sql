...
DROP TRIGGER IF EXISTS hist_saude_cirurgia_sbis_in ON historico_saude_cirurgia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_hist_saude_cirurgia_sbis_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_hist_saude_cirurgia_sbis_in() FROM PUBLIC;

CREATE TRIGGER hist_saude_cirurgia_sbis_in
	BEFORE INSERT OR UPDATE ON historico_saude_cirurgia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_hist_saude_cirurgia_sbis_in();
