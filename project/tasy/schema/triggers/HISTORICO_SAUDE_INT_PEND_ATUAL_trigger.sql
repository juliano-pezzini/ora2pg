...
DROP TRIGGER IF EXISTS historico_saude_int_pend_atual ON historico_saude_internacao CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_historico_saude_int_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_historico_saude_int_pend_atual() FROM PUBLIC;

CREATE TRIGGER historico_saude_int_pend_atual
	AFTER INSERT OR UPDATE ON historico_saude_internacao FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_historico_saude_int_pend_atual();
