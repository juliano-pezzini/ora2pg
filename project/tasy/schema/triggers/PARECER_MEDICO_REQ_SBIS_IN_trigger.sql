...
DROP TRIGGER IF EXISTS parecer_medico_req_sbis_in ON parecer_medico_req CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_parecer_medico_req_sbis_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_parecer_medico_req_sbis_in() FROM PUBLIC;

CREATE TRIGGER parecer_medico_req_sbis_in
	BEFORE INSERT OR UPDATE ON parecer_medico_req FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_parecer_medico_req_sbis_in();
