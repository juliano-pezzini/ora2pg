...
DROP TRIGGER IF EXISTS escala_apgar_in ON escala_apgar CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_escala_apgar_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_escala_apgar_in() FROM PUBLIC;

CREATE TRIGGER escala_apgar_in
	BEFORE INSERT OR UPDATE ON escala_apgar FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_escala_apgar_in();
