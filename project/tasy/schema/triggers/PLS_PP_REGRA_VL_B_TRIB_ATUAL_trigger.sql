...
DROP TRIGGER IF EXISTS pls_pp_regra_vl_b_trib_atual ON pls_pp_regra_vl_base_trib CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_pp_regra_vl_b_trib_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_pp_regra_vl_b_trib_atual() FROM PUBLIC;

CREATE TRIGGER pls_pp_regra_vl_b_trib_atual
	BEFORE INSERT OR UPDATE ON pls_pp_regra_vl_base_trib FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_pp_regra_vl_b_trib_atual();
