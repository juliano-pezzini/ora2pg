...
DROP TRIGGER IF EXISTS hd_prc_avaliacao_befup_sign ON hd_prc_avaliacao CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_hd_prc_avaliacao_befup_sign() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_hd_prc_avaliacao_befup_sign() FROM PUBLIC;

CREATE TRIGGER hd_prc_avaliacao_befup_sign
	BEFORE UPDATE ON hd_prc_avaliacao FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_hd_prc_avaliacao_befup_sign();
