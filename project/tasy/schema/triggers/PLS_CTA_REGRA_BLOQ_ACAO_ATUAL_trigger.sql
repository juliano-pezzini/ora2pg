...
DROP TRIGGER IF EXISTS pls_cta_regra_bloq_acao_atual ON pls_cta_regra_bloq_acao CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_cta_regra_bloq_acao_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_cta_regra_bloq_acao_atual() FROM PUBLIC;

CREATE TRIGGER pls_cta_regra_bloq_acao_atual
	BEFORE INSERT OR UPDATE ON pls_cta_regra_bloq_acao FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_cta_regra_bloq_acao_atual();
