...
DROP TRIGGER IF EXISTS titulo_rec_liq_abat_acres_afte ON titulo_rec_liq_abat_acres CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_titulo_rec_liq_abat_acres_afte() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_titulo_rec_liq_abat_acres_afte() FROM PUBLIC;

CREATE TRIGGER titulo_rec_liq_abat_acres_afte
	AFTER INSERT OR UPDATE ON titulo_rec_liq_abat_acres FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_titulo_rec_liq_abat_acres_afte();
