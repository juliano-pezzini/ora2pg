...
DROP TRIGGER IF EXISTS pls_titulo_rec_liq_neg_after ON pls_titulo_rec_liq_neg CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_titulo_rec_liq_neg_after() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_titulo_rec_liq_neg_after() FROM PUBLIC;

CREATE TRIGGER pls_titulo_rec_liq_neg_after
	AFTER INSERT OR UPDATE ON pls_titulo_rec_liq_neg FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_titulo_rec_liq_neg_after();
