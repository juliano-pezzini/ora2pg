...
DROP TRIGGER IF EXISTS hist_saude_mulher_pend_atual ON historico_saude_mulher CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_hist_saude_mulher_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_hist_saude_mulher_pend_atual() FROM PUBLIC;

CREATE TRIGGER hist_saude_mulher_pend_atual
	AFTER INSERT OR UPDATE ON historico_saude_mulher FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_hist_saude_mulher_pend_atual();
