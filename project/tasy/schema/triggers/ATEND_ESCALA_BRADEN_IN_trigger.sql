...
DROP TRIGGER IF EXISTS atend_escala_braden_in ON atend_escala_braden CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_atend_escala_braden_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_atend_escala_braden_in() FROM PUBLIC;

CREATE TRIGGER atend_escala_braden_in
	BEFORE INSERT OR UPDATE ON atend_escala_braden FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_atend_escala_braden_in();
