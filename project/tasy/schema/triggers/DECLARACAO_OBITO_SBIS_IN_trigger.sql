...
DROP TRIGGER IF EXISTS declaracao_obito_sbis_in ON declaracao_obito CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_declaracao_obito_sbis_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_declaracao_obito_sbis_in() FROM PUBLIC;

CREATE TRIGGER declaracao_obito_sbis_in
	BEFORE INSERT OR UPDATE ON declaracao_obito FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_declaracao_obito_sbis_in();
