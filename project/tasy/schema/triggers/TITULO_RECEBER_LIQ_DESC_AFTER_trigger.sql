...
DROP TRIGGER IF EXISTS titulo_receber_liq_desc_after ON titulo_receber_liq_desc CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_titulo_receber_liq_desc_after() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_titulo_receber_liq_desc_after() FROM PUBLIC;

CREATE TRIGGER titulo_receber_liq_desc_after
	AFTER INSERT OR UPDATE ON titulo_receber_liq_desc FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_titulo_receber_liq_desc_after();
