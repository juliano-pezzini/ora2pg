...
DROP TRIGGER IF EXISTS apache_in ON apache CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_apache_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_apache_in() FROM PUBLIC;

CREATE TRIGGER apache_in
	BEFORE INSERT OR UPDATE ON apache FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_apache_in();
