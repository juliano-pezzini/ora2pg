...
DROP TRIGGER IF EXISTS anexo_agenda_after_update ON anexo_agenda CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_anexo_agenda_after_update() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_anexo_agenda_after_update() FROM PUBLIC;

CREATE TRIGGER anexo_agenda_after_update
	AFTER INSERT OR UPDATE ON anexo_agenda FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_anexo_agenda_after_update();
