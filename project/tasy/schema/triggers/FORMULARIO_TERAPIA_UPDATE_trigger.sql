...
DROP TRIGGER IF EXISTS formulario_terapia_update ON formulario_terapia CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_formulario_terapia_update() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_formulario_terapia_update() FROM PUBLIC;

CREATE TRIGGER formulario_terapia_update
	BEFORE UPDATE ON formulario_terapia FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_formulario_terapia_update();
