...
DROP TRIGGER IF EXISTS prescr_dieta_update_hl7_dixtal ON prescr_dieta CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_prescr_dieta_update_hl7_dixtal() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_prescr_dieta_update_hl7_dixtal() FROM PUBLIC;

CREATE TRIGGER prescr_dieta_update_hl7_dixtal
	AFTER UPDATE ON prescr_dieta FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_prescr_dieta_update_hl7_dixtal();
