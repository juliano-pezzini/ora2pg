...
DROP TRIGGER IF EXISTS pls_prestador_med_espec_delete ON pls_prestador_med_espec CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_prestador_med_espec_delete() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_prestador_med_espec_delete() FROM PUBLIC;

CREATE TRIGGER pls_prestador_med_espec_delete
	AFTER DELETE ON pls_prestador_med_espec FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_prestador_med_espec_delete();
