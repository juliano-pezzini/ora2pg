...
DROP TRIGGER IF EXISTS paciente_medic_uso_sbis_in ON paciente_medic_uso CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_paciente_medic_uso_sbis_in() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_paciente_medic_uso_sbis_in() FROM PUBLIC;

CREATE TRIGGER paciente_medic_uso_sbis_in
	BEFORE INSERT OR UPDATE ON paciente_medic_uso FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_paciente_medic_uso_sbis_in();
