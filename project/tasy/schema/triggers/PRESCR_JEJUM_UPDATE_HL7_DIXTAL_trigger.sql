...
DROP TRIGGER IF EXISTS prescr_jejum_update_hl7_dixtal ON rep_jejum CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_prescr_jejum_update_hl7_dixtal() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_prescr_jejum_update_hl7_dixtal() FROM PUBLIC;

CREATE TRIGGER prescr_jejum_update_hl7_dixtal
	AFTER UPDATE ON rep_jejum FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_prescr_jejum_update_hl7_dixtal();
