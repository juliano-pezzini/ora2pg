...
DROP TRIGGER IF EXISTS pls_regra_msg_mensal_atual ON pls_regra_msg_mensalidade CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pls_regra_msg_mensal_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pls_regra_msg_mensal_atual() FROM PUBLIC;

CREATE TRIGGER pls_regra_msg_mensal_atual
	BEFORE INSERT OR UPDATE ON pls_regra_msg_mensalidade FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pls_regra_msg_mensal_atual();
