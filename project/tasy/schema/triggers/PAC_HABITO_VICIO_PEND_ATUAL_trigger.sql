...
DROP TRIGGER IF EXISTS pac_habito_vicio_pend_atual ON paciente_habito_vicio CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pac_habito_vicio_pend_atual() RETURNS trigger AS $BODY$
declare
...
-- REVOKE ALL ON FUNCTION trigger_fct_pac_habito_vicio_pend_atual() FROM PUBLIC;

CREATE TRIGGER pac_habito_vicio_pend_atual
	AFTER INSERT OR UPDATE ON paciente_habito_vicio FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pac_habito_vicio_pend_atual();
