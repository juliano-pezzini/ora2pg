...
DROP TRIGGER IF EXISTS pcs_atributo_tp ON pcs_atributo CASCADE;
CREATE OR REPLACE FUNCTION trigger_fct_pcs_atributo_tp() RETURNS trigger AS $BODY$
...
-- REVOKE ALL ON FUNCTION trigger_fct_pcs_atributo_tp() FROM PUBLIC;

CREATE TRIGGER pcs_atributo_tp
	AFTER UPDATE ON pcs_atributo FOR EACH ROW
	EXECUTE PROCEDURE trigger_fct_pcs_atributo_tp();
