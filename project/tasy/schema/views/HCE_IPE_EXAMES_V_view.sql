...
select
	...
	0				qt_item,
	0				vl_matmed,
	round((sum(CASE WHEN c.cd_item_convenio=32200005 THEN c.qt_item  ELSE 0 END )*0.0645),2)
					vl_total_matmed,
	' '				nm_paciente,
	0 				cd_solicitante,
	' '				nm_arquivo_pdf
