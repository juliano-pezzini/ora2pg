...
CREATE OR REPLACE VIEW ptu_resposta_pedido_auto_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_guia, nr_seq_requisicao, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nr_seq_origem, cd_unimed, cd_usuario_plano, nm_beneficiario, dt_validade, ds_observacao, ie_tipo_tabela, cd_servico, ds_servico, ie_autorizado, qt_autorizada, cd_mens_espec_1, cd_mens_espec_2, cd_mens_espec_3, cd_mens_espec_4, cd_mens_espec_5, ds_fim) AS select	1				ie_tipo_registro,
	00401 				cd_transacao,
...
select	3				ie_tipo_registro,
	...
	ptu_obter_inconsist_trans(nr_seq_guia,nr_seq_requisicao,null,'00401',1,b.nr_sequencia,cd_servico) cd_mens_espec_1,
	ptu_obter_inconsist_trans(nr_seq_guia,nr_seq_requisicao,null,'00401',2,b.nr_sequencia,cd_servico) cd_mens_espec_2,
	ptu_obter_inconsist_trans(nr_seq_guia,nr_seq_requisicao,null,'00401',3,b.nr_sequencia,cd_servico) cd_mens_espec_3,
	ptu_obter_inconsist_trans(nr_seq_guia,nr_seq_requisicao,null,'00401',4,b.nr_sequencia,cd_servico) cd_mens_espec_4,
	ptu_obter_inconsist_trans(nr_seq_guia,nr_seq_requisicao,null,'00401',5,b.nr_sequencia,cd_servico) cd_mens_espec_5,
	''				ds_fim
