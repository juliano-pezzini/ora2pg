...
CREATE OR REPLACE VIEW analise_os_antiga_grupo_v (ie_registro, nr_seq_grupo, ds_grupo, dt_posicao, qt_total_ordens, qt_ordens_antigas, pr_ordens_antigas) AS select	a.ie_registro,
	a.nr_seq_grupo,
	a.ds_grupo,
	a.dt_posicao,
	a.qt_total_ordens,
...
FROM (
	...
	where 	c.nr_sequencia = a.nr_seq_grupo_des
