...
CREATE OR REPLACE VIEW eis_maddox_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_profissional, ie_faixa_etaria, ds_unidade, dt_avaliacao, cd_empresa, cd_estabelecimento, qt_ponto, ds_gradacao, nr_atendimento, cd_paciente) AS SELECT	DISTINCT
	...
	IE_INTENSIDADE qt_ponto,
	CASE WHEN IE_INTENSIDADE='0' THEN 'zero'  ELSE IE_INTENSIDADE END  ds_gradacao,
	a.nr_atendimento,
	a.cd_pessoa_fisica cd_paciente
FROM 	ESCALA_FLEBITE e,
	estabelecimento f,
