...
CREATE OR REPLACE VIEW pls_segurado_conta_imp_v (nr_sequencia, nr_seq_plano, cd_convenio, cd_categoria, qt_idade_anos, qt_idade_meses, ie_local_cadastro, ie_tipo_segurado, ie_pcmso, ie_sexo, ie_preco, nr_seq_contrato, nr_contrato, nr_seq_intercambio, ie_regulamentacao, dt_nascimento, dt_primeira_utilizacao, dt_contrato, dt_contratacao, nr_seq_titular, nr_seq_grupo_coop, cd_matricula_estipulante, ie_acomodacao, nr_seq_grupo_intercambio, nr_seq_congenere) AS select	a.nr_sequencia,
	a.nr_seq_plano,
