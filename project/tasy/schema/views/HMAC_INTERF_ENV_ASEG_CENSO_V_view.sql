...
CREATE OR REPLACE VIEW hmac_interf_env_aseg_censo_v (nr_ordem, nr_interno_conta, ie_tipo_registro, cd_chave_hospital, cd_chave_aseguradora, cd_chave_paciente, nm_paciente, dt_nascimento, ie_sexo, nr_quarto, dt_entrada_hospital, hr_entrada_hospital, cd_medico_resp, dt_saida, hr_saida, vl_total_cobrar, cd_icd, cd_cpd, ie_tipo_validacao, vl_perc_coparticipacao, vl_deduzido, vl_topo_coparticipacao, cd_codigo_produto, vl_perc_desc, qt_quantidade, vl_preco_unitario, ds_descricao, ds_grupo, dt_servico, ds_area) AS SELECT
        ...
        elimina_caractere_especial(substr(obter_nome_pf(b.cd_medico_resp), 1, 30))                                      cd_medico_resp,
        ...
        ''                                                                                                              cd_icd,
        ''                                                                                                              cd_cpd,
        CASE WHEN a.ie_status_acerto=1 THEN  'S' WHEN a.ie_status_acerto=2 THEN  'V' END                                                                       ie_tipo_validacao,
    ...
    WHERE
        ...
        AND a.cd_convenio_calculo = d.cd_convenio
...
UNION ALL
    ...
    SELECT
        ...
        lpad(campo_mascara_virgula(a.vl_unitario), 16, ' ')                                   vl_preco_unitario,
