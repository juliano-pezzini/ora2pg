...
CREATE OR REPLACE VIEW exp_dps_prefeitura_sp (tp_registro, ds_tipo_dps, nr_versao, nr_inscricao_municipal, nr_nota_fiscal, dt_emissao, cd_servico, ie_situacao, vl_servico, cd_estabelecimento, qt_linhas) AS select 	1                    tp_registro,
	'N'                   ds_tipo_dps, 
	'001'                  nr_versao, 
...
select	2                   tp_registro, 
	...
	lpad(coalesce(substr(elimina_caractere_especial(obter_dados_grupo_servico_item(obter_item_servico_proced(obter_procedimento_nfse(n.nr_sequencia,'P'), obter_procedimento_nfse(n.nr_sequencia,'O')),'CD')),1,5), obter_dados_pf_pj_estab(n.cd_estabelecimento, null, n.cd_cgc_emitente, 'ATIV')),5,'0') cd_servico, 
