...
CREATE OR REPLACE VIEW ptu_movimento_sos_2_v (nr_seq_benef, nr_seq_lote, cd_unimed, cd_empresa, cd_familia, cd_dependencia, nm_benef, dt_nascimento, ie_sexo, ie_estado_civil, dt_inclusao_sos, dt_exclusao_sos, ie_tipo_cliente, ds_endereco, ds_complemento, ds_bairro, ds_cidade, sg_uf, cd_cep, nr_ddd, nr_telefone, nm_pessoa_contato, cd_unimed_origem, nr_digito_verificador) AS select	d.nr_sequencia									nr_seq_benef,
	a.nr_sequencia									nr_seq_lote,
	d.cd_unimed									cd_unimed,
	substr(d.cd_usuario_plano,1,4)							cd_empresa,
	substr(d.cd_usuario_plano,5,6)							cd_familia,
	substr(d.cd_usuario_plano,11,2)							cd_dependencia,
	d.nm_beneficiario 								nm_benef,
	d.dt_nascimento									dt_nascimento,
	d.ie_sexo									ie_sexo,
	CASE WHEN d.ie_estado_civil='A' THEN 'D' WHEN d.ie_estado_civil='D' THEN 'D' WHEN d.ie_estado_civil='M' THEN 'C' WHEN d.ie_estado_civil='S' THEN 'S' WHEN d.ie_estado_civil='W' THEN 'V' WHEN d.ie_estado_civil='U' THEN 'O' END 	ie_estado_civil,
