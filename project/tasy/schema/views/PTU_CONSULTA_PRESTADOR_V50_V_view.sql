...
CREATE OR REPLACE VIEW ptu_consulta_prestador_v50_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_guia, nr_seq_requisicao, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nm_prestador, cd_cgc_cpf, sg_cons_profissional, nr_cons_profissional, uf_cons_profissional, ds_fim, nr_versao) AS select	1				ie_tipo_registro,
	00418				cd_transacao,
