...
CREATE OR REPLACE VIEW eis_escala_crib_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_profissional, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_pontos, cd_empresa, cd_estabelecimento, nr_atendimento, ds_grau) AS select	coalesce(a.cd_setor_atendimento,obter_setor_atend_data(a.nr_atendimento, e.dt_avaliacao)) cd_setor_atendimento,
	...
	a.nr_atendimento, 
	SUBSTR(Obter_grau_CRIB(QT_PONTOS),1,100) ds_grau 
FROM 	escala_crib e, 
	estabelecimento f, 
