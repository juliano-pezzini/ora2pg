...
CREATE OR REPLACE VIEW pls_resumo_mens_plano_v (ie_reg, dt_mesano_referencia, ds_plano, vl_item_individual, vl_item_coletivo, vl_item_cancelado, vl_item_estorno, vl_antec_estorno, vl_aberto, vl_pro_rata_dia, vl_antecipacao) AS select	1 ie_reg,
	trunc(b.dt_mesano_referencia,'month') dt_mesano_referencia,
	substr(d.ds_plano,1,55) ds_plano,
...
group by	d.ds_plano,trunc(b.dt_mesano_referencia,'month')
