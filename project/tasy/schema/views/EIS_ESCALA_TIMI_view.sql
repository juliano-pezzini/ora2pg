...
CREATE OR REPLACE VIEW eis_escala_timi (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_ponto, pr_morte_infarto, pr_morte_infarto_revasc, cd_empresa, cd_estabelecimento, nr_atendimento, cd_paciente) AS SELECT	DISTINCT
	...
	e.dt_avaliacao, 
	e.QT_ESCORE qt_ponto, 
	PR_MORTE_INFARTO, 
	PR_MORTE_INFARTO_REVASC, 
	f.cd_empresa, 
	a.cd_estabelecimento, 
	a.nr_atendimento, 
	a.cd_pessoa_fisica cd_paciente 
FROM 	ATEND_TIMI_RISK e, 
	estabelecimento f, 
