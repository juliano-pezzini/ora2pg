...
CREATE OR REPLACE VIEW receita_conta_paciente_v (dt_entrada_unidade, nr_atendimento, ie_proc_mat, dt_conta, dt_item, cd_item, qt_item, vl_item, vl_medico, vl_anestesista, vl_filme, vl_auxiliares, vl_custo_operacional, nr_interno_conta, dt_acerto_conta, dt_acerto_convenio, cd_convenio_parametro, cd_categoria, cd_setor_atendimento, cd_motivo_exc_conta, vl_unitario, cd_conta_contabil, nr_lote_contabil, ds_conta_receita, dt_mesano_referencia, dt_mesano_contabil) AS select	to_date(to_char(a.dt_entrada_unidade, 'DD/MM/YYYY'),'DD/MM/YYYY') dt_entrada_unidade,
	a.nr_atendimento,
	1 ie_proc_mat,
	a.dt_conta,
