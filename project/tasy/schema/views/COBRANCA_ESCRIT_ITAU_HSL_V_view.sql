...
SELECT	1				tp_registro, 
	...
	CASE WHEN c.cd_ocorrencia='06' THEN  coalesce(b.dt_pagamento_previsto, b.dt_vencimento)  ELSE coalesce(b.dt_pagamento_previsto, b.dt_vencimento) END  dt_vencimento, 
