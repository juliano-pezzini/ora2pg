...
CREATE OR REPLACE VIEW ptu_pedido_autorizacao_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_requisicao, nr_seq_guia, ie_tipo_cliente, cd_unimed_exec, cd_unimed_benef, nr_ident_exec, cd_unimed, cd_usuario_plano, nr_via_cartao, cd_cid, ie_alto_custo, nm_prestador, cd_unimed_prest_req, cd_prestador_requisitante, cd_unimed_prestador, cd_prestador, cd_especialidade_medica, qt_dias_doenca, ie_urgencia_emergencia, dt_atendimento, ds_observacao, ds_indicacao_clinica, ds_biometria, tp_tabela, cd_procedimento, qt_procedimento, ds_opme, vl_procedimento, ds_fim) AS select	1					ie_tipo_registro,
	00500					cd_transacao,
...
select	2					ie_tipo_registro,
	...
	Elimina_Acentuacao(ds_ind_clinica)	ds_indicacao_clinica,
