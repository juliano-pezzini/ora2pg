...
CREATE OR REPLACE VIEW pls_resumo_mens_forma_cobr_v (ie_reg, dt_mesano_referencia, ds_forma_cobranca, vl_item_individual, vl_item_coletivo, vl_item_cancelado, vl_item_estorno, vl_antec_estorno, vl_aberto, vl_pro_rata_dia, vl_pro_rata_individual, vl_pro_rata_coletivo, vl_antecipacao, vl_antecipacao_individual, vl_antecipacao_coletivo, cd_estabelecimento) AS select	1 ie_reg,
...
FROM (	select	b.dt_mesano_referencia dt_mesano_referencia,
		substr(obter_valor_dominio(1720,e.nr_seq_forma_cobranca),1,255) ds_forma_cobranca,
...
select	2 ie_reg,
	...
	substr(obter_valor_dominio(1720,e.nr_seq_forma_cobranca),1,100)||'/ destacado' ds_forma_cobranca,
	sum(CASE WHEN d.ie_tipo_contratacao='I' THEN a.vl_item END ) vl_item_individual,
	sum(CASE WHEN substr(d.ie_tipo_contratacao,1,1)='C' THEN a.vl_item END ) vl_item_coletivo,
