...
CREATE OR REPLACE VIEW ptu_mov_produto_v (tp_registro, nr_sequencia, cd_tipo_registro, nr_seq_movimentacao, cd_unimed_des, cd_unimed_ori, dt_geracao, ie_tipo_mov, dt_mov_inicio, dt_mov_fim, tp_protudo, nr_versao_trans, cd_filial, nm_empr_compl, nm_empr_abre, tp_pessoa_con, cd_cgc_cpf302, cd_insc_est, ds_end_pri302, ds_end_cpl, ds_bairro302, nr_cep302, ds_cidade302, cd_uf302, nr_ddd302, nr_fone302, nr_fax, dt_incl_uni302, dt_excl_uni, cd_empr_ori302, ie_tipo_natureza, cd_munic, cd_uni, id_benef, cd_familia, nm_benef, cd_plano_des, cd_plano_desc, dt_nasc, ie_sexo, cd_cgc_cpf304, cd_rg, cd_uf_rg, cd_civil, dt_incl_uni304, dt_exclu_uni, cd_depe, dt_repasse, dt_base_carencia, dt_incl_plano, dt_incl_empr_uni, vl_mensalidade, cd_uni_ant, id_benef_ant, id_benef_tit, nm_compl_benef, tp_prazo_beneficio, id_filho, cd_empr_ori304, ie_tipo_acomodacao, cd_ident, ds_orgao_emissor, cd_pais, cd_plano, nr_cartao_nac_sus, ds_end_pri306, ds_bairro306, nr_cep306, ds_cidade306, cd_uf306, nr_ddd306, nr_fone306, nr_ramal, qt_tot_r302, qt_tot_r304, qt_tot_r306, qt_tot_alt, qt_tot_plano, qt_tot_incl, qt_tot_excl, nr_seq_benef, nr_seq_empresa) AS select	1			tp_registro,
	null			nr_sequencia,
...
select	2			tp_registro,
	...
	nr_seq_mov_produto	nr_seq_movimentacao,
	null			cd_unimed_des,
	null			cd_unimed_ori,
	null			dt_geracao,
	null			ie_tipo_mov,
...
select	3			tp_registro,
	...
	b.nr_seq_mov_produto	nr_seq_movimentacao,
	null			cd_unimed_des,
	null			cd_unimed_ori,
	null			dt_geracao,
	null			ie_tipo_mov,
	...
	from	pls_plano	x,
		pls_sca_vinculo	z
	where	a.nr_seq_vinculo_sca	= z.nr_sequencia
	and	x.nr_sequencia		= z.nr_seq_plano) cd_plano_desc,
