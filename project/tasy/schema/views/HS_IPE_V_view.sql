...
select
	...
	(sum(CASE WHEN c.tp_nota=76 THEN  CASE WHEN c.ie_responsavel_credito='IPEOP' THEN c.qt_item *c.vl_unitario_item  ELSE CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN  c.vl_total_item  ELSE c.qt_item *c.vl_unitario_item END  END  WHEN c.tp_nota=86 THEN  CASE WHEN c.ie_responsavel_credito='IPEOP' THEN c.qt_item *c.vl_unitario_item  ELSE CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN  c.vl_total_item  ELSE c.qt_item *c.vl_unitario_item END  END   ELSE 0 END ) +
	...
	sum(CASE WHEN c.tp_nota=76 THEN  CASE WHEN c.ie_responsavel_credito='IPEOP' THEN c.qt_item *c.vl_unitario_item  ELSE CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN  c.vl_total_item  ELSE c.qt_item *c.vl_unitario_item END  END  WHEN c.tp_nota=86 THEN  CASE WHEN c.ie_responsavel_credito='IPEOP' THEN c.qt_item *c.vl_unitario_item  ELSE CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN  c.vl_total_item  ELSE c.qt_item *c.vl_unitario_item END  END   ELSE 0 END ) vl_total_despesa,
...
select
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN c.ie_responsavel_credito='IPEOP' THEN c.qt_item *c.vl_unitario_item  ELSE CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN  c.vl_total_item  ELSE c.qt_item *c.vl_unitario_item END  END ) vl_total_item,
...
select
	...
	c.ie_urgencia			ie_urgencia,
	0				vl_honorario,
	CASE WHEN c.ie_responsavel_credito='IPEOP' THEN c.qt_item *c.vl_unitario_item  ELSE CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN  c.vl_total_item  ELSE c.qt_item *c.vl_unitario_item END  END  vl_total_item,
	0				vl_total_matmed,
