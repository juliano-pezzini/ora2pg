...
CREATE OR REPLACE VIEW protocolo_convenio_item_v2 (dt_entrada_unidade, nr_atendimento, ie_proc_mat, dt_conta, dt_item, cd_item, cd_item_convenio, qt_item, vl_item, vl_medico, vl_anestesista, vl_filme, vl_auxiliares, vl_custo_operacional, vl_desconto, nr_interno_conta, nr_conta_convenio, dt_acerto_conta, dt_acerto_convenio, cd_convenio, cd_categoria, cd_setor_atendimento, ds_item, tp_item, ds_subgrupo_item, ds_unidade, cd_motivo_exc_conta, ie_cobra_pf_pj, vl_unitario, nr_protocolo, nr_seq_protocolo, cd_convenio_protocolo, dt_mesano_protocolo, cd_convenio_parametro, dt_mesano_referencia, dt_periodo_inicial, dt_periodo_final, ie_status_acerto, ie_cancelamento, cd_autorizacao, nr_sequencia, nr_prescricao, nr_sequencia_prescricao, cd_medico_executor, nr_lote_contabil, ie_funcao_medico, ie_origem_proced, ie_tipo_servico_sus, cd_setor_receita, nr_seq_proc_pacote, cd_cgc_prestador, nr_seq_apresent, vl_original, tx_procedimento, ie_status_protocolo, dt_vencimento, nr_seq_proc_princ) AS SELECT	TO_DATE(TO_CHAR(A.DT_ENTRADA_UNIDADE, 'DD/MM/YYYY'),'DD/MM/YYYY') DT_ENTRADA_UNIDADE,
	A.NR_ATENDIMENTO, 
	1 IE_PROC_MAT, 
	A.DT_CONTA, 
