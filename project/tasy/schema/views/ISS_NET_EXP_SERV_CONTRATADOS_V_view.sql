...
CREATE OR REPLACE VIEW iss_net_exp_serv_contratados_v (tp_registro, nr_sequencia, cd_estabelecimento, dt_emissao, valor_registro) AS SELECT	1																	TP_REGISTRO,	
	null																	NR_SEQUENCIA,											
...
select  2																							TP_REGISTRO,
	...
	CASE WHEN upper(obter_dados_pf_pj(a.cd_pessoa_fisica, a.cd_cgc_emitente, 'CDMDV'))=upper(obter_dados_pf_pj(null, e.cd_cgc, 'CDMDV')) THEN '7'  ELSE '4' END 	||';'|| --cd_modelo pode ou a.cd_serie_nf,
