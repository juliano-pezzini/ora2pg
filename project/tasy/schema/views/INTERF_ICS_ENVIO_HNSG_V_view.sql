...
WHERE b.nr_sequencia                =
        (select coalesce(min(x.nr_sequencia),b.nr_sequencia)
                from w_interf_conta_autor x
                where a.nr_interno_conta = x.nr_interno_conta) and a.nr_interno_conta        = c.nr_interno_conta and c.cd_area_proc                in (1,2,3,4,7) group by
        a.nr_seq_protocolo,
        a.nr_interno_conta,
