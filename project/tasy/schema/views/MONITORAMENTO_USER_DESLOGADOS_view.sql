...
from	( 
	select	a.nm_usuario,
		...
		(	select CASE WHEN count(*)=0 THEN  'N'  ELSE 'S' END   
			from	tasy_controle_login z  
			where trunc(z.dt_acesso) = trunc(LOCALTIMESTAMP)   
			and	z.ds_aplicacao = 'TasySwing'   
			and	z.dt_saida is null   
			and	upper(z.ds_maquina) = upper(a.ds_maquina_chamada)) ie_usuario_logado,
