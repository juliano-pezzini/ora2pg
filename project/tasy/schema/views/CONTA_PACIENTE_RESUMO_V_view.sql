...
CREATE OR REPLACE VIEW conta_paciente_resumo_v (cd_convenio, ds_convenio, dt_mesano_referencia, ie_status_protocolo, nr_seq_protocolo, nr_atendimento, ie_tipo_atendimento, ie_tipo_convenio, cd_setor_receita, cd_setor_atendimento, cd_conta_contabil, cd_especialidade, nr_seq_grupo_rec, cd_estrutura_conta, ds_setor_receita, cd_estabelecimento, vl_mat, vl_medic, qt_paciente, qt_exame, nr_diarias, vl_medico, vl_medico_fora_conta, vl_material, vl_diaria, vl_sadt_fora_conta, vl_custo, vl_proced, vl_item, vl_total_receita, vl_imposto, qt_item, vl_procedimento, vl_repasse_calc, vl_original, cd_medico_resp) AS select	c.cd_convenio,
	d.ds_convenio, 
