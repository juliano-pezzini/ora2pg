...
CREATE OR REPLACE VIEW cus_paciente_cc_2_v (cd_estabelecimento, dt_referencia, cd_centro_controle, qt_distribuicao) AS select 	a.cd_estabelecimento,
	a.dt_referencia, 
...
and 	ie_periodo = 'M' 
--and	s.cd_centro_custo in ()	-- aqui entre parêntesis devem ser definidos os centros de controle 
