...
CREATE OR REPLACE VIEW ptu_cancelamento_v (cd_transacao, ie_tipo_registro, nr_sequencia, nr_seq_guia, nr_seq_requisicao, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nr_seq_origem, ds_fim) AS select	00211				cd_transacao,
	1				ie_tipo_registro,
