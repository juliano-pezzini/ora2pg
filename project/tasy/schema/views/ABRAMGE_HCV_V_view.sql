...
SELECT		'CABECALHO CONTA   '		DS_REGISTRO, 
		...
		coalesce(somente_numero(substr(obter_unidade_atendimento(B.nr_atendimento,'MTI','CTA'),1,1)),0) CD_ACOMODACAO, 
