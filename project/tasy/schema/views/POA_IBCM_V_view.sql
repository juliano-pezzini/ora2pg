...
CREATE OR REPLACE VIEW poa_ibcm_v (ds_registro, tp_registro, ie_apresentacao, nr_seq_protocolo, cd_convenio, dt_competencia, vl_total_fatura, dt_atendimento, nr_matricula_ibcm, nr_matricula_ipe, cd_categoria, tp_procedimento, cd_item, nm_paciente, vl_total_item, nr_cremers, nr_parcelas) AS SELECT	'CABEÇALHO' DS_REGISTRO,
	1 TP_REGISTRO,
	0 IE_APRESENTACAO,
	A.NR_SEQ_PROTOCOLO,
	66 CD_CONVENIO,
...
SELECT	'DETALHE' DS_REGISTRO,
	...
	lpad(A.ie_tipo_atendimento,13,0) NR_MATRICULA_IPE,
	CASE WHEN A.cd_convenio=55 THEN Obter_Categoria_Atendimento(A.nr_atendimento)  ELSE '' END  CD_CATEGORIA,
	'06' 	TP_PROCEDIMENTO,
...
group by
	...
	CASE WHEN A.cd_convenio=55 THEN Obter_Categoria_Atendimento(A.nr_atendimento)  ELSE '' END ,
	B.cd_item_convenio,
