...
WHERE a.cd_agenda		= b.cd_agenda  and a.cd_tipo_agenda	= 1       and a.cd_tipo_agenda	= v.vl_dominio and v.cd_dominio		= 34 and b.ie_status_agenda	= i.vl_dominio and i.cd_dominio		= 83;
