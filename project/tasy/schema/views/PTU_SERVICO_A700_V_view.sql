...
CREATE OR REPLACE VIEW ptu_servico_a700_v (nr_seq_servico, tp_registro, nr_sequencia, nr_seq_geracao, id_benef, cd_tipo_registro, cd_unimed_destino, cd_unimed_origem, dt_geracao, dt_inicio_pagto, dt_fim_pagto, nr_versao_transacao, nr_lote, nr_nota, reservado_1, cd_unimed, reservado_2, cd_usuario_plano, nm_beneficiario, dt_atendimento, reservado_3, cd_excecao, ie_carater_atendimento, reservado_4, reservado_5, cd_cid, reservado_6, ie_paciente, ie_tipo_saida_spdat, ie_tipo_atendimento, nr_guia_principal, nr_lote_703, nr_nota_703, cd_uni_hosp, cd_hosp, nm_hosp, tp_acomodacao, dt_internacao, dt_alta, ft_mult_amb, tp_ind_acidente, tp_saida, cgc_hospital, tp_internacao, qt_nasc_vivos, qt_nasc_mortos, qt_nasc_vivos_pre, qt_obito_precoce, qt_obito_tardio, id_int_obstetricia_1, id_int_obstetricia_2, id_int_obstetricia_3, id_int_obstetricia_4, id_int_obstetricia_5, id_int_obstetricia_6, id_int_obstetricia_7, id_int_obstetricia_8, id_int_obstetricia_9, tp_faturamento, cd_cid_obito, nr_declara_vivo_1, nr_declara_vivo_2, nr_declara_vivo_3, nr_declara_vivo_4, nr_declara_vivo_5, ie_obito_mulher, nr_declara_obito, cd_cid_obito_1, cd_cid_obito_2, cd_cid_obito_3, cd_cid_obito_4, cd_cid_obito_5, nr_declara_obito_1, nr_declara_obito_2, nr_declara_obito_3, nr_declara_obito_4, nr_declara_obito_5, nr_lote_704, nr_nota_704, id_copartic, cd_unimed_prestador, cd_prestador, nm_prestador, ie_tipo_participacao, dt_procedimento, dt_pagamento, ie_tipo_tabela, cd_procedimento, qt_procedimento, vl_procedimento, vl_custo_operacional, vl_filme, cd_porte_anestesico, cd_unimed_autorizadora, reservado_7, reservado_8, cd_unimed_pre_req, cd_prestador_req, ie_via_acesso, reservado_9, reservado_10, reservado_11, vl_adic_procedimento, vl_adic_co, vl_adic_filme, cd_especialidade, ie_tipo_prestador, ie_rede_propria, ie_tipo_pessoa_prestador, nr_cgc_cpf, ie_pacote, cd_ato, tx_procedimento, nr_seq_nota, ds_hora_procedimento, cd_cnes_prest, nm_profissional_prestador, sg_cons_prof_prest, nr_cons_prof_prest, sg_uf_cons_prest, reservado_12, nr_cgc_cpf_req, nm_prestador_requisitante, sg_cons_prof_req, nr_cons_prof_req, sg_uf_cons_req, ie_reembolso, nr_autorizacao, nr_lote_705, nr_nota_705, tp_reg_cpl, ie_tipo_complemento, ds_complemento, nr_nota_fiscal, ds_link_nfe, qt_tot_r702, qt_tot_r703, qt_tot_r704, qt_tot_r705, qt_tot_serv, vl_tot_serv, vl_tot_co, vl_tot_filme, reservado, dt_postagem, nr_protocolo, nr_ver_tra) AS select	/*+ USE_CONCAT*/	nr_sequencia		nr_seq_servico,
	1			tp_registro,
	1			nr_sequencia,
	...
	dt_inicio_pagto		dt_inicio_pagto,
	dt_fim_pagto		dt_fim_pagto,
...
select	nr_seq_serv_pre_pagto	nr_seq_servico,
	...
	null			dt_geracao,
	LOCALTIMESTAMP			dt_inicio_pagto,
	null			dt_fim_pagto,
	...
	ie_tipo_saida_spdat	ie_tipo_saida_spdat,
...
select	b.nr_seq_serv_pre_pagto		nr_seq_servico,
	...
	substr(ptu_obter_proced_conversao_700(a.cd_procedimento,a.ie_origem_proced, a.cd_prestador, b.cd_unimed),1,15)	cd_procedimento,
...
select	nr_sequencia		nr_seq_servico,
	...
	ptu_obter_qt_registro_serv(nr_sequencia, 'vl_co')		vl_tot_co,
	ptu_obter_qt_registro_serv(nr_sequencia, 'vl_fi')		vl_tot_filme,
	null			reservado,
	null			dt_postagem,
	null			nr_protocolo,
	'F15'			nr_ver_tra
