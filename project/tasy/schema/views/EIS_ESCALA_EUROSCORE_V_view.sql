...
CREATE OR REPLACE VIEW eis_escala_euroscore_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_score, cd_empresa, cd_estabelecimento, nm_pessoa_fisica) AS select	distinct
