...
CREATE OR REPLACE VIEW ptu_confirmacao_v50_v (cd_transacao, ie_tipo_registro, nr_sequencia, nr_seq_requisicao, nr_seq_guia, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nr_seq_origem, ie_tipo_identificador, ie_tipo_resposta, nr_versao, ds_fim) AS select	00309				cd_transacao,
	1				ie_tipo_registro,
