...
CREATE OR REPLACE VIEW ptu_resp_consulta_prest_v40_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_requisicao, nr_seq_guia, ie_tipo_cliente, cd_unimed_executora, nr_seq_execucao, cd_unimed_beneficiario, ie_confirmacao, cd_mens_erro, nr_seq_origem, cd_unimed_prestador, ie_alto_custo, nm_prestador, cd_prestador, cd_especialidade, ds_fim) AS select	1				ie_tipo_registro,
	00419				cd_transacao,
	...
	ptu_obter_inconsist_trans_v40(null,null,nr_seq_origem,'00419',1,null,null) cd_mens_erro,
