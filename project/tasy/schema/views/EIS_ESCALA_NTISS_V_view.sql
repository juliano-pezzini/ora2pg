...
CREATE OR REPLACE VIEW eis_escala_ntiss_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_ponto, cd_empresa, cd_estabelecimento, ds_gradacao, nr_atendimento, cd_paciente) AS SELECT	DISTINCT
	...
	e.dt_avaliacao, 
	e.qt_pto_total qt_ponto, 
	f.cd_empresa, 
	a.cd_estabelecimento, 
	SUBSTR(obter_classif_tiss(qt_pto_total),1,255) ds_gradacao, 
	a.nr_atendimento, 
