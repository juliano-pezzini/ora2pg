...
CREATE OR REPLACE VIEW grafico_burndown_prog_v (nr_seq_programa, dt_ref, qt_hr_previstas, qt_hr_residuais) AS select	r.nr_seq_programa,
		r.dt_ref,
	  ...
	  select t.*
		,coalesce((
			...
			where  	pf.nr_sequencia = pr.nr_seq_portifolio
			  ...
			  and 	pr.nr_sequencia = t.nr_seq_programa
			  and 	e1.ie_fase = 'N'
