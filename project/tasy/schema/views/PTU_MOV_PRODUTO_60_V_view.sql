...
select	b.nr_seq_mov_produto		nr_seq_movimentacao,
	...
	nr_rg				cd_rg,
	substr(pls_obter_campos_null_a300(a.nr_seq_empresa, a.nr_seq_segurado, 'UF'),1,50) cd_uf_rg,
	...
	a.cd_usuario_plano_ant		id_benef_ant,
	a.cd_titular_plano		id_benef_tit,
	...
	substr(pls_obter_campos_null_a300(a.nr_seq_empresa, a.nr_seq_segurado, 'RG'),1,50) cd_ident,
	substr(pls_obter_campos_null_a300(a.nr_seq_empresa, a.nr_seq_segurado, 'OE'),1,50) ds_orgao_emissor,
	substr(pls_obter_campos_null_a300(a.nr_seq_empresa, a.nr_seq_segurado, 'P'),1,50) cd_pais,
	a.cd_plano			cd_plano,
