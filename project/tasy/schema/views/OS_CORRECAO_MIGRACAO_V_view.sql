...
CREATE OR REPLACE VIEW os_correcao_migracao_v (nr_seq_projeto, nr_seq_os, nr_seq_os_teste, ds_dano_breve, ds_estagio, nm_executor, dt_os, nr_seq_grupo_desenv_proj, nr_seq_grupo_desenv_os, nr_seq_estagio_os, cd_funcao, ie_resp_teste) AS select	p.nr_sequencia nr_seq_projeto,
