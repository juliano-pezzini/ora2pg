...
CREATE OR REPLACE VIEW curva_abc_v2 (dt_mesano_referencia, cd_estabelecimento, cd_local_estoque, cd_material, cd_material_comercial, ie_consignado, ie_curva_abc, cd_grupo_material, ds_grupo_material, cd_centro_custo, ds_centro_custo, qt_estoque, vl_estoque) AS select	a.dt_mesano_referencia,
