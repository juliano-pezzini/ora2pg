...
CREATE OR REPLACE VIEW w_copia_rep_v (nr_seq_ordem, ds_item, nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec, nr_prescricao, ie_tipo_item, qt_item, cd_unidade_medida, cd_intervalo, ie_via_aplicacao, nr_seq_item, cd_item, ie_copiar, hr_prim_horario, ds_intervalo_sol, nr_seq_apres_grupo, nr_seq_apres_inf, ie_superior_composto, ds_horarios, ie_duplicado, ie_mesma_vigencia, ds_dose_diferenciada) AS select	obter_ordem_informacoes_gestao(ie_tipo_item, 'R', null) nr_seq_ordem,
	('          ' || ds_item) ds_item,
	nr_sequencia,
	dt_atualizacao,
	nm_usuario,
