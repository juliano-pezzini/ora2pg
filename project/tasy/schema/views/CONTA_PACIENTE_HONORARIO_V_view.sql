...
CREATE OR REPLACE VIEW conta_paciente_honorario_v (ie_emite_conta, nr_interno_conta_proc, nr_interno_conta, ie_cancelamento, cd_procedimento, ie_origem_proced, cd_procedimento_convenio, ds_procedimento, dt_procedimento, dt_conta, dt_conta_dia, qt_procedimento, vl_medico, vl_unitario, vl_procedimento, vl_custo_operacional, vl_proc_custo_oper, vl_medico_custo_oper, vl_total_medico_custo_oper, cd_setor_atendimento, ds_setor_atendimento, ds_classif_setor, nm_medico, qt_pto_medico, qt_pto_medico_ajust, qt_pto_auxiliares, qt_pto_anestesista, qt_pto_custo_oper, qt_pto_procedimento, nr_crm, nr_crm_dig, pr_participacao, tx_procedimento, ie_funcao_medico, ds_funcao, nr_sequencia, nr_seq_proc_pacote, ie_responsavel_credito, ds_responsavel_credito, cd_unidade_basica, cd_unidade_compl, cd_tipo_acomodacao_pac, ds_tipo_acomodacao_pac, cd_medico, dt_item, qt_porte_anestesico, pr_via_acesso, cd_procedimento_princ, nr_cpf_medico, cd_cgc_medico, cd_cgc_cpf_medico, ie_cobra_pf_pj, ie_corpo_clinico, uf_crm, ie_vinculo_medico, cd_motivo_exc_conta, cd_especialidade, cd_cgc_prestador, cd_cgc_cpf_resp_cred, cd_funcao_espec_med, nr_prescricao, dt_prescricao, nr_seq_autorizacao, nr_doc_convenio, nr_seq_protocolo, nr_atendimento, cd_convenio, dt_mesano_referencia, cd_proc_ref, cd_proc_ref_conv, ie_emite_conta_honor, ie_emite_conta_hosp, vl_filme, cd_proc_convenio, ds_proc_convenio, ie_video, pr_procedimento, pr_faturado, ie_participante, ds_especialidade, cd_medico_convenio, cd_medico_crm_convenio, ie_via_acesso, cd_tipo_procedimento, cd_grupo_proc, nr_cirurgia, qt_tempo_cirurgia, qt_tempo_anestesia, ds_tipo_anestesia, hr_conta, hr_execucao, tx_hora_extra, ds_hora_extra, nr_seq_atepacu, ds_resp_credito, cd_tipo_acomod_int, ds_tipo_acomod_int, vl_desconto, cd_prestador, qt_pto_medico_ajus, vl_medio_proc, vl_medio_medico, vl_proced_bruto, nm_medico_prescricao, cd_senha, cd_estabelecimento, vl_proced_origem, cd_proc_esp, nr_seq_proc_princ, ie_espaco, vl_bruto, cd_autorizacao, nr_doc_honor_conv, vl_ch_honorarios, ds_proc_int_conv_orig, cd_categoria_parametro, nr_seq_ajuste_proc, ds_convenio, cd_atuacao, cd_proc_princ_cirurgia, ds_proc_princ_cirurgia, dt_inicio_procedimento, nr_seq_proc_crit_hor, cd_proc_principal, ds_proc_principal, cd_categoria_locate, vl_medico_custo_mat, dt_inicio_cirurgia, dt_proc_agrupado, cd_profissional, vl_auxiliares, vl_anestesista, nm_fantasia_prest, ie_valor_informado, dt_inicio_real, dt_termino, vl_total_bruto, cd_procedimento_tuss, vl_unitario_bruto, ie_conferencia, cd_especialidade_proc, tx_ajuste_percentual, vl_proc_original, cd_porte_cbhpm, vl_proc_sem_glosa, ds_procedimento_tuss, cd_proc_transicao_tuss, ds_proc_transicao_tuss, cd_proced_tuss, ds_proced_tuss, cd_proc_conv_tuss, ds_via_hemodinamica, vl_custo_mat, vl_repasse_calc, ds_classif_agrup, vl_med_conta, cd_conv_tuss_proc, ds_cgc_cpf_medico, nr_seq_apresent, ds_lado, ie_reapresentacao_sus, nr_fone_integracao, dt_ligacao_integracao, ds_proc_conv_tuss, nr_seq_proc_interno, nr_ato_ipasgo, cd_cgc_partic) AS select
	...
	substr(obter_crm_medico(g.cd_pessoa_fisica), 1, 20) nr_crm,
	substr(obter_crm_medico(g.cd_pessoa_fisica), 1, 20) || calcula_digito('Modulo11',substr(obter_crm_medico(g.cd_pessoa_fisica), 1, 20)) nr_crm_dig,
	100 pr_participacao,
	1 tx_procedimento,
	a.ie_funcao_medico,
	w.ds_funcao,
	...
	g.ie_cobra_pf_pj,
	g.ie_corpo_clinico,
	substr(obter_uf_crm_medico(g.cd_pessoa_fisica), 1, 15) uf_crm,
	g.ie_vinculo_medico,
	...
	coalesce(a.cd_medico_convenio, substr(obter_crm_medico(g.cd_pessoa_fisica), 1, 20)) cd_medico_crm_convenio,
	a.ie_via_acesso,
	...
	a.nr_seq_atepacu,
	CASE WHEN a.ie_responsavel_credito='M' THEN 	CASE WHEN g.ie_cobra_pf_pj='J' THEN			substr(OBTER_NOME_PF_PJ(null,g.cd_cgc),1,80)  ELSE substr(OBTER_NOME_PF_PJ(e.cd_pessoa_fisica, null),1,80) END  WHEN a.ie_responsavel_credito='H' THEN  substr(OBTER_NOME_PF_PJ(null,a.cd_cgc_prestador),1,80) WHEN a.ie_responsavel_credito='RM' THEN substr(OBTER_NOME_PF_PJ(null,a.cd_cgc_prestador),1,80)  ELSE substr(OBTER_NOME_PF_PJ(null,coalesce(x.cd_cgc,a.cd_cgc_prestador)),1,80) END  ds_resp_credito,
	...
	dividir((a.vl_procedimento + coalesce(obter_desconto_matproc(a.nr_sequencia,'P'),0)) - obter_valor_participante(a.nr_sequencia),a.qt_procedimento) vl_unitario_bruto,
	CASE WHEN a.dt_conferencia IS NULL THEN 'N'  ELSE 'S' END  ie_conferencia,
	(substr(obter_dados_estrut_proc(a.cd_procedimento,a.ie_origem_proced,'C','E'),1,20))::numeric  cd_especialidade_proc,
	...
	substr(coalesce(obter_porte_cbhpm(a.dt_procedimento,a.cd_procedimento,a.ie_origem_proced),0),1,10) cd_porte_cbhpm,
	...
	CASE WHEN Obter_Se_Vigente_TUSS(a.dt_procedimento, a.cd_convenio, y.cd_estabelecimento)=1 THEN 		coalesce(a.cd_procedimento_convenio,a.cd_procedimento)  ELSE CASE WHEN coalesce(a.cd_procedimento_tuss,0)=0 THEN  a.cd_procedimento  ELSE a.cd_procedimento_tuss END  END  cd_proc_transicao_tuss,
	CASE WHEN Obter_Se_Vigente_TUSS(a.dt_procedimento, a.cd_convenio, y.cd_estabelecimento)=1 THEN 				coalesce(y.ds_procedimento, substr(b.ds_procedimento,0,100))  ELSE substr(CASE WHEN coalesce(a.cd_procedimento_tuss,0)=0 THEN  b.ds_procedimento  ELSE obter_descricao_procedimento(a.cd_procedimento_tuss, 8) END ,1,180) END  ds_proc_transicao_tuss,
	...
	coalesce(a.vl_custo_operacional,0) + coalesce(a.vl_materiais,0) vl_custo_mat,
	a.vl_repasse_calc,
	...
	CASE WHEN g.ie_cobra_pf_pj='J' THEN substr(OBTER_NOME_PF_PJ(null,g.cd_cgc),1,80)  ELSE substr(OBTER_NOME_PF_PJ(e.cd_pessoa_fisica,null),1,80) END  ds_cgc_cpf_medico,
	coalesce(w.nr_seq_apresentacao,1) nr_seq_apresent,
	substr(obter_valor_dominio(1372, a.ie_lado),1,254) ds_lado,
	y.ie_reapresentacao_sus,
	a.nr_fone_integracao,
	a.dt_ligacao_integracao,
	substr(coalesce(y.ds_procedimento, CASE WHEN coalesce(a.cd_procedimento_tuss,0)=0 THEN  b.ds_procedimento  ELSE obter_descricao_procedimento(a.cd_procedimento_tuss, 8) END ),1,180) ds_proc_conv_tuss,
...
select
	...
	coalesce(h.cd_medico_convenio, substr(obter_crm_medico(g.cd_pessoa_fisica), 1, 20)) cd_medico_crm_convenio,
	a.ie_via_acesso,
	b.cd_tipo_procedimento,
	b.cd_grupo_proc,
	a.nr_cirurgia,
	...
	((coalesce(a.tx_hora_extra,1) * 100) - 100) ds_hora_extra,
	a.nr_seq_atepacu,
	CASE WHEN a.ie_responsavel_credito='M' THEN 	CASE WHEN g.ie_cobra_pf_pj='J' THEN 			substr(OBTER_NOME_PF_PJ(null,g.cd_cgc),1,80)  ELSE substr(OBTER_NOME_PF_PJ(e.cd_pessoa_fisica, null),1,80) END  WHEN a.ie_responsavel_credito='H' THEN  substr(OBTER_NOME_PF_PJ(null,a.cd_cgc_prestador),1,80) WHEN a.ie_responsavel_credito='RM' THEN substr(OBTER_NOME_PF_PJ(null,a.cd_cgc_prestador),1,80)  ELSE substr(OBTER_NOME_PF_PJ(null,coalesce(h.cd_cgc,coalesce(x.cd_cgc,a.cd_cgc_prestador))),1,80) END  ds_resp_credito,
	obter_tipo_acomod_proc(a.nr_atendimento, a.nr_sequencia) cd_tipo_acomod_int,
	substr(obter_desc_tipo_acomod(obter_tipo_acomod_proc(a.nr_atendimento, a.nr_sequencia)),1,40)  ds_tipo_acomod_int,
	coalesce(obter_desconto_matproc(a.nr_sequencia,'P'),0) vl_desconto,
	substr(obter_medico_convenio(y.cd_estabelecimento,e.cd_pessoa_fisica,y.cd_convenio_parametro, null, null, null, 
	...
	CASE WHEN coalesce(a.cd_procedimento_tuss,0)=0 THEN  a.cd_procedimento  ELSE a.cd_procedimento_tuss END  cd_procedimento_tuss,
	dividir((h.vl_participante + coalesce(obter_desconto_matproc(a.nr_sequencia,'P'),0)),a.qt_procedimento) vl_unitario_bruto,
	CASE WHEN a.dt_conferencia IS NULL THEN 'N'  ELSE 'S' END  ie_conferencia,
	(substr(obter_dados_estrut_proc(a.cd_procedimento,a.ie_origem_proced,'C','E'),1,20))::numeric  cd_especialidade_proc,
	((1- obter_indice_preco_proc(a.nr_sequencia)) * 100) tx_ajuste_percentual,
	dividir(h.vl_conta,obter_indice_preco_proc(a.nr_sequencia)) vl_proc_original ,
	substr(coalesce(obter_porte_cbhpm(a.dt_procedimento,a.cd_procedimento,a.ie_origem_proced),0),1,10) cd_porte_cbhpm,
	0 vl_proc_sem_glosa,
	--nvl(substr(obter_descricao_procedimento(a.cd_procedimento_tuss, 8),1,180), substr(b.ds_procedimento,1,180)) ds_procedimento_tuss
	...
	a.vl_repasse_calc,
	coalesce(substr(obter_agrup_classif_setor(c.nr_seq_agrup_classif),1,200), substr(obter_desc_expressao(960582), 1, 200)) ds_classif_agrup,
	h.vl_conta vl_med_conta,
	CASE WHEN coalesce(a.cd_procedimento_convenio, to_char(a.cd_procedimento))=to_char(a.cd_procedimento) THEN  		CASE WHEN coalesce(to_char(a.cd_procedimento_tuss),'0')='0' THEN  to_char(a.cd_procedimento)  ELSE to_char(a.cd_procedimento_tuss) END   ELSE a.cd_procedimento_convenio END  cd_conv_tuss_proc,
	CASE WHEN g.ie_cobra_pf_pj='J' THEN substr(OBTER_NOME_PF_PJ(null,g.cd_cgc),1,80)  ELSE substr(OBTER_NOME_PF_PJ(e.cd_pessoa_fisica,null),1,80) END  ds_cgc_cpf_medico,
	coalesce(i.nr_seq_apresentacao,1) nr_seq_apresent,
	substr(obter_valor_dominio(1372, a.ie_lado),1,254) ds_lado,
	y.ie_reapresentacao_sus,
	a.nr_fone_integracao,
	a.dt_ligacao_integracao,
