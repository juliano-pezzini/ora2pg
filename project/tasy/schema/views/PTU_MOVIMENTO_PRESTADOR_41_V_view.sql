...
CREATE OR REPLACE VIEW ptu_movimento_prestador_41_v (tp_registro, ie_ordem, ie_ordem_2, nr_sequencia, cd_tipo_registro, cd_unimed_des, cd_unimed_ori, dt_geracao, nr_versao_trans, sg_cons_diretor_tecnico, sg_uf_cons_diretor_tecnico, ie_tipo_rede_min, ie_tipo_prestador, cd_prestador, cd_cgc_cpf402, cd_insc_est, nr_crm, cd_uf_crm, nm_prestador, nm_fantasia, ie_tipo_vinculo, dt_inclusao_uni, dt_exclusao_uni, ie_tipo_contratualizacao, ie_tipo_class_estabelecimento, ie_categoria_diferente, ie_acidente_trabalho, ie_urgencia_emergencia, dt_inicio_serv, dt_inicio_contrato, nr_registro_ans, nm_diretor_tecnico, nr_crm_diretor_tec, ie_tipo_disponibilidade, ie_tabela_propria, cd_perfil_assist_hosp, ie_tipo_produto, ie_guia_medico, ie_registro_cert1, ie_registro_atua1, ie_registro_cert2, ie_registro_atua2, reservado, ie_tipo_endereco, ds_endereco, nr_endereco, ds_complemento, ds_bairro, cd_municipio, nr_cep, nr_ddd, nr_fone_1, nr_fone_2, nr_fax, ds_email, ds_endereco_web, cd_cnes, nr_leitos_totais, nr_leito_contrato, nr_leitos_psiquiatria, nr_uti_adulto, nr_uti_neonatal, nr_uti_pediatria, cd_cgc_cpf, cd_grupo_servico, cd_rede, nm_rede, qt_tot_r402, qt_tot_r403, qt_tot_r404, qt_tot_r405, nr_seq_movimento, nr_seq_endereco, cd_espec_1, cd_atua_1, cd_espec_2, cd_atua_2, reservado7, nr_seq_prestador, ie_guia_medico_espec_1, ie_guia_medico_espec_2, ie_guia_medico_atua_1, ie_guia_medico_atua_2, nr_leitos_intermed, ie_filial, cd_imposto, vl_imposto, ie_prest_acred, ds_inst_acred, ie_nivel_acred, ie_particip_notivisa, ie_particip_qualiss_ans, nr_leitos_hosp_dia, nr_rce_espec_1, nr_rce_espec_2, nr_rce_2_espec_1, nr_rce_2_espec_2, nr_rce_atua_1, nr_rce_atua_2, nr_rce_2_atua_1, nr_rce_2_atua_2, indic_pos_graduacao, tp_graduacao, ie_particip_prog_cert, nr_leitos_tot_clinic, nr_leitos_tot_cirurgico, nr_leitos_tot_obstr, nr_latitude, nr_longitude, qt_tot_r407, qt_tot_r408, nr_leitos_tot_pediat, nr_leitos_tot_psiqu, nr_seq_endereco_prest) AS select	/* + CHOOSE */
	...
	null				nr_rce_espec_1, 
	null				nr_rce_espec_2, 
	null				nr_rce_2_espec_1, 
	null				nr_rce_2_espec_2, 
	null				nr_rce_atua_1, 
	null				nr_rce_atua_2, 
	null				nr_rce_2_atua_1, 
	null				nr_rce_2_atua_2, 
	null				indic_pos_graduacao, 
	null				tp_graduacao, 
	null				ie_particip_prog_cert, 
	null				nr_leitos_tot_clinic, 
	null				nr_leitos_tot_cirurgico, 
	null				nr_leitos_tot_obstr, 
	null				nr_latitude, 
	null				nr_longitude, 
	null				qt_tot_r407, 
	null				qt_tot_r408, 
	null				nr_leitos_tot_pediat, 
	null				nr_leitos_tot_psiqu, 
	1				nr_seq_endereco_prest 
...
select	2				tp_registro, 
	...
	CASE WHEN a.ie_tipo_vinculo=3 THEN a.dt_inicio_contrato  ELSE null END 	dt_inicio_contrato, 
	...
	lpad(coalesce(a.ie_perfil_assistencial,'0'),2,'0')	cd_perfil_assist_hosp, 
	...
	coalesce(a.id_rce_espec_1,' ') ie_registro_cert1, 
	coalesce(a.id_rce_atua_1,' ') ie_registro_atua1, 
	coalesce(a.id_rce_espec_2,' ') ie_registro_cert2, 
	coalesce(a.id_rce_atua_2,' ') ie_registro_atua2, 
	' '				reservado, 
	null				ie_tipo_endereco, 
	null				ds_endereco, 
	null				nr_endereco, 
	...
	0				nr_seq_endereco, 
	lpad(a.cd_espec_1,2,'0') cd_espec_1, 
	lpad(a.cd_atua_1,2,'0') cd_atua_1, 
	lpad(a.cd_espec_2,2,'0') cd_espec_2, 
	lpad(a.cd_atua_2,2,'0') cd_atua_2,						 
	' '				reservado7, 
	a.nr_sequencia			nr_seq_prestador, 
	coalesce(a.id_guia_medico_espec_1,' ') ie_guia_medico_espec_1, 
	coalesce(a.id_guia_medico_espec_2,' ') ie_guia_medico_espec_2, 
	coalesce(a.id_guia_medico_atua_1,' ') ie_guia_medico_atua_1, 
	coalesce(a.id_guia_medico_atua_2,' ') ie_guia_medico_atua_2, 
	null				nr_leitos_intermed, 
	null				ie_filial, 
	null				cd_imposto, 
	null				vl_imposto, 
	...
	null				nr_leitos_hosp_dia, 
	lpad(a.nr_rce_espec_1,10,'0') nr_rce_espec_1, 
	lpad(a.nr_rce_espec_2,10,'0') nr_rce_espec_2, 
	lpad(a.nr_rce_2_espec_1,10,'0') nr_rce_2_espec_1, 
	lpad(a.nr_rce_2_espec_2,10,'0') nr_rce_2_espec_2, 
	lpad(a.nr_rce_atua_1,10,'0') nr_rce_atua_1, 
	lpad(a.nr_rce_atua_2,10,'0') nr_rce_atua_2, 
	lpad(a.nr_rce_2_atua_1,10,'0') nr_rce_2_atua_1, 
	lpad(a.nr_rce_2_atua_2,10,'0') nr_rce_2_atua_2, 
	substr(CASE WHEN a.cd_pessoa_fisica IS NULL THEN ' '  ELSE pls_obter_dados_prestador(a.nr_seq_prestador,'GP') END ,1,255) indic_pos_graduacao, 
	'4'				tp_graduacao, 
	CASE WHEN a.cd_pessoa_fisica IS NULL THEN ' '  ELSE 'N' END 	ie_particip_prog_cert, 
	null				nr_leitos_tot_clinic, 
	null				nr_leitos_tot_cirurgico, 
	null				nr_leitos_tot_obstr, 
	null				nr_latitude, 
...
select	3				tp_registro, 
	...
	coalesce(substr(pls_obter_dados_prestador(a.nr_seq_prestador,'F'),1,1),'N')	ie_filial, 
	null				cd_imposto, 
	null				vl_imposto, 
	null				ie_prest_acred, 
	null				ds_inst_acred, 
	...
	null				tp_graduacao, 
	null				ie_particip_prog_cert, 
	b.nr_leitos_tot_clinic		nr_leitos_tot_clinic, 
	b.nr_leitos_tot_cirurgico	nr_leitos_tot_cirurgico, 
	b.nr_leitos_tot_obstr		nr_leitos_tot_obstr, 
	lpad(' ',20,' ')		nr_latitude, 
	lpad(' ',20,' ')		nr_longitude, 
	null				qt_tot_r407, 
	null				qt_tot_r408, 
	b.nr_leitos_tot_pediat		nr_leitos_tot_pediat, 
	b.nr_leitos_tot_psiqu		nr_leitos_tot_psiqu, 
	b.nr_sequencia			nr_seq_endereco_prest 
...
select	4				tp_registro, 
	...
	null				nr_leitos_tot_pediat, 
	null				nr_leitos_tot_psiqu, 
	c.nr_sequencia			nr_seq_endereco_prest 
from	ptu_prestador			a, 
...
select	5				tp_registro, 
	...
	null				nr_leitos_tot_pediat, 
	null				nr_leitos_tot_psiqu, 
	99999999999			 nr_seq_endereco_prest 
...
select	7				tp_registro, 
	...
	99999999999			 nr_seq_endereco_prest 
from	ptu_movimento_prestador 
order by nr_seq_endereco_prest,cd_tipo_registro,nr_sequencia;
