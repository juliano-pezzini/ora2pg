...
CREATE OR REPLACE VIEW eis_lab_tempos_etapa_v2 (cd_setor_atendimento, ie_tipo, nr_seq_grupo, ds_base, nr_seq_exame, nr_atendimento, dt_referencia, min_1, min_2, min_3, min_4, min_5, min_6, min_7, min_8, min_9, qt1, qt2, qt3, qt4, qt5, qt6, qt7, qt8, qt9, ds_tipo_atendimento, ie_tipo_atendimento) AS select 	0 cd_setor_atendimento, /* Mapa traballho */
	1 ie_tipo, 
	c.nr_seq_grupo, 
	substr(OBTER_DESC_GRUPO_EXAME_LAB(c.nr_seq_grupo),1,60) ds_base,	 
	0 nr_seq_exame, 
	0 nr_atendimento, 
...
select b.cd_setor_atendimento, /* Mapa traballho */
	...
	2 ie_tipo, 
	0 nr_seq_grupo,	 
	substr(obter_nome_setor(b.cd_setor_atendimento),1,60) ds_base,	 
	0 nr_seq_exame, 
	0 nr_atendimento, 
	trunc(b.dt_prescricao) dt_referencia, 
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '15', 'D'),'dd/mm/yyyy hh24:mi:ss') 
...
select 	0 cd_setor_atendimento, /* Mapa traballho */
	...
	4 ie_tipo, 
	0 nr_seq_grupo, 
	substr(c.nm_exame,1,30) ds_base, 
...
select 	0 cd_setor_atendimento, /* Mapa traballho */
	...
	3 ie_tipo, 
	0 nr_seq_grupo, 
	substr(obter_nome_setor(b.cd_setor_entrega),1,60) ds_base, 
	0 nr_seq_exame, 
	0 nr_atendimento, 
	trunc(b.dt_prescricao) dt_referencia, 
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '15', 'D'),'dd/mm/yyyy hh24:mi:ss') 
...
select 	0 cd_setor_atendimento, /* Mapa traballho */
	...
	5 ie_tipo, 
	0 nr_seq_grupo, 
	obter_valor_dominio(12,obter_tipo_atendimento(b.nr_atendimento)) ds_base, 
	0 nr_seq_exame, 
