...
select
	...
	(sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN x.cd_grupo_material=15 THEN CASE WHEN c.ie_responsavel_credito='OP' THEN c.vl_unitario_item  ELSE c.vl_total_item END   ELSE c.vl_total_item END  WHEN c.tp_nota=86 THEN c.vl_total_item  ELSE 0 END ) +
	sum(CASE WHEN c.tp_nota=77 THEN c.vl_total_item WHEN c.tp_nota=87 THEN  c.vl_total_item  ELSE 0 END ) +
	sum(CASE WHEN c.tp_nota=75 THEN c.vl_total_item WHEN c.tp_nota=85 THEN  c.vl_total_item  ELSE 0 END )) vl_total_conta,
	...
	sum(CASE WHEN c.tp_nota=75 THEN c.vl_total_item WHEN c.tp_nota=85 THEN  c.vl_total_item  ELSE 0 END )		vl_total_honorario,
	0				nr_linha,
	LOCALTIMESTAMP				dt_item,
	' '				cd_item_convenio,
	0				qt_dias_executado,
...
select
	...
	c.nr_linha			nr_linha,
	c.dt_item			dt_item,
	coalesce(substr(c.cd_item_convenio,1,8),c.cd_item) cd_item_convenio,
	1				qt_dias_executado,
	1				qt_ocorrencia_dia,
...
select
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN x.cd_grupo_material=15 THEN CASE WHEN c.ie_responsavel_credito='OP' THEN c.vl_unitario_item  ELSE c.vl_total_item END   ELSE c.vl_total_item END   ELSE c.vl_total_item END ) vl_total_item,
...
select
	...
	0				vl_honorario,
	CASE WHEN c.tp_nota=76 THEN CASE WHEN x.cd_grupo_material=15 THEN CASE WHEN c.ie_responsavel_credito='OP' THEN c.vl_unitario_item  ELSE c.vl_total_item END   ELSE c.vl_total_item END   ELSE c.vl_total_item END  vl_total_item,
	0				vl_total_matmed,
