...
CREATE OR REPLACE VIEW ptu_resp_consulta_prest_v50_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_requisicao, nr_seq_guia, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nr_seq_origem, ie_confirmacao, cd_mens_erro, nr_versao, nm_prestador, cd_unimed_prestador, cd_prestador, cd_especialidade, ie_alto_custo, ds_fim) AS select	1				ie_tipo_registro,
	00419				cd_transacao,
	...
	ptu_obter_inconsist_trans_v50(null,null,nr_seq_origem,'00419',1,null,null) cd_mens_erro,
