...
and   c.cd_item_convenio <> 32200005
...
select 	3				tp_registro,
	...
	c.dt_item			dt_item,
	c.cd_item_convenio	cd_item_convenio,
	ceil(sum(c.vl_total_item)/0.0645)	qt_item,
	0				vl_matmed,
	0				vl_total_matmed,
	substr(b.nm_paciente,1,45)	nm_paciente,
	somente_numero(coalesce(coalesce(b.cd_conv_medico_resp,b.nr_crm_medico_resp),0))
...
group by
	...
	somente_numero(c.cd_cgc_hospital),
	c.nr_seq_conta_convenio,
	b.cd_usuario_convenio,c.nr_linha,
	c.dt_item,
	c.cd_item_convenio, b.nm_paciente,
	b.cd_conv_medico_resp,
