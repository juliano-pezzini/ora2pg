...
CREATE OR REPLACE VIEW lab_checklist_lablink_v (nr_prescricao, cd_estabelecimento, nr_seq_prescr, nr_seq_exame, ie_padrao_amostra, nr_seq_lab, padrao_amostra_nr_seq_lab, integra_amostra, ie_salva_etapa, integra_salva_etapa, dt_integracao, integra_dt_integracao, ie_status_atend, ds_status_atend, integra_envio, equip_exame, integra_equip, nr_seq_grupo_imp, ds_grupo_imp, integra_grupo_imp, ds_material_especial, integra_mat_especial, equip_exame_duplicado, integra_equip_exame_dup, ie_suspenso, integra_suspenso, dt_liberacao, integra_dt_liberacao) AS select	a.nr_prescricao,
	...
	c.ie_salva_etapa,
	CASE WHEN coalesce(c.ie_salva_etapa, 'N')='N' THEN  'Não'  ELSE 'Sim' END  integra_salva_etapa,
	b.dt_integracao,
	...
	CASE WHEN Obter_Equipamento_Exame(b.nr_seq_exame, null, 'CETUS') IS NULL THEN  'Não'  ELSE 'Sim' END  integra_equip,
	d.nr_seq_grupo_imp,
	...
	CASE WHEN obter_equip_exame_duplicado(b.nr_seq_exame, 'CETUS') IS NULL THEN  'Sim'  ELSE 'Não' END  integra_equip_exame_dup,
	b.ie_suspenso,
