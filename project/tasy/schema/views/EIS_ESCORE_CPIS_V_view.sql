...
CREATE OR REPLACE VIEW eis_escore_cpis_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_pontuacao, cd_empresa, cd_estabelecimento, ds_gradacao, nr_atendimento, cd_paciente) AS select	distinct
	...
	substr(obter_resultado_braden(qt_pontuacao),1,100) ds_gradacao, 
	a.nr_atendimento, 
	a.cd_pessoa_fisica cd_paciente 
FROM 	cpis_atendimento e, 
	estabelecimento f, 
