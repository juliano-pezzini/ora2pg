...
select	distinct 3					ie_registro, 
	...
	0						cd_movimento, 
	c.cd_banco					cd_banco, 
	CASE WHEN c.ie_tipo_pagamento IS NULL THEN cd_camara_compensacao WHEN c.ie_tipo_pagamento='DOC' THEN 700  ELSE 18 END 	cd_compensacao, 
