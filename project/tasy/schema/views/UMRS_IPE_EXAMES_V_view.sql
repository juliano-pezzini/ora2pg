...
select
	...
	CASE WHEN somente_numero(coalesce(coalesce(b.cd_conv_medico_resp,b.nr_crm_medico_resp),0))=99999 THEN 13495  ELSE somente_numero(coalesce(coalesce(b.cd_conv_medico_resp,b.nr_crm_medico_resp),0)) END  cd_solicitante,
