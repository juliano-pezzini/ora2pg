...
CREATE OR REPLACE VIEW medical_certificates_v (ie_type_admission, dt_hospitalization, dt_creation, cd_current_medical_department, ds_current_medical_department, cd_current_ward, ds_current_ward, cd_patient_id, nm_patient_name, ie_sex, qt_age, ds_type_admission, ds_medical_department_doc, ds_ward_doc, nm_attending_doctor, ie_status, ds_status, nr_document, nr_atendimento) AS SELECT	1 ie_type_admission, /*Inpatient*/
        b.dt_entrada dt_hospitalization,
	obter_data_atestado_paciente(get_data_doc_medic_certificate(b.nr_atendimento,'SEQ')) dt_creation,	
	...
	substr(get_data_doc_medic_certificate(b.nr_atendimento,'DSD'),1,255) ds_Medical_department_doc,
	substr(get_data_doc_medic_certificate(b.nr_atendimento,'DSW'),1,255) ds_Ward_Doc,
	substr(get_data_doc_medic_certificate(b.nr_atendimento,'NMAD'),1,255) nm_Attending_doctor,
	substr(get_data_doc_medic_certificate(b.nr_atendimento,'IEST'),1,255) ie_Status,
	substr(get_data_doc_medic_certificate(b.nr_atendimento,'DSST'),1,255) ds_Status,
	substr(get_data_doc_medic_certificate(b.nr_atendimento,'SEQ'),1,255) nr_Document,
	b.nr_atendimento
