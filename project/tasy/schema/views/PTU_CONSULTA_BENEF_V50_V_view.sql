...
CREATE OR REPLACE VIEW ptu_consulta_benef_v50_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_execucao, nr_seq_guia, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, cd_unimed, cd_usuario_plano, dt_nascimento, nm_beneficiario, sobrenome_beneficiario, nr_versao, ds_fim) AS select	1				ie_tipo_registro,
	00412				cd_transacao,
