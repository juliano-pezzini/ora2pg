...
FROM (	SELECT	d.nr_seq_edicao,
		...
		CASE WHEN b.cd_periodo=0 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor0,
		CASE WHEN b.cd_periodo=1 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor1,
		CASE WHEN b.cd_periodo=2 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor2,
		CASE WHEN b.cd_periodo=3 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor3,
		CASE WHEN b.cd_periodo=4 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor4,
		CASE WHEN b.cd_periodo=5 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor5,
		CASE WHEN b.cd_periodo=6 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor6,
		CASE WHEN b.cd_periodo=7 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor7,
		CASE WHEN b.cd_periodo=8 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor8,
		CASE WHEN b.cd_periodo=9 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor9,
		CASE WHEN b.cd_periodo=10 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor10,
		CASE WHEN b.cd_periodo=11 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor11,
		CASE WHEN b.cd_periodo=12 THEN SUBSTR(bsc_obter_cor_ind_html5(a.nr_sequencia, b.nr_sequencia, b.cd_ano, b.cd_periodo),1,50)  ELSE '' END  ds_cor12
FROM	ple_objetivo d,
	bsc_ind_obj c,
	bsc_ind_inf b,
	bsc_indicador a
