...
CREATE OR REPLACE VIEW ocupacao_recem_nascido_v (nr_atendimento, dt_entrada_unidade, cd_unidade, cd_unidade_basica, cd_unidade_compl, nm_pessoa_fisica, cd_setor_atendimento, cd_pessoa_fisica, cd_convenio, nr_seq_apresent, classif, ds_tipo_atendimento, ie_tipo_atendimento, dt_nascimento, dt_entrada, dt_alta, nr_prontuario, nm_medico_resp) AS select	a.nr_atendimento,
	...
	substr(obter_nome_tipo_atend(obter_tipo_atendimento(c.nr_atendimento)),1,255) ds_tipo_atendimento, 
