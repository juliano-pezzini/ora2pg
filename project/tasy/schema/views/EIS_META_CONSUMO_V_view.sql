...
CREATE OR REPLACE VIEW eis_meta_consumo_v (dt_referencia, cd_estabelecimento, cd_grupo_material, ds_grupo_material, vl_meta, vl_consumo, pr_percentual) AS select	a.dt_referencia,
