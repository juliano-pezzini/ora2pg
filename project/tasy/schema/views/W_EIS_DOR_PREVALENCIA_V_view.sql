...
CREATE OR REPLACE VIEW w_eis_dor_prevalencia_v (cd_setor, ds_setor_atendimento, ds_unidade, ie_sexo, ds_sexo, ie_faixa_etaria, dt_sinal_vital, qt_avaliacao, qt_avaliacao_dor, qt_avaliacao_sem_dor, qt_max_intensidade, nr_atendimento, cd_pessoa_fisica, qt_paciente_dor, nr_seq_result_dor, ds_result_dor, nr_turno, ds_turno) AS select	distinct	
