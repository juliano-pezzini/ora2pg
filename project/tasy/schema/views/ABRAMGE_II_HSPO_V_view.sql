...
SELECT		'CABECALHO CONTA      '	DS_REGISTRO,
		...
		CASE WHEN B.ie_tipo_atendimento=3 THEN 0  ELSE B.CD_MOTIVO_ALTA END
						CD_MOTIVO_ALTA,
		'N'				IE_LAUDO_ESPECIAL,
...
SELECT     	'ITEM DA CONTA         ' 	DS_REGISTRO,
		...
		' '				UF_CRM_REQ,
         	...
         	SUM(CASE WHEN(coalesce(c.vl_honorario,0) + coalesce(c.vl_custo_oper,0))=0 THEN c.vl_total_item  ELSE (coalesce(c.vl_honorario,0) + coalesce(c.vl_custo_oper,0)) END )
						VL_ITEM,
           	0                        	IE_CIRURGIA_MULTIPLA,
           	0		      		VL_TOTAL_ITEM,
           	0	      			QT_ITEM_CONTA,
...
SELECT     	'ITEM DA CONTA         ' 	DS_REGISTRO,
		...
		' '				UF_CRM_REQ,
           	max(c.NR_SEQ_ITEM)         	NR_SEQ_ITEM,
           	'90010019'			CD_ITEM,
           	'Filmes para radiologia'	NM_ITEM,
           	CASE WHEN W.IE_CARATER_INTER='U' THEN 'S'  ELSE 'N' END 
						IE_EMERGENCIA,
