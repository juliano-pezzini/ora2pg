...
CREATE OR REPLACE VIEW pls_interface_mens_copartic_v (tp_registro, nr_seq_segurado, titular, vl_mensalidade, vl_coparticipacao, vl_agrupado, nr_cpf, nm_pessoa_fisica, dt_nascimento, ds_titularidade, nr_seq_titular, nm_usuario, cd_matricula) AS select	1 tp_registro,
...
from (	select	a.nr_seq_segurado,
		...
		coalesce(pls_obter_valor_item_mens(c.nr_sequencia,'1'),0) + coalesce(pls_obter_valor_item_mens(c.nr_sequencia,'12'),0) vl_mensalidade,
		c.vl_coparticipacao,
		a.vl_agrupado,
		0 nr_seq_titular,
		d.nr_cpf,
...
union all
	...
	select	a.nr_seq_segurado,
		...
		coalesce(pls_obter_valor_item_mens(c.nr_sequencia,'1'),0) + coalesce(pls_obter_valor_item_mens(c.nr_sequencia,'12'),0),
		c.vl_coparticipacao,
		vl_agrupado,
		b.nr_seq_titular,
		d.nr_cpf,
