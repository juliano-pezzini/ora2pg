...
CREATE OR REPLACE VIEW eis_indicador_gestao_v (nr_seq_indicador, cd_estabelecimento, dt_ano, ds_ano, ie_periodo, vl_janeiro, vl_fevereiro, vl_marco, vl_abril, vl_maio, vl_junho, vl_julho, vl_agosto, vl_setembro, vl_outubro, vl_novembro, vl_dezembro, vl_media_anual) AS select	a.nr_seq_indicador,
