...
SELECT		'CABECALHO CONTA      '	DS_REGISTRO,
		...
		substr(B.cd_senha_guia,1,10)	CD_SENHA_GUIA,
		1				NR_PARCELA,
		0				CD_CONVENIO,
		' '				NM_CONVENIO,
		'J'				TP_PRESTADOR,
...
SELECT     	'ITEM DA CONTA         ' 	DS_REGISTRO,
		...
		to_char(c.NR_INTERNO_CONTA)	NR_INTERNO_CONTA,
           	substr(w.cd_senha_guia,1,10)	CD_SENHA_GUIA,
