...
select 
	...
	coalesce(somente_numero(substr(CASE WHEN c.ie_responsavel_credito='M' THEN c.cd_medico_exec_conv  ELSE '0' END ,1,8)),0)	cd_prest, 
...
group	by 
	...
	coalesce(somente_numero(substr(CASE WHEN c.ie_responsavel_credito='M' THEN c.cd_medico_exec_conv  ELSE '0' END ,1,8)),0), 
