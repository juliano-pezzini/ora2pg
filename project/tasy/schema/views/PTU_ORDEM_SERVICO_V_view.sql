...
CREATE OR REPLACE VIEW ptu_ordem_servico_v (cd_transacao, ie_tipo_registro, nr_sequencia, nr_seq_requisicao, nr_seq_guia, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, cd_unimed, cd_usuario_plano, nr_via_cartao, nr_seq_origem, ie_urg_emerg, dt_validade, nm_benficiario, dt_prov_atendimento, cd_doenca_cid, cd_unimed_prestador_req, nr_seq_prestador_req, cd_unimed_prestador, nr_seq_prestador, cd_especialidade, ds_observacao, ds_ind_clinica, ie_tipo_tabela, cd_servico, qt_servico_aut, ds_opme, ds_fim) AS select	00506				cd_transacao,
	1				ie_tipo_registro,
