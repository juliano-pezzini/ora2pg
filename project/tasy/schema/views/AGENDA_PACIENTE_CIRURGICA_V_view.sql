...
CREATE OR REPLACE VIEW agenda_paciente_cirurgica_v (nr_atendimento, ie_status_agenda, ie_tipo_classif, ie_autorizacao, dt_confirmacao, cd_pessoa_fisica, dt_agenda, ds_agenda, hr_inicio, nr_minuto_duracao, nm_paciente_pf, ds_convenio, nm_medico, ds_observacao, ds_tipo_anestesia, nm_pessoa_contato, ds_proc_cirurgia, nm_guerra, nm_instrumentador, nm_circulante, dt_entrada_tasy, qt_min_espera_tasy, ds_cirurgia, nr_seq_status_pac, ie_reserva_leito, ie_banco_sangue, ds_status_agenda, nr_sequencia, cd_convenio, cd_procedimento, ie_origem_proced, cd_tipo_agenda, cd_estabelecimento, cd_medico, cd_turno, cd_agenda) AS select
	b.nr_atendimento,
	b.ie_status_agenda,
	x.ie_tipo_classif,
	b.ie_autorizacao,
