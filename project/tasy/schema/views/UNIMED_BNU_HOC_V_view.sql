...
union all
 ...
 SELECT 10 TP_REG, 
  ...
  a.nr_interno_conta, 
  a.nr_seq_protocolo, 
  CASE WHEN b.ie_tipo_guia='A' THEN '05'  ELSE b.ie_tipo_guia END  tp_documento, 
...
WHERE a.nr_atendimento = c.nr_atendimento  and coalesce(b.nr_sequencia,0)	= 
	  ...
	  a.nr_seq_protocolo, 
 	  CASE WHEN b.ie_tipo_guia='A' THEN '05'  ELSE b.ie_tipo_guia END , 
