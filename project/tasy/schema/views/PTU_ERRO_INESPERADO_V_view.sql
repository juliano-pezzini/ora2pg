...
CREATE OR REPLACE VIEW ptu_erro_inesperado_v (cd_transacao, ie_tipo_registro, nr_sequencia, nr_seq_requisicao, nr_seq_guia, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nr_seq_origem, cd_mens_excecao, ds_fim) AS select	00210				cd_transacao,
	1				ie_tipo_registro,
