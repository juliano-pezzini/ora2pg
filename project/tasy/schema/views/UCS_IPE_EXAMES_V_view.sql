...
/*View utilizada pela Unimed Centro Sul - Guaiba*/
	...
	somente_numero(coalesce(
		CASE WHEN a.cd_cgc_hospital='89379960000118' THEN  14308 WHEN a.cd_cgc_hospital='89096616004779' THEN  49536 WHEN a.cd_cgc_hospital='89379960000207' THEN  44677  ELSE a.cd_interno END ,0)) cd_interno,
...
group by
	...
	a.cd_cgc_hospital,
	somente_numero(coalesce(
		CASE WHEN a.cd_cgc_hospital='89379960000118' THEN  14308 WHEN a.cd_cgc_hospital='89096616004779' THEN  49536 WHEN a.cd_cgc_hospital='89379960000207' THEN  44677  ELSE a.cd_interno END ,0)),
...
select
	...
	somente_numero(c.cd_cgc_hospital)
					cd_prestador,
	CASE WHEN somente_numero(c.cd_cgc_hospital)=89379960000118 THEN 5 WHEN somente_numero(c.cd_cgc_hospital)=89096616004779 THEN 3 WHEN somente_numero(c.cd_cgc_hospital)=89379960000207 THEN 3  ELSE 3 END  tp_prestador,
