...
CREATE OR REPLACE VIEW hp_ipe_exames_v (tp_registro, nr_seq_protocolo, nm_sistema, cd_cgc_hospital, qt_total_conta, qt_total_lancamento, cd_interno, nm_hospital, ds_espaco, ie_zeros, tp_nota, nr_folha, qt_lancamento, qt_matricula, cd_usuario_convenio, cd_prestador, tp_prestador, dt_referencia, nr_interno_conta, vl_total_conta, nr_linha, dt_item, cd_item_convenio, qt_item, vl_matmed, vl_total_matmed, nm_paciente, cd_solicitante, nm_arquivo_pdf) AS Select
	...
	0				qt_matricula,
	' '				cd_usuario_convenio,
	somente_numero(coalesce(a.cd_regional,0)) cd_prestador,
	3				tp_prestador,
...
select
	...
	0				qt_lancamento,
	0				qt_matricula,
	substr(b.cd_usuario_convenio,1,13)	cd_usuario_convenio,
	0				cd_prestador,
	3				tp_prestador,
	LOCALTIMESTAMP				dt_referencia,
	c.nr_seq_conta_convenio		nr_interno_conta,
	...
	somente_numero(coalesce(coalesce(coalesce(c.nr_crm_executor, c.cd_medico_executor),coalesce(b.nr_crm_medico_resp, b.cd_conv_medico_resp)),0)) -- Trazer primeiramente o Crm do medico  OS 240299
					cd_solicitante,
