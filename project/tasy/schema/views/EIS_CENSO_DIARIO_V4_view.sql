...
CREATE OR REPLACE VIEW eis_censo_diario_v4 (ds_faixa_etaria, ds_idade, cd_idade, cd_convenio, cd_estabelecimento, ie_periodo, cd_tipo_acomodacao, cd_setor_atendimento, ie_clinica, dt_referencia, cd_medico, nm_pessoa_fisica, nm_paciente, ie_situacao, cd_procedencia, ie_tipo_atendimento, qt_hora_alta, ie_clinica_alta, nr_seq_origem, ie_sexo, cd_cid_principal, cd_categoria_cid, ds_cid_principal, ds_categoria_cid, ds_referencia, cd_dia, nr_pacientes, nr_pac_dia, qt_temp, nr_admissoes, nr_altas, nr_obitos, nr_transf_entrada, nr_transf_saida, nr_transf_ent_int, nr_transf_ent_ext, nr_transf_saida_int, nr_transf_saida_ext, qt_admitido_alta_dia, hr_alta, ie_tipo_convenio, cd_especialidade, qt_leito_livre, cd_procedimento, ds_procedimento, ds_estabelecimento, ds_motivo_alta, cd_motivo_alta, cd_empresa, cd_classif_etaria, ds_classif_etaria, cd_estabelecimento_base, cd_municipio_ibge, nr_seq_queixa, ds_queixa, cd_categoria, ds_categoria, nr_seq_forma_chegada, ds_forma_chegada, nr_horario, cd_convenio_glosa, cd_categoria_glosa, ds_convenio_glosa, ds_categoria_glosa, ds_indicacao, nr_seq_indicacao, cd_pessoa_fisica, ie_carater_inter_sus, ds_carater_atend, cd_empresa_conv, ds_empresa_conv, ds_agrupamento, nr_seq_agrupamento, nr_seq_classificacao, ds_grupo, ds_subgrupo, ds_forma_organizacao, ds_grupo_proc, ds_area_proc, ds_especialidade_proc, cd_grupo, cd_subgrupo, cd_forma_organizacao, cd_grupo_proc, cd_area_proc, cd_especialidade_proc, cd_proced_principal, ds_proced_principal, ds_classif_atend, ds_estado_civil, nr_control) AS SELECT
	...
	sum(CASE WHEN ie_leito_temp='N' THEN (CASE WHEN A.IE_SITUACAO='P' THEN NR_PACIENTES  ELSE 0 END )  ELSE (CASE WHEN A.cd_pessoa_fisica IS NULL THEN  0  ELSE NR_PACIENTES END ) END ) NR_PAC_DIA, -- Era assim : (decode(a.cd_pessoa_fisica, null, 0, 1)))) OS 90712
	sum(CASE WHEN ie_leito_temp='S' THEN  1  ELSE 0 END ) qt_temp,
	...
	A.HR_ALTA,
	ie_tipo_convenio,
	cd_espec_medico CD_ESPECIALIDADE,
	...
	A.cd_motivo_alta,
	A.cd_empresa,
	Obter_classif_etaria_censo2(A.cd_estabelecimento,A.cd_pessoa_fisica,'C') cd_classif_etaria,
	obter_valor_dominio(1698, Obter_classif_etaria_censo2(A.cd_estabelecimento,A.cd_pessoa_fisica,'C')) ds_classif_etaria,
...
GROUP 	BY 	ds_faixa_etaria, 
	...
	A.cd_motivo_alta,
	A.cd_empresa,
	Obter_classif_etaria_censo2(A.cd_estabelecimento,A.cd_pessoa_fisica,'C'),
	obter_valor_dominio(1698, Obter_classif_etaria_censo2(A.cd_estabelecimento,A.cd_pessoa_fisica,'C')),
	c.cd_estabelecimento_base,
