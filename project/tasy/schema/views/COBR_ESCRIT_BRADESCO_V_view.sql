...
CREATE OR REPLACE VIEW cobr_escrit_bradesco_v (tp_registro, nr_seq_envio, cd_empresa, nm_empresa, dt_gravacao, cd_agencia_bancaria, cd_sacado, cd_conta, id_empresa, nr_controle_partic, cd_banco, nr_nosso_numero, nr_dig_nosso_numero, vl_desconto_dia, cd_condicao, ie_emite_papeleta, ie_rateio, ie_endereco, ie_ocorrencia, nr_documento, dt_vencimento, vl_titulo, cd_banco_cobranca, cd_agencia_deposito, ie_especie, ie_aceite, dt_emissao, ie_instrucao1, ie_instrucao2, dt_desconto, vl_desconto, vl_acrescimo, vl_abatimento, vl_iof, ie_tipo_inscricao, nr_inscricao, nm_sacado, ds_endereco_sacado, cd_cep, nr_seq_arquivo, ie_digito_conta) AS select	0 				tp_registro,
	...
	' '				ds_endereco_sacado, 
	' '				cd_cep, 
	coalesce(a.nr_sequencia,0)		nr_seq_arquivo, 
	''				ie_digito_conta 
...
select	1				tp_registro, 
	...
	lpad(coalesce(e.cd_carteira,'0'),4,'0') || 
		(select lpad(somente_numero(x.cd_agencia_bancaria),5,'0') || lpad(somente_numero(x.cd_conta),7,'0') || coalesce(x.ie_digito_conta,'0') 
