...
FROM   lab_parametro g,
  ...
  (SELECT row_number() OVER () AS linha FROM tabela_sistema x LIMIT 12) x
...
group by lote_obter_barras_ficha(b.nr_seq_ficha_lote, b.nr_seq_lote_entrada),
  ...
  a.nr_seq_lote_externo, CASE WHEN g.ie_prescr_agrupamento='S' THEN  to_char(a.nr_prescricao)   ELSE ' ' END ,CASE WHEN a.ie_exame_bloqueado='R' THEN 'R'  ELSE 'N' END
