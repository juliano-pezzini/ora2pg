...
/* 	autorizações 		*/
	...
	0 						qt_zeros, 
	'0' 						ie_tipo_nota, 
	max((substr(coalesce(OBTER_GUIA_CONTA(b.nr_interno_conta),'0'),1,11))::numeric ) 
							nr_nota,							 
	0 						nr_conta_ambulat,	 
	' ' 						tp_conta_origem, 
	0 						nr_conta_origem,	 
