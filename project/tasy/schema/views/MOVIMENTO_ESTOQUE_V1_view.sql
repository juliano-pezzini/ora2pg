...
CREATE OR REPLACE VIEW movimento_estoque_v1 (nr_movimento_estoque, cd_estabelecimento, cd_local_estoque, dt_movimento_estoque, cd_operacao_estoque, cd_acao, cd_material_estoque, dt_mesano_referencia, dt_processo, cd_unidade_medida_estoque, cd_setor_atendimento, ie_origem_documento, nr_documento, nr_sequencia_item_docto, cd_fornecedor, cd_local_estoque_destino, cd_centro_custo, cd_conta_contabil, qt_movimento, cd_unidade_med_mov, nm_usuario, dt_atualizacao, ds_observacao, nr_seq_tab_orig, nr_atendimento, qt_estoque, vl_estoque, vl_movimento) AS SELECT	M.NR_MOVIMENTO_ESTOQUE,
...
WHERE M.DT_PROCESSO IS NOT NULL group by
	M.CD_ESTABELECIMENTO,
	M.DT_MESANO_REFERENCIA,
	M.DT_PROCESSO,
	M.CD_LOCAL_ESTOQUE,
