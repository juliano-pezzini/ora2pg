...
CREATE OR REPLACE VIEW pls_exec_glosa_ocorr_analise_v (ie_tipo, nr_sequencia, nr_codigo, ds_descricao_glosa_ocor, ds_grupo, ds_observacao, ds_msg_externa, nr_regra_ocor, nr_ocorrencia, nr_seq_auditoria, nr_seq_aud_item, nr_nivel_liberacao, ie_status, nr_seq_execucao, nr_seq_exec_proc, nr_seq_exec_mat) AS select	b.ie_tipo,
	a.nr_sequencia,
