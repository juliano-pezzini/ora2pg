...
select
	...
	lpad(substr(a.cd_interno,1,6),6,'0') cd_prestador,
	3				tp_prestador,
	CASE WHEN a.ie_tipo_atendimento=1 THEN coalesce(coalesce((obter_conversao_meio_ext_ipe(c.cd_cgc_convenio,'W_INTERF_CONTA_CAB','CD_MOTIVO_ALTA',a.cd_motivo_alta))::numeric ,a.cd_motivo_alta),4)  ELSE 0 END 
					cd_motivo_cobranca,
	coalesce(a.dt_periodo_inicial, HDP_OBTER_DATA_ATEND_IPE(a.nr_atendimento,a.nr_interno_conta)) dt_entrada,
	coalesce(a.dt_periodo_final, a.dt_alta) dt_alta,
	--substr(a.nr_doc_convenio,1,6)	nr_guia,
	substr(obter_guia_conta(a.nr_interno_conta),1,6) nr_guia,
	...
	(sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN c.ie_responsavel_credito='FRC' THEN c.qt_item *c.vl_unitario_item WHEN c.ie_responsavel_credito='MEDIC' THEN c.qt_item *c.vl_unitario_item  ELSE c.vl_total_item END  WHEN c.tp_nota=86 THEN CASE WHEN c.ie_responsavel_credito='FRC' THEN c.qt_item *c.vl_unitario_item WHEN c.ie_responsavel_credito='MEDIC' THEN c.qt_item *c.vl_unitario_item  ELSE c.vl_total_item END   ELSE 0 END ) +
	sum(CASE WHEN c.tp_nota=77 THEN CASE WHEN c.ie_responsavel_credito='P' THEN  c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=87 THEN CASE WHEN c.ie_responsavel_credito='P' THEN  c.vl_honorario  ELSE c.vl_total_item END   ELSE 0 END ) +
	...
	sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN c.ie_responsavel_credito='FRC' THEN c.qt_item *c.vl_unitario_item WHEN c.ie_responsavel_credito='MEDIC' THEN c.qt_item *c.vl_unitario_item  ELSE c.vl_total_item END  WHEN c.tp_nota=86 THEN CASE WHEN c.ie_responsavel_credito='FRC' THEN c.qt_item *c.vl_unitario_item WHEN c.ie_responsavel_credito='MEDIC' THEN c.qt_item *c.vl_unitario_item  ELSE c.vl_total_item END   ELSE 0 END ) vl_total_despesa,
	...
	sum(CASE WHEN c.tp_nota=77 THEN CASE WHEN c.ie_responsavel_credito='P' THEN  c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=87 THEN CASE WHEN c.ie_responsavel_credito='P' THEN  c.vl_honorario  ELSE c.vl_total_item END   ELSE 0 END ) vl_total_servico,
...
group by
	a.nr_seq_protocolo,
	CASE WHEN a.ie_tipo_atendimento=1 THEN 75 WHEN a.ie_tipo_atendimento=8 THEN 85  ELSE 0 END ,
	lpad(substr(a.cd_interno,1,6),6,'0'),
	substr(a.cd_usuario_convenio,1,13),
	substr(a.cd_cid_principal,1,6),
	CASE WHEN a.ie_tipo_atendimento=1 THEN coalesce(coalesce((obter_conversao_meio_ext_ipe(c.cd_cgc_convenio,'W_INTERF_CONTA_CAB','CD_MOTIVO_ALTA',a.cd_motivo_alta))::numeric ,a.cd_motivo_alta),4)  ELSE 0 END ,
	coalesce(a.dt_periodo_inicial, HDP_OBTER_DATA_ATEND_IPE(a.nr_atendimento,a.nr_interno_conta)),
	coalesce(a.dt_periodo_final, a.dt_alta),
	--substr(a.nr_doc_convenio,1,6),
	substr(obter_guia_conta(a.nr_interno_conta),1,6),
	coalesce((substr(lpad(a.nr_seq_conta_convenio,10,'0'),6,5))::numeric ,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	lpad(substr(CASE WHEN c.ie_responsavel_credito='M' THEN coalesce(c.cd_medico_exec_conv,c.nr_cpf_executor)  ELSE to_char(c.cd_cgc_prestador) END ,1,14),14,'0') cd_prestador,
	3				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
	...
	CASE WHEN c.cd_funcao_executor=0 THEN CASE WHEN c.ie_video='S' THEN 15  ELSE 0 END  WHEN c.cd_funcao_executor=1 THEN CASE WHEN c.ie_video='S' THEN 15  ELSE 0 END 	 WHEN c.cd_funcao_executor=2 THEN CASE WHEN c.ie_video='S' THEN 15  ELSE 0 END   ELSE 0 END 	ie_urgencia,
...
select
	...
	lpad(substr(a.cd_interno,1,6),6,'0') cd_prestador,
	3				tp_prestador,
	CASE WHEN a.ie_tipo_atendimento=1 THEN coalesce((obter_conversao_meio_ext_ipe(c.cd_cgc_convenio,'W_INTERF_CONTA_CAB','CD_MOTIVO_ALTA',a.cd_motivo_alta))::numeric ,a.cd_motivo_alta)  ELSE 0 END 
					cd_motivo_cobranca,
	coalesce(a.dt_periodo_inicial, HDP_OBTER_DATA_ATEND_IPE(a.nr_atendimento,a.nr_interno_conta)) dt_entrada,
	a.dt_alta			dt_alta,
	substr(a.nr_doc_convenio,1,6)	nr_guia,
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN c.ie_responsavel_credito='FRC' THEN c.qt_item * c.vl_unitario_item WHEN c.ie_responsavel_credito='MEDIC' THEN c.qt_item *c.vl_unitario_item  ELSE c.vl_total_item END ) vl_total_item,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	lpad(substr(CASE WHEN c.ie_responsavel_credito='M' THEN  c.nr_cpf_executor  ELSE c.cd_cgc_prestador END ,1,14),14,'0') cd_prestador,
	3				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
	...
	0				vl_honorario,
	CASE WHEN c.ie_responsavel_credito='FRC' THEN c.qt_item * c.vl_unitario_item WHEN c.ie_responsavel_credito='MEDIC' THEN c.qt_item *c.vl_unitario_item  ELSE c.vl_total_item END  vl_total_item,
	0				vl_total_matmed,
...
select
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN c.ie_responsavel_credito='P' THEN  c.vl_honorario  ELSE c.vl_total_item END ) vl_total_item,
...
select
	...
	CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END 
					vl_honorario,
	CASE WHEN c.ie_responsavel_credito='P' THEN  c.vl_honorario  ELSE c.vl_total_item END  vl_total_item,
	0				vl_total_matmed,
	' '				cd_brasindice,
	' '				cd_unidade_medida
from	w_interf_conta_item_ipe c,
