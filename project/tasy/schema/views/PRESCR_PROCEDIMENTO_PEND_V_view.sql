...
CREATE OR REPLACE VIEW prescr_procedimento_pend_v (nr_atendimento, dt_prescricao, nm_usuario, nm_usuario_original, nm_paciente, dt_nascimento, nm_medico, nr_prescricao, cd_setor_atendimento, dt_emissao_setor_atend, ie_status_atend, dt_liberacao, dt_liberacao_medico, dt_entrega, cd_setor_entrega, cd_setor_usuario, cd_estabelecimento, qt_peso, qt_altura_cm, cd_procedimento, ie_origem_proced, nr_seq_proc_interno, dt_prev_execucao) AS SELECT	B.NR_ATENDIMENTO,
	B.DT_PRESCRICAO, 
	B.NM_USUARIO, 
