...
CREATE OR REPLACE VIEW eis_escala_prism_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_profissional, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_pto_total, cd_empresa, cd_estabelecimento, nr_atendimento, cd_paciente, ie_turno) AS select	distinct
