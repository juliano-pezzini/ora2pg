...
CREATE OR REPLACE VIEW eis_ocupacao_especialidade_v2 (cd_estabelecimento, dt_referencia, cd_especialidade, ds_especialidade, ie_periodo, nr_unidades_setor, qt_disponiveis, nr_leitos_ocupados, nr_leitos_livres, nr_admissoes, nr_altas, nr_obitos, nr_transf_entrada, nr_transf_saida, nr_dias_periodo, cd_medico, nm_medico, cd_setor_atendimento, ie_clinica, ie_tipo_atendimento, ie_clinica_alta, nr_seq_origem, ie_sexo, cd_cid_principal, ie_tipo_convenio, qt_hora_alta, cd_procedencia, cd_tipo_acomodacao, hr_alta, ie_temp, ie_carater_inter_sus, cd_convenio) AS SELECT 	A.cd_estabelecimento,
		A.DT_REFERENCIA, 
		...
		coalesce(ie_carater_inter_sus,'00') ie_carater_inter_sus, 
		A.cd_convenio 
...
GROUP BY 	A.cd_estabelecimento, 
		...
		obter_especialidade_medico(A.cd_medico, 'D'), 
		A.IE_PERIODO, 
		A.cd_medico, 
		...
		coalesce(ie_carater_inter_sus,'00'), 
		A.cd_convenio;
