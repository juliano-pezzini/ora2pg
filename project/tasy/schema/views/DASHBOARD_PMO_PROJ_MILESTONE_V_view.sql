...
CREATE OR REPLACE VIEW dashboard_pmo_proj_milestone_v (nr_sequencia, ds_titulo, qt_milestone_prev, qt_milestone_real, ie_status_milestone, qt_total_milestone) AS select x.NR_SEQUENCIA,x.DS_TITULO,x.QT_MILESTONE_PREV,x.QT_MILESTONE_REAL,x.IE_STATUS_MILESTONE,x.QT_TOTAL_MILESTONE
