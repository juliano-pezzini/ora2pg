...
select	'Principal' ds_registro, 
	...
	null nr_laudos, 
	'0' ie_tipo_laudo, 
	substr(to_char(c.dt_emissao,'yyyy')||'14'||adiciona_zeros_esquerda(to_char(coalesce(c.nr_ordem_laudo,c.nr_laudo_sus)),6)||calcula_digito('MODULO11',to_char(c.dt_emissao,'yyyy')||'14'||adiciona_zeros_esquerda(to_char(coalesce(c.nr_ordem_laudo,c.nr_laudo_sus)),6)),1,13) nr_laudo, 
...
select	'Suplementar' ds_registro, 
	...
	substr(to_char(a.dt_emissao,'yyyy')||'14'||adiciona_zeros_esquerda(to_char(coalesce(a.nr_ordem_laudo,a.nr_laudo_sus)),6)||calcula_digito('MODULO11',to_char(a.dt_emissao,'yyyy')||'14'||adiciona_zeros_esquerda(to_char(coalesce(a.nr_ordem_laudo,a.nr_laudo_sus)),6)),1,13) nr_laudo, 
	null nm_paciente, 
	null ie_sexo, 
	null dt_nascimento, 
	null nr_prontuario, 
