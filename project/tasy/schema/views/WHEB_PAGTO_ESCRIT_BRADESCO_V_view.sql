...
where e.cd_estabelecimento 	= a.cd_estabelecimento 
 and e.cd_estabelecimento 	= coalesce(b.cd_estabelecimento,e.cd_estabelecimento) 
...
select 	1 tp_registro, 
	...
	a.nr_sequencia nr_seq_envio, 
	'' nr_bloqueto, 
	CASE WHEN e.cd_cgc=d.cd_favorecido THEN 'D'  ELSE 'C' END  || '000000' || CASE WHEN e.cd_cgc=d.cd_favorecido THEN '01'  ELSE '03' END  || '01' nr_livre_bloqueto, 
	'' ie_dig_bloqueto, 
	'' cd_moeda_bloqueto, 
	0 cd_banco_bloqueto, 
	0 vl_bloqueto, 
...
WHERE e.nr_sequencia			= c.nr_seq_escrit and e.cd_banco 			= b.cd_banco  and e.cd_estabelecimento 		= coalesce(b.cd_estabelecimento,e.cd_estabelecimento) and e.cd_estabelecimento 		= a.cd_estabelecimento and b.ie_tipo_relacao		in ('EP', 'ECC') group by e.nr_sequencia;
