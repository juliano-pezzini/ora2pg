...
CREATE OR REPLACE VIEW pacote_v2 (nr_seq_pacote, cd_convenio, cd_proced_pacote, ie_origem_proced, ie_situacao, dt_atualizacao, nm_usuario, ds_observacao, cd_estabelecimento, dt_atualizacao_nrec, nm_usuario_nrec, ie_prioridade, ie_agendavel, ie_pacote_automatico, cd_moeda, cd_procedimento, ie_origem_proc, ds_pacote, ds_procedimento) AS select   a.NR_SEQ_PACOTE,a.CD_CONVENIO,a.CD_PROCED_PACOTE,a.IE_ORIGEM_PROCED,a.IE_SITUACAO,a.DT_ATUALIZACAO,a.NM_USUARIO,a.DS_OBSERVACAO,a.CD_ESTABELECIMENTO,a.DT_ATUALIZACAO_NREC,a.NM_USUARIO_NREC,a.IE_PRIORIDADE,a.IE_AGENDAVEL,a.IE_PACOTE_AUTOMATICO,a.CD_MOEDA,
	 b.cd_procedimento,
