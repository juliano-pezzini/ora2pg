...
CREATE OR REPLACE VIEW paciente_internado_v (nr_atendimento, nr_atend_original, dt_entrada, cd_pessoa_fisica, cd_procedencia, ie_tipo_atendimento, ie_tipo_convenio, cd_medico_resp, dt_alta, cd_motivo_alta, ie_permite_visita, ie_permite_visita_rel, ie_clinica, ie_clinica_ant, nr_seq_classificacao, dt_entrada_unidade, dt_saida_unidade, cd_setor_atendimento, cd_unidade_basica, cd_unidade_compl, ds_unidade, cd_tipo_acomod_unid, cd_convenio, cd_categoria, cd_usuario_convenio, cd_empresa, cd_tipo_acomod_conv, nr_doc_convenio, ds_setor_atendimento, ds_convenio, ds_categoria, nm_medico, nm_paciente, nr_prontuario, dt_nascimento, cd_religiao, cd_classif_setor, dt_previsto_alta, qt_dia_internacao, ie_carater_inter_sus, dt_alta_convenio, nr_seq_indicacao, cd_estabelecimento, nr_seq_tipo_acidente, dt_saida_real, nm_usuario_saida, dt_cancelamento, ds_nivel_urgencia, nr_seq_triagem_prioridade) AS select	/*+ ordered */
	a.nr_atendimento,
	a.nr_atend_original,
	a.dt_entrada,
	a.cd_pessoa_fisica,
