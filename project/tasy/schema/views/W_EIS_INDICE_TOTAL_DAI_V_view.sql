...
CREATE OR REPLACE VIEW w_eis_indice_total_dai_v (cd_setor, ds_setor_atendimento, dt_evento, ds_unidade, ie_sexo, ds_sexo, ie_faixa_etaria, na) AS select	distinct
