...
select	/* Documento */
	...
	CASE WHEN b.ie_tipo_atendimento=8 THEN  ' ' WHEN b.ie_tipo_atendimento=7 THEN  ' '  ELSE substr(b.cd_tipo_acomodacao,1,4) END  cd_acomodacao, 
