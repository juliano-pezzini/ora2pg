...
CREATE OR REPLACE VIEW eis_compras_v (ie_grupo_material, vl_compra_ano, vl_compra_12m, vl_compra_ant, vl_compra_atual, vl_anual, vl_ultimos_12m, vl_mensal, vl_atual, pr_ano, pr_12meses, pr_mes_anterior, pr_mes_atual, ds_descricao, cd_grupo_material, cd_estabelecimento, cd_material) AS select
	'G' ie_grupo_material,
...
group  by	substr(obter_desc_estrut_mat(e.cd_grupo_material,null,null, null),1,40),
	e.cd_grupo_material,
	e.cd_estabelecimento
...
where	b.nr_sequencia	= obter_seq_param_exec(613,'DT_REFERENCIA')
  and e.dt_referencia 		>= add_months(b.dt_parametro, -12)
group  by	obter_desc_material(e.cd_material),
	e.cd_grupo_material,
	e.cd_estabelecimento,
	e.cd_material;
