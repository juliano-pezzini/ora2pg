...
CREATE OR REPLACE VIEW w_eis_tx_preventivo_flebite_v (ds_setor_atendimento, ds_unidade, ie_faixa_etaria, ie_prescrito, nr_atendimento, ds_conduta, dt_atualizacao_nrec, ie_escala) AS SELECT	DISTINCT	
