...
CREATE OR REPLACE VIEW w_eis_indice_flebite_v (cd_setor_atendimento, ds_setor_atendimento, dt_evento, cd_empresa, cd_estabelecimento, ie_origem, ds_unidade, ie_faixa_etaria, nr_atendimento, dt_atualizacao_nrec, ds_grau) AS select	distinct
