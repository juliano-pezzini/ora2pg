...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	CASE WHEN c.cd_item_convenio=16000005 THEN c.cd_cgc_hospital WHEN c.cd_item_convenio=16000004 THEN c.cd_cgc_hospital WHEN c.cd_item_convenio=16000010 THEN c.cd_cgc_hospital WHEN c.cd_item_convenio=16000007 THEN c.cd_cgc_hospital WHEN c.cd_item_convenio=16000008 THEN c.cd_cgc_hospital WHEN c.cd_item_convenio=16000009 THEN c.cd_cgc_hospital WHEN c.cd_item_convenio=16000001 THEN c.cd_cgc_hospital  ELSE c.cd_prestador END  cd_prestador,
	3				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
...
select
	...
	CASE WHEN c.ie_tipo_item=1 THEN CASE WHEN c.qt_item=3 THEN c.qt_item  ELSE 1 END  END 
					qt_dias_executado,
	...
	CASE WHEN to_char(c.cd_item_convenio)=to_char(c.cd_item) THEN  c.cd_unidade_medida  ELSE null END  cd_unidade_medida
from	w_interf_conta_item_ipe c
