...
CREATE OR REPLACE VIEW total_ocupacao_setores_v2 (cd_setor_atendimento, ds_setor_atendimento, cd_estabelecimento_base, cd_classif_setor, nm_unidade, ds_ocup_hosp, nr_seq_apresentacao, nr_unidades_setor, nr_unidades_temporarias, nr_unidades_ocupadas, qt_unidade_acomp, nr_unidades_interditadas, nr_unidades_livres, nr_unidades_higienizacao, nr_unidades_reservadas, qt_unidades_isolamento, qt_unidades_alta, qt_unidade_saida_inter, qt_unidade_chamad_manut, qt_unidade_manutencao, nr_unid_aguard_higien, nr_unid_temp_ocup, nr_unid_temp_ocupadas, qt_unid_temp_acomp, nr_unid_temp_interditadas, nr_unid_temp_livres, nr_unid_temp_higienizacao, nr_unid_temp_reservadas, qt_unid_temp_isolamento, qt_unid_temp_said_interd, qt_unid_temp_alta, nr_unidades_reserva, ie_ocup_hospitalar, ie_situacao, qt_disponiveis, qt_pac_isolado, nr_agrupamento) AS select c.cd_setor_atendimento,
