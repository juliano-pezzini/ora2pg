...
CREATE OR REPLACE VIEW gpt_released_items_enf_v (nr_prescricao, nr_seq_cpoe, ie_item_type, table_name, nr_atendimento, cd_pessoa_fisica, inactivate, cd_funcao_origem) AS select distinct
	   nr_prescricao,
	   nr_seq_cpoe,
	   ie_item_type,
	   table_name,
