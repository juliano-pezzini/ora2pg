...
CREATE OR REPLACE VIEW ageint_check_list_pac_item_v (ordem, ds_item_padrao, nr_seq_grupo, nr_seq_checklist, nr_seq_item_checklist, ds_resultado, ds_item, ds_grupo, nr_seq_ageint, dt_liberacao, ds_email_destino, ie_bloq_agendamento) AS select	distinct
	1 ordem,
...
select	distinct
	...
	d.dt_liberacao,
	'' ds_email_destino,
	coalesce(b.ie_bloqueia_agendamento, 'N') ie_bloq_agendamento
from	ageint_check_list_pac_item c,
		ageint_item_check_list b,
		ageint_grupo_check_list a,
		ageint_check_list_paciente d
