...
CREATE OR REPLACE VIEW amico_hmv_v (tp_registro, nr_seq_protocolo, cd_interno, dt_referencia, nr_interno_conta, cd_usuario_convenio, nm_paciente, cd_empresa_paciente, dt_atendimento, dt_internacao, dt_alta, cd_motivo_alta, ie_sexo, qt_idade_paciente, cd_tipo_acomodacao, ie_clinica, vl_total_conta, cd_senha, cd_centro_custo, cd_medico_solicitante, nr_crm_solicitante, cd_especialidade_solic, cd_especialidade_real, ie_motivo_encaminhamento, cd_cid, ie_processamento, dt_processamento, cd_servico, cd_setor_atendimento, ie_urgencia, qt_servico, vl_servico, dt_entrada) AS select	1 tp_registro,
	a.nr_seq_protocolo, 
 	a.cd_interno, 
...
select	2 tp_registro, 
	...
	sum(b.qt_item) qt_servico, 
    	sum(CASE WHEN b.ie_responsavel_credito='M' THEN 0 WHEN b.ie_responsavel_credito='RM' THEN b.vl_honorario  ELSE b.vl_total_item END ) vl_servico, 
	a.dt_entrada 
from	Protocolo_convenio d, 
	w_interf_conta_total x, 
