...
, 
	...
	x.nr_seq_grupo_rec, 
	x.cd_senha, 
	substr(obter_dados_material_estab(w.cd_material,M.cd_estabelecimento,'UME'),1,30) cd_unidade_medida 
FROM  MATERIAL W, 
