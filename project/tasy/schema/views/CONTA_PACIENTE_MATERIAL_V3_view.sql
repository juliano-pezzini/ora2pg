...
ds_fornec_ultima_compra, 
	...
	coalesce(substr(Obter_Codigo_Simpro2(a.cd_material,a.cd_convenio,c.cd_estabelecimento,a.dt_atendimento,a.nr_seq_conv_simp),1,20), 
	...
	coalesce(substr(lpad(Obter_Codigo_Simpro2(a.cd_material,a.cd_convenio,c.cd_estabelecimento,a.dt_atendimento,a.nr_seq_conv_simp),10,0),1,10),a.cd_material) cd_simpro_tiss_dez, 
