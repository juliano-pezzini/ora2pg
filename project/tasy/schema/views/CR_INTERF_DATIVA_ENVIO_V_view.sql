...
SELECT   	'ITEM DA CONTA     ' 	DS_REGISTRO, 
		...
		' '				UF_CRM_REQ, 
      	...
      	SUM(CASE WHEN c.cd_area_proc=1 THEN  coalesce(c.vl_total_item,0)  ELSE coalesce(c.vl_honorario,0) + coalesce(c.vl_custo_oper,0) END ) 
							VL_ITEM, 
      	0            	IE_CIRURGIA_MULTIPLA, 
      	0		   		VL_TOTAL_ITEM, 
      	0	   			QT_ITEM_CONTA, 
