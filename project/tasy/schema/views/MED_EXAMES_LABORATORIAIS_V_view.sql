...
CREATE OR REPLACE VIEW med_exames_laboratoriais_v (ie_resultado, dt_prescricao, cr_procedimento, ie_origem_proced, nr_prescricao, nr_sequencia, cd_exame, ds_procedimento, ds_exame, nr_atendimento, ie_recem_nato, nr_seq_result, nm_medico, dt_coleta, nr_controle, ds_material, nr_seq_prescr_proc, dt_prev_execucao, dt_aprovacao, dt_impressao, dt_emissao_resultado, nm_usuario_aprovacao, ds_status_lab, nr_seq_exame, ie_status_atend) AS select	1 ie_resultado,
	b.dt_prescricao, 
	...
	a.dt_coleta, coalesce(b.nr_controle,0) nr_controle, 
...
select	2 ie_resultado, 
	...
	LOCALTIMESTAMP dt_coleta, 0 nr_controle, 
...
select 	3 ie_resultado, 
	...
	a.nr_controle, null ds_material, 
