...
CREATE OR REPLACE VIEW conta_paciente_pagador_v (cd_pagador, ds_pagador, nr_interno_conta, nr_atendimento, ds_label_cgc_cpf, cd_cpf_cgc, ds_endereco, ds_bairro, ds_municipio, ds_uf, cd_cep, ds_pais) AS select	a.cd_pessoa_fisica cd_pagador,
