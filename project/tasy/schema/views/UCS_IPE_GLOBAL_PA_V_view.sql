...
select
	...
	01				qt_matricula,
	' '				cd_usuario_convenio,
	CASE WHEN max(c.ie_responsavel_credito)='RM' THEN  '049536' WHEN max(c.ie_responsavel_credito)='H' THEN  '049536' WHEN max(c.ie_responsavel_credito)='MEDIC' THEN  '049536'  ELSE max(b.cd_interno) END  cd_prestador,
	3				tp_prestador,
...
group by
	c.nr_seq_protocolo,
	--decode(c.ie_responsavel_credito,'RM', '87096616004779','H', '87096616004779','MEDIC', '87096616004779',b.cd_interno),
...
select
	...
	substr(b.cd_usuario_convenio,1,13)
					cd_usuario_convenio,
	CASE WHEN c.ie_responsavel_credito='RM' THEN  '87096616004779' WHEN c.ie_responsavel_credito='H' THEN  '87096616004779' WHEN c.ie_responsavel_credito='MEDIC' THEN  '87096616004779'  ELSE CASE WHEN to_char(c.cd_prestador)='87096616004698' THEN '87096616004779'  ELSE to_char(c.cd_prestador) END  END  cd_prestador,
	3				tp_prestador,
	LOCALTIMESTAMP			dt_referencia,
	c.nr_seq_conta_convenio	nr_interno_conta,
	0				vl_total_conta,
