...
CREATE OR REPLACE VIEW pls_desconto_folha_dmae_v (tp_registro, dt_competencia, cd_matricula_7, vl_pago, nr_vinculo_pmpa, nr_seq_cobranca) AS select	1				TP_REGISTRO,
	coalesce(to_char(e.dt_fim_vigencia,'ddmmyyyy'),0)	DT_COMPETENCIA,
	substr(c.cd_matricula,1,7)	CD_MATRICULA_7,
	obter_Valor_sem_virgula(a.vl_cobranca) VL_PAGO,
	substr(c.nr_seq_vinculo_est,1,2)NR_VINCULO_PMPA,
