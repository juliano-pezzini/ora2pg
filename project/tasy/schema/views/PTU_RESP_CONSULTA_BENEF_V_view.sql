...
CREATE OR REPLACE VIEW ptu_resp_consulta_benef_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_execucao, nr_seq_origem, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, cd_mens_erro, ie_confirmacao, nm_beneficiario, dt_nascimento, nm_empresa_abrev, cd_unimed, cd_usuario_plano, nm_compl_benef, nm_plano, nm_tipo_acomodacao, ie_abrangencia, cd_local_cobranca, dt_validade_carteira, dt_inclusao_benef, dt_exclusao_benef, ie_sexo, nr_via_cartao, ds_fim) AS select	1				ie_tipo_registro,
	...
	ptu_obter_inconsist_trans(null,null,nr_seq_origem,'00313',1,null,null) cd_mens_erro,
