...
select	distinct 4 		tp_registro,
	'J' 		ds_registro,
	'' 		versao_sefinnet,
	Lpad(substr(obter_dados_pf_pj(null, n.cd_cgc_emitente,'IM'),1,7),7,'0') nr_cmc,
	Rpad(substr(n.cd_cgc_emitente,1,14),14,' ') cnpj,
	'' 		ds_razao,
	'' 		ds_nome,
	'' 		insc_estadual,
	'' 		junta_comercial,
	...
	obter_cfps_municipio(n.cd_estabelecimento,n.cd_cgc,n.cd_pessoa_fisica,'FLORIANOPOLIS') cfps,
