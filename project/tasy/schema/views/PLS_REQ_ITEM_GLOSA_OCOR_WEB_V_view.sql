...
CREATE OR REPLACE VIEW pls_req_item_glosa_ocor_web_v (ie_tipo, nr_sequencia, nr_codigo, ds_descricao_glosa_ocor, ds_grupo, ds_observacao, ds_msg_externa, ds_documentacao, nr_regra_ocor, nr_seq_requisicao, nr_seq_proc, nr_seq_mat, nr_ocorrencia, ie_vinculo, nr_seq_vinculo) AS select	'G' ie_tipo,
	a.nr_sequencia,
