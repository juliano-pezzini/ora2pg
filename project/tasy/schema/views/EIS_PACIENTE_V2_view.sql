...
CREATE OR REPLACE VIEW eis_paciente_v2 (cd_cgc_indicacao, cd_cgc_seguradora, cd_estabelecimento, cd_funcao_alta_medica, cd_lugar_acc, cd_medico_atendimento, cd_medico_chamado, cd_medico_infect, cd_medico_preferencia, cd_medico_referido, cd_medico_resp, cd_motivo_alta, cd_motivo_alta_medica, cd_municipio_ocorrencia, cd_perfil_ativo, cd_pessoa_fisica, cd_pessoa_indic, cd_pessoa_juridica_indic, cd_pessoa_responsavel, cd_procedencia, cd_psicologo, cd_serv_alta_mx, cd_serv_entrada_mx, cd_serv_sec_mx, cd_serv_ter_mx, cd_setor_desejado, cd_setor_obito, cd_setor_usuario_atend, cd_tipo_acomod_desej, crm_medico_externo, ds_causa_externa, ds_informacao, ds_justif_saida_real, ds_obs_alta, ds_obs_alta_medic, ds_observacao, ds_observacao_biobanco, ds_obs_pa, ds_obs_prev_alta, ds_obs_prior, ds_pend_autorizacao, ds_sintoma_paciente, ds_utc, ds_utc_atualizacao, ds_vinculo_censo, dt_alta, dt_alta_interno, dt_alta_medico, dt_alta_tesouraria, dt_atend_medico, dt_atend_original, dt_atualizacao, dt_atualizacao_biobanco, dt_atualizacao_nrec, dt_cancelamento, dt_chamada_enfermagem, dt_chamada_medic, dt_chamada_paciente, dt_chamada_reavaliacao, dt_checagem_adep, dt_chegada_medic, dt_chegada_paciente, dt_classif_risco, dt_descolonizar_paciente, dt_entrada, dt_fim_consulta, dt_fim_conta, dt_fim_esp_exame, dt_fim_observacao, dt_fim_prescr_pa, dt_fim_reavaliacao, dt_fim_triagem, dt_impressao, dt_impressao_alta, dt_inicio_atendimento, dt_inicio_esp_exame, dt_inicio_observacao, dt_inicio_prescr_pa, dt_inicio_reavaliacao, dt_liberacao_enfermagem, dt_liberacao_financeiro, dt_lib_medico, dt_medicacao, dt_ocorrencia, dt_previsto_alta, dt_reavaliacao_medica, dt_recebimento_senha, dt_saida_prev_loc_pa, dt_saida_real, dt_ultima_menstruacao, dt_usuario_intern, dt_ver_prev_alta, ie_assinou_termo_biobanco, ie_avisar_medico_referido, ie_boletim_inform, ie_carater_inter_sus, ie_chamado, ie_classif_lote_ent, ie_clinica, ie_clinica_alta, ie_clinica_ant, ie_declaracao_obito, ie_divulgar_obito, ie_extra_teto, ie_fim_conta, ie_grupo_atend_bpa, ie_horario_verao, ie_laudo_preenchido, ie_liberado_checkout, ie_modo_internacao, ie_necropsia, ie_nivel_atencao, ie_paciente_gravida, ie_paciente_isolado, ie_permite_acomp, ie_permite_visita, ie_permite_visita_rel, ie_prm, ie_probabilidade_alta, ie_responsavel, ie_status_atendimento, ie_status_pa, ie_tipo_alta, ie_tipo_atend_bpa, ie_tipo_atendimento, ie_tipo_atend_tiss, ie_tipo_consulta, ie_tipo_convenio, ie_tipo_endereco_entrega, ie_tipo_saida_consulta, ie_tipo_serv_mx, ie_tipo_status_alta, ie_tipo_vaga, ie_trat_conta_rn, ie_vinculo_sus, nm_descolonizar_paciente, nm_fim_triagem, nm_inicio_atendimento, nm_medico_externo, nm_usuario, nm_usuario_alta, nm_usuario_alta_medica, nm_usuario_atend, nm_usuario_biobanco, nm_usuario_cancelamento, nm_usuario_intern, nm_usuario_nrec, nm_usuario_prob_alta, nm_usuario_saida, nm_usuario_triagem, nr_atend_alta, nr_atendimento, nr_atendimento_mae, nr_atend_origem_bpa, nr_atend_origem_pa, nr_atend_original, nr_bilhete, nr_cat, nr_conv_interno, nr_dias_prev_alta, nr_gestante_pre_natal, nr_int_cross, nr_reserva_leito, nr_seq_atend_pls, nr_seq_cat, nr_seq_check_list, nr_seq_classif_esp, nr_seq_classificacao, nr_seq_classif_medico, nr_seq_episodio, nr_seq_evento_atend, nr_seq_ficha, nr_seq_ficha_lote, nr_seq_ficha_lote_ant, nr_seq_forma_chegada, nr_seq_forma_laudo, nr_seq_grau_parentesco, nr_seq_indicacao, nr_seq_informacao, nr_seq_local_destino, nr_seq_local_pa, nr_seq_motivo_biobanco, nr_seq_oftalmo, nr_seq_pac_senha_fila, nr_seq_pa_status, nr_seq_pq_protocolo, nr_seq_queixa, nr_seq_registro, nr_seq_regra_funcao, nr_seq_segurado, nr_seq_tipo_acidente, nr_seq_tipo_admissao_fat, nr_seq_tipo_lesao, nr_seq_tipo_midia, nr_seq_tipo_obs_alta, nr_seq_topografia, nr_seq_triagem, nr_seq_triagem_old, nr_seq_triagem_prioridade, nr_seq_unid_atual, nr_seq_unid_int, nr_serie_bilhete, nr_submotivo_alta, nr_vinculo_censo, qt_dia_longa_perm, qt_dias_prev_inter, qt_ig_dia, qt_ig_semana, vl_consulta, cd_religiao, ie_sexo, ie_estado_civil, ie_grau_instrucao, nm_usuario_int, nm_usuario_atend_up, nm_usuario_inter_up, nm_usuario_alta_up, ds_retorno, cd_retorno, cd_convenio, ds_convenio, ie_faixa_etaria, ds_municipio_ibge, ds_municipio, cd_municipio_ibge, ds_bairro, ds_procedencia, ds_sexo, ds_estado_civil, ds_grau_instrucao, ds_tipo_atendimento, ds_clinica, ds_religiao, nm_medico, ds_forma_chegada, ds_tipo_acidente, cd_especialidade, ds_especialidade, cd_setor_atendimento, ds_setor_atendimento, ds_microregiao, dt_dia_entrada, dt_dia_alta, dt_mes_entrada, dt_ano_entrada, cd_tipo_convenio, ds_tipo_convenio, ds_tipo_indicacao, nm_pessoa_indic, nm_pj_indic, ie_atendimento, ds_atendimento, ds_motivo_alta, nr_primeiro_atend, cd_empresa_atend, nm_empresa_atend, ds_classificacao, ds_diagnostico, cd_doenca_cid, ie_tipo_guia, ds_tipo_guia, ds_interna_proc, ds_lado, ds_procedimento, cd_procedimento, ie_proced_origem, nm_procedimento_up, ds_tipo_acomodacao, nr_dias_internado, ds_estabelecimento, ds_queixa, cd_classif_setor, ds_classif_setor, ds_classif_medico, ds_hora, cd_hora, ds_dia_semana, ds_dia_mes, ds_dia_mes_alta, ds_categoria, cd_plano, ds_plano, ds_nacionalidade, ds_carater_inter, ds_unidade, ds_hora_intervalo, cd_hora_intervalo, cd_empresa, ds_dia_turno, ds_turno, cd_turno, nr_dias_internado_number, ds_idade, cd_idade, nr_seq_cor_pele, ds_cor_pele, ie_fluencia_portugues, ds_fluencia_portugues, ds_usuario_alta, ds_usuario_atend, ds_usuario_internacao, ds_cidade_natal, nr_cep_cidade_nasc, ds_municipio_estado_ibge, nm_medico_referido, ds_motivo_transf, ds_hospital_destino, ds_convenio_glosa, ds_categoria_glosa, cd_convenio_glosa, cd_categoria_glosa, ds_categoria_cid, cd_categoria_cid, ds_hora_alta, cd_hora_alta, nm_paciente, cd_setor_entrada, ds_setor_entrada, cd_tipo_historico, ds_tipo_historico, ds_agrupamento, nr_seq_agrupamento, ds_motivo_canc_atend, ds_usuario_inter, ie_atend_cancelado, ds_atend_cancelado, ds_proc_interno, ds_cidade_param86, nr_seq_motivo_canc) AS select	a.CD_CGC_INDICACAO,
	...
	uppeR(nm_usuario_atend) nm_usuario_atend_up,
	upper(substr(obter_usuario_prim_internacao(a.NM_USUARIO_INTERN,a.nr_atendimento),1,15)) nm_usuario_inter_up,
	upper(nm_usuario_alta) nm_usuario_alta_up,
	CASE WHEN Obter_se_atend_retorno(a.nr_atendimento)='S' THEN OBTER_DESC_EXPRESSAO(297871)   ELSE OBTER_DESC_EXPRESSAO(346808) END  ds_retorno,
	Obter_se_atend_retorno(a.nr_atendimento) cd_retorno,
	...
	substr(obter_idade(b.dt_nascimento,dt_entrada,'E'),1,10) ie_faixa_etaria,
	Initcap(obter_compl_pf(b.cd_pessoa_fisica,1, 'DM')) ds_municipio_ibge,
	Initcap(obter_compl_pf(b.cd_pessoa_fisica,1, 'DSM')) ds_municipio,
	obter_compl_pf(b.cd_pessoa_fisica,1, 'CDM') cd_municipio_ibge,
	Initcap(obter_compl_pf(b.cd_pessoa_fisica,1, 'B')) ds_bairro,
	obter_desc_procedencia(a.cd_procedencia) ds_procedencia,
	obter_valor_dominio(4, b.ie_sexo) ds_sexo,
	obter_valor_dominio(5, b.ie_estado_civil) ds_estado_civil,
	obter_valor_dominio(10, b.ie_grau_instrucao) ds_grau_instrucao,
	obter_valor_dominio(12, a.ie_tipo_atendimento) ds_tipo_atendimento,
	obter_valor_dominio(17, a.ie_clinica) ds_clinica,
	obter_descricao_padrao('RELIGIAO', 'DS_RELIGIAO', b.cd_religiao) ds_religiao,
	obter_nome_pessoa_fisica(a.cd_medico_resp, null) nm_medico,
	obter_descricao_padrao('FORMA_CHEGADA', 'DS_FORMA', A.NR_SEQ_FORMA_CHEGADA) ds_forma_chegada,
	obter_descricao_padrao('TIPO_ACIDENTE', 'DS_TIPO_ACIDENTE', A.NR_SEQ_TIPO_ACIDENTE) ds_tipo_acidente,
	COALESCE(Obter_Espec_medico_atend(a.nr_atendimento,a.cd_medico_resp,'C'), Obter_Especialidade_medico(a.cd_medico_resp, 'C')) cd_especialidade,
	COALESCE(Obter_Espec_medico_atend(a.nr_atendimento,a.cd_medico_resp,'D'), Obter_Especialidade_medico(a.cd_medico_resp, 'D')) ds_especialidade,
	c.cd_setor_atendimento,
	obter_nome_setor(c.cd_setor_atendimento) ds_setor_atendimento,
	...
	substr(obter_nome_pf_pj(null,cd_pessoa_juridica_indic),1,200) nm_pj_indic,
	CASE WHEN COALESCE(nr_atend_original,0)=0 THEN 'N'  ELSE 'O' END  ie_atendimento,
	obter_valor_dominio(1536,CASE WHEN COALESCE(nr_atend_original,0)=0 THEN 'N'  ELSE 'O' END ) ds_atendimento,
	obter_desc_motivo_alta(a.cd_motivo_alta) ds_motivo_alta,
	CASE WHEN obter_se_primeiro_atend(a.nr_atendimento)='N' THEN 0  ELSE 1 END  nr_primeiro_atend,
	Obter_Empresa_Atend(a.nr_atendimento,'A','C') cd_empresa_atend,
	Obter_Empresa_Atend(a.nr_atendimento,'A','N') nm_empresa_atend,
	...
	obter_tipo_guia_convenio(a.nr_atendimento) ie_tipo_guia,
	obter_valor_dominio(1031,obter_tipo_guia_convenio(a.nr_atendimento)) ds_tipo_guia,
	substr(Obter_Desc_intern_Proc_Princ(a.nr_atendimento),1,125) ds_interna_proc,
	obter_lado_proced_princ_atend(a.nr_atendimento, 'D') ds_lado,
	...
	substr(obter_categoria_convenio(cd_convenio, cd_categoria),1,100) ds_categoria,
	cd_plano_convenio cd_plano,
	substr(obter_desc_plano_conv(cd_convenio,cd_plano_convenio),1,100) ds_plano,
	...
	substr(obter_nome_setor(c.cd_setor_atendimento),1,100) || ' ' || cd_unidade_basica || ' ' || cd_unidade_compl ds_unidade,
	...
	f.cd_empresa,
	Obter_Turno_Atendimento(a.dt_entrada,a.cd_estabelecimento,'T') ds_dia_turno,
	Obter_Turno_Atendimento(a.dt_entrada,a.cd_estabelecimento,'D') ds_turno,
	Obter_Turno_Atendimento(a.dt_entrada,a.cd_estabelecimento,'C') cd_turno,
	lpad((trunc(trunc(COALESCE(A.DT_ALTA, LOCALTIMESTAMP)) - trunc(A.DT_ENTRADA)))::numeric ,2,'0') nr_dias_internado_number,
	substr(lpad(obter_idade(b.dt_nascimento,LOCALTIMESTAMP,'A'),3,'0'),1,50) ds_idade,
	(obter_idade(b.dt_nascimento,LOCALTIMESTAMP,'A'))::numeric  cd_idade,
	b.nr_seq_cor_pele,
	substr(COALESCE(obter_desc_cor_pele(b.nr_seq_cor_pele),OBTER_DESC_EXPRESSAO(778770)),1,80) ds_cor_pele,
	b.ie_fluencia_portugues,
	substr(obter_valor_dominio(1343,b.ie_fluencia_portugues),1,100) ds_fluencia_portugues,
	substr(obter_nome_usuario(nm_usuario_alta),1,100) ds_usuario_alta,
	substr(obter_nome_usuario(nm_usuario_atend),1,100) ds_usuario_atend,
	...
	Initcap(obter_compl_pf(b.cd_pessoa_fisica,1, 'DM'))||CASE WHEN obter_compl_pf(b.cd_pessoa_fisica,1,'DM') IS NULL THEN ''  ELSE CASE WHEN obter_uf_ibge(obter_compl_pf(b.cd_pessoa_fisica,1, 'CDM')) IS NULL THEN ''  ELSE ' - '||obter_uf_ibge(obter_compl_pf(b.cd_pessoa_fisica,1, 'CDM')) END  END  ds_municipio_estado_ibge,
	...
	from	atend_paciente_unidade 
	where	nr_seq_interno = obter_atepacu_paciente(c.nr_atendimento, 'P'))),1,255),OBTER_DESC_EXPRESSAO(327119)) ds_setor_entrada,
	substr(obter_historico_atendimento(c.nr_atendimento, 'C'), 1, 10) cd_tipo_historico,
	substr(coalesce(obter_historico_atendimento(c.nr_atendimento, 'D'),OBTER_DESC_EXPRESSAO(327119)), 1, 100) ds_tipo_historico,	
	...
	substr(obter_desc_canc_atend(a.nr_atendimento),1,100) ds_motivo_canc_atend,
	substr(obter_nome_usuario(nm_usuario_intern),1,100) ds_usuario_inter,
	CASE WHEN a.dt_cancelamento IS NULL THEN 'N'  ELSE 'C' END  ie_atend_cancelado,
	obter_valor_dominio(5727,CASE WHEN a.dt_cancelamento IS NULL THEN 'N'  ELSE 'C' END ) ds_atend_cancelado,
	substr(Obter_Desc_Proc_Inter(obter_proc_principal(a.nr_atendimento, obter_convenio_atendimento(a.nr_atendimento), a.ie_tipo_atendimento, null, 'C'),obter_proc_principal(a.nr_atendimento, obter_convenio_atendimento(a.nr_atendimento), a.ie_tipo_atendimento, null, 'IO')),1,100) ds_proc_interno,
	substr(obter_dados_pf(a.cd_pessoa_fisica,'CNP'),1,240) ds_cidade_param86,
	obter_mot_canc_atend(a.nr_atendimento) nr_seq_motivo_canc
...
WHERE a.cd_pessoa_fisica	= b.cd_pessoa_fisica and a.nr_atendimento	= c.nr_atendimento and d.nr_atendimento	= a.nr_atendimento and a.cd_estabelecimento	= f.cd_estabelecimento  and COALESCE(h.ie_cancelado,'N')	= 'N' and c.nr_seq_interno 	=
	(select obter_atepacu_paciente(c.nr_atendimento, 'A') ) and d.nr_seq_interno	= Obter_Atecaco_atendimento(a.nr_atendimento);
