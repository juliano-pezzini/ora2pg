...
CREATE OR REPLACE VIEW itens_quebra_relat_exame_re (ie_ordem, cd_selecionado, cd_n_selecionado, ds, nm) AS SELECT	01 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1028513) DS, 'NM_MEDICO_CRM' NM
...
SELECT	63 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103663) DS, 'DT_IMPRIMIR' NM


UNION

SELECT	64 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103664) DS, 'DS_MOTIVO_COB_APAC' NM


UNION

SELECT	65 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103666) DS, 'NR_CONTA' NM


UNION

SELECT	66 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103667) DS, 'DS_COORDENADORIA' NM


UNION

SELECT	67 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103668) DS, 'DS_CONVENIO_ATEND' NM


UNION

SELECT	68 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103669) DS, 'DS_TIPO_UTIL' NM


UNION

SELECT	69 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103671) DS, 'DS_CID_AMA' NM


UNION

SELECT	70 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103672) DS, 'DS_CLASSIF_PROC_INT' NM


UNION

SELECT	71 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, wheb_mensagem_pck.get_texto(1103674) DS, 'DS_CONVENIO' NM
;
