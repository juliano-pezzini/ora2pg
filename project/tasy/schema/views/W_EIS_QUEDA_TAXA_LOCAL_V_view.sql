...
CREATE OR REPLACE VIEW w_eis_queda_taxa_local_v (cd_setor_queda, dt_queda, ds_setor_queda, dt_evento, cd_empresa, cd_estabelecimento, ds_unidade, nr_seq_local_queda, ds_local, nr_atendimento) AS select	distinct
	e.cd_setor_queda, 
	e.dt_queda, 
