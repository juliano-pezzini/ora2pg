...
CREATE OR REPLACE VIEW os_migracao_correcao_usuario_v (nr_seq_projeto, nr_seq_os, nm_executor, dt_os, nr_seq_grupo_desenv) AS select	p.nr_sequencia nr_seq_projeto,
