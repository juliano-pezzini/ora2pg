...
CREATE OR REPLACE VIEW eis_paciente_uti_v (nr_sequencia, dt_referencia, cd_setor_atendimento, dt_atualizacao, nm_usuario, nr_atendimento, ie_sexo, qt_idade, qt_obito, qt_cirurgia_eletiva, qt_cirurgia_urgencia, dt_entrada, dt_saida, qt_min_perm, qt_apache, pr_risco, nm_pessoa_fisica, dt_nascimento, qt_hr_perm, qt_dia_perm, ie_faixa_apache, ie_faixa_risco, ie_faixa_etaria, qt_peso) AS SELECT a.NR_SEQUENCIA,a.DT_REFERENCIA,a.CD_SETOR_ATENDIMENTO,a.DT_ATUALIZACAO,a.NM_USUARIO,a.NR_ATENDIMENTO,a.IE_SEXO,a.QT_IDADE,a.QT_OBITO,a.QT_CIRURGIA_ELETIVA,a.QT_CIRURGIA_URGENCIA,a.DT_ENTRADA,a.DT_SAIDA,a.QT_MIN_PERM,a.QT_APACHE,a.PR_RISCO,
	p.nm_pessoa_fisica, 
	p.dt_nascimento, 
	...
	substr(obter_qt_peso_sv(T.nr_atendimento),1,10) qt_peso 
