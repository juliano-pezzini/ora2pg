...
select	null cd_agenda, 
	...
	b.cd_pessoa_fisica, 
	substr(c.nm_pessoa_fisica,1,60) nm_paciente_pf, 
	substr(c.nm_pessoa_fisica,1,60) nm_paciente, 
	substr(c.nm_pessoa_fisica,1,60) nm_cliente, 
