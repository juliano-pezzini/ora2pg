...
SELECT 	CASE WHEN a.cd_tipo_agenda=5 THEN obter_desc_expressao(298345)  ELSE obter_desc_expressao(285916) END  ds_tipo_agenda,
	coalesce(SUBSTR(obter_nome_pf(a.cd_pessoa_fisica),1,60),SUBSTR(coalesce(Obter_Desc_Espec_medica(a.cd_Especialidade),a.ds_agenda),1,255)) ds_Agenda,
...
SELECT 	obter_desc_expressao(289736) ds_tipo_agenda,
	...
	null nr_seq_radio,
	null nr_seq_quimio,
	substr(CASE WHEN b.dt_cancelamento IS NULL THEN  Obter_Desc_Status_Ageint(a.nr_Seq_status)  ELSE obter_desc_expressao(322155) END ,1,80) ds_status,
	null cd_convenio_exame,
