...
CREATE OR REPLACE VIEW prescr_material_pendente_v (nr_prescricao, dt_prescricao, nr_atendimento, dt_primeiro_horario, nm_medico, nm_paciente, nr_itens, nr_itens_urgentes, ie_item_urgente, dt_liberacao, dt_liberacao_medico, dt_liberacao_farmacia, ie_lib_farm, dt_emissao_farmacia, nm_usuario, nm_usuario_original, cd_setor_atendimento, ds_setor_atendimento, cd_local_estoque, cd_local_material, dt_emissao_setor_atend, cd_estabelecimento, ie_imp_parcial, nr_prontuario, nr_cirurgia, ie_cirurgia, ds_origem_inf, nr_seq_atend_futuro, ie_agrupador, nr_seq_status_farm) AS select	a.nr_prescricao,
	a.dt_prescricao,
	a.nr_atendimento,
