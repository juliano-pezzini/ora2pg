...
SELECT 	10 			TP_REG, 
	...
	a.nr_interno_conta, 
  	...
  	substr(Obter_maior_guia_conta(a.nr_interno_conta),1,8) 
				nr_documento, 
...
SELECT 	12 			TP_REG, 
	...
	a.nr_interno_conta 	nr_conta, 
	a.cd_procedimento_tuss	cd_proc_tuss 
...
SELECT 	19 			TP_REG, 
	...
	'', 
	'', 
	max(HSI_Obter_Total_Linhas(a.nr_seq_protocolo, a.nr_interno_conta)) NR_TOTAL_LINHA, 
...
and 	coalesce(b.ie_responsavel_credito,'H') <> 'PRC' 
