...
CREATE OR REPLACE VIEW eis_maddox_braden_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, cd_empresa, cd_estabelecimento, qt_ponto, ds_gradacao, nr_atendimento, cd_paciente) AS SELECT	DISTINCT
