...
SELECT		'CABECALHO CONTA      '		DS_REGISTRO,
		...
		'0'				ie_tipo_faturamento,
		'N'				ie_folha_sala,
		CASE WHEN B.ie_tipo_atendimento=7 THEN '3' WHEN B.ie_tipo_atendimento=1 THEN '4' WHEN B.ie_tipo_atendimento=3 THEN '6' WHEN B.ie_tipo_atendimento=8 THEN 			CASE WHEN B.ie_clinica=21 THEN '2' WHEN B.ie_clinica=22 THEN '2'  ELSE '4' END   ELSE ' ' END   cd_classe_atend
