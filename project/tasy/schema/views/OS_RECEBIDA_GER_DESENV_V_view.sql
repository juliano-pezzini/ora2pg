...
CREATE OR REPLACE VIEW os_recebida_ger_desenv_v (nr_sequencia, nr_seq_gerencia, dt_ordem_servico, nr_seq_grupo_des, nr_seq_localizacao, cd_funcao) AS select	a.nr_sequencia,
	b.nr_Seq_gerencia,
	a.dt_ordem_servico,
	a.nr_seq_grupo_des,
