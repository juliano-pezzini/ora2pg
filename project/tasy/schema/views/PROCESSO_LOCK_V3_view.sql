...
CREATE OR REPLACE VIEW processo_lock_v3 (ds_status, sid, "serial#", programa, machine, modulo, nm_objeto, locked_mode, status, usuario, nome) AS SELECT SUBSTR(CASE WHEN L.request=0 THEN  'Lock'  ELSE 'Wait' END ,1,4) ds_status,
	  S.sid, 
	  S.serial#, 
