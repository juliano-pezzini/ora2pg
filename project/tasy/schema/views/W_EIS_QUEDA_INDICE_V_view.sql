...
CREATE OR REPLACE VIEW w_eis_queda_indice_v (cd_setor_queda, ds_setor_queda, dt_evento, cd_empresa, cd_estabelecimento, ds_unidade, ie_gravidade, ds_gravidade, nr_seq_local_queda, ds_local, qt_total, nr_atendimento) AS select	distinct
	e.cd_setor_queda,
