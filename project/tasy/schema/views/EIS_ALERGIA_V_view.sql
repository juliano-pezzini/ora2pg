...
CREATE OR REPLACE VIEW eis_alergia_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, cd_pessoa_fisica, ie_faixa_etaria, dt_avaliacao, cd_empresa, cd_estabelecimento, nr_atendimento, cd_paciente, ds_alergeno, nm_paciente, nr_seq_tipo) AS select	distinct
