...
CREATE OR REPLACE VIEW patient_details_report_v (cd_pessoa_fisica, ds_patient, ds_dob_age, ds_gender, ds_address, mob_numer, ds_phone_number, dt_admission, nr_mrn, nr_encounter, cd_medicare, dt_medicare_exp, ds_health_fund, ds_ins_member, ds_concessio_card, cd_concession_number, ds_safetynet, nr_ihi, nm_doctor) AS select
        trim(both a.cd_pessoa_fisica) cd_pessoa_fisica,
