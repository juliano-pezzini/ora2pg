...
CREATE OR REPLACE VIEW hl7_dixtar_quati_obx_v (ie_tipo, value_type, oi_identifier, oi_text, observation_value, u_identifier, u_text, references_range, observ_result_status, date_time_of_the_observation, units, abnormalflags, nr_seq_resultado, nr_seq_prescr, oi_name_coding_system, oi_alternate_identifier, oi_alternate_text, oi_alternate_coding_text, nr_seq_result_item) AS select	1 ie_tipo,
