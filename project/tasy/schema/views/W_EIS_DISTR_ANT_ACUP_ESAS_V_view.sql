...
CREATE OR REPLACE VIEW w_eis_distr_ant_acup_esas_v (nr_sequencia, dt_avaliacao, nr_atendimento, setor, ds_setor_atendimento, ie_sexo, ds_sexo, ie_faixa_etaria, cd_estabelecimento, ds_estabelecimento, ds_pont_dor, ds_pont_cansaco, ds_pont_nausea, ds_pont_depressao, ds_pont_ansiedade, ds_pont_sonolencia, ds_pont_inapetencia, ds_pont_estar, ds_pont_falta_ar, tipo, ds_atendimento) AS select distinct
	a.nr_sequencia, 
	a.dt_avaliacao, 
	a.nr_atendimento, 
