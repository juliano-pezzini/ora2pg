...
select
	...
	b.cd_grupo,
	b.ie_tipo,
	a.vl_debito - coalesce(a.vl_ord_debito,0) vl_debito,
	a.vl_credito - coalesce(a.vl_ord_credito,0) vl_credito,
	a.vl_saldo - coalesce(a.vl_ordem,0),
	a.vl_movimento - coalesce(a.vl_ordem,0),
	a.vl_saldo - a.vl_movimento vl_saldo_ant,
	coalesce(a.vl_eliminacao,0) vl_eliminacao,
	coalesce(a.nr_nivel_conta, ctb_obter_nivel_classif_conta(coalesce(a.cd_classificacao, b.cd_classificacao))) ie_nivel,
	obter_classif_ctb(coalesce(a.cd_classificacao, b.cd_classificacao), 'SUPERIOR') ie_classif_superior,
...
select
	...
	b.cd_grupo,
	b.ie_tipo,
	a.vl_debito - coalesce(a.vl_enc_debito,0) - coalesce(a.vl_ord_debito,0) vl_debito,
	a.vl_credito - coalesce(a.vl_enc_credito,0) - coalesce(a.vl_ord_credito,0) vl_credito,
	a.vl_saldo - a.vl_encerramento - coalesce(a.vl_ordem,0),
	a.vl_movimento - a.vl_encerramento - coalesce(a.vl_ordem,0),
	a.vl_saldo - a.vl_movimento vl_saldo_ant,
	coalesce(a.vl_eliminacao,0) vl_eliminacao,
	coalesce(a.nr_nivel_conta, ctb_obter_nivel_classif_conta(coalesce(a.cd_classificacao, b.cd_classificacao))) ie_nivel,
	obter_classif_ctb(coalesce(a.cd_classificacao, b.cd_classificacao), 'SUPERIOR') ie_classif_superior,
