...
CREATE OR REPLACE VIEW epimed_nas_v (nr_atendimento, nr_sequencia, dt_avaliacao, setor, ds_setor_atendimento, ds_item, qt_score, qt_pontuacao, ie_sexo, ds_sexo, ie_faixa_etaria, cd_estabelecimento, ds_estabelecimento, ds_unidade) AS select distinct
	a.nr_atendimento,
	a.nr_sequencia,
