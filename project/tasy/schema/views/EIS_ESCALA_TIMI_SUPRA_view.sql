...
CREATE OR REPLACE VIEW eis_escala_timi_supra (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_ponto, pr_risco_morte_30d, cd_empresa, cd_estabelecimento, nr_atendimento, cd_paciente) AS SELECT	DISTINCT
