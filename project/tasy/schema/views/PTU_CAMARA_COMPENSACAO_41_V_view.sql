...
CREATE OR REPLACE VIEW ptu_camara_compensacao_41_v (nr_seq_compensacao, tp_registro, nr_sequencia, cd_tipo_registro, cd_unimed_destino, cd_unimed_origem, dt_geracao, dt_camara, ie_tipo_camara, nr_versao_transacao, cd_unimed_credora, cd_unimed_devedora, nr_fatura, ie_tipo_fatura, vl_total_fatura, dt_atualizacao_602, qt_total_uni_credora, qt_total_uni_devedora, qt_nr_fatura, vl_total_fatura_609, dt_postagem, nr_protocolo) AS select	nr_sequencia		nr_seq_compensacao,
	1			tp_registro,
	1			nr_sequencia,
