...
CREATE OR REPLACE VIEW resumen_clinico_medic_2_v (nr_atendimento, ds_material, dt_adm, dt_fim_adm, qt_dose, ie_via_aplicacao, ie_desc_via_aplicacao, ds_observacao, cd_cat_medicamento, ds_medicamento, cd_material) AS SELECT  a.nr_atendimento NR_ATENDIMENTO,
