...
CREATE OR REPLACE VIEW w_eis_complex_fugulin_v (nr_sequencia, dt_avaliacao, setor, ds_setor_atendimento, ds_item, qt_pontuacao, qt_score, nr_seq_gradacao, ds_gradacao, ie_sexo, ds_sexo, ie_faixa_etaria, cd_estabelecimento, ds_estabelecimento, ds_unidade, cd_paciente, nm_paciente, cd_setor_atendimento) AS select distinct
	a.nr_sequencia, 
