...
CREATE OR REPLACE VIEW eis_cih_v (ie_origem_inf, nr_atendimento, dt_ficha, dt_alta, nr_ficha_ocorrencia, cd_clinica, cd_medico, ie_retardou_alta, cd_doenca_cid, cd_topografia, cd_caso_infeccao, ds_clinica, nm_medico_atend, ds_retard_alta, ds_doenca, ds_topografia, ds_caso_infec, qt_todos, qt_nao_infec, qt_infectados, ie_sexo, ie_faixa_etaria, ds_setor_atendimento, cd_empresa) AS select		distinct 1 ie_origem_inf,
		a.nr_atendimento, 
		trunc(a.dt_ficha) dt_ficha, 
		null dt_alta, 
		...
		substr(obter_nome_setor(b.cd_setor_origem),1,100) ds_setor_atendimento, 
		obter_empresa_estab(obter_estab_atend(a.nr_atendimento)) cd_empresa 
FROM cih_ficha_ocorrencia a
LEFT OUTER JOIN cih_local_infeccao b ON (a.nr_ficha_ocorrencia = b.nr_ficha_ocorrencia) group BY		trunc(a.dt_ficha), 
		a.nr_ficha_ocorrencia, 
		a.cd_clinica, 
		a.cd_medico, 
		a.ie_retardou_alta, 
		...
		substr(obter_nome_setor(b.cd_setor_origem),1,100), 
...
WHERE cd_topografia is null group by	trunc(a.dt_ficha), 
		a.nr_ficha_ocorrencia, 
		a.cd_clinica, 
		a.cd_medico, 
		a.ie_retardou_alta, 
...
FROM cih_ficha_ocorrencia a
LEFT OUTER JOIN cih_local_infeccao b ON (a.nr_ficha_ocorrencia = b.nr_ficha_ocorrencia)
WHERE cd_topografia is not null group by		trunc(a.dt_ficha), 
		a.nr_ficha_ocorrencia, 
		a.cd_clinica, 
		a.cd_medico, 
		a.ie_retardou_alta, 
...
LEFT OUTER JOIN cih_local_infeccao b ON (a.nr_ficha_ocorrencia = b.nr_ficha_ocorrencia)
WHERE a.nr_atendimento    =  	g.nr_atendimento  group by	trunc(g.dt_alta), 
		a.nr_ficha_ocorrencia, 
		a.cd_clinica, 
		a.cd_medico, 
		a.ie_retardou_alta, 
...
FROM atendimento_paciente g, cih_ficha_ocorrencia a
LEFT OUTER JOIN cih_local_infeccao b ON (a.nr_ficha_ocorrencia = b.nr_ficha_ocorrencia)
WHERE a.nr_atendimento    =  	g.nr_atendimento  and cd_topografia is null group by	trunc(g.dt_alta), 
		a.nr_ficha_ocorrencia, 
		a.cd_clinica, 
		a.cd_medico, 
		a.ie_retardou_alta, 
...
FROM atendimento_paciente g, cih_ficha_ocorrencia a
LEFT OUTER JOIN cih_local_infeccao b ON (a.nr_ficha_ocorrencia = b.nr_ficha_ocorrencia)
WHERE a.nr_atendimento    =  	g.nr_atendimento  and cd_topografia is not null group by	trunc(g.dt_alta), 
		a.nr_ficha_ocorrencia, 
		a.cd_clinica, 
		a.cd_medico, 
		a.ie_retardou_alta, 
