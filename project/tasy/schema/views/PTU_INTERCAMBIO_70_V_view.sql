...
CREATE OR REPLACE VIEW ptu_intercambio_70_v (nr_seq_intercabio, tp_registro, nr_sequencia, cd_tipo_registro, cd_unimed_destino, cd_unimed_origem, dt_geracao, ie_tipo_mov, dt_mov_inicio, dt_mov_fim, nr_versao_transacao, cd_filial, nm_empr_comp, nm_empr_abrev, ds_reservado, cd_cgc_cpf, nr_insc_estadual, ds_endereco, ds_complemento, ds_bairro, cd_cep, nm_cidade, sg_uf, nr_ddd, dt_inclusao, dt_exclusao, cd_empresa_origem, cd_municipio_ibge, nr_telefone, nr_fax, nr_endereco_empresa, cd_plano_origem, ds_plano_origem, cd_plano_intercambio, dt_inclusao_plano, dt_exclusao_plano, ie_natureza, ie_abrangencia, nr_ind_reembolso, cd_ope_ans, cd_prod_ans, ie_plano, cd_unimed, cd_usuario_plano, cd_familia, nm_benef_abreviado, cd_plano_intercambio_benef, dt_nascimento, ie_sexo, cd_cgc_cpf_benef, nr_rg, sg_uf_rg, ie_estado_civil, dt_inclusao_benef, dt_exclusao_benef, ie_repasse, cd_dependencia, ie_recem_nascido, nr_matricula, dt_validade_carteira, cd_local_atendimento, cd_lotacao, ds_lotacao, dt_repasse, dt_fim_repasse, dt_inclusao_plano_dest, cd_plano_origem_benef, nr_vigencia_origem, cd_titular_plano, nm_beneficiario, nr_cartao_nac_sus, nm_mae_benef, nr_pis_pasep, cd_segmentacao_ptu, cd_tipo_cobertura, dt_fim_carencia, cd_tipo_produto, ds_produto, ds_endereco_benef, ds_bairro_benef, cd_cep_benef, nm_municipio, sg_uf_benef, nr_ddd_benef, nr_ramal, nr_fone, nr_endereco, cd_cid, dt_fim_carencia_preex, qt_total_r102, qt_total_r103, qt_total_r104, qt_total_inclusao, qt_exclusos_benef, qt_total_alteracoes, qt_total_transferencia, qt_total_r105, qt_total_r106, qt_total_r107, qt_total_r108, dt_postagem, nr_protocolo, nr_seq_plano, nr_seq_segurado, nr_seq_empresa, nr_seq_benef, ie_contrato_local, dt_comp_risco, ie_exclusao_rn412) AS select	nr_sequencia		nr_seq_intercabio,
	1			tp_registro,
	1			nr_sequencia,
	...
	0			nr_seq_empresa,
	0			nr_seq_benef,
	null			ie_contrato_local,
	null			dt_comp_risco,
	null			ie_exclusao_rn412
...
select	nr_seq_intercambio	nr_seq_intercabio,
	...
	a.cd_cep		cd_cep,
	Elimina_Acentuacao(a.nm_cidade)	nm_cidade,
	a.sg_uf			sg_uf,
	a.nr_ddd		nr_ddd,
	...
	1			nr_seq_benef,
	ie_contrato_local	ie_contrato_local,
	null			dt_comp_risco,
	null			ie_exclusao_rn412
...
select	b.nr_seq_intercambio	nr_seq_intercabio,
	...
	elimina_acentuacao(a.nm_mae_benef) nm_mae_benef,
	a.nr_pis_pasep		nr_pis_pasep,
	a.cd_segmentacao_ptu	cd_segmentacao_ptu, -- Atributo adicionado PTU 6.3 - OS: 910470 - lkcoelho
	null			cd_tipo_cobertura,
	null			dt_fim_carencia,
	null			cd_tipo_produto,
	null			ds_produto,
