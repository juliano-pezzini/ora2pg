...
select
	...
	03				tp_prestador,
	CASE WHEN c.tp_nota=85 THEN 0  ELSE CASE WHEN a.ie_tipo_atendimento=1 THEN coalesce((obter_conversao_meio_ext_ipe(c.cd_cgc_convenio,'W_INTERF_CONTA_CAB','CD_MOTIVO_ALTA',a.cd_motivo_alta))::numeric ,0)  ELSE 0 END  END 
					cd_motivo_cobranca,
	...
	(sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END  WHEN c.tp_nota=86 THEN CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END   ELSE 0 END ) +
	sum(CASE WHEN c.tp_nota=77 THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=87 THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_honorario  ELSE c.vl_total_item END   ELSE 0 END ) +
	...
	sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END  WHEN c.tp_nota=86 THEN CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END   ELSE 0 END ) vl_total_despesa,
	...
	sum(CASE WHEN c.tp_nota=77 THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=87 THEN c.vl_total_item  ELSE 0 END ) vl_total_servico,
...
select
	...
	a.cd_interno		cd_prestador,
	03				tp_prestador,
	CASE WHEN a.ie_tipo_atendimento=1 THEN coalesce((obter_conversao_meio_ext_ipe(c.cd_cgc_convenio,'W_INTERF_CONTA_CAB','CD_MOTIVO_ALTA',a.cd_motivo_alta))::numeric ,0)  ELSE 0 END 
					cd_motivo_cobranca,
	a.dt_entrada			dt_entrada,
	a.dt_alta			dt_alta,
	substr(a.nr_doc_convenio,1,6)	nr_guia,
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END )		vl_total_item,
	sum(CASE WHEN to_char(c.cd_item_convenio)=to_char(c.cd_item) THEN CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END   ELSE 0 END )	vl_total_matmed,
	' '				cd_brasindice,
	' '				cd_unidade_medida
from	w_interf_conta_item_ipe c,
	w_interf_conta_total b,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	CASE WHEN c.ie_responsavel_credito='H' THEN '00000000000000' WHEN c.ie_responsavel_credito='MEDIC' THEN CASE WHEN c.cd_cgc_prestador=c.cd_cgc_hospital THEN '00000000000000'  ELSE c.cd_cgc_prestador END   ELSE c.ie_prestador END  cd_prestador,
	03				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
	...
	c.ie_urgencia			ie_urgencia,
	0				vl_honorario,
	CASE WHEN ie_tipo_item='2' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_custo_oper  ELSE c.vl_total_item END  WHEN ie_tipo_item='4' THEN CASE WHEN ie_responsavel_credito='MPRC' THEN (vl_unitario_item * qt_item)  ELSE c.vl_total_item END   ELSE c.vl_total_item END 			vl_total_item,
	0				vl_total_matmed,
...
select
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN ie_responsavel_credito='MPRC' THEN c.vl_honorario  ELSE c.vl_total_item END ) vl_total_item,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	CASE WHEN c.ie_responsavel_credito='H' THEN c.cd_cgc_hospital WHEN c.ie_responsavel_credito='MEDIC' THEN c.cd_cgc_prestador WHEN c.ie_responsavel_credito='MPRC' THEN c.cd_cgc_prestador  ELSE c.ie_prestador END  cd_prestador,
	03				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
	...
	CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END 
					vl_honorario,
	CASE WHEN c.ie_responsavel_credito='MPRC' THEN c.vl_honorario  ELSE c.vl_total_item END 	vl_total_item,
	0				vl_total_matmed,
	' '				cd_brasindice,
	' '				cd_unidade_medida
from	w_interf_conta_item_ipe c,
