...
CREATE OR REPLACE VIEW eis_lab_tempos_etapa_v (cd_setor_atendimento, ie_tipo, nr_seq_grupo, ds_grupo, ds_setor_atendimento, ds_setor_entrega, cd_setor_entrega, nm_exame, nr_seq_exame, nr_atendimento, dt_referencia, min_1, min_2, min_3, min_4, min_5, min_6, min_7, min_8, min_9, qt1, qt2, qt3, qt4, qt5, qt6, qt7, qt8, qt9, ds_tipo_atendimento, ie_tipo_atendimento, cd_estabelecimento, nm_estabelecimento) AS select 	0 cd_setor_atendimento, /* Mapa traballho */
	1 ie_tipo,
	c.nr_seq_grupo,
	...
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '15', 'D'),'dd/mm/yyyy hh24:mi:ss')
 	- coalesce(to_date(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,15,1),'dd/mm/yyyy hh24:mi:ss'),b.dt_liberacao)),3) min_1,
	0 min_2,
	0 min_3,
	0 min_4,
	0 min_5,
  ...
  substr(obter_nome_estabelecimento(b.cd_Estabelecimento), 1,255) nm_estabelecimento
...
group by c.nr_seq_grupo,
	 trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, b.nr_atendimento, b.cd_estabelecimento
...
select  0 cd_setor_atendimento, /* Coleta do Material */
	...
	trunc(b.dt_prescricao) dt_referencia,
	0 min_1,
	round((coalesce(to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '20', 'D'),'dd/mm/yyyy hh24:mi:ss'),a.dt_coleta)
				- coalesce(to_date(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,20,1),'dd/mm/yyyy
hh24:mi:ss'),b.dt_liberacao)),3) min_2,
	0 min_3,
	0 min_4,
	0 min_5,
	0 min_6,
	...
	obter_valor_dominio(12,obter_tipo_atendimento(b.nr_atendimento)) ds_tipo_atendimento,
	obter_tipo_atendimento(b.nr_atendimento) ie_tipo_atendimento,
  b.cd_estabelecimento, substr(obter_nome_estabelecimento(b.cd_Estabelecimento), 1,255) nm_estabelecimento
from   prescr_medica b,
	exame_laboratorio c,
	prescr_procedimento a
where 	c.nr_seq_exame = a.nr_seq_exame
...
and  	a.nr_seq_exame is not null
group by  c.nr_seq_grupo,
	 trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, b.nr_atendimento, a.dt_coleta,b.cd_estabelecimento
...
select 0 cd_setor_atendimento, /* Distribuição do Material */
	...
	0 min_1,
	0 min_2,
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '25', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- coalesce(to_date(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,25,1),'dd/mm/yyyy
hh24:mi:ss'),b.dt_liberacao)),3) min_3,
	0 min_4,
	0 min_5,
	0 min_6,
	0 min_7,
...
select 0 cd_setor_atendimento, /* Digitação */
	...
	0 min_2,
	0 min_3,
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '30', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- coalesce(to_date(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,30,1),'dd/mm/yyyy
hh24:mi:ss'),b.dt_liberacao)),3) min_4,
	0 min_5,
	0 min_6,
	0 min_7,
	0 min_8,
...
select 0 cd_setor_atendimento, /*  Aprovação */
	...
	0 min_3,
	0 min_4,
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '35', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- coalesce(to_date(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,35,1),'dd/mm/yyyy
hh24:mi:ss'),b.dt_liberacao)),3) min_5,
	0 min_6,
	0 min_7,
	0 min_8,
	0 min_9,
...
select 	0 cd_setor_atendimento, /*  Liberação até a Coleta */
	...
	0 min_4,
	0 min_5,
	round((a.dt_coleta - b.dt_liberacao),3) min_6,
	0 min_7,
	0 min_8,
	0 min_9,
	0 qt1,
...
select 0 cd_setor_atendimento, /* Liberação até Liberação do exame */
	...
	0 min_7,
	0 min_8,
	round((to_date(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '40', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- b.dt_liberacao),3) min_9,
	0 qt1,
	0 qt2,
	0 qt3,
	0 qt4,
...
hh24:mi:ss'),b.dt_liberacao)),3) min_1,
	0 min_2,
	0 min_3,
	0 min_4,
	0 min_5,
...
and  	a.nr_seq_exame is not null
group by c.nm_exame,
	 trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, c.nr_seq_exame, b.nr_atendimento,b.cd_estabelecimento
...
and  	a.nr_seq_exame is not null
group by  c.nm_exame,
	 trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, c.nr_seq_exame, b.nr_atendimento, a.dt_coleta, b.cd_estabelecimento
...
group by b.cd_setor_entrega,
	 trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, b.cd_setor_entrega, b.nr_atendimento, b.cd_estabelecimento
...
and  	a.nr_seq_exame is not null
group by  b.cd_setor_entrega,
	 trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, b.cd_setor_entrega, b.nr_atendimento, a.dt_coleta, b.cd_estabelecimento
...
and   a.dt_coleta is not null
and    a.nr_seq_exame is not null
group by b.cd_estabelecimento,a.dt_coleta,
   trunc(b.dt_prescricao),a.nr_prescricao, a.nr_sequencia, b.dt_liberacao, c.nr_seq_exame, b.nr_atendimento
