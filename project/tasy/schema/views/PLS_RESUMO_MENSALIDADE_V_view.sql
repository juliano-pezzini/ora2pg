...
CREATE OR REPLACE VIEW pls_resumo_mensalidade_v (dt_mes_referencia, vl_mensalidade, vl_coparticipacao, vl_liq_sem_copartic, vl_mens_definitivo, vl_antecipacao_rata, vl_pro_rata_dia, vl_cancelado, vl_imposto, vl_antecipacao, vl_antecipacao_rata_ant, vl_manual, vl_carteirinha, cd_estabelecimento) AS select	trunc(c.dt_mesano_referencia,'month') dt_mes_referencia,
