...
select
	...
	3				tp_prestador,
	CASE WHEN c.tp_nota=85 THEN 0  ELSE CASE WHEN a.ie_tipo_atendimento=1 THEN CASE WHEN a.dt_periodo_final=coalesce(a.dt_alta,a.dt_entrada) THEN a.cd_motivo_alta  ELSE 4 END   ELSE 0 END  END 
					cd_motivo_cobranca,
	...
	sum(CASE WHEN c.tp_nota=75 THEN CASE WHEN c.ie_responsavel_credito='TH' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END  WHEN c.tp_nota=85 THEN CASE WHEN c.ie_responsavel_credito='TH' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END   ELSE 0 END )) vl_total_conta,
	...
	sum(CASE WHEN c.tp_nota=75 THEN CASE WHEN c.ie_responsavel_credito='TH' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END  WHEN c.tp_nota=85 THEN CASE WHEN c.ie_responsavel_credito='TH' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END   ELSE 0 END ) vl_total_honorario,
	0				nr_linha,
	LOCALTIMESTAMP				dt_item,
	0				cd_item_convenio,
	0				qt_dias_executado,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	CASE WHEN c.ie_responsavel_credito='H' THEN c.cd_cgc_hospital  ELSE to_char(c.cd_prestador) END  cd_prestador,
	3				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
	...
	CASE WHEN c.ie_responsavel_credito='H' THEN c.vl_honorario WHEN c.ie_responsavel_credito='TH' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END 
					vl_honorario,
...
select
	...
	a.cd_interno			cd_prestador,
	3				tp_prestador,
	CASE WHEN a.ie_tipo_atendimento=1 THEN CASE WHEN a.dt_periodo_final=coalesce(a.dt_alta,a.dt_entrada) THEN a.cd_motivo_alta  ELSE 4 END   ELSE 0 END 
					cd_motivo_cobranca,
	a.dt_periodo_inicial		dt_entrada,
	a.dt_periodo_final		dt_alta,
	substr(a.nr_doc_convenio,1,6)	nr_guia,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	CASE WHEN c.ie_responsavel_credito='H' THEN c.cd_cgc_hospital  ELSE c.ie_prestador END  cd_prestador,
	3				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
