...
select	2					tp_registro, 
	...
	substr(coalesce(nfse_obter_regra('TP', n.cd_estabelecimento),'I'),1,2) 	ie_situacao, 
	...
	substr(coalesce(CASE WHEN n.cd_pessoa_fisica IS NULL THEN obter_dados_pf_pj(null,n.cd_cgc,'LO')  ELSE Sus_Obter_Desc_TipoLog(obter_dados_pf_pj(n.cd_pessoa_fisica,null,'TLS')) END ,'Rua'),1,3) ds_tipo_logradouro, 
