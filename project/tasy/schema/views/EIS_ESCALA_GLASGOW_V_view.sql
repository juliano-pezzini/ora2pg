...
CREATE OR REPLACE VIEW eis_escala_glasgow_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_glasgow, cd_empresa, cd_estabelecimento, ds_gradacao, cd_paciente) AS select	distinct
	...
	substr(obter_resultado_glasgow(e.qt_glasgow),1,100) ds_gradacao,
	substr(obter_pessoa_atendimento(e.nr_atendimento,'C'),1,50) cd_paciente
FROM 	atend_escala_indice e,
	estabelecimento f,
