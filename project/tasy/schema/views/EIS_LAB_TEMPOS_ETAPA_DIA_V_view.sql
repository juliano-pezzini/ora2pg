...
CREATE OR REPLACE VIEW eis_lab_tempos_etapa_dia_v (cd_setor_atendimento, ie_tipo, nr_seq_grupo, ds_grupo, ds_setor_atendimento, ds_setor_entrega, nm_exame, dt_referencia, min_1, min_2, min_3, min_4, min_5, min_6, min_7, min_8, min_9, qt1, qt2, qt3, qt4, qt5, qt6, qt7, qt8, qt9) AS select 	0 cd_setor_atendimento, /* Mapa traballho */
	1 ie_tipo,
	c.nr_seq_grupo,
	...
	(TO_DATE(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '15', 'D'),'dd/mm/yyyy hh24:mi:ss') - coalesce(TO_DATE(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,15,1),'dd/mm/yyyy hh24:mi:ss'),b.dt_liberacao)) min_1,
	0 min_2,
	0 min_3,
	0 min_4,
	0 min_5,
...
select  0 cd_setor_atendimento, /* Coleta do Material */
	...
	(coalesce(TO_DATE(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '20', 'D'),'dd/mm/yyyy hh24:mi:ss'),a.dt_coleta)
				- coalesce(TO_DATE(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,20,1),'dd/mm/yyyy hh24:mi:ss'),b.dt_liberacao)) min_2,
	0 min_3,
	0 min_4,
	0 min_5,
	0 min_6,
...
select 0 cd_setor_atendimento, /* Distribuição do Material */
	...
	(TO_DATE(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '25', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- coalesce(TO_DATE(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,25,1),'dd/mm/yyyy hh24:mi:ss'),b.dt_liberacao)) min_3,
	0 min_4,
	0 min_5,
	0 min_6,
	0 min_7,
...
select 0 cd_setor_atendimento, /* Digitação */
	...
	(TO_DATE(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '30', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- coalesce(TO_DATE(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,30,1),'dd/mm/yyyy hh24:mi:ss'),b.dt_liberacao)) min_4,
	0 min_5,
	0 min_6,
	0 min_7,
	0 min_8,
...
select 0 cd_setor_atendimento, /*  Aprovação */
	...
	(TO_DATE(obter_lab_execucao_etapa(a.nr_prescricao, a.nr_sequencia, '35', 'D'),'dd/mm/yyyy hh24:mi:ss')
				- coalesce(TO_DATE(lab_obter_etapa_ant(a.nr_prescricao,a.nr_sequencia,35,1),'dd/mm/yyyy hh24:mi:ss'),b.dt_liberacao)) min_5,
	0 min_6,
	0 min_7,
	0 min_8,
	0 min_9,
