...
CREATE OR REPLACE VIEW exp_nota_fiscal_entrada_v (tp_registro, ie_tipo_servico, ie_tipo_documento, nr_nota_fiscal, dt_mesano_referencia, ie_pf_pj_prestador, cd_cpf_cnpj_prestador, ie_pf_pj_tomador, cd_cpf_cnpj_tomador, dt_emissao, vl_total_nota, ie_situacao, ds_observacao, ie_simples_nacional, cd_estabelecimento, cd_operacao_nf, cd_serie_nf, nr_sequencia, cd_servico, pr_aliquota, vl_mercadoria, vl_deducao, vl_retido, cd_municipio, cd_situacao_tributaria, cd_local_prest_servico, nm_pessoa_nota, ds_endereco, nr_endereco, ds_complemento, ds_bairro, ds_municipio, sg_estado, cd_cep, nr_telefone, nr_fax) AS select	10 tp_registro,
	...
	0 vl_retido, 
	'' cd_municipio, 
	CASE WHEN substr(obter_se_nota_entrada_saida(n.nr_sequencia),1,1)='E' THEN  '0'  ELSE '13' END  cd_situacao_tributaria, 
	CASE WHEN substr(obter_se_nota_entrada_saida(n.nr_sequencia),1,1)='E' THEN  '4218202'  ELSE '4218202' END  cd_local_prest_servico, 
	'' nm_pessoa_nota, 
	'' ds_endereco, 
	'' nr_endereco, 
	'' ds_complemento, 
...
FROM	nota_fiscal n, 
		operacao_nota o 
where	1=1 
and	n.ie_tipo_nota NOT IN ('ST', 'SD', 'SF') 
