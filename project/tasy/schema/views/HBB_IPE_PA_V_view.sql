...
select 
	...
	substr(b.cd_usuario_convenio,1,13) 
				cd_usuario_convenio, 
	CASE WHEN obter_se_medico_conveniado(Obter_estab_atend(b.nr_atendimento),c.cd_medico_executor, 				c.cd_convenio, null, null,null,null,null,null, null, null)='S' THEN  		c.NR_CPF_EXECUTOR  ELSE to_char(c.cd_prestador) END 	cd_prestador, 
	3			tp_prestador, 
	LOCALTIMESTAMP			dt_referencia, 
	c.nr_seq_conta_convenio	nr_interno_conta, 
	0			vl_total_conta, 
	...
	CASE WHEN c.cd_item_convenio=98007530 THEN 1 WHEN c.cd_item_convenio=98007963 THEN 1  ELSE c.qt_item END  qt_item, 
