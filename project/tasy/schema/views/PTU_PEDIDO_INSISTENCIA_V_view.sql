...
CREATE OR REPLACE VIEW ptu_pedido_insistencia_v (ie_tipo_registro, cd_transacao, nr_sequencia, nr_seq_guia, nr_seq_requisicao, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_seq_execucao, nr_seq_origem, ds_mensagem, ds_fim) AS select	1				ie_tipo_registro,
	00202				cd_transacao,
...
select	2				ie_tipo_registro,
	...
	nr_seq_execucao 		nr_seq_execucao,
	null 				nr_seq_origem,
	Elimina_Acentuacao(ds_mensagem)	ds_mensagem,
	null				ds_fim
from	ptu_pedido_insistencia
