...
CREATE OR REPLACE VIEW eis_escala_tiss_28_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_pessoa_fisica, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_ponto, cd_empresa, cd_estabelecimento, ds_gradacao, nr_atendimento, cd_paciente) AS SELECT	DISTINCT
	...
	SUBSTR(obter_classif_tiss(qt_pontuacao),1,255) ds_gradacao, 
	a.nr_atendimento, 
	a.cd_pessoa_fisica cd_paciente 
FROM 	TISS_INTERV_TERAPEUTICA e, 
	estabelecimento f, 
