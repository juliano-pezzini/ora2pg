...
CREATE OR REPLACE VIEW pls_desconto_folha_pmpa_v (tp_registro, cd_matricula_7, cd_matricula_10, vl_pago, nr_vinculo_pmpa, nr_seq_cobranca) AS select	1				TP_REGISTRO,
