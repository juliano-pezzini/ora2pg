...
CREATE OR REPLACE VIEW localizador_pes_fis_cirur_v (cd_pessoa_fisica, nm_pessoa_fisica_sem_acento, nm_pessoa_fisica, nr_prontuario, dt_nascimento, ds_apelido, cd_funcionario, dt_nasc_grid, ie_funcionario, ie_func_grid, ie_func_assistencial, ds_setor_atendimento, ie_func_assist_grid, dt_ultima_alta, nm_social, ie_medico, nr_seq_conselho, nr_cpf, ds_conselho) AS select  a.cd_pessoa_fisica,
...
left join pessoa_fisica_pront_estab b ON (a.cd_pessoa_fisica = b.cd_pessoa_fisica
