...
CREATE OR REPLACE VIEW exp_rps_prefeitura_sp_v (tp_registro, nr_inscricao_municipal, ds_tipo_rps, cd_serie_nf, nr_nota_fiscal, dt_emissao, ie_situacao, ie_situacao_nf, vl_servico, vl_descontos, cd_servico, vl_aliquota, ie_iss_retido, ie_cpf_cnpj, cd_cpf_cnpj, nr_inscricao_munic_tomador, nr_inscricao_estad_tomador, nm_tomador, ds_tipo_logradouro, ds_endereco, nr_endereco, ds_complemento, ds_bairro, ds_municipio, sg_estado, cd_cep, ds_email, ds_servicos, ds_observacao, vl_total_servicos, vl_total_descontos, qt_linhas, nr_sequencia, cd_operacao_nf, cd_estabelecimento, ds_natureza_operacao, vl_deducoes, vl_total_deducoes, vl_nota_fiscal, vl_total_nota_fiscal, cd_pessoa_fisica, vl_pis_retido, vl_cofins_retido, vl_inss_retido, vl_ir_retido, vl_csll_retido, vl_carga_tributaria, pr_carga_tributaria, ds_carga_tributaria_fonte) AS select	1					tp_registro,
	...
	0 					pr_carga_tributaria,
	' ' 					ds_carga_tributaria_fonte	
...
select	2					tp_registro,
	...
	fis_obter_situacao_rps(n.cd_natureza_operacao, n.cd_estabelecimento, n.ie_situacao) ie_situacao,
	...
	/*lpad(substr(elimina_caractere_especial(obter_dados_grupo_servico_item(obter_item_servico_proced(obter_procedimento_nfse(n.nr_sequencia,'P'), 
	obter_procedimento_nfse(n.nr_sequencia,'O')),'CD')),1,5),5,'0') cd_servico,*/

	coalesce(o.nr_codigo_serv_prest,lpad(coalesce(substr(elimina_caractere_especial(obter_dados_grupo_servico_item(obter_item_servico_proced(obter_procedimento_nfse(n.nr_sequencia,'P'), obter_procedimento_nfse(n.nr_sequencia,'O')),'CD')),1,5)
		,obter_dados_pf_pj_estab(n.cd_estabelecimento, null, n.cd_cgc_emitente, 'ATIV')),5,'0')) cd_servico,
	0	vl_aliquota,
	...
	coalesce(obter_dados_pf_pj(n.cd_pessoa_fisica, n.cd_cgc, 'LO'), 'RUA') ds_tipo_logradouro,
	...
	0					vl_total_nota_fiscal,
	n.cd_pessoa_fisica,
	obter_valor_tipo_trib_retido(n.nr_sequencia, 'V', 'PIS') vl_pis_retido,
	obter_valor_tipo_trib_retido(n.nr_sequencia, 'V', 'COFINS') vl_cofins_retido,
	obter_valor_tipo_trib_retido(n.nr_sequencia, 'V', 'INSS') vl_inss_retido,
	obter_valor_tipo_trib_retido(n.nr_sequencia, 'V', 'IR') vl_ir_retido,
	obter_valor_tipo_trib_retido(n.nr_sequencia, 'V', 'CSLL') vl_csll_retido,		
	(obter_valor_tributo_exp_nf(n.nr_sequencia, 'V', 'N') + obter_valor_tributo_exp_nf(n.nr_sequencia, 'V', 'I')) vl_carga_tributaria,	
	(obter_valor_tributo_exp_nf(n.nr_sequencia, 'X', 'N') + obter_valor_tributo_exp_nf(n.nr_sequencia, 'X', 'I')) pr_carga_tributaria,
	rpad('IBPT',10,' ') ds_carga_tributaria_fonte
