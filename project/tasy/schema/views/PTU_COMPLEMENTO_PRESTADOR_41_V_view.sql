...
CREATE OR REPLACE VIEW ptu_complemento_prestador_41_v (tp_registro, ie_ordem, ie_ordem_2, nr_sequencia, cd_tipo_registro, cd_unimed_des, cd_unimed_ori, dt_geracao, nr_versao_trans, cd_rede, nm_comercial_prod, ie_reg_plano_ans, nr_reg_plano_ans, ie_classif_plano, ie_situacao_ans, ie_seg_produto, qt_tot_r452, nr_seq_movimento, nm_com_produto) AS select	1				tp_registro,
	1				ie_ordem,
	1				ie_ordem_2,
	1				nr_sequencia,
