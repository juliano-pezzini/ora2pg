...
CREATE OR REPLACE VIEW os_testes_migracao_usuario_v (nr_seq_projeto, nr_seq_os, nm_executor, dt_os, nr_seq_grupo_desenv, ie_tipo_os_teste, nr_seq_estagio_os) AS select	p.nr_sequencia nr_seq_projeto,
	o.nr_sequencia nr_seq_os,
	e.nm_usuario_exec nm_executor,
	o.dt_ordem_servico dt_os,
	p.nr_seq_grupo_des nr_seq_grupo_desenv,
	r.ie_tipo_ordem ie_tipo_os_teste,
