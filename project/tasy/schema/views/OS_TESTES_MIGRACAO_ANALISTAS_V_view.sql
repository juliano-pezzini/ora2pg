...
CREATE OR REPLACE VIEW os_testes_migracao_analistas_v (nr_seq_projeto, nr_seq_os, nm_executor, dt_os, nr_seq_grupo_desenv, ie_tipo_os_teste, nr_seq_estagio_os) AS select	p.nr_sequencia nr_seq_projeto,
