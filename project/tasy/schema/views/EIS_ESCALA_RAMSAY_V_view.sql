...
CREATE OR REPLACE VIEW eis_escala_ramsay_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_profissional, cd_medico_resp, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_ponto, cd_empresa, cd_estabelecimento, ds_ramsay, nr_atendimento, cd_paciente, ie_turno) AS select	distinct
	...
	e.ie_ramsay qt_ponto, 
	f.cd_empresa, 
	a.cd_estabelecimento, 
	substr(obter_valor_dominio(1509,ie_ramsay),1,255) ds_ramsay, 
	a.nr_atendimento, 
	a.cd_pessoa_fisica cd_paciente, 
  	substr(obter_turno_data(dt_avaliacao),1,255) ie_turno 
FROM 	escala_ramsay e, 
	estabelecimento f, 
