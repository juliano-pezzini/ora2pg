...
select
	...
	sum(CASE WHEN c.tp_nota=75 THEN CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=76 THEN CASE WHEN c.ie_responsavel_credito='IPEM' THEN c.vl_unitario_item  ELSE 0 END  WHEN c.tp_nota=85 THEN CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END   ELSE 0 END )) vl_total_conta,
	...
	sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN c.ie_responsavel_credito='IPEM' THEN c.vl_unitario_item  ELSE c.vl_total_item END  WHEN c.tp_nota=86 THEN c.vl_total_item  ELSE 0 END ) vl_total_despesa,
...
select
	...
	0				ie_urgencia,
	0				vl_honorario,
	sum(CASE WHEN c.ie_responsavel_credito='IPEM' THEN c.vl_unitario_item  ELSE c.vl_total_item END )			vl_total_item,
...
select
	...
	c.ie_urgencia			ie_urgencia,
	0				vl_honorario,
	CASE WHEN c.ie_responsavel_credito='IPEM' THEN c.vl_unitario_item  ELSE c.vl_total_item END 			vl_total_item,
	0				vl_total_matmed,
