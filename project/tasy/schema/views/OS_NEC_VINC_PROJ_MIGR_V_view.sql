...
CREATE OR REPLACE VIEW os_nec_vinc_proj_migr_v (nr_seq_projeto, nr_seq_os, nr_seq_os_projeto, ds_dano_breve, ds_estagio, nm_executor, dt_os, nr_seq_grupo_desenv_proj, nr_seq_grupo_desenv_os, nr_seq_estagio_os, dt_estagio_os, ie_resp_teste) AS select	p.nr_sequencia nr_seq_projeto,
	...
	obter_data_ultimo_estagio_os(o.nr_sequencia) dt_estagio_os,
	o.ie_resp_teste
...
where	s.nr_sequencia = o.nr_seq_estagio
and	e.nr_seq_ordem = o.nr_sequencia
and	r.nr_seq_projeto = p.nr_sequencia
and	r.nr_seq_ordem_serv = o.nr_sequencia
and	p.nr_seq_gerencia = 9
and	p.nr_seq_classif = 14;
