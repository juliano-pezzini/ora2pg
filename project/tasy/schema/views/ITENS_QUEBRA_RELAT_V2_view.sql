...
SELECT	09 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, obter_desc_expressao(298370) DS, 'IE_QUEBRA_24' NM, 'DS_SETOR_ATENDIMENTO' VL_QUEBRA, ' SUBSTR(obter_nome_setor(NVL(b.cd_setor_atendimento,0)),1,100) ds_setor_atendimento ' VL_TOTAL_QUEBRA
...
SELECT	15 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, obter_desc_expressao(287208) DS, 'IE_QUEBRA_12' NM, 'DS_MOTIVO_CANC' VL_QUEBRA, ' SUBSTR(obter_dados_motivo_cancel(a.ie_motivo_cancelamento,''D''),1,255) ds_motivo_canc ' VL_TOTAL_QUEBRA
...
SELECT	19 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, obter_desc_expressao(713995) DS, 'IE_QUEBRA_16' NM, 'DS_TIPO_ANESTESIA' VL_QUEBRA, ' NVL(SUBSTR(obter_valor_dominio(36,NVL(a.cd_tipo_anestesia,''NI'')),1,100), ''Não Informado'') ds_tipo_anestesia ' VL_TOTAL_QUEBRA
...
SELECT	21 IE_ORDEM, 'S' CD_SELECIONADO, 'N' CD_N_SELECIONADO, obter_desc_expressao(347248) DS, 'IE_QUEBRA_18' NM, 'DS_PROC_INTERNO' VL_QUEBRA, ' substr(obter_desc_proc_interno(a.nr_seq_proc_interno),1,255) ds_proc_interno ' VL_TOTAL_QUEBRA
