...
select
	...
	sum(CASE WHEN to_char(c.cd_item_convenio)=to_char(c.cd_item) THEN c.vl_total_item  ELSE 0 END )	vl_total_matmed,
	' '				cd_brasindice,
	' '				cd_unidade_medida
from	w_interf_conta_item_ipe c,
	w_interf_conta_total b,
