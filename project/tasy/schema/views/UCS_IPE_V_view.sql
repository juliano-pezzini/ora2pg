...
select
	...
	(sum(CASE WHEN c.tp_nota=76 THEN CASE WHEN c.ie_tipo_item=1 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN  c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END   ELSE CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.qt_item * c.vl_unitario_item  ELSE c.vl_total_item END  END  WHEN c.tp_nota=86 THEN CASE WHEN c.ie_tipo_item=1 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN  c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END   ELSE CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.qt_item * c.vl_unitario_item  ELSE c.vl_total_item END  END   ELSE 0 END ) +
	sum(CASE WHEN c.tp_nota=77 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=87 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE c.vl_total_item END   ELSE 0 END ) +
	sum(CASE WHEN c.tp_nota=75 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END  WHEN c.tp_nota=85 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END   ELSE 0 END )) vl_total_conta,
	...
	sum(CASE WHEN c.tp_nota=77 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE c.vl_total_item END  WHEN c.tp_nota=87 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE c.vl_total_item END   ELSE 0 END ) vl_total_servico,
	sum(CASE WHEN c.tp_nota=75 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END  WHEN c.tp_nota=85 THEN CASE WHEN c.ie_responsavel_credito='SANGU' THEN c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END   ELSE 0 END ) vl_total_honorario,
	0				nr_linha,
	LOCALTIMESTAMP				dt_item,
	0				cd_item_convenio,
	0				qt_dias_executado,
...
select
	...
	' '				cd_usuario_convenio,
	' '				cd_cid,
	CASE WHEN c.ie_responsavel_credito='H' THEN  '89379960000207' WHEN c.ie_responsavel_credito='MEDIC' THEN  '89379960000207'  ELSE c.ie_prestador END  cd_prestador,
	3				tp_prestador,
	0 				cd_motivo_cobranca,
	LOCALTIMESTAMP				dt_entrada,
	LOCALTIMESTAMP				dt_alta,
	...
	CASE WHEN c.ie_responsavel_credito='SANGU' THEN  c.vl_honorario  ELSE CASE WHEN c.vl_total_item=0 THEN c.vl_honorario  ELSE c.vl_total_item END  END 
					vl_honorario,
