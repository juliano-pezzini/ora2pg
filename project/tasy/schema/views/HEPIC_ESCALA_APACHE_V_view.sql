...
CREATE OR REPLACE VIEW hepic_escala_apache_v (qt_apache_ii, qt_risco_calculado, pr_risco, qt_pont_idade, cd_setor_atendimento, ds_setor_atendimento, ds_unidade, dt_avaliacao, ds_estabelecimento, cd_convenio, ds_convenio, ie_sexo, ds_sexo, cd_medico_resp, ie_faixa_etaria, cd_empresa, cd_estabelecimento, nr_atendimento, cd_paciente, ds_categoria_diag, cd_motivo_alta, ds_motivo_alta, ie_clinica, ds_clinica) AS select 	distinct
		e.qt_apache_ii, 
		qt_risco_calculado, 
		pr_risco, 
		qt_pont_idade, 
