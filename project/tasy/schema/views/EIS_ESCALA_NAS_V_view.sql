...
CREATE OR REPLACE VIEW eis_escala_nas_v (cd_setor_atendimento, ds_estabelecimento, cd_convenio, ds_convenio, ds_setor_atendimento, ie_sexo, ds_sexo, nm_medico, cd_profissional, ie_faixa_etaria, ds_unidade, dt_avaliacao, qt_pontuacao, cd_empresa, cd_estabelecimento, nr_atendimento, nm_paciente) AS select	coalesce(e.cd_setor_atendimento, obter_setor_atend_data(a.nr_atendimento, e.dt_avaliacao)) cd_setor_atendimento,
	...
	obter_nome_setor(coalesce(e.cd_setor_atendimento, obter_setor_atend_data(a.nr_atendimento, e.dt_avaliacao))) ds_setor_atendimento, 
	...
	coalesce(Obter_Unidade_Atend_Data(a.nr_atendimento, e.dt_avaliacao), obter_unidade_atendimento(a.nr_atendimento,'A','U')) ds_unidade, 
	e.dt_avaliacao, 
	e.qt_pontuacao, 
	f.cd_empresa, 
