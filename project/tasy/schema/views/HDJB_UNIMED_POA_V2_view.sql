...
select	/* Documento  */
	...
	LOCALTIMESTAMP				dt_referencia,
	coalesce((substr(Obter_Conversao_Externa(b.cd_cgc_convenio,'HDJB_UNIMED_POA_V2','CD_MOTIVO_ALTA',
		substr(b.cd_motivo_alta,1,3)),1,3))::numeric ,03) cd_motivo_alta,
	substr(b.cd_cid_principal,1,4)	cd_cid,
	Obter_Data_Maior(b.dt_entrada,b.dt_periodo_inicial)	dt_entrada,
	coalesce(b.dt_alta,b.dt_periodo_final)	dt_alta,
	...
	CASE WHEN coalesce(b.cd_setor_atendimento,0)=13 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=68 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=72 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=110 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=90 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=109 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=91 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=67 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END  WHEN coalesce(b.cd_setor_atendimento,0)=35 THEN CASE WHEN b.ie_tipo_atendimento=8 THEN 91 WHEN b.ie_tipo_atendimento=7 THEN 92  ELSE 90 END   ELSE CASE WHEN d.ie_tipo_guia='C' THEN 91 WHEN d.ie_tipo_guia='A' THEN 91 WHEN d.ie_tipo_guia='AI' THEN 92 WHEN d.ie_tipo_guia='I' THEN 90 WHEN d.ie_tipo_guia='IC' THEN 90 WHEN d.ie_tipo_guia='IO' THEN 90 WHEN d.ie_tipo_guia='IP' THEN 90  ELSE (substr(Obter_Conversao_Externa(b.cd_cgc_convenio,'HDJB_UNIMED_POA_V2','CD_SETOR_ATENDIMENTO',				coalesce(b.cd_setor_atendimento,0)),1,5))::numeric  END  END  cd_setor_atendimento,
	0				cd_procedimento,
	0 				qt_procedimento_autor,
	LOCALTIMESTAMP 			dt_procedimento,
	' '	 			ie_urgencia,
	...
	substr(Obter_Conversao_Externa(b.cd_cgc_convenio,'HDJB_UNIMED_POA_V2','IE_TIPO_ALTA',
		substr(b.cd_motivo_alta,1,3)),1,3) ie_tipo_saida,
	...
	substr(d.nm_medico_solicitante,1,70)
					nm_prof_solicitante,
	lpad(substr(b.ie_tipo_atendimento,1,1),2,0)		ie_tipo_atendimento,
	1				ie_tipo_consulta,
	' '				ds_observacoes,
...
and	coalesce(d.cd_grupo_gasto,0) not in (10,11,12,20,99)
and 	d.ie_tipo_item = 1
and 	d.ie_responsavel_credito <> 'M'
and	d.ie_emite_conta <> 73
...
select	/* Insumos  (Taxas e diarias)  */
	...
	somente_numero(coalesce(d.cd_item_convenio,d.cd_item))
					cd_insumo,
	sum(d.qt_item_conv_div)		qt_insumo,
	max(d.dt_item)			dt_insumo,
	sum(d.qt_item_conv_div)		qt_cobrada,
...
and	c.nr_seq_protocolo = f.nr_seq_protocolo
and	d.nr_seq_proc_pacote is null
and	coalesce(d.cd_grupo_gasto,0) in (10,11,12,20,99)
and 	d.ie_tipo_item = 1
and	d.ie_emite_conta <> 73
group by
	c.nr_seq_protocolo,
...
select	/* Trailler */
	...
	LOCALTIMESTAMP 			dt_emissao,
 	...
 	4 				qt_reg_proc,
	5 				qt_reg_insumo,
	(sum(c.vl_total_conta) - obter_valor_pacote_protocolo(nr_seq_protocolo)) vl_total_lote,
	0				nr_seq_pacote,
	0				nr_lote,
	0 				qt_nasc_vivos_termo,
	0				 qt_nasc_mortos,
