...
CREATE OR REPLACE VIEW consulta_ageexam_html5_v (cd_agenda, ds_agenda, cd_tipo_agenda, ie_agendamento_coletivo, cd_estabelecimento, nr_sequencia, dt_agenda, hr_inicio, nr_minuto_duracao, ie_status_agenda, ie_classif_agenda, ds_classificacao, cd_pessoa_fisica, nm_paciente, cd_medico, nm_medico, nm_medico_exec, cd_convenio, cd_categoria, cd_plano, cd_procedencia, ds_convenio, nr_atendimento, cd_procedimento, ie_origem_proced, nr_seq_proc_interno, ds_observacao, ds_complemento, ds_curta, nr_pront_ext, cd_motivo_cancelamento, ie_encaixe, cd_medico_resp, ie_anestesia, cd_especialidade, nm_usuario_origem, dt_agendamento, nm_medico_agendamento, ie_reference_letter, ie_emergency_response_required, ds_procedencia, nr_seq_status_pac) AS select	a.cd_agenda,
	...
	(select max(I.ie_agend_coletivo) FROM agenda_integrada I, agenda_integrada_item C, agenda_consulta t
    	...
    	and t.NR_SEQ_AGEPACI = b.NR_SEQUENCIA) ie_agendamento_coletivo,
	...
	b.dt_agendamento,
	SUBSTR(obter_nome_pf(b.cd_medico_exec),1,255) nm_medico_agendamento,
