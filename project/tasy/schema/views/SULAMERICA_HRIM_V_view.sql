...
select
	...
	b.qt_item,
	CASE WHEN b.cd_medico_executor IS NULL THEN b.vl_total_item  ELSE (coalesce(b.vl_honorario,0) + coalesce(b.vl_custo_oper,0)) END  vl_item,
	b.pr_via_acesso
