...
CREATE OR REPLACE VIEW ordem_compra_distribuidor_v (ds_razao_social, nr_ordem_compra, dt_ordem_compra, dt_aprovacao, nr_sequencia, nr_nota_fiscal, ds_fornecedor, vl_ordem_compra, ds_complemento, dt_vencimento, nr_titulo, nm_fantasia, cd_fornec, dt_baixa) AS select	distinct
	ds_razao_social, 
	nr_ordem_compra, 
	dt_ordem_compra, 
	dt_aprovacao, 
...
union all
	...
	select	distinct 
		...
		coalesce(o.cd_pessoa_fisica, o.cd_cgc_fornecedor) cd_fornec, 
		o.dt_baixa 
	FROM ordem_compra o, proj_rat a
...
WHERE a.nr_ordem_compra = o.nr_ordem_compra   and o.nr_seq_motivo_cancel is null 
...
LEFT OUTER JOIN nota_fiscal_item i ON (n.nr_sequencia = i.nr_sequencia)
WHERE o.nr_seq_motivo_cancel is null and not exists (	select	1 
			from	proj_rat x 
