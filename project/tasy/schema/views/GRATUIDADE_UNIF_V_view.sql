...
CREATE OR REPLACE VIEW gratuidade_unif_v (dt_mesano_referencia, nr_seq_protocolo, nr_atendimento, nr_interno_conta, qt_resumo, qt_diaria, vl_rec_material, vl_custo_material, vl_rec_diaria, vl_custo_diaria, vl_rec_proc, vl_custo_proc, ie_cancelamento, cd_centro_custo, cd_convenio, cd_setor_receita) AS select
	...
	sum(CASE WHEN b.ie_diaria='S' THEN 0  ELSE CASE WHEN b.cd_procedimento IS NULL THEN  0  ELSE CASE WHEN b.ie_origem_proced=7 THEN (b.vl_custo_operacional + b.vl_materiais)  ELSE CASE WHEN b.vl_procedimento=0 THEN  0   ELSE (b.vl_procedimento -			(b.vl_medico + b.vl_anestesista + b.vl_auxiliares)) END  END  END  END ) vl_Rec_Proc,
