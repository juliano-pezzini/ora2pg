...
group by nr_ordem,
	 ...
	 ie_status
/*union
select	decode(ds_tipo_despesa,'P1','1','P2','3','P3','2','P4','4','M1','6','M2','5','M3','7') ie_ordem,
	1 ie_ordem_titulo,
	nr_sequencia,
	nr_seq_conta,
	nr_seq_item,
	...
	ds_tipo_guia ds_guia,
	nr_seq_conta_referencia,
	nvl(cd_guia_referencia,cd_guia) nr_guia,
	2 nr_seq_apres,
	ie_status ie_status_item,
	ie_situacao,
	ie_ocorrencia_glosa,
