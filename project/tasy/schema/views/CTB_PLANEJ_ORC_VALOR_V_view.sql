...
CREATE OR REPLACE VIEW ctb_planej_orc_valor_v (vl_planej, nr_sequencia, nr_seq_planej, dt_referencia, cd_estab_exclusivo, cd_empresa, cd_conta_contabil, cd_centro_custo, cd_conta_financ, nr_seq_contrato, cd_cnpj, nr_seq_proj_gpi, cd_estabelecimento) AS select a.vl_planej_01 vl_planej,
       a.nr_sequencia,
       a.nr_seq_planej,
