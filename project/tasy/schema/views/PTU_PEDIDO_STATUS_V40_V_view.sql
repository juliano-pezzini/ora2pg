...
CREATE OR REPLACE VIEW ptu_pedido_status_v40_v (cd_transacao, ie_tipo_registro, nr_sequencia, nr_seq_guia, nr_seq_requisicao, ie_tipo_cliente, cd_unimed_executora, cd_unimed_beneficiario, nr_transacao_uni_exec, ds_fim) AS select	00360				cd_transacao,
	1				ie_tipo_registro,
