...
CREATE OR REPLACE VIEW conta_paciente_diaria_total_v (nr_sequencia, cd_convenio, ie_emite_conta, nr_interno_conta, cd_procedimento, cd_setor_atendimento, ds_setor_atendimento, ds_classif_setor, ds_procedimento, cd_procedimento_convenio, ds_procedimento_convenio, nr_seq_proc_pacote, cd_unidade_basica, cd_unidade_compl, vl_unitario_real, qt_procedimento, vl_procedimento, vl_unitario, dt_diaria_final, dt_diaria_final_d0, dt_diaria_inicial, dt_diaria_inicial_d0, vl_desconto, vl_unitario_bruto, vl_bruto) AS select 	max(a.nr_sequencia) nr_sequencia,
	a.cd_convenio, 
	a.ie_emite_conta, 
	f.nr_interno_conta, 
	a.cd_procedimento, 
	...
	e.cd_unidade_basica, 
	e.cd_unidade_compl, 
	(a.vl_procedimento / a.qt_procedimento) vl_unitario_real, 
	...
	max(trunc(coalesce(a.dt_conta, a.dt_procedimento),'dd')) dt_diaria_final, 
	max(trunc(coalesce(a.dt_conta, a.dt_procedimento),'dd') - 1) dt_diaria_final_d0, 
	min(trunc(coalesce(a.dt_conta, a.dt_procedimento),'dd')) dt_diaria_inicial, 
	min(trunc(coalesce(a.dt_conta, a.dt_procedimento),'dd') - 1) dt_diaria_inicial_d0, 
