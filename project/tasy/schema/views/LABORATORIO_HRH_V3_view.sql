...
and a.ie_suspenso <> 'S'
AND a.DT_INTEGRACAO IS NULL
and lab_obter_result_ant_seq(a.nr_prescricao,a.nr_seq_exame,'DH',1) is not null
...
select	distinct
	 ...
	 coalesce(d.cd_exame_integracao,d.cd_exame) cd_exame,
	 ' ' CD_PARAMETRO,
  lab_obter_result_ant_seq(a.nr_prescricao,a.nr_seq_exame,'R',1) ds_resultado_ant,
	 '' ds_valor,
	 ' ' ds_sigla,
	 ' ' ie_verificacao,
	 a.NR_SEQ_LOTE_EXTERNO
...
and h.dt_integracao is null
and g.cd_estabelecimento = b.cd_estabelecimento
and coalesce(Obter_Equipamento_Exame(d.nr_seq_exame,null,'MATRIX'),d.cd_exame_integracao) is not null
and g.ie_padrao_amostra IN ('AMO9','AMO10','AMO11','AM10F','AM11F','AMO13')
and a.ie_suspenso <> 'S'
and a.dt_integracao is null
AND d.NR_SEQ_SUPERIOR IS NOT NULL
