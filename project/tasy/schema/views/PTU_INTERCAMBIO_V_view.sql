...
CREATE OR REPLACE VIEW ptu_intercambio_v (nr_seq_intercabio, tp_registro, nr_sequencia, cd_tipo_registro, cd_unimed_destino, cd_unimed_origem, dt_geracao, ie_tipo_mov, dt_mov_inicio, dt_mov_fim, nr_versao_transacao, cd_filial, ds_razao_social, nm_empr_abrev, ie_tipo_pessoa, reservado_1, cd_cgc_cpf, nr_insc_estadual, ds_endereco, ds_complemento, ds_bairro, cd_cep, nm_cidade, sg_uf, nr_ddd, nr_telefone, nr_fax, dt_inclusao, dt_exclusao, cd_empresa_origem, cd_municipio_ibge, cd_plano_origem, ds_plano_origem, cd_plano_intercambio, dt_inclusao_plano, dt_exclusao_plano, ie_natureza, ie_abrangencia, nr_ind_reembolso, cd_ope_ans, cd_prod_ans, cd_unimed, cd_usuario_plano, cd_familia, nm_benef_abreviado, cd_plano_intercambio_benef, dt_nascimento, ie_sexo, cd_cgc_cpf_benef, nr_rg, sg_uf_rg, ie_estado_civil, dt_inclusao_benef, dt_exclusao_benef, ie_repasse, cd_dependencia, ie_recem_nascido, nr_matricula, dt_validade_carteira, cd_local_atendimento, cd_lotacao, ds_lotacao, dt_repasse, dt_fim_repasse, dt_inclusao_plano_dest, cd_plano_origem_benef, nr_vigencia_origem, cd_titular_plano, nm_beneficiario, nr_cartao_nac_sus, cd_tipo_cobertura, dt_fim_carencia, cd_tipo_produto, ds_produto, ds_endereco_benef, ds_bairro_benef, cd_cep_benef, nm_municipio, sg_uf_benef, nr_ddd_benef, nr_fone, nr_ramal, cd_cid, dt_fim_carencia_preex, qt_total_r102, qt_total_r103, qt_total_r104, qt_total_inclusao, qt_exclusos_benef, qt_total_alteracoes, qt_total_transferencia, qt_total_r105, qt_total_r106, qt_total_r107, qt_total_r108, nr_seq_plano, nr_seq_segurado, nr_seq_empresa, nr_seq_benef) AS select	nr_sequencia		nr_seq_intercabio,
	1			tp_registro,
	1			nr_sequencia,
...
select	nr_seq_intercambio	nr_seq_intercambio,
	2			tp_registro,
	2			nr_sequencia,
	...
	a.ie_tipo_pessoa	ie_tipo_pessoa,
	' '			reservado_1,
...
select	b.nr_seq_intercambio	nr_seq_intercambio,
	3			tp_registro,
	3			nr_sequencia,
	...
	null			cd_empresa_origem,
	null			cd_municipio_ibge,
	a.cd_plano_origem	cd_plano_origem,
