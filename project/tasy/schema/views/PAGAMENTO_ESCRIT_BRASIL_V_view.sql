...
CREATE OR REPLACE VIEW pagamento_escrit_brasil_v (tp_registro, nr_inscricao, cd_agencia, ie_dig_agencia, cd_conta, ie_dig_conta, ds_dac_agencia, nm_empresa, ds_banco, dt_arquivo, nr_seq_envio, ie_tipo_fornecedor, cd_cgc_fornecedor, cd_agencia_bancaria, nr_conta_forneced, nm_hospital, ds_endereco, nr_endereco, ds_cidade, cd_cep, ds_estado, cd_banco_fornecedor, cd_agencia_fornecedor, cd_agencia_conta, nm_fornecedor, nr_documento, dt_vencimento, vl_saldo_titulo, nr_inscricao_fornec, qt_registros, ie_cod_barras, vl_titulo, vl_desconto, vl_acrescimo, dt_pagto, vl_pagto, vl_total_pagto, qt_lotes_arquivo, qt_total_registros) AS select	0 tp_registro,
	...
	substr(b.ie_digito_conta,2,1) ds_dac_agencia, 
...
select	distinct 1 tp_registro, 
	...
	b.cd_conta || substr(b.ie_digito_conta,1,1) nr_conta_forneced, 
