...
CREATE OR REPLACE VIEW pls_item_autor_v (ie_tipo, ds_tipo, nr_seq_material, ds_material, ie_origem_proced, cd_procedimento, ds_procedimento, ds_item, nr_seq_guia, nr_seq_conta) AS select  'P'            ie_tipo,
