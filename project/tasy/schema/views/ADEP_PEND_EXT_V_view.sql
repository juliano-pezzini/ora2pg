...
CREATE OR REPLACE VIEW adep_pend_ext_v (nr_seq_apresent, ie_tipo_item, ds_tipo_item, ds_tipo_item_plural, ie_laboratorio, nr_atendimento, nr_prescricao, cd_prescritor, nm_prescritor, dt_prescricao, dt_inicio_prescr, dt_validade_prescr, dt_liberacao, cd_setor_prescr, nr_seq_item, ie_acm_sn, ie_di, cd_item, ds_item, cd_intervalo, ds_diluente, ds_topografia, ie_assoc_adep, nr_seq_horario, dt_horario, qt_pend, cd_um, qt_dose, cd_unidade_medida_dose, ie_via, cd_pessoa_evento, nm_pessoa_evento) AS select	1 nr_seq_apresent,
	'D' ie_tipo_item, 
