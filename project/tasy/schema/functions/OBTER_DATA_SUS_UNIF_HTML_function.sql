...
CREATE OR REPLACE FUNCTION obter_data_sus_unif_html ( nr_interno_conta_p bigint, ie_opcao_p text) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_data_sus_unif_html ( nr_interno_conta_p bigint, ie_opcao_p text) FROM PUBLIC;
