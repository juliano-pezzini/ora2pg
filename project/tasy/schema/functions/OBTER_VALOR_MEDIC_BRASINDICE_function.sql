...
if (coalesce(ie_tipo_preco_regra_p::text, '') = '') then
...
ie_tipo_preco_regra_w	:= coalesce(ie_tipo_preco_regra_p, ie_tipo_preco_regra_w);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_medic_brasindice ( cd_estabelecimento_p bigint, cd_medicamento_p text, cd_apresentacao_p text, cd_laboratorio_p text, qt_conversao_p bigint, dt_vigencia_p timestamp, tx_brasindice_pfb_p bigint, tx_brasindice_pmc_p bigint, tx_pmc_neg_p bigint, tx_pmc_pos_p bigint, tx_pfb_pos_p bigint, tx_pfb_neg_p bigint, cd_convenio_p bigint, cd_categoria_p text, cd_material_p bigint, ie_tipo_atendimento_p bigint, ie_tipo_preco_regra_p text default null) FROM PUBLIC;
