...
CREATE OR REPLACE FUNCTION pls_obter_se_simultaneo_exec ( nr_seq_simultaneo_p pls_ocorrencia_simultaneo.nr_sequencia%type, nr_seq_execucao_p pls_execucao_requisicao.nr_sequencia%type, cd_procedimento_p procedimento.cd_procedimento%type, ie_origem_proced_p procedimento.ie_origem_proced%type, nr_seq_material_p pls_material.nr_sequencia%type, cd_estabelecimento_p bigint, nm_usuario_p text) RETURNS varchar AS $body$
DECLARE


/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:
Verifica se há itens simultâneos na execução da requisição.
-------------------------------------------------------------------------------------------------------------------
...
union 	all
				...
				PERFORM	1
				from	pls_execucao_req_item c
				where	c.nr_seq_execucao 	= nr_seq_execucao_p
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_se_simultaneo_exec ( nr_seq_simultaneo_p pls_ocorrencia_simultaneo.nr_sequencia%type, nr_seq_execucao_p pls_execucao_requisicao.nr_sequencia%type, cd_procedimento_p procedimento.cd_procedimento%type, ie_origem_proced_p procedimento.ie_origem_proced%type, nr_seq_material_p pls_material.nr_sequencia%type, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
