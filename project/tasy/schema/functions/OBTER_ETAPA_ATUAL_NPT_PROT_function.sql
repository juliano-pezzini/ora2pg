...
CREATE OR REPLACE FUNCTION obter_etapa_atual_npt_prot ( nr_prescricao_p bigint, nr_seq_item_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_etapa_atual_npt_prot ( nr_prescricao_p bigint, nr_seq_item_p bigint) FROM PUBLIC;
