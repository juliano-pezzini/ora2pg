...
CREATE OR REPLACE FUNCTION obter_desc_mat_subst_prescr ( nr_prescricao_p bigint, nr_sequencia_p bigint, ie_localizacao_p text, cd_local_estoque_p bigint) RETURNS varchar AS $body$
DECLARE
...
select	coalesce(cd_material_baixa,cd_material),
	dt_baixa,
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_mat_subst_prescr ( nr_prescricao_p bigint, nr_sequencia_p bigint, ie_localizacao_p text, cd_local_estoque_p bigint) FROM PUBLIC;
