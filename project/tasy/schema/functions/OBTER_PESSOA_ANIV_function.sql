...
CREATE OR REPLACE FUNCTION obter_pessoa_aniv ( nr_seq_regra_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_pessoa_aniv ( nr_seq_regra_p text) FROM PUBLIC;
