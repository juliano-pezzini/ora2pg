...
CREATE OR REPLACE FUNCTION obter_valor_terceiro_conta ( nr_interno_conta_p bigint, ie_opcao_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_terceiro_conta ( nr_interno_conta_p bigint, ie_opcao_p text) FROM PUBLIC;
