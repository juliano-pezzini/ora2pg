...
CREATE OR REPLACE FUNCTION obter_se_liberacao_auditoria (nr_seq_auditoria_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_liberacao_auditoria (nr_seq_auditoria_p bigint) FROM PUBLIC;
