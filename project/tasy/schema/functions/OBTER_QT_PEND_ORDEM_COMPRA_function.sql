...
CREATE OR REPLACE FUNCTION obter_qt_pend_ordem_compra ( cd_estabelecimento_p bigint, cd_material_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qt_pend_ordem_compra ( cd_estabelecimento_p bigint, cd_material_p bigint) FROM PUBLIC;
