...
CREATE OR REPLACE FUNCTION obter_horarios_suspensos (nr_atendimento_p bigint, qt_minutos_anterior_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_horarios_suspensos (nr_atendimento_p bigint, qt_minutos_anterior_p bigint) FROM PUBLIC;
