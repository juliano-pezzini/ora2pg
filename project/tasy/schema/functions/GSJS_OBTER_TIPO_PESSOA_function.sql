...
CREATE OR REPLACE FUNCTION gsjs_obter_tipo_pessoa ( cd_pessoa_fisica_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION gsjs_obter_tipo_pessoa ( cd_pessoa_fisica_p text) FROM PUBLIC;
