...
CREATE OR REPLACE FUNCTION obter_select_dashboards ( ds_comando_p text, ds_parametros_p text, ds_separador_p text, nr_colum_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_select_dashboards ( ds_comando_p text, ds_parametros_p text, ds_separador_p text, nr_colum_p bigint) FROM PUBLIC;
