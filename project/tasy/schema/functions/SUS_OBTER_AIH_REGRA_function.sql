...
CREATE OR REPLACE FUNCTION sus_obter_aih_regra ( nr_seq_regra_p bigint, ie_opcao_p text, ie_tipo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION sus_obter_aih_regra ( nr_seq_regra_p bigint, ie_opcao_p text, ie_tipo_p text) FROM PUBLIC;
