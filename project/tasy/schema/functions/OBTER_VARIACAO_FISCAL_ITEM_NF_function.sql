...
CREATE OR REPLACE FUNCTION obter_variacao_fiscal_item_nf ( nr_seq_nota_p text, ie_tributo_p text, ie_tipo_valor_fiscal_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_variacao_fiscal_item_nf ( nr_seq_nota_p text, ie_tributo_p text, ie_tipo_valor_fiscal_p bigint) FROM PUBLIC;
