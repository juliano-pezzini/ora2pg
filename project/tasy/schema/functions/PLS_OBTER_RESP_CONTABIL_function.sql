...
CREATE OR REPLACE FUNCTION pls_obter_resp_contabil ( nr_seq_resp_contabil_p bigint, ie_tipo_p bigint) RETURNS varchar AS $body$
DECLARE
...
where	nr_sequencia	= nr_seq_resp_contabil_p;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_resp_contabil ( nr_seq_resp_contabil_p bigint, ie_tipo_p bigint) FROM PUBLIC;
