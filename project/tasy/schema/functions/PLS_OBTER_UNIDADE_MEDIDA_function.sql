...
CREATE OR REPLACE FUNCTION pls_obter_unidade_medida (cd_unidade_medida_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_unidade_medida (cd_unidade_medida_p text) FROM PUBLIC;
