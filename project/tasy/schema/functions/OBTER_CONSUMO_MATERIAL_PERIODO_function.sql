...
CREATE OR REPLACE FUNCTION obter_consumo_material_periodo ( cd_estabelecimento_p bigint, cd_material_p bigint, dt_inicial_p timestamp, dt_final_p timestamp, ie_tipo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_consumo_material_periodo ( cd_estabelecimento_p bigint, cd_material_p bigint, dt_inicial_p timestamp, dt_final_p timestamp, ie_tipo_p text) FROM PUBLIC;
