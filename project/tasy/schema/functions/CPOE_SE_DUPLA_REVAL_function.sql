...
CREATE OR REPLACE FUNCTION cpoe_se_dupla_reval (nr_seq_reval_rule_p bigint, cd_material_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cpoe_se_dupla_reval (nr_seq_reval_rule_p bigint, cd_material_p bigint) FROM PUBLIC;
