...
CREATE OR REPLACE FUNCTION obter_lab_integr_item_matrix (nr_prescricao_p bigint, cd_setor_atendimento_p bigint, ie_opcao_p text, ie_separador_p text, ie_status_envio_p bigint, ds_sigla_p text, nr_seq_prescr_proc_mat_p text, nr_seq_lote_externo_p bigint, cd_estabelecimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_lab_integr_item_matrix (nr_prescricao_p bigint, cd_setor_atendimento_p bigint, ie_opcao_p text, ie_separador_p text, ie_status_envio_p bigint, ds_sigla_p text, nr_seq_prescr_proc_mat_p text, nr_seq_lote_externo_p bigint, cd_estabelecimento_p bigint) FROM PUBLIC;
