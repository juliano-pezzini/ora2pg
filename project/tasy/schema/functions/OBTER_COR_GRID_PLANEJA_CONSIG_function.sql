...
CREATE OR REPLACE FUNCTION obter_cor_grid_planeja_consig ( nr_seq_agenda_p bigint, nr_seq_age_consig_p bigint, ie_linha_coluna_p text, ie_coluna_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cor_grid_planeja_consig ( nr_seq_agenda_p bigint, nr_seq_age_consig_p bigint, ie_linha_coluna_p text, ie_coluna_p text) FROM PUBLIC;
