...
CREATE OR REPLACE FUNCTION obter_marcas_concatenadas ( cd_material_p bigint, ie_opcao_p text, ie_quebra_linha_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_marcas_concatenadas ( cd_material_p bigint, ie_opcao_p text, ie_quebra_linha_p text) FROM PUBLIC;
