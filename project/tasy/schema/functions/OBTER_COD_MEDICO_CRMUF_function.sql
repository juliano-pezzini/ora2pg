...
CREATE OR REPLACE FUNCTION obter_cod_medico_crmuf ( cd_crm_uf_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cod_medico_crmuf ( cd_crm_uf_p text) FROM PUBLIC;
