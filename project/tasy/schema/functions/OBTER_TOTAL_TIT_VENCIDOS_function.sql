...
CREATE OR REPLACE FUNCTION obter_total_tit_vencidos (cd_pessoa_p text, tp_pessoa_p bigint, nm_usuario_p text) RETURNS bigint AS $body$
DECLARE
 vl_vencido bigint;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_total_tit_vencidos (cd_pessoa_p text, tp_pessoa_p bigint, nm_usuario_p text) FROM PUBLIC;
