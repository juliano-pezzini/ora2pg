...
CREATE OR REPLACE FUNCTION obter_leitos_ocup_setor ( cd_setor_atendimento_p bigint ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_leitos_ocup_setor ( cd_setor_atendimento_p bigint ) FROM PUBLIC;
