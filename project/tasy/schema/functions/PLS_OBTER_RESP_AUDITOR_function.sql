...
CREATE OR REPLACE FUNCTION pls_obter_resp_auditor ( nr_seq_resp_auditor_p bigint, ie_tipo_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_resp_auditor ( nr_seq_resp_auditor_p bigint, ie_tipo_p bigint) FROM PUBLIC;
