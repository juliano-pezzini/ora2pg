...
CREATE OR REPLACE FUNCTION san_obter_possui_exame_pai_pf (cd_pessoa_fisica_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION san_obter_possui_exame_pai_pf (cd_pessoa_fisica_p text) FROM PUBLIC;
