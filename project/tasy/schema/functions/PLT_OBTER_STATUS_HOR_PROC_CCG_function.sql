...
CREATE OR REPLACE FUNCTION plt_obter_status_hor_proc_ccg ( dt_administracao_p timestamp, dt_suspensao_p timestamp, ie_dose_especial_p text, dt_lib_horario_p timestamp) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION plt_obter_status_hor_proc_ccg ( dt_administracao_p timestamp, dt_suspensao_p timestamp, ie_dose_especial_p text, dt_lib_horario_p timestamp) FROM PUBLIC;
