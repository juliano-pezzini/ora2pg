...
CREATE OR REPLACE FUNCTION sus_obter_valores_sadt ( nr_seq_protocolo_p bigint, ie_opcao_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION sus_obter_valores_sadt ( nr_seq_protocolo_p bigint, ie_opcao_p bigint) FROM PUBLIC;
