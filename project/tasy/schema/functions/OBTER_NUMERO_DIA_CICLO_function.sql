...
CREATE OR REPLACE FUNCTION obter_numero_dia_ciclo ( ds_campo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 IMMUTABLE;
-- REVOKE ALL ON FUNCTION obter_numero_dia_ciclo ( ds_campo_p text) FROM PUBLIC;
