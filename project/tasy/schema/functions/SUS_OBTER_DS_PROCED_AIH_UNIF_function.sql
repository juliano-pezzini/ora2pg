...
CREATE OR REPLACE FUNCTION sus_obter_ds_proced_aih_unif ( nr_atendimento_p bigint, ie_tipo_proc_aih_p bigint, ie_retorno_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION sus_obter_ds_proced_aih_unif ( nr_atendimento_p bigint, ie_tipo_proc_aih_p bigint, ie_retorno_p text) FROM PUBLIC;
