...
CREATE OR REPLACE FUNCTION obter_estab_mat_frac (cd_material_p bigint, nr_seq_estagio_armaz_p bigint ) RETURNS bigint AS $body$
DECLARE
...
if (cd_material_p IS NOT NULL AND cd_material_p::text <> '') then
	...
	and		coalesce(NR_SEQ_ESTAGIO,nr_seq_estagio_armaz_p) = nr_seq_estagio_armaz_p;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_estab_mat_frac (cd_material_p bigint, nr_seq_estagio_armaz_p bigint ) FROM PUBLIC;
