...
CREATE OR REPLACE FUNCTION obter_se_somente_numero_md ( ds_campo_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_somente_numero_md ( ds_campo_p text) FROM PUBLIC;
