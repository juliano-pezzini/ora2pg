...
CREATE OR REPLACE FUNCTION sus_ordenar_proc_apac (nr_interno_conta_p bigint, cd_procedimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION sus_ordenar_proc_apac (nr_interno_conta_p bigint, cd_procedimento_p bigint) FROM PUBLIC;
