...
CREATE OR REPLACE FUNCTION obter_se_mat_lib_subgrupo_com ( nr_seq_subgrupo_compras_p bigint, cd_material_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_mat_lib_subgrupo_com ( nr_seq_subgrupo_compras_p bigint, cd_material_p bigint) FROM PUBLIC;
