...
CREATE OR REPLACE FUNCTION obter_maior_valor_compra (cd_material_p text, data_p timestamp, qt_dias_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_maior_valor_compra (cd_material_p text, data_p timestamp, qt_dias_p bigint) FROM PUBLIC;
