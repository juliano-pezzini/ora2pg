...
CREATE OR REPLACE FUNCTION obter_proced_princ_sus (NR_ATENDIMENTO_P bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_proced_princ_sus (NR_ATENDIMENTO_P bigint) FROM PUBLIC;
