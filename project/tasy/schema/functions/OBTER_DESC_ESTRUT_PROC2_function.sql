...
CREATE OR REPLACE FUNCTION obter_desc_estrut_proc2 ( cd_area_proced_p bigint, cd_especial_proced_p bigint, cd_grupo_proced_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_estrut_proc2 ( cd_area_proced_p bigint, cd_especial_proced_p bigint, cd_grupo_proced_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint) FROM PUBLIC;
