...
CREATE OR REPLACE FUNCTION pls_obter_end_prestador ( nr_seq_prestador_p pls_prestador.nr_sequencia%type, ie_tipo_endereco_p pls_prestador.ie_tipo_endereco%type, nr_seq_compl_adic_p pessoa_juridica_compl.nr_sequencia%type) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_end_prestador ( nr_seq_prestador_p pls_prestador.nr_sequencia%type, ie_tipo_endereco_p pls_prestador.ie_tipo_endereco%type, nr_seq_compl_adic_p pessoa_juridica_compl.nr_sequencia%type) FROM PUBLIC;
