...
CREATE OR REPLACE FUNCTION obter_padrao_param_prescr ( nr_atendimento_p bigint, cd_material_p bigint, ie_via_aplicacao_p text, cd_setor_atendimento_p bigint, cd_pessoa_fisica_p text, qt_idade_p bigint, qt_peso_p bigint, ie_se_necessario_p text, ie_opcao_p text, cd_intervalo_p text default null, ie_solucao_p text default 'N') RETURNS varchar AS $body$
DECLARE
...
ds_retorno_justificativa_w	varchar(2000) := null;
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (ie_opcao_p = 'I') then
		...
		ds_retorno_justificativa_w	:= substr(ds_justificativa_w,1,2000);
		...
		ds_retorno_w	:= substr(ds_horarios_w,1,255);	
...
if (ie_opcao_p = 'O') then
	...
	return ds_retorno_justificativa_w;
else
	return ds_retorno_w;
end if;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_padrao_param_prescr ( nr_atendimento_p bigint, cd_material_p bigint, ie_via_aplicacao_p text, cd_setor_atendimento_p bigint, cd_pessoa_fisica_p text, qt_idade_p bigint, qt_peso_p bigint, ie_se_necessario_p text, ie_opcao_p text, cd_intervalo_p text default null, ie_solucao_p text default 'N') FROM PUBLIC;
