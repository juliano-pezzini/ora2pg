...
CREATE OR REPLACE FUNCTION ageint_consistir_marc_regra (nr_seq_ageint_p bigint, nr_seq_item_p bigint, ie_acao_p text, hr_agenda_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ageint_consistir_marc_regra (nr_seq_ageint_p bigint, nr_seq_item_p bigint, ie_acao_p text, hr_agenda_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
