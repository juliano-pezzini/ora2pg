...
CREATE OR REPLACE FUNCTION obter_file_schematic4test (NR_SEQ_SCHEDULE_P bigint, NR_SEQ_SCRIPT_P bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_file_schematic4test (NR_SEQ_SCHEDULE_P bigint, NR_SEQ_SCRIPT_P bigint) FROM PUBLIC;
