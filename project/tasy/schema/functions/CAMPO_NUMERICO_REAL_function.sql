...
CREATE OR REPLACE FUNCTION campo_numerico_real ( ds_campo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION campo_numerico_real ( ds_campo_p text) FROM PUBLIC;
