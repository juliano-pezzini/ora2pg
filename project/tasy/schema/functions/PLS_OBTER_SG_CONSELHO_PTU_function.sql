...
CREATE OR REPLACE FUNCTION pls_obter_sg_conselho_ptu (cd_medico_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_sg_conselho_ptu (cd_medico_p text) FROM PUBLIC;
