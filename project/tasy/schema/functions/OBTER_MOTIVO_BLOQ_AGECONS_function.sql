...
CREATE OR REPLACE FUNCTION obter_motivo_bloq_agecons (nr_seq_agenda_p bigint, nr_seq_motivo_p bigint) RETURNS varchar AS $body$
DECLARE
...
if (nr_seq_agenda_p IS NOT NULL AND nr_seq_agenda_p::text <> '') then
	...
	elsif (nm_usuario_status_w IS NOT NULL AND nm_usuario_status_w::text <> '') then
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_motivo_bloq_agecons (nr_seq_agenda_p bigint, nr_seq_motivo_p bigint) FROM PUBLIC;
