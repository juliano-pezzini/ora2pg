...
CREATE OR REPLACE FUNCTION get_qtd_agendamentos_cirurgias ( nr_atendimento_p bigint, cd_pessoa_fisica_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 IMMUTABLE;
-- REVOKE ALL ON FUNCTION get_qtd_agendamentos_cirurgias ( nr_atendimento_p bigint, cd_pessoa_fisica_p text) FROM PUBLIC;
