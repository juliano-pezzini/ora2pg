...
CREATE OR REPLACE FUNCTION obter_se_med_uso_cont_padr_lib (nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_med_uso_cont_padr_lib (nr_sequencia_p bigint) FROM PUBLIC;
