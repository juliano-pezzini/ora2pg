...
CREATE OR REPLACE FUNCTION obter_status_hor_material ( dt_administracao_p timestamp, dt_suspensao_p timestamp) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_status_hor_material ( dt_administracao_p timestamp, dt_suspensao_p timestamp) FROM PUBLIC;
