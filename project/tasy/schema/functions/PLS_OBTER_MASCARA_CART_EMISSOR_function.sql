...
CREATE OR REPLACE FUNCTION pls_obter_mascara_cart_emissor (cd_usuario_plano_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_mascara_cart_emissor (cd_usuario_plano_p text) FROM PUBLIC;
