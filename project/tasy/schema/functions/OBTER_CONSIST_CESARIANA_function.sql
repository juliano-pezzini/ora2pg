...
CREATE OR REPLACE FUNCTION obter_consist_cesariana (nr_seq_protocolo_p bigint, ie_tipo_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_consist_cesariana (nr_seq_protocolo_p bigint, ie_tipo_p bigint) FROM PUBLIC;
