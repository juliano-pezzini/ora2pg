...
CREATE OR REPLACE FUNCTION obter_alerta_atend_mat ( nr_prescricao_p bigint, cd_material_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_alerta_atend_mat ( nr_prescricao_p bigint, cd_material_p bigint) FROM PUBLIC;
