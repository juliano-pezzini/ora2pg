...
CREATE OR REPLACE FUNCTION obter_proximo_agrup_medic (nr_prescricao_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_proximo_agrup_medic (nr_prescricao_p bigint) FROM PUBLIC;
