...
CREATE OR REPLACE FUNCTION fis_obter_unidade_medida (cd_unidade_medida_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION fis_obter_unidade_medida (cd_unidade_medida_p text) FROM PUBLIC;
