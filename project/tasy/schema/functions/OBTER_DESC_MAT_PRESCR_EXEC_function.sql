...
CREATE OR REPLACE FUNCTION obter_desc_mat_prescr_exec ( nr_prescricao_p bigint, nr_sequencia_p bigint, ie_localizacao_p text, cd_local_estoque_p bigint, ie_origem_P text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_mat_prescr_exec ( nr_prescricao_p bigint, nr_sequencia_p bigint, ie_localizacao_p text, cd_local_estoque_p bigint, ie_origem_P text) FROM PUBLIC;
