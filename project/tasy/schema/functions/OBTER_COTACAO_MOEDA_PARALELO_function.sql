...
CREATE OR REPLACE FUNCTION obter_cotacao_moeda_paralelo ( cd_moeda_p bigint, dt_cotacao_p timestamp) RETURNS bigint AS $body$
DECLARE
...
BEGIN
	...
	begin
		select coalesce(a.vl_cotacao_paral,a.vl_cotacao)
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cotacao_moeda_paralelo ( cd_moeda_p bigint, dt_cotacao_p timestamp) FROM PUBLIC;
