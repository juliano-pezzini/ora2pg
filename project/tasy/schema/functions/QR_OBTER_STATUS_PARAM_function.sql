...
CREATE OR REPLACE FUNCTION qr_obter_status_param (nr_sequencia_p bigint, cd_funcao_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION qr_obter_status_param (nr_sequencia_p bigint, cd_funcao_p bigint, ie_opcao_p text) FROM PUBLIC;
