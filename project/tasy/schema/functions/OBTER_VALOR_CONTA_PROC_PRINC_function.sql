...
CREATE OR REPLACE FUNCTION obter_valor_conta_proc_princ (nr_interno_conta_p bigint, nr_seq_item_p bigint, ie_valor_p integer) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_conta_proc_princ (nr_interno_conta_p bigint, nr_seq_item_p bigint, ie_valor_p integer) FROM PUBLIC;
