...
CREATE OR REPLACE FUNCTION elimina_caracteres_telefone ( ds_campo_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION elimina_caracteres_telefone ( ds_campo_p text) FROM PUBLIC;
