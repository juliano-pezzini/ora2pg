...
CREATE OR REPLACE FUNCTION obter_dose_prot_pessoa_dia ( nr_seq_paciente_p bigint, nr_seq_material_p bigint, cd_material_p bigint, qt_dose_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dose_prot_pessoa_dia ( nr_seq_paciente_p bigint, nr_seq_material_p bigint, cd_material_p bigint, qt_dose_p bigint) FROM PUBLIC;
