...
CREATE OR REPLACE FUNCTION obter_setor_destino ( nr_sequencia_p bigint, nm_usuario_param_p text ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_setor_destino ( nr_sequencia_p bigint, nm_usuario_param_p text ) FROM PUBLIC;
