...
CREATE OR REPLACE FUNCTION obter_vel_infusao_sne ( nr_prescricao_p bigint, nr_seq_material_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_vel_infusao_sne ( nr_prescricao_p bigint, nr_seq_material_p bigint) FROM PUBLIC;
