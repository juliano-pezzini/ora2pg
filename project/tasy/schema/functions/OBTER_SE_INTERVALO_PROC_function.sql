...
CREATE OR REPLACE FUNCTION obter_se_intervalo_proc (cd_procedimento_p bigint, ie_origem_proced_p bigint, nr_seq_proc_interno_p bigint, cd_intervalo_p text, cd_setor_atendimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_intervalo_proc (cd_procedimento_p bigint, ie_origem_proced_p bigint, nr_seq_proc_interno_p bigint, cd_intervalo_p text, cd_setor_atendimento_p bigint) FROM PUBLIC;
