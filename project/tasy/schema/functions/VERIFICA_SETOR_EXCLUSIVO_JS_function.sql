...
CREATE OR REPLACE FUNCTION verifica_setor_exclusivo_js ( cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_setor_atendimento_p bigint, nr_seq_proc_interno_p bigint, cd_convenio_p bigint, cd_categoria_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION verifica_setor_exclusivo_js ( cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_setor_atendimento_p bigint, nr_seq_proc_interno_p bigint, cd_convenio_p bigint, cd_categoria_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
