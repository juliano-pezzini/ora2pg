...
CREATE OR REPLACE FUNCTION obter_mat_comercial_estoque ( cd_material_p bigint, ie_cod_desc_p text) RETURNS varchar AS $body$
DECLARE
...
RETURN substr(ds_retorno_w,1,50);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_mat_comercial_estoque ( cd_material_p bigint, ie_cod_desc_p text) FROM PUBLIC;
