...
CREATE OR REPLACE FUNCTION homg_obter_capacidade_agenda (cd_agenda_p bigint, nr_sequencia_p bigint, dt_inicial_p timestamp, dt_final_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION homg_obter_capacidade_agenda (cd_agenda_p bigint, nr_sequencia_p bigint, dt_inicial_p timestamp, dt_final_p timestamp) FROM PUBLIC;
