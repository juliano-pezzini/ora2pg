...
CREATE OR REPLACE FUNCTION obter_origem_proced ( cd_estabelecimento_p bigint, ie_tipo_atendimento_p bigint, ie_tipo_convenio_p bigint, cd_convenio_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_origem_proced ( cd_estabelecimento_p bigint, ie_tipo_atendimento_p bigint, ie_tipo_convenio_p bigint, cd_convenio_p bigint) FROM PUBLIC;
