...
CREATE OR REPLACE FUNCTION obter_valor_acum_oc_direta ( cd_conta_contabil_p text, cd_estabelecimento_p bigint, nr_seq_tipo_compra_p bigint, nr_seq_mod_compra_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_acum_oc_direta ( cd_conta_contabil_p text, cd_estabelecimento_p bigint, nr_seq_tipo_compra_p bigint, nr_seq_mod_compra_p bigint) FROM PUBLIC;
