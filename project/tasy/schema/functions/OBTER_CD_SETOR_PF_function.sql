...
CREATE OR REPLACE FUNCTION obter_cd_setor_pf ( cd_pessoa_fisica_p text ) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cd_setor_pf ( cd_pessoa_fisica_p text ) FROM PUBLIC;
