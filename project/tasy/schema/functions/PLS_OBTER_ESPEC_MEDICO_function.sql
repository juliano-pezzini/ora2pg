...
CREATE OR REPLACE FUNCTION pls_obter_espec_medico ( cd_medico_p text) RETURNS varchar AS $body$
DECLARE


/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade: Obter as especialidades do médico
-------------------------------------------------------------------------------------------------------------------
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_espec_medico ( cd_medico_p text) FROM PUBLIC;
