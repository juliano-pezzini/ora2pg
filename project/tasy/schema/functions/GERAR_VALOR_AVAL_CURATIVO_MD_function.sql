...
CREATE OR REPLACE FUNCTION gerar_valor_aval_curativo_md ( ds_valor_list_p text ) RETURNS bigint AS $body$
...
BEGIN
  ...
  loop
    fetch c01 into c01_w;
      ...
      begin
        qt_result_w := ((c01_w.val)::numeric  + qt_result_w);
      end;
  end loop;
  close c01;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION gerar_valor_aval_curativo_md ( ds_valor_list_p text ) FROM PUBLIC;
