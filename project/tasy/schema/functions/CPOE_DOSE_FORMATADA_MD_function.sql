...
CREATE OR REPLACE FUNCTION cpoe_dose_formatada_md ( vl_campo_p bigint ) RETURNS varchar AS $body$
DECLARE
...
BEGIN
  ...
  --INICIO MD
            BEGIN
                ...
                EXECUTE sql_w
                    USING IN vl_campo_p, OUT ds_decimais_w;
      --FIM MD
            EXCEPTION
                WHEN OTHERS THEN
                    ds_decimais_w := NULL;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cpoe_dose_formatada_md ( vl_campo_p bigint ) FROM PUBLIC;
