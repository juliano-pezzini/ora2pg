...
CREATE OR REPLACE FUNCTION obter_exames_prescr_lab_exter ( nr_prescricao_p bigint, cd_setor_atendimento_p bigint, cd_material_p text, nr_seq_grupo_p bigint, ie_equipamento_p text, ie_opcao_p text, ie_separador_p text, ie_tam_linha_p bigint) RETURNS varchar AS $body$
DECLARE
...
c01 CURSOR FOR
	...
	WHERE a.nr_seq_exame		= b.nr_seq_exame
	  ...
	  AND (b.cd_cgc_externo IS NOT NULL AND b.cd_cgc_externo::text <> '')
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_exames_prescr_lab_exter ( nr_prescricao_p bigint, cd_setor_atendimento_p bigint, cd_material_p text, nr_seq_grupo_p bigint, ie_equipamento_p text, ie_opcao_p text, ie_separador_p text, ie_tam_linha_p bigint) FROM PUBLIC;
