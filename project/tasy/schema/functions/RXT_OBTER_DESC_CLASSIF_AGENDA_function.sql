...
CREATE OR REPLACE FUNCTION rxt_obter_desc_classif_agenda (nr_seq_classif_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION rxt_obter_desc_classif_agenda (nr_seq_classif_p bigint) FROM PUBLIC;
