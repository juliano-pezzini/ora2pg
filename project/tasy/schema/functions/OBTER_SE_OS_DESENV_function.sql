...
CREATE OR REPLACE FUNCTION obter_se_os_desenv ( nr_ordem_servico_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_os_desenv ( nr_ordem_servico_p bigint) FROM PUBLIC;
