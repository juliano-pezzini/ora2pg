...
CREATE OR REPLACE FUNCTION pls_obter_seq_protocolo_ws ( nr_seq_protocolo_prest_p text, cd_cnpj_prest_p text, nr_cpf_prest_p text, cd_prestador_p text, cd_estabelecimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:
Obter a sequencia da PLS_PROTOCOLO_CONTA conforme os parametros recebidos pelo WebSerivice do Prestador
-------------------------------------------------------------------------------------------------------------------
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_seq_protocolo_ws ( nr_seq_protocolo_prest_p text, cd_cnpj_prest_p text, nr_cpf_prest_p text, cd_prestador_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
