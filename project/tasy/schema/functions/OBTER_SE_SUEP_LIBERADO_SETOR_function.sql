...
CREATE OR REPLACE FUNCTION obter_se_suep_liberado_setor ( nr_seq_suep_p bigint, cd_pessoa_usuario_p text, nr_atendimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_suep_liberado_setor ( nr_seq_suep_p bigint, cd_pessoa_usuario_p text, nr_atendimento_p bigint) FROM PUBLIC;
