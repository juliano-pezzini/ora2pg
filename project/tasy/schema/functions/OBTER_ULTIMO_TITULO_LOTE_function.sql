...
CREATE OR REPLACE FUNCTION obter_ultimo_titulo_lote (nr_seq_lote_protocolo_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_ultimo_titulo_lote (nr_seq_lote_protocolo_p bigint) FROM PUBLIC;
