...
CREATE OR REPLACE FUNCTION ctb_obter_contrapartida_movto ( nr_seq_movimento_p bigint, nr_lote_contabil_p bigint, ie_contrapartida_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ctb_obter_contrapartida_movto ( nr_seq_movimento_p bigint, nr_lote_contabil_p bigint, ie_contrapartida_p text) FROM PUBLIC;
