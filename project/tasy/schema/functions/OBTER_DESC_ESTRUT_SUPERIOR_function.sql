...
CREATE OR REPLACE FUNCTION obter_desc_estrut_superior (nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_estrut_superior (nr_sequencia_p bigint) FROM PUBLIC;
