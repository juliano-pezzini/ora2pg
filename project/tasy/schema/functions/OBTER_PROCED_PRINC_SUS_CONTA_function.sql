...
CREATE OR REPLACE FUNCTION obter_proced_princ_sus_conta (nr_interno_conta_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_proced_princ_sus_conta (nr_interno_conta_p bigint) FROM PUBLIC;
