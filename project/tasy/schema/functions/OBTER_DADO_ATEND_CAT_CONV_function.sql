...
CREATE OR REPLACE FUNCTION obter_dado_atend_cat_conv ( nr_atendimento_p bigint, dt_referencia_p timestamp, cd_convenio_p bigint, cd_categoria_p text, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dado_atend_cat_conv ( nr_atendimento_p bigint, dt_referencia_p timestamp, cd_convenio_p bigint, cd_categoria_p text, ie_opcao_p text) FROM PUBLIC;
