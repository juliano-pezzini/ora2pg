...
CREATE OR REPLACE FUNCTION obter_nosso_numero_banco_param (cd_banco_p bigint, nr_seq_conta_banco_p bigint, cd_estabelecimento_p bigint, nr_titulo_p bigint) RETURNS varchar AS $body$
DECLARE


/* Function criada para utilização em update,
devido a tratamento de triggers que impedem.*/
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_nosso_numero_banco_param (cd_banco_p bigint, nr_seq_conta_banco_p bigint, cd_estabelecimento_p bigint, nr_titulo_p bigint) FROM PUBLIC;
