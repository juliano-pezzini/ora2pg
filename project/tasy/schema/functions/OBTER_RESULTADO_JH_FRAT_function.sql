...
CREATE OR REPLACE FUNCTION obter_resultado_jh_frat ( qt_pontos_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_resultado_jh_frat ( qt_pontos_p bigint) FROM PUBLIC;
