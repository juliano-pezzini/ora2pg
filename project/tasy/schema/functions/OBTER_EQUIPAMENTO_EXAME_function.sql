...
CREATE OR REPLACE FUNCTION obter_equipamento_exame ( nr_seq_exame_p bigint, cd_equipamento_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_equipamento_exame ( nr_seq_exame_p bigint, cd_equipamento_p bigint, ie_opcao_p text) FROM PUBLIC;
