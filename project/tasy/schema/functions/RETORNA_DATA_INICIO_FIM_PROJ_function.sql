...
CREATE OR REPLACE FUNCTION retorna_data_inicio_fim_proj (nr_seq_proj_p bigint, ie_tipo_p text) RETURNS timestamp AS $body$
DECLARE
...
/*
	Esta function tem como objetivo retornar a data prevista de início OU fim de um projeto.

	ie_tipo_p = 'I'  irá retornar a data de Inicio do projeto
	ie_tipo_p = 'F'  irá retornar a data de Fim do projeto
...
--Se o projeto começar antes da data prevista, então deve ser retornado o valor de inicio realizado do projeto
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION retorna_data_inicio_fim_proj (nr_seq_proj_p bigint, ie_tipo_p text) FROM PUBLIC;
