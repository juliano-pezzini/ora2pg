...
CREATE OR REPLACE FUNCTION get_mipres_prescriber_code ( nr_seq_cpoe_p prescr_mipres.nr_seq_item_cpoe%type, nr_prescricao_p prescr_mipres.nr_prescricao%type, nr_seq_item_presc_p prescr_mipres.nr_seq_item_presc%type, nr_seq_receita_amb_p prescr_mipres.nr_seq_receita_amb%type, nr_seq_item_receita_amb_p prescr_mipres.nr_seq_item_receita_amb%type, ie_tipo_item_presc_p prescr_mipres.ie_tipo_item_presc%type ) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION get_mipres_prescriber_code ( nr_seq_cpoe_p prescr_mipres.nr_seq_item_cpoe%type, nr_prescricao_p prescr_mipres.nr_prescricao%type, nr_seq_item_presc_p prescr_mipres.nr_seq_item_presc%type, nr_seq_receita_amb_p prescr_mipres.nr_seq_receita_amb%type, nr_seq_item_receita_amb_p prescr_mipres.nr_seq_item_receita_amb%type, ie_tipo_item_presc_p prescr_mipres.ie_tipo_item_presc%type ) FROM PUBLIC;
