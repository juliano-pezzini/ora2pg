...
CREATE OR REPLACE FUNCTION somente_letra_espaco_trim ( ds_campo_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION somente_letra_espaco_trim ( ds_campo_p text) FROM PUBLIC;
