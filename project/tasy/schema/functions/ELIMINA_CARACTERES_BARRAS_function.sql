...
CREATE OR REPLACE FUNCTION elimina_caracteres_barras (ds_campo_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 IMMUTABLE;
-- REVOKE ALL ON FUNCTION elimina_caracteres_barras (ds_campo_p text) FROM PUBLIC;
