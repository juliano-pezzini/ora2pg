...
CREATE OR REPLACE FUNCTION obter_fornec_ult_compra_param ( cd_estabelecimento_p bigint, cd_material_p bigint, cd_local_estoque_p bigint, ie_tipo_p text, qt_compra_p bigint) RETURNS varchar AS $body$
DECLARE


vl_retorno_w		varchar(14);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_fornec_ult_compra_param ( cd_estabelecimento_p bigint, cd_material_p bigint, cd_local_estoque_p bigint, ie_tipo_p text, qt_compra_p bigint) FROM PUBLIC;
