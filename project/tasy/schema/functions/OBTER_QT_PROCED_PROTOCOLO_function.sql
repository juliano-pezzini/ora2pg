...
CREATE OR REPLACE FUNCTION obter_qt_proced_protocolo (nr_seq_protocolo_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qt_proced_protocolo (nr_seq_protocolo_p bigint) FROM PUBLIC;
