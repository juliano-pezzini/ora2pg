...
CREATE OR REPLACE FUNCTION ageint_obter_mot_bloq (cd_agenda_p bigint, dt_horario_p timestamp, ie_dia_semana_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ageint_obter_mot_bloq (cd_agenda_p bigint, dt_horario_p timestamp, ie_dia_semana_p bigint) FROM PUBLIC;
