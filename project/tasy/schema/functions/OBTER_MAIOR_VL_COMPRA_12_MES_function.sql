...
CREATE OR REPLACE FUNCTION obter_maior_vl_compra_12_mes ( cd_estabelecimento_p bigint, qt_dia_p bigint, cd_material_p bigint, cd_local_estoque_p bigint, ie_tipo_p text) RETURNS bigint AS $body$
DECLARE


/*Function correta para buscar o maior valor de compra de um material.
É uma cópia da obter_valor_ultima_compra, mas buscando o maior valor*/
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_maior_vl_compra_12_mes ( cd_estabelecimento_p bigint, qt_dia_p bigint, cd_material_p bigint, cd_local_estoque_p bigint, ie_tipo_p text) FROM PUBLIC;
