...
CREATE OR REPLACE FUNCTION obter_retornos_lote_hist (nr_seq_lote_hist_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_retornos_lote_hist (nr_seq_lote_hist_p bigint) FROM PUBLIC;
