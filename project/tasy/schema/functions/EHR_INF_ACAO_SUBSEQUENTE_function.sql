...
CREATE OR REPLACE FUNCTION ehr_inf_acao_subsequente ( nr_seq_elemento_p bigint, cd_pessoa_fisica_p text, nr_atendimento_p bigint, ie_inf_entidade_p text, ie_atendimento_p text) RETURNS varchar AS $body$
DECLARE
...
ds_comando_w	:= 'Select '||ds_comando_w ||' ds '||chr(13) ||'From pessoa_fisica ';
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	ds_comando_ww	:= ds_comando_w || chr(13) || 'where cd_pessoa_fisica = '|| chr(39) || cd_pessoa_fisica_w || chr(39);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ehr_inf_acao_subsequente ( nr_seq_elemento_p bigint, cd_pessoa_fisica_p text, nr_atendimento_p bigint, ie_inf_entidade_p text, ie_atendimento_p text) FROM PUBLIC;
