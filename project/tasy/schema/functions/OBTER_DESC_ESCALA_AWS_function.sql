...
CREATE OR REPLACE FUNCTION obter_desc_escala_aws ( qt_score_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_escala_aws ( qt_score_p bigint) FROM PUBLIC;
