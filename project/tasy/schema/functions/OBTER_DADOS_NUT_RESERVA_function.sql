...
CREATE OR REPLACE FUNCTION obter_dados_nut_reserva ( nr_seq_nut_reserva_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dados_nut_reserva ( nr_seq_nut_reserva_p bigint, ie_opcao_p text) FROM PUBLIC;
