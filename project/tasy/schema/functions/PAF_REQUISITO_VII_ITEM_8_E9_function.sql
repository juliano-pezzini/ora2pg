...
CREATE OR REPLACE FUNCTION paf_requisito_vii_item_8_e9 (cd_estabelecimento_p bigint, qt_registros_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION paf_requisito_vii_item_8_e9 (cd_estabelecimento_p bigint, qt_registros_p bigint) FROM PUBLIC;
