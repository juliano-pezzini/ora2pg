...
CREATE OR REPLACE FUNCTION parse_previous_name ( nm_pessoa_fisica_p text , option_p text default 'FULLN') RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION parse_previous_name ( nm_pessoa_fisica_p text , option_p text default 'FULLN') FROM PUBLIC;
