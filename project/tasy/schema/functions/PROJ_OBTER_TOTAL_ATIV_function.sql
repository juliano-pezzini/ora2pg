...
CREATE OR REPLACE FUNCTION proj_obter_total_ativ ( nr_seq_cliente_p bigint, nr_seq_cronograma_p bigint, cd_executor_p text, dt_mes_p timestamp, nr_seq_etapa_p bigint default null) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION proj_obter_total_ativ ( nr_seq_cliente_p bigint, nr_seq_cronograma_p bigint, cd_executor_p text, dt_mes_p timestamp, nr_seq_etapa_p bigint default null) FROM PUBLIC;
