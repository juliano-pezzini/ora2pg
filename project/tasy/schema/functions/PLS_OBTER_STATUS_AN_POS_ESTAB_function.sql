...
CREATE OR REPLACE FUNCTION pls_obter_status_an_pos_estab ( nr_seq_analise_p bigint, nr_seq_conta_pos_estab_p bigint, ie_item_nao_encontrado_p text, ie_tipo_item_p text) RETURNS varchar AS $body$
DECLARE
...
-------------------------------------------------------------------------------------------------------------------
ie_tipo_item_p:   'P' - Procedimento  'M' - Material
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_status_an_pos_estab ( nr_seq_analise_p bigint, nr_seq_conta_pos_estab_p bigint, ie_item_nao_encontrado_p text, ie_tipo_item_p text) FROM PUBLIC;
