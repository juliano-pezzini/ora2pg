...
CREATE OR REPLACE FUNCTION gpt_obter_grupo_rule ( cd_perfil_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION gpt_obter_grupo_rule ( cd_perfil_p bigint, ie_opcao_p text) FROM PUBLIC;
