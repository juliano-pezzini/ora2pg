...
CREATE OR REPLACE FUNCTION obter_se_tipo_alerta_lib_js ( nr_seq_tipo_alerta_p bigint, nm_usuario_p text, cd_funcao_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_tipo_alerta_lib_js ( nr_seq_tipo_alerta_p bigint, nm_usuario_p text, cd_funcao_p bigint) FROM PUBLIC;
