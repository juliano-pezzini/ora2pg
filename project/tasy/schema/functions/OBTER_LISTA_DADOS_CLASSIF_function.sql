...
CREATE OR REPLACE FUNCTION obter_lista_dados_classif (cd_pessoa_fisica_p text, ie_campo_retorno_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_lista_dados_classif (cd_pessoa_fisica_p text, ie_campo_retorno_p text) FROM PUBLIC;
