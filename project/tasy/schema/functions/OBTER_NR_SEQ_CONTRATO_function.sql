...
CREATE OR REPLACE FUNCTION obter_nr_seq_contrato ( cd_cnpj_p text, cd_pessoa_fisica_p text, cd_material_p bigint ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_nr_seq_contrato ( cd_cnpj_p text, cd_pessoa_fisica_p text, cd_material_p bigint ) FROM PUBLIC;
