...
CREATE OR REPLACE FUNCTION obter_se_integr_sc_ext ( nr_solic_compra_p bigint, ie_sistema_ext_p text) RETURNS varchar AS $body$
DECLARE
...
if (ie_envia_integracao_w = 'S') then
	...
	EXIT WHEN NOT FOUND; /* apply on C01 */
		...
		/* Parar assim que já houver um item para integrar */
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_integr_sc_ext ( nr_solic_compra_p bigint, ie_sistema_ext_p text) FROM PUBLIC;
