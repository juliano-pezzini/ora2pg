...
CREATE OR REPLACE FUNCTION lab_obter_valor_referencia (nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, ie_opcao_p bigint) RETURNS bigint AS $body$
DECLARE
...
/*
IE_OPCAO_P:
1 = Valor de referencia minimo
2 = Valor de referencia maximo
*/
BEGIN
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION lab_obter_valor_referencia (nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, ie_opcao_p bigint) FROM PUBLIC;
