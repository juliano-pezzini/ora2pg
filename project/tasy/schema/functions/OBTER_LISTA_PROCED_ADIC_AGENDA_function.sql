...
CREATE OR REPLACE FUNCTION obter_lista_proced_adic_agenda (nr_seq_agenda_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_lista_proced_adic_agenda (nr_seq_agenda_p bigint) FROM PUBLIC;
