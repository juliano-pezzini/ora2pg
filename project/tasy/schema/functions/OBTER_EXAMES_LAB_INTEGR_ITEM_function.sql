...
CREATE OR REPLACE FUNCTION obter_exames_lab_integr_item (nr_prescricao_p bigint, cd_setor_atendimento_p bigint, ie_opcao_p text, ie_separador_p text, ie_status_envio_p bigint, ds_sigla_p text, nr_seq_prescr_proc_mat_p text, nr_seq_lote_externo_p bigint, cd_estabelecimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
c01 CURSOR FOR
	SELECT	a.cd_procedimento,
		b.nr_seq_exame,
		b.cd_exame,
		coalesce(obter_equipamento_exame(a.nr_seq_exame,null,ds_sigla_p),coalesce(b.cd_exame_integracao, b.cd_exame)),
		max(a.nr_sequencia),
		b.nm_exame,
		d.nr_amostra
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_exames_lab_integr_item (nr_prescricao_p bigint, cd_setor_atendimento_p bigint, ie_opcao_p text, ie_separador_p text, ie_status_envio_p bigint, ds_sigla_p text, nr_seq_prescr_proc_mat_p text, nr_seq_lote_externo_p bigint, cd_estabelecimento_p bigint) FROM PUBLIC;
