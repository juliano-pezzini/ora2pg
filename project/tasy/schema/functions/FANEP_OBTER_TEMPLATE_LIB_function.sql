...
CREATE OR REPLACE FUNCTION fanep_obter_template_lib ( nr_seq_item_fanep_p bigint ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION fanep_obter_template_lib ( nr_seq_item_fanep_p bigint ) FROM PUBLIC;
