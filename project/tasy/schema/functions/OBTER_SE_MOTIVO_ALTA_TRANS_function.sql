...
CREATE OR REPLACE FUNCTION obter_se_motivo_alta_trans ( cd_motivo_alta_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_motivo_alta_trans ( cd_motivo_alta_p bigint) FROM PUBLIC;
