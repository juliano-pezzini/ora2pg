...
CREATE OR REPLACE FUNCTION obter_medico_aux_pa (nr_atendimento_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_medico_aux_pa (nr_atendimento_p bigint, ie_opcao_p text) FROM PUBLIC;
