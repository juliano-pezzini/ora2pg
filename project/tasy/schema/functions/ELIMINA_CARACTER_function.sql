...
CREATE OR REPLACE FUNCTION elimina_caracter (ds_campo_p text, caracter_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION elimina_caracter (ds_campo_p text, caracter_p text) FROM PUBLIC;
