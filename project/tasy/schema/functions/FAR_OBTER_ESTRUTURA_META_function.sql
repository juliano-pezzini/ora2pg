...
CREATE OR REPLACE FUNCTION far_obter_estrutura_meta (nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION far_obter_estrutura_meta (nr_sequencia_p bigint) FROM PUBLIC;
