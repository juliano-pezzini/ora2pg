...
CREATE OR REPLACE FUNCTION get_preview_outcome (nr_seq_etapa_p bigint, ie_count_p text DEFAULT 'N', ie_nome_amigavel_p text DEFAULT 'N') RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION get_preview_outcome (nr_seq_etapa_p bigint, ie_count_p text DEFAULT 'N', ie_nome_amigavel_p text DEFAULT 'N') FROM PUBLIC;
