...
CREATE OR REPLACE FUNCTION obter_exame_lista_agenda ( nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_exame_lista_agenda ( nr_sequencia_p bigint) FROM PUBLIC;
