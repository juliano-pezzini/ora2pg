...
CREATE OR REPLACE FUNCTION kpi_obter_horas_regist (nr_seq_gerencia_p bigint, nr_seq_grupo_p bigint, cd_pessoa_fisica_p text, dt_referencia_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION kpi_obter_horas_regist (nr_seq_gerencia_p bigint, nr_seq_grupo_p bigint, cd_pessoa_fisica_p text, dt_referencia_p timestamp) FROM PUBLIC;
