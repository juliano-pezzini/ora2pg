...
CREATE OR REPLACE FUNCTION obter_regra_lote_inspecao ( cd_estabelecimento_p bigint, cd_material_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_regra_lote_inspecao ( cd_estabelecimento_p bigint, cd_material_p bigint) FROM PUBLIC;
