...
CREATE OR REPLACE FUNCTION get_alerta_paciente_alert ( nr_seq_pac_alerta_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION get_alerta_paciente_alert ( nr_seq_pac_alerta_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
