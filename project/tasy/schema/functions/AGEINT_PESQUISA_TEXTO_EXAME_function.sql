...
CREATE OR REPLACE FUNCTION ageint_pesquisa_texto_exame (nr_seq_proc_interno_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_estabelecimento_p bigint, ie_primeiro_exame_p text, cd_convenio_p bigint, cd_categoria_p text, cd_plano_p text, nr_seq_grupo_p bigint, ie_resumo_p text, ie_resumo_long_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ageint_pesquisa_texto_exame (nr_seq_proc_interno_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_estabelecimento_p bigint, ie_primeiro_exame_p text, cd_convenio_p bigint, cd_categoria_p text, cd_plano_p text, nr_seq_grupo_p bigint, ie_resumo_p text, ie_resumo_long_p text) FROM PUBLIC;
