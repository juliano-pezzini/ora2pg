...
CREATE OR REPLACE FUNCTION obter_obs_alerta_adm_processo ( nr_seq_processo_p bigint, cd_tipos_obs_adm_p text , ie_tipo_solucao_p bigint ) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_obs_alerta_adm_processo ( nr_seq_processo_p bigint, cd_tipos_obs_adm_p text , ie_tipo_solucao_p bigint ) FROM PUBLIC;
