...
CREATE OR REPLACE FUNCTION obter_qtd_doacoes_aptas ( cd_pessoa_fisica_p text, nr_seq_doacao_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qtd_doacoes_aptas ( cd_pessoa_fisica_p text, nr_seq_doacao_p bigint) FROM PUBLIC;
