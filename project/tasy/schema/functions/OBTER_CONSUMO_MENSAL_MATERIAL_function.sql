...
CREATE OR REPLACE FUNCTION obter_consumo_mensal_material ( IE_TIPO_P text, CD_ESTABELECIMENTO_P bigint, CD_MATERIAL_P bigint, DT_MESANO_REFERENCIA_P timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_consumo_mensal_material ( IE_TIPO_P text, CD_ESTABELECIMENTO_P bigint, CD_MATERIAL_P bigint, DT_MESANO_REFERENCIA_P timestamp) FROM PUBLIC;
