...
CREATE OR REPLACE FUNCTION cta_obter_cor_painel ( vl_referencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cta_obter_cor_painel ( vl_referencia_p bigint) FROM PUBLIC;
