...
CREATE OR REPLACE FUNCTION obter_alerta_prescr_mat ( nr_prescricao_p bigint, nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_alerta_prescr_mat ( nr_prescricao_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
