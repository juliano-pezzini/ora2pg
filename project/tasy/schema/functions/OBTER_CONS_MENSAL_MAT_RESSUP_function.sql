...
CREATE OR REPLACE FUNCTION obter_cons_mensal_mat_ressup ( ie_tipo_p text, cd_estabelecimento_p bigint, cd_material_p bigint, dt_mesano_referencia_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cons_mensal_mat_ressup ( ie_tipo_p text, cd_estabelecimento_p bigint, cd_material_p bigint, dt_mesano_referencia_p timestamp) FROM PUBLIC;
