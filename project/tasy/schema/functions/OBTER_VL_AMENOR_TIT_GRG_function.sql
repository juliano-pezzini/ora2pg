...
CREATE OR REPLACE FUNCTION obter_vl_amenor_tit_grg ( nr_titulo_p bigint, ie_opcao_p text, dt_referencia_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_vl_amenor_tit_grg ( nr_titulo_p bigint, ie_opcao_p text, dt_referencia_p timestamp) FROM PUBLIC;
