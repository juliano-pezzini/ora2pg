...
CREATE OR REPLACE FUNCTION obter_se_todos_alertas (cd_pessoa_fisica_p text) RETURNS varchar AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	ds_retorno_w := ds_retorno_w || to_char(dt_alerta_w, 'dd/mm/yyyy hh24:mi:ss') || ' - ' || ds_alerta_w || chr(13);
end loop;
close c01;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_todos_alertas (cd_pessoa_fisica_p text) FROM PUBLIC;
