...
CREATE OR REPLACE FUNCTION obter_se_dlp_obrigatorio ( nr_seq_proc_p bigint, cd_tipo_procedimento_p bigint, cd_procedimentos_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_dlp_obrigatorio ( nr_seq_proc_p bigint, cd_tipo_procedimento_p bigint, cd_procedimentos_p text) FROM PUBLIC;
