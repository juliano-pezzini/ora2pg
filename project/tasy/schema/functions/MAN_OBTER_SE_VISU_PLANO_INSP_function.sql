...
CREATE OR REPLACE FUNCTION man_obter_se_visu_plano_insp ( nr_seq_plano_insp_p bigint, nm_usuario_p text) RETURNS varchar AS $body$
DECLARE


ie_visualizacao_w	varchar(1) := 'N';
qt_existe_w		bigint;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION man_obter_se_visu_plano_insp ( nr_seq_plano_insp_p bigint, nm_usuario_p text) FROM PUBLIC;
