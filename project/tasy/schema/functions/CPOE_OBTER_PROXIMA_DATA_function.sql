...
CREATE OR REPLACE FUNCTION cpoe_obter_proxima_data (ie_tipo_item_p text, dt_horario_p timestamp, nr_sequencia_p bigint, ds_horarios_p text) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cpoe_obter_proxima_data (ie_tipo_item_p text, dt_horario_p timestamp, nr_sequencia_p bigint, ds_horarios_p text) FROM PUBLIC;
