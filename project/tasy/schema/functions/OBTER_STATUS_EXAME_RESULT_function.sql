...
CREATE OR REPLACE FUNCTION obter_status_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
select	max(substr(Obter_Valor_Dominio_Status_LIS(b.ie_status_atend),1,100)) ds_status_exame
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_status_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
