...
CREATE OR REPLACE FUNCTION obter_qtd_pacientes_familia ( NR_SEQ_AG_CONSULTA_P bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qtd_pacientes_familia ( NR_SEQ_AG_CONSULTA_P bigint) FROM PUBLIC;
