...
CREATE OR REPLACE FUNCTION pls_converte_path_storage_web ( ds_arquivo_p text) RETURNS varchar AS $body$
DECLARE


/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:
Converter o diretório dos arquivos do Storage para o diretório linux.
Rotina utilizada para possibilitar o download no Portal dos arquivos inseridos pelo Tasy HTML5
-------------------------------------------------------------------------------------------------------------------
...
if (position('tasy-storage' in ds_arquivo_p) > 0) then	
	-- Pega o valor do diretório entre a segunda e ultima '/'
	...
	-- Pega o valor do diretório entre a primeira e segunda barra
	...
	--Tratamento realizado caso o diretório venha de regra de geração de arquivo, onde são adicionadas pastas ao diretório. Pega o valor da segunda até a ultima '/'
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_converte_path_storage_web ( ds_arquivo_p text) FROM PUBLIC;
