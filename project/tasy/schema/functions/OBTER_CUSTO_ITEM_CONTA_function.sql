...
CREATE OR REPLACE FUNCTION obter_custo_item_conta ( nr_sequencia_p bigint, ie_proc_mat_p bigint) RETURNS bigint AS $body$
DECLARE
...
/*
	...
	set 	vl_custo		= vl_custo_w,
		vl_custo_variavel	= vl_custo_variavel_w,
		vl_custo_sadt		= vl_custo_sadt_w,
		vl_custo_dir_apoio	= vl_custo_dir_apoio_w,
		vl_custo_mao_obra	= vl_custo_mao_obra_w,
		vl_custo_direto	= vl_custo_direto_w,
		vl_custo_indireto	= vl_custo_indireto_w,
		vl_despesa		= vl_despesa_w,
		vl_custo_hm		= vl_custo_hm_w,
		pr_imposto_custo	= pr_imposto_w
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_custo_item_conta ( nr_sequencia_p bigint, ie_proc_mat_p bigint) FROM PUBLIC;
