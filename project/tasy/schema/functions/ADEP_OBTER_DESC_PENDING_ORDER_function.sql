...
--
-- dblink wrapper to call function adep_obter_desc_pending_order as an autonomous transaction
--
CREATE EXTENSION IF NOT EXISTS dblink;

CREATE OR REPLACE FUNCTION adep_obter_desc_pending_order ( nr_seq_cpoe_p bigint, ie_tipo_item_p text, dt_filtro_p timestamp default null, ie_adep_p text default 'N', ie_exibir_dt_fim_p text default 'N') RETURNS varchar AS $body$
DECLARE
	...
	v_ret	varchar;
BEGIN
	v_query := 'SELECT * FROM adep_obter_desc_pending_order_atx ( ' || quote_nullable(nr_seq_cpoe_p) || ',' || quote_nullable(ie_tipo_item_p) || ',' || quote_nullable(dt_filtro_p) || ',' || quote_nullable(ie_adep_p) || ',' || quote_nullable(ie_exibir_dt_fim_p) || ' )';
...
CREATE OR REPLACE FUNCTION adep_obter_desc_pending_order_atx ( nr_seq_cpoe_p bigint, ie_tipo_item_p text, dt_filtro_p timestamp default null, ie_adep_p text default 'N', ie_exibir_dt_fim_p text default 'N') RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION adep_obter_desc_pending_order ( nr_seq_cpoe_p bigint, ie_tipo_item_p text, dt_filtro_p timestamp default null, ie_adep_p text default 'N', ie_exibir_dt_fim_p text default 'N') FROM PUBLIC; -- REVOKE ALL ON FUNCTION adep_obter_desc_pending_order_atx ( nr_seq_cpoe_p bigint, ie_tipo_item_p text, dt_filtro_p timestamp default null, ie_adep_p text default 'N', ie_exibir_dt_fim_p text default 'N') FROM PUBLIC;
