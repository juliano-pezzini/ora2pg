...
CREATE OR REPLACE FUNCTION obter_unidades_temp_setor ( cd_setor_atendimento_p bigint ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_unidades_temp_setor ( cd_setor_atendimento_p bigint ) FROM PUBLIC;
