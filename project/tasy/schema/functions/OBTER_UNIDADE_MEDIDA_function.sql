...
CREATE OR REPLACE FUNCTION obter_unidade_medida (cd_unidade_medida_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_unidade_medida (cd_unidade_medida_p text) FROM PUBLIC;
