...
CREATE OR REPLACE FUNCTION obter_pr_agregado_etapa_prog ( nr_seq_prog_p bigint,dt_inicio_prev_p timestamp ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_pr_agregado_etapa_prog ( nr_seq_prog_p bigint,dt_inicio_prev_p timestamp ) FROM PUBLIC;
