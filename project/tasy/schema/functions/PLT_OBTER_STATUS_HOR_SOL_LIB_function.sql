...
CREATE OR REPLACE FUNCTION plt_obter_status_hor_sol_lib ( dt_instalacao_p timestamp, dt_administracao_p timestamp, dt_suspensao_p timestamp, dt_interrupcao_p timestamp, ie_dose_especial_p text, nr_seq_processo_p bigint, nr_seq_area_prep_p bigint, dt_lib_horario_p timestamp) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION plt_obter_status_hor_sol_lib ( dt_instalacao_p timestamp, dt_administracao_p timestamp, dt_suspensao_p timestamp, dt_interrupcao_p timestamp, ie_dose_especial_p text, nr_seq_processo_p bigint, nr_seq_area_prep_p bigint, dt_lib_horario_p timestamp) FROM PUBLIC;
