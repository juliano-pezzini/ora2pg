...
CREATE OR REPLACE FUNCTION hd_cons_se_qt_medic_disp_pf (ds_lista_param_p text, qt_medicamento_p bigint, cd_pessoa_fisica_p bigint, cd_estabelecimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hd_cons_se_qt_medic_disp_pf (ds_lista_param_p text, qt_medicamento_p bigint, cd_pessoa_fisica_p bigint, cd_estabelecimento_p bigint) FROM PUBLIC;
