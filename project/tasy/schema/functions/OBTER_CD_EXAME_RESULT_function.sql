...
CREATE OR REPLACE FUNCTION obter_cd_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
select	max(c.cd_exame) cd_exame
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cd_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
