...
CREATE OR REPLACE FUNCTION teste_relatorio_q360 ( QT_UTILIZACAO_P bigint, CD_UNIDADE_MEDIDA_P bigint, IE_FREQUENCIA_P text, DT_INICIO_P timestamp, DT_FIM_P timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION teste_relatorio_q360 ( QT_UTILIZACAO_P bigint, CD_UNIDADE_MEDIDA_P bigint, IE_FREQUENCIA_P text, DT_INICIO_P timestamp, DT_FIM_P timestamp) FROM PUBLIC;
