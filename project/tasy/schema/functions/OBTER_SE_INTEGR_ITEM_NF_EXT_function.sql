...
CREATE OR REPLACE FUNCTION obter_se_integr_item_nf_ext ( nr_sequencia_nf_p bigint, nr_item_nf_p bigint, ie_sistema_ext_p text) RETURNS varchar AS $body$
DECLARE
...
where	1 = 1
and	a.ie_integracao = ie_sistema_ext_p
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_integr_item_nf_ext ( nr_sequencia_nf_p bigint, nr_item_nf_p bigint, ie_sistema_ext_p text) FROM PUBLIC;
