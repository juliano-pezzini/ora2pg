...
CREATE OR REPLACE FUNCTION obter_cotacao_moeda_financ ( cd_moeda_p bigint, dt_cotacao_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_cotacao_moeda_financ ( cd_moeda_p bigint, dt_cotacao_p timestamp) FROM PUBLIC;
