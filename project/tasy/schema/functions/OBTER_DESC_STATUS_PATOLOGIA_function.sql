...
CREATE OR REPLACE FUNCTION obter_desc_status_patologia (nr_seq_status_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_status_patologia (nr_seq_status_p bigint) FROM PUBLIC;
