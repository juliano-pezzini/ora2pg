...
CREATE OR REPLACE FUNCTION hl7_oru_ep12_obter_seq_obx ( nr_seq_prescricao_p bigint, nr_seq_resultado_p bigint, nr_seq_result_item_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hl7_oru_ep12_obter_seq_obx ( nr_seq_prescricao_p bigint, nr_seq_resultado_p bigint, nr_seq_result_item_p bigint) FROM PUBLIC;
