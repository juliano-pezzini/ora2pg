...
CREATE OR REPLACE FUNCTION obter_metodo_regra (nr_prescricao_p bigint, nr_seq_exame_p bigint ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_metodo_regra (nr_prescricao_p bigint, nr_seq_exame_p bigint ) FROM PUBLIC;
