...
CREATE OR REPLACE FUNCTION obter_funcao_usuario_grupo (nm_usuario_p text, nr_seq_grupo_p bigint, nr_seq_gerencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_funcao_usuario_grupo (nm_usuario_p text, nr_seq_grupo_p bigint, nr_seq_gerencia_p bigint) FROM PUBLIC;
