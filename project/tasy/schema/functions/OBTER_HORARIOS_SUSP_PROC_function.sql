...
CREATE OR REPLACE FUNCTION obter_horarios_susp_proc (nr_prescricao_p bigint, nr_seq_proc_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_horarios_susp_proc (nr_prescricao_p bigint, nr_seq_proc_p bigint) FROM PUBLIC;
