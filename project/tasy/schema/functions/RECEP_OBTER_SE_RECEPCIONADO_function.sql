...
CREATE OR REPLACE FUNCTION recep_obter_se_recepcionado ( cd_pessoa_fisica_p bigint, nr_seq_age_proc_p bigint, nr_seq_agenda_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION recep_obter_se_recepcionado ( cd_pessoa_fisica_p bigint, nr_seq_age_proc_p bigint, nr_seq_agenda_p bigint) FROM PUBLIC;
