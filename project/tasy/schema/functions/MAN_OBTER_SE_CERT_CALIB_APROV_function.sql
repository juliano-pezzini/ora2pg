...
CREATE OR REPLACE FUNCTION man_obter_se_cert_calib_aprov (nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
qt_variavel_w	:= (coalesce(qt_erro_total_w,0) - coalesce(qt_incerteza_medicao_w,0));
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION man_obter_se_cert_calib_aprov (nr_sequencia_p bigint) FROM PUBLIC;
