...
CREATE OR REPLACE FUNCTION obter_hr_prev_etapa_proj ( nr_seq_proj_p bigint,dt_inicio_prev_p timestamp ) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_hr_prev_etapa_proj ( nr_seq_proj_p bigint,dt_inicio_prev_p timestamp ) FROM PUBLIC;
