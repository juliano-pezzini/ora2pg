...
CREATE OR REPLACE FUNCTION somente_numero_real ( ds_campo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION somente_numero_real ( ds_campo_p text) FROM PUBLIC;
