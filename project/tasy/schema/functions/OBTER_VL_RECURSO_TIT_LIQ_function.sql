...
CREATE OR REPLACE FUNCTION obter_vl_recurso_tit_liq ( nr_titulo_p bigint, nr_seq_liq_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_vl_recurso_tit_liq ( nr_titulo_p bigint, nr_seq_liq_p bigint) FROM PUBLIC;
