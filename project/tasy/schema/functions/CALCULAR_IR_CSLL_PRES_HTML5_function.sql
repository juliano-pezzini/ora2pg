...
CREATE OR REPLACE FUNCTION calcular_ir_csll_pres_html5 ( cd_estabelecimento_p bigint, dt_inicial_p timestamp, dt_final_p timestamp, ie_tributo_p text, vl_adicionais_p text, vl_descontos_p text, ie_opcao_p bigint, cd_tributo_p text default null, ie_opcao_tributo_p bigint default 1) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION calcular_ir_csll_pres_html5 ( cd_estabelecimento_p bigint, dt_inicial_p timestamp, dt_final_p timestamp, ie_tributo_p text, vl_adicionais_p text, vl_descontos_p text, ie_opcao_p bigint, cd_tributo_p text default null, ie_opcao_tributo_p bigint default 1) FROM PUBLIC;
