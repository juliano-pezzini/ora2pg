...
CREATE OR REPLACE FUNCTION obter_diagnostico_episodio_ger ( nr_seq_episodio_p bigint, ie_por_usuario_logado bigint default 0) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_diagnostico_episodio_ger ( nr_seq_episodio_p bigint, ie_por_usuario_logado bigint default 0) FROM PUBLIC;
