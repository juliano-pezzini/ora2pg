...
CREATE OR REPLACE FUNCTION obter_proced_adicional_agecons (nr_seq_agenda_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_proced_adicional_agecons (nr_seq_agenda_p bigint) FROM PUBLIC;
