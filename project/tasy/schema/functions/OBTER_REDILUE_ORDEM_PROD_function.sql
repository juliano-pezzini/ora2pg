...
CREATE OR REPLACE FUNCTION obter_redilue_ordem_prod ( nr_seq_ordem_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
/* ie_opcao_p M - Material, D - dose U - unidade medida */
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_redilue_ordem_prod ( nr_seq_ordem_p bigint, ie_opcao_p text) FROM PUBLIC;
