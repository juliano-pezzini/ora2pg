...
CREATE OR REPLACE FUNCTION obter_descr_downton_index (qt_pontos_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_descr_downton_index (qt_pontos_p bigint) FROM PUBLIC;
