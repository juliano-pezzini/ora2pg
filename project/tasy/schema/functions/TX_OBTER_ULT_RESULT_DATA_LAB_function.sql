...
CREATE OR REPLACE FUNCTION tx_obter_ult_result_data_lab (cd_pessoa_fisica_p text, seq_grid_p bigint, nr_seq_exame_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION tx_obter_ult_result_data_lab (cd_pessoa_fisica_p text, seq_grid_p bigint, nr_seq_exame_p bigint) FROM PUBLIC;
