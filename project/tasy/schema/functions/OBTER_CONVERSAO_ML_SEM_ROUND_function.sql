...
CREATE OR REPLACE FUNCTION obter_conversao_ml_sem_round ( cd_material_p material_conversao_unidade.cd_material%type, qt_dose_p cpoe_material.qt_dose%type, cd_unid_med_p material_conversao_unidade.cd_unidade_medida%type) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_conversao_ml_sem_round ( cd_material_p material_conversao_unidade.cd_material%type, qt_dose_p cpoe_material.qt_dose%type, cd_unid_med_p material_conversao_unidade.cd_unidade_medida%type) FROM PUBLIC;
