...
CREATE OR REPLACE FUNCTION obter_dado_clin_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dado_clin_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
