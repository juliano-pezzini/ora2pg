...
CREATE OR REPLACE FUNCTION obter_dt_ultimo_sinal_vital_pf (cd_pessoa_fisica_p text) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dt_ultimo_sinal_vital_pf (cd_pessoa_fisica_p text) FROM PUBLIC;
