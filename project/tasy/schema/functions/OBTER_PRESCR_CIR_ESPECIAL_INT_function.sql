...
CREATE OR REPLACE FUNCTION obter_prescr_cir_especial_int ( nr_cirurgia_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_prescr_cir_especial_int ( nr_cirurgia_p bigint) FROM PUBLIC;
