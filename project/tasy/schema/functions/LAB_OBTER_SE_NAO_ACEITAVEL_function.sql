...
CREATE OR REPLACE FUNCTION lab_obter_se_nao_aceitavel (nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, nr_seq_material_p bigint, ds_resultado_p text, qt_resultado_p bigint, pr_resultado_p bigint) RETURNS varchar AS $body$
DECLARE


ie_resultado_critico_w		varchar(1);					
...
elsif   ((ie_formato_resultado_w = 'D') or (ie_formato_resultado_w = 'S') or (ie_formato_resultado_w = 'SM') or (ie_formato_resultado_w = 'SDM')) then
	begin
		select ie_tipo_valor
		into STRICT	 ie_tipo_valor_w
		from exame_lab_padrao
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION lab_obter_se_nao_aceitavel (nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, nr_seq_material_p bigint, ds_resultado_p text, qt_resultado_p bigint, pr_resultado_p bigint) FROM PUBLIC;
