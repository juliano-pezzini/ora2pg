...
CREATE OR REPLACE FUNCTION obter_se_regra_permanencia ( cd_estabelecimento_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_regra_permanencia ( cd_estabelecimento_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint) FROM PUBLIC;
