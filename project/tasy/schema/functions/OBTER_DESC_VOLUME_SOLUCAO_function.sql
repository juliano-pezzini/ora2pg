...
CREATE OR REPLACE FUNCTION obter_desc_volume_solucao ( nr_prescricao_p bigint, nr_Seq_solucao_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_volume_solucao ( nr_prescricao_p bigint, nr_Seq_solucao_p bigint) FROM PUBLIC;
