...
CREATE OR REPLACE FUNCTION cpoe_obter_desc_tipo_item_rel ( ie_tipo_item_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cpoe_obter_desc_tipo_item_rel ( ie_tipo_item_p text) FROM PUBLIC;
