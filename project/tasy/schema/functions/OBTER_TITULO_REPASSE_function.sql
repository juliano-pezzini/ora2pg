...
CREATE OR REPLACE FUNCTION obter_titulo_repasse (nr_repasse_terceiro_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_titulo_repasse (nr_repasse_terceiro_p bigint) FROM PUBLIC;
