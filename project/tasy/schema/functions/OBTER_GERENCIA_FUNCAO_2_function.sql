...
CREATE OR REPLACE FUNCTION obter_gerencia_funcao_2 ( cd_funcao_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_gerencia_funcao_2 ( cd_funcao_p bigint) FROM PUBLIC;
