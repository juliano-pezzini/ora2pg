...
CREATE OR REPLACE FUNCTION obter_motivo_isolamento_ccih (nr_atendimento_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_motivo_isolamento_ccih (nr_atendimento_p bigint, ie_opcao_p text) FROM PUBLIC;
