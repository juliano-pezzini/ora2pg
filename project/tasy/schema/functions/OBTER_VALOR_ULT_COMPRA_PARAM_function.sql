...
CREATE OR REPLACE FUNCTION obter_valor_ult_compra_param ( cd_estabelecimento_p bigint, cd_material_p bigint, cd_local_estoque_p bigint, ie_tipo_p text, qt_compra_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_ult_compra_param ( cd_estabelecimento_p bigint, cd_material_p bigint, cd_local_estoque_p bigint, ie_tipo_p text, qt_compra_p bigint) FROM PUBLIC;
