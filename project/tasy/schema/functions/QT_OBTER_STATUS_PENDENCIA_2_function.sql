...
CREATE OR REPLACE FUNCTION qt_obter_status_pendencia_2 ( nr_seq_pend_agenda_p bigint) RETURNS varchar AS $body$
DECLARE


ds_retorno_w		smallint	:= 3;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION qt_obter_status_pendencia_2 ( nr_seq_pend_agenda_p bigint) FROM PUBLIC;
