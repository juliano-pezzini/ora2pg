...
CREATE OR REPLACE FUNCTION obter_ult_cid_atend_pac_cod (nr_atendimento_p bigint, ie_classificacao_p text, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_ult_cid_atend_pac_cod (nr_atendimento_p bigint, ie_classificacao_p text, ie_opcao_p text) FROM PUBLIC;
