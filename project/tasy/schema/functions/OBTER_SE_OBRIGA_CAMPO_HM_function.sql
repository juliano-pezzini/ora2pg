...
CREATE OR REPLACE FUNCTION obter_se_obriga_campo_hm ( nr_prescricao_p bigint, nr_seq_solic_sangue_p bigint) RETURNS varchar AS $body$
DECLARE
...
if (qt_peso_w = 0) then
	...
	and	nr_sequencia = nr_seq_solic_sangue_p;
end if;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_obriga_campo_hm ( nr_prescricao_p bigint, nr_seq_solic_sangue_p bigint) FROM PUBLIC;
