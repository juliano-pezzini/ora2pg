...
CREATE OR REPLACE FUNCTION obter_dia_sem_age_cons_onc (ie_diario_p text, dt_agenda_p timestamp, cd_agenda_p bigint, cd_agenda_diaria_p text, cd_agenda_where_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dia_sem_age_cons_onc (ie_diario_p text, dt_agenda_p timestamp, cd_agenda_p bigint, cd_agenda_diaria_p text, cd_agenda_where_p text) FROM PUBLIC;
