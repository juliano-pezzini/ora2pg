...
CREATE OR REPLACE FUNCTION hd_obter_dados_modelo_maq (nr_seq_modelo_p bigint, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hd_obter_dados_modelo_maq (nr_seq_modelo_p bigint, ie_opcao_p text) FROM PUBLIC;
