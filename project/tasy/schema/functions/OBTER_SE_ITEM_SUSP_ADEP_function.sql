...
CREATE OR REPLACE FUNCTION obter_se_item_susp_adep (cd_estabelecimento_p bigint, nm_usuario_p text, nr_atendimento_p bigint, ie_tipo_item_p text, cd_item_p text, nr_prescricoes_p text) RETURNS varchar AS $body$
DECLARE
...
BEGIN 
if (nr_atendimento_p IS NOT NULL AND nr_atendimento_p::text <> '') and (ie_tipo_item_p IS NOT NULL AND ie_tipo_item_p::text <> '') and (cd_item_p IS NOT NULL AND cd_item_p::text <> '') and (nr_prescricoes_p IS NOT NULL AND nr_prescricoes_p::text <> '') then 
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_item_susp_adep (cd_estabelecimento_p bigint, nm_usuario_p text, nr_atendimento_p bigint, ie_tipo_item_p text, cd_item_p text, nr_prescricoes_p text) FROM PUBLIC;
