...
CREATE OR REPLACE FUNCTION hd_obter_acesso_prc ( cd_pessoa_fisica_p text, ie_opcao_p text) RETURNS varchar AS $body$
DECLARE


/*
	C -> Retorna a sequencia do acesso
	D -> Retornar a descrição da técnica concatenada com o local
*/
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hd_obter_acesso_prc ( cd_pessoa_fisica_p text, ie_opcao_p text) FROM PUBLIC;
