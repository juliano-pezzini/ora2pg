...
CREATE OR REPLACE FUNCTION vipe_obter_prescricoes ( nr_atendimento_p bigint, ie_tipo_item_p text, cd_item_p text, nr_seq_proc_interno_p bigint, cd_intervalo_p text, qt_item_p bigint, ie_data_lib_proc_p text, ie_data_lib_prescr_p text, ie_exibe_suspensos_p text, dt_validade_p timestamp, cd_setor_paciente_p bigint, nr_seq_prot_glic_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION vipe_obter_prescricoes ( nr_atendimento_p bigint, ie_tipo_item_p text, cd_item_p text, nr_seq_proc_interno_p bigint, cd_intervalo_p text, qt_item_p bigint, ie_data_lib_proc_p text, ie_data_lib_prescr_p text, ie_exibe_suspensos_p text, dt_validade_p timestamp, cd_setor_paciente_p bigint, nr_seq_prot_glic_p bigint) FROM PUBLIC;
