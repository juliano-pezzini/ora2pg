...
CREATE OR REPLACE FUNCTION obter_pr_real_programa ( nr_seq_programa_p bigint ) RETURNS bigint AS $body$
DECLARE

/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:  Obter percentual real de execução de um programa
---------------------------------------------------------------------------------------------------------------------------------------------
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_pr_real_programa ( nr_seq_programa_p bigint ) FROM PUBLIC;
