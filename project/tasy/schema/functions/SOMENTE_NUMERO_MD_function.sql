...
CREATE OR REPLACE FUNCTION somente_numero_md ( ds_campo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 IMMUTABLE;
-- REVOKE ALL ON FUNCTION somente_numero_md ( ds_campo_p text) FROM PUBLIC;
