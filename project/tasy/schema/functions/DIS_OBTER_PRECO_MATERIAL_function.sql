...
CREATE OR REPLACE FUNCTION dis_obter_preco_material ( cd_material_p bigint, cd_estabelecimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION dis_obter_preco_material ( cd_material_p bigint, cd_estabelecimento_p bigint) FROM PUBLIC;
