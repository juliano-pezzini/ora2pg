...
CREATE OR REPLACE FUNCTION ehr_paciente_medic_uso ( nr_seq_reg_elemento_p bigint, nr_seq_entidade_p bigint, nr_seq_elemento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ehr_paciente_medic_uso ( nr_seq_reg_elemento_p bigint, nr_seq_entidade_p bigint, nr_seq_elemento_p bigint) FROM PUBLIC;
