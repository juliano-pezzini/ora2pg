...
CREATE OR REPLACE FUNCTION html_obter_dt_termino_agecons ( nr_seq_agenda_p bigint, ie_diario_p text, ie_final_semana_p text, qt_dias_p bigint, ds_dias_p text) RETURNS timestamp AS $body$
DECLARE
...
-- criada function para o html5 como cópia da funciton obter_dt_termino_per_agecons com o retorno de date
BEGIN
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION html_obter_dt_termino_agecons ( nr_seq_agenda_p bigint, ie_diario_p text, ie_final_semana_p text, qt_dias_p bigint, ds_dias_p text) FROM PUBLIC;
