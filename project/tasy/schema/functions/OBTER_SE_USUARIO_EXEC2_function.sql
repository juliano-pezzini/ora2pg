...
CREATE OR REPLACE FUNCTION obter_se_usuario_exec2 ( nr_ordem_servico_p bigint, nm_usuario_p text, ie_opcao_p bigint, nm_usuario_exec_p text) RETURNS varchar AS $body$
DECLARE
...
if (ie_opcao_p in (0,1)) then
	--begin
	nm_usuario_w	:= nm_usuario_exec_p;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_usuario_exec2 ( nr_ordem_servico_p bigint, nm_usuario_p text, ie_opcao_p bigint, nm_usuario_exec_p text) FROM PUBLIC;
