...
CREATE OR REPLACE FUNCTION obter_seq_apresent_dieta (cd_dieta_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_seq_apresent_dieta (cd_dieta_p bigint) FROM PUBLIC;
