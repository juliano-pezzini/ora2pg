...
CREATE OR REPLACE FUNCTION obter_qt_proc_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) RETURNS bigint AS $body$
DECLARE
...
select	max(b.qt_procedimento) qt_procedimento
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qt_proc_exame_result ( nr_seq_resultado_p bigint, nr_seq_exame_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
