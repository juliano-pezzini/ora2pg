...
CREATE OR REPLACE FUNCTION obter_forma_confirmada_sms ( nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE

			
ds_retorno_w		varchar(255);
ds_retorno_cons_w	varchar(255);
ds_retorno_exam_w	varchar(255);
...
if (ds_retorno_cons_w IS NOT NULL AND ds_retorno_cons_w::text <> '') then
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_forma_confirmada_sms ( nr_sequencia_p bigint) FROM PUBLIC;
