...
CREATE OR REPLACE FUNCTION pls_obter_espec_prest ( nr_seq_prestador_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_espec_prest ( nr_seq_prestador_p bigint) FROM PUBLIC;
