...
CREATE OR REPLACE FUNCTION obter_valores_nf_icms ( nr_seq_nf_p bigint, ie_tipo_valor_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valores_nf_icms ( nr_seq_nf_p bigint, ie_tipo_valor_p text) FROM PUBLIC;
