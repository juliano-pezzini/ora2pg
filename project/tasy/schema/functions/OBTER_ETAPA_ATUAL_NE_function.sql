...
CREATE OR REPLACE FUNCTION obter_etapa_atual_ne ( nr_prescricao_p bigint, nr_seq_solucao_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_etapa_atual_ne ( nr_prescricao_p bigint, nr_seq_solucao_p bigint) FROM PUBLIC;
