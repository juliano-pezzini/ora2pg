...
CREATE OR REPLACE FUNCTION obter_nr_intervalos_dose_dif (ds_dose_dif_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION obter_nr_intervalos_dose_dif (ds_dose_dif_p text) FROM PUBLIC;
