...
CREATE OR REPLACE FUNCTION obter_regra_dispensacao ( cd_estabelecimento_p bigint, cd_material_p bigint, cd_unid_med_dose_p text, ie_via_aplicacao_p text, cd_intervalo_p text, nr_atendimento_p bigint, ie_opcao_p text, nr_prescricao_p bigint, nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_regra_dispensacao ( cd_estabelecimento_p bigint, cd_material_p bigint, cd_unid_med_dose_p text, ie_via_aplicacao_p text, cd_intervalo_p text, nr_atendimento_p bigint, ie_opcao_p text, nr_prescricao_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
