...
CREATE OR REPLACE FUNCTION verifica_setor_exclusivo ( cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_setor_atendimento_p bigint, nr_seq_proc_interno_p bigint, nm_usuario_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION verifica_setor_exclusivo ( cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_setor_atendimento_p bigint, nr_seq_proc_interno_p bigint, nm_usuario_p text) FROM PUBLIC;
