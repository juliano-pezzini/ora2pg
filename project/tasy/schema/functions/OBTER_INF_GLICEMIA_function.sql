...
CREATE OR REPLACE FUNCTION obter_inf_glicemia (nr_atendimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
if (nr_atendimento_p IS NOT NULL AND nr_atendimento_p::text <> '') then
 ...
 || to_char(dt_inicio_hgt_w,'dd/mm/yyyy hh24:mi')			|| CHR(10) ||
							obter_desc_expressao(781046)/*' Última medição: '*/
 || to_char(dt_final_hgt_w,'dd/mm/yyyy hh24:mi')		|| CHR(10) ||
							obter_desc_expressao(648277)/*' Dias: '*/
 || to_char(qt_dia_hgt_w)		|| CHR(10) ||
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_inf_glicemia (nr_atendimento_p bigint) FROM PUBLIC;
