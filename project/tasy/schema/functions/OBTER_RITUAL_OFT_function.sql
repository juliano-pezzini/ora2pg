...
CREATE OR REPLACE FUNCTION obter_ritual_oft ( cd_perfil_p bigint, nm_usuario_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_ritual_oft ( cd_perfil_p bigint, nm_usuario_p text) FROM PUBLIC;
