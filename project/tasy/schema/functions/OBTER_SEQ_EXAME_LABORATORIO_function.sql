...
CREATE OR REPLACE FUNCTION obter_seq_exame_laboratorio ( cd_exame_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_seq_exame_laboratorio ( cd_exame_p text) FROM PUBLIC;
