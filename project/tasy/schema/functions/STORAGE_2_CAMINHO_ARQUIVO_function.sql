...
CREATE OR REPLACE FUNCTION storage_2_caminho_arquivo (ds_storage text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION storage_2_caminho_arquivo (ds_storage text) FROM PUBLIC;
