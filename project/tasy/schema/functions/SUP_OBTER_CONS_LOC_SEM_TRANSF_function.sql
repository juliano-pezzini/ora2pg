...
CREATE OR REPLACE FUNCTION sup_obter_cons_loc_sem_transf ( cd_estabelecimento_p bigint, cd_local_estoque_p bigint, cd_material_p bigint, dt_mesano_referencia_p timestamp, ie_tipo_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION sup_obter_cons_loc_sem_transf ( cd_estabelecimento_p bigint, cd_local_estoque_p bigint, cd_material_p bigint, dt_mesano_referencia_p timestamp, ie_tipo_p text) FROM PUBLIC;
