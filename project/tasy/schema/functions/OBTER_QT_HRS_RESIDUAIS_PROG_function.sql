...
CREATE OR REPLACE FUNCTION obter_qt_hrs_residuais_prog (nr_seq_prog_p bigint, dt_ref_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qt_hrs_residuais_prog (nr_seq_prog_p bigint, dt_ref_p timestamp) FROM PUBLIC;
