...
CREATE OR REPLACE FUNCTION pls_obter_se_plano_proposta ( nr_seq_plano_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_se_plano_proposta ( nr_seq_plano_p bigint) FROM PUBLIC;
