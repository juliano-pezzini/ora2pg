...
CREATE OR REPLACE FUNCTION rxt_tratamento_ag_seg_fisico ( nr_seq_tratamento_p rxt_tratamento.nr_sequencia%TYPE ) RETURNS varchar AS $body$
DECLARE
...
BEGIN
    ...
    AND EXISTS (
        ...
        AND (fase.dt_aprovacao_medico IS NOT NULL AND fase.dt_aprovacao_medico::text <> '')
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION rxt_tratamento_ag_seg_fisico ( nr_seq_tratamento_p rxt_tratamento.nr_sequencia%TYPE ) FROM PUBLIC;
