...
CREATE OR REPLACE FUNCTION obter_data_hist_unidade_date ( nr_seq_unidade_p bigint, ie_status_unidade_p text) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_data_hist_unidade_date ( nr_seq_unidade_p bigint, ie_status_unidade_p text) FROM PUBLIC;
