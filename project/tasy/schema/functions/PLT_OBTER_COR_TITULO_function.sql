...
CREATE OR REPLACE FUNCTION plt_obter_cor_titulo ( ie_tipo_item_p text, nr_seq_regra_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION plt_obter_cor_titulo ( ie_tipo_item_p text, nr_seq_regra_p bigint) FROM PUBLIC;
