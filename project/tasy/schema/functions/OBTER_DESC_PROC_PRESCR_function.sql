...
CREATE OR REPLACE FUNCTION obter_desc_proc_prescr ( nr_prescricao_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_proc_prescr ( nr_prescricao_p bigint) FROM PUBLIC;
