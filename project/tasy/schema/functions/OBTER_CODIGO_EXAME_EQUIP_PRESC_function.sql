...
CREATE OR REPLACE FUNCTION obter_codigo_exame_equip_presc (cd_sigla_equip_p text, nr_prescricao_p bigint, nr_seq_prescr_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_codigo_exame_equip_presc (cd_sigla_equip_p text, nr_prescricao_p bigint, nr_seq_prescr_p bigint) FROM PUBLIC;
