...
CREATE OR REPLACE FUNCTION obter_mascara_cid (cd_doenca_cid_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_mascara_cid (cd_doenca_cid_p text) FROM PUBLIC;
