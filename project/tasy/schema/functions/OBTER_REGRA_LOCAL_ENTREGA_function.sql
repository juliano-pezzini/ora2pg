...
CREATE OR REPLACE FUNCTION obter_regra_local_entrega ( cd_estabelecimento_p bigint, cd_material_p bigint, ie_regra_p text, ie_tipo_ordem_p text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_regra_local_entrega ( cd_estabelecimento_p bigint, cd_material_p bigint, ie_regra_p text, ie_tipo_ordem_p text) FROM PUBLIC;
