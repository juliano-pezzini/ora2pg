...
CREATE OR REPLACE FUNCTION hsl_quebra_linha_etiqueta ( ds_texto_p text, linha_p bigint, qt_caracter_linha_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hsl_quebra_linha_etiqueta ( ds_texto_p text, linha_p bigint, qt_caracter_linha_p bigint) FROM PUBLIC;
