...
CREATE OR REPLACE FUNCTION search_names_dev ( nm_filter_p text, cd_person_filter_p text, nr_person_name_p bigint, ds_type_name_p text DEFAULT NULL, ds_filter_name_p text DEFAULT NULL, establishment_p estabelecimento.cd_estabelecimento%TYPE DEFAULT NULL, exact_match_p text DEFAULT NULL) RETURNS SETOF PERSON_NAME_DEV_TABLE AS $body$
DECLARE
    ...
    SELECT
        ...
        END
    FROM
        TABLE( pkg_name_utils.search_names(nm_filter_p, ds_filter_name_w, exact_match_p) )         a,
        pessoa_fisica                                                                               b
    WHERE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION search_names_dev ( nm_filter_p text, cd_person_filter_p text, nr_person_name_p bigint, ds_type_name_p text DEFAULT NULL, ds_filter_name_p text DEFAULT NULL, establishment_p estabelecimento.cd_estabelecimento%TYPE DEFAULT NULL, exact_match_p text DEFAULT NULL) FROM PUBLIC;
