...
CREATE OR REPLACE FUNCTION get_nm_department_wpb ( nr_atendimento_p atendimento_paciente.nr_atendimento%type, ie_department_short_p char) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION get_nm_department_wpb ( nr_atendimento_p atendimento_paciente.nr_atendimento%type, ie_department_short_p char) FROM PUBLIC;
