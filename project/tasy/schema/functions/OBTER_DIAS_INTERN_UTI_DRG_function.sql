...
CREATE OR REPLACE FUNCTION obter_dias_intern_uti_drg ( nr_atendimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dias_intern_uti_drg ( nr_atendimento_p bigint) FROM PUBLIC;
