...
CREATE OR REPLACE FUNCTION pls_obter_med_grau_part_exec ( nr_seq_item_p pls_conta_proc.nr_sequencia%type, ie_mat_proc_p text, ie_tipo_p text) RETURNS varchar AS $body$
DECLARE

/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade: Obter o código do médico executor da conta ou o grau de participação do mesmo.

ie_tipo_p
'M' = Médico
'G' = 'Grau de participação'
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_med_grau_part_exec ( nr_seq_item_p pls_conta_proc.nr_sequencia%type, ie_mat_proc_p text, ie_tipo_p text) FROM PUBLIC;
