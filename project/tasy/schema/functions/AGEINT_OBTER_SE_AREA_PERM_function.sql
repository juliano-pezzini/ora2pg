...
CREATE OR REPLACE FUNCTION ageint_obter_se_area_perm ( nr_seq_area_p bigint, cd_perfil_p bigint, cd_pessoa_Fisica_p text, cd_setor_atendimento_p bigint, cd_estabelecimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ageint_obter_se_area_perm ( nr_seq_area_p bigint, cd_perfil_p bigint, cd_pessoa_Fisica_p text, cd_setor_atendimento_p bigint, cd_estabelecimento_p bigint) FROM PUBLIC;
