...
CREATE OR REPLACE FUNCTION obter_se_contido_char_v2 (qt_valor_p text, ds_possib_p text) RETURNS varchar AS $body$
DECLARE
...
/*******OBSERVAR QUE O DS_POSSIB_P deve ter o formato (9,4,3) que é gerado pelo sistema de relatórios */

ds_possib_w			varchar(32000);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_contido_char_v2 (qt_valor_p text, ds_possib_p text) FROM PUBLIC;
