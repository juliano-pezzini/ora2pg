...
CREATE OR REPLACE FUNCTION obter_dias_ct_proj ( IE_TAMANHO_P text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_dias_ct_proj ( IE_TAMANHO_P text) FROM PUBLIC;
