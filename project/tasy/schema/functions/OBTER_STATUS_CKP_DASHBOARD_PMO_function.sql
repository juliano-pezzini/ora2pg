...
CREATE OR REPLACE FUNCTION obter_status_ckp_dashboard_pmo (ie_tipo_p text, nr_sequencia_p bigint) RETURNS bigint AS $body$
DECLARE


/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:  Obter status geral de checkpoints de um portifolio/ programa/ projeto conforme o parametro ie_tipo_p
---------------------------------------------------------------------------------------------------------------------------------------------
...
Retornos:     2 = AZUL - todos os checkpoints do projeto foram concluídos
		1  = VERDE - todos os checkpoints previstos para estarem concluídos até o momento, foram concluídos
	         4. = VERMELHO - o total de checkpoint concluído até o momento é menor do que o previsto
...
if ie_tipo_p = 'PJ' then
	--Obtem se algum checkpoint não está concluído
    ...
    --Obtem se todos os checkpoints previstos para estarem concluídos até o momento, foram concluídos
    select  count(e.nr_sequencia)
...
if (ie_ckp_concluidos_w = 0) then
    -- 2- Todos Chks concluídos     Cor: Azul
	return 2;
else if (qt_concluido_w < qt_previsto_w) then
	-- 4 - Todos Chks concluídos menor que o previsto    Cor: Vermelho
	return 4;
else
  -- 1- todos os checkpoints previstos para estarem concluídos até o momento, foram concluídoss   Cor: Verde
  return 1;
end if;
end if;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_status_ckp_dashboard_pmo (ie_tipo_p text, nr_sequencia_p bigint) FROM PUBLIC;
