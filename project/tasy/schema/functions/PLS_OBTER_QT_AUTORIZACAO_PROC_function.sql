...
CREATE OR REPLACE FUNCTION pls_obter_qt_autorizacao_proc ( nr_seq_segurado_p bigint, nr_seq_limitacao_p bigint, cd_procedimento_p bigint, ie_periodo_p text, ie_tipo_periodo_p text, ie_origem_proced_p bigint) RETURNS bigint AS $body$
DECLARE
...
dt_final_w	:= trunc(dt_final_w,'dd') + 86399/86400;

select	coalesce(sum(c.qt_autorizada),0)
into STRICT	qt_retorno_w
from	pls_guia_plano_proc	c,
	pls_guia_plano		b,
	pls_segurado		a
where	a.nr_sequencia = b.nr_seq_segurado
and	b.nr_sequencia = c.nr_seq_guia
and	b.dt_autorizacao between dt_inicial_w and dt_final_w
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_qt_autorizacao_proc ( nr_seq_segurado_p bigint, nr_seq_limitacao_p bigint, cd_procedimento_p bigint, ie_periodo_p text, ie_tipo_periodo_p text, ie_origem_proced_p bigint) FROM PUBLIC;
