...
CREATE OR REPLACE FUNCTION suep_obter_se_lab_ref (nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, nr_seq_material_p bigint, ds_resultado_p text, qt_resultado_p bigint, pr_resultado_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION suep_obter_se_lab_ref (nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, nr_seq_material_p bigint, ds_resultado_p text, qt_resultado_p bigint, pr_resultado_p bigint) FROM PUBLIC;
