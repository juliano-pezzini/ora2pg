...
CREATE OR REPLACE FUNCTION obter_seq_valor_301 (nm_tabela_301_p text, nm_campo_chave_p text, ds_campo_p text) RETURNS varchar AS $body$
DECLARE
...
if (nm_tabela_301_p IS NOT NULL AND nm_tabela_301_p::text <> '') and (nm_campo_chave_p IS NOT NULL AND nm_campo_chave_p::text <> '') then
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_seq_valor_301 (nm_tabela_301_p text, nm_campo_chave_p text, ds_campo_p text) FROM PUBLIC;
