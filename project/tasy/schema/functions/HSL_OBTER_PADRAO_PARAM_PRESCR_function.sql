...
CREATE OR REPLACE FUNCTION hsl_obter_padrao_param_prescr ( cd_material_p bigint, ie_via_aplicacao_p text, cd_setor_atendimento_p bigint, cd_pessoa_fisica_p text, qt_idade_p bigint, qt_peso_p bigint, ie_se_necessario_p text, ie_opcao_p text, cd_intervalo_p text default null, cd_estabelecimento_p bigint default null) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hsl_obter_padrao_param_prescr ( cd_material_p bigint, ie_via_aplicacao_p text, cd_setor_atendimento_p bigint, cd_pessoa_fisica_p text, qt_idade_p bigint, qt_peso_p bigint, ie_se_necessario_p text, ie_opcao_p text, cd_intervalo_p text default null, cd_estabelecimento_p bigint default null) FROM PUBLIC;
