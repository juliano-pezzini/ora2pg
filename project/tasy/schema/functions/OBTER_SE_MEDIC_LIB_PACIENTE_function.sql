...
CREATE OR REPLACE FUNCTION obter_se_medic_lib_paciente ( cd_pessoa_fisica_p text, cd_material_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_medic_lib_paciente ( cd_pessoa_fisica_p text, cd_material_p bigint) FROM PUBLIC;
