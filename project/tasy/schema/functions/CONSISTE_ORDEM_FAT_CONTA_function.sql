...
CREATE OR REPLACE FUNCTION consiste_ordem_fat_conta (nr_interno_conta_p conta_paciente.nr_interno_conta%type) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION consiste_ordem_fat_conta (nr_interno_conta_p conta_paciente.nr_interno_conta%type) FROM PUBLIC;
