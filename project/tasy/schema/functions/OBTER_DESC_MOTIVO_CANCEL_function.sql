...
CREATE OR REPLACE FUNCTION obter_desc_motivo_cancel ( nr_seq_motivo_p bigint) RETURNS varchar AS $body$
DECLARE



ds_motivo_cancelamento_w	varchar(80);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_motivo_cancel ( nr_seq_motivo_p bigint) FROM PUBLIC;
