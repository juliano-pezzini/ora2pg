...
CREATE OR REPLACE FUNCTION obter_kit_proced ( nr_atendimento_p bigint, nr_seq_proc_interno_p bigint, cd_setor_atendimento_p bigint, cd_estabelecimento_p bigint, cd_medico_p text, cd_convenio_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_kit_proced ( nr_atendimento_p bigint, nr_seq_proc_interno_p bigint, cd_setor_atendimento_p bigint, cd_estabelecimento_p bigint, cd_medico_p text, cd_convenio_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint) FROM PUBLIC;
