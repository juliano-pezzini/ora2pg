...
CREATE OR REPLACE FUNCTION obter_porte_proc_cirurgia (nr_cirurgia_p bigint, nr_seq_agenda_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_porte_proc_cirurgia (nr_cirurgia_p bigint, nr_seq_agenda_p bigint) FROM PUBLIC;
