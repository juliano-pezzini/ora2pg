...
CREATE OR REPLACE FUNCTION obter_mot_canc_atend (nr_atendimento_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_mot_canc_atend (nr_atendimento_p bigint) FROM PUBLIC;
