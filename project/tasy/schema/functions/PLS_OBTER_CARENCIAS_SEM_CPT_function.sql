...
CREATE OR REPLACE FUNCTION pls_obter_carencias_sem_cpt ( nr_seq_segurado_p bigint, nr_seq_contrato_p bigint, nr_seq_plano_p bigint, ie_opcao_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_carencias_sem_cpt ( nr_seq_segurado_p bigint, nr_seq_contrato_p bigint, nr_seq_plano_p bigint, ie_opcao_p bigint) FROM PUBLIC;
