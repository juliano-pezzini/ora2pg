...
CREATE OR REPLACE FUNCTION obter_se_lote_desdobrado (cd_material_p bigint, cd_estabelecimento_p bigint) RETURNS varchar AS $body$
DECLARE


ie_desdobrado_w			varchar(1) := 'N';
nr_regras_w			integer;
...
return coalesce(ie_desdobrado_w, 'N');
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_lote_desdobrado (cd_material_p bigint, cd_estabelecimento_p bigint) FROM PUBLIC;
