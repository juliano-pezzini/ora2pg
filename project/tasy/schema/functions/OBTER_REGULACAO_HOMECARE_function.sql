...
CREATE OR REPLACE FUNCTION obter_regulacao_homecare ( ie_classificacao_p text, ie_tipo_regra_p text, ie_grupo_p text default 'N') RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_regulacao_homecare ( ie_classificacao_p text, ie_tipo_regra_p text, ie_grupo_p text default 'N') FROM PUBLIC;
