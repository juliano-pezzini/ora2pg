...
CREATE OR REPLACE FUNCTION obter_se_contido_char (qt_valor_p text, ds_possib_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 IMMUTABLE;
-- REVOKE ALL ON FUNCTION obter_se_contido_char (qt_valor_p text, ds_possib_p text) FROM PUBLIC;
