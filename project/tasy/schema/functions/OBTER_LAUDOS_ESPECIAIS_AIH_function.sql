...
CREATE OR REPLACE FUNCTION obter_laudos_especiais_aih ( nr_atendimento_p bigint, ie_laudo_p bigint, ie_tipo_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_laudos_especiais_aih ( nr_atendimento_p bigint, ie_laudo_p bigint, ie_tipo_p bigint) FROM PUBLIC;
