...
CREATE OR REPLACE FUNCTION obter_medida_referencia_laudo (nr_seq_laudo_med_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_medida_referencia_laudo (nr_seq_laudo_med_p bigint) FROM PUBLIC;
