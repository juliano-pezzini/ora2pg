...
CREATE OR REPLACE FUNCTION obter_se_rediluente ( nr_prescricao_p bigint, nr_sequencia_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_rediluente ( nr_prescricao_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
