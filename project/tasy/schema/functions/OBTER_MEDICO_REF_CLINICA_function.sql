...
CREATE OR REPLACE FUNCTION obter_medico_ref_clinica (ie_clinica_p bigint default 0, ie_tipo_atendimento_p bigint default 0, cd_pessoa_fisica_p text default null) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_medico_ref_clinica (ie_clinica_p bigint default 0, ie_tipo_atendimento_p bigint default 0, cd_pessoa_fisica_p text default null) FROM PUBLIC;
