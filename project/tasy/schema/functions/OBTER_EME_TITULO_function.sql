...
CREATE OR REPLACE FUNCTION obter_eme_titulo (nr_seq_contrato_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_eme_titulo (nr_seq_contrato_p bigint) FROM PUBLIC;
