...
CREATE OR REPLACE FUNCTION obter_spa_titulo (nr_seq_spa_p bigint, nr_titulo_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_spa_titulo (nr_seq_spa_p bigint, nr_titulo_p bigint) FROM PUBLIC;
