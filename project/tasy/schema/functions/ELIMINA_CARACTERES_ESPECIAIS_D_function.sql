...
CREATE OR REPLACE FUNCTION elimina_caracteres_especiais_d ( ds_valor_p text, ds_carac_esp_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION elimina_caracteres_especiais_d ( ds_valor_p text, ds_carac_esp_p text) FROM PUBLIC;
