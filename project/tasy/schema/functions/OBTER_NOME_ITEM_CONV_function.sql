...
CREATE OR REPLACE FUNCTION obter_nome_item_conv ( cd_convenio_p bigint, ie_tipo_item_p bigint, cd_item_p bigint, ie_origem_proced_p bigint, ie_estrutura_completa_p text, cd_especialidade_med_p bigint, cd_medico_p text, ie_tipo_atendimento_p bigint, nr_atendimento_p bigint) RETURNS varchar AS $body$
DECLARE
...
C01 CURSOR FOR
	SELECT	coalesce(ds_proc_convenio,ds_item_w)
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_nome_item_conv ( cd_convenio_p bigint, ie_tipo_item_p bigint, cd_item_p bigint, ie_origem_proced_p bigint, ie_estrutura_completa_p text, cd_especialidade_med_p bigint, cd_medico_p text, ie_tipo_atendimento_p bigint, nr_atendimento_p bigint) FROM PUBLIC;
