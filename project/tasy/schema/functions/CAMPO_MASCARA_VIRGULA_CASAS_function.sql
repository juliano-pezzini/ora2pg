...
CREATE OR REPLACE FUNCTION campo_mascara_virgula_casas ( vl_campo_p bigint, qt_decimais_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION campo_mascara_virgula_casas ( vl_campo_p bigint, qt_decimais_p bigint) FROM PUBLIC;
