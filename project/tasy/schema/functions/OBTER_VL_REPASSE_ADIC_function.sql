...
CREATE OR REPLACE FUNCTION obter_vl_repasse_adic ( nr_seq_criterio_p bigint, nr_seq_proc_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_vl_repasse_adic ( nr_seq_criterio_p bigint, nr_seq_proc_p bigint) FROM PUBLIC;
