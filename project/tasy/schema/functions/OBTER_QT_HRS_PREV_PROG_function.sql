...
CREATE OR REPLACE FUNCTION obter_qt_hrs_prev_prog ( nr_seq_prog_p bigint, dt_ref_p timestamp ) RETURNS bigint AS $body$
DECLARE
...
/*Se o valor está nulo, provalvemente é pq o programa começou antes da data prevista. Neste caso, retorna o valor total de horas previstas do cronograma*/
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qt_hrs_prev_prog ( nr_seq_prog_p bigint, dt_ref_p timestamp ) FROM PUBLIC;
