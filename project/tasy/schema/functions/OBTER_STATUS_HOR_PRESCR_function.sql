...
CREATE OR REPLACE FUNCTION obter_status_hor_prescr (nr_seq_horario_p bigint, ie_tipo_item_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_status_hor_prescr (nr_seq_horario_p bigint, ie_tipo_item_p text) FROM PUBLIC;
