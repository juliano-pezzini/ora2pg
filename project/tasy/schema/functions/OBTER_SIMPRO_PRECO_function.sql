...
CREATE OR REPLACE FUNCTION obter_simpro_preco ( cd_material_p bigint, tx_pfb_p bigint, tx_pcm_p bigint, dt_vigencia_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_simpro_preco ( cd_material_p bigint, tx_pfb_p bigint, tx_pcm_p bigint, dt_vigencia_p timestamp) FROM PUBLIC;
