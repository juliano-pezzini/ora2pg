...
CREATE OR REPLACE FUNCTION obter_se_mat_lib_profissional ( cd_pessoa_fisica_p text, cd_material_p bigint, ie_entrega_retira_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_mat_lib_profissional ( cd_pessoa_fisica_p text, cd_material_p bigint, ie_entrega_retira_p text) FROM PUBLIC;
