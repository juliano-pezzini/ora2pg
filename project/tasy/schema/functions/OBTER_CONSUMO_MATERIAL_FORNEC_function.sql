...
CREATE OR REPLACE FUNCTION obter_consumo_material_fornec ( ie_tipo_p text, cd_estabelecimento_p bigint, cd_material_p bigint, cd_fornecedor_p text, dt_inicial_p timestamp, dt_final_p timestamp) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_consumo_material_fornec ( ie_tipo_p text, cd_estabelecimento_p bigint, cd_material_p bigint, cd_fornecedor_p text, dt_inicial_p timestamp, dt_final_p timestamp) FROM PUBLIC;
