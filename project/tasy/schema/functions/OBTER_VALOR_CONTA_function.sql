...
CREATE OR REPLACE FUNCTION obter_valor_conta ( nr_interno_conta_p bigint, ie_valor_p integer) RETURNS bigint AS $body$
DECLARE
...
/* Felipe - 17/08/2007 - OS - 65674 - Existem convênios do tipo SUS que deve ter o valor baseado no calculo SUS */
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_conta ( nr_interno_conta_p bigint, ie_valor_p integer) FROM PUBLIC;
