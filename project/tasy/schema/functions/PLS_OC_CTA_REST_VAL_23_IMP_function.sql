...
CREATE OR REPLACE FUNCTION pls_oc_cta_rest_val_23_imp ( dados_validacao_p pls_ocor_imp_pck.dados_regra_val_util_item, dados_conta_proc_p pls_ocor_imp_pck.dados_conta_proc, nr_seq_selecao_p pls_oc_cta_selecao_ocor_v.nr_sequencia%type, bind_sql_valor_p INOUT sql_pck.t_dado_bind) AS $body$
DECLARE
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
retorno_w	pls_ocor_imp_pck.dados_restricao_select;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_oc_cta_rest_val_23_imp ( dados_validacao_p pls_ocor_imp_pck.dados_regra_val_util_item, dados_conta_proc_p pls_ocor_imp_pck.dados_conta_proc, nr_seq_selecao_p pls_oc_cta_selecao_ocor_v.nr_sequencia%type, bind_sql_valor_p INOUT sql_pck.t_dado_bind) FROM PUBLIC;
