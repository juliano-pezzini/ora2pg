...
CREATE OR REPLACE FUNCTION cpoe_obter_dt_suspensao (nr_sequencia_p bigint, ie_tipo_item_p text) RETURNS timestamp AS $body$
DECLARE
...
return	coalesce(dt_suspensao_w,null);
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cpoe_obter_dt_suspensao (nr_sequencia_p bigint, ie_tipo_item_p text) FROM PUBLIC;
