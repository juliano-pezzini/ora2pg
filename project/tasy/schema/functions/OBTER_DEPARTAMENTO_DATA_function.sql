...
CREATE OR REPLACE FUNCTION obter_departamento_data ( nr_atendimento_p bigint, dt_referencia_p timestamp default clock_timestamp()) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_departamento_data ( nr_atendimento_p bigint, dt_referencia_p timestamp default clock_timestamp()) FROM PUBLIC;
