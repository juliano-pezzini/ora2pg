...
CREATE OR REPLACE FUNCTION pfcs_ofuse_checksum ( cd_key_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pfcs_ofuse_checksum ( cd_key_p text) FROM PUBLIC;
