...
CREATE OR REPLACE FUNCTION sus_obter_proced_adic ( nr_seq_interno_p bigint, ie_laudo_p bigint, ie_tipo_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION sus_obter_proced_adic ( nr_seq_interno_p bigint, ie_laudo_p bigint, ie_tipo_p bigint) FROM PUBLIC;
