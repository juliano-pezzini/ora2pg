...
CREATE OR REPLACE FUNCTION ca_obter_vmp (nr_seq_exame_p bigint, nr_seq_analise_p bigint) RETURNS bigint AS $body$
DECLARE


ie_local_analise_w	varchar(1);
vl_vmp_w			double precision;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ca_obter_vmp (nr_seq_exame_p bigint, nr_seq_analise_p bigint) FROM PUBLIC;
