...
CREATE OR REPLACE FUNCTION get_equipment_acronym_return (nr_seq_return_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION get_equipment_acronym_return (nr_seq_return_p bigint) FROM PUBLIC;
