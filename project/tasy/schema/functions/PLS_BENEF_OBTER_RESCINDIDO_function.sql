...
CREATE OR REPLACE FUNCTION pls_benef_obter_rescindido ( nr_seq_contrato_p bigint, nr_seq_pagador_p bigint, ie_tipo_p bigint) RETURNS bigint AS $body$
DECLARE
...
*/
qt_conta_w			bigint	:= 0;
vl_rescisao_w			double precision	:= 0;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_benef_obter_rescindido ( nr_seq_contrato_p bigint, nr_seq_pagador_p bigint, ie_tipo_p bigint) FROM PUBLIC;
