...
CREATE OR REPLACE FUNCTION med_obter_resultados_validos (nr_seq_exame_p bigint, nr_seq_cliente_p bigint) RETURNS varchar AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	select	coalesce(max(med_obter_se_result_valido(nr_seq_cliente_p, nr_seq_exame_p, dt_exame_w)), 'N')
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION med_obter_resultados_validos (nr_seq_exame_p bigint, nr_seq_cliente_p bigint) FROM PUBLIC;
