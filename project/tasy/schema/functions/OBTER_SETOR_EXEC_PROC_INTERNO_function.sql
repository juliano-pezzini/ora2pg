...
CREATE OR REPLACE FUNCTION obter_setor_exec_proc_interno ( nr_seq_proc_interno_p bigint, cd_setor_origem_p bigint, ie_tipo_atendimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, ie_proced_principal_p text default 'S') RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_setor_exec_proc_interno ( nr_seq_proc_interno_p bigint, cd_setor_origem_p bigint, ie_tipo_atendimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, ie_proced_principal_p text default 'S') FROM PUBLIC;
