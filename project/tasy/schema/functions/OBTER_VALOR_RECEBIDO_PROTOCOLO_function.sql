...
CREATE OR REPLACE FUNCTION obter_valor_recebido_protocolo (nr_seq_protocolo_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_valor_recebido_protocolo (nr_seq_protocolo_p bigint) FROM PUBLIC;
