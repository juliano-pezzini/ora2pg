...
CREATE OR REPLACE FUNCTION obter_se_proc_grupo_lib (nr_seq_grupo_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_se_proc_grupo_lib (nr_seq_grupo_p bigint) FROM PUBLIC;
