...
CREATE OR REPLACE FUNCTION obter_saldo_estoque_solic_req ( nr_requisicao_p bigint, nr_sequencia_p bigint) RETURNS bigint AS $body$
DECLARE
...
select	a.cd_estabelecimento, 
	...
	b.cd_material, 
	b.cd_cgc_fornecedor, 
	PKG_DATE_UTILS.start_of(a.dt_solicitacao_requisicao, 'month', 0) 
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_saldo_estoque_solic_req ( nr_requisicao_p bigint, nr_sequencia_p bigint) FROM PUBLIC;
