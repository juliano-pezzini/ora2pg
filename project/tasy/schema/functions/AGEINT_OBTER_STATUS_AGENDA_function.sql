...
CREATE OR REPLACE FUNCTION ageint_obter_status_agenda ( nr_seq_agenda_cons_p bigint, nr_seq_agenda_exame_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ageint_obter_status_agenda ( nr_seq_agenda_cons_p bigint, nr_seq_agenda_exame_p bigint) FROM PUBLIC;
