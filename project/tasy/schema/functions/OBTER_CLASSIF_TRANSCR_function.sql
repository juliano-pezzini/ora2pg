...
CREATE OR REPLACE FUNCTION obter_classif_transcr (nr_seq_classif_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_classif_transcr (nr_seq_classif_p bigint) FROM PUBLIC;
