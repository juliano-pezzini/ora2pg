...
CREATE OR REPLACE FUNCTION obter_qt_erro_total_cal_escala ( nr_sequencia_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_qt_erro_total_cal_escala ( nr_sequencia_p bigint) FROM PUBLIC;
