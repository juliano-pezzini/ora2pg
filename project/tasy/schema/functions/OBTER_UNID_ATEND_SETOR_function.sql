...
CREATE OR REPLACE FUNCTION obter_unid_atend_setor ( nr_atendimento_p bigint, cd_setor_atendimento_p bigint, ie_informacao_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_unid_atend_setor ( nr_atendimento_p bigint, cd_setor_atendimento_p bigint, ie_informacao_p text) FROM PUBLIC;
