...
CREATE OR REPLACE FUNCTION eis_obter_nfe_conta_protocolo (nr_seq_protocolo_p bigint, nr_interno_conta_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION eis_obter_nfe_conta_protocolo (nr_seq_protocolo_p bigint, nr_interno_conta_p bigint) FROM PUBLIC;
