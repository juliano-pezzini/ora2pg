...
CREATE OR REPLACE FUNCTION obter_desc_intervalo ( cd_intervalo_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_desc_intervalo ( cd_intervalo_p text) FROM PUBLIC;
