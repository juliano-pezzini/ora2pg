...
CREATE OR REPLACE FUNCTION pls_obter_se_benef_liminar ( nr_seq_requisicao_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_se_benef_liminar ( nr_seq_requisicao_p bigint) FROM PUBLIC;
