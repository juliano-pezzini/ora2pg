...
CREATE OR REPLACE FUNCTION obter_data_resultado_regra (nr_seq_prescricao_p bigint, nr_prescricao_p bigint) RETURNS timestamp AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_data_resultado_regra (nr_seq_prescricao_p bigint, nr_prescricao_p bigint) FROM PUBLIC;
