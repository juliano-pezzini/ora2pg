...
c01 CURSOR FOR
	...
	and (y.nr_seq_material = coalesce(nr_seq_material_w, y.nr_seq_material) or (c.cd_material_exame = cd_material_p and d.ie_prioridade = 888))
	...
	--	(c.cd_material_exame	= cd_material_p and d.ie_prioridade = 888))
	  ...
	  and ((a.nr_seq_lab = coalesce(NR_SEQ_LAB_P,a.nr_seq_lab)) or (ie_padrao_amostra_w in ('PM','PM11','PMR11','PM13')))
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_exam_lab_integr_mat_ind ( nr_prescricao_p bigint, cd_setor_atendimento_p bigint, cd_material_p text, nr_seq_grupo_p bigint, ie_equipamento_p text, ie_opcao_p text, ie_separador_p text, nr_seq_GRUPO_IMP_P bigint, NR_SEQ_LAB_P text, ie_status_envio_p bigint, ds_sigla_p text, nr_seq_apresent_p bigint, nr_seq_lote_externo_p bigint) FROM PUBLIC;
