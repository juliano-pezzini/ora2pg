...
CREATE OR REPLACE FUNCTION obter_movto_banco_pend_orig ( nr_seq_movto_trans_financ_p bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_movto_banco_pend_orig ( nr_seq_movto_trans_financ_p bigint) FROM PUBLIC;
