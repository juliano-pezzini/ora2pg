...
CREATE OR REPLACE FUNCTION obter_turno_ocorrencia ( dt_evento_p timestamp, cd_estabelecimento_p bigint, ie_opcao_p text, ie_opcao_local_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_turno_ocorrencia ( dt_evento_p timestamp, cd_estabelecimento_p bigint, ie_opcao_p text, ie_opcao_local_p text) FROM PUBLIC;
