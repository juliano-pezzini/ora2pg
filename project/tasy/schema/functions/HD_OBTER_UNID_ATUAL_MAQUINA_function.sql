...
CREATE OR REPLACE FUNCTION hd_obter_unid_atual_maquina ( nr_seq_maquina_p bigint, ie_tipo_p text) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION hd_obter_unid_atual_maquina ( nr_seq_maquina_p bigint, ie_tipo_p text) FROM PUBLIC;
