...
CREATE OR REPLACE FUNCTION ehr_escala_risco_cardio_cirurg ( nr_seq_reg_elemento_p bigint, nr_seq_entidade_p bigint, nr_seq_elemento_p bigint) RETURNS varchar AS $body$
DECLARE
...
c01 CURSOR FOR
SELECT	nr_sequencia
from	escala_risco_cardio_cirurg
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ehr_escala_risco_cardio_cirurg ( nr_seq_reg_elemento_p bigint, nr_seq_entidade_p bigint, nr_seq_elemento_p bigint) FROM PUBLIC;
