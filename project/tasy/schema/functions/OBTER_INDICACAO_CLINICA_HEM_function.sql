...
CREATE OR REPLACE FUNCTION obter_indicacao_clinica_hem (nr_seq_indicacao_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_indicacao_clinica_hem (nr_seq_indicacao_p bigint) FROM PUBLIC;
