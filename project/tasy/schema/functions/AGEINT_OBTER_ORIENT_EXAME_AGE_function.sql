...
CREATE OR REPLACE FUNCTION ageint_obter_orient_exame_age (cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_convenio_p bigint, nr_seq_proc_interno_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, cd_funcao_p bigint) RETURNS varchar AS $body$
DECLARE


ds_orientacao_w	varchar(10000) := '';
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION ageint_obter_orient_exame_age (cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_convenio_p bigint, nr_seq_proc_interno_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, cd_funcao_p bigint) FROM PUBLIC;
