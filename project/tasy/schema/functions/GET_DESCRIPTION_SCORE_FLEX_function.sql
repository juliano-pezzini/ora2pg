...
CREATE OR REPLACE FUNCTION get_description_score_flex ( nr_sequencia_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION get_description_score_flex ( nr_sequencia_p bigint) FROM PUBLIC;
