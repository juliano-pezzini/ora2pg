...
CREATE OR REPLACE FUNCTION pls_obter_proc_mat_msg_ext_req ( nr_seq_requisicao_p bigint, nr_seq_guia_proc_p bigint, nr_seq_guia_mat_p bigint) RETURNS varchar AS $body$
DECLARE
...
C01 CURSOR FOR
	...
	from	pls_requisicao_glosa_ocorr_v a,
		pls_requisicao b
	where	a.nr_seq_requisicao		= coalesce(nr_seq_requisicao_w,nr_seq_requisicao_p)
...
C02 CURSOR FOR
	...
	where	a.nr_seq_proc		= coalesce(nr_seq_req_proc_w,nr_seq_guia_proc_p)
...
C03 CURSOR FOR
	...
	where	a.nr_seq_mat		= coalesce(nr_seq_req_mat_w,nr_seq_guia_mat_p)
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION pls_obter_proc_mat_msg_ext_req ( nr_seq_requisicao_p bigint, nr_seq_guia_proc_p bigint, nr_seq_guia_mat_p bigint) FROM PUBLIC;
