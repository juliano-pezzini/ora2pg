...
CREATE OR REPLACE FUNCTION obter_titulo_pendente_atend (nr_atendimento_p bigint, nr_interno_conta_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_titulo_pendente_atend (nr_atendimento_p bigint, nr_interno_conta_p bigint) FROM PUBLIC;
