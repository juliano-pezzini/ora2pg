...
CREATE OR REPLACE FUNCTION cpoe_obter_regra_padrao ( cd_material_p bigint, cd_perfil_p bigint, nm_usuario_p text, ie_via_aplicacao_p text, ie_se_necessario_p text, cd_estabelecimento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text DEFAULT NULL, cd_intervalo_p text DEFAULT NULL, qt_dose_medic_p bigint DEFAULT NULL, cd_unidade_medida_dose_p text DEFAULT NULL, ie_retorno_campo_p bigint  DEFAULT NULL) RETURNS bigint AS $body$
DECLARE
...
/*
    ESTA FUNCTION ESTA SENDO DEPRECIADA, A PARTIR DA VERSAO 3.07.1814 SE USA A PROCEDURE CPOE_OBTER_REGRA_PADRAO_PRESCR
*/
        ...
        BEGIN
            IF ( ie_retorno_campo_p = 1 ) THEN
                ...
                /* Fim MD1 */
                    ...
                    RETURN qt_hora_min_aplicacao_w;
                END IF;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cpoe_obter_regra_padrao ( cd_material_p bigint, cd_perfil_p bigint, nm_usuario_p text, ie_via_aplicacao_p text, ie_se_necessario_p text, cd_estabelecimento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text DEFAULT NULL, cd_intervalo_p text DEFAULT NULL, qt_dose_medic_p bigint DEFAULT NULL, cd_unidade_medida_dose_p text DEFAULT NULL, ie_retorno_campo_p bigint  DEFAULT NULL) FROM PUBLIC;
