...
CREATE OR REPLACE FUNCTION cus_obter_se_ng_taxa ( cd_estabelecimento_p bigint, nr_seq_gng_p bigint, nr_seq_ng_p bigint, cd_centro_controle_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION cus_obter_se_ng_taxa ( cd_estabelecimento_p bigint, nr_seq_gng_p bigint, nr_seq_ng_p bigint, cd_centro_controle_p bigint) FROM PUBLIC;
