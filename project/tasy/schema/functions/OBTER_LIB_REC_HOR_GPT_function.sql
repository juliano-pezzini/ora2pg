...
CREATE OR REPLACE FUNCTION obter_lib_rec_hor_gpt ( ie_tipo_usuario_p text, nm_tabela_p text, nr_seq_item_p bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION obter_lib_rec_hor_gpt ( ie_tipo_usuario_p text, nm_tabela_p text, nr_seq_item_p bigint) FROM PUBLIC;
