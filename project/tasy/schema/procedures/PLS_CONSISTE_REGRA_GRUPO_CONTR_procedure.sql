...
CREATE OR REPLACE PROCEDURE pls_consiste_regra_grupo_contr ( nr_seq_regra_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_consiste_regra_grupo_contr ( nr_seq_regra_p bigint, nm_usuario_p text) FROM PUBLIC;
