...
CREATE OR REPLACE PROCEDURE baca_dt_vig_regra_simpro_preco () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_regra_simpro_preco () FROM PUBLIC;
