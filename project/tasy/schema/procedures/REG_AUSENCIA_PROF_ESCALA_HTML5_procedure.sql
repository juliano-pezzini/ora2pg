...
CREATE OR REPLACE PROCEDURE reg_ausencia_prof_escala_html5 (cd_profissional_p text, dt_inicio_p timestamp, dt_fim_p timestamp, cd_motivo_afast_p text, cd_substituto_p text, cd_escala_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE reg_ausencia_prof_escala_html5 (cd_profissional_p text, dt_inicio_p timestamp, dt_fim_p timestamp, cd_motivo_afast_p text, cd_substituto_p text, cd_escala_p bigint, nm_usuario_p text) FROM PUBLIC;
