...
CREATE OR REPLACE PROCEDURE consistir_regra_wbarras ( nr_seq_regra_p bigint, cd_material_p bigint, qt_material_p bigint, ds_mensagem_p INOUT text, ie_regra_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE consistir_regra_wbarras ( nr_seq_regra_p bigint, cd_material_p bigint, qt_material_p bigint, ds_mensagem_p INOUT text, ie_regra_p INOUT text) FROM PUBLIC;
