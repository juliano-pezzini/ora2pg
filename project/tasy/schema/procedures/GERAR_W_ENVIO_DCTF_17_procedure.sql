...
CREATE OR REPLACE PROCEDURE gerar_w_envio_dctf_17 ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	select	rpad(ie_qualificacao_pj_w,2,0)
...
EXIT WHEN NOT FOUND; /* apply on c04 */
	...
	select	rpad(ie_qualificacao_pj_w,2,0) -- dsantos em 26/04/2010, OS200896
	into STRICT	ie_qualificacao_pj_w
	;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_envio_dctf_17 ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
