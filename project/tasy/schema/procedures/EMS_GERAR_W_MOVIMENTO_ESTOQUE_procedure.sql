...
CREATE OR REPLACE PROCEDURE ems_gerar_w_movimento_estoque ( qt_horas_p bigint, cd_estabelecimento_p bigint, --Informar '0' para considerar todos 
...
c01 CURSOR FOR 
	...
	where	dt_atualizacao between clock_timestamp() - (qt_horas_p/24) and clock_timestamp() 
	and (coalesce(cd_estabelecimento_p,0) = 0 or cd_estabelecimento_p = cd_estabelecimento) 
	--and	obter_se_integr_movto_estoque(a.nr_movimento_estoque) = 'S' 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ems_gerar_w_movimento_estoque ( qt_horas_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
