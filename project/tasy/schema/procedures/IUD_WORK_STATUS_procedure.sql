...
CREATE OR REPLACE PROCEDURE iud_work_status ( cd_pessoa_fisica_p pessoa_fisica.cd_pessoa_fisica%type, nm_usuario_p text, operation_type_p text, cd_work_status_p pessoa_fisica_aux.cd_work_status%type ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE iud_work_status ( cd_pessoa_fisica_p pessoa_fisica.cd_pessoa_fisica%type, nm_usuario_p text, operation_type_p text, cd_work_status_p pessoa_fisica_aux.cd_work_status%type ) FROM PUBLIC;
