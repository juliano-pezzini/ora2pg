...
CREATE OR REPLACE PROCEDURE atualizar_correcao_laudo (nr_laudo_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_correcao_laudo (nr_laudo_p bigint) FROM PUBLIC;
