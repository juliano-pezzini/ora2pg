...
CREATE OR REPLACE PROCEDURE pls_gerar_w_analise_pos_tit ( nr_seq_analise_p pls_analise_conta.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, nr_id_transacao_p w_pls_analise_item.nr_id_transacao%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_w_analise_pos_tit ( nr_seq_analise_p pls_analise_conta.nr_sequencia%type, nr_seq_conta_p pls_conta.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, nr_id_transacao_p w_pls_analise_item.nr_id_transacao%type) FROM PUBLIC;
