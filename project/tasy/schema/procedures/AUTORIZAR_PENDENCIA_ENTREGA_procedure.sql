...
CREATE OR REPLACE PROCEDURE autorizar_pendencia_entrega ( nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE autorizar_pendencia_entrega ( nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
