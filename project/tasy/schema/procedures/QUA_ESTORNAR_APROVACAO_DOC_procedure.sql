...
CREATE OR REPLACE PROCEDURE qua_estornar_aprovacao_doc ( nr_sequencia_p bigint, ie_status_p text, nm_usuario_p text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE qua_estornar_aprovacao_doc ( nr_sequencia_p bigint, ie_status_p text, nm_usuario_p text) FROM PUBLIC;
