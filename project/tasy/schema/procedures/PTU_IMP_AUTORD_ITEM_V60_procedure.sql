...
CREATE OR REPLACE PROCEDURE ptu_imp_autord_item_v60 ( nr_seq_item_p ptu_aut_ordem_serv_servico.nr_seq_item%type, ie_tipo_tabela_p ptu_aut_ordem_serv_servico.ie_tipo_tabela%type, cd_servico_p ptu_aut_ordem_serv_servico.cd_servico%type, ds_servico_p ptu_aut_ordem_serv_servico.ds_servico%type, ie_autorizado_p ptu_aut_ordem_serv_servico.ie_autorizado%type, nm_usuario_p ptu_aut_ordem_serv_servico.nm_usuario%type, qt_autorizado_p ptu_aut_ordem_serv_servico.qt_autorizado%type, nr_seq_aut_ord_serv_p ptu_aut_ordem_serv_servico.nr_seq_aut_ord_serv%type) AS $body$
DECLARE
...
insert into ptu_aut_ordem_serv_servico(nr_sequencia, ie_tipo_tabela, cd_servico,
	...
	ie_autorizado)
values (nextval('ptu_aut_ordem_serv_servico_seq'), ie_tipo_tabela_p, cd_servico_p,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_imp_autord_item_v60 ( nr_seq_item_p ptu_aut_ordem_serv_servico.nr_seq_item%type, ie_tipo_tabela_p ptu_aut_ordem_serv_servico.ie_tipo_tabela%type, cd_servico_p ptu_aut_ordem_serv_servico.cd_servico%type, ds_servico_p ptu_aut_ordem_serv_servico.ds_servico%type, ie_autorizado_p ptu_aut_ordem_serv_servico.ie_autorizado%type, nm_usuario_p ptu_aut_ordem_serv_servico.nm_usuario%type, qt_autorizado_p ptu_aut_ordem_serv_servico.qt_autorizado%type, nr_seq_aut_ord_serv_p ptu_aut_ordem_serv_servico.nr_seq_aut_ord_serv%type) FROM PUBLIC;
