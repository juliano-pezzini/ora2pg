...
CREATE OR REPLACE PROCEDURE gerar_analise_prod_migr_colab () AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	qt_hora_colab_w := coalesce(man_obter_tempo_ativ_usuario(nm_usuario_colab_w, clock_timestamp(), 'H'),0);	
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_analise_prod_migr_colab () FROM PUBLIC;
