...
CREATE OR REPLACE PROCEDURE pls_consistir_lote_mensalidade ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_consistir_lote_mensalidade ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
