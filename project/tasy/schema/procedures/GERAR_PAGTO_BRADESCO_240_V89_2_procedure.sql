...
CREATE OR REPLACE PROCEDURE gerar_pagto_bradesco_240_v89_2 ( nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') || -- 1 ate 3
			...
			'089' || -- 164 ate 166
			'01600' || --Densidade do arquivo: 6250 BPI (Nota G020)
			rpad(' ',69,' ');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pagto_bradesco_240_v89_2 ( nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
