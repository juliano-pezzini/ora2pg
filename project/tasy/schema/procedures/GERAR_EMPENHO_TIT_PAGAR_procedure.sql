...
CREATE OR REPLACE PROCEDURE gerar_empenho_tit_pagar (nr_titulo_p text, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	CALL ctb_registrar_doc_empenho(cd_estabelecimento_w, trunc(dt_emissao_w,'mm'), null, null, null, nr_titulo_p, null,
					vet01.cd_centro_custo, vet01.cd_conta_contabil, vet01.vl_titulo, 'N','I',nm_usuario_p);
	end;
end loop;
close C01;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_empenho_tit_pagar (nr_titulo_p text, nm_usuario_p text) FROM PUBLIC;
