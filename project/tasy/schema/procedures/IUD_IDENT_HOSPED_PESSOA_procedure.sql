...
CREATE OR REPLACE PROCEDURE iud_ident_hosped_pessoa ( cd_pessoa_fisica_p pessoa_fisica.cd_pessoa_fisica%type, nm_usuario_p text, operation_type_p text, nr_ident_hosped_p pessoa_fisica_aux.nr_ident_hosped%type ) AS $body$
DECLARE
...
BEGIN
  ...
  IF (operation_type_p NOT IN ('DELETE')) THEN
    ...
    ELSIF (nr_seq_pessoa_aux_w IS NOT NULL AND nr_seq_pessoa_aux_w::text <> '') THEN
      ...
      SET p.nr_ident_hosped    = nr_ident_hosped_p,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE iud_ident_hosped_pessoa ( cd_pessoa_fisica_p pessoa_fisica.cd_pessoa_fisica%type, nm_usuario_p text, operation_type_p text, nr_ident_hosped_p pessoa_fisica_aux.nr_ident_hosped%type ) FROM PUBLIC;
