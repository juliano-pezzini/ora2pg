...
CREATE OR REPLACE PROCEDURE gera_componente_kit_mat_pda ( cd_kit_material_P bigint, nr_seq_kit_estoque_p bigint, ie_baixa_estoque_p text, ie_desconsidera_param_81_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gera_componente_kit_mat_pda ( cd_kit_material_P bigint, nr_seq_kit_estoque_p bigint, ie_baixa_estoque_p text, ie_desconsidera_param_81_p text, nm_usuario_p text) FROM PUBLIC;
