...
CREATE OR REPLACE PROCEDURE gerar_d301_conteudo_pent ( nr_seq_dataset_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_d301_conteudo_pent ( nr_seq_dataset_p bigint, nm_usuario_p text) FROM PUBLIC;
