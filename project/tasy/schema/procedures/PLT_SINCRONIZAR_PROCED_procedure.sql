...
CREATE OR REPLACE PROCEDURE plt_sincronizar_proced ( cd_estabelecimento_p bigint, cd_setor_usuario_p bigint, nm_usuario_p text, nr_atendimento_p bigint, dt_validade_limite_p timestamp, dt_horario_p timestamp, nr_horario_p integer, ie_prescr_usuario_p text) AS $body$
DECLARE
...
SELECT	a.nr_prescricao,
	...
	c.nr_sequencia,
	SUBSTR(plt_obter_status_hor_proc_lib(c.dt_fim_horario,c.dt_suspensao,c.ie_dose_especial,c.dt_inicio_proced,c.dt_lib_horario),1,15),
	c.cd_procedimento,
	y.ds_procedimento,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE plt_sincronizar_proced ( cd_estabelecimento_p bigint, cd_setor_usuario_p bigint, nm_usuario_p text, nr_atendimento_p bigint, dt_validade_limite_p timestamp, dt_horario_p timestamp, nr_horario_p integer, ie_prescr_usuario_p text) FROM PUBLIC;
