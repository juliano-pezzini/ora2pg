...
CREATE OR REPLACE PROCEDURE baca_dt_vigencia_tuss_mat_it () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vigencia_tuss_mat_it () FROM PUBLIC;
