...
CREATE OR REPLACE PROCEDURE limpar_realiz_ativ_proj_migr ( nr_seq_projeto_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE limpar_realiz_ativ_proj_migr ( nr_seq_projeto_p bigint, nm_usuario_p text) FROM PUBLIC;
