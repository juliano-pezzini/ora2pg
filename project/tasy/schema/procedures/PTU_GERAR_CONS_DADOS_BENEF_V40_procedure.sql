...
CREATE OR REPLACE PROCEDURE ptu_gerar_cons_dados_benef_v40 ( cd_unimed_benef_p bigint, cd_usuario_plano_p text, nm_beneficiario_p text, sobrenome_benef_p text, dt_nascimento_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_cons_dados_benef_v40 ( cd_unimed_benef_p bigint, cd_usuario_plano_p text, nm_beneficiario_p text, sobrenome_benef_p text, dt_nascimento_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) FROM PUBLIC;
