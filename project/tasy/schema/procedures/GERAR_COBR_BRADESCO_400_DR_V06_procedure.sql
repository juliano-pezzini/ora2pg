...
CREATE OR REPLACE PROCEDURE gerar_cobr_bradesco_400_dr_v06 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobr_bradesco_400_dr_v06 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
