...
CREATE OR REPLACE PROCEDURE gerar_cobranca_cecred_240 ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	ds_conteudo_w		:=	'085' || 
					...
					rpad(' ',20,' ') || 
					'1' || 
					'0' || -- Forma de cad. do título no banco 
					'2' || -- Tipo de documento 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobranca_cecred_240 ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
