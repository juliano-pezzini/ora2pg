...
CREATE OR REPLACE PROCEDURE man_gerar_os_proj_etapa ( nr_sequencia_p INOUT bigint, cd_pessoa_solicitante_p text, nr_seq_localizacao_p bigint, nr_seq_equipamento_p bigint, ds_dano_breve_p text, ds_dano_p text, cd_funcao_p bigint, ie_classificacao_p text, ie_forma_receb_p text, dt_inicio_previsto_p timestamp, dt_fim_previsto_p timestamp, nr_seq_estagio_p bigint, ie_tipo_ordem_p text, nr_grupo_planej_p bigint, nr_grupo_trabalho_p bigint, ie_prioridade_p text, ie_status_ordem_p text, nm_usuario_p text, nr_seq_proj_cron_etapa_p bigint, nr_seq_grupo_des_p bigint, nr_seq_projeto_p bigint, nr_seq_ativ_exec_p bigint, qt_horas_previstos_p bigint, dt_inicio_p timestamp, cd_estabelecimento_p bigint, nr_seq_executor_p bigint default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE man_gerar_os_proj_etapa ( nr_sequencia_p INOUT bigint, cd_pessoa_solicitante_p text, nr_seq_localizacao_p bigint, nr_seq_equipamento_p bigint, ds_dano_breve_p text, ds_dano_p text, cd_funcao_p bigint, ie_classificacao_p text, ie_forma_receb_p text, dt_inicio_previsto_p timestamp, dt_fim_previsto_p timestamp, nr_seq_estagio_p bigint, ie_tipo_ordem_p text, nr_grupo_planej_p bigint, nr_grupo_trabalho_p bigint, ie_prioridade_p text, ie_status_ordem_p text, nm_usuario_p text, nr_seq_proj_cron_etapa_p bigint, nr_seq_grupo_des_p bigint, nr_seq_projeto_p bigint, nr_seq_ativ_exec_p bigint, qt_horas_previstos_p bigint, dt_inicio_p timestamp, cd_estabelecimento_p bigint, nr_seq_executor_p bigint default null) FROM PUBLIC;
