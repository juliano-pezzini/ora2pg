...
CREATE OR REPLACE PROCEDURE psa_subject_insert ( rc_usuario_p usuario ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE psa_subject_insert ( rc_usuario_p usuario ) FROM PUBLIC;
