...
CREATE OR REPLACE PROCEDURE baca_eis_conta ( dt_parametro_P timestamp, nr_seq_protocolo_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_eis_conta ( dt_parametro_P timestamp, nr_seq_protocolo_p bigint) FROM PUBLIC;
