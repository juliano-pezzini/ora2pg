...
CREATE OR REPLACE PROCEDURE atualizar_laudo_corrigido (nr_laudo_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_laudo_corrigido (nr_laudo_p bigint) FROM PUBLIC;
