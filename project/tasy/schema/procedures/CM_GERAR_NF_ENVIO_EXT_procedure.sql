...
CREATE OR REPLACE PROCEDURE cm_gerar_nf_envio_ext ( cd_cgc_emite_p text, nr_nota_fiscal_p text, cd_serie_nf_p text, cd_operacao_nf_p bigint, cd_natureza_nf_p bigint, cd_cond_pagto_p bigint, cd_local_estoque_p bigint, nr_seq_envio_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_nota_gerada_p INOUT bigint) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (cd_material_w <> 0) then
		...
		if (ds_lote_w IS NOT NULL AND ds_lote_w::text <> '') and (coalesce(dt_validade_w::text, '') = '') then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cm_gerar_nf_envio_ext ( cd_cgc_emite_p text, nr_nota_fiscal_p text, cd_serie_nf_p text, cd_operacao_nf_p bigint, cd_natureza_nf_p bigint, cd_cond_pagto_p bigint, cd_local_estoque_p bigint, nr_seq_envio_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_nota_gerada_p INOUT bigint) FROM PUBLIC;
