...
CREATE OR REPLACE PROCEDURE plt_obter_medic_hd_de ( nm_usuario_p text, nr_atendimento_p bigint, nr_seq_dialise_p bigint, dt_inicial_horarios_p timestamp, dt_final_horarios_p timestamp, ie_agrupar_acm_sn_p text, ie_prescr_usuario_p text, nr_seq_regra_p bigint) AS $body$
DECLARE
...
ie_copiar_w 	:= plt_obter_se_item_marcado('ME', nr_seq_regra_p);
ds_cor_titulo_w	:= plt_obter_se_item_marcado('ME', nr_seq_regra_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE plt_obter_medic_hd_de ( nm_usuario_p text, nr_atendimento_p bigint, nr_seq_dialise_p bigint, dt_inicial_horarios_p timestamp, dt_final_horarios_p timestamp, ie_agrupar_acm_sn_p text, ie_prescr_usuario_p text, nr_seq_regra_p bigint) FROM PUBLIC;
