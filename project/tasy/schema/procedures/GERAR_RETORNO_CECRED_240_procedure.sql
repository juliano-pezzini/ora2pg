...
CREATE OR REPLACE PROCEDURE gerar_retorno_cecred_240 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
	SELECT	nr_sequencia,
		trim(both substr(ds_string,46,12)),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_retorno_cecred_240 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
