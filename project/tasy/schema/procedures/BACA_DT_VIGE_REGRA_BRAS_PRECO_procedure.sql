...
CREATE OR REPLACE PROCEDURE baca_dt_vige_regra_bras_preco () AS $body$
DECLARE
...
C01 CURSOR FOR 
	SELECT	nr_sequencia, 
		...
		pls_util_pck.obter_dt_vigencia_null(dt_final_vigencia, 'F') dt_fim_vigencia_ref 
...
loop 
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last 
		update	pls_regra_brasindice_preco 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vige_regra_bras_preco () FROM PUBLIC;
