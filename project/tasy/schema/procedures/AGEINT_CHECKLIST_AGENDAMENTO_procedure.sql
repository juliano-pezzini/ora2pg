...
CREATE OR REPLACE PROCEDURE ageint_checklist_agendamento (nr_seq_ageint_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, ie_gerado_p INOUT text) AS $body$
DECLARE
...
C01 CURSOR FOR
	...
	and	a.nr_sequencia in (SELECT	nr_seq_grupo_check_list
				   ...
				   and		coalesce(ie_apres_agendamento,'N') = 'S');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ageint_checklist_agendamento (nr_seq_ageint_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, ie_gerado_p INOUT text) FROM PUBLIC;
