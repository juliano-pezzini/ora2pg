...
Pontos de atencao: Ao realizar alguma alteracao testar se continua funcionando para as guias.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
BEGIN
...
if (ie_aplicacao_regra_p = 1) then
	CALL pls_gerar_ocor_aut_somente_fil(	nr_seq_ocorrencia_p, nr_seq_ocor_combinada_p, nr_seq_segurado_p,
					nr_seq_motivo_glosa_p, nr_seq_guia_p, null,
					null, null, null,
					null, null, null,
...
if (ie_aplicacao_regra_p	= 3) then
	CALL pls_valida_ocor_aut_vl_conta(	nr_seq_ocorrencia_p, nr_seq_ocor_combinada_p, ie_aplicacao_regra_p,
					ie_utiliza_filtro_p, nr_seq_segurado_p, nr_seq_motivo_glosa_p,
...
/* Tratamento para validacao do procedimento x especialidade*/
...
--pls_atualiza_guia_ocor_comb(nr_seq_guia_p, nm_usuario_p, cd_estabelecimento_p);
...
/* Tratamento para a Validacao do fornecedor do material*/

if (ie_aplicacao_regra_p	= 15) then
	CALL pls_valida_ocor_aut_fornec_mat(	nr_seq_ocor_combinada_p, nr_seq_ocorrencia_p, nr_seq_segurado_p,
					nr_seq_motivo_glosa_p, nr_seq_guia_p, null,
					null, ie_utiliza_filtro_p, null,
					null, null, null,
					null, nm_usuario_p, cd_estabelecimento_p);	
...
/* Tratamento para elegibilidade */

if (ie_aplicacao_regra_p	= 21) then
	CALL pls_valida_ocor_aut_elegib(	nr_seq_ocor_combinada_p, nr_seq_ocorrencia_p, nr_seq_segurado_p,
					nr_seq_motivo_glosa_p, nr_seq_guia_p, null,
					null, ie_utiliza_filtro_p, nm_usuario_p,
					cd_estabelecimento_p);
end if;

/* Tratamento para validar as informacoes do Anexo de guias */
...
/* Tratamento para validar a duplicidade de guias*/
...
/* Tratamento para validar a regra de pacote SCS*/
...
/* Tratamento para validar o controle interno da guia*/

if (ie_aplicacao_regra_p	= 31) then
	CALL pls_valida_ocor_aut_cont_int(	nr_seq_ocor_combinada_p, nr_seq_ocorrencia_p, nr_seq_segurado_p,
					nr_seq_motivo_glosa_p, nr_seq_guia_p, ie_utiliza_filtro_p,
					nm_usuario_p, cd_estabelecimento_p);
end if;
...
if (ie_aplicacao_regra_p	= 34) then
	CALL pls_valida_ocor_aut_cons_obr(	nr_seq_ocor_combinada_p, nr_seq_ocorrencia_p, nr_seq_motivo_glosa_p,
					nr_seq_guia_p, null, ie_utiliza_filtro_p,
					nm_usuario_p, cd_estabelecimento_p);
end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_ocor_aut_comb_guia ( nr_seq_ocorrencia_p bigint, nr_seq_ocor_combinada_p bigint, ie_aplicacao_regra_p text, ie_utiliza_filtro_p text, nr_seq_segurado_p bigint, nr_seq_motivo_glosa_p bigint, nr_seq_guia_p bigint, nr_seq_param1_p bigint, nr_seq_param2_p bigint, nr_seq_param3_p bigint, nr_seq_param4_p bigint, nr_seq_param5_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
