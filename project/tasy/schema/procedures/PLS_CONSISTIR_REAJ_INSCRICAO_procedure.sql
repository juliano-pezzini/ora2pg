...
CREATE OR REPLACE PROCEDURE pls_consistir_reaj_inscricao (nr_seq_contrato_p bigint, nr_seq_regra_inscricao_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, ds_erro_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_consistir_reaj_inscricao (nr_seq_contrato_p bigint, nr_seq_regra_inscricao_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, ds_erro_p INOUT text) FROM PUBLIC;
