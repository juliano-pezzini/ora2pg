...
CREATE OR REPLACE PROCEDURE gerar_curva_abc_local ( cd_estabelecimento_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text) AS $body$
DECLARE
...
delete	FROM material_abc_local
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	EXIT WHEN NOT FOUND; /* apply on C02 */
		...
		insert into Material_abc_local(
			cd_material,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_curva_abc_local ( cd_estabelecimento_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text) FROM PUBLIC;
