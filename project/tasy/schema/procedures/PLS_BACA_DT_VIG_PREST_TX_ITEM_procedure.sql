...
CREATE OR REPLACE PROCEDURE pls_baca_dt_vig_prest_tx_item () AS $body$
DECLARE
...
loop
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last
		update	pls_prestador_taxa_item
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_baca_dt_vig_prest_tx_item () FROM PUBLIC;
