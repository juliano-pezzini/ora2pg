...
CREATE OR REPLACE PROCEDURE sus_consiste_internacao ( nr_atendimento_p text, ds_mensagem_p INOUT text, ie_permite_lib_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE sus_consiste_internacao ( nr_atendimento_p text, ds_mensagem_p INOUT text, ie_permite_lib_p INOUT text) FROM PUBLIC;
