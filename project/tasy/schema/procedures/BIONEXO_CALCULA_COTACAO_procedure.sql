...
CREATE OR REPLACE PROCEDURE bionexo_calcula_cotacao ( nr_cot_compra_p bigint, ie_forma_calc_entrega_p text, nm_usuario_p text) AS $body$
DECLARE
...
if (qt_existe_w > 0) then 
	...
	CALL bionexo_gerar_ordem_compra(nr_cot_compra_p, ie_forma_calc_entrega_p, nm_usuario_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE bionexo_calcula_cotacao ( nr_cot_compra_p bigint, ie_forma_calc_entrega_p text, nm_usuario_p text) FROM PUBLIC;
