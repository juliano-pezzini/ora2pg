...
CREATE OR REPLACE PROCEDURE gerar_retorno_pagto_bradesco (nr_seq_banco_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (qt_retorno_liq_w	> 0) and (coalesce(ie_movto_bco_pag_escrit_w,'T') = 'T') then 
...
if (coalesce(ie_movto_bco_pag_escrit_w,'T') = 'T') then 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_retorno_pagto_bradesco (nr_seq_banco_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
