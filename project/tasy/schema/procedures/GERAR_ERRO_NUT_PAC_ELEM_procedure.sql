...
CREATE OR REPLACE PROCEDURE gerar_erro_nut_pac_elem ( nr_prescricao_p bigint, nr_seq_nut_elem_mat_p bigint, nr_regra_p bigint, ie_permite_liberar_p text, ds_compl_erro_p text, cd_perfil_p bigint, nm_usuario_p text, nr_seq_erro_p INOUT bigint) AS $body$
DECLARE
...
BEGIN
if (nr_prescricao_p IS NOT NULL AND nr_prescricao_p::text <> '') and (nr_seq_nut_elem_mat_p IS NOT NULL AND nr_seq_nut_elem_mat_p::text <> '') and (ie_permite_liberar_p IS NOT NULL AND ie_permite_liberar_p::text <> '') and (nm_usuario_p IS NOT NULL AND nm_usuario_p::text <> '') then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_erro_nut_pac_elem ( nr_prescricao_p bigint, nr_seq_nut_elem_mat_p bigint, nr_regra_p bigint, ie_permite_liberar_p text, ds_compl_erro_p text, cd_perfil_p bigint, nm_usuario_p text, nr_seq_erro_p INOUT bigint) FROM PUBLIC;
