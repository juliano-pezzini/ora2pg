...
CREATE OR REPLACE PROCEDURE gerar_evento_pronto_socorro ( nr_atendimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_pronto_socorro ( nr_atendimento_p bigint, nm_usuario_p text) FROM PUBLIC;
