...
if (ie_tipo_componente_p = 'WDBP') and (nm_tabela_p IS NOT NULL AND nm_tabela_p::text <> '') then
	...
	if (ie_tipo_componente_p = 'WPOPUP') then
		...
		begin
		nr_seq_dic_objeto_w := copiar_dic_objeto(cd_funcao_p, nr_seq_dic_objeto_p, nm_usuario_p, ie_dinamicform_w, nr_seq_dic_objeto_w, 'S');
		end;
	end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE criar_objeto_schematic_aut ( cd_funcao_p bigint, nr_seq_funcao_schematic_p bigint, nr_seq_tipo_schematic_p bigint, ds_objeto_p text, ie_tipo_componente_p text, nr_seq_superior_p bigint, nm_tabela_p text, nr_seq_visao_p bigint, nr_seq_dic_objeto_p bigint, cd_exp_desc_obj_p bigint, nm_usuario_p text, ie_tipo_objeto_p text, ie_tipo_objeto_painel_p text, ie_tipo_objeto_navegador_p text, ie_tipo_objeto_master_reg_p text, nr_seq_gerado_p INOUT bigint) FROM PUBLIC;
