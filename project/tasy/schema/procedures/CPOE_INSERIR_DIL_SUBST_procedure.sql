...
CREATE OR REPLACE PROCEDURE cpoe_inserir_dil_subst ( nr_prescricao_p bigint, nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
if (cd_material_w IS NOT NULL AND cd_material_w::text <> '') then 
	...
	/* Atualizar reg. do diluente */
 
	update	cpoe_material 
	set		cd_mat_dil 					= cd_material_w, 
			cd_unid_med_dose_dil		= cd_unidade_medida_dose_w, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cpoe_inserir_dil_subst ( nr_prescricao_p bigint, nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
