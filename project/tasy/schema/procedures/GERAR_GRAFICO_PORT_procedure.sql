...
CREATE OR REPLACE PROCEDURE gerar_grafico_port (nr_seq_port_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	qt_hora_real_w	:= Obter_Qt_Hrs_Residuais_Port(nr_seq_port_p, dt_ref_w);
	qt_hora_prev_w	:= OBTER_QT_HRS_PREV_Port(nr_seq_port_p, dt_ref_w);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_grafico_port (nr_seq_port_p bigint, nm_usuario_p text) FROM PUBLIC;
