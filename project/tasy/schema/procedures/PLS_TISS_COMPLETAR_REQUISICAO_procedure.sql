...
CREATE OR REPLACE PROCEDURE pls_tiss_completar_requisicao ( nr_seq_guia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
if (ie_tiss_tipo_guia_w	= '2') then
	...
	where	nr_seq_requisicao = nr_sequencia_autor_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_tiss_completar_requisicao ( nr_seq_guia_p bigint, nm_usuario_p text) FROM PUBLIC;
