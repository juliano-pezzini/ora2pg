...
CREATE OR REPLACE PROCEDURE html_create_rule_obj_schem ( nr_seq_lote_p bigint, nr_seq_regra_acao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
ie_visible_w				html_param_to_rule_action.si_field_visible%type;
...
if (vl_parametro_w = vl_parametro_de_w) then 
	...
	CALL INSERT_RULE_OBJ_SCHEM(nr_seq_lote_p, 
						cd_funcao_w, 
						nr_seq_parametro_w, 
						vl_parametro_de_w, 
						null, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE html_create_rule_obj_schem ( nr_seq_lote_p bigint, nr_seq_regra_acao_p bigint, nm_usuario_p text) FROM PUBLIC;
