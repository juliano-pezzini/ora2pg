...
CREATE OR REPLACE PROCEDURE baca_dt_vige_regra_calc_irpf () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vige_regra_calc_irpf () FROM PUBLIC;
