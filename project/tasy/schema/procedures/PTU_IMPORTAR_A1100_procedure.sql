...
CREATE OR REPLACE PROCEDURE ptu_importar_a1100 ( nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	--Dados dos itens
		...
		qt_autorizada_w		:= (substr(ds_conteudo_w,101,8))::numeric;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_importar_a1100 ( nm_usuario_p text) FROM PUBLIC;
