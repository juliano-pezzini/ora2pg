...
CREATE OR REPLACE PROCEDURE w_mprev_deletar_w_ag_ativ ( nr_seq_w_agendamento_p w_mprev_agendamento_ativ.nr_sequencia%type, nm_usuario_p text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE w_mprev_deletar_w_ag_ativ ( nr_seq_w_agendamento_p w_mprev_agendamento_ativ.nr_sequencia%type, nm_usuario_p text) FROM PUBLIC;
