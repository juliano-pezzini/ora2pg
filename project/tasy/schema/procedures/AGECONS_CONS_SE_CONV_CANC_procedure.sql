...
CREATE OR REPLACE PROCEDURE agecons_cons_se_conv_canc ( cd_convenio_p bigint, dt_agenda_p timestamp) AS $body$
DECLARE
...
if (ds_retorno_w = 'S') then
	CALL wheb_mensagem_pck.exibir_mensagem_abort(184953);
end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE agecons_cons_se_conv_canc ( cd_convenio_p bigint, dt_agenda_p timestamp) FROM PUBLIC;
