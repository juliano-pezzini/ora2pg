...
CREATE OR REPLACE PROCEDURE baca_dt_vige_tributo_cta_pagar () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vige_tributo_cta_pagar () FROM PUBLIC;
