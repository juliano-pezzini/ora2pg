...
CREATE OR REPLACE PROCEDURE atualizar_lista_ag_cons_eup (nr_atendimento_p bigint, ds_lista_agenda_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_lista_ag_cons_eup (nr_atendimento_p bigint, ds_lista_agenda_p text, nm_usuario_p text) FROM PUBLIC;
