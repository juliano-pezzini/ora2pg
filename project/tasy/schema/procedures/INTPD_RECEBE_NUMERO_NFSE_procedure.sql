...
CREATE OR REPLACE PROCEDURE intpd_recebe_numero_nfse ( nr_sequencia_p bigint, xml_p xml) AS $body$
DECLARE
...
from	xmltable('/STRUCTURE/INVOICE' passing xml_p columns 
	...
	nr_nfe_imp		varchar(40)	path	'NR_E_INVOICE');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE intpd_recebe_numero_nfse ( nr_sequencia_p bigint, xml_p xml) FROM PUBLIC;
