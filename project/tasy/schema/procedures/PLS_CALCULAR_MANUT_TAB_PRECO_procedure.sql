...
CREATE OR REPLACE PROCEDURE pls_calcular_manut_tab_preco ( nr_seq_tabela_p bigint, nr_seq_plano_preco_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_calcular_manut_tab_preco ( nr_seq_tabela_p bigint, nr_seq_plano_preco_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
