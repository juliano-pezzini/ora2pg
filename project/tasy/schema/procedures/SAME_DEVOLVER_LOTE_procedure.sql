...
CREATE OR REPLACE PROCEDURE same_devolver_lote ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE same_devolver_lote ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
