...
CREATE OR REPLACE PROCEDURE plt_sincronizar_medic_hd_de ( nm_usuario_p text, nr_atendimento_p bigint, nr_seq_dialise_p bigint, ie_obs_diferenciar_p text, dt_horario_p timestamp, nr_horario_p integer, ie_prescr_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE plt_sincronizar_medic_hd_de ( nm_usuario_p text, nr_atendimento_p bigint, nr_seq_dialise_p bigint, ie_obs_diferenciar_p text, dt_horario_p timestamp, nr_horario_p integer, ie_prescr_usuario_p text) FROM PUBLIC;
