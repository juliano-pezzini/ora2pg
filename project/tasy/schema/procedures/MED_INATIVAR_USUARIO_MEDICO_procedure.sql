...
CREATE OR REPLACE PROCEDURE med_inativar_usuario_medico ( cd_medico_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE med_inativar_usuario_medico ( cd_medico_p text, nm_usuario_p text) FROM PUBLIC;
