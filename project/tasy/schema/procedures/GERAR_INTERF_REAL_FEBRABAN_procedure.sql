...
CREATE OR REPLACE PROCEDURE gerar_interf_real_febraban (nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SELECT	0						ie_ordem_arq, 
	...
	'0' 						ie_registro, 
	'0'						nr_barras, 
	lpad(substr(g.cd_agencia_bancaria,1,4),4,'0')||lpad(substr(g.cd_conta,1,7),7,0)||'PG' cd_convenio, 
	'2' 						ie_tipo_inscricao, 
	'' 						cd_moeda, 
	' ' 						DS_DAC_AGENCIA 
...
select	1						ie_ordem_arq, 
	...
	CASE WHEN c.ie_tipo_pagamento='CC' THEN '01' WHEN c.ie_tipo_pagamento='CCP' THEN '01' WHEN c.ie_tipo_pagamento='TED' THEN '03' WHEN c.ie_tipo_pagamento='OP' THEN '10' WHEN c.ie_tipo_pagamento='PC' THEN '33' WHEN c.ie_tipo_pagamento='BLQ' THEN CASE WHEN c.cd_banco=356 THEN '30'  ELSE '31' END  WHEN c.ie_tipo_pagamento='DOC' THEN '03' END  ie_forma_lancamento, 
	0						ie_ordem_lote, 
	1						tp_registro, 
	...
	'1' 						ie_registro, 
	'0'						nr_barras, 
	lpad(substr(b.cd_agencia_bancaria,1,4),4,'0')||lpad(substr(b.cd_conta,1,7),7,0)||'PG' cd_convenio, 
	'2'						ie_tipo_inscricao, 
	'' 						cd_moeda, 
	' '						DS_DAC_AGENCIA 
...
select	1						ie_ordem_arq, 
	...
	CASE WHEN obter_dados_tit_pagar(d.nr_titulo,'MO')=1 THEN 'BRL'  ELSE 'USD' END  	cd_moeda, 
	c.IE_DIGITO_AGENCIA				DS_DAC_AGENCIA 
...
group by	e.nr_sequencia, 
		c.ie_tipo_pagamento, 
		CASE WHEN c.ie_tipo_pagamento='CC' THEN '01' WHEN c.ie_tipo_pagamento='CCP' THEN '01' WHEN c.ie_tipo_pagamento='TED' THEN '03' WHEN c.ie_tipo_pagamento='OP' THEN '10' WHEN c.ie_tipo_pagamento='PC' THEN '33' WHEN c.ie_tipo_pagamento='BLQ' THEN CASE WHEN c.cd_banco=356 THEN '30'  ELSE '31' END  WHEN c.ie_tipo_pagamento='DOC' THEN '03' END  
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_interf_real_febraban (nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
