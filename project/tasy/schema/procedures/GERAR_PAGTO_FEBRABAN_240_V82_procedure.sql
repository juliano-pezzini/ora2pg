...
CREATE OR REPLACE PROCEDURE gerar_pagto_febraban_240_v82 ( nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE


/* PADRAO CNAB 240 VERSAO 8.2 
Essa rotina foi criada para atender as necessidades da OS 1773401,*/
...
ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') || 		--01,0
			'0000' || 				--02.0
			'0' ||					--03.0
			rpad(' ',9,' ') ||			--04.0
			'2' ||					--05.0
			cd_cgc_estab_w ||			--06.0
			cd_convenio_banco_w ||			--07.0
			cd_agencia_estab_w ||			--08.0 / 09.0
			nr_conta_estab_w ||			--10.0 
			ie_digito_estab_w ||			--11.0
			' ' ||					--12.0
			nm_empresa_w ||				--13.0
			rpad(upper(ds_banco_w),30,' ') ||	--14.0
			rpad(' ',10,' ') ||			--15.0
			'1' ||					--16.0
			dt_geracao_w ||				--17.0 / 18.0
			lpad(nr_remessa_w,6,'0') ||		--19.0
			'082' ||				--20.0
			'06250' || 				--21.0
			rpad(' ',69,' ');			--22.0 / 23.0 / 24.0
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||		--01.1
				lpad(nr_lote_servico_w,4,'0') ||	--02.1
				'1' ||					--03.1
				'C' ||					--04.1
				'20' ||					--05.1
				ie_forma_lanc_w ||			--06.1
				'042' ||				--07.1
				' ' ||					--08.1
				'2' ||					--09.1
				cd_cgc_estab_w ||			--10.1
				cd_convenio_banco_w ||			--11.1
				cd_agencia_estab_w ||			--12.1 / 13.1
				nr_conta_estab_w ||			--14.1
				ie_digito_estab_w ||			--15.1
				' ' ||					--16.1
				nm_empresa_w ||				--17.1
				rpad(' ',40,' ') ||			--18.1
				ds_endereco_w ||			--19.1
				nr_endereco_w ||			--20.1
				ds_complemento_w ||			--21.1
				ds_municipio_w ||			--22.1
				nr_cep_w ||				--23.1
				substr(sg_estado_w,1,2) ||		--24.1
				rpad(' ',18,' ');			--25.1
	insert	into w_envio_banco(cd_estabelecimento,
		ds_conteudo,
		dt_atualizacao,
	...
	EXIT WHEN NOT FOUND; /* apply on c02 */
		...
		ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||				--01.3A
					lpad(nr_lote_servico_w,4,'0') ||			--02.3A
					'3' ||							--03.3A
					lpad(nr_sequencia_w,5,'0') ||				--04.3A
					'A' ||							--05.3A
					'000' ||						--06.3A / 07.3A
					cd_camara_w ||						--08.3A
					lpad(cd_banco_w,3,'0') ||				--09.3A
					cd_agencia_bancaria_w ||				--10.3A // 11.3A
					lpad(substr(nr_conta_w,1,12),12,'0') ||			--12.3A
					ie_digito_conta_w ||					--13.3A
					' ' ||							--14.3A
					nm_pessoa_w ||						--15.3A
					rpad(nr_titulo_w,20,' ') ||				--16.3A
					to_char(dt_remessa_retorno_w,'ddmmyyyy') ||		--17.3A
					'BRL' ||						--18.3A
					'000000000000000' ||					--19.3A
					lpad(somente_numero(to_char(coalesce(vl_escritural_w,0) - coalesce(vl_desconto_w,0) + coalesce(vl_acrescimo_w,0) + coalesce(vl_despesa_w,0) + coalesce(vl_juros_w,0) + coalesce(vl_multa_w,0),'9999999999990.00')),15,'0') || -- 20.3A
					rpad(' ',20,' ') ||					--21.3
					'00000000' ||						--22.3
					'000000000000000' ||					--23.3
					rpad(' ',40,' ') ||					--24.3A
					'07' ||							--25.3A
					'00005' ||						--26.3A
					rpad(' ',5,' ') ||					--27.3A / 28.3A
		...
		ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||				--01.3B
					lpad(nr_lote_servico_w,4,'0') ||			--02.3B
					'3' ||							--03.3B
					lpad(nr_sequencia_w,5,'0') ||				--04.3B
					'B' ||							--05.3B
					rpad(' ',3,' ') ||					--06.3B
					ie_tipo_inscricao_w ||					--07.3B
					nr_inscricao_w ||					--08.3B
					ds_endereco_det_w ||					--09.3B
					nr_endereco_det_w ||					--10.3B
					ds_complemento_det_w ||					--11.3B
					ds_bairro_det_w ||					--12.3B
					ds_municipio_det_w ||					--13.3B
					nr_cep_det_w ||						--14.3B / 15.3B
					substr(sg_estado_det_w,1,2) ||				--16.3B
					to_char(dt_vencimento_w,'ddmmyyyy') ||			--17.3B
					lpad(somente_numero(to_char(coalesce(vl_escritural_w,0),'9999999999990.00')),15,'0') || 	--18.3B
					'000000000000000' ||									--19.3B
					lpad(somente_numero(to_char(coalesce(vl_desconto_w,0),'9999999999990.00')),15,'0') ||	--20.3B
					lpad(somente_numero(to_char(coalesce(vl_juros_w,0),'9999999999990.00')),15,'0') ||		--21.3B
					lpad(somente_numero(to_char(coalesce(vl_multa_w,0),'9999999999990.00')),15,'0') ||		--22.3B
					rpad(' ',15,' ') ||									--23.3B
					'0' ||											--24.3B
					rpad(' ',14,' ');									--25.3B / 26.3B
		insert	into w_envio_banco(cd_estabelecimento,
	...
	ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||				--01.5
				lpad(nr_lote_servico_w,4,'0') ||			--02.5
				'5' ||							--03.5
				rpad(' ',9,' ') ||					--04.5
				lpad(nr_sequencia_w + 2,6,'0') ||			--05.5
				lpad(somente_numero(to_char(coalesce(vl_total_w,0),'9999999999999990.00')),18,'0') ||	--06.5
				'000000000000000000' || 				--07.5
				'000000' ||						--08.5
				rpad(' ',175,' ');					--09.5 / 10.5
	insert	into w_envio_banco(cd_estabelecimento,
		ds_conteudo,
	...
	EXIT WHEN NOT FOUND; /* apply on c04 */
		...
		if (ie_forma_lanc_w	= '16') then
			...
			ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') || 				--01.3N
						...
						to_char(dt_vencimento_w,'ddmmyyyy') ||							--10.3.N2
						rpad(' ',18,' ') ||									--11.3.N2
						rpad(' ',10,' ');					--13.3N
		...
		/* segmento J */
			...
			ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||			--01.3J
						lpad(nr_lote_servico_w,4,'0') ||		--02.3J
						'3' ||						--03.3J
						lpad(nr_sequencia_w,5,'0') ||			--04.3J
						'J' ||						--05.3J
						'0' ||						--06.3J
						'00' ||						--07.3J
						nr_bloqueto_w ||				--08.3J
						nm_pessoa_w ||					--09.3J
						to_char(dt_vencimento_w,'ddmmyyyy') ||		--10.3J
						lpad(somente_numero(to_char(coalesce(vl_escritural_w,0),'9999999999990.00')),15,'0') || 	--11.3J
						lpad(somente_numero(to_char(coalesce(vl_desconto_w,0),'9999999999990.00')),15,'0') ||	--12.3J
						lpad(somente_numero(to_char(coalesce(vl_multa_w,0) + coalesce(vl_juros_w,0),'9999999999990.00')),15,'0') ||	--13.3J
						to_char(dt_remessa_retorno_w,'ddmmyyyy') ||						--14.3J
						lpad(somente_numero(to_char(coalesce(vl_escritural_w,0) - coalesce(vl_desconto_w,0) + coalesce(vl_acrescimo_w,0) + coalesce(vl_despesa_w,0) + coalesce(vl_juros_w,0) + coalesce(vl_multa_w,0),'9999999999990.00')),15,'0') ||	--15.3J
						'000000000000000' ||				--16.3J
						rpad(nr_titulo_w,20,' ') ||			--17.3J
						rpad(nr_nosso_numero_w,20,' ') ||		--18.3J
						'09' ||						--19.3J
						rpad(' ',16,' ');				--20.3J / 21.3J
...
ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||			--01.9
			'9999' ||					--02.9
			'9' ||						--03.9
			rpad(' ',9,' ') ||				--04.9
			lpad(nr_lote_servico_w,6,'0') ||		--05.9
			lpad(coalesce(qt_registro_w,0) + (coalesce(nr_lote_servico_w,0) * 2) + 2,6,'0') ||	--06.9   /* registros detalhe + header e trailer dos lotes + header e trailer do arquivo */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pagto_febraban_240_v82 ( nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
