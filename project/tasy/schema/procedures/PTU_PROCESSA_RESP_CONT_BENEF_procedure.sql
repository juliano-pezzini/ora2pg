...
CREATE OR REPLACE PROCEDURE ptu_processa_resp_cont_benef ( nr_seq_pedido_cont_p ptu_pedido_contagem_benef.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_ret_cont_p INOUT ptu_resp_contagem_benef.nr_sequencia%type) AS $body$
DECLARE
...
--dt_mes_referencia e dt_ano_referencia, são iguais e completos(com mês e ano).
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_processa_resp_cont_benef ( nr_seq_pedido_cont_p ptu_pedido_contagem_benef.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_ret_cont_p INOUT ptu_resp_contagem_benef.nr_sequencia%type) FROM PUBLIC;
