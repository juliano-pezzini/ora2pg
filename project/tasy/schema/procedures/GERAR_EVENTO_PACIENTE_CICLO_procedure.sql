...
CREATE OR REPLACE PROCEDURE gerar_evento_paciente_ciclo ( nr_seq_evento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text, nr_seq_paciente_p bigint, ds_dias_gerados_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_paciente_ciclo ( nr_seq_evento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text, nr_seq_paciente_p bigint, ds_dias_gerados_p text, nm_usuario_p text) FROM PUBLIC;
