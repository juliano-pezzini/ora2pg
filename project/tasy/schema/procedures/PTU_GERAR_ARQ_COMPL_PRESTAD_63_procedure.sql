...
CREATE OR REPLACE PROCEDURE ptu_gerar_arq_compl_prestad_63 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text) AS $body$
DECLARE

 
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
Finalidade: Gerar arquivo A450 de acordo com a versão PTU 6.3 
------------------------------------------------------------------------------------------------------------------- 
...
ds_conteudo_w :=	lpad(nr_seq_registro_w,8,'0') || '451' || cd_unimed_destino_w || cd_unimed_origem_w || dt_geracao_w || '04';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_arq_compl_prestad_63 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text) FROM PUBLIC;
