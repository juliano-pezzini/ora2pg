...
CREATE OR REPLACE PROCEDURE gerar_retorno_debito_itau_150 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
	SELECT	trim(both substr(ds_string,70,25)),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_retorno_debito_itau_150 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
