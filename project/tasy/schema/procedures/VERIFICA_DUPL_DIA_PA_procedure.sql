...
CREATE OR REPLACE PROCEDURE verifica_dupl_dia_pa ( cd_material_p bigint, nr_prescricao_p bigint, nr_seq_material_p bigint, nm_usuario_p text, ds_retorno_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE verifica_dupl_dia_pa ( cd_material_p bigint, nr_prescricao_p bigint, nr_seq_material_p bigint, nm_usuario_p text, ds_retorno_p INOUT text) FROM PUBLIC;
