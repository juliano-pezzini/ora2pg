...
CREATE OR REPLACE PROCEDURE lib_material_pac_susp_dose ( cd_pessoa_fisica_p text, cd_material_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lib_material_pac_susp_dose ( cd_pessoa_fisica_p text, cd_material_p text, nm_usuario_p text) FROM PUBLIC;
