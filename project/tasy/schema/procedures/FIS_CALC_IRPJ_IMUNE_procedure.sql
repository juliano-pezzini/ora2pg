...
CREATE OR REPLACE PROCEDURE fis_calc_irpj_imune ( nr_seq_lote_p bigint ) AS $body$
DECLARE


vl_BCIRPJ_w		double precision := 0.0;  -- 01  Base de Cálculo da IRPJ
vl_IRPJAA9_w		double precision := 0.0;  -- 02 IRPJ Apurada - Alíquota 15%
vl_deducoes_w		double precision := 0.0;  -- 03  Deduções
vl_IRPJ_pagar_w		double precision := 0.0;  -- 04 IRPJ a Pagar
...
EXIT WHEN NOT FOUND; /* apply on c03 */
	...
	if (c03_w.linha in (1,3)) then
		...
		begin
		vl_IRPJ_pagar_w := vl_IRPJAA9_w - vl_deducoes_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fis_calc_irpj_imune ( nr_seq_lote_p bigint ) FROM PUBLIC;
