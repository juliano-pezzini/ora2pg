...
CREATE OR REPLACE PROCEDURE obter_estab_regr_conta_terc ( cd_estabelecimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, ie_tipo_atendimento_p bigint, cd_setor_atendimento_p bigint, cd_area_procedimento_p bigint, cd_especialidade_proc_p bigint, cd_grupo_proc_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_grupo_material_p bigint, cd_subgrupo_material_p bigint, cd_classe_material_p bigint, cd_material_p bigint, cd_plano_p text, cd_procedencia_p bigint, cd_medico_executor_p text, dt_vigencia_p timestamp, ie_clinica_p bigint, nr_seq_proc_interno_p bigint, cd_estab_conta_p INOUT bigint, nr_sequencia_regra_p INOUT bigint) AS $body$
DECLARE


cd_estab_conta_w			smallint;
NR_SEQ_CONTA_TERC_W	regra_conta_terceiro.nr_sequencia%type := 0;
...
C01 CURSOR FOR
	SELECT cd_estabelecimento_conta, nr_sequencia
...
FETCH C01 into
	...
	NR_SEQ_CONTA_TERC_W	:= NR_SEQ_CONTA_TERC_W;
	end;	
END LOOP;
CLOSE C01;
		
	cd_estab_conta_p	:= cd_estab_conta_w;
	nr_sequencia_regra_p	:= NR_SEQ_CONTA_TERC_W;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE obter_estab_regr_conta_terc ( cd_estabelecimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, ie_tipo_atendimento_p bigint, cd_setor_atendimento_p bigint, cd_area_procedimento_p bigint, cd_especialidade_proc_p bigint, cd_grupo_proc_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, cd_grupo_material_p bigint, cd_subgrupo_material_p bigint, cd_classe_material_p bigint, cd_material_p bigint, cd_plano_p text, cd_procedencia_p bigint, cd_medico_executor_p text, dt_vigencia_p timestamp, ie_clinica_p bigint, nr_seq_proc_interno_p bigint, cd_estab_conta_p INOUT bigint, nr_sequencia_regra_p INOUT bigint) FROM PUBLIC;
