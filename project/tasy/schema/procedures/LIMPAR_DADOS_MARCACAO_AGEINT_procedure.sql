...
CREATE OR REPLACE PROCEDURE limpar_dados_marcacao_ageint ( ie_deletar_prof_p text, nm_usuario_p text) AS $body$
DECLARE
...
where	nm_usuario = nm_usuario_p
and		coalesce(ie_confirmado,'S') = 'N'
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE limpar_dados_marcacao_ageint ( ie_deletar_prof_p text, nm_usuario_p text) FROM PUBLIC;
