...
CREATE OR REPLACE PROCEDURE pls_obter_excecao_preco_proc ( nr_seq_regra_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, dt_guia_p timestamp, ie_preco_p text, ie_tipo_contratacao_p text, ie_tipo_segurado_p text, nr_seq_contrato_p bigint, nr_seq_prestador_p bigint, nr_seq_congenere_p bigint, nr_seq_tipo_prestador_p bigint, nr_seq_grupo_intercambio_p bigint, nr_seq_classificacao_p bigint, nr_seq_classificacao_prest_p bigint, nr_seq_contrato_intercambio_p text, nr_seq_congenere_prot_p bigint, nr_seq_excecao_preco_proc_p INOUT bigint, nr_seq_tipo_prestador_prot_p pls_excecao_preco_proc.nr_seq_tipo_prestador_prot%type, ie_origem_protocolo_p text, ie_tipo_intercambio_p text, nr_seq_tipo_atend_princ_p bigint, ie_tipo_guia_p text, nr_seq_prestador_intercambio_p pls_conta.nr_seq_prest_inter%type default null, ie_regime_atendimento_princ_p pls_excecao_preco_proc.ie_regime_atendimento%type default null, ie_saude_ocupacional_p pls_excecao_preco_proc.ie_saude_ocupacional%type default null) AS $body$
DECLARE
...
from	procedimento c
where	c.ie_origem_proced		= ie_origem_proced_p
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_obter_excecao_preco_proc ( nr_seq_regra_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, dt_guia_p timestamp, ie_preco_p text, ie_tipo_contratacao_p text, ie_tipo_segurado_p text, nr_seq_contrato_p bigint, nr_seq_prestador_p bigint, nr_seq_congenere_p bigint, nr_seq_tipo_prestador_p bigint, nr_seq_grupo_intercambio_p bigint, nr_seq_classificacao_p bigint, nr_seq_classificacao_prest_p bigint, nr_seq_contrato_intercambio_p text, nr_seq_congenere_prot_p bigint, nr_seq_excecao_preco_proc_p INOUT bigint, nr_seq_tipo_prestador_prot_p pls_excecao_preco_proc.nr_seq_tipo_prestador_prot%type, ie_origem_protocolo_p text, ie_tipo_intercambio_p text, nr_seq_tipo_atend_princ_p bigint, ie_tipo_guia_p text, nr_seq_prestador_intercambio_p pls_conta.nr_seq_prest_inter%type default null, ie_regime_atendimento_princ_p pls_excecao_preco_proc.ie_regime_atendimento%type default null, ie_saude_ocupacional_p pls_excecao_preco_proc.ie_saude_ocupacional%type default null) FROM PUBLIC;
