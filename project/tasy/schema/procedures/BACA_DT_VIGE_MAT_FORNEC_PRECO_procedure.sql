...
CREATE OR REPLACE PROCEDURE baca_dt_vige_mat_fornec_preco () AS $body$
DECLARE
...
loop 
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last 
		update	pls_material_fornec_preco 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vige_mat_fornec_preco () FROM PUBLIC;
