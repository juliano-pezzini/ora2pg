...
CREATE OR REPLACE PROCEDURE baca_dt_vig_pls_material_tiss () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_pls_material_tiss () FROM PUBLIC;
