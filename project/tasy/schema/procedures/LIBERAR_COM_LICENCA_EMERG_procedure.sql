...
CREATE OR REPLACE PROCEDURE liberar_com_licenca_emerg ( nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE liberar_com_licenca_emerg ( nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
