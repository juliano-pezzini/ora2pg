...
CREATE OR REPLACE PROCEDURE calcular_min_dur_agenda_proc (cd_estabelecimento_p bigint, cd_perfil_p bigint, nm_usuario_p text, nr_seq_agenda_p bigint, ie_ajustar_min_p INOUT text, ds_ajustar_min_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE calcular_min_dur_agenda_proc (cd_estabelecimento_p bigint, cd_perfil_p bigint, nm_usuario_p text, nr_seq_agenda_p bigint, ie_ajustar_min_p INOUT text, ds_ajustar_min_p INOUT text) FROM PUBLIC;
