...
CREATE OR REPLACE PROCEDURE fis_gerar_reg_1900_efd ( nr_seq_controle_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, dt_inicio_p timestamp, dt_fim_p timestamp, cd_empresa_p bigint, ds_separador_p text, qt_linha_p INOUT bigint, nr_sequencia_p INOUT bigint) AS $body$
DECLARE
...
c01 CURSOR FOR 
	SELECT	'1900' tp_registro, 
		...
		'01' cd_cst_pis, 
		'01' cd_cst_cofins, 
		CASE WHEN obter_dados_pf_pj(n.cd_pessoa_fisica,n.cd_cgc,'UF')=sg_estado_w THEN '5933'  ELSE '6933' END  cd_cfop, 
		'' ds_info_compl, 
		'' cd_conta_contabil 
	from	nota_fiscal n, 
		operacao_nota o, 
	...
	group by CASE WHEN obter_dados_pf_pj(n.cd_pessoa_fisica,n.cd_cgc,'UF')=sg_estado_w THEN '5933'  ELSE '6933' END;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fis_gerar_reg_1900_efd ( nr_seq_controle_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, dt_inicio_p timestamp, dt_fim_p timestamp, cd_empresa_p bigint, ds_separador_p text, qt_linha_p INOUT bigint, nr_sequencia_p INOUT bigint) FROM PUBLIC;
