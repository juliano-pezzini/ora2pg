...
CREATE OR REPLACE PROCEDURE limpar_tabela_log_tasy_tipo () AS $body$
DECLARE
...
CALL gravar_processo_longo('Vetor Principal', 'LIMPAR_TABELA_LOG_TASY_TIPO', -1);
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	CALL gravar_processo_longo('LOG_TASY','LIMPAR_TABELA_LOG_TASY_TIPO',-1);
	...
	for i in 1..Vetor_c01_w.COUNT loop
		...
		CALL gravar_processo_longo('Removendo LOG_TASY -> ' || i || '/' || Vetor_c01_w.COUNT,'LIMPAR_TABELA_LOG_TASY_TIPO',-1);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE limpar_tabela_log_tasy_tipo () FROM PUBLIC;
