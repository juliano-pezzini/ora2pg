...
CREATE OR REPLACE PROCEDURE ptu_envio_ordem_servico_v60 ( nr_seq_ordem_p ptu_requisicao_ordem_serv.nr_sequencia%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p Usuario.nm_usuario%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_envio_ordem_servico_v60 ( nr_seq_ordem_p ptu_requisicao_ordem_serv.nr_sequencia%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p Usuario.nm_usuario%type) FROM PUBLIC;
