...
CREATE OR REPLACE PROCEDURE inserir_regra_alocacao (nr_seq_origem_p bigint, cd_estabelecimento_p bigint, cd_setor_atendimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE inserir_regra_alocacao (nr_seq_origem_p bigint, cd_estabelecimento_p bigint, cd_setor_atendimento_p bigint, nm_usuario_p text) FROM PUBLIC;
