...
CREATE OR REPLACE PROCEDURE nut_gerar_cardapio_protocolo2 ( nr_seq_protocolo_p bigint, ie_terceirizado_p text, dt_vigencia_inicial_p timestamp, dt_vigencia_final_p timestamp, ie_semana_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE nut_gerar_cardapio_protocolo2 ( nr_seq_protocolo_p bigint, ie_terceirizado_p text, dt_vigencia_inicial_p timestamp, dt_vigencia_final_p timestamp, ie_semana_p text) FROM PUBLIC;
