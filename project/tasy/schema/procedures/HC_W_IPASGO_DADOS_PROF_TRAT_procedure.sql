...
CREATE OR REPLACE PROCEDURE hc_w_ipasgo_dados_prof_trat ( nr_interno_conta_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text, nr_seq_tipo_fatura_p bigint, qt_linha_arq_p INOUT bigint, qt_linha_atend_p INOUT bigint) AS $body$
DECLARE
...
SELECT	sum(CASE WHEN Obter_Conversao_Externa(null,'W_IPASGO_DADOS_PROF_TRAT','CD_FUNCAO',a.ie_funcao)=3 THEN     	(coalesce(((b.qt_procedimento * 			Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDE')) * 				(b.tx_procedimento/100)),0)*0.3)  ELSE (coalesce(((b.qt_procedimento * 			Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDE')) * 				(b.tx_procedimento/100)),0)*0.2) END ) vl_procedimento,	
	a.ie_funcao,
	a.cd_pessoa_fisica,
	sum(b.qt_procedimento),
	b.dt_procedimento,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hc_w_ipasgo_dados_prof_trat ( nr_interno_conta_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text, nr_seq_tipo_fatura_p bigint, qt_linha_arq_p INOUT bigint, qt_linha_atend_p INOUT bigint) FROM PUBLIC;
