...
CREATE OR REPLACE PROCEDURE gera_sinal_vital_philips ( cd_pessoa_fisica_p text, nm_usuario_p text, dt_sinal_vital_p text, qt_freq_cardiaca_p bigint,     --HR 
