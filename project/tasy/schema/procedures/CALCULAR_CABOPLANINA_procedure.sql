...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE calcular_caboplanina ( nr_seq_paciente_p bigint, qt_peso_p bigint, qt_altura_p bigint, qt_porcent_reducao_p bigint, qt_creatinina_p bigint, ie_unid_med_p bigint, auc_p bigint, qt_clearance_p INOUT bigint, qt_carboplatina_p INOUT bigint) FROM PUBLIC;
