...
CREATE OR REPLACE PROCEDURE insere_exame_lista_medico ( nm_usuario_p text, nr_seq_lista_p bigint, nr_prescricao_p bigint, nr_sequencia_prescricao_p bigint) AS $body$
DECLARE
...
BEGIN
  ...
  SELECT nextval('lista_central_exame_seq')
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE insere_exame_lista_medico ( nm_usuario_p text, nr_seq_lista_p bigint, nr_prescricao_p bigint, nr_sequencia_prescricao_p bigint) FROM PUBLIC;
