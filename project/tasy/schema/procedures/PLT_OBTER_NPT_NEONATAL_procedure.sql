...
CREATE OR REPLACE PROCEDURE plt_obter_npt_neonatal ( nm_usuario_p text, nr_atendimento_p bigint, dt_inicial_horarios_p timestamp, dt_final_horarios_p timestamp, dt_validade_limite_p timestamp, ie_prescr_usuario_p text, nr_seq_regra_p bigint) AS $body$
DECLARE
...
ds_cor_titulo_w	:= plt_obter_se_item_marcado('NPN', nr_seq_regra_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE plt_obter_npt_neonatal ( nm_usuario_p text, nr_atendimento_p bigint, dt_inicial_horarios_p timestamp, dt_final_horarios_p timestamp, dt_validade_limite_p timestamp, ie_prescr_usuario_p text, nr_seq_regra_p bigint) FROM PUBLIC;
