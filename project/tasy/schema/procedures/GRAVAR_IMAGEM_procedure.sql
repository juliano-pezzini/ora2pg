...
CREATE OR REPLACE PROCEDURE gravar_imagem ( nr_sequencia_p bigint, ds_titulo_p text, ds_arquivo_p text, ds_arquivo_backup_p text, ds_extensao_p text, nm_usuario_p text, nm_tabela_p text, cd_estabelecimento_p bigint, nm_arquivo_ret_p INOUT text, ds_AuxPk_p text default null, ie_atualiza_p text default 'N') AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gravar_imagem ( nr_sequencia_p bigint, ds_titulo_p text, ds_arquivo_p text, ds_arquivo_backup_p text, ds_extensao_p text, nm_usuario_p text, nm_tabela_p text, cd_estabelecimento_p bigint, nm_arquivo_ret_p INOUT text, ds_AuxPk_p text default null, ie_atualiza_p text default 'N') FROM PUBLIC;
