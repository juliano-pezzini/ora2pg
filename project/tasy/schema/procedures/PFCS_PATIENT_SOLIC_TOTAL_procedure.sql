...
CREATE OR REPLACE PROCEDURE pfcs_patient_solic_total ( nr_seq_indicator_p bigint, cd_estabelecimento_p text, nm_usuario_p text) AS $body$
DECLARE
    ...
    where
        ...
        and ser.cd_service IN ('E0401','E0402')
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_patient_solic_total ( nr_seq_indicator_p bigint, cd_estabelecimento_p text, nm_usuario_p text) FROM PUBLIC;
