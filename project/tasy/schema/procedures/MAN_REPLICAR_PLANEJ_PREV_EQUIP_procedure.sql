...
CREATE OR REPLACE PROCEDURE man_replicar_planej_prev_equip ( nr_seq_planej_prev_p bigint, nr_seq_equipamento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE man_replicar_planej_prev_equip ( nr_seq_planej_prev_p bigint, nr_seq_equipamento_p bigint, nm_usuario_p text) FROM PUBLIC;
