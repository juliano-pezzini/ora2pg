...
CREATE OR REPLACE PROCEDURE gerar_d301_conteudo_verl (nr_seq_dataset_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SELECT 	'DAU+'||
	...
	cd_cid_sec_afastamento||CASE WHEN coalesce(NR_SEQ_301_LOCAL_SEC::text, '') = '' THEN null  ELSE ':' END ||obter_descricao_padrao('C301_16_LOCALIZACAO','IE_LOCALIZACAO',NR_SEQ_301_LOCAL_SEC) ||'+'||
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_d301_conteudo_verl (nr_seq_dataset_p bigint, nm_usuario_p text) FROM PUBLIC;
