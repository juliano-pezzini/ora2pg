...
CREATE OR REPLACE PROCEDURE atualizar_atend_aval_srpa ( nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_atend_aval_srpa ( nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
