...
CREATE OR REPLACE PROCEDURE gerar_w_envio_dctf_19 ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
ie_tipo_registro,
	...
	substr(obter_compl_pf(c.cd_contabilista,1,'DDT'),1,3) nr_ddd_telefone_resp,
	substr(somente_numero(obter_dados_pf_pj(c.cd_contabilista,null,'T')), (LENGTH(somente_numero(obter_dados_pf_pj(c.cd_contabilista,null,'T')))
-7),
(LENGTH(somente_numero(obter_dados_pf_pj(c.cd_contabilista,null,'T')))
))	nr_telefone_resp,
	substr(obter_compl_pf(c.cd_contabilista,1,'RAM'),1,5) nr_ramal_resp,
	substr(obter_compl_pf(c.cd_contabilista,1,'DDF'),1,3) nr_ddd_fax_resp,
...
SELECT	distinct
	...
	g.ie_grupo_tributo
	nr_grupo_tributo,
	d.cd_darf || coalesce(i.cd_variacao,f.cd_variacao)	cd_receita,
	coalesce(i.ie_periodicidade,f.ie_periodicidade) ds_periodicidade,
...
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_sequencia		= c.nr_seq_lote and c.nr_seq_darf		= d.nr_sequencia and d.nr_sequencia		= e.nr_seq_darf  and (f.cd_tributo		= g.cd_tributo or i.cd_tributo = g.cd_tributo) and h.cd_estabelecimento	= b.cd_estabelecimento and e.nr_titulo		= i.nr_titulo and h.nr_sequencia		= (select	max(x.nr_sequencia)
	...
	d.cd_darf,
	a.ie_spc_inc,
	coalesce(i.cd_variacao,f.cd_variacao),
	...
	coalesce(i.ie_periodicidade,f.ie_periodicidade),
	b.cd_cgc,
	g.ie_grupo_tributo,
...
LEFT OUTER JOIN titulo_pagar_imposto f ON (i.nr_seq_tributo = f.nr_sequencia)
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_sequencia		= c.nr_seq_lote and c.nr_seq_darf		= d.nr_sequencia and d.nr_sequencia		= e.nr_seq_darf and e.nr_titulo		= i.nr_titulo  and (f.cd_tributo		= g.cd_tributo or i.cd_tributo = g.cd_tributo) and a.nr_sequencia		= nr_seq_lote_p and a.ie_agrupar_titulos	= 'S' and d.cd_darf||coalesce(i.cd_variacao,f.cd_variacao)	= cd_receita_w and CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END  	= dt_apuracao_mensal_w and CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END  = dt_apuracao_diario_w group by 	a.nr_sequencia,
	b.cd_cgc,
	a.ie_finalidade_dctf,
	TRUNC(a.dt_referencia,'mm'),
	trunc(fim_mes(a.dt_referencia),'dd'),
	...
	TRUNC(a.dt_referencia,'mm'),
	g.ie_grupo_tributo,
	d.cd_darf||coalesce(i.cd_variacao,f.cd_variacao),
	coalesce(i.ie_periodicidade,f.ie_periodicidade),
	a.dt_referencia,
	CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END ,
	CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END ,
...
LEFT OUTER JOIN titulo_pagar_imposto f ON (i.nr_seq_tributo = f.nr_sequencia)
WHERE a.cd_estabelecimento	= b.cd_estabelecimento AND a.nr_sequencia		= c.nr_seq_lote AND c.nr_seq_darf		= d.nr_sequencia AND d.nr_sequencia		= e.nr_seq_darf AND e.nr_titulo		= i.nr_titulo   AND (f.cd_tributo		= g.cd_tributo OR i.cd_tributo = g.cd_tributo) AND a.nr_sequencia		= nr_seq_lote_p and a.ie_agrupar_titulos	= 'N' AND d.cd_darf||coalesce(i.cd_variacao,f.cd_variacao)	= cd_receita_w AND CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END  	= dt_apuracao_mensal_w AND CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END  = dt_apuracao_diario_w GROUP BY 	a.nr_sequencia,
	b.cd_cgc,
	a.ie_finalidade_dctf,
	TRUNC(a.dt_referencia,'mm'),
	TRUNC(fim_mes(a.dt_referencia),'dd'),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_envio_dctf_19 ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
