...
CREATE OR REPLACE PROCEDURE gerar_cobr_bradesco_400_br_v06 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
if (cd_banco_w <> cd_banco_cobr_w) then 
	/*'o banco do arquivo é diferente do banco da cobrança no sistema!' || chr(10) || chr(13) || 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobr_bradesco_400_br_v06 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
