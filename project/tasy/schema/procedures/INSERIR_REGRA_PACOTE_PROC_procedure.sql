...
CREATE OR REPLACE PROCEDURE inserir_regra_pacote_proc ( nr_seq_secretaria_p bigint, nm_usuario_p text, nr_seq_pacote_p bigint default null) AS $body$
DECLARE
...
ie_registro_repetido	varchar(1);
...
if (coalesce(nr_seq_pacote_p::text, '') = '') then
...
fetch c01 into 	nr_seq_ficha_w,
	...
	EXIT WHEN NOT FOUND; /* apply on c02 */
		...
		into STRICT	ie_registro_repetido
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE inserir_regra_pacote_proc ( nr_seq_secretaria_p bigint, nm_usuario_p text, nr_seq_pacote_p bigint default null) FROM PUBLIC;
