...
CREATE OR REPLACE PROCEDURE importar_ext_cartao_visa_elec (nr_seq_extrato_p bigint, nm_usuario_p text) AS $body$
DECLARE


/*
procedure utilizada para importação da "Cielo Extrato Eletrônico - Conciliação Contábil e Financeira"
OS Ref 325070
*/
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (ie_tipo_registro_w = '1') then
		...
		if (ie_status_w = '14') and (ie_debito_w = 'S') then
		...
		elsif (ie_status_w = '12') and (ie_debito_w = 'S') then
	...
	elsif (ie_tipo_registro_w = '2') and (ie_resumo_debito_w = 'S')  then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE importar_ext_cartao_visa_elec (nr_seq_extrato_p bigint, nm_usuario_p text) FROM PUBLIC;
