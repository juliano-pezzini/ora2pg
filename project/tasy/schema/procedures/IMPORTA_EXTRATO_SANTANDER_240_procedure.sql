...
CREATE OR REPLACE PROCEDURE importa_extrato_santander_240 ( nr_seq_extrato_p bigint) AS $body$
DECLARE


/* Layout CNAB Versão 8.0 de fevereiro de 2006 */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE importa_extrato_santander_240 ( nr_seq_extrato_p bigint) FROM PUBLIC;
