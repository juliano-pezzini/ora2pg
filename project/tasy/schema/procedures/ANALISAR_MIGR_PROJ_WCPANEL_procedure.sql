...
CREATE OR REPLACE PROCEDURE analisar_migr_proj_wcpanel ( cd_funcao_p bigint, nm_objeto_p text, ie_impl_after_open_p text, ie_impl_after_scroll_p text, ie_impl_before_post_p text, ie_impl_dbclick_p text, ie_impl_draw_column_cell_p text, ie_impl_enter_p text, ie_impl_exit_p text, ie_impl_abrir_consulta_p text, ie_impl_fechar_consulta_p text, ie_impl_keypress_p text, nm_usuario_p text, ds_objeto_p text default '') AS $body$
DECLARE
...
if (ie_impl_abrir_consulta_p = 'S') then
	begin
	qt_tempo_desenv_w := qt_tempo_desenv_w + qt_impl_abrir_consulta_w;
	end;
end if;
if (ie_impl_fechar_consulta_p = 'S') then
	begin
	qt_tempo_desenv_w := qt_tempo_desenv_w + qt_impl_fechar_consulta_w;
	end;
end if;
...
values (
	...
	ie_impl_enter_p,
	ie_impl_exit_p,
	ie_impl_abrir_consulta_p,
	ie_impl_fechar_consulta_p,
	ie_impl_keypress_p,
	qt_tempo_desenv_w);
commit;
end;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE analisar_migr_proj_wcpanel ( cd_funcao_p bigint, nm_objeto_p text, ie_impl_after_open_p text, ie_impl_after_scroll_p text, ie_impl_before_post_p text, ie_impl_dbclick_p text, ie_impl_draw_column_cell_p text, ie_impl_enter_p text, ie_impl_exit_p text, ie_impl_abrir_consulta_p text, ie_impl_fechar_consulta_p text, ie_impl_keypress_p text, nm_usuario_p text, ds_objeto_p text default '') FROM PUBLIC;
