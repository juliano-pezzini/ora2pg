...
CREATE OR REPLACE PROCEDURE ws_regist_prescr_proc_mat_item ( nr_seq_grupo_mat_p bigint, nr_prescricao_p bigint, nr_seq_prescr_p bigint, cd_barras_p text, nm_usuario_p text, cd_erro_p INOUT text, ds_erro_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ws_regist_prescr_proc_mat_item ( nr_seq_grupo_mat_p bigint, nr_prescricao_p bigint, nr_seq_prescr_p bigint, cd_barras_p text, nm_usuario_p text, cd_erro_p INOUT text, ds_erro_p INOUT text) FROM PUBLIC;
