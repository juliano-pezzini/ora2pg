...
CREATE OR REPLACE PROCEDURE obter_valor_dinamico_char_bv ( ds_comando_p text, ds_parametros_p text, ds_Retorno_P INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE obter_valor_dinamico_char_bv ( ds_comando_p text, ds_parametros_p text, ds_Retorno_P INOUT text) FROM PUBLIC;
