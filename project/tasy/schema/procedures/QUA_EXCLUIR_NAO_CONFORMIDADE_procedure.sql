...
CREATE OR REPLACE PROCEDURE qua_excluir_nao_conformidade (nr_sequencia_p bigint) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE qua_excluir_nao_conformidade (nr_sequencia_p bigint) FROM PUBLIC;
