...
CREATE OR REPLACE PROCEDURE intcom_gerar_int_alter_oc ( nr_ordem_compra_p bigint, ds_xml_p text, nm_usuario_p text, nr_Sequencia_p INOUT bigint) AS $body$
DECLARE
...
values (	nextval('ordem_compra_hist_seq'), 
	...
	nm_usuario_p, 
	clock_timestamp(), 
	wheb_mensagem_pck.get_texto(303507), 
	wheb_mensagem_pck.get_texto(303508), 
	clock_timestamp(), 
	nm_usuario_p, 
	'S', 
	clock_timestamp());	
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE intcom_gerar_int_alter_oc ( nr_ordem_compra_p bigint, ds_xml_p text, nm_usuario_p text, nr_Sequencia_p INOUT bigint) FROM PUBLIC;
