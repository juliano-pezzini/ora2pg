...
CREATE OR REPLACE PROCEDURE reg_inactivate_program_prs ( nr_seq_requirement_p bigint, ds_reason_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE reg_inactivate_program_prs ( nr_seq_requirement_p bigint, ds_reason_p text, nm_usuario_p text) FROM PUBLIC;
