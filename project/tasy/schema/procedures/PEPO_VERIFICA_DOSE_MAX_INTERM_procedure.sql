...
CREATE OR REPLACE PROCEDURE pepo_verifica_dose_max_interm (NR_SEQUENCIA_P CIRURGIA_AGENTE_ANESTESICO.NR_SEQUENCIA%TYPE, NR_ATENDIMENTO_P ATENDIMENTO_PACIENTE.NR_ATENDIMENTO%TYPE, DT_INICIO_P CIRURGIA_AGENTE_ANEST_OCOR.DT_INICIO_ADM%TYPE, QT_DOSE_P CIRURGIA_AGENTE_ANEST_OCOR.QT_DOSE%TYPE, DS_DOSE_P CIRURGIA_AGENTE_ANESTESICO.CD_UNID_MEDIDA_ADM%TYPE, NR_MAT_PRESCR_P INOUT MATERIAL_PRESCR.NR_SEQUENCIA%TYPE, IE_JUSTIFICATIVA_P INOUT MATERIAL_PRESCR.IE_JUSTIFICATIVA%TYPE) AS $body$
DECLARE
...
BEGIN
  ...
  IF coalesce(NR_SEQUENCIA_P, 0) > 0 THEN
    ...
    IF (cd_material_w IS NOT NULL AND cd_material_w::text <> '') THEN
      ...
      cd_unid_cons_w := obter_dados_material_estab(cd_material_w, wheb_usuario_pck.get_cd_estabelecimento, 'UMS');
        ...
        EXIT WHEN r01.count = 0;
          ...
          FOR i IN 1..r01.count LOOP
            IF coalesce(NR_MAT_PRESCR_P::text, '') = '' THEN
              ...
              qt_dose_w := obter_dose_convertida(cd_material_w, qt_dose_p, ds_dose_p, cd_unid_cons_w);
              qt_dose_max_w := obter_dose_convertida(cd_material_w, r01[i].qt_limite_pessoa, r01[i].cd_unid_med_limite, cd_unid_cons_w);
              ...
              IF r01[i].ie_dose_limite = 'DIA' or (qt_peso_w > 0 and r01[i].ie_dose_limite = 'KG/DIA') THEN
                select sum(qt_dose) + qt_dose_w
                  ...
                  from (SELECT coalesce(sum(obter_dose_convertida(a.cd_material,
                                                             b.qt_dose,
                                                             coalesce(b.cd_unid_med, a.cd_unid_medida_adm, a.cd_unidade_medida, cd_unid_cons_w), 
                                                             cd_unid_cons_w)),
                                   0) qt_dose
...
union
                        ...
                        SELECT coalesce(sum(obter_dose_convertida(b.cd_material,
                         ...
                         where a.nr_prescricao = b.nr_prescricao
                           ...
                           and trunc(c.dt_horario, 'dd') = trunc(dt_inicio_p, 'dd')) alias21;
...
union
                        ...
                        SELECT coalesce(sum(obter_dose_convertida(b.cd_material,
                         ...
                         where a.nr_prescricao = b.nr_prescricao
                           ...
                           and coalesce(b.ie_suspenso, 'N') = 'N'
                           and coalesce(c.dt_suspensao::text, '') = ''
                           and coalesce(c.ie_situacao, 'A') = 'A') alias15;
...
union
                        ...
                        SELECT coalesce(sum(obter_dose_convertida(b.cd_material,
                         ...
                         where a.nr_prescricao = b.nr_prescricao
                           ...
                           and coalesce(c.dt_suspensao::text, '') = ''
                           and coalesce(c.ie_situacao, 'A') = 'A'
						   and c.dt_horario between(dt_inicio_p - interval '1' hour * r01[i].qt_intervalo_horas) and dt_inicio_p) alias21;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pepo_verifica_dose_max_interm (NR_SEQUENCIA_P CIRURGIA_AGENTE_ANESTESICO.NR_SEQUENCIA%TYPE, NR_ATENDIMENTO_P ATENDIMENTO_PACIENTE.NR_ATENDIMENTO%TYPE, DT_INICIO_P CIRURGIA_AGENTE_ANEST_OCOR.DT_INICIO_ADM%TYPE, QT_DOSE_P CIRURGIA_AGENTE_ANEST_OCOR.QT_DOSE%TYPE, DS_DOSE_P CIRURGIA_AGENTE_ANESTESICO.CD_UNID_MEDIDA_ADM%TYPE, NR_MAT_PRESCR_P INOUT MATERIAL_PRESCR.NR_SEQUENCIA%TYPE, IE_JUSTIFICATIVA_P INOUT MATERIAL_PRESCR.IE_JUSTIFICATIVA%TYPE) FROM PUBLIC;
