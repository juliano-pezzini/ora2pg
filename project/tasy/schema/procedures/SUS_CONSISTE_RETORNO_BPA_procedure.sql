...
CREATE OR REPLACE PROCEDURE sus_consiste_retorno_bpa ( nr_atendimento_p bigint, ds_mensagem_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE sus_consiste_retorno_bpa ( nr_atendimento_p bigint, ds_mensagem_p INOUT text) FROM PUBLIC;
