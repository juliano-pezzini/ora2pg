...
CREATE OR REPLACE PROCEDURE gerar_lote_producao_opme_ws ( nr_ficha_tecnica_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, cd_local_estoque_p bigint, nr_lote_producao_p INOUT bigint, nr_prescricao_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_lote_producao_opme_ws ( nr_ficha_tecnica_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, cd_local_estoque_p bigint, nr_lote_producao_p INOUT bigint, nr_prescricao_p bigint) FROM PUBLIC;
