...
CREATE OR REPLACE PROCEDURE consulta_valor_pacote (nr_seq_pacote_p bigint, cd_tipo_acomodacao_p bigint, nm_usuario_p text, dt_vigencia_p timestamp, cd_categoria_p text, cd_plano_p text, qt_idade_p bigint, ie_clinica_p bigint default null, ie_tipo_anestesia_p text DEFAULT NULL, cd_setor_atendimento_p bigint DEFAULT NULL, vl_pacote_p INOUT bigint DEFAULT NULL, vl_honorario_p INOUT bigint DEFAULT NULL, vl_anestesista_p INOUT bigint DEFAULT NULL, vl_auxiliares_p INOUT bigint DEFAULT NULL, vl_materiais_p INOUT bigint DEFAULT NULL, nr_sequencia_p INOUT bigint DEFAULT NULL) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE consulta_valor_pacote (nr_seq_pacote_p bigint, cd_tipo_acomodacao_p bigint, nm_usuario_p text, dt_vigencia_p timestamp, cd_categoria_p text, cd_plano_p text, qt_idade_p bigint, ie_clinica_p bigint default null, ie_tipo_anestesia_p text DEFAULT NULL, cd_setor_atendimento_p bigint DEFAULT NULL, vl_pacote_p INOUT bigint DEFAULT NULL, vl_honorario_p INOUT bigint DEFAULT NULL, vl_anestesista_p INOUT bigint DEFAULT NULL, vl_auxiliares_p INOUT bigint DEFAULT NULL, vl_materiais_p INOUT bigint DEFAULT NULL, nr_sequencia_p INOUT bigint DEFAULT NULL) FROM PUBLIC;
