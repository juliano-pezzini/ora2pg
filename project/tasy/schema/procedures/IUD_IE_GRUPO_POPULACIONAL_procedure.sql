...
CREATE OR REPLACE PROCEDURE iud_ie_grupo_populacional ( cd_pessoa_fisica_p PESSOA_FISICA.CD_PESSOA_FISICA%type, nm_usuario_p PESSOA_FISICA_AUX.NM_USUARIO%type, operation_type_p text, ie_grupo_populacional_p PESSOA_FISICA_AUX.IE_GRUPO_POPULACIONAL%type default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE iud_ie_grupo_populacional ( cd_pessoa_fisica_p PESSOA_FISICA.CD_PESSOA_FISICA%type, nm_usuario_p PESSOA_FISICA_AUX.NM_USUARIO%type, operation_type_p text, ie_grupo_populacional_p PESSOA_FISICA_AUX.IE_GRUPO_POPULACIONAL%type default null) FROM PUBLIC;
