...
CREATE OR REPLACE PROCEDURE gerar_requisicao_protocolo_req ( cd_estabelecimento_p bigint, nm_usuario_p text, nr_sequencia_p bigint, cd_pessoa_req_p bigint, nr_requisicao_p INOUT bigint) AS $body$
DECLARE
...
SELECT	a.nr_sequencia, 
	coalesce(cd_pessoa_req_p,a.cd_pessoa_requisitante), 
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (ie_forma_w = 'R') then 
		...
		nr_requisicao_w := gravar_requisicao_material( 
			cd_estabelecimento_p, null, null, null, cd_local_estoque_destino_w, cd_local_estoque_w, null, cd_pessoa_requisitante_w, nm_usuario_p, ie_prescr_cirurgia_w, ie_lancado_cirurgia_w, ie_agenda_cirurgica_w, ie_mat_comercial_w, ie_saldo_maior_igual_min_w, 'N', 'N', 'N', 'N', 'X', null, null, null, null, null, null, ie_controlado_w, 'A', 'N', 'D', 'N', 'N', '0', null, 'N', 'N', qt_itens_desdobra_req_w, null, 'N', 'N', nr_requisicao_w);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_requisicao_protocolo_req ( cd_estabelecimento_p bigint, nm_usuario_p text, nr_sequencia_p bigint, cd_pessoa_req_p bigint, nr_requisicao_p INOUT bigint) FROM PUBLIC;
