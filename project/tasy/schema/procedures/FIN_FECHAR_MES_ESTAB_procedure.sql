...
CREATE OR REPLACE PROCEDURE fin_fechar_mes_estab ( dt_referencia_p timestamp, cd_estabelecimento_p bigint, nm_usuario_p text, permite_abrir_estab_p text, ie_cp_cr_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fin_fechar_mes_estab ( dt_referencia_p timestamp, cd_estabelecimento_p bigint, nm_usuario_p text, permite_abrir_estab_p text, ie_cp_cr_p text) FROM PUBLIC;
