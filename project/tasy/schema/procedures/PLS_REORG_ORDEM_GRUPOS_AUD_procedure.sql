...
CREATE OR REPLACE PROCEDURE pls_reorg_ordem_grupos_aud ( nr_seq_ordem_p bigint, nr_seq_grupo_adcionado_p bigint, nr_seq_auditoria_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
nr_contador_w			pls_auditoria_grupo.nr_seq_ordem%type := 0;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_reorg_ordem_grupos_aud ( nr_seq_ordem_p bigint, nr_seq_grupo_adcionado_p bigint, nr_seq_auditoria_p bigint, nm_usuario_p text) FROM PUBLIC;
