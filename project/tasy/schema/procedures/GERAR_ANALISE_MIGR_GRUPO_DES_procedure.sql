...
CREATE OR REPLACE PROCEDURE gerar_analise_migr_grupo_des ( nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_analise_migr_grupo_des ( nm_usuario_p text) FROM PUBLIC;
