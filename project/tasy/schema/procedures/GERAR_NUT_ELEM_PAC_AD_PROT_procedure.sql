...
CREATE OR REPLACE PROCEDURE gerar_nut_elem_pac_ad_prot ( nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_nut_elem_pac_ad_prot ( nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
