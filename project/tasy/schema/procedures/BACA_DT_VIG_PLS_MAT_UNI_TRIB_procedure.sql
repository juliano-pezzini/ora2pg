...
CREATE OR REPLACE PROCEDURE baca_dt_vig_pls_mat_uni_trib () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_pls_mat_uni_trib () FROM PUBLIC;
