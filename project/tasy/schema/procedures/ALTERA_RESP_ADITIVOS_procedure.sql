...
CREATE OR REPLACE PROCEDURE altera_resp_aditivos ( nr_sequencia_p bigint, cd_pessoa_resp_p text, nm_usuario_p text) AS $body$
DECLARE
...
where	nr_sequencia	= nr_sequencia_p;
 ...
 open c01;
	  ...
	  begin 
			...
			ds_historico_w	:= substr(wheb_mensagem_pck.get_texto(315109,	'CD_PESSOA_RESP_VELHA_W='||CD_PESSOA_RESP_VELHA_W||';DS_PESSOA_RESP_VELHA_W='||DS_PESSOA_RESP_VELHA_W|| 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE altera_resp_aditivos ( nr_sequencia_p bigint, cd_pessoa_resp_p text, nm_usuario_p text) FROM PUBLIC;
