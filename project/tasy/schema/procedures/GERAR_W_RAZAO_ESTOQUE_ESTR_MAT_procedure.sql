...
CREATE OR REPLACE PROCEDURE gerar_w_razao_estoque_estr_mat ( cd_estabelecimento_p bigint, dt_mesano_referencia_p timestamp, dt_mesano_referencia_fim_p timestamp, cd_local_estoque_p bigint, dt_inicio_movto_p timestamp, dt_fim_movto_p timestamp, cd_material_p bigint, cd_grupo_material_p bigint, cd_subgrupo_material_p bigint, cd_classe_material_p bigint, nm_usuario_p text, ie_movimento_p text, ie_ordem_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_razao_estoque_estr_mat ( cd_estabelecimento_p bigint, dt_mesano_referencia_p timestamp, dt_mesano_referencia_fim_p timestamp, cd_local_estoque_p bigint, dt_inicio_movto_p timestamp, dt_fim_movto_p timestamp, cd_material_p bigint, cd_grupo_material_p bigint, cd_subgrupo_material_p bigint, cd_classe_material_p bigint, nm_usuario_p text, ie_movimento_p text, ie_ordem_p text) FROM PUBLIC;
