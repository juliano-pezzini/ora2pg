...
CREATE OR REPLACE PROCEDURE baixar_concil_cartao_cielo (nr_seq_extrato_arq_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baixar_concil_cartao_cielo (nr_seq_extrato_arq_p bigint, nm_usuario_p text) FROM PUBLIC;
