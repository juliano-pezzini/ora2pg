...
CREATE OR REPLACE PROCEDURE gerar_pagto_febraban_240_v101 ( nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE


/* PADRAO CNAB 240 VERSAO 8.7 DE 21/09/2012 
Essa rotina foi criada para atender as necessidades da OS 962999, baseado no layout da procedure GERAR_PAGTO_FEBRABAN_240_V86 */
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	EXIT WHEN NOT FOUND; /* apply on c02 */
		...
		if (qt_favorecido_w > 0) then
			...
			cd_agencia_bancaria_w := cd_agencia_bancaria_w || ie_digito_agencia_w;
		...
		ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||
					...
					cd_camara_w ||
					lpad(cd_banco_w,3,'0') ||
					upper(cd_agencia_bancaria_w) ||
					lpad(substr(nr_conta_w,1,12),12,'0') ||
					upper(ie_digito_conta_w) ||
					' ' ||
					nm_pessoa_w ||
					rpad(nr_titulo_w,20,' ') ||
...
EXIT WHEN NOT FOUND; /* apply on c03 */
	...
	ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') || /*Pos 01 a 03*/
				lpad(nr_lote_servico_w,4,'0') || /*Pos 04 a 07*/
				'1' || /*POS 8*/
				'C' || /*POs 09*/
				ie_tipo_servico_w || /*Pos 10 a 11*/
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pagto_febraban_240_v101 ( nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
