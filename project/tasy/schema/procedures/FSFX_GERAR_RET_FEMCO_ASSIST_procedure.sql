...
CREATE OR REPLACE PROCEDURE fsfx_gerar_ret_femco_assist ( ds_linha_p text, nr_seq_cobranca_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
vl_registro_w		:= (substr(ds_linha_w,23,13))::numeric;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fsfx_gerar_ret_femco_assist ( ds_linha_p text, nr_seq_cobranca_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
