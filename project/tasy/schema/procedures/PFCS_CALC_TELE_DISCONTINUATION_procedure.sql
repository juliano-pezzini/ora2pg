...
CREATE OR REPLACE PROCEDURE pfcs_calc_tele_discontinuation ( nr_seq_indicator_p bigint, cd_estabelecimento_p text, nm_usuario_p text) AS $body$
DECLARE
...
BEGIN
	...
	select qt_time_on_tele__rule into STRICT qt_time_telemetry_rule_w  from pfcs_telemetry_config;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_calc_tele_discontinuation ( nr_seq_indicator_p bigint, cd_estabelecimento_p text, nm_usuario_p text) FROM PUBLIC;
