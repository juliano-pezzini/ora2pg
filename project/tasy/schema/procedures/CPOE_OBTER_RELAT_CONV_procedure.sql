...
CREATE OR REPLACE PROCEDURE cpoe_obter_relat_conv (nr_atendimento_p bigint, cd_relatorio_p INOUT bigint, cd_classif_relat_p INOUT text) AS $body$
DECLARE
...
if (nr_atendimento_p IS NOT NULL AND nr_atendimento_p::text <> '') then
	...
	OPEN C01;
		...
		EXIT WHEN NOT FOUND; /* apply on c01 */
			...
			cd_classif_relat_w 	:= cd_classif_relat_w;
		END LOOP;
	CLOSE C01;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cpoe_obter_relat_conv (nr_atendimento_p bigint, cd_relatorio_p INOUT bigint, cd_classif_relat_p INOUT text) FROM PUBLIC;
