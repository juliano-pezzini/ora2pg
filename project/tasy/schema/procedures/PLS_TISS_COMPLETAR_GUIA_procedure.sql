...
CREATE OR REPLACE PROCEDURE pls_tiss_completar_guia ( nr_seq_guia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_tiss_completar_guia ( nr_seq_guia_p bigint, nm_usuario_p text) FROM PUBLIC;
