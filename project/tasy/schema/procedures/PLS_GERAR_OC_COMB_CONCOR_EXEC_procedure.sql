...
CREATE OR REPLACE PROCEDURE pls_gerar_oc_comb_concor_exec ( nr_seq_regra_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, nr_seq_execucao_p bigint, ie_gerar_ocorrencia_p INOUT text, ie_valida_proc_princ_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_oc_comb_concor_exec ( nr_seq_regra_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, nr_seq_execucao_p bigint, ie_gerar_ocorrencia_p INOUT text, ie_valida_proc_princ_p text) FROM PUBLIC;
