...
CREATE OR REPLACE PROCEDURE man_gerar_os_projeto ( nm_usuario_p text) AS $body$
DECLARE
...
C02 CURSOR FOR 
	...
	and	trunc(e.dt_inicio_prev) = trunc(clock_timestamp() + interval '1 days') 
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	EXIT WHEN NOT FOUND; /* apply on C02 */
		...
		if (ie_gera_ordem_auto_w <> 'N') then 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE man_gerar_os_projeto ( nm_usuario_p text) FROM PUBLIC;
