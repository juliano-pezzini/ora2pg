...
CREATE OR REPLACE PROCEDURE cpoe_consistir_dose_terap ( cd_estabelecimento_p bigint, nr_atendimento_p bigint, cd_setor_atendimento_p bigint, cd_pessoa_fisica_p text, cd_material_p bigint, qt_dose_p bigint, nr_unidade_terp_p bigint, qt_peso_p bigint, nm_usuario_p text, ie_acao_p INOUT text, ds_mensagem_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cpoe_consistir_dose_terap ( cd_estabelecimento_p bigint, nr_atendimento_p bigint, cd_setor_atendimento_p bigint, cd_pessoa_fisica_p text, cd_material_p bigint, qt_dose_p bigint, nr_unidade_terp_p bigint, qt_peso_p bigint, nm_usuario_p text, ie_acao_p INOUT text, ds_mensagem_p INOUT text) FROM PUBLIC;
