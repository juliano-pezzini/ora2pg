...
CREATE OR REPLACE PROCEDURE gerar_adm_processo_adep (nr_seq_processo_p bigint, nm_usuario_p text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_adm_processo_adep (nr_seq_processo_p bigint, nm_usuario_p text) FROM PUBLIC;
