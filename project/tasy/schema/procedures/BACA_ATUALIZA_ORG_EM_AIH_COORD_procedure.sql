...
CREATE OR REPLACE PROCEDURE baca_atualiza_org_em_aih_coord ( dt_inicial_p timestamp , dt_final_p timestamp ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_atualiza_org_em_aih_coord ( dt_inicial_p timestamp , dt_final_p timestamp ) FROM PUBLIC;
