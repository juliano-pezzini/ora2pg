...
CREATE OR REPLACE PROCEDURE gerar_comunic_agetasy_geral (nr_seq_agenda_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_comunic_agetasy_geral (nr_seq_agenda_p bigint, nm_usuario_p text) FROM PUBLIC;
