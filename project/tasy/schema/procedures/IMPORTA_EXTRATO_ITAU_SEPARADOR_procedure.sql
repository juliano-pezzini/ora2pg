...
CREATE OR REPLACE PROCEDURE importa_extrato_itau_separador ( nr_seq_extrato_p bigint) AS $body$
DECLARE
...
SELECT	to_date(substr(obter_valor_campo_separador(a.ds_conteudo,1,';'),1,255),'dd/mm/yyyy') dt_lancto, 
	...
	(substr(obter_valor_campo_separador(a.ds_conteudo,3,';'),1,255))::numeric  vl_lancto 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE importa_extrato_itau_separador ( nr_seq_extrato_p bigint) FROM PUBLIC;
