...
CREATE OR REPLACE PROCEDURE incluir_oc_nf_transf_entrada ( nr_seq_nf_p bigint, nr_ordem_compra_p bigint, cd_estabelecimento_p bigint, cd_local_estoque_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE incluir_oc_nf_transf_entrada ( nr_seq_nf_p bigint, nr_ordem_compra_p bigint, cd_estabelecimento_p bigint, cd_local_estoque_p bigint, nm_usuario_p text) FROM PUBLIC;
