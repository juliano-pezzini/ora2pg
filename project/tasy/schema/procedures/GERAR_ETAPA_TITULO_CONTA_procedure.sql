...
CREATE OR REPLACE PROCEDURE gerar_etapa_titulo_conta ( nr_interno_conta_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_etapa_titulo_conta ( nr_interno_conta_p bigint, nm_usuario_p text) FROM PUBLIC;
