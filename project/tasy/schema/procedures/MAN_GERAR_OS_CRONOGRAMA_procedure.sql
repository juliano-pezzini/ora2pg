...
CREATE OR REPLACE PROCEDURE man_gerar_os_cronograma ( nr_seq_cronograma_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
select	nr_sequencia, 
	...
	cd_estabelecimento, 
	cd_funcao, 
	substr(obter_usuario_pessoa(cd_coordenador),1,15), 
	cd_coordenador, 
	nr_seq_grupo_des 
...
and	nr_sequencia = nr_seq_projeto_w 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE man_gerar_os_cronograma ( nr_seq_cronograma_p bigint, nm_usuario_p text) FROM PUBLIC;
