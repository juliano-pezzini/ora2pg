...
CREATE OR REPLACE PROCEDURE pls_tiss_completar_req_guia ( nr_seq_tiss_guia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
qt_autorizada_w		pls_requisicao_mat.qt_material%type;
...
C02 CURSOR FOR
	SELECT	substr(pls_obter_desc_material(a.nr_seq_material),1,255) ds_material,
		coalesce(b.cd_material_ops,b.nr_sequencia),
		a.qt_material,
		a.qt_solicitado
	...
	and	c.nr_sequencia		= a.nr_seq_requisicao
...
begin
	...
	into STRICT	nr_seq_requisicao_w,
		...
		ie_tiss_tipo_guia_w
	from	w_tiss_guia
	where	nr_sequencia		= nr_seq_tiss_guia_p
...
if (ie_tiss_tipo_guia_w	= '2') then
	...
	where	nr_seq_guia	= nr_seq_tiss_guia_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_tiss_completar_req_guia ( nr_seq_tiss_guia_p bigint, nm_usuario_p text) FROM PUBLIC;
