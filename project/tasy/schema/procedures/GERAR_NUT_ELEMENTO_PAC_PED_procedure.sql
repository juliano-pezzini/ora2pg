...
CREATE OR REPLACE PROCEDURE gerar_nut_elemento_pac_ped ( NR_SEQUENCIA_P bigint, NM_USUARIO_P text) AS $body$
DECLARE
...
select	coalesce(max(qt_fase_npt),0)
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_nut_elemento_pac_ped ( NR_SEQUENCIA_P bigint, NM_USUARIO_P text) FROM PUBLIC;
