...
CREATE OR REPLACE PROCEDURE ptu_gerar_decurso_prazo_v50 ( nr_seq_guia_p pls_guia_plano.nr_sequencia%type, nr_seq_requisicao_p pls_requisicao.nr_sequencia%type, nm_usuario_p text, nr_seq_decurso_p INOUT ptu_decurso_prazo.nr_sequencia%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_decurso_prazo_v50 ( nr_seq_guia_p pls_guia_plano.nr_sequencia%type, nr_seq_requisicao_p pls_requisicao.nr_sequencia%type, nm_usuario_p text, nr_seq_decurso_p INOUT ptu_decurso_prazo.nr_sequencia%type) FROM PUBLIC;
