...
CREATE OR REPLACE PROCEDURE wsuite_update_view_exam (nr_seq_prescr_p bigint, nr_seq_prescr_item_p bigint, ds_login_p text, ie_tipo_item_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE wsuite_update_view_exam (nr_seq_prescr_p bigint, nr_seq_prescr_item_p bigint, ds_login_p text, ie_tipo_item_p text) FROM PUBLIC;
