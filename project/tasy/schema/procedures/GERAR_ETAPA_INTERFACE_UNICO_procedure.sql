...
CREATE OR REPLACE PROCEDURE gerar_etapa_interface_unico ( nr_seq_protocolo_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
C01 CURSOR FOR 
	...
	and (coalesce(ie_evento,'U') = coalesce(ie_evento_w,'U')) 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_etapa_interface_unico ( nr_seq_protocolo_p bigint, nm_usuario_p text) FROM PUBLIC;
