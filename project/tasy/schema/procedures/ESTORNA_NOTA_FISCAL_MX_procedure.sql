...
CREATE OR REPLACE PROCEDURE estorna_nota_fiscal_mx (nr_sequencia_p INOUT bigint, nm_usuario_p text) AS $body$
DECLARE
...
select	cd_estabelecimento,
	...
	cd_pessoa_fisica,
	cd_cgc,
	'Sustituye a factura '||''|| nr_nota_fiscal
...
update nota_fiscal
set    nr_seq_nf_ref = nr_sequencia_p
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE estorna_nota_fiscal_mx (nr_sequencia_p INOUT bigint, nm_usuario_p text) FROM PUBLIC;
