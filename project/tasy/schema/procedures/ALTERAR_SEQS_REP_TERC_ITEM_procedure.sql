...
CREATE OR REPLACE PROCEDURE alterar_seqs_rep_terc_item ( nr_repasse_terceiro_p text, nr_sequencia_item_p text, nr_sequencia_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE alterar_seqs_rep_terc_item ( nr_repasse_terceiro_p text, nr_sequencia_item_p text, nr_sequencia_p text, nm_usuario_p text) FROM PUBLIC;
