...
CREATE OR REPLACE PROCEDURE ptu_gerar_envio_contest_v41b ( nr_seq_camara_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE


/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade: Gerar o arquivo A550 V4.1 B
-------------------------------------------------------------------------------------------------------------------
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_envio_contest_v41b ( nr_seq_camara_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
