...
CREATE OR REPLACE PROCEDURE pls_importar_arquivo_a580_80 ( ds_conteudo_p text, nr_seq_fat_geral_p ptu_fatura_geral.nr_sequencia%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_regra_tit_fat_p pls_regra_tit_fat_geral.nr_sequencia%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_importar_arquivo_a580_80 ( ds_conteudo_p text, nr_seq_fat_geral_p ptu_fatura_geral.nr_sequencia%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_regra_tit_fat_p pls_regra_tit_fat_geral.nr_sequencia%type) FROM PUBLIC;
