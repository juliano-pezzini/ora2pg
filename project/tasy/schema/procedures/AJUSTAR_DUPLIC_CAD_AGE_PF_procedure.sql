...
CREATE OR REPLACE PROCEDURE ajustar_duplic_cad_age_pf (cd_pessoa_fisica_p text) AS $body$
DECLARE
...
and		substr(obter_nome_pf(b.cd_pessoa_fisica),1,255) 	<> b.nm_paciente
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ajustar_duplic_cad_age_pf (cd_pessoa_fisica_p text) FROM PUBLIC;
