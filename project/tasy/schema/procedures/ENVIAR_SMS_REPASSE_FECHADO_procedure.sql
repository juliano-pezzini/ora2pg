...
CREATE OR REPLACE PROCEDURE enviar_sms_repasse_fechado ( ds_remetente_p text, ds_destinatario_p text, ds_mensagem_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enviar_sms_repasse_fechado ( ds_remetente_p text, ds_destinatario_p text, ds_mensagem_p text, nm_usuario_p text) FROM PUBLIC;
