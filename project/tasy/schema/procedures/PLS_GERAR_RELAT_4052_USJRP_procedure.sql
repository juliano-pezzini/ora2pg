...
CREATE OR REPLACE PROCEDURE pls_gerar_relat_4052_usjrp ( dt_periodo_p text, cd_matricula_familia_p bigint, cd_grupo_int_p bigint, cd_usuario_plano_p text, ie_tipo_pagador_p text, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
C01 CURSOR FOR
	SELECT	distinct c.nr_seq_grupo_intercambio
	from	pls_mensalidade		a,
		pls_contrato_pagador	b,
		pls_intercambio		c,
		pls_regra_grupo_inter	d
	where	b.nr_sequencia	= a.nr_seq_pagador
	and	c.nr_sequencia	= b.nr_seq_pagador_intercambio
	and	d.nr_sequencia	= c.nr_seq_grupo_intercambio
	and	trunc(a.dt_referencia,'month') = to_date(dt_periodo_p, 'dd/mm/yyyy')
	and	((d.cd_grupo = cd_grupo_int_p) or (coalesce(cd_grupo_int_p::text, '') = ''))
	and	(c.cd_cgc IS NOT NULL AND c.cd_cgc::text <> '');

C02 CURSOR FOR
	SELECT	distinct a.qt_idade_inicial,
		a.qt_idade_final,
		a.vl_preco_atual
	from	pls_plano_preco		a,
		pls_tabela_preco	b,
		pls_intercambio_plano	c,
		pls_intercambio		d
	where	b.nr_sequencia 	= a.nr_seq_tabela
	and	b.nr_sequencia	= c.nr_seq_tabela
	and	d.nr_sequencia	= c.nr_seq_intercambio
	and	d.nr_seq_grupo_intercambio = nr_seq_grupo_int_w
	and	c.nr_sequencia 	= (	SELECT	max(x.nr_sequencia)
					from	pls_intercambio_plano	x
					where	x.nr_seq_intercambio = d.nr_sequencia)
	order by 1;

C03 CURSOR FOR
	SELECT	distinct d.nr_sequencia nr_seq_segurado,
		b.qt_idade,
		b.nr_parcela,
		a.vl_item,
		a.nr_seq_tipo_lanc,
	...
	and	g.nr_sequencia		= d.nr_seq_intercambio
	and	g.nr_sequencia		= f.nr_seq_pagador_intercambio
	and	g.nr_seq_grupo_intercambio = nr_seq_grupo_int_w
	and	trunc(e.dt_referencia,'month') = to_date(dt_periodo_p, 'dd/mm/yyyy')
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	and	e.nr_sequencia = c.nr_seq_contrato_inter
	and	e.nr_seq_grupo_intercambio = nr_seq_grupo_int_w
			...
			if (ie_tipo_pagador_w = 'PF') then
				...
				if (pf_vl_total_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_total_w, 'TO', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_qt_tx_inscricao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							qt_beneficiarios, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_qt_tx_inscricao_w, 'TI', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_vl_inscricao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_inscricao_w, 'VI', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_qt_tx_cartao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							qt_beneficiarios, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_qt_tx_cartao_w, 'TC', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_vl_cartao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_cartao_w, 'VC', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_qt_sca_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							qt_beneficiarios, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_qt_sca_w, 'SCA', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_vl_uni_sca_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_uni_sca_w, 'USC', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_vl_sca_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_sca_w, 'TSC', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_vl_acrescimo_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_acrescimo_w, 'AC', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pf_vl_desconto_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pf_vl_desconto_w, 'DE', 'PF', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_total_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_total_w, 'TO', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_qt_tx_inscricao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							qt_beneficiarios, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_qt_tx_inscricao_w, 'TI', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_inscricao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_inscricao_w, 'VI', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_qt_tx_cartao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							qt_beneficiarios, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_qt_tx_cartao_w, 'TC', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_cartao_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_cartao_w, 'VC', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_qt_sca_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							qt_beneficiarios, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_qt_sca_w, 'SCA', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_uni_sca_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_uni_sca_w, 'USC', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_sca_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_sca_w, 'TSC', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_acrescimo_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_acrescimo_w, 'AC', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
				...
				if (pj_vl_desconto_w > 0) then
					insert into w_relat_faixa_etaria(	nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
							vl_faixa_etaria, ie_tipo_informacao, ie_tipo_pagador, qt_idade_inicial, qt_idade_final)
					values (	nextval('w_relat_faixa_etaria_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
							pj_vl_desconto_w, 'DE', 'PJ', qt_idade_inicial_w, qt_idade_final_w);
				end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_relat_4052_usjrp ( dt_periodo_p text, cd_matricula_familia_p bigint, cd_grupo_int_p bigint, cd_usuario_plano_p text, ie_tipo_pagador_p text, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
