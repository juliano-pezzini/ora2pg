...
CREATE OR REPLACE PROCEDURE gerar_analise_prod_migr_ge_mes () AS $body$
DECLARE
...
if (1 = 1) then
	begin
	/* obter análise mês / geral - caso existir */
	...
	/* gerar análise mês / geral - caso não existir */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_analise_prod_migr_ge_mes () FROM PUBLIC;
