...
CREATE OR REPLACE PROCEDURE gerar_etapa_atendimento (nr_atendimento_p bigint, ie_evento_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_etapa_atendimento (nr_atendimento_p bigint, ie_evento_p text, nm_usuario_p text) FROM PUBLIC;
