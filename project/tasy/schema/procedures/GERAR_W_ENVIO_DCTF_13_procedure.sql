...
CREATE OR REPLACE PROCEDURE gerar_w_envio_dctf_13 ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
nr_mes_declaracao_w			varchar(25);
nr_mes_ocorrencia_w			varchar(25);
...
ie_tipo_registro, 
	...
	obter_semestre_ano(a.dt_referencia) nr_mes_declaracao, 
	trunc(a.dt_referencia,'mm') dt_periodo_inicial, 
	CASE WHEN Obter_Periodo_Data(a.dt_referencia,'E')='01' THEN last_day(add_months(trunc(a.dt_referencia,'year'),5))  ELSE last_day(add_months(trunc(a.dt_referencia,'year'),11)) END  dt_periodo_final, 
...
SELECT	2						ie_tipo_registro, 
	...
	CASE WHEN a.ie_finalidade_dctf=00 THEN '00000000'  ELSE clock_timestamp() END  dt_ocorrencia_evento, 
	'R01'						ie_tipo, 
	substr(to_char(a.dt_referencia,'dd/mm/yyyy'),7,4)||Obter_Periodo_Data(a.dt_referencia,'E') nr_mes_ocorrencia, 
	clock_timestamp() dt_inicio, 
	clock_timestamp() dt_fim, 
...
and	c.nr_sequencia		= (select	max(x.nr_sequencia) 
				  from		estab_dctf x 
				  where	 
trunc(x.dt_inicio_vigencia,'dd') <= trunc(clock_timestamp(),'dd') 
				  and		x.cd_estabelecimento	 
...
ie_tipo_registro, 
	...
	lpad(obter_dados_pf_pj(c.cd_titular,null,'DDT'),3,' ')	nr_ddd_telefone_representante, 
...
SUBSTR(obter_dados_pf_pj(c.cd_titular,null,'FAX'),(LENGTH(obter_dados_pf_pj(c.cd_titular,NULL,'FAX'))-7),(LENGTH(obter_dados_pf_pj(c.cd_titular,NULL,'FAX'))))	nr_fax_representante, 
	...
	lpad(obter_dados_pf_pj(c.cd_contabilista,null,'DDT'),3,' ') nr_ddd_telefone_resp, 
...
nr_cnpj_incorporacao, 
	...
	CASE WHEN h.ie_balanco_reducao='N' THEN 0 WHEN h.ie_balanco_reducao='S' THEN 1 END 	 
ie_balanco_reducao, 
	0						 
ie_saldo_quotas, 
	clock_timestamp()	dt_periodo_apuracao, 
...
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_sequencia		= c.nr_seq_lote and c.nr_seq_darf		= d.nr_sequencia and d.nr_sequencia		= e.nr_seq_darf  and (f.cd_tributo		= g.cd_tributo or i.cd_tributo = g.cd_tributo) and h.cd_estabelecimento	= b.cd_estabelecimento and e.nr_titulo		= i.nr_titulo and h.nr_sequencia		= (SELECT	max(x.nr_sequencia) 
	...
	CASE WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='T' THEN  		obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='U' THEN  		obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='B' THEN  		obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='E' THEN  		obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END , 
...
CASE WHEN d.ie_grupo_tributo='03' THEN substr(b.cd_cgc,9,6) WHEN d.ie_grupo_tributo='09' THEN substr(b.cd_cgc,9,6)  ELSE '000000' END  nr_ordem_estab, 
	CASE WHEN d.ie_grupo_tributo='10' THEN b.cd_cgc  ELSE '00000000000000' END  
nr_cnpj_incorporacao, 
...
group by a.nr_sequencia, 
	...
	a.dt_referencia, 
	d.cd_darf, 
	coalesce(d.cd_variacao,d.cd_variacao), 
...
LEFT OUTER JOIN titulo_pagar_imposto f ON (i.nr_seq_tributo = f.nr_sequencia)
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_sequencia		= c.nr_seq_lote and c.nr_seq_darf		= d.nr_sequencia and d.nr_sequencia		= e.nr_seq_darf and e.nr_titulo		= i.nr_titulo  and (f.cd_tributo		= g.cd_tributo or i.cd_tributo = g.cd_tributo) and a.nr_sequencia		= nr_seq_lote_p and d.cd_darf||coalesce(f.cd_variacao,i.cd_variacao)	= cd_receita_w and CASE WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END  	= dt_apuracao_mensal_w and CASE WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END  = dt_apuracao_diario_w group by 	a.nr_sequencia, 
	b.cd_cgc, 
	a.ie_finalidade_dctf, 
	TRUNC(a.dt_referencia,'mm'), 
	...
	TRUNC(a.dt_referencia,'mm'), 
	g.ie_grupo_tributo, 
	d.cd_darf||coalesce(f.cd_variacao,i.cd_variacao), 
	coalesce(f.ie_periodicidade,i.ie_periodicidade), 
	a.dt_referencia, 
	CASE WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END , 
	CASE WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(f.ie_periodicidade,i.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END , 
...
group by 	a.nr_sequencia, 
	...
	TRUNC(a.dt_referencia,'mm'), 
	d.ie_grupo_tributo, 
	d.cd_darf||coalesce(d.cd_variacao,d.cd_variacao), 
	coalesce(d.ie_periodicidade,d.ie_periodicidade), 
	a.dt_referencia, 
	CASE WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END , 
	CASE WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(d.ie_periodicidade,d.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END , 
	CASE WHEN d.ie_grupo_tributo='03' THEN substr(c.cd_cgc,9,6) WHEN d.ie_grupo_tributo='09' THEN substr(c.cd_cgc,9,6)  ELSE '000000' END , 
	CASE WHEN d.ie_grupo_tributo='10' THEN c.cd_cgc  ELSE '00000000000000' END , 
	d.dt_apuracao, 
	c.cd_cgc, 
	substr(d.cd_darf,1,4), 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_envio_dctf_13 ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
