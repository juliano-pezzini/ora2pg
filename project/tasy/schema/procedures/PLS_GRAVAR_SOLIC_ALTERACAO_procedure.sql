...
CREATE OR REPLACE PROCEDURE pls_gravar_solic_alteracao ( vl_campo_old_p text, vl_campo_new_p text, nm_campo_p text, nm_tabela_p text, cd_pessoa_fisica_p text, nm_usuario_p text, ie_tipo_solicitacao_p text, nr_seq_contrato_p bigint, ie_tipo_login_solic_p text, ie_tipo_complemento_p text, cd_estabelecimento_p bigint, cd_funcao_origem_p bigint, nr_seq_solicitacao_p INOUT bigint) AS $body$
DECLARE
...
and	column_name	= upper(nm_campo_p);	

if (qt_campo_w > 0) then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gravar_solic_alteracao ( vl_campo_old_p text, vl_campo_new_p text, nm_campo_p text, nm_tabela_p text, cd_pessoa_fisica_p text, nm_usuario_p text, ie_tipo_solicitacao_p text, nr_seq_contrato_p bigint, ie_tipo_login_solic_p text, ie_tipo_complemento_p text, cd_estabelecimento_p bigint, cd_funcao_origem_p bigint, nr_seq_solicitacao_p INOUT bigint) FROM PUBLIC;
