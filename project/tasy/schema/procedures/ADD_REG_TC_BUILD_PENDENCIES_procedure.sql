...
CREATE OR REPLACE PROCEDURE add_reg_tc_build_pendencies ( nm_usuario_p text, cd_version_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE add_reg_tc_build_pendencies ( nm_usuario_p text, cd_version_p text) FROM PUBLIC;
