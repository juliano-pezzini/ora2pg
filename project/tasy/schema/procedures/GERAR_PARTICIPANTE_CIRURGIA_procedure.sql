...
CREATE OR REPLACE PROCEDURE gerar_participante_cirurgia ( cd_participante_p text, nr_cirurgia_p bigint, ie_funcao_p text, ie_opcao_funcao_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_participante_cirurgia ( cd_participante_p text, nr_cirurgia_p bigint, ie_funcao_p text, ie_opcao_funcao_p text, nm_usuario_p text) FROM PUBLIC;
