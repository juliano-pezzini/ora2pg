...
CREATE OR REPLACE PROCEDURE ptu_gerar_resp_consulta_prest ( nr_seq_consulta_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_resp_consulta_prest ( nr_seq_consulta_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) FROM PUBLIC;
