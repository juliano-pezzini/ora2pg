...
CREATE OR REPLACE PROCEDURE hd_iscmm_exame_mensal (dt_inicial_p timestamp, dt_final_p timestamp, cd_empresa_param_p bigint, nr_seq_unid_dialise_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hd_iscmm_exame_mensal (dt_inicial_p timestamp, dt_final_p timestamp, cd_empresa_param_p bigint, nr_seq_unid_dialise_p bigint, nm_usuario_p text) FROM PUBLIC;
