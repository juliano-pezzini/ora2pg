...
CREATE OR REPLACE PROCEDURE imp_extrato_itau_separador_4 ( nr_seq_extrato_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE imp_extrato_itau_separador_4 ( nr_seq_extrato_p bigint) FROM PUBLIC;
