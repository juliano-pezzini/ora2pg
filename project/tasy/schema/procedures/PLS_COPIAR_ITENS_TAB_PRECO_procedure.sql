...
CREATE OR REPLACE PROCEDURE pls_copiar_itens_tab_preco ( ie_tipo_copia_p bigint, cd_edicao_amb_p edicao_amb.cd_edicao_amb%type, dt_inicio_vigencia_p timestamp, nr_seq_preco_amb_p preco_amb.nr_sequencia%type, cd_estabelecimento_p preco_servico.cd_estabelecimento%type, cd_tabela_servico_p preco_servico.cd_tabela_servico%type, cd_procedimento_p preco_servico.cd_procedimento%type, vl_servico_p preco_servico.vl_servico%type, cd_moeda_p preco_servico.cd_moeda%type, ie_origem_proced_p preco_servico.ie_origem_proced%type, cd_unidade_medida_p preco_servico.cd_unidade_medida%type, dt_inativacao_p preco_servico.dt_inativacao%type, nm_usuario_p text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_copiar_itens_tab_preco ( ie_tipo_copia_p bigint, cd_edicao_amb_p edicao_amb.cd_edicao_amb%type, dt_inicio_vigencia_p timestamp, nr_seq_preco_amb_p preco_amb.nr_sequencia%type, cd_estabelecimento_p preco_servico.cd_estabelecimento%type, cd_tabela_servico_p preco_servico.cd_tabela_servico%type, cd_procedimento_p preco_servico.cd_procedimento%type, vl_servico_p preco_servico.vl_servico%type, cd_moeda_p preco_servico.cd_moeda%type, ie_origem_proced_p preco_servico.ie_origem_proced%type, cd_unidade_medida_p preco_servico.cd_unidade_medida%type, dt_inativacao_p preco_servico.dt_inativacao%type, nm_usuario_p text ) FROM PUBLIC;
