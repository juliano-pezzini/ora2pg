...
CREATE OR REPLACE PROCEDURE desfazer_assumir_paciente_pep ( nr_atendimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE desfazer_assumir_paciente_pep ( nr_atendimento_p bigint, nm_usuario_p text) FROM PUBLIC;
