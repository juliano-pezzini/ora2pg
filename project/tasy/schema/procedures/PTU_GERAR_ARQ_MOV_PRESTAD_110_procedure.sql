...
CREATE OR REPLACE PROCEDURE ptu_gerar_arq_mov_prestad_110 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text, ds_local_p text, nm_arquivo_p text) AS $body$
DECLARE


/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade: Gerar arquivo A400 de acordo com a versão PTU 10.0
-----------------------------------------------------------------------------------------------------------------------
...
ds_conteudo_w	:=	lpad(nr_seq_registro_w,8,'0') || '401' || cd_unimed_destino_w || cd_unimed_origem_w || dt_geracao_w || '28' || id_ope_prest_w ||
			nr_registro_ans_w;
...
nr_seq_registro_w :=	nr_seq_registro_w + 1;
ds_arquivo_w := pls_hash_ptu_pck.obter_hash_txt(ds_arquivo_w, 'N'); -- Gerar HASH sem alterar a acentuação
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_arq_mov_prestad_110 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text, ds_local_p text, nm_arquivo_p text) FROM PUBLIC;
