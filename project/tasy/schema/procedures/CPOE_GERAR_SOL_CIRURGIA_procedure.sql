...
CREATE OR REPLACE PROCEDURE cpoe_gerar_sol_cirurgia ( NR_ATENDIMENTO_P atendimento_paciente.nr_atendimento%type, NR_SEQ_MAT_CPOE_P cpoe_material.nr_sequencia%type, NR_SEQ_MAT_CPOE_NEW_P INOUT cpoe_material.nr_sequencia%type, NR_SEQ_CPOE_RP_P cpoe_material.nr_seq_cpoe_rp%type default null, NR_SEQ_CPOE_ORDER_UNIT_P cpoe_material.nr_seq_cpoe_order_unit%type default null) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cpoe_gerar_sol_cirurgia ( NR_ATENDIMENTO_P atendimento_paciente.nr_atendimento%type, NR_SEQ_MAT_CPOE_P cpoe_material.nr_sequencia%type, NR_SEQ_MAT_CPOE_NEW_P INOUT cpoe_material.nr_sequencia%type, NR_SEQ_CPOE_RP_P cpoe_material.nr_seq_cpoe_rp%type default null, NR_SEQ_CPOE_ORDER_UNIT_P cpoe_material.nr_seq_cpoe_order_unit%type default null) FROM PUBLIC;
