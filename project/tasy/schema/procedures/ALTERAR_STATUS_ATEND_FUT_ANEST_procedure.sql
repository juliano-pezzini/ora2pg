...
CREATE OR REPLACE PROCEDURE alterar_status_atend_fut_anest ( cd_pessoa_fisica_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE alterar_status_atend_fut_anest ( cd_pessoa_fisica_p text) FROM PUBLIC;
