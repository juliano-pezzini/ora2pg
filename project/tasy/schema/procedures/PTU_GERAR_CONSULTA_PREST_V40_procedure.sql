...
CREATE OR REPLACE PROCEDURE ptu_gerar_consulta_prest_v40 ( cd_unimed_benef_p text, nm_prestador_p text, cd_cgc_cpf_p text, sg_cons_prof_p text, nr_cons_prof_p bigint, uf_cons_prof_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_consulta_prest_v40 ( cd_unimed_benef_p text, nm_prestador_p text, cd_cgc_cpf_p text, sg_cons_prof_p text, nr_cons_prof_p bigint, uf_cons_prof_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) FROM PUBLIC;
