...
CREATE OR REPLACE PROCEDURE copiar_criterio_distribuicao ( cd_estabelecimento_p bigint, cd_tabela_custo_p bigint, cd_tabela_destino_p bigint, nr_seq_tabela_p bigint, nr_seq_tabela_dest_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
ie_tipo_centro_controle_w	varchar(2);
c01 CURSOR FOR
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE copiar_criterio_distribuicao ( cd_estabelecimento_p bigint, cd_tabela_custo_p bigint, cd_tabela_destino_p bigint, nr_seq_tabela_p bigint, nr_seq_tabela_dest_p bigint, nm_usuario_p text) FROM PUBLIC;
