...
CREATE OR REPLACE PROCEDURE gerar_precos_proc_interno_conv (cd_estabelecimento_p bigint, nr_seq_proc_interno_p bigint) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	EXIT WHEN NOT FOUND; /* apply on c02 */
		...
		EXIT WHEN NOT FOUND; /* apply on c03 */
			...
			SELECT * FROM Obter_Proc_Tab_Inter_Agenda(nr_seq_proc_interno_w, 0, cd_convenio_w, null, null, cd_estabelecimento_p, clock_timestamp(), null, null, null, null, null, null, null, null, cd_procedimento_w, ie_origem_proced_w) INTO STRICT cd_procedimento_w, ie_origem_proced_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_precos_proc_interno_conv (cd_estabelecimento_p bigint, nr_seq_proc_interno_p bigint) FROM PUBLIC;
