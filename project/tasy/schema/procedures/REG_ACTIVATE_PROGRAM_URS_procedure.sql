...
CREATE OR REPLACE PROCEDURE reg_activate_program_urs ( nr_seq_requirement_p bigint, ds_reason_p text, nm_usuario_p text) AS $body$
DECLARE
...
BEGIN
  ...
  for C02_w in C02 loop
    ...
    CALL reg_activate_program_prs(C02_w.nr_sequencia, ds_reason_p, nm_usuario_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE reg_activate_program_urs ( nr_seq_requirement_p bigint, ds_reason_p text, nm_usuario_p text) FROM PUBLIC;
