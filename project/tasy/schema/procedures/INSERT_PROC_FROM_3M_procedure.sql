...
CREATE OR REPLACE PROCEDURE insert_proc_from_3m (cd_procedimento_p text, nr_atendimento_p bigint, nr_seq_proc_interno_p bigint, ie_lado_p text, ie_proc_princ_atend_p text, nm_usuario_p text, ie_origem_proced_p bigint, ie_liberar_informacao_p text, nr_seq_proc_pac_medico_p INOUT bigint) AS $body$
DECLARE
...
exception
when others then
	CALL wheb_mensagem_pck.exibir_mensagem_abort(1025219); --O paciente não tem passagem por setor sem alta!
end;
...
values (nr_sequencia_w, 
	...
	'A', 			 
	cd_procedimento_p, 
	coalesce(ie_origem_proced_p,11),   
	1, 
	nr_seq_episodio_w,
	ie_lado_p,
	ie_proc_princ_w,
...
nr_seq_proc_pac_medico_p	:= nr_sequencia_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE insert_proc_from_3m (cd_procedimento_p text, nr_atendimento_p bigint, nr_seq_proc_interno_p bigint, ie_lado_p text, ie_proc_princ_atend_p text, nm_usuario_p text, ie_origem_proced_p bigint, ie_liberar_informacao_p text, nr_seq_proc_pac_medico_p INOUT bigint) FROM PUBLIC;
