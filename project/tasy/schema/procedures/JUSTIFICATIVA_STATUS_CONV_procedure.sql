...
CREATE OR REPLACE PROCEDURE justificativa_status_conv (nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE justificativa_status_conv (nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
