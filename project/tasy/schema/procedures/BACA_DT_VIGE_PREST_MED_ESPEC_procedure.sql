...
CREATE OR REPLACE PROCEDURE baca_dt_vige_prest_med_espec () AS $body$
DECLARE
...
loop 
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last 
		update	pls_prestador_med_espec 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vige_prest_med_espec () FROM PUBLIC;
