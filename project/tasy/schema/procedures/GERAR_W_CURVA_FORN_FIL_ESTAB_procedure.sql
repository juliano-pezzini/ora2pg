...
CREATE OR REPLACE PROCEDURE gerar_w_curva_forn_fil_estab ( dt_inicio_p timestamp, dt_final_p timestamp, cd_local_estoque_p bigint, cd_grupo_material_p bigint, cd_subgrupo_material_p bigint, cd_classe_material_p bigint, cd_estabelecimento_p bigint, vl_curva_a_p bigint, vl_curva_b_p bigint, vl_curva_c_p bigint, nm_usuario_p text, ie_data_p text, ie_considera_estab_p text, ie_tipo_ordem_p text) AS $body$
DECLARE
...
cd_estabelecimento_ww		smallint	:= 0;
...
and (obter_se_nf_transferencia(a.nr_sequencia) = ie_tipo_ordem_p or ie_tipo_ordem_p = 'A')
...
if (ie_considera_estab_p = 'S') then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_curva_forn_fil_estab ( dt_inicio_p timestamp, dt_final_p timestamp, cd_local_estoque_p bigint, cd_grupo_material_p bigint, cd_subgrupo_material_p bigint, cd_classe_material_p bigint, cd_estabelecimento_p bigint, vl_curva_a_p bigint, vl_curva_b_p bigint, vl_curva_c_p bigint, nm_usuario_p text, ie_data_p text, ie_considera_estab_p text, ie_tipo_ordem_p text) FROM PUBLIC;
