...
CREATE OR REPLACE PROCEDURE same_emp_pront_solic ( nr_sequencia_p bigint, nr_prontuario_p bigint, cd_setor_atendimento_p bigint, cd_agenda_p bigint, dt_emprestimo_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE same_emp_pront_solic ( nr_sequencia_p bigint, nr_prontuario_p bigint, cd_setor_atendimento_p bigint, cd_agenda_p bigint, dt_emprestimo_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
