...
CREATE OR REPLACE PROCEDURE inserir_procedimento_pac ( cd_procedimento_p bigint, qt_procedimento_p bigint, nr_seq_exame_p bigint, nr_seq_proc_interno_p bigint, ie_origem_proced_p bigint, cd_setor_atendimento_p bigint, nr_atendimento_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, ie_valor_informado_p text, cd_medico_p text, nr_seq_atepacu_p bigint, dt_procedimento_p timestamp, cd_convenio_p bigint, cd_categoria_p text, nr_interno_conta_p bigint, nr_sequencia_p INOUT bigint ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE inserir_procedimento_pac ( cd_procedimento_p bigint, qt_procedimento_p bigint, nr_seq_exame_p bigint, nr_seq_proc_interno_p bigint, ie_origem_proced_p bigint, cd_setor_atendimento_p bigint, nr_atendimento_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, ie_valor_informado_p text, cd_medico_p text, nr_seq_atepacu_p bigint, dt_procedimento_p timestamp, cd_convenio_p bigint, cd_categoria_p text, nr_interno_conta_p bigint, nr_sequencia_p INOUT bigint ) FROM PUBLIC;
