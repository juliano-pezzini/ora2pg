...
nota_fiscal_w.cd_estabelecimento    := pat_historico_bem_w.cd_estab_destino;
...
nota_fiscal_w.ie_tipo_nota          := 'EN'; -- Dom 1661 | Entrada
nota_fiscal_w.ie_entregue_bloqueto  := 'N';
nota_fiscal_w.ie_situacao           := '1'; -- Dom 1056 | Ativa
...
begin
select vl_base_deprec + vl_residual
...
===============================================================================
Atualizar numero da nota fiscal na PAT_HISTORICO_BEM
===============================================================================
*/
...
/* Gerar os vencimentos com base na forma de pagamento */
