...
CREATE OR REPLACE PROCEDURE same_liberar_solicitacao ( nr_seq_lote_p bigint, nr_seq_solic_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE same_liberar_solicitacao ( nr_seq_lote_p bigint, nr_seq_solic_p bigint, nm_usuario_p text) FROM PUBLIC;
