...
CREATE OR REPLACE PROCEDURE ptu_gerar_ped_status_trans_v40 ( nr_seq_guia_p bigint, nr_seq_requisicao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_ped_status_trans_v40 ( nr_seq_guia_p bigint, nr_seq_requisicao_p bigint, nm_usuario_p text) FROM PUBLIC;
