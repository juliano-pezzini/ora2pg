...
CREATE OR REPLACE PROCEDURE hd_obter_dados_inst_pac_html5 ( cd_pessoa_fisica_p text, cd_tipo_evolucao_p text, nr_seq_dialise_p bigint, cd_estabelecimento_p bigint, ie_peso_ideal_prescr_p text, ds_evolucao_p INOUT text, dt_evolucao_p INOUT timestamp, nr_seq_exame_hematocrito_p INOUT bigint, qt_altura_cm_p INOUT text, qt_idade_p INOUT text, ds_sexo_p INOUT text, ds_tempo_p INOUT text, ds_ult_resultado_p INOUT text, qt_pa_sist_pre_pe_p INOUT bigint, qt_pa_diast_pre_pe_p INOUT bigint, qt_pa_sist_pre_deitado_p INOUT bigint, qt_pa_diast_pre_deitado_p INOUT bigint, qt_peso_pre_p INOUT bigint, qt_soro_reposicao_p INOUT bigint, qt_soro_devolucao_p INOUT bigint, qt_peso_ideal_p INOUT bigint, qt_fluxo_sangue_p INOUT text, ds_duracao_p INOUT text, ds_ultrafiltracao_p INOUT text, ds_heparina_retorno_p INOUT text, ds_protocolo_p INOUT text, ds_agulha_p INOUT text, ie_pode_pesar_p INOUT text, nr_seq_motivo_peso_pac_p INOUT bigint, nr_seq_motivo_pa_pre_sentado_p INOUT bigint, nr_seq_motivo_pa_pre_pe_p INOUT bigint, dif_peso_ideal_atual_p INOUT bigint, qt_perc_gpid_p INOUT bigint, dt_dialise_retro_p INOUT timestamp, ie_tipo_dialise_p INOUT text, qt_ultrafiltracao_p INOUT bigint, ds_perfil_p INOUT text, nr_seq_mod_dialisador_p INOUT text, ie_tipo_hemodialise_p INOUT text, qt_sodio_p INOUT bigint, qt_bicarbonato_p INOUT bigint, qt_dose_p INOUT text, unidade_medida_p INOUT text) AS $body$
DECLARE
...
ds_modelo_w			HD_MODELO_DIALISADOR.DS_MODELO%TYPE;
ds_tratamento_w			VALOR_DOMINIO.DS_VALOR_DOMINIO%TYPE;
...
qt_ultrafiltracao_w := hd_obter_dados_prescr_dialise(cd_pessoa_fisica_p, 'QU');
ds_perfil_w := substr(hd_obter_dados_prescr_dialise(cd_pessoa_fisica_p, 'SU'),1,255);
...
qt_dose_w := HD_obter_dose_unidade_medida(cd_pessoa_fisica_p, 'C', 'D');
unidade_medida_w := HD_obter_dose_unidade_medida(cd_pessoa_fisica_p, 'C', 'UN');


select	max(ds_modelo)
into STRICT	ds_modelo_w
from	hd_modelo_dialisador
where	nr_sequencia = nr_seq_mod_dialisador_w;

ds_tratamento_w := obter_valor_dominio(1934,ie_tipo_hemodialise_w);
...
qt_ultrafiltracao_p		:= qt_ultrafiltracao_w;
ds_perfil_p			:= ds_perfil_w;
nr_seq_mod_dialisador_p := ds_modelo_w;
ie_tipo_hemodialise_p   := ds_tratamento_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hd_obter_dados_inst_pac_html5 ( cd_pessoa_fisica_p text, cd_tipo_evolucao_p text, nr_seq_dialise_p bigint, cd_estabelecimento_p bigint, ie_peso_ideal_prescr_p text, ds_evolucao_p INOUT text, dt_evolucao_p INOUT timestamp, nr_seq_exame_hematocrito_p INOUT bigint, qt_altura_cm_p INOUT text, qt_idade_p INOUT text, ds_sexo_p INOUT text, ds_tempo_p INOUT text, ds_ult_resultado_p INOUT text, qt_pa_sist_pre_pe_p INOUT bigint, qt_pa_diast_pre_pe_p INOUT bigint, qt_pa_sist_pre_deitado_p INOUT bigint, qt_pa_diast_pre_deitado_p INOUT bigint, qt_peso_pre_p INOUT bigint, qt_soro_reposicao_p INOUT bigint, qt_soro_devolucao_p INOUT bigint, qt_peso_ideal_p INOUT bigint, qt_fluxo_sangue_p INOUT text, ds_duracao_p INOUT text, ds_ultrafiltracao_p INOUT text, ds_heparina_retorno_p INOUT text, ds_protocolo_p INOUT text, ds_agulha_p INOUT text, ie_pode_pesar_p INOUT text, nr_seq_motivo_peso_pac_p INOUT bigint, nr_seq_motivo_pa_pre_sentado_p INOUT bigint, nr_seq_motivo_pa_pre_pe_p INOUT bigint, dif_peso_ideal_atual_p INOUT bigint, qt_perc_gpid_p INOUT bigint, dt_dialise_retro_p INOUT timestamp, ie_tipo_dialise_p INOUT text, qt_ultrafiltracao_p INOUT bigint, ds_perfil_p INOUT text, nr_seq_mod_dialisador_p INOUT text, ie_tipo_hemodialise_p INOUT text, qt_sodio_p INOUT bigint, qt_bicarbonato_p INOUT bigint, qt_dose_p INOUT text, unidade_medida_p INOUT text) FROM PUBLIC;
