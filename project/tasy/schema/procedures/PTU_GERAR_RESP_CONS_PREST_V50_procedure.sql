...
CREATE OR REPLACE PROCEDURE ptu_gerar_resp_cons_prest_v50 ( nr_seq_consulta_p bigint, nr_versao_ptu_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_resp_cons_prest_v50 ( nr_seq_consulta_p bigint, nr_versao_ptu_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_retorno_p INOUT bigint) FROM PUBLIC;
