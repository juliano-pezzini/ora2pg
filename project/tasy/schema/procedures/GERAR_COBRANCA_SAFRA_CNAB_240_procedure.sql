...
CREATE OR REPLACE PROCEDURE gerar_cobranca_safra_cnab_240 ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
ds_conteudo_w	:= 	cd_banco_w || --1 3 
					...
					lpad(coalesce(nr_seq_cobr_escrit_p,'0'),8,'0')|| --184 191 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobranca_safra_cnab_240 ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
