...
CREATE OR REPLACE PROCEDURE gerar_projeto_revisao_migracao ( ie_gerencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_projeto_revisao_migracao ( ie_gerencia_p bigint, nm_usuario_p text) FROM PUBLIC;
