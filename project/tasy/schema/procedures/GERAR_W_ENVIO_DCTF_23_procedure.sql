...
CREATE OR REPLACE PROCEDURE gerar_w_envio_dctf_23 ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
ds_uf_caixa_postal_w			varchar(2);
ds_uf_crc_resp_w			varchar(2);
...
ie_tipo_registro,
	...
	CASE WHEN coalesce(ie_iniciou_neste_mes::text, '') = '' THEN 0 WHEN ie_iniciou_neste_mes='N' THEN  0 WHEN ie_iniciou_neste_mes='S' THEN  1 END  ie_iniciou_neste_mes,
...
ie_tipo_registro,
	...
	substr(a.nr_recibo_retificada,1,50)		nr_recibo,
	...
	CASE WHEN c.ie_dctf_ano_anterior='N' THEN 0 WHEN c.ie_dctf_ano_anterior='S' THEN 1 END 
...
select	3
	...
	SUBSTR(obter_dados_pf_pj(NULL,b.cd_cgc,'T'),(LENGTH(obter_dados_pf_pj(NULL,b.cd_cgc,'T'))-7),(LENGTH(obter_dados_pf_pj(NULL,b.cd_cgc,'T'))))
nr_telefone,
	Substr(obter_dados_pf_pj(NULL,b.cd_cgc,'DDF'),1,3) nr_ddd_fax,
	SUBSTR(obter_dados_pf_pj(NULL,b.cd_cgc,'FAX'),(LENGTH(obter_dados_pf_pj(NULL,b.cd_cgc,'FAX'))-7),(LENGTH(obter_dados_pf_pj(NULL,b.cd_cgc,'FA
	X'))))	nr_fax,
	' ' nr_caixa_postal,
...
ie_tipo_registro,
	...
	lpad(obter_compl_pf(c.cd_titular,1,'DDT'),3,' ')	nr_ddd_telefone_representante,
	SUBSTR(obter_dados_pf_pj(c.cd_titular,null,'T'),(LENGTH(obter_dados_pf_pj(c.cd_titular,NULL,'T'))-7),(LENGTH(obter_dados_pf_pj(c.cd_titular,
	NULL,'T')))) nr_telefone_representante,
	substr(obter_compl_pf(c.cd_titular,1,'RAM'),1,5) nr_ramal_representante,
	lpad(obter_dados_pf_pj(c.cd_titular,null,'DDF'),3,' ') nr_ddd_fax_representante,
	...
	SUBSTR(obter_uf_localidade(b.cd_localidade),1,2) ds_uf_crc_resp,
	substr(obter_compl_pf(cd_contabilista_w,1,'DDT'),1,3) nr_ddd_telefone_resp,
	substr(somente_numero(obter_dados_pf_pj(cd_contabilista_w,null,'T')), (LENGTH(somente_numero(obter_dados_pf_pj(cd_contabilista_w,null,'T')))
-7),
(LENGTH(somente_numero(obter_dados_pf_pj(cd_contabilista_w,null,'T')))
))	nr_telefone_resp,
	substr(obter_compl_pf(cd_contabilista_w,1,'RAM'),1,5) nr_ramal_resp,
	substr(obter_compl_pf(cd_contabilista_w,1,'DDF'),1,3) nr_ddd_fax_resp,
	substr(obter_dados_pf_pj(cd_contabilista_w,null,'FAX'),(LENGTH(obter_dados_pf_pj(cd_contabilista_w,null,'FAX'))-7),(LENGTH(obter_dados_pf_pj(cd_contabilista_w,null,'FAX'))))	nr_fax_resp,
...
SELECT	distinct
	...
	g.ie_grupo_tributo
	nr_grupo_tributo,
	d.cd_darf || CASE WHEN coalesce(coalesce(i.cd_variacao,f.cd_variacao)::text, '') = '' THEN obter_cd_darf_variacao(g.cd_tributo,'V')  ELSE coalesce(i.cd_variacao,f.cd_variacao) END  	cd_receita,
...
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_sequencia		= c.nr_seq_lote and c.nr_seq_darf		= d.nr_sequencia and d.nr_sequencia		= e.nr_seq_darf  and (f.cd_tributo		= g.cd_tributo or i.cd_tributo = g.cd_tributo) and h.cd_estabelecimento	= b.cd_estabelecimento and e.nr_titulo		= i.nr_titulo and h.nr_sequencia		= (select	max(x.nr_sequencia)
	...
	a.dt_referencia,
	d.cd_darf || CASE WHEN coalesce(coalesce(i.cd_variacao,f.cd_variacao)::text, '') = '' THEN obter_cd_darf_variacao(g.cd_tributo,'V')  ELSE coalesce(i.cd_variacao,f.cd_variacao) END ,
	a.ie_spc_inc,
...
select	distinct
	...
	d.ie_grupo_tributo
	nr_grupo_tributo,
	d.cd_darf || d.cd_variacao cd_receita,
...
nr_cnpj_incorporacao,
	...
	obter_valor_total_darf(d.nr_sequencia) vl_principal,
	coalesce(d.vl_multa,0)		vl_multa,
	coalesce(d.vl_juros,0)		vl_juros,
	obter_valor_darf(d.nr_sequencia) vl_pago_debito,
	0 nr_trimestre_apuracao,
	0 nr_quota,
	0 qt_registros,
	' ' ds_hashcode,
...
select	distinct 6					ie_tipo_registro,
	...
	d.ie_grupo_tributo
	nr_grupo_tributo,
	d.cd_darf||coalesce(d.cd_variacao,d.cd_variacao)	cd_receita,
...
and	d.cd_darf||coalesce(d.cd_variacao,d.cd_variacao)	= cd_receita_w
...
LEFT OUTER JOIN titulo_pagar_imposto f ON (i.nr_seq_tributo = f.nr_sequencia)
WHERE a.cd_estabelecimento	= b.cd_estabelecimento AND a.nr_sequencia		= c.nr_seq_lote AND c.nr_seq_darf		= d.nr_sequencia AND d.nr_sequencia		= e.nr_seq_darf AND e.nr_titulo		= i.nr_titulo   AND (f.cd_tributo		= g.cd_tributo OR i.cd_tributo = g.cd_tributo) AND a.nr_sequencia		= nr_seq_lote_p and a.ie_agrupar_titulos	= 'N' AND d.cd_darf||CASE WHEN coalesce(coalesce(i.cd_variacao,f.cd_variacao)::text, '') = '' THEN obter_cd_darf_variacao(g.cd_tributo,'V')  ELSE coalesce(i.cd_variacao,f.cd_variacao) END 	= cd_receita_w AND CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END  	= dt_apuracao_mensal_w AND CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END  = dt_apuracao_diario_w GROUP BY 	a.nr_sequencia,
	b.cd_cgc,
	a.ie_finalidade_dctf,
	TRUNC(a.dt_referencia,'mm'),
	TRUNC(fim_mes(a.dt_referencia),'dd'),
...
FROM tributo g, darf_titulo_pagar e, darf d, dctf_lote_darf c, estabelecimento b, dctf_lote a, titulo_pagar i
LEFT OUTER JOIN titulo_pagar_imposto f ON (i.nr_seq_tributo = f.nr_sequencia)
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_sequencia		= c.nr_seq_lote and c.nr_seq_darf		= d.nr_sequencia and d.nr_sequencia		= e.nr_seq_darf and e.nr_titulo		= i.nr_titulo  and (f.cd_tributo		= g.cd_tributo or i.cd_tributo = g.cd_tributo) and a.nr_sequencia		= nr_seq_lote_p and a.ie_agrupar_titulos	= 'S' and (d.cd_tipo_credito IS NOT NULL AND d.cd_tipo_credito::text <> '') and d.cd_darf||coalesce(i.cd_variacao,f.cd_variacao)	= cd_receita_w and CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END  	= dt_apuracao_mensal_w and CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END  = dt_apuracao_diario_w group by
 	a.nr_sequencia,
	b.cd_cgc,
	a.ie_finalidade_dctf,
	TRUNC(a.dt_referencia,'mm'),
...
LEFT OUTER JOIN titulo_pagar_baixa j ON (i.nr_titulo = j.nr_titulo)
LEFT OUTER JOIN titulo_pagar_imposto f ON (i.nr_seq_tributo = f.nr_sequencia)
WHERE a.cd_estabelecimento	= b.cd_estabelecimento AND a.nr_sequencia		= c.nr_seq_lote AND c.nr_seq_darf		= d.nr_sequencia AND d.nr_sequencia		= e.nr_seq_darf AND e.nr_titulo		= i.nr_titulo   AND (f.cd_tributo		= g.cd_tributo OR i.cd_tributo = g.cd_tributo) AND a.nr_sequencia		= nr_seq_lote_p and a.ie_agrupar_titulos	= 'N' and (d.cd_tipo_credito IS NOT NULL AND d.cd_tipo_credito::text <> '') AND d.cd_darf||coalesce(i.cd_variacao,f.cd_variacao)	= cd_receita_w AND CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='T' THEN obter_periodo_data(d.dt_apuracao,'T') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='U' THEN obter_periodo_data(d.dt_apuracao,'U') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='B' THEN obter_periodo_data(d.dt_apuracao,'B') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='E' THEN obter_periodo_data(d.dt_apuracao,'E') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='A' THEN '00'  ELSE obter_periodo_data(d.dt_apuracao,'M') END  	= dt_apuracao_mensal_w AND CASE WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='S' THEN obter_periodo_data(d.dt_apuracao,'S') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='X' THEN obter_periodo_data(d.dt_apuracao,'X') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='Q' THEN obter_periodo_data(d.dt_apuracao,'Q') WHEN coalesce(i.ie_periodicidade,f.ie_periodicidade)='D' THEN obter_periodo_data(d.dt_apuracao,'D')  ELSE '00' END  = dt_apuracao_diario_w GROUP BY
 	a.nr_sequencia,
	b.cd_cgc,
	a.ie_finalidade_dctf,
	TRUNC(a.dt_referencia,'mm'),
...
EXIT WHEN NOT FOUND; /* apply on c04 */
	...
	/*
	programa DCTF mensal 1.6, da receita considera apenas a posição 55. Por isso, esta alteracao muda '07', por exemplo, para '70'
	*/
	insert into w_envio_dctf(nr_sequencia,
		nm_usuario,
		dt_atualizacao,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_envio_dctf_23 ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
