...
CREATE OR REPLACE PROCEDURE ptu_envio_resp_auditoria_v60 ( nr_seq_guia_p bigint, nr_seq_requisicao_p bigint, nr_seq_complemento_p bigint, ds_mensagem_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_auditoria_p INOUT bigint) AS $body$
DECLARE
...
values (nr_seq_auditoria_p, '00404', ie_tipo_cliente_w, 
	 ...
	 nm_usuario_p, clock_timestamp(), '060');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_envio_resp_auditoria_v60 ( nr_seq_guia_p bigint, nr_seq_requisicao_p bigint, nr_seq_complemento_p bigint, ds_mensagem_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_auditoria_p INOUT bigint) FROM PUBLIC;
