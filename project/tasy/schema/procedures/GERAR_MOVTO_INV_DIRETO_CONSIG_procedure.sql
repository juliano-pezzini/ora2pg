...
CREATE OR REPLACE PROCEDURE gerar_movto_inv_direto_consig ( nm_usuario_p text, cd_estabelecimento_p bigint, nr_documento_p bigint, cd_fornecedor_p text, dt_mesano_referencia_p timestamp default clock_timestamp(), dt_movimento_estoque_p timestamp default clock_timestamp()) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_movto_inv_direto_consig ( nm_usuario_p text, cd_estabelecimento_p bigint, nr_documento_p bigint, cd_fornecedor_p text, dt_mesano_referencia_p timestamp default clock_timestamp(), dt_movimento_estoque_p timestamp default clock_timestamp()) FROM PUBLIC;
