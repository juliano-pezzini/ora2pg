...
CREATE OR REPLACE PROCEDURE lfpd_registro_a310 ( nr_seq_controle_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_nota_p bigint, dt_inicio_p timestamp, dt_fim_p timestamp, ds_separador_p text, qt_linha_p INOUT bigint, nr_sequencia_p INOUT bigint) AS $body$
DECLARE
...
c01 CURSOR FOR
	SELECT	'A310' cd_registro,
		coalesce(b.nr_item_sequencial, b.nr_item_nf)	nr_seq_item,
		'P' || b.cd_procedimento || coalesce(to_char(b.ie_origem_proced),'1')	cd_item,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lfpd_registro_a310 ( nr_seq_controle_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_nota_p bigint, dt_inicio_p timestamp, dt_fim_p timestamp, ds_separador_p text, qt_linha_p INOUT bigint, nr_sequencia_p INOUT bigint) FROM PUBLIC;
