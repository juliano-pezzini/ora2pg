...
CREATE OR REPLACE PROCEDURE gerar_visao_atributo_selecao ( nr_sequencia_p bigint, nm_atributo_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_visao_atributo_selecao ( nr_sequencia_p bigint, nm_atributo_p text, nm_usuario_p text) FROM PUBLIC;
