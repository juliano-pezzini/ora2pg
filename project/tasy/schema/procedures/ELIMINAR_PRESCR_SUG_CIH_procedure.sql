...
CREATE OR REPLACE PROCEDURE eliminar_prescr_sug_cih (nr_prescricao_p bigint, nr_seq_material_p bigint, nr_prescr_orig_p bigint) AS $body$
DECLARE


nr_prescricao_w			prescr_medica.nr_prescricao%type;
nr_prescr_retorno_w		prescr_medica.nr_prescricao%type;
...
and	exists (select	x.nr_prescricao
		   ...
		   and		z.dt_inicio_prescr between dt_anterior_w and dt_prescricao_w
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliminar_prescr_sug_cih (nr_prescricao_p bigint, nr_seq_material_p bigint, nr_prescr_orig_p bigint) FROM PUBLIC;
