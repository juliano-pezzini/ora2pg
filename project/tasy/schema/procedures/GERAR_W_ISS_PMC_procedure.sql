...
CREATE OR REPLACE PROCEDURE gerar_w_iss_pmc (cd_estabelecimento_p bigint, nm_usuario_p text, dt_mesano_ref_p timestamp) AS $body$
DECLARE
...
and	trunc(a.dt_entrada_saida,'month') = trunc(dt_mesano_ref_p,'month') 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_iss_pmc (cd_estabelecimento_p bigint, nm_usuario_p text, dt_mesano_ref_p timestamp) FROM PUBLIC;
