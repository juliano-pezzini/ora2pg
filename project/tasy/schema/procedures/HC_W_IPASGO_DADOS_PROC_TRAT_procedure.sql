...
CREATE OR REPLACE PROCEDURE hc_w_ipasgo_dados_proc_trat ( nr_interno_conta_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text, nr_seq_tipo_fatura_p bigint, qt_linha_arq_p INOUT bigint, qt_linha_atend_p INOUT bigint) AS $body$
DECLARE

			 
-- Utilizada pelo Hospital Coração de Goiás 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hc_w_ipasgo_dados_proc_trat ( nr_interno_conta_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text, nr_seq_tipo_fatura_p bigint, qt_linha_arq_p INOUT bigint, qt_linha_atend_p INOUT bigint) FROM PUBLIC;
