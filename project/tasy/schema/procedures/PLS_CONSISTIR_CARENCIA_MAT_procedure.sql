...
CREATE OR REPLACE PROCEDURE pls_consistir_carencia_mat ( nr_seq_segurado_p pls_segurado.nr_sequencia%type, nr_seq_guia_mat_p pls_guia_plano_mat.nr_sequencia%type, nr_seq_guia_p bigint, nr_seq_conta_mat_p pls_conta_mat.nr_sequencia%type, nr_seq_requisicao_mat_p pls_requisicao_mat.nr_sequencia%type, nr_seq_material_p pls_material.nr_sequencia%type, nr_seq_estrut_mat_p bigint, dt_solicitacao_p timestamp, nr_seq_tipo_acomod_p bigint, ie_tipo_guia_p text, ie_carencia_abrangencia_ant_p text, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_consistir_carencia_mat ( nr_seq_segurado_p pls_segurado.nr_sequencia%type, nr_seq_guia_mat_p pls_guia_plano_mat.nr_sequencia%type, nr_seq_guia_p bigint, nr_seq_conta_mat_p pls_conta_mat.nr_sequencia%type, nr_seq_requisicao_mat_p pls_requisicao_mat.nr_sequencia%type, nr_seq_material_p pls_material.nr_sequencia%type, nr_seq_estrut_mat_p bigint, dt_solicitacao_p timestamp, nr_seq_tipo_acomod_p bigint, ie_tipo_guia_p text, ie_carencia_abrangencia_ant_p text, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type, nm_usuario_p usuario.nm_usuario%type) FROM PUBLIC;
