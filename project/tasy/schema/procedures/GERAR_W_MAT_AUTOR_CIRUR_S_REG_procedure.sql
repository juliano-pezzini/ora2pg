...
CREATE OR REPLACE PROCEDURE gerar_w_mat_autor_cirur_s_reg (nr_atendimento_p bigint, nr_seq_agenda_p bigint, nr_cirurgia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_mat_autor_cirur_s_reg (nr_atendimento_p bigint, nr_seq_agenda_p bigint, nr_cirurgia_p bigint, nm_usuario_p text) FROM PUBLIC;
