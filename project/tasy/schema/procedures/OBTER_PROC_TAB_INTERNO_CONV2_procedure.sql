...
CREATE OR REPLACE PROCEDURE obter_proc_tab_interno_conv2 (nr_seq_interno_p bigint, cd_estabelecimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, cd_plano_p text, dt_vigencia_p timestamp, cd_tipo_acomodacao_p bigint, cd_procedimento_p INOUT bigint, ie_origem_proced_p INOUT bigint, ie_tipo_atendimento_p atendimento_paciente.ie_tipo_atendimento%type default null) AS $body$
DECLARE
...
and 	coalesce(nr_seq_cbhpm_edicao, coalesce(nr_seq_edicao_cbhpm_w,0)) = coalesce(nr_seq_edicao_cbhpm_w,0)
...
nr_seq_edicao_cbhpm_w:= coalesce(nr_seq_edicao_cbhpm_w,0);
