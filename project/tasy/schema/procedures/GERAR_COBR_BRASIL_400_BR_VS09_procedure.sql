...
CREATE OR REPLACE PROCEDURE gerar_cobr_brasil_400_br_vs09 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE


/* Versão Set/09  - CNAB400/CBR643 */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobr_brasil_400_br_vs09 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
