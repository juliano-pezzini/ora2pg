...
CREATE OR REPLACE PROCEDURE update_diagnostico_linked_data ( nr_atendimento_p bigint, nr_seq_reg_template_p bigint, nr_seq_template_p bigint, nm_tabela_linked_data text) AS $body$
DECLARE
...
BEGIN
  ds_comando_w	:=	'update DIAGNOSTICO_ADMISSAO_ATEND set';
  FOR row1 IN c01
  LOOP
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE update_diagnostico_linked_data ( nr_atendimento_p bigint, nr_seq_reg_template_p bigint, nr_seq_template_p bigint, nm_tabela_linked_data text) FROM PUBLIC;
