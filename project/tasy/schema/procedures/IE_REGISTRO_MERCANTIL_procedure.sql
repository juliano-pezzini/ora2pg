...
CREATE OR REPLACE PROCEDURE ie_registro_mercantil ( cd_pessoa_fisica_p PESSOA_FISICA.CD_PESSOA_FISICA%type, nm_usuario_p PESSOA_FISICA_AUX.NM_USUARIO%type, operation_type_p text, ie_registro_mercantil_p PESSOA_FISICA_AUX.IE_REGISTRO_MERCANTIL%type default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ie_registro_mercantil ( cd_pessoa_fisica_p PESSOA_FISICA.CD_PESSOA_FISICA%type, nm_usuario_p PESSOA_FISICA_AUX.NM_USUARIO%type, operation_type_p text, ie_registro_mercantil_p PESSOA_FISICA_AUX.IE_REGISTRO_MERCANTIL%type default null) FROM PUBLIC;
