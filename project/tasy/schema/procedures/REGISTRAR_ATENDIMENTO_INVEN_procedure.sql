...
CREATE OR REPLACE PROCEDURE registrar_atendimento_inven ( nr_seq_inventario_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE registrar_atendimento_inven ( nr_seq_inventario_p bigint, nm_usuario_p text) FROM PUBLIC;
