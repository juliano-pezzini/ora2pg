...
CREATE OR REPLACE PROCEDURE gerar_pagto_bradesco_240_v89 ( nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE


/* Layout CNAB 240 Bradesco (de 16/06/2017) - Versao 07.6.4 de 31/05/2017.
Rotina criada para atender as necessidades da OS 1585898.  Baseada na estrutura da procedure GERAR_PAGTO_FEBRABAN_240_V87*/
...
banco_estab_interf_w	    banco_estab_interf.cd_convenio_banco%type;
...
c01 CURSOR FOR
SELECT	distinct
	CASE WHEN b.ie_tipo_pagamento='CC' THEN '01' WHEN b.ie_tipo_pagamento='DOC' THEN '03' WHEN b.ie_tipo_pagamento='TED' THEN '41' WHEN b.ie_tipo_pagamento='OP' THEN '30' WHEN b.ie_tipo_pagamento='DDA' THEN '01'  ELSE '03' END ,
	b.ie_tipo_pagamento,
	CASE WHEN b.ie_tipo_pagamento='CC' THEN '01'  ELSE '99' END
from	titulo_pagar_escrit b,
	banco_escritural a
where	b.ie_tipo_pagamento	in ('DOC','CC','OP','TED','DDA')
...
SELECT	b.cd_banco,
	...
	substr(coalesce(b.ie_digito_agencia,' '),1,1),
...
into STRICT	banco_estab_interf_w
...
and		c.nr_sequencia			= (nr_seq_envio_p)::numeric
and		upper(a.ds_objeto)		= upper('GERAR_PAGTO_BRADESCO_240_V89');
...
select	lpad(b.cd_cgc,14,'0'),
	...
	lpad(substr(c.cd_agencia_bancaria,1,5) || substr(coalesce(d.ie_digito,' '),1,1),6,'0'),
...
if (banco_estab_interf_w = 'X') then
	banco_estab_interf_w := cd_convenio_banco_w;
end if;

ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') || -- 1 ate 3
			'0000' || --4 ate 7
			'0' || -- 8
			rpad(' ',9,' ') || -- 9 ate 17
			'2' || -- 18
			cd_cgc_estab_w || -- 19 ate 32
			rpad(substr(banco_estab_interf_w,1,20),20,' ') || --33 ate 52
			...
			'089' || -- 164 ate 166
			'06250' || --Densidade do arquivo: 6250 BPI (Nota G020)
			rpad(' ',69,' ');
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||  /*Pos 01 a 03*/
						...
						rpad(substr(banco_estab_interf_w,1,20),20,' ') || /*Pos 33 a 52*/
...
WHERE a.nr_titulo	= nr_titulo_w;
		...
		ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') || /*1 a 3*/
					...
					coalesce(cd_digito_agencia_w,' ') || /*29*/
...
EXIT WHEN NOT FOUND; /* apply on c03 */
	...
	if (ie_forma_lanc_w	= '16') or (ie_forma_lanc_w	= '17') or (ie_forma_lanc_w	= '11') then
		...
		nr_versao_w	:= '040'; /*Versao para header de lote - Segmento J*/
	end if;
	...
	ds_conteudo_w	:=	lpad(cd_banco_cobr_w,3,'0') ||
				...
				'2' || --18
				cd_cgc_estab_w ||
				rpad(substr(banco_estab_interf_w,1,20),20,' ') ||
				cd_agencia_estab_w ||
				nr_conta_estab_w ||
				ie_digito_estab_w ||
				' ' ||
	...
	EXIT WHEN NOT FOUND; /* apply on c04 */
      ...
      /* segmento J-52 obrigatorio 30-08-2019 */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pagto_bradesco_240_v89 ( nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
