...
CREATE OR REPLACE PROCEDURE insere_laudo_integracao_hl7 ( nr_sequencia_p bigint, nr_acc_number_p text, cd_crm_uf_p text, ie_status_p text, cd_laudo_externo_p bigint, ds_laudo_p text, dt_liberacao_laudo_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE insere_laudo_integracao_hl7 ( nr_sequencia_p bigint, nr_acc_number_p text, cd_crm_uf_p text, ie_status_p text, cd_laudo_externo_p bigint, ds_laudo_p text, dt_liberacao_laudo_p text) FROM PUBLIC;
