...
CREATE OR REPLACE PROCEDURE ptu_gerar_arq_compl_prestad_50 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text) AS $body$
DECLARE

 
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
Finalidade: Gerar arquivo A450 de acordo com a versão PTU 5.0 
------------------------------------------------------------------------------------------------------------------- 
...
ds_conteudo_w :=	lpad(nr_seq_registro_w,8,'0') || '451' || cd_unimed_destino_w || cd_unimed_origem_w || dt_geracao_w || '03';
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	ds_conteudo_w :=	lpad(nr_seq_registro_w,8,'0') || '452' || cd_rede_w || nm_comercial_prod_w || ie_reg_plano_ans_w || nr_reg_plano_ans_w || 
				ie_classif_plano_w || ie_situacao_ans_w || ie_seg_produto_w || nm_com_produto_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_arq_compl_prestad_50 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text) FROM PUBLIC;
