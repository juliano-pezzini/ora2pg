...
CREATE OR REPLACE PROCEDURE ptu_gerar_arq_mov_prestador_60 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text, ds_local_p text, nm_arquivo_p text) AS $body$
DECLARE

 
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
Finalidade: Gerar arquivo A400 de acordo com a versão PTU 6.0 
----------------------------------------------------------------------------------------------------------------------- 
...
C02 CURSOR FOR 
	SELECT	z.nr_sequencia, 
		...
		rpad(coalesce(substr(z.ds_endereco_web,1,50),' '),50,' '), 
...
ds_conteudo_w :=	lpad(nr_seq_registro_w,8,'0') || '401' || cd_unimed_destino_w || cd_unimed_origem_w || dt_geracao_w || '21' || id_ope_prest_w || 
			nr_registro_ans_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_arq_mov_prestador_60 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text, ds_local_p text, nm_arquivo_p text) FROM PUBLIC;
