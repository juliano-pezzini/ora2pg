...
CREATE OR REPLACE PROCEDURE gerar_prescr_san_agecons (nr_seq_agenda_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_prescricao_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_prescr_san_agecons (nr_seq_agenda_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_prescricao_p INOUT bigint) FROM PUBLIC;
