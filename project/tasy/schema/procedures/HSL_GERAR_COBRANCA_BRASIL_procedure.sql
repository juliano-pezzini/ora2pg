...
CREATE OR REPLACE PROCEDURE hsl_gerar_cobranca_brasil ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
UNION
	...
	SELECT	3 nr_seq_arquivo, 
		...
		substr(elimina_acentuacao(b.nm_pessoa),1,255) nm_pessoa, 
...
UNION
	...
	SELECT	3 nr_seq_arquivo, 
		...
		b.ie_tipo_pessoa ie_tipo_inscricao, 
		b.cd_cgc_cpf nr_inscricao, 
		upper(substr(elimina_acentuacao(b.nm_pessoa),1,255)) nm_pessoa, 
		upper(substr(obter_dados_pf_pj(b.cd_pessoa_fisica, b.cd_cgc, 'E'),1,255)) ds_endereco, 
		substr(upper(obter_dados_pf_pj(b.cd_pessoa_fisica, b.cd_cgc, 'B')),1,80) ds_bairro, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hsl_gerar_cobranca_brasil ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
