...
CREATE OR REPLACE PROCEDURE limpar_tabela_log_lab () AS $body$
DECLARE
...
CALL gravar_processo_longo('Vetor Principal', 'LIMPAR_TABELA_LOG_LAB', -1);
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	CALL gravar_processo_longo(nm_tabela_w,'LIMPAR_TABELA_LOG_LAB',-1);
	...
	if (nm_tabela_w = 'LOG_LAB') then
		begin
			...
			for i in 1..Vetor_c01_w.COUNT loop
				...
				CALL gravar_processo_longo('Removendo LOG_LAB -> ' || i || '/' || Vetor_c01_w.COUNT,'LIMPAR_TABELA_LOG_LAB',-1);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE limpar_tabela_log_lab () FROM PUBLIC;
