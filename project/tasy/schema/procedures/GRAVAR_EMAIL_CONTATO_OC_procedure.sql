...
CREATE OR REPLACE PROCEDURE gravar_email_contato_oc ( nr_ordem_compra_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gravar_email_contato_oc ( nr_ordem_compra_p bigint) FROM PUBLIC;
