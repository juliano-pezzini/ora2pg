...
CREATE OR REPLACE PROCEDURE instalar_horario_solucao ( nr_prescricao_p bigint, nr_seq_solucao_p bigint, nr_etapa_p bigint, dt_instalacao_p timestamp, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE instalar_horario_solucao ( nr_prescricao_p bigint, nr_seq_solucao_p bigint, nr_etapa_p bigint, dt_instalacao_p timestamp, nm_usuario_p text) FROM PUBLIC;
