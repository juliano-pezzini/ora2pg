...
CREATE OR REPLACE PROCEDURE nut_alterar_quant_producao (nr_seq_item_p bigint, qt_novo_p bigint, nm_usuario_p text) AS $body$
DECLARE


qt_anterior_w		double precision;
qt_percent_deriv_w		double precision;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE nut_alterar_quant_producao (nr_seq_item_p bigint, qt_novo_p bigint, nm_usuario_p text) FROM PUBLIC;
