...
CREATE OR REPLACE PROCEDURE pls_obter_congenere_reg_web ( nr_Seq_contrato_p bigint, nr_seq_congenere_p INOUT bigint, cd_congenere_p INOUT text, ds_congenere_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_obter_congenere_reg_web ( nr_Seq_contrato_p bigint, nr_seq_congenere_p INOUT bigint, cd_congenere_p INOUT text, ds_congenere_p INOUT text) FROM PUBLIC;
