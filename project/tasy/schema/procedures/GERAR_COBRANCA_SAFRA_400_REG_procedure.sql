...
CREATE OR REPLACE PROCEDURE gerar_cobranca_safra_400_reg ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_grupo_inst_p bigint) AS $body$
DECLARE
...
SELECT	CASE WHEN coalesce(b.cd_pessoa_fisica::text, '') = '' THEN '02'  ELSE '01' END  ie_tipo_inscricao, 
	...
	lpad(a.cd_agencia_bancaria,5,'0') cd_agencia_bancaria, 
	lpad(substr(a.nr_conta,1,5) || substr(a.ie_digito_conta,1,1),9,'0') cd_conta, 
...
select	lpad(coalesce(b.cd_conta,'0'),9,'0'), 
...
ds_conteudo_w	:= 	'0' 								|| /*Pos 01*/
					...
					cd_agencia_cobr_w 					|| /*Pos 27*/
 
					cd_conta_cobr_w						|| /*a 40*/
					...
					rpad('BANCO SAFRA',11,' ') 			|| /*Pos 80 a 90*/
 
					rpad(' ',4,' ')						|| /*Pos 91 a 94*/
 
					dt_geracao_w 						|| /*Pos 95 a 100*/
 
					rpad(' ',291,' ') 					|| /*Pos 101 a 391*/
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	ds_conteudo_w	:=	'1' 																		|| /*Pos 01*/
						...
						lpad(cd_agencia_bancaria_w,5,'0') 											|| /*Pos 18 */
 
						lpad(cd_conta_w,9,'0') 														|| /*a 31*/
 
						rpad(' ',31,' ')	 														|| /*Pos 32 a 62*/
	 
						lpad(nr_titulo_w,9,'0') 													|| /*Pos 63 a 71*/
 
						rpad(' ',30,' ')															|| /*Pos 72 a 101*/
						...
						lpad(cd_banco_w,3,'0') 														|| /*Pos 18 a 21*/
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobranca_safra_400_reg ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_grupo_inst_p bigint) FROM PUBLIC;
