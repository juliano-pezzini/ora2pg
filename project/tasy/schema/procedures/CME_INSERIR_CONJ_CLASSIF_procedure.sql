...
CREATE OR REPLACE PROCEDURE cme_inserir_conj_classif ( nr_seq_conj_p bigint, ds_classif_p text, nm_usuario_p text) AS $body$
DECLARE
...
and	coalesce(nr_agrupador::text, '') = '';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cme_inserir_conj_classif ( nr_seq_conj_p bigint, ds_classif_p text, nm_usuario_p text) FROM PUBLIC;
