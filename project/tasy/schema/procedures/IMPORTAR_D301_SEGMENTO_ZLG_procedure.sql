...
CREATE OR REPLACE PROCEDURE importar_d301_segmento_zlg ( nr_seq_dataset_p bigint, ds_conteudo_zlg_p text, nm_usuario_p text) AS $body$
DECLARE

 ds_conteudo_zlg_w    varchar(4000);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE importar_d301_segmento_zlg ( nr_seq_dataset_p bigint, ds_conteudo_zlg_p text, nm_usuario_p text) FROM PUBLIC;
