...
CREATE OR REPLACE PROCEDURE ptu_gerar_resp_cont_benef_v40 ( nr_seq_pedido_cont_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
dt_referencia_w	:= to_date('01/'||dt_mes_referencia_w||'/'||dt_ano_referencia_w);
...
if (qt_registros_w	> 0) then 
	...
	and	pls_obter_dados_segurado(d.nr_sequencia,'CS')	= 'A';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_resp_cont_benef_v40 ( nr_seq_pedido_cont_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
