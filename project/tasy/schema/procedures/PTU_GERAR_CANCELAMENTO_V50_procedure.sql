...
CREATE OR REPLACE PROCEDURE ptu_gerar_cancelamento_v50 ( nr_seq_guia_p bigint, nr_seq_requisicao_p bigint, nr_seq_complemento_p bigint, ds_motivo_p text, nr_versao_ptu_p text, nr_seq_execucao_p INOUT bigint, nm_usuario_p text) AS $body$
DECLARE
...
values (nextval('ptu_cancelamento_seq'), '00311', ie_tipo_cliente_w,
	 ...
	 clock_timestamp(), nr_versao_ptu_p, substr(ds_motivo_p,1,999),
	 'N');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_cancelamento_v50 ( nr_seq_guia_p bigint, nr_seq_requisicao_p bigint, nr_seq_complemento_p bigint, ds_motivo_p text, nr_versao_ptu_p text, nr_seq_execucao_p INOUT bigint, nm_usuario_p text) FROM PUBLIC;
