...
CREATE OR REPLACE PROCEDURE cm_insere_conj_teste_er ( nr_seq_conjunto_p bigint, nr_seq_ciclo_p bigint, nr_seq_lote_p bigint, cd_setor_atendimento_p bigint, nm_usuario_barras_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
/* commit não é necessário, pois já está no cme_incluir_itens_controle */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cm_insere_conj_teste_er ( nr_seq_conjunto_p bigint, nr_seq_ciclo_p bigint, nr_seq_lote_p bigint, cd_setor_atendimento_p bigint, nm_usuario_barras_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
