...
CREATE OR REPLACE PROCEDURE gerar_dic_obj_idioma_wjmi (cd_funcao_p bigint, nr_seq_idioma_p bigint, nm_usuario_p text) AS $body$
DECLARE
    ...
    c01 CURSOR FOR
        SELECT a.nr_sequencia,
         ...
         where a.cd_funcao = cd_funcao_p
           ...
           and coalesce(a.ie_objeto_nulo, 'N') = 'N'
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_dic_obj_idioma_wjmi (cd_funcao_p bigint, nr_seq_idioma_p bigint, nm_usuario_p text) FROM PUBLIC;
