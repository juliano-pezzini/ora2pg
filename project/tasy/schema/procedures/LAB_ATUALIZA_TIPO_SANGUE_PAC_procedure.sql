...
CREATE OR REPLACE PROCEDURE lab_atualiza_tipo_sangue_pac ( nr_seq_resultado_p exame_lab_result_item.nr_sequencia%type, nr_seq_prescr_p exame_lab_result_item.nr_seq_prescr%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lab_atualiza_tipo_sangue_pac ( nr_seq_resultado_p exame_lab_result_item.nr_sequencia%type, nr_seq_prescr_p exame_lab_result_item.nr_seq_prescr%type) FROM PUBLIC;
