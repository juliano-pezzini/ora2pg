...
CREATE OR REPLACE PROCEDURE ptu_gerar_resp_pedido_aut_v50 ( nr_seq_controle_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
values (nr_seq_resp_novo_w, '00501', cd_unimed_exec_w,
	 ...
	 '050', ie_sexo_w, to_date(dt_nascimento_w, 'dd/mm/yyyy'));
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_resp_pedido_aut_v50 ( nr_seq_controle_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
