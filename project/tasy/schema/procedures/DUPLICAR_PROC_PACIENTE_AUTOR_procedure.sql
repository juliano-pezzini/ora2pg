...
CREATE OR REPLACE PROCEDURE duplicar_proc_paciente_autor ( nr_sequencia_p bigint, qt_procedimento_p bigint, nm_usuario_p text, nr_seq_proc_autor_p bigint, nr_seq_gerada_p INOUT bigint) AS $body$
DECLARE
...
insert into Procedimento_paciente(
	...
	cd_medico_req, ie_tipo_guia, ie_video, ie_auditoria, nr_seq_exame,nr_seq_aih,nr_seq_proc_interno, nr_seq_proc_autor)
SELECT
	nr_sequencia_w, nr_atendimento, dt_entrada_unidade, cd_procedimento,
	dt_procedimento + 3/86400, qt_procedimento_p, clock_timestamp(), nm_usuario_p,
	cd_medico, cd_convenio, cd_categoria, cd_pessoa_fisica, dt_prescricao,
	--'Item gerado ao desdobrar item na autorização convênio', vl_procedimento, vl_medico, vl_anestesista,
	wheb_mensagem_pck.get_texto(304100), vl_procedimento, vl_medico, vl_anestesista,
	vl_materiais, cd_edicao_amb, cd_tabela_servico, dt_vigencia_preco,
	cd_procedimento_princ, dt_procedimento_princ, dt_acerto_conta,
	dt_acerto_convenio, dt_acerto_medico, vl_auxiliares, vl_custo_operacional,
	tx_medico, tx_anestesia, nr_prescricao, nr_sequencia_prescricao,
	...
	cd_setor_receita, vl_adic_plant, qt_porte_anestesico, tx_hora_extra,
	ie_emite_conta_honor, nr_seq_atepacu, ie_proc_princ_atend,
	cd_medico_req, ie_tipo_guia, ie_video, ie_auditoria, nr_seq_exame,nr_seq_aih,nr_seq_proc_interno, nr_seq_proc_autor_p
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE duplicar_proc_paciente_autor ( nr_sequencia_p bigint, qt_procedimento_p bigint, nm_usuario_p text, nr_seq_proc_autor_p bigint, nr_seq_gerada_p INOUT bigint) FROM PUBLIC;
