...
CREATE OR REPLACE PROCEDURE atualizar_saldo_titulo ( nr_titulo_p bigint, nm_usuario_p text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_saldo_titulo ( nr_titulo_p bigint, nm_usuario_p text) FROM PUBLIC;
