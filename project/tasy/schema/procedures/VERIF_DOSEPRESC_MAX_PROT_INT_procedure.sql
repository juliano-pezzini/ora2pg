...
if (coalesce(cd_material_w,0) > 0) and (cd_unidade_medida_dose_w IS NOT NULL AND cd_unidade_medida_dose_w::text <> '') and (coalesce(qt_dose_ww,0) > 0) then
 ...
 -- Total do paciente  em todos os protocolos
			    qt_dose_w   :=  coalesce(obter_dose_total_medic_pf_onc(cd_pessoa_fisica_w, cd_material_w),0);
        end;
      ...
      EXIT WHEN NOT FOUND; /* apply on c01 */
        ...
        if (ie_dose_cumulativa_w = 'S') then
          if ('S' = ds_mensagem_w := valida_dose_comulativa(cd_material_w, qt_dose_ww, cd_unidade_medida_dose_w, cd_pessoa_fisica_w, coalesce(qt_adminstracao_w,1), dose_cumulativa_w, cd_unidade_cumulativa_w)) then
		        nr_seq_erro_w := gerar_erro_pac_prot(nr_seq_paciente_p, nr_sequencia_p, 1, null, cd_perfil_w, wheb_usuario_pck.get_nm_usuario, nr_seq_erro_w, ds_mensagem_w);
          end if;
        end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE verif_dosepresc_max_prot_int ( nr_seq_paciente_p bigint, nr_sequencia_p bigint, ie_utiliza_horarios_p text, ds_erro_p INOUT text, ds_erro2_p INOUT text, ds_mensagem_p INOUT text, cd_material_p bigint default null, cd_unid_med_prescr_p text default null, qt_dose_prescr_p bigint default null, ie_via_aplicacao_p text default null, ds_observacao_p text default null, ds_ciclos_aplicacao_p text default null, is_paciente_medic_update text default null, qt_dias_util_p bigint default null, ie_local_adm_p text default null, ie_uso_continuo_p text default null, cd_intervalo_p text default null, qt_dose_p bigint default null, ds_justificativa_p text default null, cd_unid_med_dose_p text default null) FROM PUBLIC;
