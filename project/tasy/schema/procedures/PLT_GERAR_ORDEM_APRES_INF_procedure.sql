...
CREATE OR REPLACE PROCEDURE plt_gerar_ordem_apres_inf ( nr_seq_grupo_p bigint, ie_acm_sn_final_p text, ie_informacao_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE plt_gerar_ordem_apres_inf ( nr_seq_grupo_p bigint, ie_acm_sn_final_p text, ie_informacao_p text) FROM PUBLIC;
