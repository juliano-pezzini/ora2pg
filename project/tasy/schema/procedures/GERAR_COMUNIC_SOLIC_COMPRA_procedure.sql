...
CREATE OR REPLACE PROCEDURE gerar_comunic_solic_compra ( nr_solic_compra_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_comunic_solic_compra ( nr_solic_compra_p bigint, nm_usuario_p text) FROM PUBLIC;
