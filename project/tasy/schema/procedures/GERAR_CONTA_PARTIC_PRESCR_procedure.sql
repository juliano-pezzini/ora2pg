...
CREATE OR REPLACE PROCEDURE gerar_conta_partic_prescr (nr_sequencia_p bigint, vl_glosa_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_conta_partic_prescr (nr_sequencia_p bigint, vl_glosa_p bigint, nm_usuario_p text) FROM PUBLIC;
