...
CREATE OR REPLACE PROCEDURE lab_aprova_exame_prescricao ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_resultado_p bigint, cd_medico_resp_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lab_aprova_exame_prescricao ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_resultado_p bigint, cd_medico_resp_p text, nm_usuario_p text) FROM PUBLIC;
