...
CREATE OR REPLACE PROCEDURE gerar_conciliacao_bb240 (nr_seq_extrato_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_conciliacao_bb240 (nr_seq_extrato_p bigint, nm_usuario_p text) FROM PUBLIC;
