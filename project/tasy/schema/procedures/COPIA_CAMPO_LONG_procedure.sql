...
CREATE OR REPLACE PROCEDURE copia_campo_long ( nm_tabela_p text,nm_coluna_p text,ds_restricao_where_p text,ds_param_select_p text,ds_param_update_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE copia_campo_long ( nm_tabela_p text,nm_coluna_p text,ds_restricao_where_p text,ds_param_select_p text,ds_param_update_p text) FROM PUBLIC;
