...
CREATE OR REPLACE PROCEDURE pls_copia_parametro_congenere ( nr_seq_con_origem_p bigint, nr_seq_con_destino_p bigint, nm_tabela_p text, ie_excluir_p text, nm_usuario_p text) AS $body$
BEGIN
...
if (nm_tabela_p	= 'PLS_REGRA_PRECO_PROC') then
	...
	insert into pls_regra_preco_proc(nr_sequencia, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec, nr_seq_congenere,
	...
	SELECT	nextval('pls_regra_preco_proc_seq'), clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p, nr_seq_con_destino_p,
		nr_seq_plano, nr_seq_categoria, nr_seq_clinica, nr_seq_tipo_acomodacao, nr_seq_tipo_atendimento, cd_edicao_amb,
		cd_procedimento, ie_origem_proced, cd_area_procedimento, cd_especialidade, cd_grupo_proc, tx_ajuste_geral,
		vl_ch_honorarios, vl_ch_custo_oper, vl_filme, tx_ajuste_custo_oper, tx_ajuste_partic, vl_proc_negociado,
		ie_situacao, dt_inicio_vigencia, cd_estabelecimento, dt_fim_vigencia, tx_ajuste_filme, tx_ajuste_ch_honor,
...
if (nm_tabela_p	= 'PLS_REGRA_PRECO_MAT') then
	...
	insert into pls_regra_preco_mat(nr_sequencia, cd_estabelecimento, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
		...
		ie_regime_atendimento, ie_regime_atendimento_princ, ie_saude_ocupacional, nr_seq_tipo_atendimento)
	SELECT	nextval('pls_regra_preco_mat_seq'), cd_estabelecimento, clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p, 
...
if (nm_tabela_p	= 'PLS_REGRA_PRECO_SERVICO') then
	...
	insert into pls_regra_preco_servico(nr_sequencia, cd_estabelecimento, dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
		...
		ie_tipo_tabela, ie_gerar_remido, ie_regime_atendimento, ie_regime_atendimento_princ, ie_saude_ocupacional,
		nr_seq_tipo_atendimento)
	SELECT	nextval('pls_regra_preco_servico_seq'), cd_estabelecimento, clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
...
if (nm_tabela_p	= 'PLS_REGRA_INTERCAMBIO') then
	...
	insert into pls_regra_intercambio(nr_sequencia, nr_seq_congenere, dt_inicio_vigencia, dt_fim_vigencia,
		dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
		pr_taxa, vl_taxa, nr_seq_plano, nr_seq_grupo_congenere, ie_beneficio_obito,ie_pcmso,
		ie_tipo_intercambio)
	SELECT	nextval('pls_regra_intercambio_seq'), nr_seq_con_destino_p, dt_inicio_vigencia, dt_fim_vigencia,
...
if (nm_tabela_p	= 'PLS_REGRA_PCMSO') then
	...
	insert into pls_regra_pcmso(nr_sequencia, nr_seq_congenere, dt_inicio_vigencia, dt_fim_vigencia,
		dt_atualizacao, nm_usuario, dt_atualizacao_nrec, nm_usuario_nrec,
		pr_taxa, vl_taxa)
	SELECT	nextval('pls_regra_intercambio_seq'), nr_seq_con_destino_p, dt_inicio_vigencia, dt_fim_vigencia,
		clock_timestamp(), nm_usuario_p, clock_timestamp(), nm_usuario_p,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_copia_parametro_congenere ( nr_seq_con_origem_p bigint, nr_seq_con_destino_p bigint, nm_tabela_p text, ie_excluir_p text, nm_usuario_p text) FROM PUBLIC;
