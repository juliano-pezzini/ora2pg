...
cd_procedimento_conta_w		pls_conta_proc_imp.cd_procedimento_conv%type;
ie_origem_proced_conta_w	bigint;
qt_procedimento_imp_w		pls_conta_proc_imp.qt_executado%type;
cd_guia_w			varchar(20);
qt_autorizada_w				pls_guia_plano_proc.qt_autorizada%type;
qt_carencia_util_w			pls_conta_proc_imp.qt_executado%type;
...
if (ie_tipo_consistencia_w = 'G') then
	...
	begin
	select	a.nr_seq_prestador_conv,
		b.cd_guia_ok_conv,
		b.nr_seq_segurado_conv,
		--a.nr_seq_congenere,
		b.ie_carater_atendimento_conv,
		'C'
	...
	if (coalesce(cd_guia_w,'X') <> 'X') then
		...
		and	cd_procedimento_conv = cd_procedimento_conta_w
		and	ie_origem_proced_conv = ie_origem_proced_conta_w
