...
CREATE OR REPLACE PROCEDURE obter_info_aval_ant ( cd_perfil_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p usuario.cd_pessoa_fisica%type, nm_usuario_p text, nr_seq_prescr_atual_p bigint, nr_seq_prescr_p INOUT bigint, nr_seq_modelo_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE obter_info_aval_ant ( cd_perfil_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p usuario.cd_pessoa_fisica%type, nm_usuario_p text, nr_seq_prescr_atual_p bigint, nr_seq_prescr_p INOUT bigint, nr_seq_modelo_p INOUT bigint) FROM PUBLIC;
