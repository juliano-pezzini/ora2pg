...
CREATE OR REPLACE PROCEDURE hd_gerar_medic_padrao ( nr_prescricao_p bigint, ds_lista_medic_p text, ie_origem_inf_p bigint, ie_sem_aprazamento_p text, nr_seq_solucao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hd_gerar_medic_padrao ( nr_prescricao_p bigint, ds_lista_medic_p text, ie_origem_inf_p bigint, ie_sem_aprazamento_p text, nr_seq_solucao_p bigint, nm_usuario_p text) FROM PUBLIC;
