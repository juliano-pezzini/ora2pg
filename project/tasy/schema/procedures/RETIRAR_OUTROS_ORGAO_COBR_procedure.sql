...
CREATE OR REPLACE PROCEDURE retirar_outros_orgao_cobr ( nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	ds_historico_w := wheb_mensagem_pck.get_texto(337852, 'NM_USUARIO=' || nm_usuario_p || ';VL_TOTAL=' || vl_acobrar_w || ';DT_ATUALIZACAO=' || to_char(clock_timestamp(),'dd/MM/yyyy hh24:mi:ss'));
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE retirar_outros_orgao_cobr ( nm_usuario_p text) FROM PUBLIC;
