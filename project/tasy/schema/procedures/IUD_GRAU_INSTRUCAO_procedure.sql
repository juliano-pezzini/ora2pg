...
CREATE OR REPLACE PROCEDURE iud_grau_instrucao ( cd_pessoa_fisica_p PESSOA_FISICA.CD_PESSOA_FISICA%type, nm_usuario_p PESSOA_FISICA_AUX.NM_USUARIO%type, operation_type_p text, nr_seq_grau_instrucao_p PESSOA_FISICA_AUX.NR_SEQ_GRAU_INSTRUCAO%type default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE iud_grau_instrucao ( cd_pessoa_fisica_p PESSOA_FISICA.CD_PESSOA_FISICA%type, nm_usuario_p PESSOA_FISICA_AUX.NM_USUARIO%type, operation_type_p text, nr_seq_grau_instrucao_p PESSOA_FISICA_AUX.NR_SEQ_GRAU_INSTRUCAO%type default null) FROM PUBLIC;
