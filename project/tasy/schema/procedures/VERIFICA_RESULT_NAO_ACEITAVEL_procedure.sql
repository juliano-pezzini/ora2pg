...
CREATE OR REPLACE PROCEDURE verifica_result_nao_aceitavel (nr_prescricao_p bigint, nr_seq_prescr_p bigint, possui_result_nao_aceit_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE verifica_result_nao_aceitavel (nr_prescricao_p bigint, nr_seq_prescr_p bigint, possui_result_nao_aceit_p INOUT text) FROM PUBLIC;
