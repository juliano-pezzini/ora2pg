...
CREATE OR REPLACE PROCEDURE gerar_transf_age_servico (ds_lista_p text, cd_agenda_p bigint, dt_agenda_p timestamp, ie_feriado_p text, ie_sobra_horario_p text, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_atendimento_p bigint, r_seq_evento_atend_p bigint, ds_erro_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_transf_age_servico (ds_lista_p text, cd_agenda_p bigint, dt_agenda_p timestamp, ie_feriado_p text, ie_sobra_horario_p text, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_atendimento_p bigint, r_seq_evento_atend_p bigint, ds_erro_p INOUT text) FROM PUBLIC;
