...
CREATE OR REPLACE PROCEDURE atualizar_impressao_lote_aqui ( nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_impressao_lote_aqui ( nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
