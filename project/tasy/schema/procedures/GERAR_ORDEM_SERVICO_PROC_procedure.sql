...
CREATE OR REPLACE PROCEDURE gerar_ordem_servico_proc (nr_prescricao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
SELECT	SUBSTR(Obter_Desc_Prescr_Proc(a.cd_procedimento,a.ie_origem_proced,a.nr_seq_proc_interno),1,255),
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	EXIT WHEN NOT FOUND; /* apply on C02 */
		...
		values(nr_sequencia_w,				-- nr_sequencia,
			...
			'A',				-- ie_prioridade,
			'N',				-- ie_parado,
			substr(obter_desc_expressao(729126) || nr_atendimento_w || ' - ' || nm_paciente_w || ' - ' || ds_procedimento_w,1,80),		-- ds_dano_breve,
			...
			obter_desc_expressao(326099) || ' ' || ds_unidade_w || chr(13) ||
			obter_desc_expressao(293151) || ': ' || ds_prescritor_w || chr(13) ||
			obter_desc_expressao(729130) || ds_procedimento_w || chr(13) ||	ds_dano_w,				-- ds_dano,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_ordem_servico_proc (nr_prescricao_p bigint, nm_usuario_p text) FROM PUBLIC;
