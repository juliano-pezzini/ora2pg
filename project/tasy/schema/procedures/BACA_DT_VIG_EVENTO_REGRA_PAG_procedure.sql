...
CREATE OR REPLACE PROCEDURE baca_dt_vig_evento_regra_pag () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_evento_regra_pag () FROM PUBLIC;
