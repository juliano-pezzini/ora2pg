...
CREATE OR REPLACE PROCEDURE gerar_evento_log_atend ( nr_seq_evento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_log_atend ( nr_seq_evento_p bigint, nm_usuario_p text) FROM PUBLIC;
