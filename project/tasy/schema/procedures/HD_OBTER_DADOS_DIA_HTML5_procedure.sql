...
CREATE OR REPLACE PROCEDURE hd_obter_dados_dia_html5 ( nr_seq_dialise_p bigint, cd_pessoa_fisica_p INOUT text, nr_seq_dialisador_ativo_p INOUT text, nr_seq_dialise_dialis_ativo_p INOUT text, nm_pessoa_fisica_p INOUT text, qt_pa_diast_pre_deitado_p INOUT text, qt_pa_diast_pre_pe_p INOUT text, qt_pa_sist_pre_deitado_p INOUT text, qt_peso_pre_p INOUT text, nr_seq_unid_dialise_p INOUT text, nr_seq_ponto_acesso_p INOUT text, nr_seq_maquina_p INOUT text, ie_tipo_dialise_p INOUT text, dt_dialise_retro_p INOUT timestamp, ds_dt_nascimento_pf_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hd_obter_dados_dia_html5 ( nr_seq_dialise_p bigint, cd_pessoa_fisica_p INOUT text, nr_seq_dialisador_ativo_p INOUT text, nr_seq_dialise_dialis_ativo_p INOUT text, nm_pessoa_fisica_p INOUT text, qt_pa_diast_pre_deitado_p INOUT text, qt_pa_diast_pre_pe_p INOUT text, qt_pa_sist_pre_deitado_p INOUT text, qt_peso_pre_p INOUT text, nr_seq_unid_dialise_p INOUT text, nr_seq_ponto_acesso_p INOUT text, nr_seq_maquina_p INOUT text, ie_tipo_dialise_p INOUT text, dt_dialise_retro_p INOUT timestamp, ds_dt_nascimento_pf_p INOUT text) FROM PUBLIC;
