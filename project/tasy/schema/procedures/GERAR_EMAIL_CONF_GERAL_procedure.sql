...
CREATE OR REPLACE PROCEDURE gerar_email_conf_geral ( qt_dias_p bigint ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_email_conf_geral ( qt_dias_p bigint ) FROM PUBLIC;
