...
CREATE OR REPLACE PROCEDURE copiar_parametros_convenio ( cd_convenio_orig_p bigint, cd_estab_orig_p bigint, cd_convenio_dest_p bigint, cd_estab_dest_p bigint, nm_tabela_p text, ie_excluir_p text, nm_usuario_p text) AS $body$
DECLARE
...
if (nm_tabela_p = 'CONSISTE_SETOR_PROC') then
	...
	insert into conta_financ_regra(
		nr_sequencia, cd_estabelecimento, cd_operacao_nf, ie_tipo_convenio, nr_seq_grupo, nr_seq_subgrupo,
		nr_seq_conta_financ, ie_entrada_saida, cd_conta_contabil, ie_tipo_atendimento, nr_seq_forma_org, nr_seq_trans_fin,
		dt_atualizacao, nm_usuario, cd_categoria, cd_local_estoque, ie_complexidade, ie_tipo_pessoa, nr_seq_produto,
		cd_procedimento, cd_material, cd_grupo_material, cd_subgrupo_material, cd_classe_material, nr_seq_proj_rec,
		ie_tipo_financiamento, nr_seq_familia, cd_area_procedimento, ie_nota_credito, ie_tipo_titulo_pagar,
		cd_especialidade, cd_grupo_proc, cd_centro_custo, ie_clinica, ie_origem_proced, ie_tipo_titulo_receber,
		cd_convenio, cd_setor_atendimento, cd_moeda, ds_observacao, ie_origem_tit_pagar, nr_seq_classe_tp,
		cd_tipo_pessoa, cd_cgc, cd_pessoa_fisica, ie_faturamento, ie_origem_tit_rec, nr_seq_classe_tr)
	SELECT	nextval('conta_financ_regra_seq'), cd_estab_dest_p, cd_operacao_nf, ie_tipo_convenio, nr_seq_grupo, nr_seq_subgrupo,
		nr_seq_conta_financ, ie_entrada_saida, cd_conta_contabil, ie_tipo_atendimento, nr_seq_forma_org, nr_seq_trans_fin, 
		clock_timestamp(), nm_usuario_p, cd_categoria, cd_local_estoque, ie_complexidade, ie_tipo_pessoa, nr_seq_produto, 
		cd_procedimento, cd_material, cd_grupo_material, cd_subgrupo_material, cd_classe_material, nr_seq_proj_rec,
		ie_tipo_financiamento, nr_seq_familia, cd_area_procedimento, ie_nota_credito, ie_tipo_titulo_pagar,
		cd_especialidade, cd_grupo_proc, cd_centro_custo, ie_clinica, ie_origem_proced, ie_tipo_titulo_receber,
		cd_convenio_dest_p, cd_setor_atendimento, cd_moeda, ds_observacao, ie_origem_tit_pagar, nr_seq_classe_tp,
		cd_tipo_pessoa, cd_cgc, cd_pessoa_fisica, ie_faturamento, ie_origem_tit_rec, nr_seq_classe_tr
	...
	open c015;
		...
		EXIT WHEN NOT FOUND; /* apply on c015 */
				...
				insert into convenio_documento(
					...
					ds_arquivo,
					dt_final_vigencia)
				values (nextval('convenio_documento_seq'),
					cd_convenio_dest_p,
					ie_documento_w,
					clock_timestamp(),
					nm_usuario_p,
	...
	EXIT WHEN NOT FOUND; /* apply on c27 */
		...
		CALL copia_campo_long('CONVENIO_DOC_ATEND','DS_DOCUMENTO','WHERE NR_SEQUENCIA = :NR_SEQUENCIA',
								 'NR_SEQUENCIA=' || c27_w.nr_sequencia,'NR_SEQUENCIA=' || nr_sequencia_w);
		end;
	end loop;
	close c27;
	...
	CALL tiss_copia_param_convenio(cd_convenio_orig_p,cd_estab_orig_p, cd_convenio_dest_p, cd_estab_dest_p, nm_tabela_p, nm_usuario_p, ie_excluir_p);
	...
	EXIT WHEN NOT FOUND; /* apply on c22 */
		...
		insert into convenio_estabelecimento(
				...
				DS_CAMINHO_EXEC, IE_TITULO_PACIENTE_PROT, IE_EXIGE_LETRA_CARTEIRA, ie_recalcular_conta, ie_codigo_convenio,
				ds_mascara_guia, ie_aplicar_tx_co_cbhpm, IE_PRIORIDADE_BRASINDICE, IE_AUTOR_MAT_EXEC, IE_PRECO_MAT_ESP,
				IE_PLANO_CONSULTA_PRECO, IE_PERMITE_VINC_ORC,
			...
			values (nextval('convenio_estabelecimento_seq'), clock_timestamp(), nm_usuario_p,
				cd_convenio_dest_p, cd_estab_dest_p, c22_w.cd_conta_contabil,
				...
				c22_w.ie_fixar_vig_brasindice, c22_w.ie_conta_atual, c22_w.ie_separa_partic_adic_hor, c22_w.ie_vl_conta_autor,
				c22_w.ie_ajustar_periodo_conta, c22_w.ie_atual_qt_solic_autor, c22_w.ie_lote_reap, c22_w.ie_exige_cobertura,
				c22_w.ie_altera_pj_tit, c22_w.ie_regra_cart_usuario, c22_w.ie_dt_prev_autor_quimio, c22_w.ie_dt_vigencia_autor_quimio,
				c22_w.dt_inicio_vig_tuss, c22_w.qt_horas_inicio_ciclo, c22_w.ie_valor_original_glosa, c22_w.ie_considera_regra_data_preco,
				c22_w.ie_contab_lote_consig, c22_w.ie_verifica_proc_glosa, c22_w.ie_valor_filme_apos_adic_hor, c22_w.ie_pre_faturamento,
				c22_w.ds_proc_retorno, c22_w.ie_exige_cpf_pagador, c22_w.ie_divide_vl_med_conv_glosa, c22_w.hr_conta_fim_dia,
				c22_w.ie_autor_mat_conta, c22_w.nr_dias_gastos_rn, c22_w.cd_proc_long_perm, c22_w.ie_orig_proc_long_perm,
				c22_w.nr_dias_venc_atend, c22_w.nr_dias_alerta, c22_w.ie_exige_desconto_conta, c22_w.ie_imprime_data_rodape,
				c22_w.ie_periodo_inicial_seg, c22_w.ie_consid_proc_bilat_autor, c22_w.ie_data_vig_cbhpm, c22_w.ie_regra_moeda_ajuste,
				c22_w.ie_trat_conta_rn, c22_w.ds_mensagem_desfecho, c22_w.ie_consiste_benef_ops, c22_w.ie_conta_transitoria,
				c22_w.ie_imprime_qtde, c22_w.ie_lib_repasse_sem_tit, c22_w.ie_arred_so_glosa_perc, c22_w.qt_dia_venc_tit_grg, c22_w.ie_grava_guia_taxa,
				c22_w.dt_fim_contrato, c22_w.ie_glosa_aceita_grg, c22_w.ie_copia_senha_guia, c22_w.ie_conv_categ_glosa, c22_w.cd_estab_pls, 						
				c22_w.ie_registro_pep, c22_w.ie_exige_conv_glosa, c22_w.ie_exige_usuario_glosa, c22_w.ie_exige_compl_glosa, 
				c22_w.ie_exige_validade_glosa, c22_w.qt_exame_prescr, c22_w.ie_consid_conv_glosa_eup, c22_w.ie_consiste_conta_prot, 
				c22_w.ie_conta_prot_ref, c22_w.ie_tiss_tipo_saida, c22_w.ie_funcao_medico, c22_w.ie_glosa_mat_aut_neg, c22_w.ie_dt_conta_tit_prot, 
				c22_w.ie_obriga_diagnostico, c22_w.ie_nova_autor_item_fim_vig, c22_w.ie_dividir_indice_pmc, c22_w.ie_dividir_indice_pfb,
				c22_w.ie_tit_liquido, c22_w.nr_seq_trans_tit_conta, c22_w.CD_CNPJ_CONV_ESTAB,
				c22_w.CD_TIPO_RECEB_NEG_TIT, c22_w.IE_TITULO_EMPRESA_RESP, c22_w.IE_RET_OUTROS_CONV, c22_w.IE_IPI_BRASINDICE, c22_w.CD_LOCALIZADOR_PACIENTE,
				c22_w.DS_CAMINHO_EXEC, c22_w.IE_TITULO_PACIENTE_PROT,  c22_w.IE_EXIGE_LETRA_CARTEIRA, c22_w.IE_RECALCULAR_CONTA, c22_w.ie_codigo_convenio,
				c22_w.ds_mascara_guia, c22_w.ie_aplicar_tx_co_cbhpm, c22_w.IE_PRIORIDADE_BRASINDICE, c22_w.IE_AUTOR_MAT_EXEC, c22_w.IE_PRECO_MAT_ESP,
				c22_w.IE_PLANO_CONSULTA_PRECO, c22_w.IE_PERMITE_VINC_ORC,				
				c22_w.IE_GERAR_CIHA, c22_w.IE_INC_CONTA_DEF_PROT, c22_w.IE_BLOQUEIA_PROC_SEM_AUTOR, c22_w.IE_AUX_MAIOR_AUX_CIR, c22_w.QT_DIAS_INTERNACAO,
				c22_w.IE_COPIA_SENHA_GUIA_PRINC, c22_w.IE_OBRIGA_NF_PROT, c22_w.IE_GERAR_AUTOR_QUIMIOTERAPIA, c22_w.IE_CONSISTE_SQL_NF,c22_w.IE_FECHAR_ANALISE_SALDO_REST,
				c22_w.IE_ATUALIZA_AUTOR_SENHA, c22_w.IE_VALOR_PAGO_GLOSA_GUIA,c22_w.IE_REGRA_HORAS_ONC_CICLO, c22_w.IE_UTILIZA_CONV_BO,c22_w.IE_EXIGE_DOC_CONV,
				c22_w.IE_PERMITE_INTERNAR_EUP, c22_w.IE_CALC_PORTE_ESTAB, c22_w.QT_DIAS_REAPRE, c22_w.QT_DIAS_AUTORIZACAO, c22_w.QT_DIAS_AUTOR_PROC,c22_w.IE_CONSISTE_CNS_CONTA,
				c22_w.IE_CH_ANESTESISTA, c22_w.IE_VALOR_PAGO_RET, c22_w.IE_EXIGE_LIB_BRAS, c22_w.IE_VALOR_INF_REVERSAO, c22_w.DS_PROC_GRG, c22_w.IE_DATA_AUTOR_PRORROG,
				c22_w.IE_LIB_REPASSE_PROT_TIT,c22_w.IE_FORMA_PROC_PRINC, c22_w.IE_EXIGE_DT_VENC_PROT, c22_w.IE_GERAR_NF_DESDOB, c22_w.IE_AUTOR_MAT_ESP_CIRURGIA,
				c22_w.IE_QT_MAT_AUTOR, c22_w.IE_EXIGE_EMPRESA_CONS, c22_w.IE_OBRIGA_NF_TIT_REC, c22_w.QT_DIAS_AUTOR_QUIMIO, c22_w.IE_GUIA_AUTOR_QUIMIO, c22_w.IE_CALC_VL_AUX_CONV,
				c22_w.IE_CONV_MEDIDA_AUTOR_QUIMIO, c22_w.IE_TRIB_TITULO_RETORNO, c22_w.IE_TOMADOR_NF_DESDOB, c22_w.IE_CONSIS_INICIO_CONTA_PROT, c22_w.IE_IGNORA_PARTIC,
	...
	EXIT WHEN NOT FOUND; /* apply on c23 */
		...
		insert into conversao_material_convenio(
			...
			ie_tipo_material, ie_tipo_preco_autor, nr_proc_interno)
		values (nextval('conversao_mat_convenio_seq'), cd_convenio_dest_p, c23_w.cd_material_convenio,
			...
			cd_estab_dest_p, c23_w.dt_dia_semana, c23_w.ie_situacao,
			c23_w.hr_inicial, c23_w.hr_final, c23_w.ie_feriado,
			c23_w.ie_tipo_material_conv, c23_w.cd_categoria, c23_w.ie_tipo_atendimento,
			c23_w.ie_tipo_material, c23_w.ie_tipo_preco_autor, c23_w.nr_proc_interno);
		end;
	end loop;
	close c23;
	...
	EXIT WHEN NOT FOUND; /* apply on c24 */
		...
		SELECT	nextval('conv_regra_seq_conta_seq'), cd_convenio_dest_p, cd_estab_dest_p, clock_timestamp(),
	...
	EXIT WHEN NOT FOUND; /* apply on c25 */
		...
		SELECT	nextval('conv_regra_usuario_categ_seq'), cd_estab_dest_p, cd_convenio_dest_p, cd_categoria, clock_timestamp(),
	...
	open c26;
		...
		EXIT WHEN NOT FOUND; /* apply on c26 */
			...
			insert into convenio_proced_padrao(
				...
				ds_proced_padrao, nr_seq_apresent, ds_cor, ie_define_qtde)
			SELECT  nr_sequencia_w, cd_estab_dest_p, clock_timestamp(), nm_usuario_p, clock_timestamp(),
			...
			if (coalesce(nr_seq_proc_interno_w,0) > 0) then
				...
				SELECT * FROM Obter_Proc_Tab_Interno_Conv(nr_seq_proc_interno_w, cd_estab_orig_p, cd_convenio_orig_p, null, null, null, cd_procedimento_w, ie_origem_proced_w, null, clock_timestamp(), null, null, null, null, null, null, null, null) INTO STRICT cd_procedimento_w, ie_origem_proced_w;
			...
			SELECT 	nextval('conv_proced_padrao_perfil_seq'), cd_estab_dest_p, nr_sequencia_w, clock_timestamp(), nm_usuario_p, clock_timestamp(),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE copiar_parametros_convenio ( cd_convenio_orig_p bigint, cd_estab_orig_p bigint, cd_convenio_dest_p bigint, cd_estab_dest_p bigint, nm_tabela_p text, ie_excluir_p text, nm_usuario_p text) FROM PUBLIC;
