...
CREATE OR REPLACE PROCEDURE dime_reg_bp_despesa ( nr_seq_controle_p bigint, cd_estabelecimento_p text, nm_usuario_p text, dt_referencia_p timestamp, ds_separador_p text, qt_linha_p INOUT bigint, nr_sequencia_p INOUT bigint) AS $body$
DECLARE
...
nr_seq_demo_w			fis_dime_controle.nr_seq_demo_desp%type;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE dime_reg_bp_despesa ( nr_seq_controle_p bigint, cd_estabelecimento_p text, nm_usuario_p text, dt_referencia_p timestamp, ds_separador_p text, qt_linha_p INOUT bigint, nr_sequencia_p INOUT bigint) FROM PUBLIC;
