...
CREATE OR REPLACE PROCEDURE pls_gerar_doc_proposta_adic ( nr_seq_proposta_p bigint, nr_seq_instrumento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_doc_proposta_adic ( nr_seq_proposta_p bigint, nr_seq_instrumento_p bigint, nm_usuario_p text) FROM PUBLIC;
