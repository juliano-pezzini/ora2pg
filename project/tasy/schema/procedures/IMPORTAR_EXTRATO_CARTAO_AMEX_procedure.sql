...
CREATE OR REPLACE PROCEDURE importar_extrato_cartao_amex (nr_seq_extrato_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE importar_extrato_cartao_amex (nr_seq_extrato_p bigint, nm_usuario_p text) FROM PUBLIC;
