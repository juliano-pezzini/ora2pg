...
CREATE OR REPLACE PROCEDURE gerar_agenda_gestao_exame ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_agenda_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_agenda_gestao_exame ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_agenda_p bigint, nm_usuario_p text) FROM PUBLIC;
