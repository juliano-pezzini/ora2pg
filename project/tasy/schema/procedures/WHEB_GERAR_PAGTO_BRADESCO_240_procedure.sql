...
CREATE OR REPLACE PROCEDURE wheb_gerar_pagto_bradesco_240 (nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE wheb_gerar_pagto_bradesco_240 (nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
