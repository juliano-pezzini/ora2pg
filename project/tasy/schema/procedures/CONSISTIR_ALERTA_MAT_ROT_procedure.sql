...
CREATE OR REPLACE PROCEDURE consistir_alerta_mat_rot ( nr_prescricao_p bigint, nr_sequencia_p bigint, nr_seq_material_p bigint, cd_protocolo_p bigint, ds_mensagem_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE consistir_alerta_mat_rot ( nr_prescricao_p bigint, nr_sequencia_p bigint, nr_seq_material_p bigint, cd_protocolo_p bigint, ds_mensagem_p INOUT text) FROM PUBLIC;
