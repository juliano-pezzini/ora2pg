...
CREATE OR REPLACE PROCEDURE pfcs_device_battery_status ( nr_seq_indicator_p bigint, cd_estabelecimento_p text, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
  SELECT ds_unit,
	...
	from(
      ...
      and pd.nr_seq_organization = org.nr_sequencia
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_device_battery_status ( nr_seq_indicator_p bigint, cd_estabelecimento_p text, nm_usuario_p text) FROM PUBLIC;
