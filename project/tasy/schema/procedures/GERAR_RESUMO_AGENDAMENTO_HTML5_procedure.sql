...
CREATE OR REPLACE PROCEDURE gerar_resumo_agendamento_html5 ( dt_inicio_p timestamp, dt_final_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
delete	FROM RESUMO_AGENDAMENTO_HTML5
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	insert into RESUMO_AGENDAMENTO_HTML5(
		dt_atualizacao,
		nm_usuario,
		cd_profissional,
		qt_agendamento,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_resumo_agendamento_html5 ( dt_inicio_p timestamp, dt_final_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
