...
CREATE OR REPLACE PROCEDURE gerar_entrada_real_internacao ( nr_atendimento_p bigint, DT_ENTRADA_REAL_P timestamp default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_entrada_real_internacao ( nr_atendimento_p bigint, DT_ENTRADA_REAL_P timestamp default null) FROM PUBLIC;
