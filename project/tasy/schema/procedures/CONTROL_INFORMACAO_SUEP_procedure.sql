...
CREATE OR REPLACE PROCEDURE control_informacao_suep (nr_seq_inf_p text, nr_seq_item_p bigint, nm_usuario_p text) AS $body$
...
;
                     ...
                     r_registros_w[qt_cursor_w].nr_seq_item         := nr_seq_item_p;
                  end if;
               end;
            end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE control_informacao_suep (nr_seq_inf_p text, nr_seq_item_p bigint, nm_usuario_p text) FROM PUBLIC;
