...
CREATE OR REPLACE PROCEDURE desvinc_adiant_cheque_tipo_um ( nr_seq_cheque_p bigint, nr_adiantamento_p bigint) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE desvinc_adiant_cheque_tipo_um ( nr_seq_cheque_p bigint, nr_adiantamento_p bigint) FROM PUBLIC;
