...
CREATE OR REPLACE PROCEDURE gerar_codigo_pj_int ( cd_cnpj_p INOUT text, nr_seq_idioma_p bigint default 1, nm_usuario_p text DEFAULT NULL) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_codigo_pj_int ( cd_cnpj_p INOUT text, nr_seq_idioma_p bigint default 1, nm_usuario_p text DEFAULT NULL) FROM PUBLIC;
