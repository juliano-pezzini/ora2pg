...
CREATE OR REPLACE PROCEDURE proj_gerar_os_marketing ( nr_seq_projeto_p bigint, cd_pessoa_fisica_p text, nm_usuario_p text, nr_seq_gerencia_p bigint, nr_ordem_servico_p INOUT text, nr_seq_ficha_p bigint default null) AS $body$
DECLARE
...
,
 ...
 ||': '|| ds_titulo_w || '.'|| chr(13) || 'Insira nesta ordem as informações relevantes do projeto encerrado, como anexos, news, etc.',
		nr_ordem_servico_p,
		cd_pessoa_fisica_p,
		'S',
		'3',
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE proj_gerar_os_marketing ( nr_seq_projeto_p bigint, cd_pessoa_fisica_p text, nm_usuario_p text, nr_seq_gerencia_p bigint, nr_ordem_servico_p INOUT text, nr_seq_ficha_p bigint default null) FROM PUBLIC;
