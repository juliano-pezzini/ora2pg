...
CREATE OR REPLACE PROCEDURE gerar_lote_producao_comp_medic ( nr_lote_producao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_lote_producao_comp_medic ( nr_lote_producao_p bigint, nm_usuario_p text) FROM PUBLIC;
