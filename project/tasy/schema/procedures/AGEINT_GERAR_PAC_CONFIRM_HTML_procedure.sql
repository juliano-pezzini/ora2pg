...
CREATE TYPE index_pessoa_fisica AS (
  ie_inserido varchar(1)
);


CREATE OR REPLACE PROCEDURE ageint_gerar_pac_confirm_html ( dt_agenda_p timestamp, nm_usuario_p text, ie_futuros_p text, cd_estabelecimento_p bigint, cd_pessoa_fisica_p text default null, nm_pessoa_fisica_p text default null, ie_tipo_agendamento_p text default null, nr_seq_status_p bigint default null, nr_seq_grupo_selec_p bigint default null, cd_estab_agenda_p bigint default null, cd_Agenda_p bigint default null, cd_profissional_p text default null, cd_especialidade_p bigint default null, ie_nao_confirmados_p text default null, ie_somente_prof_usu_p text default null) AS $body$
DECLARE


TYPE t_ageint_confirm_agendamento IS TABLE OF ageint_confirm_agendamento%ROWTYPE INDEX BY integer;
type t_ageint_pac_confirm_agenda is table of ageint_pac_confirm_agenda%rowtype index by integer;

--essa tabela serve apenas para verificar se ja foi inserido a pessoa
type t_index_pessoa_fisica is table of index_pessoa_fisica index by varchar(60);
...
index_vetor_pac_conf varchar(60);
nr_sequencia_tabela_w integer;
...
ageint_pac_confirm_agenda_w t_ageint_pac_confirm_agenda;
index_pessoa_fisica_w t_index_pessoa_fisica;
...
WHERE a.nr_sequencia  = b.nr_seq_agenda_int and (a.nm_paciente IS NOT NULL AND a.nm_paciente::text <> '') and b.nr_seq_agenda_cons   = c.nr_sequencia and c.dt_agenda             between dt_agenda_p and dt_agenda_fim_w and b.ie_tipo_agendamento = 'S' and d.cd_dominio            = 83  and ie_futuros_p	= 'N' and not exists (select 1 from ageint_confirm_agendamento x where c.nr_sequencia = x.nr_seq_agenda and x.nm_usuario = nm_usuario_p) and ((coalesce(cd_pessoa_fisica_p::text, '') = '' and coalesce(nm_pessoa_fisica_p::text, '') = '') 
	or (a.cd_pessoa_fisica = cd_pessoa_fisica_p) or (coalesce(cd_pessoa_fisica_p::text, '') = '' and upper(a.nm_paciente) = upper(nm_pessoa_fisica_p))) order by nm_paciente;
...
delete FROM ageint_pac_confirm_agenda
where	nm_usuario = nm_usuario_p
and	coalesce(ie_em_agenda,'N')	= 'N';
...
if (ie_somente_integrada_w = 'S') then
	...
	for 	r_c01 in c01 loop
      ...
      if (coalesce(ie_tipo_agendamento_p::text, '') = '' or ie_tipo_agendamento_p = r_c01.ie_tipo_agendamento) and (coalesce(nr_seq_status_p::text, '') = '' or nr_seq_status_p = r_c01.nr_seq_status) and (coalesce(nr_seq_grupo_selec_p::text, '') = '' or nr_seq_grupo_selec_p = r_c01.nr_seq_grupo_selec) and (coalesce(cd_estab_agenda_p::text, '') = '' or cd_estab_agenda_p = r_c01.cd_estab_agenda) and (coalesce(cd_Agenda_p::text, '') = '' or cd_Agenda_p = r_c01.cd_agenda) and (coalesce(cd_profissional_p::text, '') = '' or cd_profissional_p = r_c01.cd_profissional) and (coalesce(cd_especialidade_p::text, '') = '' or cd_especialidade_p = r_c01.cd_especialidade) and (ie_nao_confirmados_p = 'N' or (ie_nao_confirmados_p = 'S' and coalesce(r_c01.dt_confirmacao::text, '') = '')) and (coalesce(ie_somente_prof_usu_p::text, '') = '' or ie_somente_prof_usu_p = r_c01.cd_profissional) then
          
      
        if (r_c01.cd_pessoa_fisica IS NOT NULL AND r_c01.cd_pessoa_fisica::text <> '') then
          index_vetor_pac_conf := r_c01.cd_pessoa_fisica;
        else
          index_vetor_pac_conf := r_c01.nm_paciente;
        end if;
        if not index_pessoa_fisica_w.exists(index_vetor_pac_conf) then

          index_pessoa_fisica_w[index_vetor_pac_conf].ie_inserido := 'S';
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].cd_pessoa_fisica := r_c01.cd_pessoa_fisica;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao_nrec := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_em_agenda := ie_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_pac_internado := ie_pac_internado_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_paciente := r_c01.nm_paciente;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_em_agenda := nm_usuario_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_nrec := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nr_telefone := substr(obter_fone_pac_agenda(r_c01.cd_pessoa_fisica),1,255);

          nr_sequencia_tabela_w := nr_sequencia_tabela_w + 1;
        end if;
      end if;
	...
	for	r_c02 in c02 loop
      ...
      if (coalesce(ie_tipo_agendamento_p::text, '') = '' or ie_tipo_agendamento_p = r_c02.ie_tipo_agendamento) and (coalesce(nr_seq_status_p::text, '') = '' or nr_seq_status_p = r_c02.nr_seq_status) and (coalesce(nr_seq_grupo_selec_p::text, '') = '' or nr_seq_grupo_selec_p = r_c02.nr_seq_grupo_selec) and (coalesce(cd_estab_agenda_p::text, '') = '' or cd_estab_agenda_p = r_c02.cd_estab_agenda) and (coalesce(cd_Agenda_p::text, '') = '' or cd_Agenda_p = r_c02.cd_agenda) and (coalesce(cd_profissional_p::text, '') = '' or cd_profissional_p = r_c02.cd_profissional) and (coalesce(cd_especialidade_p::text, '') = '' or cd_especialidade_p = r_c02.cd_especialidade) and (ie_nao_confirmados_p = 'N' or (ie_nao_confirmados_p = 'S' and coalesce(r_c02.dt_confirmacao::text, '') = '')) and (coalesce(ie_somente_prof_usu_p::text, '') = '' or ie_somente_prof_usu_p = r_c02.cd_profissional) then
          
      
        if (r_c02.cd_pessoa_fisica IS NOT NULL AND r_c02.cd_pessoa_fisica::text <> '') then
          index_vetor_pac_conf := r_c02.cd_pessoa_fisica;
        else
          index_vetor_pac_conf := r_c02.nm_paciente;
        end if;
        if not index_pessoa_fisica_w.exists(index_vetor_pac_conf) then

          index_pessoa_fisica_w[index_vetor_pac_conf].ie_inserido := 'S';
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].cd_pessoa_fisica := r_c02.cd_pessoa_fisica;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao_nrec := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_em_agenda := ie_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_pac_internado := ie_pac_internado_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_paciente := r_c02.nm_paciente;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_em_agenda := nm_usuario_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_nrec := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nr_telefone := substr(obter_fone_pac_agenda(r_c02.cd_pessoa_fisica),1,255);
	...
	for	r_c03 in c03 loop
      ...
      if (coalesce(ie_tipo_agendamento_p::text, '') = '' or ie_tipo_agendamento_p = r_c03.ie_tipo_agendamento) and (coalesce(nr_seq_status_p::text, '') = '' or nr_seq_status_p = r_c03.nr_seq_status) and (coalesce(nr_seq_grupo_selec_p::text, '') = '' or nr_seq_grupo_selec_p = r_c03.nr_seq_grupo_selec) and (coalesce(cd_estab_agenda_p::text, '') = '' or cd_estab_agenda_p = r_c03.cd_estab_agenda) and (coalesce(cd_Agenda_p::text, '') = '' or cd_Agenda_p = r_c03.cd_agenda) and (coalesce(cd_profissional_p::text, '') = '' or cd_profissional_p = r_c03.cd_profissional) and (coalesce(cd_especialidade_p::text, '') = '' or cd_especialidade_p = r_c03.cd_especialidade) and (ie_nao_confirmados_p = 'N' or (ie_nao_confirmados_p = 'S' and coalesce(r_c03.dt_confirmacao::text, '') = '')) and (coalesce(ie_somente_prof_usu_p::text, '') = '' or ie_somente_prof_usu_p = r_c03.cd_profissional) then
          
      
        if (r_c03.cd_pessoa_fisica IS NOT NULL AND r_c03.cd_pessoa_fisica::text <> '') then
          index_vetor_pac_conf := r_c03.cd_pessoa_fisica;
        else
          index_vetor_pac_conf := r_c03.nm_paciente;
        end if;
        if not index_pessoa_fisica_w.exists(index_vetor_pac_conf) then

          index_pessoa_fisica_w[index_vetor_pac_conf].ie_inserido := 'S';
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].cd_pessoa_fisica := r_c03.cd_pessoa_fisica;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao_nrec := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_em_agenda := ie_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_pac_internado := ie_pac_internado_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_paciente := r_c03.nm_paciente;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_em_agenda := nm_usuario_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_nrec := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nr_telefone := substr(obter_fone_pac_agenda(r_c03.cd_pessoa_fisica),1,255);
	...
	for	r_c04 in c04 loop
      ...
      if (coalesce(ie_tipo_agendamento_p::text, '') = '' or ie_tipo_agendamento_p = r_c04.ie_tipo_agendamento) and (coalesce(nr_seq_status_p::text, '') = '' or nr_seq_status_p = r_c04.nr_seq_status) and (coalesce(nr_seq_grupo_selec_p::text, '') = '' or nr_seq_grupo_selec_p = r_c04.nr_seq_grupo_selec) and (coalesce(cd_estab_agenda_p::text, '') = '' or cd_estab_agenda_p = r_c04.cd_estab_agenda) and (coalesce(cd_Agenda_p::text, '') = '' or cd_Agenda_p = r_c04.cd_agenda) and (coalesce(cd_profissional_p::text, '') = '' or cd_profissional_p = r_c04.cd_profissional) and (coalesce(cd_especialidade_p::text, '') = '' or cd_especialidade_p = r_c04.cd_especialidade) and (ie_nao_confirmados_p = 'N' or (ie_nao_confirmados_p = 'S' and coalesce(r_c04.dt_confirmacao::text, '') = '')) and (coalesce(ie_somente_prof_usu_p::text, '') = '' or ie_somente_prof_usu_p = r_c04.cd_profissional) then
          
      
        if (r_c04.cd_pessoa_fisica IS NOT NULL AND r_c04.cd_pessoa_fisica::text <> '') then
          index_vetor_pac_conf := r_c04.cd_pessoa_fisica;
        else
          index_vetor_pac_conf := r_c04.nm_paciente;
        end if;
        if not index_pessoa_fisica_w.exists(index_vetor_pac_conf) then

          index_pessoa_fisica_w[index_vetor_pac_conf].ie_inserido := 'S';
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].cd_pessoa_fisica := r_c04.cd_pessoa_fisica;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].dt_atualizacao_nrec := clock_timestamp();
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_em_agenda := ie_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].ie_pac_internado := ie_pac_internado_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_paciente := r_c04.nm_paciente;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_em_agenda := nm_usuario_em_agenda_w;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nm_usuario_nrec := nm_usuario_p;
          ageint_pac_confirm_agenda_w[nr_sequencia_tabela_w].nr_telefone := substr(obter_fone_pac_agenda(r_c04.cd_pessoa_fisica),1,255);
...
FORALL i IN ageint_pac_confirm_agenda_w.first .. ageint_pac_confirm_agenda_w.last
	INSERT INTO ageint_pac_confirm_agenda VALUES ageint_pac_confirm_agenda_w(i);
commit;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ageint_gerar_pac_confirm_html ( dt_agenda_p timestamp, nm_usuario_p text, ie_futuros_p text, cd_estabelecimento_p bigint, cd_pessoa_fisica_p text default null, nm_pessoa_fisica_p text default null, ie_tipo_agendamento_p text default null, nr_seq_status_p bigint default null, nr_seq_grupo_selec_p bigint default null, cd_estab_agenda_p bigint default null, cd_Agenda_p bigint default null, cd_profissional_p text default null, cd_especialidade_p bigint default null, ie_nao_confirmados_p text default null, ie_somente_prof_usu_p text default null) FROM PUBLIC;
