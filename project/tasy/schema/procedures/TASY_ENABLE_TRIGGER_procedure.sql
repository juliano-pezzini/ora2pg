...
CREATE OR REPLACE PROCEDURE tasy_enable_trigger () AS $body$
DECLARE
...
LOOP
	...
	CALL Exec_Sql_Dinamico(nm_trigger_w || ' Enable trigger', ds_comando_w);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE tasy_enable_trigger () FROM PUBLIC;
