...
CREATE OR REPLACE PROCEDURE proj_calcular_ponto_avals_mes ( cd_consultor_p text, dt_mes_p timestamp, nm_usuario_p text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE proj_calcular_ponto_avals_mes ( cd_consultor_p text, dt_mes_p timestamp, nm_usuario_p text ) FROM PUBLIC;
