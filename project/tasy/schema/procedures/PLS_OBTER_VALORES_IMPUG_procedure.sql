...
CREATE OR REPLACE PROCEDURE pls_obter_valores_impug ( nr_seq_impugnacao_p pls_impugnacao.nr_sequencia%type, ie_tipo_pedido_p pls_proc_conta_pedido.ie_tipo_pedido%type, nm_usuario_p usuario.nm_usuario%type, ie_commit_p text default 'N', ie_deferimento_p text DEFAULT NULL, vl_ressarcir_p INOUT bigint DEFAULT NULL, vl_deferido_p INOUT bigint DEFAULT NULL) AS $body$
DECLARE
