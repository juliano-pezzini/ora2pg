...
CREATE OR REPLACE PROCEDURE gerar_w_envio_dctf_16 ( nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
nr_cnpj_incorporacao, 
	...
	coalesce(sum(j.vl_baixa),0)	vl_pago_debito, 
	0 nr_trimestre_apuracao, 
	0 nr_quota, 
	0 qt_registros, 
	' ' ds_hashcode, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_envio_dctf_16 ( nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
