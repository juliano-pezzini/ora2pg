...
CREATE OR REPLACE PROCEDURE duplicar_mat_paciente2 ( nr_sequencia_p bigint, nm_usuario_p text, ie_atualiza_local_estoque_p text, nr_seq_gerada_p INOUT bigint) AS $body$
DECLARE
...
insert	into material_atend_paciente(
	...
	IE_AUDITORIA,NR_SEQ_GRUPO_REC,CD_MOTIVO_AJUSTE,NR_SEQ_COR_EXEC)
SELECT
	...
	DT_PRESCRICAO,CD_MATERIAL_PRESCRICAO,IE_VIA_APLICACAO,DS_OBSERVACAO,VL_MATERIAL,
	CD_TAB_PRECO_MATERIAL,DT_VIGENCIA_TABELA,DT_ACERTO_CONTA,DT_ACERTO_CONVENIO,
	NR_PRESCRICAO,null,CD_MOTIVO_EXC_CONTA,DS_COMPL_MOTIVO_EXCON,
	...
	VL_TABELA_ORIGINAL,IE_EMITE_CONTA,CD_SETOR_RECEITA,CD_CGC_FORNECEDOR,
	NR_SEQ_LOTE_FORNEC,CD_MATERIAL_EXEC,NR_SEQ_ATEPACU,IE_TIPO_GUIA,NR_DOC_INTERNO,
	IE_AUDITORIA,NR_SEQ_GRUPO_REC,CD_MOTIVO_AJUSTE,1762
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE duplicar_mat_paciente2 ( nr_sequencia_p bigint, nm_usuario_p text, ie_atualiza_local_estoque_p text, nr_seq_gerada_p INOUT bigint) FROM PUBLIC;
