...
CREATE OR REPLACE PROCEDURE ppm_metrica_defects_client ( nr_seq_metrica_p bigint, nr_seq_objetivo_metrica_p bigint, cd_pessoa_fisica_p text, nm_usuario_p text, dt_referencia_p timestamp) AS $body$
DECLARE
...
/*and	((ie_area_gerencia_p is null) or (g.ie_area_gerencia = ie_area_gerencia_p))*/
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ppm_metrica_defects_client ( nr_seq_metrica_p bigint, nr_seq_objetivo_metrica_p bigint, cd_pessoa_fisica_p text, nm_usuario_p text, dt_referencia_p timestamp) FROM PUBLIC;
