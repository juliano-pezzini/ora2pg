...
CREATE OR REPLACE PROCEDURE gerar_pagto_febraban_240_v87 ( nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pagto_febraban_240_v87 ( nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
