...
CREATE OR REPLACE PROCEDURE registrar_receb_roupa ( nr_sequencia_p bigint, nm_usuario_p text, nr_seq_inventario_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE registrar_receb_roupa ( nr_sequencia_p bigint, nm_usuario_p text, nr_seq_inventario_p bigint) FROM PUBLIC;
