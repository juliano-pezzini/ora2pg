...
CREATE OR REPLACE PROCEDURE gerar_rel_consulta_exames ( nr_atendimento_p bigint default null, nr_prescricao_p bigint default null, ie_urgente_p text default 'N', ie_bloqueado_p text default 'N', ie_recoleta_inf_p text default 'N', ie_recoleta_p text default 'N', ie_amostra_n_p text default 'N', ie_inativ_p text default 'N', ie_tipo_data_p text default null, nr_data_restringir_p bigint default null, dt_inicial_p text default null, dt_final_p text default null, nr_lote_p bigint default null, nr_senha_p text default null, nr_controle_p bigint default null, nr_lot_ext_p bigint default null, ds_amostra_p text default null, nm_curto_p text default null, cd_exame_p text default null, cd_cliente_p text default null, ds_filtros_p text default null, cd_med_p text default null, ie_sit_p bigint default null, ie_int_p bigint default null, cd_barras_p text default null, nr_proto_p bigint default null, nr_pre_ext_p bigint default null, cd_estabelecimento_p bigint default null, ie_barras_completo_p text default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_rel_consulta_exames ( nr_atendimento_p bigint default null, nr_prescricao_p bigint default null, ie_urgente_p text default 'N', ie_bloqueado_p text default 'N', ie_recoleta_inf_p text default 'N', ie_recoleta_p text default 'N', ie_amostra_n_p text default 'N', ie_inativ_p text default 'N', ie_tipo_data_p text default null, nr_data_restringir_p bigint default null, dt_inicial_p text default null, dt_final_p text default null, nr_lote_p bigint default null, nr_senha_p text default null, nr_controle_p bigint default null, nr_lot_ext_p bigint default null, ds_amostra_p text default null, nm_curto_p text default null, cd_exame_p text default null, cd_cliente_p text default null, ds_filtros_p text default null, cd_med_p text default null, ie_sit_p bigint default null, ie_int_p bigint default null, cd_barras_p text default null, nr_proto_p bigint default null, nr_pre_ext_p bigint default null, cd_estabelecimento_p bigint default null, ie_barras_completo_p text default null) FROM PUBLIC;
