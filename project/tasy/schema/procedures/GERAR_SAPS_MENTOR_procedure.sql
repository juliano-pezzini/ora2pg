...
CREATE OR REPLACE PROCEDURE gerar_saps_mentor ( nr_atendimento_p bigint, nr_seq_pend_pac_acao_p bigint, nm_usuario_p text, cd_pessoa_fisica_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_saps_mentor ( nr_atendimento_p bigint, nr_seq_pend_pac_acao_p bigint, nm_usuario_p text, cd_pessoa_fisica_p text) FROM PUBLIC;
