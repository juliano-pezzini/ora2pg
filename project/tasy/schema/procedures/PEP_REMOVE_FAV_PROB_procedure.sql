...
CREATE OR REPLACE PROCEDURE pep_remove_fav_prob ( nr_sequencia_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pep_remove_fav_prob ( nr_sequencia_p text, nm_usuario_p text) FROM PUBLIC;
