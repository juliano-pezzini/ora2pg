...
CREATE OR REPLACE PROCEDURE ptu_env_autorizacao_ord_v50_ws ( nr_seq_guia_p pls_guia_plano.nr_sequencia%type, nr_seq_requisicao_p pls_requisicao.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_aut_ordem_serv_p INOUT ptu_autorizacao_ordem_serv.nr_sequencia%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_env_autorizacao_ord_v50_ws ( nr_seq_guia_p pls_guia_plano.nr_sequencia%type, nr_seq_requisicao_p pls_requisicao.nr_sequencia%type, nm_usuario_p usuario.nm_usuario%type, nr_seq_aut_ordem_serv_p INOUT ptu_autorizacao_ordem_serv.nr_sequencia%type) FROM PUBLIC;
