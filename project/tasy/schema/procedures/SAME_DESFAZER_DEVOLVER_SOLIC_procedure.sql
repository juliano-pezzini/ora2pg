...
CREATE OR REPLACE PROCEDURE same_desfazer_devolver_solic ( nr_seq_solic_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE same_desfazer_devolver_solic ( nr_seq_solic_p bigint, nm_usuario_p text) FROM PUBLIC;
