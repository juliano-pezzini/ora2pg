...
CREATE OR REPLACE PROCEDURE proj_desenv_gerar_cron_planej ( nr_seq_projeto_p bigint, nm_usuario_p text, nr_seq_cronograma_p INOUT bigint, ie_classificacao_p text default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE proj_desenv_gerar_cron_planej ( nr_seq_projeto_p bigint, nm_usuario_p text, nr_seq_cronograma_p INOUT bigint, ie_classificacao_p text default null) FROM PUBLIC;
