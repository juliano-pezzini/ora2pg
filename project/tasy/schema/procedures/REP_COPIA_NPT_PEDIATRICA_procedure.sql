...
CREATE OR REPLACE PROCEDURE rep_copia_npt_pediatrica (nr_prescricao_orig_p bigint, nr_prescricao_p bigint, nr_seq_regra_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE rep_copia_npt_pediatrica (nr_prescricao_orig_p bigint, nr_prescricao_p bigint, nr_seq_regra_p bigint, nm_usuario_p text) FROM PUBLIC;
