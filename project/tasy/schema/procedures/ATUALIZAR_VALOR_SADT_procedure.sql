...
CREATE OR REPLACE PROCEDURE atualizar_valor_sadt ( nr_seq_protocolo_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_valor_sadt ( nr_seq_protocolo_p bigint, nm_usuario_p text) FROM PUBLIC;
