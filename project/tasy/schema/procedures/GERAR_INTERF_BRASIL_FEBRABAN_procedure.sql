...
CREATE OR REPLACE PROCEDURE gerar_interf_brasil_febraban (nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SELECT	0						ie_ordem_arq, 
	...
	g.ie_digito_agencia				ds_dac_agencia, 
...
select	1						ie_ordem_arq, 
	...
	b.ie_digito_agencia				ds_dac_agencia, 
...
select	1						ie_ordem_arq, 
	...
	' '						cd_cep, 
	' '						sg_estado, 
	CASE WHEN c.ie_tipo_pagamento='CC' THEN 001  ELSE c.cd_banco END 	cd_banco, 
...
select	1						ie_ordem_arq, 
	...
	'0' 						cd_convenio, 
	b.ie_digito_agencia				ds_dac_agencia, 
	b.ie_digito_conta				ie_digio_conta, 
	CASE WHEN coalesce(j.cd_cgc::text, '') = '' THEN '1'  ELSE '2' END 			ie_tipo_inscricao 
from	pessoa_juridica j, 
	Estabelecimento e, 
	banco_estabelecimento_v b, 
	banco_escritural a, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_interf_brasil_febraban (nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
