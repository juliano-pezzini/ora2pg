...
CREATE OR REPLACE PROCEDURE gerar_tabsheet_cron_proj_migr ( nr_seq_cronograma_p bigint, cd_funcao_p bigint, nr_seq_atividade_p bigint, nm_usuario_p text) AS $body$
DECLARE


nr_seq_atividade_w		bigint;
nr_seq_apresent_w		bigint := 2000;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_tabsheet_cron_proj_migr ( nr_seq_cronograma_p bigint, cd_funcao_p bigint, nr_seq_atividade_p bigint, nm_usuario_p text) FROM PUBLIC;
