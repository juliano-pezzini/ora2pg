...
--
-- dblink wrapper to call function atualizar_age_seguintes_wl2 as an autonomous transaction
--
CREATE EXTENSION IF NOT EXISTS dblink;

CREATE OR REPLACE PROCEDURE atualizar_age_seguintes_wl2 (nr_seq_agenda_p bigint, nr_minuto_duracao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
BEGIN
	v_query := 'CALL atualizar_age_seguintes_wl2_atx ( ' || quote_nullable(nr_seq_agenda_p) || ',' || quote_nullable(nr_minuto_duracao_p) || ',' || quote_nullable(nm_usuario_p) || ' )';
...
CREATE OR REPLACE PROCEDURE atualizar_age_seguintes_wl2_atx (nr_seq_agenda_p bigint, nr_minuto_duracao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
union
	...
	and	a.ie_status_agenda not in ('C','E', 'L')
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_age_seguintes_wl2 (nr_seq_agenda_p bigint, nr_minuto_duracao_p bigint, nm_usuario_p text) FROM PUBLIC; -- REVOKE ALL ON PROCEDURE atualizar_age_seguintes_wl2_atx (nr_seq_agenda_p bigint, nr_minuto_duracao_p bigint, nm_usuario_p text) FROM PUBLIC;
