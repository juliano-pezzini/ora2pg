...
CREATE OR REPLACE PROCEDURE gerar_cobr_brasil_cr_v084 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
SELECT	trim(both substr(ds_string,203,20)),
	coalesce((substr(ds_string,130,15))::numeric /100,0),
	coalesce((substr(ds_string,115,15))::numeric /100,0),
	coalesce((substr(ds_string,153,15))::numeric /100,0),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobr_brasil_cr_v084 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
