...
CREATE OR REPLACE PROCEDURE gerar_w_valor_consumo_mes_cate ( cd_estabelecimento_p bigint, dt_inicio_mes_p timestamp, dt_fim_mes_p timestamp, ie_opcao_p text, nm_usuario_p text) AS $body$
DECLARE
...
dt_inicio_mes_w	:= dt_inicio_mes_p;
dt_fim_mes_w	:= dt_fim_mes_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_valor_consumo_mes_cate ( cd_estabelecimento_p bigint, dt_inicio_mes_p timestamp, dt_fim_mes_p timestamp, ie_opcao_p text, nm_usuario_p text) FROM PUBLIC;
