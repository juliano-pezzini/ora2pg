...
CREATE OR REPLACE PROCEDURE baca_dt_vig_conv_proc_fat_xml () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_conv_proc_fat_xml () FROM PUBLIC;
