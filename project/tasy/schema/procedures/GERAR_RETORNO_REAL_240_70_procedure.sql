...
CREATE OR REPLACE PROCEDURE gerar_retorno_real_240_70 ( nr_seq_banco_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_retorno_real_240_70 ( nr_seq_banco_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
