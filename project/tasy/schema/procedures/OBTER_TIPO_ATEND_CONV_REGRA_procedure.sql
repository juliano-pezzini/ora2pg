...
CREATE OR REPLACE PROCEDURE obter_tipo_atend_conv_regra ( Nr_Interno_Conta_p Conta_Paciente.Nr_Interno_Conta%type, Ds_Tipo_Atendimento_p INOUT Conv_Regra_Tipo_Atend.Ds_Tipo_Atendimento%Type, Nr_Seq_Regra_p INOUT Conv_Regra_Tipo_Atend.Nr_Sequencia%Type) AS $body$
DECLARE
...
Nr_Seq_Regra_w			Conv_Regra_Tipo_Atend.Nr_Sequencia%Type;
BEGIN
	...
	For	rConta In cConta Loop
		...
		For	rRegra	In cRegra(	rConta.Cd_Estabelecimento,
			...
			Nr_Seq_Regra_w:= rRegra.Nr_Seq_Regra;
		End Loop;

	End Loop;
	--dbms_output.put_line('Retorno:'|| Ds_Tipo_Atendimento_w);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE obter_tipo_atend_conv_regra ( Nr_Interno_Conta_p Conta_Paciente.Nr_Interno_Conta%type, Ds_Tipo_Atendimento_p INOUT Conv_Regra_Tipo_Atend.Ds_Tipo_Atendimento%Type, Nr_Seq_Regra_p INOUT Conv_Regra_Tipo_Atend.Nr_Sequencia%Type) FROM PUBLIC;
