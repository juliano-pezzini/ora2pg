...
CREATE OR REPLACE PROCEDURE fucs_gerar_w_valor_consumo_mes ( cd_estabelecimento_p bigint, dt_mesano_inicio_p timestamp, dt_mesano_fim_p timestamp, ie_opcao_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fucs_gerar_w_valor_consumo_mes ( cd_estabelecimento_p bigint, dt_mesano_inicio_p timestamp, dt_mesano_fim_p timestamp, ie_opcao_p text, nm_usuario_p text) FROM PUBLIC;
