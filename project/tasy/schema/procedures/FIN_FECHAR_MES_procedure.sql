...
CREATE OR REPLACE PROCEDURE fin_fechar_mes (nr_sequencia_p bigint, nm_usuario_p text) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fin_fechar_mes (nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
