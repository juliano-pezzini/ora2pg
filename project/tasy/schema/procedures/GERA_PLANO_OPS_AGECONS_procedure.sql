...
CREATE OR REPLACE PROCEDURE gera_plano_ops_agecons (nr_seq_agenda_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gera_plano_ops_agecons (nr_seq_agenda_p bigint) FROM PUBLIC;
