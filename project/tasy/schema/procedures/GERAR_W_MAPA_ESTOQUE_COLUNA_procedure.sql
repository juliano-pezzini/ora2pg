...
CREATE OR REPLACE PROCEDURE gerar_w_mapa_estoque_coluna ( nr_seq_mapa_p bigint, nm_usuario_p text, ie_qt_vl_p text, cd_local_estoque_p bigint, dt_mesano_referencia_p timestamp, ie_agrupa_p text, ie_consignado_p text) AS $body$
DECLARE
...
if (ie_agrupa_p = 'L') then
	CALL gerar_w_mapa_estoque_local(nr_seq_mapa_p,
							nm_usuario_p,
							ie_qt_vl_p,
							cd_local_estoque_p,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_mapa_estoque_coluna ( nr_seq_mapa_p bigint, nm_usuario_p text, ie_qt_vl_p text, cd_local_estoque_p bigint, dt_mesano_referencia_p timestamp, ie_agrupa_p text, ie_consignado_p text) FROM PUBLIC;
