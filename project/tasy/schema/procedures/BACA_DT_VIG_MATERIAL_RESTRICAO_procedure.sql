...
CREATE OR REPLACE PROCEDURE baca_dt_vig_material_restricao () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_material_restricao () FROM PUBLIC;
