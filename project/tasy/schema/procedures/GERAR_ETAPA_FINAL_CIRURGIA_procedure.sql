...
CREATE OR REPLACE PROCEDURE gerar_etapa_final_cirurgia (nr_atendimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
C01 CURSOR FOR 
	...
	and (coalesce(ie_evento,'E') = coalesce(ie_evento_w,'E')) 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_etapa_final_cirurgia (nr_atendimento_p bigint, nm_usuario_p text) FROM PUBLIC;
