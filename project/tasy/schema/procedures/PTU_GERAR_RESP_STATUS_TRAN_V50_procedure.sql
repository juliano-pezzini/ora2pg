...
CREATE OR REPLACE PROCEDURE ptu_gerar_resp_status_tran_v50 ( nr_seq_controle_p bigint, nr_seq_pedido_status_p bigint, nr_versao_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_origem_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_resp_status_tran_v50 ( nr_seq_controle_p bigint, nr_seq_pedido_status_p bigint, nr_versao_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_origem_p INOUT bigint) FROM PUBLIC;
