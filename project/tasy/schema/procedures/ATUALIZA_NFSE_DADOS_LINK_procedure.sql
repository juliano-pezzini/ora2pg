...
CREATE OR REPLACE PROCEDURE atualiza_nfse_dados_link ( nr_nfe_imp_p text, cd_verificacao_nfse_p text, dt_emissao_nfe_p text, cd_serie_nf_p text, nr_nota_fiscal_p text, cd_cgc_emitente_p text, dt_emissao_rps_p text, ds_link_rps_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualiza_nfse_dados_link ( nr_nfe_imp_p text, cd_verificacao_nfse_p text, dt_emissao_nfe_p text, cd_serie_nf_p text, nr_nota_fiscal_p text, cd_cgc_emitente_p text, dt_emissao_rps_p text, ds_link_rps_p text) FROM PUBLIC;
