...
CREATE OR REPLACE PROCEDURE gerar_w_mapa_est_loc_holding (nr_seq_mapa_p bigint, nm_usuario_p text, ie_qt_vl_p text, cd_local_estoque_p bigint, dt_mesano_referencia_p timestamp, ie_consignado_p text, cd_estab_grupo_p text default null, cd_empresa_grupo_p text default null) AS $body$
DECLARE
...
C01 CURSOR FOR
	...
	and 	obter_se_contido(cd_estabelecimento, cd_estabelecimentos_w) = 'S'
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_mapa_est_loc_holding (nr_seq_mapa_p bigint, nm_usuario_p text, ie_qt_vl_p text, cd_local_estoque_p bigint, dt_mesano_referencia_p timestamp, ie_consignado_p text, cd_estab_grupo_p text default null, cd_empresa_grupo_p text default null) FROM PUBLIC;
