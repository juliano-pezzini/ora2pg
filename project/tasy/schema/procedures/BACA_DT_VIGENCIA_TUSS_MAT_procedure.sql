...
CREATE OR REPLACE PROCEDURE baca_dt_vigencia_tuss_mat () AS $body$
DECLARE
...
C01 CURSOR FOR 
	SELECT	nr_sequencia, 
		pls_util_pck.obter_dt_vigencia_null(dt_vigencia_inicial, 'I') dt_inicio_vigencia_ref, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vigencia_tuss_mat () FROM PUBLIC;
