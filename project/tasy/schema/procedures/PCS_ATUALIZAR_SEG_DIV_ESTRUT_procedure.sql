...
CREATE OR REPLACE PROCEDURE pcs_atualizar_seg_div_estrut ( nr_sequencia_p bigint, nr_seq_motivo_p bigint, nr_seq_segmento_p bigint, ds_justificativa_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pcs_atualizar_seg_div_estrut ( nr_sequencia_p bigint, nr_seq_motivo_p bigint, nr_seq_segmento_p bigint, ds_justificativa_p text, nm_usuario_p text) FROM PUBLIC;
