...
CREATE OR REPLACE PROCEDURE ptu_gerar_a560_60 ( nr_seq_nota_deb_p bigint, nm_usuario_p text) AS $body$
DECLARE


/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade: Gerar o arquivo A560 V6.0
-------------------------------------------------------------------------------------------------------------------
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_a560_60 ( nr_seq_nota_deb_p bigint, nm_usuario_p text) FROM PUBLIC;
