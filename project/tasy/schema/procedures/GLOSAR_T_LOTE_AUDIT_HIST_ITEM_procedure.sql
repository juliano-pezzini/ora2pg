...
CREATE OR REPLACE PROCEDURE glosar_t_lote_audit_hist_item ( vl_saldo_p bigint, vl_glosa_informada_p bigint, nr_seq_item_p bigint, nm_usuario_p text, cd_motivo_glosa_p bigint default null, ie_acao_glosa_p text default null, ie_remove_motivo_acao_p text default 'N', ds_justificativa_p text default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE glosar_t_lote_audit_hist_item ( vl_saldo_p bigint, vl_glosa_informada_p bigint, nr_seq_item_p bigint, nm_usuario_p text, cd_motivo_glosa_p bigint default null, ie_acao_glosa_p text default null, ie_remove_motivo_acao_p text default 'N', ds_justificativa_p text default null) FROM PUBLIC;
