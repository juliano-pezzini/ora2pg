...
CREATE OR REPLACE PROCEDURE gerar_evento_laudo_lab ( nr_seq_evento_p bigint, nm_usuario_p text, nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, ie_trigger_p text, ds_titulo_laudo_p text, ie_tipo_evento_p text) AS $body$
DECLARE
...
if (ie_tipo_evento_p = 'P') then 
	select 	a.nm_exame 
	into STRICT 	nm_exame_w	 
	from 	exame_laboratorio a 
	where 	a.nr_seq_exame = nr_seq_exame_p;
elsif (ie_tipo_evento_p = 'L') then 
	nm_exame_w := ds_titulo_laudo_p;
end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_laudo_lab ( nr_seq_evento_p bigint, nm_usuario_p text, nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_exame_p bigint, ie_trigger_p text, ds_titulo_laudo_p text, ie_tipo_evento_p text) FROM PUBLIC;
