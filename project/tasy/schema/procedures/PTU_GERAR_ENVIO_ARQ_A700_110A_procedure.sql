...
CREATE OR REPLACE PROCEDURE ptu_gerar_envio_arq_a700_110a (nr_seq_servico_p bigint, cd_estabelecimento_p text, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C00 */
	...
	EXIT WHEN NOT FOUND; /* apply on C01 */
		...
		-- Regra: Para atendimento de Atenção Domiciliar ou TP_NOTA = 3 (Internação) o campo TP_PESSOA deverá ser preenchido com J	-- OS 1999273 JTRINDADE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_envio_arq_a700_110a (nr_seq_servico_p bigint, cd_estabelecimento_p text, nm_usuario_p text) FROM PUBLIC;
