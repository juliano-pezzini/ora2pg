...
CREATE OR REPLACE PROCEDURE calcular_pac_internado_data (nm_usuario_p text, dt_parametro_p timestamp) AS $body$
DECLARE
...
/* Calculo de lançamento paciente */
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE calcular_pac_internado_data (nm_usuario_p text, dt_parametro_p timestamp) FROM PUBLIC;
