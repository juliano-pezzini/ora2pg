...
CREATE OR REPLACE PROCEDURE receber_frasco_pato_loc ( ie_itens_p text, cd_setor_atendimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE receber_frasco_pato_loc ( ie_itens_p text, cd_setor_atendimento_p bigint, nm_usuario_p text) FROM PUBLIC;
