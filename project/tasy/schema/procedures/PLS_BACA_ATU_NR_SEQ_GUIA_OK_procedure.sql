...
CREATE OR REPLACE PROCEDURE pls_baca_atu_nr_seq_guia_ok () AS $body$
DECLARE

/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
Finalidade:	Popular o campo nr_seq_guia_ok da tabela pls_guia_plano. Este campo foi criado 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_baca_atu_nr_seq_guia_ok () FROM PUBLIC;
