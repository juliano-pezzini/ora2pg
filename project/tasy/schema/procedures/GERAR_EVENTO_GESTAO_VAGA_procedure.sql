...
CREATE OR REPLACE PROCEDURE gerar_evento_gestao_vaga ( cd_pessoa_fisica_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_gv_p bigint, nm_paciente_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_gestao_vaga ( cd_pessoa_fisica_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_gv_p bigint, nm_paciente_p text) FROM PUBLIC;
