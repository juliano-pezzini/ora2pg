...
CREATE OR REPLACE PROCEDURE gerar_oc_mat_autor_cirurgia ( nr_sequencia_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
if (nr_sequencia_p > 0) then
	...
	and	c.cd_convenio	= OBTER_DADOS_AUTOR_CIRURGIA(b.nr_sequencia,'C');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_oc_mat_autor_cirurgia ( nr_sequencia_p bigint, nm_usuario_p text) FROM PUBLIC;
