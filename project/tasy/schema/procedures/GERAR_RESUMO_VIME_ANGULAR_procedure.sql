...
CREATE OR REPLACE PROCEDURE gerar_resumo_vime_angular ( cd_paciente_p text, nr_atendimento_p bigint, nr_prescricao_p bigint, cd_material_p bigint, ie_tipo_item_p text, ie_atend_pac_p text, ie_origem_inf_p text, cd_unidade_medida_p INOUT text, dt_inicio_util_p INOUT timestamp, dt_fim_util_p INOUT timestamp, qt_dose_min_p INOUT bigint, qt_dose_susp_p INOUT bigint, qt_dose_max_p INOUT bigint, qt_dose_med_p INOUT bigint, qt_dose_tot_p INOUT bigint, ds_unid_med_p INOUT text, qt_dia_util_p INOUT bigint, qt_dia_cor_p INOUT bigint, pr_dia_intern_p INOUT bigint, qt_dose_pend_p INOUT bigint, dt_primeira_util_p INOUT timestamp, dt_ultima_util_p INOUT timestamp, qt_dose_total_medic_p INOUT bigint) AS $body$
DECLARE
...
dt_primeira_util_p	:= to_date(dt_horario_ant_w, 'dd/mm/yyyy hh24:mi:ss');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_resumo_vime_angular ( cd_paciente_p text, nr_atendimento_p bigint, nr_prescricao_p bigint, cd_material_p bigint, ie_tipo_item_p text, ie_atend_pac_p text, ie_origem_inf_p text, cd_unidade_medida_p INOUT text, dt_inicio_util_p INOUT timestamp, dt_fim_util_p INOUT timestamp, qt_dose_min_p INOUT bigint, qt_dose_susp_p INOUT bigint, qt_dose_max_p INOUT bigint, qt_dose_med_p INOUT bigint, qt_dose_tot_p INOUT bigint, ds_unid_med_p INOUT text, qt_dia_util_p INOUT bigint, qt_dia_cor_p INOUT bigint, pr_dia_intern_p INOUT bigint, qt_dose_pend_p INOUT bigint, dt_primeira_util_p INOUT timestamp, dt_ultima_util_p INOUT timestamp, qt_dose_total_medic_p INOUT bigint) FROM PUBLIC;
