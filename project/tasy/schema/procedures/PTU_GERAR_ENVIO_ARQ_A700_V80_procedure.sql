...
CREATE OR REPLACE PROCEDURE ptu_gerar_envio_arq_a700_v80 ( nr_seq_servico_p bigint, cd_estabelecimento_p text, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C00 */
	...
	EXIT WHEN NOT FOUND; /* apply on C01 */
		...
		ds_conteudo_w	:=	lpad(to_char(nr_seq_registro_w),8,'0') || '702' || nr_lote_w || lpad(' ',12,' ') || cd_unimed_destino_w || '  ' || 
					...
					cd_cnes_cont_exec_w || cd_munic_cont_exec_w;
		ds_arquivo_w	:=	ds_arquivo_w || ds_conteudo_w;
		...
		EXIT WHEN NOT FOUND; /* apply on C03 */
			...
			ds_conteudo_w	:=	lpad(to_char(nr_seq_registro_w),8,'0') || '704' || nr_lote_704_w || lpad(' ',11,' ') || 
						...
						lpad(' ',37,' ') || dt_pgto_prestador_w || nr_cnpj_fornecedor_w || cd_rec_prestador_w || cd_ref_material_fab_w;
			ds_arquivo_w	:=	ds_arquivo_w || ds_conteudo_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_envio_arq_a700_v80 ( nr_seq_servico_p bigint, cd_estabelecimento_p text, nm_usuario_p text) FROM PUBLIC;
