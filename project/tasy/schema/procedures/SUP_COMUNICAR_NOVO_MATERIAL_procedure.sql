...
CREATE OR REPLACE PROCEDURE sup_comunicar_novo_material ( cd_material_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
/*select	substr('Novo material cadastrado. ' || chr(13) ||
		'Código: ' || cd_material_p || chr(13) || chr(10) ||
		'Descrição: ' || substr(obter_desc_material(cd_material_p),1,120) || chr(13) || chr(10) ||
...
into	ds_comunic_w,
	ds_titulo_w
from 	dual;*/
select	substr(wheb_mensagem_pck.get_texto(314207) || chr(13) ||
		wheb_mensagem_pck.get_texto(314208, 'CD_MATERIAL='|| cd_material_p) || chr(13) || chr(10) ||
		wheb_mensagem_pck.get_texto(314209, 'DS_MATERIAL='|| substr(obter_desc_material(cd_material_p),1,120)) || chr(13) || chr(10) ||
	...
	wheb_mensagem_pck.get_texto(314207)
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE sup_comunicar_novo_material ( cd_material_p bigint, nm_usuario_p text) FROM PUBLIC;
