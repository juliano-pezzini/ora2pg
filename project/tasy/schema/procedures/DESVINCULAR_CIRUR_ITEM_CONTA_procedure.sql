...
CREATE OR REPLACE PROCEDURE desvincular_cirur_item_conta (nr_seq_item_p bigint, ie_proc_mat_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE desvincular_cirur_item_conta (nr_seq_item_p bigint, ie_proc_mat_p text, nm_usuario_p text) FROM PUBLIC;
