...
CREATE OR REPLACE PROCEDURE lab_desfazer_liberacao_lote (nr_seq_lote_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	CALL Desfazer_LAB_Aprovacao(nr_prescricao_w, nr_seq_prescr_w, nm_usuario_p, 'S', 'S');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lab_desfazer_liberacao_lote (nr_seq_lote_p bigint, nm_usuario_p text) FROM PUBLIC;
