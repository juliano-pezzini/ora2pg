...
CREATE OR REPLACE PROCEDURE baixar_prescr_sem_estoque (nr_prescricao_p bigint, nr_seq_atepacu_p bigint, cd_motivo_baixa_p bigint, ie_atualiza_p text, nm_usuario_p text) AS $body$
DECLARE
...
/*	and	b.ie_material_estoque	= 'N' 
	and	b.ie_baixa_estoq_pac	= 'N' Retirado por Fabio 12/10/2005*/
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (coalesce(ie_atualiza_p,'N') = 'S') then 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baixar_prescr_sem_estoque (nr_prescricao_p bigint, nr_seq_atepacu_p bigint, cd_motivo_baixa_p bigint, ie_atualiza_p text, nm_usuario_p text) FROM PUBLIC;
