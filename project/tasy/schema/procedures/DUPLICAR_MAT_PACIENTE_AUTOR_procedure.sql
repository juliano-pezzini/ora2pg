...
CREATE OR REPLACE PROCEDURE duplicar_mat_paciente_autor ( nr_sequencia_p bigint, nm_usuario_p text, nr_seq_mat_autor_p bigint, qt_mat_autor_p bigint, ie_atualiza_local_estoque_p text, nr_seq_gerada_p INOUT bigint) AS $body$
DECLARE
...
/* Ricardo 21/01/2005 - incluido o novo parâmetro IE_ATUALIZA_LOCAL_ESTOQUE, para glosa por % Não deve atualizar o estoque do item glosado */
...
insert	into material_atend_paciente(
	...
	IE_AUDITORIA,NR_SEQ_GRUPO_REC,CD_MOTIVO_AJUSTE,NR_SEQ_COR_EXEC, nr_seq_mat_autor)
SELECT
	NR_SEQUENCIA_W,NR_ATENDIMENTO,DT_ENTRADA_UNIDADE,CD_MATERIAL,DT_ATENDIMENTO + 3/86400,
	CD_UNIDADE_MEDIDA,qt_mat_autor_p,clock_timestamp(),NM_USUARIO_P,CD_CONVENIO,CD_CATEGORIA,
	--DT_PRESCRICAO,CD_MATERIAL_PRESCRICAO,IE_VIA_APLICACAO,'Item gerado ao realizar o desdobramento na Autorização convênio',VL_MATERIAL,
	DT_PRESCRICAO,CD_MATERIAL_PRESCRICAO,IE_VIA_APLICACAO,wheb_mensagem_pck.get_texto(304100),VL_MATERIAL,
	CD_TAB_PRECO_MATERIAL,DT_VIGENCIA_TABELA,DT_ACERTO_CONTA,DT_ACERTO_CONVENIO,
	NR_PRESCRICAO,NR_SEQUENCIA_PRESCRICAO,CD_MOTIVO_EXC_CONTA,DS_COMPL_MOTIVO_EXCON,
	...
	VL_TABELA_ORIGINAL,IE_EMITE_CONTA,CD_SETOR_RECEITA,CD_CGC_FORNECEDOR,
	NR_SEQ_LOTE_FORNEC,CD_MATERIAL_EXEC,NR_SEQ_ATEPACU,IE_TIPO_GUIA,NR_DOC_INTERNO,
	IE_AUDITORIA,NR_SEQ_GRUPO_REC,CD_MOTIVO_AJUSTE,1762, nr_seq_mat_autor_p
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE duplicar_mat_paciente_autor ( nr_sequencia_p bigint, nm_usuario_p text, nr_seq_mat_autor_p bigint, qt_mat_autor_p bigint, ie_atualiza_local_estoque_p text, nr_seq_gerada_p INOUT bigint) FROM PUBLIC;
