...
CREATE OR REPLACE PROCEDURE pls_valida_ocor_aut_simult ( nr_seq_ocor_combinada_p pls_ocor_aut_combinada.nr_sequencia%type, nr_seq_ocorrencia_p pls_ocorrencia.nr_sequencia%type, nr_seq_motivo_glosa_p tiss_motivo_glosa.nr_sequencia%type, nr_seq_guia_p pls_guia_plano.nr_sequencia%type, nr_seq_requisicao_p pls_requisicao.nr_sequencia%type, nr_seq_execucao_p pls_execucao_requisicao.nr_sequencia%type, ie_utiliza_filtro_p pls_ocor_aut_combinada.ie_utiliza_filtro%type, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type ) AS $body$
DECLARE


/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Finalidade:
Validar a ocorrencia combinada Valida itens simultaneos.
-------------------------------------------------------------------------------------------------------------------
...
C01 CURSOR FOR
	SELECT	nr_seq_simultaneo
	from	pls_validacao_aut_simult
	...
	begin
		if (nr_seq_guia_p IS NOT NULL AND nr_seq_guia_p::text <> '') then
			...
			for r_C02_w in C02 loop
				begin
					ie_gerar_ocorrencia_w	:= pls_obter_se_simultaneo_aut(	r_C01_w.nr_seq_simultaneo, nr_seq_guia_p, r_C02_w.cd_procedimento,
													r_C02_w.ie_origem_proced, null, null, null, 
			...
			for r_C03_w in C03 loop
				begin
					ie_gerar_ocorrencia_w	:= pls_obter_se_simultaneo_aut(	r_C01_w.nr_seq_simultaneo, nr_seq_guia_p, null,
													null, r_C03_w.nr_seq_material, null, null, 
													cd_estabelecimento_p, nm_usuario_p);
			...
			for r_C04_w in C04 loop
				begin
					ie_gerar_ocorrencia_w	:= pls_obter_se_simultaneo_req(	r_C01_w.nr_seq_simultaneo, nr_seq_requisicao_p, r_C04_w.cd_procedimento,
													r_C04_w.ie_origem_proced, null, null, null, 
													cd_estabelecimento_p, nm_usuario_p);
			...
			for r_C05_w in C05 loop
				begin
					ie_gerar_ocorrencia_w	:= pls_obter_se_simultaneo_req(	r_C01_w.nr_seq_simultaneo, nr_seq_requisicao_p, null,
													null, r_C05_w.nr_seq_material, null, null, 
													cd_estabelecimento_p, nm_usuario_p);
			...
			for r_C06_w in C06 loop
				begin
					ie_gerar_ocorrencia_w	:= pls_obter_se_simultaneo_exec(r_C01_w.nr_seq_simultaneo, nr_seq_execucao_p, r_C06_w.cd_procedimento,
													r_C06_w.ie_origem_proced, null, cd_estabelecimento_p, nm_usuario_p);
			...
			for r_C07_w in C07 loop
				begin
					ie_gerar_ocorrencia_w	:= pls_obter_se_simultaneo_exec(r_C01_w.nr_seq_simultaneo, nr_seq_execucao_p, null,
													null, r_C07_w.nr_seq_material, cd_estabelecimento_p, nm_usuario_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_valida_ocor_aut_simult ( nr_seq_ocor_combinada_p pls_ocor_aut_combinada.nr_sequencia%type, nr_seq_ocorrencia_p pls_ocorrencia.nr_sequencia%type, nr_seq_motivo_glosa_p tiss_motivo_glosa.nr_sequencia%type, nr_seq_guia_p pls_guia_plano.nr_sequencia%type, nr_seq_requisicao_p pls_requisicao.nr_sequencia%type, nr_seq_execucao_p pls_execucao_requisicao.nr_sequencia%type, ie_utiliza_filtro_p pls_ocor_aut_combinada.ie_utiliza_filtro%type, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type ) FROM PUBLIC;
