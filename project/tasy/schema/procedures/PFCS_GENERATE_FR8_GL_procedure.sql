...
CREATE OR REPLACE PROCEDURE pfcs_generate_fr8_gl (nr_seq_indicator_p bigint) AS $body$
DECLARE
...
/* INSERT QUERY/* INSERT QUERY NO: 1 */
...
cd_estabelecimento_w	:= pfcs_get_structure_level(cd_establishment_p => 2, ie_level_p => 'O', ie_info_p => 'C');
...
cd_estabelecimento_w	:= pfcs_get_structure_level(cd_establishment_p => 3, ie_level_p => 'O', ie_info_p => 'C');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_generate_fr8_gl (nr_seq_indicator_p bigint) FROM PUBLIC;
