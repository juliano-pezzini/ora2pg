...
WHERE  coalesce(a.nr_seq_etapa_prod::text, '') = '' 
       ...
       AND ( ( Trunc(a.dt_prevista) = Trunc(dt_etapa_p) ) 
		...
		and  coalesce(obter_prontuario_pf(a.cd_estabelecimento, a.cd_pessoa_fisica), 0) = coalesce(etapa_prontuario_p,coalesce(obter_prontuario_pf(a.cd_estabelecimento, a.cd_pessoa_fisica) ,0))
