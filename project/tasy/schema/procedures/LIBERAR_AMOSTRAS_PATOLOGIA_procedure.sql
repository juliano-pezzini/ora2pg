...
CREATE OR REPLACE PROCEDURE liberar_amostras_patologia ( nr_prescricao_p bigint, nr_seq_proced_p bigint, nr_seq_status_p text, nm_usuario_p text) AS $body$
BEGIN
/*
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE liberar_amostras_patologia ( nr_prescricao_p bigint, nr_seq_proced_p bigint, nr_seq_status_p text, nm_usuario_p text) FROM PUBLIC;
