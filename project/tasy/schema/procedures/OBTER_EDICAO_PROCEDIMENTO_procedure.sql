...
CREATE OR REPLACE PROCEDURE obter_edicao_procedimento ( cd_estabelecimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, dt_conta_p timestamp, cd_procedimento_p bigint, cd_edicao_amb_p INOUT bigint, dt_vigencia_p INOUT timestamp) AS $body$
DECLARE
...
dt_vigencia_p		:= dt_inicio_vigencia_w;
end;
$body$
LANGUAGE PLPGSQL
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE obter_edicao_procedimento ( cd_estabelecimento_p bigint, cd_convenio_p bigint, cd_categoria_p text, dt_conta_p timestamp, cd_procedimento_p bigint, cd_edicao_amb_p INOUT bigint, dt_vigencia_p INOUT timestamp) FROM PUBLIC;
