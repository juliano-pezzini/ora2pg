...
CREATE OR REPLACE PROCEDURE gerar_bi_despesa_towers ( nr_seq_arq_informacao_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
nr_seq_lote_pgto_w		pls_conta.nr_seq_lote_pgto%type;
...
cd_codigo_w			pls_contrato_codigo.cd_codigo%type;
ds_grupo_w			pls_preco_grupo_produto.Ds_Grupo%type;
...
ds_sql_w	:= 	'select	''C'' ie_origem,		'	|| pls_util_pck.enter_w || 
			'	''P'',				'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_segurado,		'	|| pls_util_pck.enter_w || 
			'	b.cd_procedimento,	 	'	|| pls_util_pck.enter_w || 
			'	nvl(a.cd_guia,a.cd_guia_prestador), '	|| pls_util_pck.enter_w || 
			'	a.dt_atendimento,	 	'	|| pls_util_pck.enter_w || 
			'	a.dt_alta,		 	'	|| pls_util_pck.enter_w || 
			'	b.ie_tipo_despesa,	 	'	|| pls_util_pck.enter_w || 
			'	b.vl_procedimento,	 	'	|| pls_util_pck.enter_w || 
			'	b.vl_procedimento_imp,	 	'	|| pls_util_pck.enter_w || 
			'	b.vl_liberado,		 	'	|| pls_util_pck.enter_w || 
			...
			'	a.nr_seq_tipo_atendimento,	'	|| pls_util_pck.enter_w || 
			'	b.dt_procedimento,		'	|| pls_util_pck.enter_w || 
			'	c.dt_protocolo,			'	|| pls_util_pck.enter_w || 
			'	obter_valor_dominio(1746,c.ie_tipo_guia), '|| pls_util_pck.enter_w || 
			'	substr(pls_obter_cod_prestador(a.nr_seq_prestador_exec,null),1,255), 	'	|| pls_util_pck.enter_w || 
			'	(select max(f.nr_sequencia) from pls_lote_mensalidade f,   		'  || pls_util_pck.enter_w || 
			'           pls_mensalidade g,					'  || pls_util_pck.enter_w || 
			'           pls_mensalidade_segurado h,				'  || pls_util_pck.enter_w || 
			'           pls_mensalidade_seg_item i				'  || pls_util_pck.enter_w || 
			'           where g.nr_seq_lote    = f.nr_sequencia		'  || pls_util_pck.enter_w || 
			'           and  h.nr_seq_mensalidade = g.nr_sequencia		'  || pls_util_pck.enter_w ||                         
			'           and  i.nr_seq_mensalidade_seg = h.nr_sequencia		'  || pls_util_pck.enter_w || 
			'           and  i.nr_seq_conta = a.nr_sequencia			'  ||	 pls_util_pck.enter_w || 
			'           ),							'  || pls_util_pck.enter_w || 
			'	b.ie_origem_proced, '  || pls_util_pck.enter_w || 
			'	decode(d.nr_seq_plano,45,f.cd_codigo,'''') '|| pls_util_pck.enter_w || 
			...
			'	pls_contrato    	e,	'	|| pls_util_pck.enter_w || 
			'	pls_contrato_codigo	f	'	|| pls_util_pck.enter_w || 
			'where	a.nr_sequencia 		= b.nr_seq_conta	'	|| pls_util_pck.enter_w || 
			'and	c.nr_sequencia 		= a.nr_seq_protocolo 	'	|| pls_util_pck.enter_w || 
			' and	a.nr_seq_segurado	= d.nr_sequencia	' || pls_util_pck.enter_w || 
			' and	d.nr_seq_contrato	= e.nr_sequencia 	' || pls_util_pck.enter_w || 
			' and	e.nr_sequencia		= f.nr_seq_contrato(+)	' || pls_util_pck.enter_w || 
			' and	f.nr_seq_tipo_codigo(+) = 3 			'|| pls_util_pck.enter_w || 
			' and	c.DT_MES_COMPETENCIA	between :dt_inicial and :dt_final ' || pls_util_pck.enter_w || 
			' and	exists	(	select	1						'	|| pls_util_pck.enter_w || 
			'			from	pls_conta_medica_resumo	x			'	|| pls_util_pck.enter_w || 
			'			where	x.nr_seq_conta		= a.nr_sequencia	'	|| pls_util_pck.enter_w || 
			'			and	x.nr_seq_conta_proc	= b.nr_sequencia	'	|| pls_util_pck.enter_w || 
			'			and	x.vl_liberado	> 0				'	|| pls_util_pck.enter_w || 
			'			and	x.nr_seq_lote_pgto is not null)			'	|| pls_util_pck.enter_w || 
			'and	c.ie_tipo_protocolo <> ''R'' 	'	||ds_filtros_w|| pls_util_pck.enter_w || 
			'union all '					|| pls_util_pck.enter_w || 
			'select	''C'' ie_origem,		'	|| pls_util_pck.enter_w || 
			'	''M'',				'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_segurado,		'	|| pls_util_pck.enter_w || 
			'	b.nr_seq_material cd_procedimento,'	|| pls_util_pck.enter_w || 
			'	nvl(a.cd_guia,a.cd_guia_prestador),'	|| pls_util_pck.enter_w || 
			'	a.dt_atendimento,	 	'	|| pls_util_pck.enter_w || 
			'	a.dt_alta,		 	'	|| pls_util_pck.enter_w || 
			'	b.ie_tipo_despesa,	 	'	|| pls_util_pck.enter_w || 
			'	b.vl_material vl_calculado,	'	|| pls_util_pck.enter_w || 
			'	b.vl_material_imp vl_procedimento_imp,	'|| pls_util_pck.enter_w || 
			'	b.vl_liberado,		 	'	|| pls_util_pck.enter_w || 
			'	a.cd_guia_referencia,	 	'	|| pls_util_pck.enter_w || 
			'	a.nr_sequencia,			'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_prestador_exec,	'	|| pls_util_pck.enter_w || 
			'	b.nr_sequencia,			'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_tipo_atendimento,	'	|| pls_util_pck.enter_w || 
			'	b.dt_atendimento,		'	|| pls_util_pck.enter_w || 
			'	c.dt_protocolo,			'	|| pls_util_pck.enter_w || 
			'	obter_valor_dominio(1746,c.ie_tipo_guia), '|| pls_util_pck.enter_w || 
			'	substr(pls_obter_cod_prestador(a.nr_seq_prestador_exec,null),1,255), 	'	|| pls_util_pck.enter_w || 
			'	(select max(f.nr_sequencia) from pls_lote_mensalidade f,   		'  || pls_util_pck.enter_w || 
			...
			'	decode(d.nr_seq_plano,45,f.cd_codigo,'''') '|| pls_util_pck.enter_w || 
			'from	pls_conta		a,	'	|| pls_util_pck.enter_w || 
			'	pls_conta_mat		b,	'	|| pls_util_pck.enter_w || 
			'	pls_protocolo_conta	c,	'	|| pls_util_pck.enter_w || 
			'	pls_segurado		d,	'	|| pls_util_pck.enter_w || 
			'	pls_contrato    	e,	'	|| pls_util_pck.enter_w || 
			'	pls_contrato_codigo	f	'	|| pls_util_pck.enter_w || 
			...
			'			from	pls_conta_medica_resumo	x			'	|| pls_util_pck.enter_w || 
			'			where	x.nr_seq_conta		= a.nr_sequencia	'	|| pls_util_pck.enter_w || 
			'			and	x.nr_seq_conta_mat	= b.nr_sequencia	'	|| pls_util_pck.enter_w || 
			'			and	x.vl_liberado	> 0				'	|| pls_util_pck.enter_w || 
			'			and	x.nr_seq_lote_pgto is not null)			'	|| pls_util_pck.enter_w || 
			'and	c.ie_tipo_protocolo <> ''R'' 	' ||ds_filtros_w || pls_util_pck.enter_w || 
			'union all ' || pls_util_pck.enter_w || 
			'select ''R'' ie_origem,							'	|| pls_util_pck.enter_w || 
			'	''P'' ie_tipo,								'	|| pls_util_pck.enter_w || 
			'	 a.nr_seq_segurado,							'	|| pls_util_pck.enter_w || 
			'	h.cd_procedimento,							'	|| pls_util_pck.enter_w || 
			'	nvl(a.cd_guia,a.cd_guia_prestador), 					'	|| pls_util_pck.enter_w || 
			'	a.dt_atendimento,	 						'	|| pls_util_pck.enter_w || 
			'	a.dt_alta,		 						'	|| pls_util_pck.enter_w || 
			'	h.ie_tipo_despesa,	 						'	|| pls_util_pck.enter_w || 
			'	c.vl_recursado,	 							'	|| pls_util_pck.enter_w || 
			'	c.vl_recursado,	 							'	|| pls_util_pck.enter_w || 
			'	c.vl_acatado,		 						'	|| pls_util_pck.enter_w || 
			'	a.cd_guia_referencia,	 						'	|| pls_util_pck.enter_w || 
			'	a.nr_sequencia,								'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_prestador_exec,						'	|| pls_util_pck.enter_w || 
			'	c.nr_sequencia,								'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_tipo_atendimento,						'	|| pls_util_pck.enter_w || 
			'	h.dt_procedimento,							'	|| pls_util_pck.enter_w || 
			'	e.dt_apresentacao_lote,							'	|| pls_util_pck.enter_w || 
			'	obter_valor_dominio(1746,a.ie_tipo_guia),				'	|| pls_util_pck.enter_w || 
			'	substr(pls_obter_cod_prestador(a.nr_seq_prestador_exec,null),1,255), 	'	|| pls_util_pck.enter_w || 
			'	null,									'	|| pls_util_pck.enter_w || 
			'	h.ie_origem_proced,							'	|| pls_util_pck.enter_w || 
			'	decode(d.nr_seq_plano,45,f.cd_codigo,'''') 				'	|| pls_util_pck.enter_w || 
			'from	pls_segurado		d,						'	|| pls_util_pck.enter_w || 
			'	pls_rec_glosa_protocolo	e,						'	|| pls_util_pck.enter_w || 
			'	pls_conta		a,						'	|| pls_util_pck.enter_w || 
			'	pls_rec_glosa_proc	c,						'	|| pls_util_pck.enter_w || 
			'	pls_rec_glosa_conta	g,						'	|| pls_util_pck.enter_w || 
			'	pls_contrato    	b,						'	|| pls_util_pck.enter_w || 
			'	pls_contrato_codigo	f,						'	|| pls_util_pck.enter_w || 
			'	pls_conta_proc		h						'	|| pls_util_pck.enter_w || 
			'where	c.nr_seq_conta_rec	= g.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	a.nr_seq_segurado	= d.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	g.nr_seq_protocolo	= e.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	g.nr_seq_conta		= a.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	d.nr_seq_contrato	= b.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and 	f.nr_seq_contrato	= b.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	c.nr_seq_conta_proc	= h.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	f.nr_seq_tipo_codigo(+) = 3 						'	|| pls_util_pck.enter_w || 
			'and	e.dt_liberacao_pag	between :dt_inicial and :dt_final 		'	|| pls_util_pck.enter_w || 
			'and	c.vl_acatado		> 0						'	|| pls_util_pck.enter_w || 
			'and	e.ie_status		in (''3'',''5'',''6'')	' ||ds_filtros_w || pls_util_pck.enter_w || 
			'union all									'	|| pls_util_pck.enter_w || 
			'select ''R'' ie_origem,							'	|| pls_util_pck.enter_w || 
			'	''M'' ie_tipo,								'	|| pls_util_pck.enter_w || 
			'	 a.nr_seq_segurado,							'	|| pls_util_pck.enter_w || 
			'	h.nr_seq_material cd_procedimento,					'	|| pls_util_pck.enter_w || 
			'	nvl(a.cd_guia,a.cd_guia_prestador), 					'	|| pls_util_pck.enter_w || 
			'	a.dt_atendimento,	 						'	|| pls_util_pck.enter_w || 
			'	a.dt_alta,		 						'	|| pls_util_pck.enter_w || 
			'	h.ie_tipo_despesa,	 						'	|| pls_util_pck.enter_w || 
			...
			'	c.nr_sequencia,								'	|| pls_util_pck.enter_w || 
			'	a.nr_seq_tipo_atendimento,						'	|| pls_util_pck.enter_w || 
			'	h.dt_atendimento,							'	|| pls_util_pck.enter_w || 
			'	e.dt_apresentacao_lote,							'	|| pls_util_pck.enter_w || 
			'	obter_valor_dominio(1746,a.ie_tipo_guia),				'	|| pls_util_pck.enter_w || 
			'	substr(pls_obter_cod_prestador(a.nr_seq_prestador_exec,null),1,255), 	'	|| pls_util_pck.enter_w || 
			'	null,									'	|| pls_util_pck.enter_w || 
			...
			'	pls_contrato    	b,						'	|| pls_util_pck.enter_w || 
			'	pls_contrato_codigo	f,						'	|| pls_util_pck.enter_w || 
			'	pls_conta_mat		h						'	|| pls_util_pck.enter_w || 
			'where	c.nr_seq_conta_rec	= g.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	a.nr_seq_segurado	= d.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	g.nr_seq_protocolo	= e.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	g.nr_seq_conta		= a.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	d.nr_seq_contrato	= b.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and 	f.nr_seq_contrato	= b.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	c.nr_seq_conta_mat	= h.nr_sequencia				'	|| pls_util_pck.enter_w || 
			'and	f.nr_seq_tipo_codigo(+) = 3 						'	|| pls_util_pck.enter_w || 
			'and	e.dt_liberacao_pag	between :dt_inicial and :dt_final 		'	|| pls_util_pck.enter_w || 
			'and	c.vl_acatado		> 0						'	|| pls_util_pck.enter_w || 
			'and	e.ie_status		in (''3'',''5'',''6'')' 			||ds_filtros_w;
	 
begin	 
 
	utl_file.put_line(arq_texto_w, 'SEGMENTO;TIPO DE PLANO;CODIGO DO PLANO;PLANO;GRUPO DE PLANO;CNPJ DA EMPRESA;TIPO DE CONTRATO;NUMERO IDENTIFICACAO TITULAR;'|| 
					...
					'TIPO GUIA;TITULO;FUNDO;TIPO DESPESA;' || chr(13));
	...
	bind_w := sql_pck.executa_sql_big_cursor(ds_sql_w, bind_w);
	loop 
		fetch cursor_w into ie_origem_conta_w,ie_tipo_w,nr_seq_segurado_w,cd_procedimento_w,cd_guia_w,dt_atendimento_w,dt_alta_w,ie_tipo_despesa_w,vl_calculado_w,vl_procedimento_imp_w, 
					vl_liberado_w,cd_guia_referencia_w,nr_seq_conta_w,nr_seq_prestador_w,nr_seq_conta_proc_w,nr_seq_tipo_atendimento_w, 
					dt_ocorr_evento_w,dt_protocolo_w,ie_tipo_guia_w,ds_prestador_con_w,nr_lote_mensalidade_w,ie_origem_proced_w,cd_codigo_w;
...
WHERE a.nr_sequencia 		= nr_seq_segurado_w;
			...
			if (nr_seq_plano_w IS NOT NULL AND nr_seq_plano_w::text <> '') then 
				select	obter_valor_dominio(1666,ie_tipo_contratacao), 
					...
					CASE WHEN coalesce(nr_sequencia::text, '') = '' THEN ds_plano  ELSE coalesce(nm_fantasia,ds_plano) END , 
				...
				select	max(gp.ds_grupo) 
				into STRICT  ds_grupo_w 
				from	pls_preco_grupo_produto gp, 
					pls_preco_produto 	pp 
				where	gp.nr_sequencia = pp.nr_seq_grupo 
				and	pp.nr_seq_plano = nr_seq_plano_w;
			...
			if (ie_origem_conta_w = 'C') then 
				ds_tipo_despesa_w	:= 'CONTAS MÉDICAS';
				if (ie_tipo_w = 'M') then 
					select	count(1) 
					...
					from	pls_conta_medica_resumo	x 
					where	x.nr_seq_conta		= nr_seq_conta_w 
					and	x.nr_seq_conta_proc	= nr_seq_conta_proc_w;
			...
			elsif (ie_origem_conta_w = 'R') then 
				ds_tipo_despesa_w	:= 'RECURSO DE GLOSAS';
				vl_pago_plano_w	:= vl_liberado_w;
				...
				if (ie_tipo_w = 'M') then 
					...
					where	nr_seq_mat_rec		= nr_seq_conta_proc_w;
				elsif (ie_tipo_w = 'P') then 
					select	max(nr_seq_prestador_pgto), 
						max(nr_seq_lote_pgto) 
					into STRICT	nr_seq_lote_pgto_w, 
						nr_seq_prestador_pgto_w 
					from	pls_conta_rec_resumo_item 
					where	nr_seq_proc_rec		= nr_seq_conta_proc_w;
				end if;
			...
			and	c.nr_seq_lote			= nr_seq_lote_pgto_w 
			and	c.nr_seq_prestador		= nr_seq_prestador_pgto_w;
			...
			ds_linha_w	:= ds_tipo_contratacao_w||';'||ds_segmentacao_w||';'||nr_seq_plano_w ||';'||ds_plano_w||';'||ds_grupo_w||';'||cd_cgc_estipulante_w||';'||ie_preco_w||';'||cd_usuario_plano_ww||';'|| 
					...
					replace(coalesce(vl_calculado_w,0),',','.')||';'||replace(coalesce(vl_procedimento_imp_w,0),',','.')||';'||replace(coalesce(vl_liberado_w,0),',','.')||';'||replace(coalesce(vl_pago_usuario_w,0),',','.')||';'||replace(coalesce(vl_pago_empresa_w,0),',','.')||';'||replace(coalesce(vl_pago_plano_w,0),',','.')||';'|| 
					ie_tipo_guia_w||';'||nr_titulo_w||';'||cd_codigo_w||';'||ds_tipo_despesa_w||';';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_bi_despesa_towers ( nr_seq_arq_informacao_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
