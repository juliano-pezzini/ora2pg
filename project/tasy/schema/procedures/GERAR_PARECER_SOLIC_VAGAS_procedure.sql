...
CREATE OR REPLACE PROCEDURE gerar_parecer_solic_vagas ( nr_seq_encaminhamento_p bigint, ds_conteudo_p text, nr_seq_regulacao_p bigint, nr_seq_parecer_p INOUT bigint) AS $body$
DECLARE
...
BEGIN
	...
	if (cd_pessoa_fisica_w IS NOT NULL AND cd_pessoa_fisica_w::text <> '') then
		...
		Select 	obter_desc_expressao(926250) -- Solicitação de vagas
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_parecer_solic_vagas ( nr_seq_encaminhamento_p bigint, ds_conteudo_p text, nr_seq_regulacao_p bigint, nr_seq_parecer_p INOUT bigint) FROM PUBLIC;
