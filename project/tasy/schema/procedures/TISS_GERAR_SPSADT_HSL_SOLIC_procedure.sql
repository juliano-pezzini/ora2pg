...
CREATE OR REPLACE PROCEDURE tiss_gerar_spsadt_hsl_solic ( nr_atendimento_p bigint, ds_dir_padrao_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE tiss_gerar_spsadt_hsl_solic ( nr_atendimento_p bigint, ds_dir_padrao_p text, nm_usuario_p text) FROM PUBLIC;
