...
CREATE OR REPLACE PROCEDURE iud_contribuicao_pessoa ( cd_pessoa_fisica_p pessoa_fisica.cd_pessoa_fisica%type, nm_usuario_p text, operation_type_p text, ie_tipo_contribuicao_p pessoa_fisica_aux.ie_tipo_contribuicao%type ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE iud_contribuicao_pessoa ( cd_pessoa_fisica_p pessoa_fisica.cd_pessoa_fisica%type, nm_usuario_p text, operation_type_p text, ie_tipo_contribuicao_p pessoa_fisica_aux.ie_tipo_contribuicao%type ) FROM PUBLIC;
