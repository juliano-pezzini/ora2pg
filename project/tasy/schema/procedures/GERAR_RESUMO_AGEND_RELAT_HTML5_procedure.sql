...
CREATE OR REPLACE PROCEDURE gerar_resumo_agend_relat_html5 ( dt_inicio_p timestamp, dt_final_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_resumo_agend_relat_html5 ( dt_inicio_p timestamp, dt_final_p timestamp, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
