...
CREATE OR REPLACE PROCEDURE baca_dt_vig_pls_eve_rg_tit_pag () AS $body$
DECLARE
...
loop 
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last 
		update	pls_evento_regra_tit_pagar 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_pls_eve_rg_tit_pag () FROM PUBLIC;
