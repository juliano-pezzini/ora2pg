...
CREATE OR REPLACE PROCEDURE limpar_real_ativ_proj_migr_pep ( nr_seq_projeto_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE limpar_real_ativ_proj_migr_pep ( nr_seq_projeto_p bigint, nm_usuario_p text) FROM PUBLIC;
