...
CREATE OR REPLACE PROCEDURE gerar_copia_participantes ( nr_cirurgia_p bigint, nr_seq_copia_p bigint, nr_seq_cola_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
C01 CURSOR FOR
	...
	and	nr_seq_procedimento	= nr_seq_copia_p;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_copia_participantes ( nr_cirurgia_p bigint, nr_seq_copia_p bigint, nr_seq_cola_p bigint, nm_usuario_p text) FROM PUBLIC;
