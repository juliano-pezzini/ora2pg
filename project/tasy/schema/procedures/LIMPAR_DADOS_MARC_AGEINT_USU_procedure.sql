...
CREATE OR REPLACE PROCEDURE limpar_dados_marc_ageint_usu ( nr_seq_ageint_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE limpar_dados_marc_ageint_usu ( nr_seq_ageint_p bigint, nm_usuario_p text) FROM PUBLIC;
