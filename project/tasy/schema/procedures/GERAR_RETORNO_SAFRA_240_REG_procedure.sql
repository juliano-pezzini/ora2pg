...
CREATE OR REPLACE PROCEDURE gerar_retorno_safra_240_reg ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_retorno_safra_240_reg ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
