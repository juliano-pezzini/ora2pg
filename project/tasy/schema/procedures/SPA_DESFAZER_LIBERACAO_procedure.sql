...
CREATE OR REPLACE PROCEDURE spa_desfazer_liberacao ( nr_seq_spa_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
CALL spa_gerar_historico(nr_seq_spa_p,nm_usuario_p,ie_status_w,1,8,'','N');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE spa_desfazer_liberacao ( nr_seq_spa_p bigint, nm_usuario_p text) FROM PUBLIC;
