...
CREATE OR REPLACE PROCEDURE gerar_opme_presc_cirurgia ( nr_cirurgia_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_prescricao_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_opme_presc_cirurgia ( nr_cirurgia_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_prescricao_p INOUT bigint) FROM PUBLIC;
