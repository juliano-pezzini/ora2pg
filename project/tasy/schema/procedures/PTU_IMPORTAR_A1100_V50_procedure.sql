...
CREATE OR REPLACE PROCEDURE ptu_importar_a1100_v50 ( nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_importar_a1100_v50 ( nm_usuario_p text) FROM PUBLIC;
