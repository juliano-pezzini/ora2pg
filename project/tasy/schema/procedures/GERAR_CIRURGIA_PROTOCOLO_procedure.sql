...
CREATE OR REPLACE PROCEDURE gerar_cirurgia_protocolo ( nr_cirurgia_p bigint, nr_seq_protocolo_p bigint, dt_inicio_p timestamp, nr_seq_pepo_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_modelo_p bigint default null) AS $body$
DECLARE
...
select max(nr_sequencia)
 ...
 where (nr_cirurgia = nr_cirurgia_p or nr_seq_pepo = nr_seq_pepo_p); --Buscar ultimo evento inserido
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cirurgia_protocolo ( nr_cirurgia_p bigint, nr_seq_protocolo_p bigint, dt_inicio_p timestamp, nr_seq_pepo_p bigint, nm_usuario_p text, cd_estabelecimento_p bigint, nr_seq_modelo_p bigint default null) FROM PUBLIC;
