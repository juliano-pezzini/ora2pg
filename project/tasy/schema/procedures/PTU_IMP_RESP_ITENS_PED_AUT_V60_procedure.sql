...
CREATE OR REPLACE PROCEDURE ptu_imp_resp_itens_ped_aut_v60 ( nr_seq_resp_autorizacao_p ptu_resposta_autorizacao.nr_sequencia%type, nr_seq_execucao_p ptu_resposta_autorizacao.nr_seq_execucao%type, nr_seq_item_p ptu_resposta_aut_servico.nr_seq_item%type, ie_tipo_tabela_p ptu_pedido_aut_servico.ie_tipo_tabela%type, cd_servico_p ptu_pedido_compl_aut_serv.cd_servico%type, ds_servico_p ptu_resposta_aut_servico.ds_servico%type, qt_autorizada_p text, ie_autorizado_p ptu_resposta_aut_servico.ie_autorizado%type, cd_mens_espec_1_p bigint, cd_mens_espec_2_p bigint, cd_mens_espec_3_p bigint, cd_mens_espec_4_p bigint, cd_mens_espec_5_p bigint, ds_mensagem_espec_p text, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) AS $body$
DECLARE
...
if (ie_tipo_tabela_p	in ('0','1','4')) then
	if (coalesce(nr_seq_pedido_aut_w,0)	<> 0) then
		begin
			...
			and	coalesce(cd_servico_consersao,cd_servico)		= cd_servico_p
		...
		begin
			...
			and	ie_tipo_tabela					= ie_tipo_tabela_p
			and	coalesce(cd_servico_conversao,cd_servico)		= cd_servico_p
			and	nr_seq_item					= nr_seq_item_p;
		exception
		when others then
			nr_seq_ped_aut_compl_serv_w	:= null;
	...
	values (nextval('ptu_resposta_aut_servico_seq'), nr_seq_resp_autorizacao_p, ie_tipo_tabela_p,
		cd_servico_p, coalesce(ds_servico_p,'Não informado'), ie_autorizado_p,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_imp_resp_itens_ped_aut_v60 ( nr_seq_resp_autorizacao_p ptu_resposta_autorizacao.nr_sequencia%type, nr_seq_execucao_p ptu_resposta_autorizacao.nr_seq_execucao%type, nr_seq_item_p ptu_resposta_aut_servico.nr_seq_item%type, ie_tipo_tabela_p ptu_pedido_aut_servico.ie_tipo_tabela%type, cd_servico_p ptu_pedido_compl_aut_serv.cd_servico%type, ds_servico_p ptu_resposta_aut_servico.ds_servico%type, qt_autorizada_p text, ie_autorizado_p ptu_resposta_aut_servico.ie_autorizado%type, cd_mens_espec_1_p bigint, cd_mens_espec_2_p bigint, cd_mens_espec_3_p bigint, cd_mens_espec_4_p bigint, cd_mens_espec_5_p bigint, ds_mensagem_espec_p text, nm_usuario_p usuario.nm_usuario%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) FROM PUBLIC;
