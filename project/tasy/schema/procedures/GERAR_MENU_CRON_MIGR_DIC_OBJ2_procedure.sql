...
CREATE OR REPLACE PROCEDURE gerar_menu_cron_migr_dic_obj2 ( cd_funcao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_menu_cron_migr_dic_obj2 ( cd_funcao_p bigint, nm_usuario_p text) FROM PUBLIC;
