...
CREATE OR REPLACE PROCEDURE liberar_prescr_farmacia_js ( nr_prescricao_p bigint, nr_seq_item_p bigint, nm_usuario_p text, ie_lib_parc_p text, ds_var_gera_solic_nao_padrao_p text, cd_estabelecimento_p bigint, cd_perfil_p bigint, qt_solic_compra_p INOUT bigint, cd_funcao_ativa_p funcao.cd_funcao%type default null) AS $body$
DECLARE
...
if (nr_prescricao_p IS NOT NULL AND nr_prescricao_p::text <> '')then
	...
	CALL liberar_prescricao_farmacia(nr_prescricao_p => nr_prescricao_p,
								nr_seq_item_p => nr_seq_item_p,
								nm_usuario_p => nm_usuario_p,
								ie_lib_parc_p => ie_lib_parc_p,
								ie_copia_diaria_p => 'N',
								cd_funcao_ativa_p => cd_funcao_ativa_p);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE liberar_prescr_farmacia_js ( nr_prescricao_p bigint, nr_seq_item_p bigint, nm_usuario_p text, ie_lib_parc_p text, ds_var_gera_solic_nao_padrao_p text, cd_estabelecimento_p bigint, cd_perfil_p bigint, qt_solic_compra_p INOUT bigint, cd_funcao_ativa_p funcao.cd_funcao%type default null) FROM PUBLIC;
