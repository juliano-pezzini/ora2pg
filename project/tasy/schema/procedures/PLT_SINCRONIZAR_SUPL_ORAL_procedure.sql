...
CREATE OR REPLACE PROCEDURE plt_sincronizar_supl_oral ( cd_estabelecimento_p bigint, cd_setor_usuario_p bigint, cd_perfil_p bigint, nm_usuario_p text, nr_atendimento_p bigint, dt_validade_limite_p timestamp, ie_agrupar_acm_sn_p text, dt_horario_p timestamp, nr_horario_p integer, ie_prescr_usuario_p text) AS $body$
DECLARE
...
SELECT	a.nr_prescricao, 
	c.nr_seq_material, 
	c.nr_sequencia, 
	SUBSTR(plt_obter_status_hor_supl_lib(c.dt_fim_horario,c.dt_suspensao,c.dt_lib_horario),1,1),	 
	c.cd_material, 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE plt_sincronizar_supl_oral ( cd_estabelecimento_p bigint, cd_setor_usuario_p bigint, cd_perfil_p bigint, nm_usuario_p text, nr_atendimento_p bigint, dt_validade_limite_p timestamp, ie_agrupar_acm_sn_p text, dt_horario_p timestamp, nr_horario_p integer, ie_prescr_usuario_p text) FROM PUBLIC;
