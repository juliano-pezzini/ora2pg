...
CREATE OR REPLACE PROCEDURE registrar_amostra_inad_item ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_motivo_inadeq_p bigint, nr_seq_tipo_ocorr_p bigint, ds_motivo_p text, ie_suspender_item_p text, nr_seq_status_p bigint, nm_usuario_p text, nr_seq_ocorrencia_p INOUT bigint) AS $body$
DECLARE
...
select	nr_sequencia,
		nr_seq_exame,
		cd_material_exame
into STRICT	nr_seq_proc_prescr_w,
		nr_seq_exame_w,
		cd_material_exame_w
...
where	nr_prescricao = nr_prescricao_p
and (nr_sequencia = nr_seq_prescr_p) or (coalesce(nr_seq_prescr_p,0) = 0);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE registrar_amostra_inad_item ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nr_seq_motivo_inadeq_p bigint, nr_seq_tipo_ocorr_p bigint, ds_motivo_p text, ie_suspender_item_p text, nr_seq_status_p bigint, nm_usuario_p text, nr_seq_ocorrencia_p INOUT bigint) FROM PUBLIC;
