...
CREATE OR REPLACE PROCEDURE importa_extrato_santander_200 ( nr_seq_extrato_p bigint) AS $body$
DECLARE
...
SELECT	substr(ds_conteudo,75,6) nr_documento,
	...
	substr(ds_conteudo,34,8) nr_conta,
...
EXIT WHEN NOT FOUND; /* apply on c01 */
	...
	if (nr_conta_ant_w	= '-1') or (nr_conta_ant_w <> nr_conta_w) then
		...
		where	substr(ds_conteudo,59,12)	= nr_conta_w
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE importa_extrato_santander_200 ( nr_seq_extrato_p bigint) FROM PUBLIC;
