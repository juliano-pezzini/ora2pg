...
CREATE OR REPLACE PROCEDURE ptu_importar_arq_a700_v120 ( ds_conteudo_p text, nm_arquivo_p text, cd_estabelecimento_p bigint, nm_usuario_p text, ie_versao_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_importar_arq_a700_v120 ( ds_conteudo_p text, nm_arquivo_p text, cd_estabelecimento_p bigint, nm_usuario_p text, ie_versao_p INOUT text) FROM PUBLIC;
