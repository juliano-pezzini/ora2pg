...
CREATE OR REPLACE PROCEDURE concluir_atendimentos_ul (nm_usuario_p text) AS $body$
DECLARE
	...
	begin
		...
		insert	into	pls_atendimento_historico(	nr_sequencia, nr_seq_atendimento, ds_historico_long,
			...
			values (	nextval('pls_atendimento_historico_seq'), r_C01_w.nr_sequencia,
					'O atendimento foi finalizado através do script solicitado na OS 1513379/98451, pelo usuário' ||
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE concluir_atendimentos_ul (nm_usuario_p text) FROM PUBLIC;
