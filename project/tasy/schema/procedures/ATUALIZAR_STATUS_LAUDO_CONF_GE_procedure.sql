...
CREATE OR REPLACE PROCEDURE atualizar_status_laudo_conf_ge ( nr_sequencia_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE atualizar_status_laudo_conf_ge ( nr_sequencia_p text, nm_usuario_p text) FROM PUBLIC;
