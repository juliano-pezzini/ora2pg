...
CREATE OR REPLACE PROCEDURE gerar_menu_cron_migr_dic_obj4 ( cd_funcao_p bigint, nr_seq_menu_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
and	a.nr_sequencia = coalesce(nr_seq_menu_p,a.nr_sequencia)
group by
	a.nm_objeto,
	a.nr_sequencia
order by
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_menu_cron_migr_dic_obj4 ( cd_funcao_p bigint, nr_seq_menu_p bigint, nm_usuario_p text) FROM PUBLIC;
