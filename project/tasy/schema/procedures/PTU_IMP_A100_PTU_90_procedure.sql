...
CREATE OR REPLACE PROCEDURE ptu_imp_a100_ptu_90 ( ds_conteudo_p text, nm_arquivo_p text, ie_tipo_contrato_p text, nm_usuario_p text) AS $body$
DECLARE
...
if (cd_tipo_registro_w	= '101') then
	...
	*/
	...
	if (ie_tipo_contrato_w = 'F') then --Tratamento para Fundações
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_imp_a100_ptu_90 ( ds_conteudo_p text, nm_arquivo_p text, ie_tipo_contrato_p text, nm_usuario_p text) FROM PUBLIC;
