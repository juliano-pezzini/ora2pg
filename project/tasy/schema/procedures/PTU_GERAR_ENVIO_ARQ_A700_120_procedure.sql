...
CREATE OR REPLACE PROCEDURE ptu_gerar_envio_arq_a700_120 (nr_seq_servico_p bigint, cd_estabelecimento_p text, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C00 */
	...
	EXIT WHEN NOT FOUND; /* apply on C01 */
		...
		ds_conteudo_w	:=	lpad(to_char(nr_seq_registro_w),8,'0') || '702' || nr_lote_w || lpad(' ',12,' ') || cd_unimed_destino_w || '   ' ||
					...
					id_rec_proprio_w || cd_cid_obito_cobr_w;
		ds_arquivo_w	:=	ds_arquivo_w || ds_conteudo_w;
		...
		EXIT WHEN NOT FOUND; /* apply on C03 */
			...
			ds_conteudo_w	:=	lpad(to_char(nr_seq_registro_w),8,'0') || '704' || nr_lote_704_w || lpad(' ',11,' ') ||
						...
						ie_tipo_tabela_w || lpad(' ',8,' ') || qt_procedimento_w || vl_procedimento_w || vl_custo_operacional_w ||
						...
						nm_profissional_prestador_w || cd_procedimento_w;
			ds_arquivo_w	:=	ds_arquivo_w || ds_conteudo_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_envio_arq_a700_120 (nr_seq_servico_p bigint, cd_estabelecimento_p text, nm_usuario_p text) FROM PUBLIC;
