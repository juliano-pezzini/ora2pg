...
CREATE OR REPLACE PROCEDURE gerar_movto_esto_receb_dankia ( nr_requisicao_p bigint, nr_sequencia_p bigint, ie_tipo_recebimento_p text, qt_material_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
CALL gravar_log_tasy(48787, '1 qt_material_req_w=' || qt_material_req_w || ' :new.ie_tipo_requisicao_w=' || ie_tipo_requisicao_w || ' nr_requisicao_p=' || nr_requisicao_p ||
' nr_sequencia_p=' || nr_sequencia_p || ' :new.nm_usuario_p=' || nm_usuario_p,'dankia_estoq');
...
CALL gravar_log_tasy(48787, ' qt_material_atendida_w=' || qt_material_atendida_w || ' qt_mat_recebida_w=' || qt_mat_recebida_w || ' :new.ie_tipo_requisicao_w=' || ie_tipo_requisicao_w || ' nr_requisicao_p=' || nr_requisicao_p ||
' nr_sequencia_p=' || nr_sequencia_p || ' :new.nm_usuario_p=' || nm_usuario_p,'dankia_estoq');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_movto_esto_receb_dankia ( nr_requisicao_p bigint, nr_sequencia_p bigint, ie_tipo_recebimento_p text, qt_material_p bigint, nm_usuario_p text) FROM PUBLIC;
