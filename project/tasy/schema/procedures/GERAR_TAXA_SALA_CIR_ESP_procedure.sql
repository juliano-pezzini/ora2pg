...
CREATE OR REPLACE PROCEDURE gerar_taxa_sala_cir_esp ( nr_sequencia_p bigint, nm_usuario_p text, ie_regra_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_taxa_sala_cir_esp ( nr_sequencia_p bigint, nm_usuario_p text, ie_regra_p INOUT text) FROM PUBLIC;
