...
CREATE OR REPLACE PROCEDURE gerar_evento_transf_agenda ( nr_seq_evento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text, nr_seq_laudo_p bigint, nm_usuario_p text, cd_agenda_p bigint, hr_inicio_p timestamp, cd_medico_p text, cd_procedimento_p bigint, ie_origem_proced_p bigint, dt_cancelamento_p timestamp, dt_transferencia_p timestamp, cd_agenda_destino_p bigint, ds_observacao_p text, ie_trigger_p text default 'S') AS $body$
DECLARE
...
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w, '@dtinicioagenda', to_char(hr_inicio_p,'dd/mm/yyyy hh24:mi:ss')),1,4000);
...
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w, '@dtcancelagenda', to_char(dt_cancelamento_p,'dd/mm/yyyy hh24:mi:ss')),1,4000);
...
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w, '@dt_transferencia', to_char(dt_transferencia_p,'dd/mm/yyyy hh24:mi:ss')),1,4000);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_transf_agenda ( nr_seq_evento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text, nr_seq_laudo_p bigint, nm_usuario_p text, cd_agenda_p bigint, hr_inicio_p timestamp, cd_medico_p text, cd_procedimento_p bigint, ie_origem_proced_p bigint, dt_cancelamento_p timestamp, dt_transferencia_p timestamp, cd_agenda_destino_p bigint, ds_observacao_p text, ie_trigger_p text default 'S') FROM PUBLIC;
