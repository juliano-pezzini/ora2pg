...
CREATE OR REPLACE PROCEDURE gerar_evento_medico_infecto ( nr_seq_evento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text, nr_prescricao_p bigint, nm_usuario_p text, nr_seq_unidade_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	if (ie_pessoa_destino_w = '9') then /* Médico solicitante da prescrição */
 
		/* pegar o medico solicitante da prescricao*/
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_medico_infecto ( nr_seq_evento_p bigint, nr_atendimento_p bigint, cd_pessoa_fisica_p text, nr_prescricao_p bigint, nm_usuario_p text, nr_seq_unidade_p text) FROM PUBLIC;
