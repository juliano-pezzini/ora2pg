...
CREATE OR REPLACE PROCEDURE gerar_retorno_safra_400 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
	SELECT	trim(both substr(ds_string,63,9)),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_retorno_safra_400 ( nr_seq_cobr_escrit_p bigint, nm_usuario_p text) FROM PUBLIC;
