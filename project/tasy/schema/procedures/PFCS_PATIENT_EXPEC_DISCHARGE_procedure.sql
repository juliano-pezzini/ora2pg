...
CREATE OR REPLACE PROCEDURE pfcs_patient_expec_discharge ( nr_seq_indicator_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
where a.nr_atendimento	= b.nr_atendimento
    ...
    and	trunc(a.dt_previsto_alta) = trunc(clock_timestamp())
...
where ser.cd_service = 'E0405'
    ...
    and	trunc(coalesce(ser.dt_authored_on, ser.dt_atualizacao)) = trunc(clock_timestamp())
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pfcs_patient_expec_discharge ( nr_seq_indicator_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
