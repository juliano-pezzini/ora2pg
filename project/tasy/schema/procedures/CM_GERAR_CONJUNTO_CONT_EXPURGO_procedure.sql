...
CREATE OR REPLACE PROCEDURE cm_gerar_conjunto_cont_expurgo ( nr_seq_conjunto_p bigint, nr_seq_ciclo_p bigint, nr_seq_lote_p bigint, nr_expurgo_retirada_p bigint, nr_expurgo_receb_p bigint, cd_setor_atendimento_p bigint, nm_usuario_barras_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE cm_gerar_conjunto_cont_expurgo ( nr_seq_conjunto_p bigint, nr_seq_ciclo_p bigint, nr_seq_lote_p bigint, nr_expurgo_retirada_p bigint, nr_expurgo_receb_p bigint, cd_setor_atendimento_p bigint, nm_usuario_barras_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
