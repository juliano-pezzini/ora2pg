...
CREATE OR REPLACE PROCEDURE pls_gerar_ocorr_glosa_aud_req ( nr_seq_auditoria_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_ocorr_glosa_aud_req ( nr_seq_auditoria_p bigint, nm_usuario_p text) FROM PUBLIC;
