...
CREATE OR REPLACE PROCEDURE baca_dt_vig_pls_prestador_tipo () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_pls_prestador_tipo () FROM PUBLIC;
