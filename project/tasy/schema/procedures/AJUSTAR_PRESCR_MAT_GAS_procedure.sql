...
CREATE OR REPLACE PROCEDURE ajustar_prescr_mat_gas ( nr_prescricao_p bigint, nr_sequencia_p bigint, cd_perfil_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ajustar_prescr_mat_gas ( nr_prescricao_p bigint, nr_sequencia_p bigint, cd_perfil_p bigint, nm_usuario_p text) FROM PUBLIC;
