...
CREATE OR REPLACE PROCEDURE baca_dt_vig_regra_pos_estab () AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_regra_pos_estab () FROM PUBLIC;
