...
CREATE OR REPLACE PROCEDURE fin_gerar_oc_repasse_titulo ( nr_seq_nf_p bigint, nr_seq_titulo_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	EXIT WHEN NOT FOUND; /* apply on C02 */
		...
		vl_repasse_w := round((vl_repasse_w / qt_parcelas_w)::numeric,2);
	...
	into STRICT	nr_seq_item_venc_w 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE fin_gerar_oc_repasse_titulo ( nr_seq_nf_p bigint, nr_seq_titulo_p bigint, nm_usuario_p text) FROM PUBLIC;
