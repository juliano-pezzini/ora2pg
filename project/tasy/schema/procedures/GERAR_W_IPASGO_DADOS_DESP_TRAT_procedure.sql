...
CREATE OR REPLACE PROCEDURE gerar_w_ipasgo_dados_desp_trat ( nr_interno_conta_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text, nr_seq_tipo_fatura_p bigint, qt_linha_arq_p INOUT bigint, qt_linha_atend_p INOUT bigint) AS $body$
DECLARE
...
SELECT	b.cd_procedimento,
	...
	sum(CASE WHEN coalesce(b.ie_valor_informado,'N')='N' THEN  CASE WHEN coalesce((b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDT', b.nr_sequencia)),0)=0 THEN			coalesce(b.vl_procedimento,0)  ELSE coalesce((b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDT', b.nr_sequencia)),0) END   ELSE CASE WHEN b.ie_responsavel_credito='M' THEN  coalesce(b.vl_custo_operacional, 0)  ELSE coalesce(b.vl_procedimento, 0) END  END ) vl,
...
SELECT	b.cd_procedimento,
	b.ie_origem_proced,
	sum(b.qt_procedimento) qt_procedimento,
	sum(CASE WHEN coalesce((b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDT', b.nr_sequencia)),0)=0 THEN 		coalesce(b.vl_procedimento,0)  ELSE coalesce((b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDT', b.nr_sequencia)),0) END ) vl,
	min(b.dt_procedimento) dt_procedimento,
	b.cd_cgc_prestador,
	b.nr_seq_proc_interno,
	coalesce(b.nr_ato_ipasgo,0) nr_ato_ipasgo
...
select	999999,
	...
	sum(coalesce(coalesce(ipasgo_obter_valor_conta(b.nr_interno_conta,0),
		(b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'F', b.nr_sequencia))),0)) vl,
	min(b.dt_procedimento) dt_procedimento,
	b.cd_cgc_prestador,
	b.nr_seq_proc_interno,
	coalesce(b.nr_ato_ipasgo,0) nr_ato_ipasgo
...
--- Comando abaixo nao agrupam , demonstram pela data
select	b.cd_procedimento,
	b.ie_origem_proced,
	sum(b.qt_procedimento) qt_procedimento,
	sum(CASE WHEN coalesce((b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDT', b.nr_sequencia)),0)=0 THEN 		coalesce(b.vl_procedimento,0)  ELSE coalesce((b.qt_procedimento * Obter_preco_proc_ipasgo_atend(b.nr_atendimento,b.dt_conta,b.cd_procedimento,b.ie_origem_proced,b.nr_seq_proc_interno,b.ie_responsavel_credito,'IPDT', b.nr_sequencia)),0) END ) vl,
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	/*Buscar as conversoes de procedimento*/
	...
	if (coalesce(nr_seq_proc_interno_w,0) > 0) then
		/*Buscar as conversoes meio externo - proc interno*/
	...
	if (nr_ato_ipasgo_w > 0) then
		...
		if (qt_ato_w > qt_ato_ww) then --Apenas zera a sequencia, se o ato do item anterior for menor que o ato do item atual.
			begin
			qt_ato_ww := qt_ato_w;
			nr_seq_proc_w := 0;
			end;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_w_ipasgo_dados_desp_trat ( nr_interno_conta_p bigint, dt_mesano_referencia_p timestamp, nm_usuario_p text, nr_seq_tipo_fatura_p bigint, qt_linha_arq_p INOUT bigint, qt_linha_atend_p INOUT bigint) FROM PUBLIC;
