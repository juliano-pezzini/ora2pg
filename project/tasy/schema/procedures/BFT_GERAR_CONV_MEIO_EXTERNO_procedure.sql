...
CREATE OR REPLACE PROCEDURE bft_gerar_conv_meio_externo ( cd_cgc_p text, nm_tabela_p text, nm_atributo_p text, cd_interno_p text, cd_externo_p text, ie_sistema_externo_p text, ie_envio_receb_p text, nm_usuario_p text) AS $body$
DECLARE
...
conversao_meio_externo_w.nr_seq_regra			:=	null;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE bft_gerar_conv_meio_externo ( cd_cgc_p text, nm_tabela_p text, nm_atributo_p text, cd_interno_p text, cd_externo_p text, ie_sistema_externo_p text, ie_envio_receb_p text, nm_usuario_p text) FROM PUBLIC;
