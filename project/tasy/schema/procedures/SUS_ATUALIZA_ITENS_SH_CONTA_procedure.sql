...
CREATE OR REPLACE PROCEDURE sus_atualiza_itens_sh_conta ( nr_interno_conta_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE sus_atualiza_itens_sh_conta ( nr_interno_conta_p bigint, nm_usuario_p text) FROM PUBLIC;
