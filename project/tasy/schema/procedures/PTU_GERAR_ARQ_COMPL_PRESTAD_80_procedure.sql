...
CREATE OR REPLACE PROCEDURE ptu_gerar_arq_compl_prestad_80 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text) AS $body$
DECLARE

 
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
Finalidade: Gerar arquivo A450 de acordo com a versão PTU 8.0 
------------------------------------------------------------------------------------------------------------------- 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_arq_compl_prestad_80 (nr_seq_lote_p bigint, cd_interface_p text, nm_usuario_p text) FROM PUBLIC;
