...
CREATE OR REPLACE PROCEDURE ptu_gerar_ped_insistencia_v40 ( nr_seq_requisicao_p bigint, nr_seq_guia_p bigint, nr_seq_complemento_p bigint, ds_menssagem_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_execucao_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_ped_insistencia_v40 ( nr_seq_requisicao_p bigint, nr_seq_guia_p bigint, nr_seq_complemento_p bigint, ds_menssagem_p text, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_execucao_p INOUT bigint) FROM PUBLIC;
