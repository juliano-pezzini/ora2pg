...
CREATE OR REPLACE PROCEDURE pls_atualizar_totalizador_pel ( nm_usuario_p text, nr_seq_superior_p bigint, nr_seq_periodo_p bigint) AS $body$
DECLARE


vl_mes_n_w			diops_movto_pel.vl_mes_n%type;
vl_mes_n1_w			diops_movto_pel.vl_mes_n1%type;
vl_mes_n2_w			diops_movto_pel.vl_mes_n2%type;
vl_mes_n3_w			diops_movto_pel.vl_mes_n3%type;
vl_mes_n4_w			diops_movto_pel.vl_mes_n4%type;
vl_mes_n5_w			diops_movto_pel.vl_mes_n5%type;
vl_mes_n6_w                     diops_movto_pel.vl_mes_n6%type;
vl_mes_n7_w                     diops_movto_pel.vl_mes_n7%type;
vl_mes_n8_w                     diops_movto_pel.vl_mes_n8%type;
vl_mes_n9_w                     diops_movto_pel.vl_mes_n9%type;
vl_mes_n10_w                    diops_movto_pel.vl_mes_n10%type;
vl_mes_n11_w                    diops_movto_pel.vl_mes_n11%type;
vl_mes_n12_w                    diops_movto_pel.vl_mes_n12%type;
vl_mes_n13_w                    diops_movto_pel.vl_mes_n13%type;
vl_mes_n14_w                    diops_movto_pel.vl_mes_n14%type;
vl_mes_n15_w                    diops_movto_pel.vl_mes_n15%type;
vl_mes_n16_w                    diops_movto_pel.vl_mes_n16%type;
vl_mes_n17_w                    diops_movto_pel.vl_mes_n17%type;
vl_mes_n18_w                    diops_movto_pel.vl_mes_n18%type;
vl_mes_n19_w                    diops_movto_pel.vl_mes_n19%type;
vl_mes_n20_w                    diops_movto_pel.vl_mes_n20%type;
vl_mes_n21_w			diops_movto_pel.vl_mes_n21%type;
vl_mes_n22_w			diops_movto_pel.vl_mes_n22%type;
vl_mes_n23_w			diops_movto_pel.vl_mes_n23%type;
vl_mes_n24_w			diops_movto_pel.vl_mes_n24%type;
vl_mes_n25_w			diops_movto_pel.vl_mes_n25%type;
vl_mes_n26_w			diops_movto_pel.vl_mes_n26%type;
vl_mes_n27_w			diops_movto_pel.vl_mes_n27%type;
vl_mes_n28_w			diops_movto_pel.vl_mes_n28%type;
vl_mes_n29_w			diops_movto_pel.vl_mes_n29%type;
vl_mes_n30_w			diops_movto_pel.vl_mes_n30%type;
vl_mes_n31_w			diops_movto_pel.vl_mes_n31%type;
vl_mes_n32_w			diops_movto_pel.vl_mes_n32%type;
vl_mes_n33_w			diops_movto_pel.vl_mes_n33%type;
vl_mes_n34_w			diops_movto_pel.vl_mes_n34%type;
vl_mes_n35_w			diops_movto_pel.vl_mes_n35%type;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_atualizar_totalizador_pel ( nm_usuario_p text, nr_seq_superior_p bigint, nr_seq_periodo_p bigint) FROM PUBLIC;
