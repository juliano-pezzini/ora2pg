...
CREATE OR REPLACE PROCEDURE liberar_horario_reserv_ag_serv (nr_seq_agenda_p bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE liberar_horario_reserv_ag_serv (nr_seq_agenda_p bigint) FROM PUBLIC;
