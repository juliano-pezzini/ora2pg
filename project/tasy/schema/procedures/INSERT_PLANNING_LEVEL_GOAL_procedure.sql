...
CREATE OR REPLACE PROCEDURE insert_planning_level_goal ( nr_sequencia_p bigint, nr_seq_measure_goal_p bigint, dt_evaluation_goal_p timestamp ) AS $body$
DECLARE
    ...
    nr_seq_ind_pla_w		patient_cp_indic_measure.nr_sequencia%type;
...
;
      ...
      INSERT into PATIENT_CP_INDIC_PLAN(
		...
		set	  	nr_seq_plan_indic = nr_seq_ind_pla_w
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE insert_planning_level_goal ( nr_sequencia_p bigint, nr_seq_measure_goal_p bigint, dt_evaluation_goal_p timestamp ) FROM PUBLIC;
