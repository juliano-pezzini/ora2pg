...
CREATE OR REPLACE PROCEDURE dispens_farm_gerar_inventario (cd_material_p bigint, qt_contagem_p bigint, nm_usuario_p text, ds_erro_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE dispens_farm_gerar_inventario (cd_material_p bigint, qt_contagem_p bigint, nm_usuario_p text, ds_erro_p INOUT text) FROM PUBLIC;
