...
CREATE OR REPLACE PROCEDURE lab_gerar_etiq_prescr_mat_item (nr_prescricao_p bigint, nr_seq_prescr_p text, qt_exames_p bigint, ie_opcao_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
c01 CURSOR FOR
	...
	WHERE	a.nr_seq_exame = b.nr_seq_exame
	  ...
	  AND	c.cd_material_exame = Obter_Mat_Exame_Lab_prescr(a.nr_prescricao,a.nr_sequencia,1)
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lab_gerar_etiq_prescr_mat_item (nr_prescricao_p bigint, nr_seq_prescr_p text, qt_exames_p bigint, ie_opcao_p bigint, nm_usuario_p text) FROM PUBLIC;
