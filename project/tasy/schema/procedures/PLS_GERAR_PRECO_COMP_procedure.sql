...
CREATE OR REPLACE PROCEDURE pls_gerar_preco_comp ( cd_estabelecimento_p bigint, nr_seq_prestador_p bigint, nr_seq_material_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, ie_tipo_item_p bigint, nm_usuario_p text, nr_seq_categoria_p bigint, nr_seq_tipo_acomodacao_p bigint, nr_seq_tipo_atendimento_p bigint, nr_seq_clinica_p bigint, ie_todos_prestadores_p text, cd_convenio_p bigint, cd_categoria_p text, ie_tipo_contratacao_p text, nr_seq_outorgante_p bigint, ie_tipo_class_prest_p bigint, nr_seq_plano_p bigint, nr_seq_item_p bigint, qt_item_p bigint, ie_regime_atendimento_p pls_conta.ie_regime_atendimento%type default null, ie_saude_ocupacional_p pls_conta.ie_saude_ocupacional%type default null) AS $body$
DECLARE
...
C00 CURSOR FOR
	SELECT	nr_sequencia
	from	pls_prestador
	where	((nr_sequencia = nr_seq_prestador_p) or (coalesce(nr_seq_prestador_p::text, '') = '') or (ie_todos_prestadores_p = 'S'))
	and	cd_estabelecimento = cd_estabelecimento_p
	and	ie_tipo_relacao <> 'F'
...
EXIT WHEN NOT FOUND; /* apply on C00 */
	...
	if (ie_tipo_item_p = 1) then
		...
		if (ie_tipo_despesa_w = '1') then
			...
			EXIT WHEN NOT FOUND; /* apply on C01 */
				...
				dados_regra_preco_proc_w := pls_define_preco_proc(cd_estabelecimento_p, nr_seq_prestador_w, nr_seq_categoria_w, clock_timestamp(), null, cd_procedimento_p, ie_origem_w, nr_seq_tipo_acomodacao_p, nr_seq_tipo_atendimento_p, nr_seq_clinica_p, nr_seq_plano_p, ie_tipo_conta_w, 0, nr_seq_outorgante_p, null, 'N', cd_convenio_p, cd_categoria_p, ie_tipo_contratacao_p, '', '', '', '', ie_tipo_class_prest_p, '', 'S', '', '', 'A', 'X', null, null, dt_procedimento_w, null, null, null, null, null, dados_regra_preco_proc_w, null, null, ie_regime_atendimento_p, null, ie_saude_ocupacional_p);
					...
					if (nr_seq_regra_w	> 0) then
						...
						set	vl_procedimento_regra = (vl_procedimento_w * qt_item_p)
			...
			dados_regra_preco_servico_w := pls_define_preco_servico(cd_estabelecimento_p, nr_seq_prestador_w, clock_timestamp(), cd_procedimento_p, ie_origem_w, ie_tipo_conta_w, null, 'N', ie_tipo_contratacao_p, null, '', '', '', 0, nr_seq_classificacao_w, nr_seq_categoria_w, 'N', ie_tipo_vinculo_w, '', '', null, null, null, null, nr_seq_clinica_p, nr_seq_tipo_atendimento_p, nr_seq_tipo_acomodacao_p, null, null, dados_regra_preco_servico_w, null, null, ie_regime_atendimento_p, ie_saude_ocupacional_p);
		...
		EXIT WHEN NOT FOUND; /* apply on c03 */
			...
			SELECT * FROM pls_define_preco_material(cd_estabelecimento_p, nr_seq_prestador_w, clock_timestamp(), nr_seq_material_p, ie_tipo_tabela_w, ie_tipo_despesa_w, ie_origem_w, ie_tipo_conta_w, nr_seq_outorgante_p, '', '', '', '', '', '', '', '', '', '', 'S', nm_usuario_p, '', '', null, null, nr_seq_tipo_prestador_w, null, nr_seq_estrut_mat_w, null, null, null, null, null, null, nr_seq_classificacao_prest_w, sg_estado_outorg_w, null, null, vl_material_w, dt_ult_vigencia_w, nr_seq_material_preco_w, vl_material_simpro_w, vl_material_brasindice_w, vl_material_tabela_w, dados_regra_preco_material_w) INTO STRICT _ora2pg_r;
 vl_material_w := _ora2pg_r.vl_material_p; dt_ult_vigencia_w := _ora2pg_r.dt_ult_vigencia_p; nr_seq_material_preco_w := _ora2pg_r.nr_seq_material_preco_p; vl_material_simpro_w := _ora2pg_r.vl_material_simpro_p; vl_material_brasindice_w := _ora2pg_r.vl_material_brasindice_p; vl_material_tabela_w := _ora2pg_r.vl_material_tabela_p; dados_regra_preco_material_w := _ora2pg_r.dados_regra_preco_material_p;
			...
			if (nr_seq_regra_w		> 0) and (vl_material_w		> 0) then
				update	pls_pacote_material
				set	vl_material_regra = (vl_material_w * qt_item_p)
				where	nr_sequencia	= nr_seq_item_p;
			end if;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_preco_comp ( cd_estabelecimento_p bigint, nr_seq_prestador_p bigint, nr_seq_material_p bigint, cd_procedimento_p bigint, ie_origem_proced_p bigint, ie_tipo_item_p bigint, nm_usuario_p text, nr_seq_categoria_p bigint, nr_seq_tipo_acomodacao_p bigint, nr_seq_tipo_atendimento_p bigint, nr_seq_clinica_p bigint, ie_todos_prestadores_p text, cd_convenio_p bigint, cd_categoria_p text, ie_tipo_contratacao_p text, nr_seq_outorgante_p bigint, ie_tipo_class_prest_p bigint, nr_seq_plano_p bigint, nr_seq_item_p bigint, qt_item_p bigint, ie_regime_atendimento_p pls_conta.ie_regime_atendimento%type default null, ie_saude_ocupacional_p pls_conta.ie_saude_ocupacional%type default null) FROM PUBLIC;
