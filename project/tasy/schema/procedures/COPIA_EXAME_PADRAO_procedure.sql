...
CREATE OR REPLACE PROCEDURE copia_exame_padrao ( cd_medico_origem_p text, cd_medico_destino_p text, nr_seq_grupo_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE copia_exame_padrao ( cd_medico_origem_p text, cd_medico_destino_p text, nr_seq_grupo_p bigint, nm_usuario_p text) FROM PUBLIC;
