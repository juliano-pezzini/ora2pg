...
CREATE OR REPLACE PROCEDURE verif_dose_max_atend_int (nr_seq_atendimento_p bigint, nr_sequencia_p bigint, ie_utiliza_horarios_p text, ds_erro_p INOUT text, ds_erro2_p INOUT text, ie_forma_consistencia_p INOUT text, ds_mensagem_p INOUT text, cd_material_p bigint default null, cd_unid_med_prescr_p text default null, qt_dose_prescricao_p bigint default null, ie_via_aplicacao_p text default null, ds_observacao_p text default null, is_paciente_medic_update text default 'N', nr_seq_material_p bigint default null, qt_dose_p bigint default null, cd_unid_med_dose_p text default null) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE verif_dose_max_atend_int (nr_seq_atendimento_p bigint, nr_sequencia_p bigint, ie_utiliza_horarios_p text, ds_erro_p INOUT text, ds_erro2_p INOUT text, ie_forma_consistencia_p INOUT text, ds_mensagem_p INOUT text, cd_material_p bigint default null, cd_unid_med_prescr_p text default null, qt_dose_prescricao_p bigint default null, ie_via_aplicacao_p text default null, ds_observacao_p text default null, is_paciente_medic_update text default 'N', nr_seq_material_p bigint default null, qt_dose_p bigint default null, cd_unid_med_dose_p text default null) FROM PUBLIC;
