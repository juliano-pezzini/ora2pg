...
CREATE OR REPLACE PROCEDURE execute_grobal_angular ( nm_acao_p text, cd_funcao_p bigint, nm_usuario_p text, nr_seq_obj_script_p INOUT bigint, nr_seq_obj_proc_func_p INOUT bigint, nr_sequencia_p INOUT bigint ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE execute_grobal_angular ( nm_acao_p text, cd_funcao_p bigint, nm_usuario_p text, nr_seq_obj_script_p INOUT bigint, nr_seq_obj_proc_func_p INOUT bigint, nr_sequencia_p INOUT bigint ) FROM PUBLIC;
