...
CREATE OR REPLACE PROCEDURE excluir_conv_regra_uso ( nr_sequencia_p bigint, cd_convenio_orig_p bigint, cd_convenio_dest_p text, ie_convenio_p text, ie_tabela_p text, ie_excluir_estrutura_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE excluir_conv_regra_uso ( nr_sequencia_p bigint, cd_convenio_orig_p bigint, cd_convenio_dest_p text, ie_convenio_p text, ie_tabela_p text, ie_excluir_estrutura_p text, nm_usuario_p text) FROM PUBLIC;
