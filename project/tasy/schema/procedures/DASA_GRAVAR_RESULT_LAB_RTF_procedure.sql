...
CREATE OR REPLACE PROCEDURE dasa_gravar_result_lab_rtf ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nm_usuario_p text, ds_resultado_p text, nr_sequencia_p INOUT bigint, cd_erro_p INOUT bigint, ds_erro_p INOUT text, ie_final_p text default 'S', cd_exame_integracao_p text default null, ie_atualizar_rtf_p text default 'N') AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE dasa_gravar_result_lab_rtf ( nr_prescricao_p bigint, nr_seq_prescr_p bigint, nm_usuario_p text, ds_resultado_p text, nr_sequencia_p INOUT bigint, cd_erro_p INOUT bigint, ds_erro_p INOUT text, ie_final_p text default 'S', cd_exame_integracao_p text default null, ie_atualizar_rtf_p text default 'N') FROM PUBLIC;
