...
CREATE OR REPLACE PROCEDURE ptu_gerar_confirmacao_v60 ( nr_seq_execucao_p bigint, cd_estabelecimento_p bigint, ie_tipo_resposta_p text, nr_versao_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ptu_gerar_confirmacao_v60 ( nr_seq_execucao_p bigint, cd_estabelecimento_p bigint, ie_tipo_resposta_p text, nr_versao_p text, nm_usuario_p text) FROM PUBLIC;
