...
CREATE OR REPLACE PROCEDURE ageint_consiste_sugest_exproc ( cd_agenda_p bigint, hr_Agenda_p timestamp, nr_minuto_duracao_p bigint, nr_Seq_ageint_p bigint, nr_seq_ageint_item_p bigint, nm_usuario_p text, ds_retorno_p INOUT text, nr_min_regra_p INOUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ageint_consiste_sugest_exproc ( cd_agenda_p bigint, hr_Agenda_p timestamp, nr_minuto_duracao_p bigint, nr_Seq_ageint_p bigint, nr_seq_ageint_item_p bigint, nm_usuario_p text, ds_retorno_p INOUT text, nr_min_regra_p INOUT bigint) FROM PUBLIC;
