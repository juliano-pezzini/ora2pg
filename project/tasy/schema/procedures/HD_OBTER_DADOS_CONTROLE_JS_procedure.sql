...
CREATE OR REPLACE PROCEDURE hd_obter_dados_controle_js ( nr_seq_dialise_p bigint, qt_tempo_controle_p bigint, qt_fluxo_sangue_p INOUT bigint, qt_fluxo_dialisado_p INOUT bigint, qt_pa_arterial_p INOUT bigint, qt_heparina_p INOUT bigint, qt_sangue_dial_p INOUT bigint, ie_clearence_p INOUT text, ie_kvt_p INOUT text, nm_paciente_p INOUT text, hr_controle_p INOUT text, ie_tipo_dialise_p INOUT text, hr_dialise_retro_p INOUT text) AS $body$
DECLARE
...
hr_dialise_retro_p := TO_CHAR(TO_DATE(hd_obter_dt_dialise_retro(nr_seq_dialise_p),'dd/mm/yyyy hh24:mi:ss'),'hh24:mi:ss');
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hd_obter_dados_controle_js ( nr_seq_dialise_p bigint, qt_tempo_controle_p bigint, qt_fluxo_sangue_p INOUT bigint, qt_fluxo_dialisado_p INOUT bigint, qt_pa_arterial_p INOUT bigint, qt_heparina_p INOUT bigint, qt_sangue_dial_p INOUT bigint, ie_clearence_p INOUT text, ie_kvt_p INOUT text, nm_paciente_p INOUT text, hr_controle_p INOUT text, ie_tipo_dialise_p INOUT text, hr_dialise_retro_p INOUT text) FROM PUBLIC;
