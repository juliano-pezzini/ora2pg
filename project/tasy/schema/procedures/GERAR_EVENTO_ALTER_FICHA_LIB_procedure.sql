...
CREATE OR REPLACE PROCEDURE gerar_evento_alter_ficha_lib ( nr_seq_evento_p bigint, nr_lote_p bigint, nr_seq_ficha_p bigint, nm_usuario_p text, nr_prescricao_p bigint, cd_pessoa_fisica_p text) AS $body$
DECLARE
...
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@ficha',nr_seq_ficha_p),1,4000);
...
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@lote',nr_lote_p),1,4000);
 
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@atendimento',nr_atendimento_w),1,4000);
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@ficha',nr_seq_ficha_p),1,4000);
...
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@lote',nr_lote_p),1,4000);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_evento_alter_ficha_lib ( nr_seq_evento_p bigint, nr_lote_p bigint, nr_seq_ficha_p bigint, nm_usuario_p text, nr_prescricao_p bigint, cd_pessoa_fisica_p text) FROM PUBLIC;
