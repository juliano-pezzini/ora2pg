...
CREATE OR REPLACE PROCEDURE gerar_cobr_msg_itau_400_reg ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_grupo_inst_p bigint) AS $body$
DECLARE
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	exceção da carteira 115 cuja faixa de Nosso Número é de livre utilização pelo beneficiário; */
	if (nr_carteira_w <> '115') then /*Se carteira diferente de 115, vai zerado pro Banco.*/
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_cobr_msg_itau_400_reg ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text, nr_seq_grupo_inst_p bigint) FROM PUBLIC;
