...
CREATE OR REPLACE PROCEDURE baca_dt_vig_pls_prest_crit_rec () AS $body$
DECLARE
...
loop 
	...
	forall	i in tb_nr_sequencia_w.first..tb_nr_sequencia_w.last 
		update	pls_prestador_crit_receb 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE baca_dt_vig_pls_prest_crit_rec () FROM PUBLIC;
