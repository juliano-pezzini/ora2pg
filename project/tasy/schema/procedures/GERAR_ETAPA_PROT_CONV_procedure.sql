...
CREATE OR REPLACE PROCEDURE gerar_etapa_prot_conv ( nr_seq_protocolo_p bigint, ie_evento_p text, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_etapa_prot_conv ( nr_seq_protocolo_p bigint, ie_evento_p text, nm_usuario_p text) FROM PUBLIC;
