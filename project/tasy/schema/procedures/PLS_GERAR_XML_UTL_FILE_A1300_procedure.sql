...
CREATE OR REPLACE PROCEDURE pls_gerar_xml_utl_file_a1300 ( nr_seq_projeto_p bigint, ds_parametros_p text, nm_arquivo_p text) AS $body$
DECLARE
...
SELECT * FROM obter_evento_utl_file(9, null, ds_local_w, ds_erro_w) INTO STRICT ds_local_w, ds_erro_w;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_gerar_xml_utl_file_a1300 ( nr_seq_projeto_p bigint, ds_parametros_p text, nm_arquivo_p text) FROM PUBLIC;
