...
from reg_operacoes_terc_w;

insert into reg_operacoes_terc_w(	nr_sequencia,
									nm_terceiro, 
									ds_mat_proc, 
									cd_material_barras, 
									cd_procedimento,
