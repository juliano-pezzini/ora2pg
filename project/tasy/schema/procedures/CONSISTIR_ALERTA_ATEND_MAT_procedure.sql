...
CREATE OR REPLACE PROCEDURE consistir_alerta_atend_mat ( nr_prescricao_p bigint, cd_material_p bigint, ds_mensagem_p INOUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE consistir_alerta_atend_mat ( nr_prescricao_p bigint, cd_material_p bigint, ds_mensagem_p INOUT text) FROM PUBLIC;
