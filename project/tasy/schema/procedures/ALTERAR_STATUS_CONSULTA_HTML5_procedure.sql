...
CREATE OR REPLACE PROCEDURE alterar_status_consulta_html5 ( nr_sequencia_p bigint, cd_motivo_p bigint, ds_motivo_p text, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE alterar_status_consulta_html5 ( nr_sequencia_p bigint, cd_motivo_p bigint, ds_motivo_p text, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
