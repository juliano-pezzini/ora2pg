...
CREATE OR REPLACE PROCEDURE lote_ent_gerar_evento_lab ( nr_seq_evento_p bigint, nm_usuario_p text, nr_seq_instituicao_p bigint, ds_razao_social_inst_p text, nr_telefone_inst_p text, nr_ramal_p text, ds_instituicao_p text, cd_cnes_inst_p text) AS $body$
DECLARE
...
/*MACROS DISPONIVEIS PARA O LOTE DE ENTRADA*/
 
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@seq_instituicao',nr_seq_instituicao_p),1,4000);
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@razao_social',ds_razao_social_inst_p),1,4000);
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@nr_telefone',nr_telefone_inst_p),1,4000);
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@nr_ramal',nr_ramal_p),1,4000);
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@ds_instituicao',ds_instituicao_p),1,4000);
ds_mensagem_w	:= substr(replace_macro(ds_mensagem_w,'@cd_cnes',cd_cnes_inst_p),1,4000);
 
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@seq_instituicao',nr_seq_instituicao_p),1,4000);
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@razao_social',ds_razao_social_inst_p),1,4000);
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@nr_telefone',nr_telefone_inst_p),1,4000);
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@nr_ramal',nr_ramal_p),1,4000);
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@ds_instituicao',ds_instituicao_p),1,4000);
ds_titulo_w	:= substr(replace_macro(ds_titulo_w,'@cd_cnes',cd_cnes_inst_p),1,4000);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE lote_ent_gerar_evento_lab ( nr_seq_evento_p bigint, nm_usuario_p text, nr_seq_instituicao_p bigint, ds_razao_social_inst_p text, nr_telefone_inst_p text, nr_ramal_p text, ds_instituicao_p text, cd_cnes_inst_p text) FROM PUBLIC;
