...
CREATE OR REPLACE PROCEDURE pls_obter_campo_fat_fund_xml ( nm_campo_conversao_p pls_fat_regra_prest.nm_campo%type, ds_valor_original_p pls_fat_regra_prest.ds_valor_original%type, ds_valor_convertido_p INOUT pls_fat_regra_prest.ds_valor_convertido%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_obter_campo_fat_fund_xml ( nm_campo_conversao_p pls_fat_regra_prest.nm_campo%type, ds_valor_original_p pls_fat_regra_prest.ds_valor_original%type, ds_valor_convertido_p INOUT pls_fat_regra_prest.ds_valor_convertido%type, cd_estabelecimento_p estabelecimento.cd_estabelecimento%type) FROM PUBLIC;
