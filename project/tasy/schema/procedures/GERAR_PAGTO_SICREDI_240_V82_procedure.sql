...
CREATE OR REPLACE PROCEDURE gerar_pagto_sicredi_240_v82 ( nr_seq_envio_p bigint, nm_usuario_p text) AS $body$
DECLARE


/* PADRAO CNAB 240 VERSAO 8.2 
Essa rotina foi criada para atender as necessidades da OS 2001185,*/
...
EXIT WHEN NOT FOUND; /* apply on c03 */
	...
	if (ie_forma_lanc_w in ('16', '17', '11')) then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE gerar_pagto_sicredi_240_v82 ( nr_seq_envio_p bigint, nm_usuario_p text) FROM PUBLIC;
