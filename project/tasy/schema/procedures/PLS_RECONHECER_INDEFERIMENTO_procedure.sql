...
CREATE OR REPLACE PROCEDURE pls_reconhecer_indeferimento ( nr_seq_defesa_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE pls_reconhecer_indeferimento ( nr_seq_defesa_p bigint, nm_usuario_p text) FROM PUBLIC;
