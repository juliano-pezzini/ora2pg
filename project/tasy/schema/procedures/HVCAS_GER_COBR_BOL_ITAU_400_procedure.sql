...
CREATE OR REPLACE PROCEDURE hvcas_ger_cobr_bol_itau_400 ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) AS $body$
DECLARE
...
C01 CURSOR FOR
	SELECT	lpad(coalesce(c.cd_agencia_bancaria,'0'),4,'0'),
		...
		to_char(coalesce(b.dt_pagamento_previsto,clock_timestamp()),'dd/mm/yyyy'),
		to_char(coalesce(b.dt_emissao,clock_timestamp()),'ddmmyy'),
		elimina_acentuacao(rpad(substr(obter_nome_pf_pj(b.cd_pessoa_fisica,b.cd_cgc),1,255),30,' ')) nm_pagador,
		elimina_acentuacao(rpad(substr(upper(pls_obter_end_pagador(d.nr_seq_pagador,'EN')),1,120),40,' ')) ds_endereco,
		elimina_acentuacao(rpad(substr(upper(pls_obter_end_pagador(d.nr_seq_pagador,'B')),1,40),12,' ')) ds_bairro,
		elimina_acentuacao(rpad(substr(upper(pls_obter_end_pagador(d.nr_seq_pagador,'CEP')),1,120),8,' ')) cd_cep,
		elimina_acentuacao(rpad(substr(upper(pls_obter_end_pagador(d.nr_seq_pagador,'CI')),1,40),15,' ')) ds_cidade,
		elimina_acentuacao(rpad(substr(upper(pls_obter_end_pagador(d.nr_seq_pagador,'UF')),1,2),2, ' ')) ds_uf,
		...
		to_char(add_months(coalesce(b.dt_pagamento_previsto,clock_timestamp()),1),'dd/mm/yyyy'),
		elimina_acentuacao(rpad(coalesce(obter_instrucao_boleto(b.nr_titulo,a.cd_banco,1),' '),80, ' ')) ds_mensagem_1,
		elimina_acentuacao(rpad(coalesce(obter_instrucao_boleto(b.nr_titulo,a.cd_banco,2),' '),80, ' ')) ds_mensagem_2,
...
EXIT WHEN NOT FOUND; /* apply on C01 */
	...
	ds_conteudo_w	:=	'1' ||
				...
				rpad(coalesce(substr(sg_estado_w,1,2),' '),2,' ') ||
				nm_sacador_avalista_w ||
				ds_brancos_4_w ||
				'000000' ||
				'00 ' ||
...
WHERE a.cd_estabelecimento	= b.cd_estabelecimento and a.nr_seq_conta_banco	= c.nr_sequencia  and a.nr_sequencia		= nr_seq_cobr_escrit_p;
	...
	/*1997577 - Buscar o tipo de contratacao do pagador da mensalidade*/

	select	coalesce(max(c.ie_tipo_contratacao),'X')
	...
	select	coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,0,ie_tipo_contratacao_w)),' ')
		...
		nr_linha_col_3_w	:= nr_linha_w + 3;
			...
			if (i = 1) then
				...
				if (ie_tipo_contratacao_w = 'CE') then
					ds_conteudo_col_2_w	:= 	rpad('CONTRATO',13,' ') || rpad('CONTRATANTE',33,' ') ||
				...
				select	coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,1,ie_tipo_contratacao_w)),ds_mensagem_boleto_w),
					CASE WHEN trim(both elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,1,ie_tipo_contratacao_w))) IS NULL THEN 'N'  ELSE 'S' END
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,2,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,2,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,3,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,3,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,4,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,4,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,5,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,5,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_1_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,6,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,6,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_2_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,7,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,7,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,8,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,8,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_1_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,9,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,9,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_2_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,10,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,10,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,11,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,11,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_1_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,12,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,12,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_2_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,13,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,13,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,14,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,14,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_1_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,15,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,15,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_2_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,16,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,16,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,17,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,17,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_1_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,18,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,18,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_2_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,19,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,19,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,20,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,20,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_1_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,21,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,21,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_2_w
				;
				...
				select	CASE WHEN ie_mensagem_boleto_w='N' THEN coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,22,ie_tipo_contratacao_w)),' ')  ELSE coalesce(elimina_acentuacao(hvc_obter_informacao_boleto(nr_titulo_w,22,ie_tipo_contratacao_w)),ds_mensagem_boleto_w) END
				into STRICT	ds_conteudo_col_3_w
				;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE hvcas_ger_cobr_bol_itau_400 ( nr_seq_cobr_escrit_p bigint, cd_estabelecimento_p bigint, nm_usuario_p text) FROM PUBLIC;
