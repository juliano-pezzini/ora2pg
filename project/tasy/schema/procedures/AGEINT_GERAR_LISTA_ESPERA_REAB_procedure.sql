...
CREATE OR REPLACE PROCEDURE ageint_gerar_lista_espera_reab (ds_lista_espera_p text, ie_gera_sessoes_p text, nm_usuario_p text, cd_estabelecimento_p bigint) AS $body$
DECLARE
...
select	max(cd_convenio), 
	...
	max(obter_dados_pf(cd_pessoa_fisica,'DN')), 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE ageint_gerar_lista_espera_reab (ds_lista_espera_p text, ie_gera_sessoes_p text, nm_usuario_p text, cd_estabelecimento_p bigint) FROM PUBLIC;
